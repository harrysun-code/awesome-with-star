...
* [Ngrep](https://github.com/jpr5/ngrep/) [![GitHub stars](https://img.shields.io/github/stars/jpr5/ngrep/?style=flat)](https://github.com/jpr5/ngrep//stargazers): strives to provide most of GNU grep's common features, applying them to the network layer. ngrep is a pcap-aware tool that will allow you to specify extended regular or hexadecimal expressions to match against data payloads of packets. It currently recognizes TCP, UDP and ICMP across Ethernet, PPP, SLIP, FDDI, Token Ring and null interfaces, and understands bpf filter logic in the same fashion as more common packet sniffing tools, such as tcpdump and snoop. [Screenshot](https://www.cyberciti.biz/media/new/cms/2012/12/ngrep.png)

* [clj-net-pcap](https://github.com/ruedigergad/clj-net-pcap) [![GitHub stars](https://img.shields.io/github/stars/ruedigergad/clj-net-pcap?style=flat)](https://github.com/ruedigergad/clj-net-pcap/stargazers): `clj-net-pcap` is a packet capturing library for Clojure. clj-net-pcap uses jNetPcap and adds convenience functionality around jNetPcap for easing the usability. A [paper on clj-net-pcap](http://ieeexplore.ieee.org/xpl/articleDetails.jsp?tp=&arnumber=6903107) was published in scope of COMPSACW 2014.
...
* [Netis Packet Agent](https://github.com/Netis/packet-agent) [![GitHub stars](https://img.shields.io/github/stars/Netis/packet-agent?style=flat)](https://github.com/Netis/packet-agent/stargazers): It is a remote data capture utility through GRE tunnel, which makes you easily capture packets from an NIC interface, encapsulate them with GRE and send them to a remote machine for monitoring and analysis.

* [OpenFPC](https://github.com/leonward/OpenFPC) [![GitHub stars](https://img.shields.io/github/stars/leonward/OpenFPC?style=flat)](https://github.com/leonward/OpenFPC/stargazers): OpenFPC is a set of scripts that combine to provide a lightweight full-packet network traffic recorder & buffering tool. Its design goal is to allow non-expert users to deploy a distributed network traffic recorder on COTS hardware while integrating into existing alert and log tools.

* [PCAPdroid](https://github.com/emanuele-f/PCAPdroid) [![GitHub stars](https://img.shields.io/github/stars/emanuele-f/PCAPdroid?style=flat)](https://github.com/emanuele-f/PCAPdroid/stargazers): PCAPdroid is an Android app which lets you monitor and export the network traffic of your device without root. Traffic can be dumped in the PCAP format to be analyzed with popular tools like Wireshark, even in real time. The built-in traffic monitor lets you detect suspicious connections made by user and system apps.
...
* [pmacct](https://github.com/pmacct/pmacct) [![GitHub stars](https://img.shields.io/github/stars/pmacct/pmacct?style=flat)](https://github.com/pmacct/pmacct/stargazers): is a small set of multi-purpose passive network monitoring tools. It can account, classify, aggregate, replicate and export forwarding-plane data, ie. IPv4 and IPv6 traffic; collect and correlate control-plane data via BGP and BMP; collect and correlate RPKI data; collect infrastructure data via Streaming Telemetry.

* [softflowd](https://github.com/irino/softflowd) [![GitHub stars](https://img.shields.io/github/stars/irino/softflowd?style=flat)](https://github.com/irino/softflowd/stargazers): is a flow-based network monitor, that listens promiscously to a network interface using libpcap and exports NetFlow data.
...
* [sharppcap](https://github.com/dotpcap/sharppcap) [![GitHub stars](https://img.shields.io/github/stars/dotpcap/sharppcap?style=flat)](https://github.com/dotpcap/sharppcap/stargazers): Fully managed, cross platform (Windows, Mac, Linux) .NET library for capturing packets from live and file based devices. A realiable and robust wrapper of libpcap and npcap.
...
* [BruteShark](https://github.com/odedshimon/BruteShark) [![GitHub stars](https://img.shields.io/github/stars/odedshimon/BruteShark?style=flat)](https://github.com/odedshimon/BruteShark/stargazers): Is an open-source, cross-platform network forensic analysis tool with many features. It includes: password extracting,  displaying a visual network map, reconstruct TCP sessions, extract hashes of encrypted passwords and even convert them to a Hashcat format in order to perform an offline Brute Force attack.
...
* [CapTipper](https://github.com/omriher/CapTipper) [![GitHub stars](https://img.shields.io/github/stars/omriher/CapTipper?style=flat)](https://github.com/omriher/CapTipper/stargazers): Malicious HTTP traffic explorer

* [Chopshop](https://github.com/MITRECND/chopshop) [![GitHub stars](https://img.shields.io/github/stars/MITRECND/chopshop?style=flat)](https://github.com/MITRECND/chopshop/stargazers): is a MITRE developed framework to aid analysts in the creation and execution of pynids based decoders and detectors of APT tradecraft.
...
* [DPKT](https://github.com/kbandla/dpkt) [![GitHub stars](https://img.shields.io/github/stars/kbandla/dpkt?style=flat)](https://github.com/kbandla/dpkt/stargazers): Python packet creation/parsing library.
...
* [Joy](https://github.com/cisco/joy) [![GitHub stars](https://img.shields.io/github/stars/cisco/joy?style=flat)](https://github.com/cisco/joy/stargazers): joy is a traffic analysis and parsing tool that was developed. In part to assist in classifying encrypted traffic streams, such as HTTPS traffic. It is able to parse pcap files into usable json files that contain details on the capture statistics and features.

* [Libcrafter](https://github.com/pellegre/libcrafter) [![GitHub stars](https://img.shields.io/github/stars/pellegre/libcrafter?style=flat)](https://github.com/pellegre/libcrafter/stargazers): is a high level library for C++ designed to make easier the creation and decoding of network packets. It is able to craft or decode packets of most common network protocols, send them on the wire, capture them and match requests and replies.

* [Libnet](https://github.com/libnet/libnet) [![GitHub stars](https://img.shields.io/github/stars/libnet/libnet?style=flat)](https://github.com/libnet/libnet/stargazers): is a collection of routines to help with the construction and handling of network packets. It provides a portable framework for low-level network packet shaping, handling and injection. Libnet features portable packet creation interfaces at the IP layer and link layer, as well as a host of supplementary and complementary functionality. Using libnet, quick and simple packet assembly applications can be whipped up with little effort.
...
* [nfdump](https://github.com/phaag/nfdump) [![GitHub stars](https://img.shields.io/github/stars/phaag/nfdump?style=flat)](https://github.com/phaag/nfdump/stargazers): is a powerful suite of tools for collecting, processing, and analysing flow data from network devices.

* [NFStream](https://github.com/nfstream/nfstream) [![GitHub stars](https://img.shields.io/github/stars/nfstream/nfstream?style=flat)](https://github.com/nfstream/nfstream/stargazers): is a Python framework providing fast, flexible, and expressive data structures designed to make working with online or offline network data both easy and intuitive. It aims to be the fundamental high-level building block for doing practical, real world network data analysis in Python. Additionally, it has the broader goal of becoming a common network data analytics framework for researchers providing data reproducibility across experiments.
...
* [packemon](https://github.com/ddddddO/packemon) [![GitHub stars](https://img.shields.io/github/stars/ddddddO/packemon?style=flat)](https://github.com/ddddddO/packemon/stargazers): Packet monster (っ‘-’)╮=͟͟͞͞◒ ヽ( '-'ヽ) TUI tool for sending packets of arbitrary input and monitoring packets on any network interfaces (default: eth0).

* [PacketQ](https://github.com/dotse/PacketQ) [![GitHub stars](https://img.shields.io/github/stars/dotse/PacketQ?style=flat)](https://github.com/dotse/PacketQ/stargazers): A tool that provides a basic SQL-frontend to PCAP-files. Outputs JSON, CSV and XML and includes a build-in webserver with JSON-api and a nice looking AJAX GUI.

* [Pcap2har](https://github.com/andrewf/pcap2har) [![GitHub stars](https://img.shields.io/github/stars/andrewf/pcap2har?style=flat)](https://github.com/andrewf/pcap2har/stargazers): A program to convert .pcap network capture files to HTTP Archive files using library dpkt.

* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus) [![GitHub stars](https://img.shields.io/github/stars/seladb/PcapPlusPlus?style=flat)](https://github.com/seladb/PcapPlusPlus/stargazers): PcapPlusPlus a multiplatform C++ network sniffing and packet parsing and manipulation framework. It's meant to be lightweight, efficient and easy to use. It's a C++ wrapper for popular engines like libpcap, WinPcap, DPDK and PF_RING. It also contains parsing and edit capabilities for many protocols including Ethernet, IPv4, IPv6, ARP, VLAN, MPLS, PPPoE, GRE, TCP, UDP, ICMP, DNS as well as layer 7 protocols like HTTP and SSL/TLS

* [pcaptoparquet](https://github.com/nokia/pcaptoparquet) [![GitHub stars](https://img.shields.io/github/stars/nokia/pcaptoparquet?style=flat)](https://github.com/nokia/pcaptoparquet/stargazers): pcaptoparquet is a Python package designed for converting PCAP or PCAPNG files to structured data formats, primarily Apache Parquet. The tool focuses on network traffic analysis by extracting, decoding, and transforming packet data into queryable datasets suitable for analysis and visualization. The tool supports both command-line and programmatic interfaces, enabling integration into various network analysis workflows.

* [pkt2flow](https://github.com/caesar0301/pkt2flow) [![GitHub stars](https://img.shields.io/github/stars/caesar0301/pkt2flow?style=flat)](https://github.com/caesar0301/pkt2flow/stargazers): A simple utility to classify packets into flows. It's so simple that only one task is aimed to finish.  For Deep Packet Inspection or flow classification, it's so common to analyze the feature of one specific flow. I have make the attempt to use made-ready tools like tcpflows, tcpslice, tcpsplit, but all these tools try to either decrease the trace volume (under requirement) or resemble the packets into flow payloads (over requirement). I have not found a simple tool to classify the packets into flows without further processing.

* [potiron](https://github.com/CIRCL/potiron) [![GitHub stars](https://img.shields.io/github/stars/CIRCL/potiron?style=flat)](https://github.com/CIRCL/potiron/stargazers): Normalizes, indexes, enriches and visualizes network captures.
...
* [Socket Sentry](https://github.com/rhasselbaum/socket-sentry) [![GitHub stars](https://img.shields.io/github/stars/rhasselbaum/socket-sentry?style=flat)](https://github.com/rhasselbaum/socket-sentry/stargazers): Socket Sentry is a real-time network traffic monitor for KDE Plasma in the same spirit as tools like iftop and netstat.
...
* [Tcpreplay](https://github.com/appneta/tcpreplay) [![GitHub stars](https://img.shields.io/github/stars/appneta/tcpreplay?style=flat)](https://github.com/appneta/tcpreplay/stargazers): Replays a pcap file on an interface using libnet.

* [Tcpslice](https://github.com/pyke369/tcpsplice) [![GitHub stars](https://img.shields.io/github/stars/pyke369/tcpsplice?style=flat)](https://github.com/pyke369/tcpsplice/stargazers): Tcpslice is a tool for extracting portions of packet trace files generated using tcpdump's -w flag. It can combine multiple trace files, and/or extract portions of one or more traces based on time.

* [Tcpsplit](https://github.com/pmcgleenon/tcpsplit) [![GitHub stars](https://img.shields.io/github/stars/pmcgleenon/tcpsplit?style=flat)](https://github.com/pmcgleenon/tcpsplit/stargazers): A tool to break a single libpcap packet trace into some number of sub- traces, breaking the trace along TCP connection boundaries so that a TCP connection doesn't end up split across two sub-traces. This is useful for making large trace files tractable for in- depth analysis and for subsetting a trace for developing analysis on only part of a trace.
...
* [Tcptrace](https://github.com/blitz/tcptrace) [![GitHub stars](https://img.shields.io/github/stars/blitz/tcptrace?style=flat)](https://github.com/blitz/tcptrace/stargazers): A tool written by Shawn Ostermann at Ohio University, for analysis of TCP dump files. It can take as input the files produced by several popular packet- capture programs, including tcpdump, snoop, etherpeek, HP Net Metrix, and WinDump. tcptrace can produce several different types of output containing information on each connection seen, such as elapsed time, bytes and segments sent and received, retransmissions, round trip times, window advertisements, throughput, and more. It can also produce a number of graphs for further analysis.
...
* [WinDivert](https://github.com/basil00/WinDivert) [![GitHub stars](https://img.shields.io/github/stars/basil00/WinDivert?style=flat)](https://github.com/basil00/WinDivert/stargazers): is a Windows library for user-mode packet interception.
...
* [yaraPcap](https://github.com/kevthehermit/YaraPcap) [![GitHub stars](https://img.shields.io/github/stars/kevthehermit/YaraPcap?style=flat)](https://github.com/kevthehermit/YaraPcap/stargazers): Process HTTP Pcaps With YARA

* [yaraprocessor](https://github.com/MITRECND/yaraprocessor) [![GitHub stars](https://img.shields.io/github/stars/MITRECND/yaraprocessor?style=flat)](https://github.com/MITRECND/yaraprocessor/stargazers): With yaraprocessor YARA can be run against individual packet payloads as well as a concatenation of some or all of the payloads. It was originally written for use in Chopshop, but can also be used without it.
...
* [Foremost](https://github.com/jonstewart/foremost) [![GitHub stars](https://img.shields.io/github/stars/jonstewart/foremost?style=flat)](https://github.com/jonstewart/foremost/stargazers): is a console program to recover files based on their headers, footers, and internal data structures. This process is commonly referred to as data carving. Foremost can work on image files, such as those generated by dd, Safeback, Encase, etc, or directly on a drive. The headers and footers can be specified by a configuration file or you can use command line switches to specify built-in file types. These built-in types look at the data structures of a given file format allowing for a more reliable and faster recovery.
...
* [pcapfex](https://github.com/vikwin/pcapfex) [![GitHub stars](https://img.shields.io/github/stars/vikwin/pcapfex?style=flat)](https://github.com/vikwin/pcapfex/stargazers) - Packet CAPture Forensic Evidence eXtractor (pcapfex) is a tool that finds and extracts files from packet capture files. Its power lies in its ease of use. Just provide it a pcap file, and it will try to extract all of the files. It is an extensible platform, so additional file types to recognize and extract can be added easily.

* [scalpel](https://github.com/sleuthkit/scalpel) [![GitHub stars](https://img.shields.io/github/stars/sleuthkit/scalpel?style=flat)](https://github.com/sleuthkit/scalpel/stargazers): Scalpel is an open source data carving tool.
...
* [USBPcap](https://github.com/desowin/usbpcap) [![GitHub stars](https://img.shields.io/github/stars/desowin/usbpcap?style=flat)](https://github.com/desowin/usbpcap/stargazers) - a solution for Windows.

### Analysis
* [USBPcapOdinDumper](https://github.com/KOLANICH/USBPcapOdinDumper) [![GitHub stars](https://img.shields.io/github/stars/KOLANICH/USBPcapOdinDumper?style=flat)](https://github.com/KOLANICH/USBPcapOdinDumper/stargazers) - transforms .pcap files with `usbmon` and `USBPcap` frames format of captures from flashing an Android phone with Odin or [Heimdall](https://gitlab.com/BenjaminDobell/Heimdall) into a set of files with frames payload. Useful for reverse-engineering. Has a modular architecture easily transformable for other applications formats.
...
* [RIPE-NCC Hadoop for PCAP](https://github.com/RIPE-NCC/hadoop-pcap) [![GitHub stars](https://img.shields.io/github/stars/RIPE-NCC/hadoop-pcap?style=flat)](https://github.com/RIPE-NCC/hadoop-pcap/stargazers): A Hadoop library to read packet capture (PCAP) files. Bundles the code used to read PCAPs. Can be used within MapReduce jobs to natively read PCAP files. Also features a Hive Serializer/Deserializer (SerDe) to query PCAPs using SQL like commands.
