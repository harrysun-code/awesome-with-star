...
- [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) [![GitHub stars](https://img.shields.io/github/stars/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element?style=flat)](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element/stargazers)
...
- [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) [![GitHub stars](https://img.shields.io/github/stars/web-platform-tests/wpt/tree/master/css/css-shadow-parts?style=flat)](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts/stargazers)
...
- [generic-components](https://github.com/thepassle/generic-components) [![GitHub stars](https://img.shields.io/github/stars/thepassle/generic-components?style=flat)](https://github.com/thepassle/generic-components/stargazers) - Collection of generic web components with a focus on accessibility, and ease of use.
- [howto-components](https://github.com/GoogleChromeLabs/howto-components) [![GitHub stars](https://img.shields.io/github/stars/GoogleChromeLabs/howto-components?style=flat)](https://github.com/GoogleChromeLabs/howto-components/stargazers) - Collection of web components that implement common web UI patterns.
- [Nude UI](https://github.com/LeaVerou/nudeui) [![GitHub stars](https://img.shields.io/github/stars/LeaVerou/nudeui?style=flat)](https://github.com/LeaVerou/nudeui/stargazers) - Collection of accessible, customizable, ultra-light web components.
...
- [vanilla-retro-js](https://github.com/martine-dowden/vanilla-retro-js) [![GitHub stars](https://img.shields.io/github/stars/martine-dowden/vanilla-retro-js?style=flat)](https://github.com/martine-dowden/vanilla-retro-js/stargazers) - Vanilla JS UI component library of HTML deprecated tags.
- [web-components-examples](https://github.com/mdn/web-components-examples) [![GitHub stars](https://img.shields.io/github/stars/mdn/web-components-examples?style=flat)](https://github.com/mdn/web-components-examples/stargazers) - Series of web components examples, related to the MDN web components documentation.
...
- [`<active-table>`](https://github.com/OvidijusParsiunas/active-table) [![GitHub stars](https://img.shields.io/github/stars/OvidijusParsiunas/active-table?style=flat)](https://github.com/OvidijusParsiunas/active-table/stargazers) - Editable table web component.
- [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) [![GitHub stars](https://img.shields.io/github/stars/web-padawan/api-viewer-element?style=flat)](https://github.com/web-padawan/api-viewer-element/stargazers) - API documentation and live playground for Web Components.
- [`<aura-router>`](https://github.com/aura-ui/router) [![GitHub stars](https://img.shields.io/github/stars/aura-ui/router?style=flat)](https://github.com/aura-ui/router/stargazers) - HTML-first client-side router web component.
- [`<chess-board>`](https://github.com/justinfagnani/chessboard-element) [![GitHub stars](https://img.shields.io/github/stars/justinfagnani/chessboard-element?style=flat)](https://github.com/justinfagnani/chessboard-element/stargazers) - Standalone chess board web component.
- [`<css-doodle>`](https://github.com/css-doodle/css-doodle) [![GitHub stars](https://img.shields.io/github/stars/css-doodle/css-doodle?style=flat)](https://github.com/css-doodle/css-doodle/stargazers) - Web component for drawing patterns with CSS.
- [`<dark-mode-toggle>`](https://github.com/GoogleChromeLabs/dark-mode-toggle) [![GitHub stars](https://img.shields.io/github/stars/GoogleChromeLabs/dark-mode-toggle?style=flat)](https://github.com/GoogleChromeLabs/dark-mode-toggle/stargazers) - Custom element that allows to create a dark mode toggle or switch.
- [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) [![GitHub stars](https://img.shields.io/github/stars/OvidijusParsiunas/deep-chat?style=flat)](https://github.com/OvidijusParsiunas/deep-chat/stargazers) - Web component for chat with AI capabilities.
- [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) [![GitHub stars](https://img.shields.io/github/stars/nolanlawson/emoji-picker-element?style=flat)](https://github.com/nolanlawson/emoji-picker-element/stargazers) - Lightweight emoji picker, distributed as a web component.
- [`<fg-modal>`](https://github.com/filamentgroup/fg-modal) [![GitHub stars](https://img.shields.io/github/stars/filamentgroup/fg-modal?style=flat)](https://github.com/filamentgroup/fg-modal/stargazers) - Accessible modal dialog web component.
- [`<file-viewer>`](https://github.com/avipunes/file-viewer) [![GitHub stars](https://img.shields.io/github/stars/avipunes/file-viewer?style=flat)](https://github.com/avipunes/file-viewer/stargazers) - Web component built with Svelte to view files.
- [`<json-viewer>`](https://github.com/alenaksu/json-viewer) [![GitHub stars](https://img.shields.io/github/stars/alenaksu/json-viewer?style=flat)](https://github.com/alenaksu/json-viewer/stargazers) - Web component to visualize JSON data in a tree view.
- [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) [![GitHub stars](https://img.shields.io/github/stars/paulirish/lite-youtube-embed?style=flat)](https://github.com/paulirish/lite-youtube-embed/stargazers) - Lite YouTube embed with a focus on visual performance.
- [`<midi-player>`](https://github.com/cifkao/html-midi-player) [![GitHub stars](https://img.shields.io/github/stars/cifkao/html-midi-player?style=flat)](https://github.com/cifkao/html-midi-player/stargazers) - MIDI file player and visualizer web components.
- [`<model-viewer>`](https://github.com/google/model-viewer) [![GitHub stars](https://img.shields.io/github/stars/google/model-viewer?style=flat)](https://github.com/google/model-viewer/stargazers) - Web component for rendering interactive 3D models.
- [`<notectl-editor>`](https://github.com/Samyssmile/notectl) [![GitHub stars](https://img.shields.io/github/stars/Samyssmile/notectl?style=flat)](https://github.com/Samyssmile/notectl/stargazers) - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
- [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) [![GitHub stars](https://img.shields.io/github/stars/alekswebnet/pdfjs-viewer-element?style=flat)](https://github.com/alekswebnet/pdfjs-viewer-element/stargazers) - Custom element that embeds PDF.js default viewer.
- [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) [![GitHub stars](https://img.shields.io/github/stars/Aejkatappaja/phantom-ui?style=flat)](https://github.com/Aejkatappaja/phantom-ui/stargazers) - Skeleton loader that measures your real DOM to render matching shimmer placeholders.
- [`<player-x>`](https://github.com/playerxo/playerx) [![GitHub stars](https://img.shields.io/github/stars/playerxo/playerx?style=flat)](https://github.com/playerxo/playerx/stargazers) - Media player web component.
- [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) [![GitHub stars](https://img.shields.io/github/stars/andreruffert/progressive-image-element?style=flat)](https://github.com/andreruffert/progressive-image-element/stargazers) - Custom element to progressively enhance image placeholders.
- [`<qr-code>`](https://github.com/bitjson/qr-code) [![GitHub stars](https://img.shields.io/github/stars/bitjson/qr-code?style=flat)](https://github.com/bitjson/qr-code/stargazers) – Web component for rendering customizable, animate-able, SVG-based QR codes.
- [`<range-slider>`](https://github.com/andreruffert/range-slider-element) [![GitHub stars](https://img.shields.io/github/stars/andreruffert/range-slider-element?style=flat)](https://github.com/andreruffert/range-slider-element/stargazers) - Accessible range slider custom element with keyboard support.
- [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) [![GitHub stars](https://img.shields.io/github/stars/mrin9/RapiDoc?style=flat)](https://github.com/mrin9/RapiDoc/stargazers) - Web component for creating documentation from OpenAPI Specification.
- [`<shader-doodle>`](https://github.com/halvves/shader-doodle) [![GitHub stars](https://img.shields.io/github/stars/halvves/shader-doodle?style=flat)](https://github.com/halvves/shader-doodle/stargazers) - Web component for writing and rendering shaders.
- [`<theme-switch>`](https://github.com/mahozad/theme-switch) [![GitHub stars](https://img.shields.io/github/stars/mahozad/theme-switch?style=flat)](https://github.com/mahozad/theme-switch/stargazers) - Animated toggle button to switch between light, dark, and system theme.
- [`<trix-editor>`](https://github.com/basecamp/trix) [![GitHub stars](https://img.shields.io/github/stars/basecamp/trix?style=flat)](https://github.com/basecamp/trix/stargazers) - Rich text editor custom element for everyday writing.
- [`<vime-player>`](https://github.com/vime-js/vime) [![GitHub stars](https://img.shields.io/github/stars/vime-js/vime?style=flat)](https://github.com/vime-js/vime/stargazers) - Customizable, extensible, accessible and framework agnostic media player.
- [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) [![GitHub stars](https://img.shields.io/github/stars/stefanjudis/web-vitals-element?style=flat)](https://github.com/stefanjudis/web-vitals-element/stargazers) - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/web-vitals?style=flat)](https://github.com/GoogleChrome/web-vitals/stargazers) quickly into your page using custom elements.

### Component Libraries

- [AgnosticUI](https://github.com/AgnosticUI/agnosticui) [![GitHub stars](https://img.shields.io/github/stars/AgnosticUI/agnosticui?style=flat)](https://github.com/AgnosticUI/agnosticui/stargazers) - A CLI-based UI component library that copies Lit web components directly into your project. Full React and Vue wrappers for native framework experience.
- [AMP](https://github.com/ampproject/amphtml) [![GitHub stars](https://img.shields.io/github/stars/ampproject/amphtml?style=flat)](https://github.com/ampproject/amphtml/stargazers) - Web component framework for easily creating user-first websites, stories, ads, emails and more.
- [AnywhereUI](https://github.com/adaleks/anywhere-ui) [![GitHub stars](https://img.shields.io/github/stars/adaleks/anywhere-ui?style=flat)](https://github.com/adaleks/anywhere-ui/stargazers) - Collection of rich web components that includes framework bindings. Created with StencilJS.
- [Apollo Elements](https://github.com/apollo-elements/apollo-elements) [![GitHub stars](https://img.shields.io/github/stars/apollo-elements/apollo-elements?style=flat)](https://github.com/apollo-elements/apollo-elements/stargazers) - Custom elements for using Apollo GraphQL with various web components libraries.
- [AXA Pattern Library](https://github.com/axa-ch-webhub-cloud/pattern-library) [![GitHub stars](https://img.shields.io/github/stars/axa-ch-webhub-cloud/pattern-library?style=flat)](https://github.com/axa-ch-webhub-cloud/pattern-library/stargazers) - AXA CH UI components library built with Web Components.
- [Blackstone UI](https://github.com/kjantzer/bui) [![GitHub stars](https://img.shields.io/github/stars/kjantzer/bui?style=flat)](https://github.com/kjantzer/bui/stargazers) - Web components for creating interfaces by Blackstone Publishing.
- [Blaze UI Atoms](https://github.com/BlazeSoftware/atoms) [![GitHub stars](https://img.shields.io/github/stars/BlazeSoftware/atoms?style=flat)](https://github.com/BlazeSoftware/atoms/stargazers) - Set of web components powered by Blaze CSS.
- [Brightspace UI core](https://github.com/BrightspaceUI/core) [![GitHub stars](https://img.shields.io/github/stars/BrightspaceUI/core?style=flat)](https://github.com/BrightspaceUI/core/stargazers) - Collection of web components for building Brightspace applications.
- [Burnish Components](https://github.com/danfking/burnish/tree/main/packages/components) [![GitHub stars](https://img.shields.io/github/stars/danfking/burnish/tree/main/packages/components?style=flat)](https://github.com/danfking/burnish/tree/main/packages/components/stargazers) - Web components for rendering MCP tool-call output as UI.
- [Clever components](https://github.com/CleverCloud/clever-components) [![GitHub stars](https://img.shields.io/github/stars/CleverCloud/clever-components?style=flat)](https://github.com/CleverCloud/clever-components/stargazers) - Collection of Web Components made by Clever Cloud.
- [Curvenote](https://github.com/curvenote/article) [![GitHub stars](https://img.shields.io/github/stars/curvenote/article?style=flat)](https://github.com/curvenote/article/stargazers) - Web components for creating interactive scientific articles.
- [DataFormsJS](https://github.com/dataformsjs/dataformsjs) [![GitHub stars](https://img.shields.io/github/stars/dataformsjs/dataformsjs?style=flat)](https://github.com/dataformsjs/dataformsjs/stargazers) - Standalone Components for SPA routing, displaying data from web services, and more.
- [Dile Components](https://github.com/Polydile/dile-components) [![GitHub stars](https://img.shields.io/github/stars/Polydile/dile-components?style=flat)](https://github.com/Polydile/dile-components/stargazers) - General use Web Components for websites and applications.
- [elements-sk](https://github.com/google/elements-sk) [![GitHub stars](https://img.shields.io/github/stars/google/elements-sk?style=flat)](https://github.com/google/elements-sk/stargazers) - Collection of custom elements for "a la carte" web development.
- [github-elements](https://github.com/github/github-elements) [![GitHub stars](https://img.shields.io/github/stars/github/github-elements?style=flat)](https://github.com/github/github-elements/stargazers) - GitHub's Web Component collection.
- [Elix](https://github.com/elix/elix) [![GitHub stars](https://img.shields.io/github/stars/elix/elix?style=flat)](https://github.com/elix/elix/stargazers) - High-quality, customizable web components for common user interface patterns.
- [Furo Webcomponents](https://github.com/eclipse/eclipsefuro-web) [![GitHub stars](https://img.shields.io/github/stars/eclipse/eclipsefuro-web?style=flat)](https://github.com/eclipse/eclipsefuro-web/stargazers) - Enterprise ready set of web components which work best with Eclipse Furo.
- [Fusion Web Components](https://github.com/equinor/fusion-web-components) [![GitHub stars](https://img.shields.io/github/stars/equinor/fusion-web-components?style=flat)](https://github.com/equinor/fusion-web-components/stargazers) - Ser of web components used by Equinor Fusion.
- [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) [![GitHub stars](https://img.shields.io/github/stars/IgniteUI/igniteui-webcomponents?style=flat)](https://github.com/IgniteUI/igniteui-webcomponents/stargazers) - Complete library of UI components from Infragistics.
- [Immersive Custom Elements](https://github.com/MozillaReality/immersive-custom-elements) [![GitHub stars](https://img.shields.io/github/stars/MozillaReality/immersive-custom-elements?style=flat)](https://github.com/MozillaReality/immersive-custom-elements/stargazers) - Set of web components for embedding immersive (VR & AR) content.
- [Joomla UI custom elements](https://github.com/joomla-projects/custom-elements) [![GitHub stars](https://img.shields.io/github/stars/joomla-projects/custom-elements?style=flat)](https://github.com/joomla-projects/custom-elements/stargazers) - Compilation of Joomla 4 Custom Elements.
- [Ketch.UP](https://github.com/smeup/ketchup) [![GitHub stars](https://img.shields.io/github/stars/smeup/ketchup?style=flat)](https://github.com/smeup/ketchup/stargazers) - Web components library for Sme.UP.
- [LDRS](https://github.com/GriffinJohnston/ldrs) [![GitHub stars](https://img.shields.io/github/stars/GriffinJohnston/ldrs?style=flat)](https://github.com/GriffinJohnston/ldrs/stargazers) - Lightweight, customizable loading animations/spinners.
- [Lion Web Components](https://github.com/ing-bank/lion) [![GitHub stars](https://img.shields.io/github/stars/ing-bank/lion?style=flat)](https://github.com/ing-bank/lion/stargazers) - Set of highly performant, accessible and flexible Web Components.
...
- [Microsoft Graph Toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) [![GitHub stars](https://img.shields.io/github/stars/microsoftgraph/microsoft-graph-toolkit?style=flat)](https://github.com/microsoftgraph/microsoft-graph-toolkit/stargazers) - Collection of web components for the Microsoft Graph.
...
- [One Platform Components](https://github.com/1-Platform/op-components) [![GitHub stars](https://img.shields.io/github/stars/1-Platform/op-components?style=flat)](https://github.com/1-Platform/op-components/stargazers) - Set of web components for Red Hat One Platform.
- [Open Business Application Platform Web Components](https://github.com/openbap/obap-elements) [![GitHub stars](https://img.shields.io/github/stars/openbap/obap-elements?style=flat)](https://github.com/openbap/obap-elements/stargazers) - Collection of web components designed for business applications.
- [Pixano Elements](https://github.com/pixano/pixano-elements) [![GitHub stars](https://img.shields.io/github/stars/pixano/pixano-elements?style=flat)](https://github.com/pixano/pixano-elements/stargazers) - Re-usable web components dedicated to data annotation tasks.
...
- [Shoelace](https://github.com/shoelace-style/shoelace) [![GitHub stars](https://img.shields.io/github/stars/shoelace-style/shoelace?style=flat)](https://github.com/shoelace-style/shoelace/stargazers) - A forward-thinking library of web components.
...
- [Tradeshift Elements](https://github.com/Tradeshift/elements) [![GitHub stars](https://img.shields.io/github/stars/Tradeshift/elements?style=flat)](https://github.com/Tradeshift/elements/stargazers) - Reusable Tradeshift UI Components as Web Components.
- [TrendChart Elements](https://github.com/WebLogin/trendchart-elements) [![GitHub stars](https://img.shields.io/github/stars/WebLogin/trendchart-elements?style=flat)](https://github.com/WebLogin/trendchart-elements/stargazers) - Components to generate simple, light and responsive charts.
- [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) [![GitHub stars](https://img.shields.io/github/stars/umbraco/Umbraco.UI?style=flat)](https://github.com/umbraco/Umbraco.UI/stargazers) - Collection of user interface web components for Umbraco CMS.
- [Vaadin components](https://github.com/vaadin/web-components) [![GitHub stars](https://img.shields.io/github/stars/vaadin/web-components?style=flat)](https://github.com/vaadin/web-components/stargazers) - Evolving set of high-quality web components for building business web applications.
- [VSCode Webview Elements](https://github.com/bendera/vscode-webview-elements) [![GitHub stars](https://img.shields.io/github/stars/bendera/vscode-webview-elements?style=flat)](https://github.com/bendera/vscode-webview-elements/stargazers) - Components for creating VSCode extensions which use the Webview API.
- [Warp View](https://github.com/senx/warpview) [![GitHub stars](https://img.shields.io/github/stars/senx/warpview?style=flat)](https://github.com/senx/warpview/stargazers) - Collection of charting web components for Warp 10.
- [Webmarkets web components](https://github.com/Webmarkets/wm-web-components) [![GitHub stars](https://img.shields.io/github/stars/Webmarkets/wm-web-components?style=flat)](https://github.com/Webmarkets/wm-web-components/stargazers) - Set of Webmarkets' public web components.
- [Wired Elements](https://github.com/wiredjs/wired-elements) [![GitHub stars](https://img.shields.io/github/stars/wiredjs/wired-elements?style=flat)](https://github.com/wiredjs/wired-elements/stargazers) - Set of common UI elements with a hand-drawn, sketchy look.
- [Wokwi Elements](https://github.com/wokwi/wokwi-elements) [![GitHub stars](https://img.shields.io/github/stars/wokwi/wokwi-elements?style=flat)](https://github.com/wokwi/wokwi-elements/stargazers) - Web Components for Arduino and various electronic parts.
- [XWeather](https://github.com/kherrick/x-weather) [![GitHub stars](https://img.shields.io/github/stars/kherrick/x-weather?style=flat)](https://github.com/kherrick/x-weather/stargazers) - Collection of web components implementing portions of the OpenWeatherMap API.

### Design Systems

- [Astro Space UX Design System](https://github.com/RocketCommunicationsInc/astro) [![GitHub stars](https://img.shields.io/github/stars/RocketCommunicationsInc/astro?style=flat)](https://github.com/RocketCommunicationsInc/astro/stargazers) - Set of components to build rich space app experiences with established interaction patterns.
...
- [Bolt Design System](https://github.com/boltdesignsystem/bolt) [![GitHub stars](https://img.shields.io/github/stars/boltdesignsystem/bolt?style=flat)](https://github.com/boltdesignsystem/bolt/stargazers) - Twig and Web Component-powered UI components, reusable visual styles and tooling.
- [Calcite Components](https://github.com/Esri/calcite-components) [![GitHub stars](https://img.shields.io/github/stars/Esri/calcite-components?style=flat)](https://github.com/Esri/calcite-components/stargazers) - Shared Web Components for Esri's Calcite design framework.
...
- [Clarity Core Web Components](https://github.com/vmware-clarity/core/tree/main/projects/core) [![GitHub stars](https://img.shields.io/github/stars/vmware-clarity/core/tree/main/projects/core?style=flat)](https://github.com/vmware-clarity/core/tree/main/projects/core/stargazers) - Suite of web components from the Clarity Design System.
- [Crayons](https://github.com/freshdesk/crayons) [![GitHub stars](https://img.shields.io/github/stars/freshdesk/crayons?style=flat)](https://github.com/freshdesk/crayons/stargazers) - Collection of web components that adheres to the Freshworks Design System.
- [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) [![GitHub stars](https://img.shields.io/github/stars/microsoft/fast/tree/master/packages/web-components?style=flat)](https://github.com/microsoft/fast/tree/master/packages/web-components/stargazers) - Library of Web Components based on the FAST design language.
- [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) [![GitHub stars](https://img.shields.io/github/stars/microsoft/fluentui/tree/master/packages/web-components?style=flat)](https://github.com/microsoft/fluentui/tree/master/packages/web-components/stargazers) - Library of Web Components that supports Microsoft's Fluent design language.
- [Forge Components](https://github.com/tyler-technologies-oss/forge) [![GitHub stars](https://img.shields.io/github/stars/tyler-technologies-oss/forge?style=flat)](https://github.com/tyler-technologies-oss/forge/stargazers) - Library of Web Components adhering to the Forge Design System.
- [GOV.UK Web Components](https://github.com/tgreyuk/govuk-webcomponents) [![GitHub stars](https://img.shields.io/github/stars/tgreyuk/govuk-webcomponents?style=flat)](https://github.com/tgreyuk/govuk-webcomponents/stargazers) - Set of encapsulated web components consuming the GOV.UK Design System.
- [Helix UI](https://github.com/HelixDesignSystem/helix-ui) [![GitHub stars](https://img.shields.io/github/stars/HelixDesignSystem/helix-ui?style=flat)](https://github.com/HelixDesignSystem/helix-ui/stargazers) - Web Component library for the Helix Design System.
- [Liquid](https://github.com/emdgroup-liquid/liquid) [![GitHub stars](https://img.shields.io/github/stars/emdgroup-liquid/liquid?style=flat)](https://github.com/emdgroup-liquid/liquid/stargazers) - UI component library based on the Liquid Design System.
- [Lyne Components](https://github.com/lyne-design-system/lyne-components) [![GitHub stars](https://img.shields.io/github/stars/lyne-design-system/lyne-components?style=flat)](https://github.com/lyne-design-system/lyne-components/stargazers) - Building blocks of the Lyne Design System are based on Web Components.
- [Material Web Components](https://github.com/material-components/material-web) [![GitHub stars](https://img.shields.io/github/stars/material-components/material-web?style=flat)](https://github.com/material-components/material-web/stargazers) - Material Design implemented as Web Components.
- [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/master/web-components) [![GitHub stars](https://img.shields.io/github/stars/momentum-design/momentum-ui/tree/master/web-components?style=flat)](https://github.com/momentum-design/momentum-ui/tree/master/web-components/stargazers) - Set of UI components based on Momentum Design.
- [Nord](https://nordhealth.design) - Nordhealth’s design system for products, digital experiences and brand.
- [NuML | NUDE Elements](https://github.com/tenphi/numl) [![GitHub stars](https://img.shields.io/github/stars/tenphi/numl?style=flat)](https://github.com/tenphi/numl/stargazers) - HTML Framework and Design System based on Web Components and runtime CSS generation.
- [NVIDIA Elements](https://github.com/nvidia/elements) [![GitHub stars](https://img.shields.io/github/stars/nvidia/elements?style=flat)](https://github.com/nvidia/elements/stargazers) - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
- [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) [![GitHub stars](https://img.shields.io/github/stars/SAP/ui5-webcomponents?style=flat)](https://github.com/SAP/ui5-webcomponents/stargazers) - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
- [U-M Library Design System](https://design-system.lib.umich.edu) - University of Michigan Library Design System.
- [Zooplus web components](https://github.com/zooplus/zoo-web-components) [![GitHub stars](https://img.shields.io/github/stars/zooplus/zoo-web-components?style=flat)](https://github.com/zooplus/zoo-web-components/stargazers) - Set of web components that implement Z+ shop style guide.
...
- [DNA](https://github.com/chialab/dna) [![GitHub stars](https://img.shields.io/github/stars/chialab/dna?style=flat)](https://github.com/chialab/dna/stargazers) - Progressive Web Components library.
- [element-js](https://github.com/webtides/element-js) [![GitHub stars](https://img.shields.io/github/stars/webtides/element-js?style=flat)](https://github.com/webtides/element-js/stargazers) - Simple and lightweight base classes for web components with a beautiful API.
- [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) [![GitHub stars](https://img.shields.io/github/stars/microsoft/fast/tree/master/packages/web-components/fast-element?style=flat)](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element/stargazers) - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
- [Forge Core](https://github.com/tyler-technologies-oss/forge-core) [![GitHub stars](https://img.shields.io/github/stars/tyler-technologies-oss/forge-core?style=flat)](https://github.com/tyler-technologies-oss/forge-core/stargazers) - Building blocks and utilities that are used when building Forge Web Components.
- [Joist](https://github.com/joist-framework/joist) [![GitHub stars](https://img.shields.io/github/stars/joist-framework/joist?style=flat)](https://github.com/joist-framework/joist/stargazers) - Set of small libraries designed to add the bare minimum to web components to make you productive.
- [Lit](https://lit.dev) - Simple library for building fast, lightweight web components.
- [Lightning Web Components](https://github.com/salesforce/lwc) [![GitHub stars](https://img.shields.io/github/stars/salesforce/lwc?style=flat)](https://github.com/salesforce/lwc/stargazers) - blazing fast, enterprise-grade Web Components foundation.
- [Lume Element](https://github.com/lume/element) [![GitHub stars](https://img.shields.io/github/stars/lume/element?style=flat)](https://github.com/lume/element/stargazers) - Write custom elements with reactivity and templating powered by Solid.js signals and effects.
...
- [Tonic](https://github.com/optoolco/tonic) [![GitHub stars](https://img.shields.io/github/stars/optoolco/tonic?style=flat)](https://github.com/optoolco/tonic/stargazers) - Minimalist, stable, audit friendly component framework.
...
- [ember-custom-elements](https://github.com/Ravenstine/ember-custom-elements) [![GitHub stars](https://img.shields.io/github/stars/Ravenstine/ember-custom-elements?style=flat)](https://github.com/Ravenstine/ember-custom-elements/stargazers) - Render Ember and Glimmer components using custom elements.
- [preact-custom-element](https://github.com/preactjs/preact-custom-element) [![GitHub stars](https://img.shields.io/github/stars/preactjs/preact-custom-element?style=flat)](https://github.com/preactjs/preact-custom-element/stargazers) - Generate/register a custom element from a preact component.
- [@adobe/react-webcomponent](https://github.com/adobe/react-webcomponent) [![GitHub stars](https://img.shields.io/github/stars/adobe/react-webcomponent?style=flat)](https://github.com/adobe/react-webcomponent/stargazers) - Automate the wrapping of a React component in a custom element.
- [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) [![GitHub stars](https://img.shields.io/github/stars/GrabarzUndPartner/nuxt-custom-elements?style=flat)](https://github.com/GrabarzUndPartner/nuxt-custom-elements/stargazers) - Export your project components as custom elements for integration into external pages.
- [react-shadow](https://github.com/Wildhoney/ReactShadow) [![GitHub stars](https://img.shields.io/github/stars/Wildhoney/ReactShadow?style=flat)](https://github.com/Wildhoney/ReactShadow/stargazers) - Utilise Shadow DOM in React with all the benefits of style encapsulation.
- [reactify-wc](https://github.com/BBKolton/reactify-wc) [![GitHub stars](https://img.shields.io/github/stars/BBKolton/reactify-wc?style=flat)](https://github.com/BBKolton/reactify-wc/stargazers) - Use web components with React properties and functions.
- [remount](https://github.com/rstacruz/remount) [![GitHub stars](https://img.shields.io/github/stars/rstacruz/remount?style=flat)](https://github.com/rstacruz/remount/stargazers) - Mount React components to the DOM using custom elements.
- [@riotjs/custom-elements](https://github.com/riot/custom-elements) [![GitHub stars](https://img.shields.io/github/stars/riot/custom-elements?style=flat)](https://github.com/riot/custom-elements/stargazers) - Simple API to create vanilla custom elements with Riot.js.
...
- [AMP](https://github.com/ampproject/amphtml) [![GitHub stars](https://img.shields.io/github/stars/ampproject/amphtml?style=flat)](https://github.com/ampproject/amphtml/stargazers) - Web component framework to easily create user-first experiences for the web.
- [Enhance](https://enhance.dev/docs/) - Web standards-based HTML framework for building lightweight web applications.
- [luna-js](https://github.com/webtides/luna-js) [![GitHub stars](https://img.shields.io/github/stars/webtides/luna-js?style=flat)](https://github.com/webtides/luna-js/stargazers) - SSR framework that makes working with the WebComponents standard a breeze.
- [Rocket](https://rocket.modern-web.dev) - Modern web setup for static sites with a sprinkle of JavaScript.
- [Web Components Compiler](https://github.com/ProjectEvergreen/wcc) [![GitHub stars](https://img.shields.io/github/stars/ProjectEvergreen/wcc?style=flat)](https://github.com/ProjectEvergreen/wcc/stargazers) - Compiler to make server-side rendering of native web components easier.
- [WebC](https://github.com/11ty/webc) [![GitHub stars](https://img.shields.io/github/stars/11ty/webc?style=flat)](https://github.com/11ty/webc/stargazers) - Framework-independent standalone HTML serializer for generating markup for web components.

### Starter Kits

- [Create Open Web Components](https://open-wc.org/docs/development/generator/) - Web component project scaffolding.
- [custom-element-boilerplate](https://github.com/github/custom-element-boilerplate) [![GitHub stars](https://img.shields.io/github/stars/github/custom-element-boilerplate?style=flat)](https://github.com/github/custom-element-boilerplate/stargazers) - Boilerplate for creating a custom element.
- [hello-web-components](https://github.com/fernandopasik/hello-web-components) [![GitHub stars](https://img.shields.io/github/stars/fernandopasik/hello-web-components?style=flat)](https://github.com/fernandopasik/hello-web-components/stargazers) - Simple starter hello world web component written in TypeScript.
- [nutmeg](https://github.com/abraham/nutmeg) [![GitHub stars](https://img.shields.io/github/stars/abraham/nutmeg?style=flat)](https://github.com/abraham/nutmeg/stargazers) - Build, test, and publish vanilla Web Components with a little spice.

### Testing Solutions

- [capybara-shadowdom](https://github.com/yuki24/capybara-shadowdom) [![GitHub stars](https://img.shields.io/github/stars/yuki24/capybara-shadowdom?style=flat)](https://github.com/yuki24/capybara-shadowdom/stargazers) - Ruby gem that adds basic support for the Shadow DOM to Capybara.
...
- [cypress-lit](https://github.com/simonireilly/cypress-lit) [![GitHub stars](https://img.shields.io/github/stars/simonireilly/cypress-lit?style=flat)](https://github.com/simonireilly/cypress-lit/stargazers) - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
- [query-selector-shadow-dom](https://github.com/webdriverio/query-selector-shadow-dom) [![GitHub stars](https://img.shields.io/github/stars/webdriverio/query-selector-shadow-dom?style=flat)](https://github.com/webdriverio/query-selector-shadow-dom/stargazers) - querySelector that can pierce Shadow DOM roots, useful for automated testing.
- [shadow-automation-selenium](https://github.com/sukgu/shadow-automation-selenium) [![GitHub stars](https://img.shields.io/github/stars/sukgu/shadow-automation-selenium?style=flat)](https://github.com/sukgu/shadow-automation-selenium/stargazers) - Shadow DOM automation using Selenium.
...
- [Custom Elements Locator](https://github.com/open-wc/locator) [![GitHub stars](https://img.shields.io/github/stars/open-wc/locator?style=flat)](https://github.com/open-wc/locator/stargazers) - Chrome extension to find custom elements on a page.
...
- [web-component-analyzer](https://github.com/runem/web-component-analyzer) [![GitHub stars](https://img.shields.io/github/stars/runem/web-component-analyzer?style=flat)](https://github.com/runem/web-component-analyzer/stargazers) - CLI that analyzes web components and emits documentation / diagnostics.
- [Web Components Codemods](https://github.com/kcmr/web-components-codemods) [![GitHub stars](https://img.shields.io/github/stars/kcmr/web-components-codemods?style=flat)](https://github.com/kcmr/web-components-codemods/stargazers) - Codemods for Web Components.
...
- [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) [![GitHub stars](https://img.shields.io/github/stars/web-platform-tests/wpt/tree/master/custom-elements/form-associated?style=flat)](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated/stargazers)

### Constructable Stylesheet Objects

- [Specification Draft](https://wicg.github.io/construct-stylesheets/)
- [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) [![GitHub stars](https://img.shields.io/github/stars/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html?style=flat)](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html/stargazers)
- [Explainer](https://github.com/WICG/construct-stylesheets/blob/gh-pages/explainer.md) [![GitHub stars](https://img.shields.io/github/stars/WICG/construct-stylesheets/blob/gh-pages/explainer.md?style=flat)](https://github.com/WICG/construct-stylesheets/blob/gh-pages/explainer.md/stargazers)
...
- [`ElementInternals`'s `states` property and the `:state()` pseudo class](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md) [![GitHub stars](https://img.shields.io/github/stars/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md?style=flat)](https://github.com/w3c/webcomponents/blob/gh-pages/proposals/custom-states-and-state-pseudo-class.md/stargazers)

## Miscellaneous

- [bruck](https://github.com/Heydon/bruck) [![GitHub stars](https://img.shields.io/github/stars/Heydon/bruck?style=flat)](https://github.com/Heydon/bruck/stargazers) - Prototyping system built with web components and the Houdini Paint API.
...
- [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) [![GitHub stars](https://img.shields.io/github/stars/webcomponents/polyfills/tree/master/packages/custom-elements?style=flat)](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements/stargazers) - Custom Elements polyfill by Polymer team.
- [document-register-element](https://github.com/WebReflection/document-register-element) [![GitHub stars](https://img.shields.io/github/stars/WebReflection/document-register-element?style=flat)](https://github.com/WebReflection/document-register-element/stargazers) - Custom Elements polyfill by Andrea Giammarchi.

#### Customized Built-in Elements polyfills

- [@corpuscule/custom-builtin-elements](https://github.com/corpusculejs/custom-builtin-elements) [![GitHub stars](https://img.shields.io/github/stars/corpusculejs/custom-builtin-elements?style=flat)](https://github.com/corpusculejs/custom-builtin-elements/stargazers) - Customized built-in elements polyfill by [CorpusculeJS](https://github.com/corpusculejs) [![GitHub stars](https://img.shields.io/github/stars/corpusculejs?style=flat)](https://github.com/corpusculejs/stargazers).
- [@ungap/custom-elements-builtin](https://github.com/ungap/custom-elements-builtin) [![GitHub stars](https://img.shields.io/github/stars/ungap/custom-elements-builtin?style=flat)](https://github.com/ungap/custom-elements-builtin/stargazers) - Customized built-in elements polyfill by [ungap project](https://ungap.github.io).

#### Shadow DOM shims

- [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) [![GitHub stars](https://img.shields.io/github/stars/webcomponents/polyfills/tree/master/packages/shadydom?style=flat)](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom/stargazers) - ShadowDOM v1 shim.
- [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) [![GitHub stars](https://img.shields.io/github/stars/webcomponents/polyfills/tree/master/packages/shadycss?style=flat)](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss/stargazers) - ShadowDOM style encapsulation shim.
- [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) [![GitHub stars](https://img.shields.io/github/stars/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow?style=flat)](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow/stargazers) - Shadow DOM polyfill by [LWC](https://lwc.dev).

#### HTML Templates polyfills

- [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) [![GitHub stars](https://img.shields.io/github/stars/webcomponents/polyfills/tree/master/packages/template?style=flat)](https://github.com/webcomponents/polyfills/tree/master/packages/template/stargazers) - Minimal polyfill for `<template>`.
- [@ungap/import-node](https://github.com/ungap/import-node) [![GitHub stars](https://img.shields.io/github/stars/ungap/import-node?style=flat)](https://github.com/ungap/import-node/stargazers) - An `importNode` polyfill for IE11 by [ungap project](https://ungap.github.io).
...
- [HTML as Custom Elements](https://github.com/domenic/html-as-custom-elements) [![GitHub stars](https://img.shields.io/github/stars/domenic/html-as-custom-elements?style=flat)](https://github.com/domenic/html-as-custom-elements/stargazers)
...
- Created by [@mateusortiz](https://github.com/mateusortiz) [![GitHub stars](https://img.shields.io/github/stars/mateusortiz?style=flat)](https://github.com/mateusortiz/stargazers) in 2014.
- Maintained by [@web-padawan](https://github.com/web-padawan) [![GitHub stars](https://img.shields.io/github/stars/web-padawan?style=flat)](https://github.com/web-padawan/stargazers) since 2018.
