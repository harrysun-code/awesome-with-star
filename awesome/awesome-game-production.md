...
> 来源：[vhladiienko/awesome-game-production](https://github.com/vhladiienko/awesome-game-production)

[![GitHub stars](https://img.shields.io/github/stars/vhladiienko/awesome-game-production?style=flat)](https://github.com/vhladiienko/awesome-game-production/stargazers)
...
This list does not cover specific disciplines like game design, quality assurance, programming. Refer to the [Gaming section](https://github.com/sindresorhus/awesome#gaming) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers) of the "master" awesome list for other gamedev stuff.

Majority of the provided resources are in English, but I might include items in other languages too, if you help me by [creating a pull request](https://github.com/vhladiienko/awesome-game-production/blob/main/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/vhladiienko/awesome-game-production/blob/main/contributing.md?style=flat)](https://github.com/vhladiienko/awesome-game-production/blob/main/contributing.md/stargazers). Look for a flag next to the link.
...
- [Excalidraw](https://excalidraw.com/) - A free and [open source](https://github.com/excalidraw/excalidraw) [![GitHub stars](https://img.shields.io/github/stars/excalidraw/excalidraw?style=flat)](https://github.com/excalidraw/excalidraw/stargazers) online drawing tool. Neither gamedev or project management related, but is so versatile, I find myself using it quite often.
