...
Want to add something? Just make a pull request, but be sure to follow the [contributing guidelines](./contributing.md)! Question? Ask it in the [General Discussion issue](https://github.com/stingalleman/awesome-audiovisual/issues/2) [![GitHub stars](https://img.shields.io/github/stars/stingalleman/awesome-audiovisual/issues/2?style=flat)](https://github.com/stingalleman/awesome-audiovisual/issues/2/stargazers).
...
- [QLC+](https://www.qlcplus.org/) - QLC+ is a free and cross-platform software to control DMX or analog lighting systems like moving heads, dimmers, scanners etc. [Source Code](https://github.com/mcallegari/qlcplus) [![GitHub stars](https://img.shields.io/github/stars/mcallegari/qlcplus?style=flat)](https://github.com/mcallegari/qlcplus/stargazers) `✓ open-source`.
- [xLights](https://xlights.org/) - Meant for home Christmas light shows but is a great way to sync lights to music on a budget. [Source Code](https://github.com/smeighan/xLights) [![GitHub stars](https://img.shields.io/github/stars/smeighan/xLights?style=flat)](https://github.com/smeighan/xLights/stargazers) `✓ open-source`.
...
- [Ardour](https://ardour.org/) - A full realtime audio recording and editing suite. [Source Code](https://github.com/Ardour/ardour) [![GitHub stars](https://img.shields.io/github/stars/Ardour/ardour?style=flat)](https://github.com/Ardour/ardour/stargazers) `✓ open-source`.
...
- [Linux Show Player](https://www.linux-show-player.org/) - Free cue player designed for stage productions. [Source Code](https://github.com/FrancescoCeruti/linux-show-player) [![GitHub stars](https://img.shields.io/github/stars/FrancescoCeruti/linux-show-player?style=flat)](https://github.com/FrancescoCeruti/linux-show-player/stargazers) `✓ open-source`.
...
- [Livescript](https://github.com/Netlob/livescript) [![GitHub stars](https://img.shields.io/github/stars/Netlob/livescript?style=flat)](https://github.com/Netlob/livescript/stargazers) - Insert a musical/theatre-script from Google Docs and use this for a live "autocue" and scroller with everyone on the site. `✓ open-source`.
- [Ontime](https://github.com/cpvalente/ontime) [![GitHub stars](https://img.shields.io/github/stars/cpvalente/ontime?style=flat)](https://github.com/cpvalente/ontime/stargazers) - Browser-based application that manages event rundowns, scheduling, and cueing. Plan, track your schedule, manage automation and cross-department show information in one place. `✓ open-source`.
...
- [TCgenerator](https://github.com/dimitriCGNL/TCGenerator) [![GitHub stars](https://img.shields.io/github/stars/dimitriCGNL/TCGenerator?style=flat)](https://github.com/dimitriCGNL/TCGenerator/stargazers) - Reaper time marker to GrandMA2 TC Generator. `✓ open-source`.
- [Timecode](https://github.com/MrExplode/Timecode) [![GitHub stars](https://img.shields.io/github/stars/MrExplode/Timecode?style=flat)](https://github.com/MrExplode/Timecode/stargazers) - ArtNet and LTC timecode generator, made with Java. `✓ open-source`.
- [Time MIDI sender](https://github.com/TheGreyDiamond/Time-MIDI-sender) [![GitHub stars](https://img.shields.io/github/stars/TheGreyDiamond/Time-MIDI-sender?style=flat)](https://github.com/TheGreyDiamond/Time-MIDI-sender/stargazers) - A free tool for sending time data to DasLight (via MIDI). `✓ open-source`.
- [TimelordMTC](https://timelord-mtc.com/) - Advanced timecode management tool. `⚠ not free`.
- [M2Q](https://github.com/lorenzofattori/M2Q) [![GitHub stars](https://img.shields.io/github/stars/lorenzofattori/M2Q?style=flat)](https://github.com/lorenzofattori/M2Q/stargazers) - Python application capable to trigger Chamsys Consoles/Software via MIDI for advanced synchronized shows. `✓ open-source`.

### Monitoring

- [AES67 WebMeter](https://github.com/zjstraus/AES67-WebMeter) [![GitHub stars](https://img.shields.io/github/stars/zjstraus/AES67-WebMeter?style=flat)](https://github.com/zjstraus/AES67-WebMeter/stargazers) - Server that receives an AES67 audio stream and presents a webpage with meters. `✓ open-source`.
- [meters.lv2](https://github.com/x42/meters.lv2) [![GitHub stars](https://img.shields.io/github/stars/x42/meters.lv2?style=flat)](https://github.com/x42/meters.lv2/stargazers) - meters.lv2 is a collection of audio-level meters with GUI in LV2 plugin format. `✓ open-source`.
...
- [Open Lighting Architecture](https://www.openlighting.org/ola/) - A framework for lighting control information. Supports a range of protocols and over a dozen of USB devices. [Source Code](https://github.com/OpenLightingProject/ola) [![GitHub stars](https://img.shields.io/github/stars/OpenLightingProject/ola?style=flat)](https://github.com/OpenLightingProject/ola/stargazers)
- [node-dmx](https://github.com/node-dmx/dmx) [![GitHub stars](https://img.shields.io/github/stars/node-dmx/dmx?style=flat)](https://github.com/node-dmx/dmx/stargazers) - DMX controller library for Node.js. `nodejs` `✓ open-source`.

### ArtNet Libraries

- [artnet](https://github.com/hobbyquaker/artnet) [![GitHub stars](https://img.shields.io/github/stars/hobbyquaker/artnet?style=flat)](https://github.com/hobbyquaker/artnet/stargazers) - Node.js module that can be used to send ArtDMX packages to an Art-Net node. `nodejs`.
- [artnet4j](https://github.com/cansik/artnet4j) [![GitHub stars](https://img.shields.io/github/stars/cansik/artnet4j?style=flat)](https://github.com/cansik/artnet4j/stargazers) - Art-Net library for Java and Processing. `java`.
...
- [awesome-linuxaudio](https://github.com/nodiscc/awesome-linuxaudio) [![GitHub stars](https://img.shields.io/github/stars/nodiscc/awesome-linuxaudio?style=flat)](https://github.com/nodiscc/awesome-linuxaudio/stargazers) - A Awesome list with all things Linux audio.
...
- [Blender ArtNet](https://github.com/BryanCrotaz/blender-artnet) [![GitHub stars](https://img.shields.io/github/stars/BryanCrotaz/blender-artnet?style=flat)](https://github.com/BryanCrotaz/blender-artnet/stargazers) - Blender script to push ArtNet data to Evee lights. Runs at 30fps with Evee rendering in the viewport. `✓ open-source`.
...
- [MIDI Monster](https://github.com/cbdevnet/midimonster/) [![GitHub stars](https://img.shields.io/github/stars/cbdevnet/midimonster/?style=flat)](https://github.com/cbdevnet/midimonster//stargazers) - MIDIMonster is a universal control and translation tool. It can translate between many different protocols such as MIDI, Artnet, sACN and OSC. `✓ open-source`.
