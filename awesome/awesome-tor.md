...
# [![awesome-tor-logo](https://github.com/Polycarbohydrate/awesome-tor/assets/169401794/d8c7415e-1874-49f5-a1c6-04b3a8aa689f) [![GitHub stars](https://img.shields.io/github/stars/Polycarbohydrate/awesome-tor/assets/169401794/d8c7415e-1874-49f5-a1c6-04b3a8aa689f?style=flat)](https://github.com/Polycarbohydrate/awesome-tor/assets/169401794/d8c7415e-1874-49f5-a1c6-04b3a8aa689f/stargazers)](https://www.torproject.org)
...
### Other applications
- [ansible-relayor](https://github.com/nusenu/ansible-relayor) [![GitHub stars](https://img.shields.io/github/stars/nusenu/ansible-relayor?style=flat)](https://github.com/nusenu/ansible-relayor/stargazers) - This is an ansible role for tor relay operators.
- [bine](https://github.com/cretz/bine) [![GitHub stars](https://img.shields.io/github/stars/cretz/bine?style=flat)](https://github.com/cretz/bine/stargazers) - Go library for accessing and embedding Tor clients and servers.
...
- [dnscrypt-proxy](https://github.com/DNSCrypt/dnscrypt-proxy) [![GitHub stars](https://img.shields.io/github/stars/DNSCrypt/dnscrypt-proxy?style=flat)](https://github.com/DNSCrypt/dnscrypt-proxy/stargazers) - A flexible DNS proxy, with support for encrypted DNS protocols.
- [dos-over-tor](https://github.com/skizap/dos-over-tor) [![GitHub stars](https://img.shields.io/github/stars/skizap/dos-over-tor?style=flat)](https://github.com/skizap/dos-over-tor/stargazers) - Proof of concept denial of service over Tor stress test tool. 
...
- [eotk](https://github.com/alecmuffett/eotk) [![GitHub stars](https://img.shields.io/github/stars/alecmuffett/eotk?style=flat)](https://github.com/alecmuffett/eotk/stargazers) - Tool for deploying HTTP/Onion sites to provide official, onion-networking for popular websites.
- [exitmap](https://www.cs.kau.se/philwint/spoiled_onions/) - Scanner for Tor to detect bad exits (spoiled onions).
- [haskell-tor](https://github.com/GaloisInc/haskell-tor) [![GitHub stars](https://img.shields.io/github/stars/GaloisInc/haskell-tor?style=flat)](https://github.com/GaloisInc/haskell-tor/stargazers) - A Haskell implementation of the Tor protocol.
- [HTTPS Everywhere](https://www.eff.org/https-everywhere) - Only allows the browser to connect using HTTPS, built-in Tor.
- [kalitorify](https://github.com/brainfucksec/kalitorify) [![GitHub stars](https://img.shields.io/github/stars/brainfucksec/kalitorify?style=flat)](https://github.com/brainfucksec/kalitorify/stargazers) - Shell script to create a transparent proxy through Tor for Kali Linux OS.
- [Tor Metrics](https://metrics.torproject.org/) - Adjustable graphs to visualize the statistics of Tor.
- [multitor](https://github.com/trimstray/multitor) [![GitHub stars](https://img.shields.io/github/stars/trimstray/multitor?style=flat)](https://github.com/trimstray/multitor/stargazers) - Create multiple Tor instances with load balancing.
- [mini-tor](https://github.com/wbenny/mini-tor) [![GitHub stars](https://img.shields.io/github/stars/wbenny/mini-tor?style=flat)](https://github.com/wbenny/mini-tor/stargazers) - Smallest application size while accessing internet content and hidden service content.
- [node-Tor](https://github.com/Ayms/node-Tor) [![GitHub stars](https://img.shields.io/github/stars/Ayms/node-Tor?style=flat)](https://github.com/Ayms/node-Tor/stargazers) - JavaScript open-source implementation of the Tor protocol on the server side and browsers.
- [nyx](https://nyx.torproject.org/) - CLI interface which includes detailed real-time information about your relay.
- [offensive-tor-toolkit](https://github.com/atorrescogollo/offensive-tor-toolkit) [![GitHub stars](https://img.shields.io/github/stars/atorrescogollo/offensive-tor-toolkit?style=flat)](https://github.com/atorrescogollo/offensive-tor-toolkit/stargazers) - Bind/Reverse Shells, SOCKS, etc over Tor in Go.
- [onion-grater](https://github.com/Whonix/onion-grater) [![GitHub stars](https://img.shields.io/github/stars/Whonix/onion-grater?style=flat)](https://github.com/Whonix/onion-grater/stargazers) - Whitelisting filter for dangerous Tor control protocol commands.
...
- [php-torcontrol](https://github.com/dunglas/php-torcontrol) [![GitHub stars](https://img.shields.io/github/stars/dunglas/php-torcontrol?style=flat)](https://github.com/dunglas/php-torcontrol/stargazers) - TorControl is a PHP library to control a Tor server.
...
- [rotating-proxy](https://github.com/mattes/rotating-proxy) [![GitHub stars](https://img.shields.io/github/stars/mattes/rotating-proxy?style=flat)](https://github.com/mattes/rotating-proxy/stargazers) - Rotating Tor proxy with Docker.
...
- [Stormy](https://github.com/glamrock/stormy) [![GitHub stars](https://img.shields.io/github/stars/glamrock/stormy?style=flat)](https://github.com/glamrock/stormy/stargazers) - Stormy is a wizard that helps people create Tor Onion Services with just a few clicks.
- [setup-tor](https://github.com/tor-actions/setup-tor) [![GitHub stars](https://img.shields.io/github/stars/tor-actions/setup-tor?style=flat)](https://github.com/tor-actions/setup-tor/stargazers) - Set up your GitHub Actions workflow with a specific version of Tor.
...
- [Tallow](https://github.com/basil00/TorWall) [![GitHub stars](https://img.shields.io/github/stars/basil00/TorWall?style=flat)](https://github.com/basil00/TorWall/stargazers) - A program that redirects all outbound traffic from a Windows machine via the Tor anonymity network.
- [tor_box](https://github.com/CMoncur/tor_box) [![GitHub stars](https://img.shields.io/github/stars/CMoncur/tor_box?style=flat)](https://github.com/CMoncur/tor_box/stargazers) - An all-inclusive Tor configuration for Raspberry Pi, that serves as a relay and personal Tor network.
- [Tor_Onion_Proxy](https://github.com/thaliproject/Tor_Onion_Proxy_Library) [![GitHub stars](https://img.shields.io/github/stars/thaliproject/Tor_Onion_Proxy_Library?style=flat)](https://github.com/thaliproject/Tor_Onion_Proxy_Library/stargazers) - Provides a .JAR and an .AAR file for embedding Tor into a Java or Android Program.
...
- [tor-browser-selenium](https://github.com/webfp/tor-browser-selenium) [![GitHub stars](https://img.shields.io/github/stars/webfp/tor-browser-selenium?style=flat)](https://github.com/webfp/tor-browser-selenium/stargazers) - A Python library to automate Tor Browser with Selenium WebDriver.
- [tor-controller](https://github.com/kragniz/tor-controller) [![GitHub stars](https://img.shields.io/github/stars/kragniz/tor-controller?style=flat)](https://github.com/kragniz/tor-controller/stargazers) - Run Tor Onion Services on Kubernetes.
- [tor-hidden-service](https://hub.docker.com/r/goldy/tor-hidden-service) - Docker container made for Onion Services in v2 or v3.
- [tor-relay-bootstrap](https://github.com/coldhakca/tor-relay-bootstrap) [![GitHub stars](https://img.shields.io/github/stars/coldhakca/tor-relay-bootstrap?style=flat)](https://github.com/coldhakca/tor-relay-bootstrap/stargazers) - Script to bootstrap a Debian server to be a set-and-forget Tor relay.
- [Tor.framework](https://github.com/iCepa/Tor.framework) [![GitHub stars](https://img.shields.io/github/stars/iCepa/Tor.framework?style=flat)](https://github.com/iCepa/Tor.framework/stargazers) - Tor.framework is the easiest way to embed Tor in your iOS application.
- [tor.rb](https://github.com/dryruby/tor.rb) [![GitHub stars](https://img.shields.io/github/stars/dryruby/tor.rb?style=flat)](https://github.com/dryruby/tor.rb/stargazers) - This is a Ruby library for interacting with the Tor anonymity network.
- [Tor2web](https://github.com/tor2web/Tor2web) [![GitHub stars](https://img.shields.io/github/stars/tor2web/Tor2web?style=flat)](https://github.com/tor2web/Tor2web/stargazers) - HTTP proxy software that enables access to Tor Hidden Services through common web browsers.
- [TorBot](https://github.com/DedSecInside/TorBot) [![GitHub stars](https://img.shields.io/github/stars/DedSecInside/TorBot?style=flat)](https://github.com/DedSecInside/TorBot/stargazers) - Onion site crawler for data collection.
- [TorChat-Mac](https://github.com/javerous/TorChat-Mac) [![GitHub stars](https://img.shields.io/github/stars/javerous/TorChat-Mac?style=flat)](https://github.com/javerous/TorChat-Mac/stargazers) - macOS native TorChat client.
- [TorChat](https://github.com/prof7bit/TorChat) [![GitHub stars](https://img.shields.io/github/stars/prof7bit/TorChat?style=flat)](https://github.com/prof7bit/TorChat/stargazers) - Decentralized anonymous instant messenger on top of Tor Hidden Services.
- [TorCheck](https://check.torproject.org/) - Determines if a visitor is using Tor or not.
- [torDDoS](https://github.com/r3nt0n/torDDoS) [![GitHub stars](https://img.shields.io/github/stars/r3nt0n/torDDoS?style=flat)](https://github.com/r3nt0n/torDDoS/stargazers) - TorDDos is a Python tool to automatize DDoS attacks on a website from the Tor network.
- [toriptabkes2](https://github.com/ruped24/toriptables2) [![GitHub stars](https://img.shields.io/github/stars/ruped24/toriptables2?style=flat)](https://github.com/ruped24/toriptables2/stargazers) - An anonymizer that sets up iptables and Tor to route all traffic through the Tor network.
- [torps](https://github.com/torps/torps) [![GitHub stars](https://img.shields.io/github/stars/torps/torps?style=flat)](https://github.com/torps/torps/stargazers) - The Tor Path Simulator (TorPS) is a tool for efficiently simulating path selection in Tor.
...
- [tun2tor](https://github.com/iCepa/tun2tor) [![GitHub stars](https://img.shields.io/github/stars/iCepa/tun2tor?style=flat)](https://github.com/iCepa/tun2tor/stargazers) - Rust library that creates a utun (userspace tunnel) interface, and connects it to a stream-based proxy.
...
- [Vanguards](https://github.com/mikeperry-tor/vanguards) [![GitHub stars](https://img.shields.io/github/stars/mikeperry-tor/vanguards?style=flat)](https://github.com/mikeperry-tor/vanguards/stargazers) - This addon protects against guard discovery and related traffic analysis attacks.
...
- [ScrambleSuit](https://github.com/NullHypothesis/scramblesuit) [![GitHub stars](https://img.shields.io/github/stars/NullHypothesis/scramblesuit?style=flat)](https://github.com/NullHypothesis/scramblesuit/stargazers) - Outdated and deprecated bridge type. A pluggable transport protocol for obfsproxy. It is written in pure Python.
...
## Bypass Censorship
- [Firefly](https://github.com/yinghuocho/firefly-proxy) [![GitHub stars](https://img.shields.io/github/stars/yinghuocho/firefly-proxy?style=flat)](https://github.com/yinghuocho/firefly-proxy/stargazers) - A proxy software to help circumvent the Great Firewall.
- [FWlite](https://github.com/v3aqb/fwlite) [![GitHub stars](https://img.shields.io/github/stars/v3aqb/fwlite?style=flat)](https://github.com/v3aqb/fwlite/stargazers) - An anti-censorship HTTP proxy with built-in shadowsocks support.
...
- [Lantern](https://github.com/getlantern/lantern) [![GitHub stars](https://img.shields.io/github/stars/getlantern/lantern?style=flat)](https://github.com/getlantern/lantern/stargazers) - Censorship circumvention tool available for free download on any operating system.
- [MTProxy](https://github.com/TelegramMessenger/MTProxy) [![GitHub stars](https://img.shields.io/github/stars/TelegramMessenger/MTProxy?style=flat)](https://github.com/TelegramMessenger/MTProxy/stargazers) - Allows users in censored areas to connect to Telegram.
- [NaïveProxy](https://github.com/klzgrad/naiveproxy) [![GitHub stars](https://img.shields.io/github/stars/klzgrad/naiveproxy?style=flat)](https://github.com/klzgrad/naiveproxy/stargazers) - NaïveProxy uses Chromium's network stack to camouflage traffic with strong censorship resistance and low detectability.
- [nodeunblocker](https://github.com/nfriedly/nodeunblocker.com) [![GitHub stars](https://img.shields.io/github/stars/nfriedly/nodeunblocker.com?style=flat)](https://github.com/nfriedly/nodeunblocker.com/stargazers) - Host your copy of nodeunblocker.com using Node.js to bypass censorship on the internet.
...
- [Runet Censorship Bypass](https://github.com/anticensority/runet-censorship-bypass) [![GitHub stars](https://img.shields.io/github/stars/anticensority/runet-censorship-bypass?style=flat)](https://github.com/anticensority/runet-censorship-bypass/stargazers) - A browser extension for Chromium and Firefox that helps to bypass censorship in Russia.
- [StegoTorus](https://github.com/SRI-CSL/stegotorus) [![GitHub stars](https://img.shields.io/github/stars/SRI-CSL/stegotorus?style=flat)](https://github.com/SRI-CSL/stegotorus/stargazers) - A Camouflage Proxy for the Tor Anonymity System.
- [trojan](https://github.com/trojan-gfw/trojan) [![GitHub stars](https://img.shields.io/github/stars/trojan-gfw/trojan?style=flat)](https://github.com/trojan-gfw/trojan/stargazers) - An unidentifiable mechanism that helps you bypass GFW.
