...
- [The Solcurity Standard](https://github.com/Rari-Capital/solcurity) [![GitHub stars](https://img.shields.io/github/stars/Rari-Capital/solcurity?style=flat)](https://github.com/Rari-Capital/solcurity/stargazers) - Opinionated security and code quality standard for Solidity smart contracts.
...
- [KEVM](https://github.com/kframework/evm-semantics) [![GitHub stars](https://img.shields.io/github/stars/kframework/evm-semantics?style=flat)](https://github.com/kframework/evm-semantics/stargazers) - A formal model of the EVM in the K framework.
...
- [List of Security Vulnerabilities](https://github.com/runtimeverification/verified-smart-contracts/wiki/List-of-Security-Vulnerabilities) [![GitHub stars](https://img.shields.io/github/stars/runtimeverification/verified-smart-contracts/wiki/List-of-Security-Vulnerabilities?style=flat)](https://github.com/runtimeverification/verified-smart-contracts/wiki/List-of-Security-Vulnerabilities/stargazers) - A comprehensive list of common smart contract security vulnerabilities, compiled from various sources.
...
## Controls
- [Simple Security Toolkit](https://github.com/nascentxyz/simple-security-toolkit) [![GitHub stars](https://img.shields.io/github/stars/nascentxyz/simple-security-toolkit?style=flat)](https://github.com/nascentxyz/simple-security-toolkit/stargazers) - Opinionated recommendations that the team at Nascent find to be appropriate,  particularly for teams developing and managing early versions of a protocol.
...
- [Building Secure Contracts](https://github.com/crytic/building-secure-contracts/) [![GitHub stars](https://img.shields.io/github/stars/crytic/building-secure-contracts/?style=flat)](https://github.com/crytic/building-secure-contracts//stargazers) - Trail of Bits' guidelines and best practices on how to write secure smart contracts.
...
- [Smart Contract Security Registry](https://github.com/ethereum-lists/contracts) [![GitHub stars](https://img.shields.io/github/stars/ethereum-lists/contracts?style=flat)](https://github.com/ethereum-lists/contracts/stargazers) - An effort to identify deployed contracts instances given their chain and address, by listing the project they belong to.
...
- [Awesome BlockSec CTF](https://github.com/0xjeffsec/awesome-blocksec-ctf) [![GitHub stars](https://img.shields.io/github/stars/0xjeffsec/awesome-blocksec-ctf?style=flat)](https://github.com/0xjeffsec/awesome-blocksec-ctf/stargazers) - Blockchain security Capture the Flag (CTF) competitions.
- [Awesome Buggy ERC20 Tokens](https://github.com/sec-bit/awesome-buggy-erc20-tokens) [![GitHub stars](https://img.shields.io/github/stars/sec-bit/awesome-buggy-erc20-tokens?style=flat)](https://github.com/sec-bit/awesome-buggy-erc20-tokens/stargazers) - Vulnerabilities in ERC20 Smart Contracts With Tokens Affected.
- [Awesome Cryptoeconomics](https://github.com/jpantunes/awesome-cryptoeconomics) [![GitHub stars](https://img.shields.io/github/stars/jpantunes/awesome-cryptoeconomics?style=flat)](https://github.com/jpantunes/awesome-cryptoeconomics/stargazers) - Cryptoeconomic research and learning materials.
- [Awesome Zero-Knowledge Proofs (ZKP)](https://github.com/matter-labs/awesome-zero-knowledge-proofs) [![GitHub stars](https://img.shields.io/github/stars/matter-labs/awesome-zero-knowledge-proofs?style=flat)](https://github.com/matter-labs/awesome-zero-knowledge-proofs/stargazers) - A curated list of awesome things related to learning Zero-Knowledge Proofs (ZKP).
- [Officer CIA's Ultimate DeFi Research Base](https://github.com/OffcierCia/ultimate-defi-research-base) [![GitHub stars](https://img.shields.io/github/stars/OffcierCia/ultimate-defi-research-base?style=flat)](https://github.com/OffcierCia/ultimate-defi-research-base/stargazers) - Curated DeFI & Blockchain research papers and tools.
- [Awesome MEV resources](https://github.com/0xalpharush/awesome-MEV-resources) [![GitHub stars](https://img.shields.io/github/stars/0xalpharush/awesome-MEV-resources?style=flat)](https://github.com/0xalpharush/awesome-MEV-resources/stargazers)
