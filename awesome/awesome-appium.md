...
> 来源：[SrinivasanTarget/awesome-appium](https://github.com/SrinivasanTarget/awesome-appium)

[![GitHub stars](https://img.shields.io/github/stars/SrinivasanTarget/awesome-appium?style=flat)](https://github.com/SrinivasanTarget/awesome-appium/stargazers)
...
## Server
- [Appium](https://github.com/appium/appium/blob/master/docs/en/about-appium/intro.md) [![GitHub stars](https://img.shields.io/github/stars/appium/appium/blob/master/docs/en/about-appium/intro.md?style=flat)](https://github.com/appium/appium/blob/master/docs/en/about-appium/intro.md/stargazers) - Appium is an open source, cross-platform test automation tool for native, hybrid and mobile web and desktop apps, tested on simulators (iOS), emulators (Android), and real devices (iOS, Android, Windows, Mac).

## Clients
- [Ruby](https://github.com/appium/ruby_lib) [![GitHub stars](https://img.shields.io/github/stars/appium/ruby_lib?style=flat)](https://github.com/appium/ruby_lib/stargazers)
- [Python](https://github.com/appium/python-client) [![GitHub stars](https://img.shields.io/github/stars/appium/python-client?style=flat)](https://github.com/appium/python-client/stargazers)
- [Java](https://github.com/appium/java-client) [![GitHub stars](https://img.shields.io/github/stars/appium/java-client?style=flat)](https://github.com/appium/java-client/stargazers)
- [JavaScript](http://webdriver.io/)
- [Objective C](https://github.com/appium/selenium-objective-c) [![GitHub stars](https://img.shields.io/github/stars/appium/selenium-objective-c?style=flat)](https://github.com/appium/selenium-objective-c/stargazers)
- [PHP](https://github.com/appium/php-client) [![GitHub stars](https://img.shields.io/github/stars/appium/php-client?style=flat)](https://github.com/appium/php-client/stargazers)
- [C# (.NET)](https://github.com/appium/appium-dotnet-driver) [![GitHub stars](https://img.shields.io/github/stars/appium/appium-dotnet-driver?style=flat)](https://github.com/appium/appium-dotnet-driver/stargazers)
- [RobotFramework](https://github.com/jollychang/robotframework-appiumlibrary) [![GitHub stars](https://img.shields.io/github/stars/jollychang/robotframework-appiumlibrary?style=flat)](https://github.com/jollychang/robotframework-appiumlibrary/stargazers)

## Inspectors
- [Appium Desktop](https://github.com/appium/appium-desktop) [![GitHub stars](https://img.shields.io/github/stars/appium/appium-desktop?style=flat)](https://github.com/appium/appium-desktop/stargazers) - Appium Server and Inspector in Desktop GUIs for Mac, Windows, and Linux.
- [WebDriverAgent Inspector](https://github.com/facebook/WebDriverAgent/wiki/Starting-WebDriverAgent) [![GitHub stars](https://img.shields.io/github/stars/facebook/WebDriverAgent/wiki/Starting-WebDriverAgent?style=flat)](https://github.com/facebook/WebDriverAgent/wiki/Starting-WebDriverAgent/stargazers) - A WebDriver server for iOS that runs inside the Simulator.
- [Selendroid Inspector](http://selendroid.io/inspector.html) - The web app which is embedded inside your selendroid test server.
- [Appium iOS Inspector](https://github.com/mykola-mokhnach/Appium-iOS-Inspector) [![GitHub stars](https://img.shields.io/github/stars/mykola-mokhnach/Appium-iOS-Inspector?style=flat)](https://github.com/mykola-mokhnach/Appium-iOS-Inspector/stargazers) - The tool for iOS elements location based on the original source of Selendroid Inspector.
- [app-inspector](https://github.com/macacajs/app-inspector) [![GitHub stars](https://img.shields.io/github/stars/macacajs/app-inspector?style=flat)](https://github.com/macacajs/app-inspector/stargazers) - Macacajs App Inspector.
...
## Workshops
- [Appium Workshop Selnium Conf 2016](https://github.com/isonic1/appium-workshop) [![GitHub stars](https://img.shields.io/github/stars/isonic1/appium-workshop?style=flat)](https://github.com/isonic1/appium-workshop/stargazers) - Repo for Appium Workshop at the 2016 Selenium Conference - Justin Ison.

## Cloud and Docker Solutions
- [Appium Tests in AWS Device Farm](https://github.com/awslabs/aws-device-farm-appium-tests-for-sample-app) [![GitHub stars](https://img.shields.io/github/stars/awslabs/aws-device-farm-appium-tests-for-sample-app?style=flat)](https://github.com/awslabs/aws-device-farm-appium-tests-for-sample-app/stargazers) - Sample Appium tests runs on AWS Device Farm.
- [Appium Tests in OpenSTF Device Farm](https://github.com/openstf/stf-appium-example) [![GitHub stars](https://img.shields.io/github/stars/openstf/stf-appium-example?style=flat)](https://github.com/openstf/stf-appium-example/stargazers) - Sample Appium tests runs on STF Device Farm.
- [Official Appium Docker Images](https://github.com/appium/appium-docker-android) [![GitHub stars](https://img.shields.io/github/stars/appium/appium-docker-android?style=flat)](https://github.com/appium/appium-docker-android/stargazers) - DockerFile for Appium Android Real Devices.
- [Appium Docker Images](https://github.com/butomo1989/docker-android) [![GitHub stars](https://img.shields.io/github/stars/butomo1989/docker-android?style=flat)](https://github.com/butomo1989/docker-android/stargazers) - DockerFile for Appium Android.
- [Appium Docker File](https://github.com/aluedeke/appium-android) [![GitHub stars](https://img.shields.io/github/stars/aluedeke/appium-android?style=flat)](https://github.com/aluedeke/appium-android/stargazers) - DockerFile for Appium Android.
- [Appium Docker File](https://github.com/softsam/docker-appium) [![GitHub stars](https://img.shields.io/github/stars/softsam/docker-appium?style=flat)](https://github.com/softsam/docker-appium/stargazers) - DockerFile for Appium Android.
...
## Test Frameworks 
- [Appium Cucumber Test](https://github.com/priyankshah217/AppiumCucumberTest) [![GitHub stars](https://img.shields.io/github/stars/priyankshah217/AppiumCucumberTest?style=flat)](https://github.com/priyankshah217/AppiumCucumberTest/stargazers) - Sample Appium Cucumber Project.
- [Appium-Native-Crawler](https://github.com/isonic1/Appium-Native-Crawler) [![GitHub stars](https://img.shields.io/github/stars/isonic1/Appium-Native-Crawler?style=flat)](https://github.com/isonic1/Appium-Native-Crawler/stargazers) - Appium Native Crawler CLI - Features include: Screenshots, Performance, Accessibility Detection, Google Translate, Applitools, Monkey Tester.
- [coteafs-appium](https://github.com/WasiqB/coteafs-appium) [![GitHub stars](https://img.shields.io/github/stars/WasiqB/coteafs-appium?style=flat)](https://github.com/WasiqB/coteafs-appium/stargazers) - A tester friendly Mobile Automation Framework built on top of Appium which supports testing web and native apps for Android, iOS and Windows real or emulator Mobiles and Tablets.
- [Optimus](https://github.com/testvagrant/optimusTemplate) [![GitHub stars](https://img.shields.io/github/stars/testvagrant/optimusTemplate?style=flat)](https://github.com/testvagrant/optimusTemplate/stargazers) - Cucumber based Mobile Automation Framework, which supports test parallelization.
- [PageObject Pattern Framework](https://github.com/saikrishna321/PageObjectPatternAppium) [![GitHub stars](https://img.shields.io/github/stars/saikrishna321/PageObjectPatternAppium?style=flat)](https://github.com/saikrishna321/PageObjectPatternAppium/stargazers) - Sample Page Object Pattern Framework to use directly.
- [Parallel Framework Java-Client](https://github.com/saikrishna321/AppiumTestDistribution) [![GitHub stars](https://img.shields.io/github/stars/saikrishna321/AppiumTestDistribution?style=flat)](https://github.com/saikrishna321/AppiumTestDistribution/stargazers) - Run appium tests in parallel across iOS and Android devices.
...
To the extent possible under law, [Srinivasan Sekar](https://github.com/SrinivasanTarget) [![GitHub stars](https://img.shields.io/github/stars/SrinivasanTarget?style=flat)](https://github.com/SrinivasanTarget/stargazers) has waived all copyright and related or neighboring rights to this work.
