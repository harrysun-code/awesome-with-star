...
> 来源：[hkirat/awesome-chess](https://github.com/hkirat/awesome-chess)
...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers) list thing. You might want to read the complete [awesome](https://github.com/sindresorhus/awesome) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers) list.*

### Contributing
Kindly go through [Contribution Guidelines](https://github.com/hkirat/awesome-chess/blob/master/CONTRIBUTING.md#contribution-guidelines) [![GitHub stars](https://img.shields.io/github/stars/hkirat/awesome-chess/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/hkirat/awesome-chess/blob/master/CONTRIBUTING.md/stargazers) first.
...
*Forsyth–Edwards Notation (FEN) is a standard notation for describing a particular board position of a chess game.*
 ...
 - [fenparser by tlehman](https://github.com/tlehman/fenparser) [![GitHub stars](https://img.shields.io/github/stars/tlehman/fenparser?style=flat)](https://github.com/tlehman/fenparser/stargazers) - A parser for Forsyth-Edwards Notation wriitten in Python.
 - [fen by ucarion](https://github.com/ucarion/fen) [![GitHub stars](https://img.shields.io/github/stars/ucarion/fen?style=flat)](https://github.com/ucarion/fen/stargazers) - A Rust Forsyth-Edwards notation parser with proper error handling.
 - [fen-diagram by andyherbert](https://github.com/andyherbert/fen-diagram) [![GitHub stars](https://img.shields.io/github/stars/andyherbert/fen-diagram?style=flat)](https://github.com/andyherbert/fen-diagram/stargazers) - JavaScript for generating chess diagrams using Forsyth-Edwards notation.

Bots
---
*Bots are algorithms involving artificial intelligence to play against a user.*

 - [latrunculorum](https://github.com/benwr/latrunculorum) [![GitHub stars](https://img.shields.io/github/stars/benwr/latrunculorum?style=flat)](https://github.com/benwr/latrunculorum/stargazers) - A simple chess bot in Python.
 - [Chessbot](https://github.com/jfabeel/Chessbot) [![GitHub stars](https://img.shields.io/github/stars/jfabeel/Chessbot?style=flat)](https://github.com/jfabeel/Chessbot/stargazers) - Bot written in Java.

Move Validators
---
*Validators are tools for checking authenticity of a move.*

 - [chess.js](https://github.com/jhlywa/chess.js) [![GitHub stars](https://img.shields.io/github/stars/jhlywa/chess.js?style=flat)](https://github.com/jhlywa/chess.js/stargazers) - chess.js, Structured code for chess authentication.
 ...
 - [Chessnut](https://github.com/cgearhart/Chessnut.git) [![GitHub stars](https://img.shields.io/github/stars/cgearhart/Chessnut.git?style=flat)](https://github.com/cgearhart/Chessnut.git/stargazers) - Chessnut is a simple chess board model written in Python. It provides functionality of parsing FEN and generating a list of legal moves for each FEN representation.
...
*Boards are tools for encapsulating the process of rendering a board.*
 ...
 - [Chessboard.js](https://github.com/oakmac/chessboardjs/) [![GitHub stars](https://img.shields.io/github/stars/oakmac/chessboardjs/?style=flat)](https://github.com/oakmac/chessboardjs//stargazers) - chessboard.js is a standalone JavaScript chess board.
 - [chess-board](https://github.com/laat/chess-board) [![GitHub stars](https://img.shields.io/github/stars/laat/chess-board?style=flat)](https://github.com/laat/chess-board/stargazers) - A web component for displaying chess positions. It takes FEN string as input and renders the board as output.
 - [jchess](https://github.com/bmarini/jchess) [![GitHub stars](https://img.shields.io/github/stars/bmarini/jchess?style=flat)](https://github.com/bmarini/jchess/stargazers) - A jQuery based JavaScript library for parsing and displaying chess games. Currently takes FEN and PGN as inputs.
 - [Chessboard-js](https://github.com/caustique/chessboard-js) [![GitHub stars](https://img.shields.io/github/stars/caustique/chessboard-js?style=flat)](https://github.com/caustique/chessboard-js/stargazers) - A responsive mobile-first JavaScript chessboard library.
