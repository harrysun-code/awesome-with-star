...
[<img src="android-chrome-512x512.png" align="right" width="100">](https://github.com/dh-tech/awesome-digital-humanities/) [![GitHub stars](https://img.shields.io/github/stars/dh-tech/awesome-digital-humanities/?style=flat)](https://github.com/dh-tech/awesome-digital-humanities//stargazers)
...
- [IntellyWeave](https://github.com/vericle/intellyweave) [![GitHub stars](https://img.shields.io/github/stars/vericle/intellyweave?style=flat)](https://github.com/vericle/intellyweave/stargazers) - Open-source platform for humanities research featuring AI-powered entity extraction (persons, organizations, locations, dates, events), semantic search across document collections, geospatial visualization for historical events, and archive research agents with 30+ curated international sources.
...
- [renoir](https://github.com/MichailSemoglou/renoir) [![GitHub stars](https://img.shields.io/github/stars/MichailSemoglou/renoir?style=flat)](https://github.com/MichailSemoglou/renoir/stargazers) - Python package for teaching computational color theory through art history. Extracts and analyzes artist-specific works from WikiArt with color palette extraction, harmony detection, and 17 progressive Jupyter notebooks for digital humanities education.
- [Stylo](https://github.com/computationalstylistics/stylo) [![GitHub stars](https://img.shields.io/github/stars/computationalstylistics/stylo?style=flat)](https://github.com/computationalstylistics/stylo/stargazers) - R package for stylometric analyses.
...
- [OCRmyPDF](https://github.com/jbarlow83/OCRmyPDF) [![GitHub stars](https://img.shields.io/github/stars/jbarlow83/OCRmyPDF?style=flat)](https://github.com/jbarlow83/OCRmyPDF/stargazers) - OCR toolkit.
...
- [Awesome Digital History](https://github.com/maehr/awesome-digital-history) [![GitHub stars](https://img.shields.io/github/stars/maehr/awesome-digital-history?style=flat)](https://github.com/maehr/awesome-digital-history/stargazers) - A curated list of awesome things related to digital history.
- [Awesome IIIF](https://github.com/IIIF/awesome-iiif) [![GitHub stars](https://img.shields.io/github/stars/IIIF/awesome-iiif?style=flat)](https://github.com/IIIF/awesome-iiif/stargazers) - A curated list of awesome resources related to the International Image Interoperability Framework (IIIF).
- [Awesome OCR](https://github.com/kba/awesome-ocr) [![GitHub stars](https://img.shields.io/github/stars/kba/awesome-ocr?style=flat)](https://github.com/kba/awesome-ocr/stargazers) - This list contains links to great software tools and libraries and literature related to Optical Character Recognition (OCR).
- [Awesome Scientific Writing](https://github.com/writing-resources/awesome-scientific-writing) [![GitHub stars](https://img.shields.io/github/stars/writing-resources/awesome-scientific-writing?style=flat)](https://github.com/writing-resources/awesome-scientific-writing/stargazers) - A curated list of awesome tools, demos and resources to go beyond LaTeX.
- [Awesome Web Archiving](https://github.com/iipc/awesome-web-archiving) [![GitHub stars](https://img.shields.io/github/stars/iipc/awesome-web-archiving?style=flat)](https://github.com/iipc/awesome-web-archiving/stargazers) - Resources to archive the web.
...
- [DHSlack](https://github.com/amandavisconti/DHslack/blob/master/CodeOfConduct.md) [![GitHub stars](https://img.shields.io/github/stars/amandavisconti/DHslack/blob/master/CodeOfConduct.md?style=flat)](https://github.com/amandavisconti/DHslack/blob/master/CodeOfConduct.md/stargazers) - Slack channels for digital humanities scholars.
...
- [Jupyter Notebooks for Digital Humanities](https://github.com/quinnanya/dh-jupyter/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/quinnanya/dh-jupyter/blob/master/README.md?style=flat)](https://github.com/quinnanya/dh-jupyter/blob/master/README.md/stargazers) - A diverse range of Jupyter notebooks, comprising research materials, course content, Python tutorials, and specific analysis tools.
...
- [Bertin.js](https://github.com/neocarto/bertin) [![GitHub stars](https://img.shields.io/github/stars/neocarto/bertin?style=flat)](https://github.com/neocarto/bertin/stargazers) - JavaScript library for visualizing geospatial data and make thematic maps for the web.
