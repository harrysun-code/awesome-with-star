...
Before this list, there exist other *awesome deep learning lists*, for example, [Deep Vision](https://github.com/kjw0612/awesome-deep-vision) [![GitHub stars](https://img.shields.io/github/stars/kjw0612/awesome-deep-vision?style=flat)](https://github.com/kjw0612/awesome-deep-vision/stargazers) and [Awesome Recurrent Neural Networks](https://github.com/kjw0612/awesome-rnn) [![GitHub stars](https://img.shields.io/github/stars/kjw0612/awesome-rnn?style=flat)](https://github.com/kjw0612/awesome-rnn/stargazers). Also, after this list comes out, another awesome list for deep learning beginners, called [Deep Learning Papers Reading Roadmap](https://github.com/songrotek/Deep-Learning-Papers-Reading-Roadmap) [![GitHub stars](https://img.shields.io/github/stars/songrotek/Deep-Learning-Papers-Reading-Roadmap?style=flat)](https://github.com/songrotek/Deep-Learning-Papers-Reading-Roadmap/stargazers), has been created and loved by many deep learning researchers.
...
(Please read the [contributing guide](https://github.com/terryum/awesome-deep-learning-papers/blob/master/Contributing.md) [![GitHub stars](https://img.shields.io/github/stars/terryum/awesome-deep-learning-papers/blob/master/Contributing.md?style=flat)](https://github.com/terryum/awesome-deep-learning-papers/blob/master/Contributing.md/stargazers) for further instructions, though just letting me know the title of papers can also be a big contribution to us.)

(Update) You can download all top-100 papers with [this](https://github.com/terryum/awesome-deep-learning-papers/blob/master/fetch_papers.py) [![GitHub stars](https://img.shields.io/github/stars/terryum/awesome-deep-learning-papers/blob/master/fetch_papers.py?style=flat)](https://github.com/terryum/awesome-deep-learning-papers/blob/master/fetch_papers.py/stargazers) and collect all authors' names with [this](https://github.com/terryum/awesome-deep-learning-papers/blob/master/get_authors.py) [![GitHub stars](https://img.shields.io/github/stars/terryum/awesome-deep-learning-papers/blob/master/get_authors.py?style=flat)](https://github.com/terryum/awesome-deep-learning-papers/blob/master/get_authors.py/stargazers). Also, [bib file](https://github.com/terryum/awesome-deep-learning-papers/blob/master/top100papers.bib) [![GitHub stars](https://img.shields.io/github/stars/terryum/awesome-deep-learning-papers/blob/master/top100papers.bib?style=flat)](https://github.com/terryum/awesome-deep-learning-papers/blob/master/top100papers.bib/stargazers) for all top-100 papers are available. Thanks, doodhwala, [Sven](https://github.com/sunshinemyson) [![GitHub stars](https://img.shields.io/github/stars/sunshinemyson?style=flat)](https://github.com/sunshinemyson/stargazers) and [grepinsight](https://github.com/grepinsight) [![GitHub stars](https://img.shields.io/github/stars/grepinsight?style=flat)](https://github.com/grepinsight/stargazers)!
