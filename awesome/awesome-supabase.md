...
- [Vuepabase](https://github.com/JMaylor/vuepabase) [![GitHub stars](https://img.shields.io/github/stars/JMaylor/vuepabase?style=flat)](https://github.com/JMaylor/vuepabase/stargazers) - Vue3 Supabase starter, with Pinia, Vue-router 4, Tailwind CSS, Vitest, Cypress and more.
...
- [RedwoodJS Supabase Quickstart](https://github.com/redwoodjs/redwoodjs-supabase-quickstart) [![GitHub stars](https://img.shields.io/github/stars/redwoodjs/redwoodjs-supabase-quickstart?style=flat)](https://github.com/redwoodjs/redwoodjs-supabase-quickstart/stargazers) - Supabase Quickstart example app with RedwoodJS.
...
- [SupaSasS Lite](https://github.com/Razikus/supabase-nextjs-template) [![GitHub stars](https://img.shields.io/github/stars/Razikus/supabase-nextjs-template?style=flat)](https://github.com/Razikus/supabase-nextjs-template/stargazers) - Open source Next.js SasS template (with 2FA, and example app)
- [SupaSocial](https://github.com/koji0701/supabase-react-social-media-starter/tree/main) [![GitHub stars](https://img.shields.io/github/stars/koji0701/supabase-react-social-media-starter/tree/main?style=flat)](https://github.com/koji0701/supabase-react-social-media-starter/tree/main/stargazers) - React social media starter with auth, friend requests, profile pics, and example app (profile, friends, signin, leaderboard, and more pages).
- [Extro](https://github.com/turbostarter/extro) [![GitHub stars](https://img.shields.io/github/stars/turbostarter/extro?style=flat)](https://github.com/turbostarter/extro/stargazers) - Open source browser extension starter kit.
...
- [Supabase DB to Google Sheets](https://github.com/jadynekena/supabase-googlesheet) [![GitHub stars](https://img.shields.io/github/stars/jadynekena/supabase-googlesheet?style=flat)](https://github.com/jadynekena/supabase-googlesheet/stargazers) - Tool to pull Supabase data into Google Sheets.
...
- [Lovable Cloud to Supabase Exporter](https://github.com/dreamlit-ai/lovable-cloud-to-supabase-exporter) [![GitHub stars](https://img.shields.io/github/stars/dreamlit-ai/lovable-cloud-to-supabase-exporter?style=flat)](https://github.com/dreamlit-ai/lovable-cloud-to-supabase-exporter/stargazers) - Migrate tables, users, and storage from Lovable Cloud to your own Supabase backend without password resets or manual CSV work.
...
- [Supabase Plus](https://github.com/dsplce-co/supabase-plus) [![GitHub stars](https://img.shields.io/github/stars/dsplce-co/supabase-plus?style=flat)](https://github.com/dsplce-co/supabase-plus/stargazers) - An extra set of tools for managing Supabase projects, going beyond the possibilities of the regular Supabase CLI.
...
- [Octokit-lite](https://github.com/lyqht/Octokit-lite) [![GitHub stars](https://img.shields.io/github/stars/lyqht/Octokit-lite?style=flat)](https://github.com/lyqht/Octokit-lite/stargazers) - App to perform common use case GitHub operations on multiple repositories efficiently. Uses Supabase Auth and DB.
- [Generate Supabase Database Types GitHub Action](https://github.com/lyqht/generate-supabase-db-types-github-action) [![GitHub stars](https://img.shields.io/github/stars/lyqht/generate-supabase-db-types-github-action?style=flat)](https://github.com/lyqht/generate-supabase-db-types-github-action/stargazers) - GitHub action to generate types based on your Supabase database.
- [Supabase Cache Helpers](https://github.com/psteinroe/supabase-cache-helpers) [![GitHub stars](https://img.shields.io/github/stars/psteinroe/supabase-cache-helpers?style=flat)](https://github.com/psteinroe/supabase-cache-helpers/stargazers) - Collection of framework specific Cache utilities for working with Supabase.
...
- [Bemi for Supabase JS](https://github.com/BemiHQ/bemi-supabase-js) [![GitHub stars](https://img.shields.io/github/stars/BemiHQ/bemi-supabase-js?style=flat)](https://github.com/BemiHQ/bemi-supabase-js/stargazers) - Open-source platform for automatic data change tracking.
- [Supabase automated self host](https://github.com/singh-inder/supabase-automated-self-host) [![GitHub stars](https://img.shields.io/github/stars/singh-inder/supabase-automated-self-host?style=flat)](https://github.com/singh-inder/supabase-automated-self-host/stargazers) - Self-host Supabase with Caddy and Authelia. Just run ONE script.
...
- [Supabase DataFlows SMS Hook](https://github.com/dataflows-au/supabase-sms-hook) [![GitHub stars](https://img.shields.io/github/stars/dataflows-au/supabase-sms-hook?style=flat)](https://github.com/dataflows-au/supabase-sms-hook/stargazers) - Send phone OTP verification via DataFlows SMS API. Australian alternative to Twilio for Supabase Auth.
- [Pharos AI](https://github.com/Juliusolsson05/pharos-ai) [![GitHub stars](https://img.shields.io/github/stars/Juliusolsson05/pharos-ai?style=flat)](https://github.com/Juliusolsson05/pharos-ai/stargazers) - Open-source real-time intelligence dashboard for geopolitical conflict tracking with interactive maps, OSINT feeds, and AI-powered briefs.
...
- [Firebase to Supabase](https://github.com/supabase-community/firebase-to-supabase) [![GitHub stars](https://img.shields.io/github/stars/supabase-community/firebase-to-supabase?style=flat)](https://github.com/supabase-community/firebase-to-supabase/stargazers) - A collection of guides of migrating from different components of Firebase such as Auth, Firestore, Storage, Functions to Supabase.
