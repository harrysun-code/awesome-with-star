...
> A collection of awesome [Umbraco CMS](https://github.com/umbraco/Umbraco-CMS/) [![GitHub stars](https://img.shields.io/github/stars/umbraco/Umbraco-CMS/?style=flat)](https://github.com/umbraco/Umbraco-CMS//stargazers) packages, resources and shiny things.

Inspired by [awesome lists](https://github.com/sindresorhus/awesome) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers). For general C#/.NET please see the [awesome-dotnet](https://github.com/quozd/awesome-dotnet/) [![GitHub stars](https://img.shields.io/github/stars/quozd/awesome-dotnet/?style=flat)](https://github.com/quozd/awesome-dotnet//stargazers) collection!

### Contributing

**Contributions are always welcome!** 

Please read the [contribution guidelines and quality standard](https://github.com/umbraco-community/awesome-umbraco/blob/master/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/umbraco-community/awesome-umbraco/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/umbraco-community/awesome-umbraco/blob/master/CONTRIBUTING.md/stargazers) page before making a pull-request. If you see a resource or package here that is no longer maintained, please submit a pull request to help improve this collection.

Thank you to all [contributors](https://github.com/umbraco-community/awesome-umbraco/graphs/contributors) [![GitHub stars](https://img.shields.io/github/stars/umbraco-community/awesome-umbraco/graphs/contributors?style=flat)](https://github.com/umbraco-community/awesome-umbraco/graphs/contributors/stargazers), you are awesome and this list wouldn't be possible without you! The goal is to build a categorized community-driven collection of very well-known resources.
...
* [Deploy Contrib](https://github.com/umbraco/Umbraco.Deploy.Contrib) [![GitHub stars](https://img.shields.io/github/stars/umbraco/Umbraco.Deploy.Contrib?style=flat)](https://github.com/umbraco/Umbraco.Deploy.Contrib/stargazers) - Offers value-connectors for the most popular Umbraco community packages. To allow Umbraco Cloud deploy to transfer content/property-data to a target environment. **(Maintained by Umbraco HQ)** _Umbraco Cloud only_
