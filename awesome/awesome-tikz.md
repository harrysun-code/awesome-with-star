...
-   [SourceForge](https://github.com/pgf-tikz/pgf) [![GitHub stars](https://img.shields.io/github/stars/pgf-tikz/pgf?style=flat)](https://github.com/pgf-tikz/pgf/stargazers) - Code, releases, support and bug reports.
...
-   [walmes/Tikz](https://github.com/walmes/Tikz) [![GitHub stars](https://img.shields.io/github/stars/walmes/Tikz?style=flat)](https://github.com/walmes/Tikz/stargazers) - Collection of TikZ art from Prof. Walmes M. Zeviani, contains about 200 TikZ figures, most of which were done to teach statistics.
-   [MartinThoma/LaTeX-examples](https://github.com/MartinThoma/LaTeX-examples/tree/master/tikz) [![GitHub stars](https://img.shields.io/github/stars/MartinThoma/LaTeX-examples/tree/master/tikz?style=flat)](https://github.com/MartinThoma/LaTeX-examples/tree/master/tikz/stargazers) - Contains about 350 TikZ examples from Martin. Thoma.
...
-   [PetarV-/TikZ](https://github.com/PetarV-/TikZ) [![GitHub stars](https://img.shields.io/github/stars/PetarV-/TikZ?style=flat)](https://github.com/PetarV-/TikZ/stargazers) - A collection of publication-ready PGF/TikZ figures by Petar Veličković.
-   [alemelis/tikz_drawings](https://github.com/alemelis/tikz_drawings) [![GitHub stars](https://img.shields.io/github/stars/alemelis/tikz_drawings?style=flat)](https://github.com/alemelis/tikz_drawings/stargazers) - Source codes for illustration made in TikZ by Alessandro Melis for various publications.
...
-   [ktikz](https://github.com/fhackenberger/ktikz) [![GitHub stars](https://img.shields.io/github/stars/fhackenberger/ktikz?style=flat)](https://github.com/fhackenberger/ktikz/stargazers) - Provides a nice user interface for making pictures using TikZ.
-   [gratex](https://sourceforge.net/projects/gratex/) - Visual graph creator for LaTeX (PGF & TikZ).
-   [itikz](https://github.com/jbn/itikz) [![GitHub stars](https://img.shields.io/github/stars/jbn/itikz?style=flat)](https://github.com/jbn/itikz/stargazers) - Cell and line magic for PGF/TikZ-to-SVG rendering in Jupyter notebooks.
-   [matlab2tikz](https://github.com/matlab2tikz/matlab2tikz) [![GitHub stars](https://img.shields.io/github/stars/matlab2tikz/matlab2tikz?style=flat)](https://github.com/matlab2tikz/matlab2tikz/stargazers) - Converts MATLAB®/Octave figures to TikZ/pgfplots figures.
-   [matplotlib2tikz](https://github.com/nschloe/matplotlib2tikz) [![GitHub stars](https://img.shields.io/github/stars/nschloe/matplotlib2tikz?style=flat)](https://github.com/nschloe/matplotlib2tikz/stargazers) - Convert matplotlib figure and spits out a TikZ/PGFplots figure.
-   [PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet) [![GitHub stars](https://img.shields.io/github/stars/HarisIqbal88/PlotNeuralNet?style=flat)](https://github.com/HarisIqbal88/PlotNeuralNet/stargazers) - Latex code for making neural networks diagrams
-   [awesome-latex-drawing](https://github.com/xinychen/awesome-latex-drawing) [![GitHub stars](https://img.shields.io/github/stars/xinychen/awesome-latex-drawing?style=flat)](https://github.com/xinychen/awesome-latex-drawing/stargazers) - Drawing Bayesian networks, graphical models, and technical frameworks in LaTeX.
-   [sane_tikz](https://github.com/negrinho/sane_tikz) [![GitHub stars](https://img.shields.io/github/stars/negrinho/sane_tikz?style=flat)](https://github.com/negrinho/sane_tikz/stargazers) - Create TikZ figures with Python.
-   [quiver](https://github.com/varkor/quiver) [![GitHub stars](https://img.shields.io/github/stars/varkor/quiver?style=flat)](https://github.com/varkor/quiver/stargazers) - A commutative diagram editor that exports to tikz-cd.
