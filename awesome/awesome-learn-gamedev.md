...
- [GameDev Resources](https://github.com/Kavex/GameDev-Resources) [![GitHub stars](https://img.shields.io/github/stars/Kavex/GameDev-Resources?style=flat)](https://github.com/Kavex/GameDev-Resources/stargazers)
- [Gamedev Resources](https://github.com/Hengle/gamedev-resources-1) [![GitHub stars](https://img.shields.io/github/stars/Hengle/gamedev-resources-1?style=flat)](https://github.com/Hengle/gamedev-resources-1/stargazers)
...
[The Open Source University](https://github.com/ossu/computer-science) [![GitHub stars](https://img.shields.io/github/stars/ossu/computer-science?style=flat)](https://github.com/ossu/computer-science/stargazers) 🟪 - A complete study plan for a computer science education.


[Coding Interview University](https://github.com/jwasham/coding-interview-university) [![GitHub stars](https://img.shields.io/github/stars/jwasham/coding-interview-university?style=flat)](https://github.com/jwasham/coding-interview-university/stargazers) 🟪 - Another complete study plan aimed at software engineers.


[Professional Programming](https://github.com/charlax/professional-programming) [![GitHub stars](https://img.shields.io/github/stars/charlax/professional-programming?style=flat)](https://github.com/charlax/professional-programming/stargazers) 🟪 - An expansive list of resources and other lists of resources intended to make you a more proficient programmer at a professional level.
...
[A Study Path for Game Programmers](https://github.com/miloyip/game-programmer) [![GitHub stars](https://img.shields.io/github/stars/miloyip/game-programmer?style=flat)](https://github.com/miloyip/game-programmer/stargazers) 🟪 - A huge collection of game programming book titles and covers organized by specialization, with fancy flow charts between each title for a recommended reading order! Note that the books are _not_ included - a quick search should help you out with that ;]
...
[Awesome Math](https://github.com/rossant/awesome-math) [![GitHub stars](https://img.shields.io/github/stars/rossant/awesome-math?style=flat)](https://github.com/rossant/awesome-math/stargazers) 🟪 - Another awesome list for mathematics, useful generally but often applicable to programming.
...
[The Awesome list for Computer Graphics](https://github.com/luisnts/awesome-computer-graphics) [![GitHub stars](https://img.shields.io/github/stars/luisnts/awesome-computer-graphics?style=flat)](https://github.com/luisnts/awesome-computer-graphics/stargazers) 💠🟪 - Another awesome list specifically tailored to this topic, albeit not games-focused.
...
[Dialogger](https://github.com/etodd/dialogger) [![GitHub stars](https://img.shields.io/github/stars/etodd/dialogger?style=flat)](https://github.com/etodd/dialogger/stargazers) - A simple cross-platform dialogue graph editor (free with MIT license!)
...
[Awesome Game Production](https://github.com/vhladiienko/awesome-game-production) [![GitHub stars](https://img.shields.io/github/stars/vhladiienko/awesome-game-production?style=flat)](https://github.com/vhladiienko/awesome-game-production/stargazers) 🟪 - An Awesome list, focused on project and product management in game development.
...
[The Reverse Interview](https://github.com/viraptor/reverse-interview) [![GitHub stars](https://img.shields.io/github/stars/viraptor/reverse-interview?style=flat)](https://github.com/viraptor/reverse-interview/stargazers) - Another list for you to ask a potential employer (created for non-games tech, but most questions apply to games, and some apply to all disciplines).
