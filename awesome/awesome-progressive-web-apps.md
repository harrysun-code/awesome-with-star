...
- [Awesome Service Workers](https://github.com/TalAter/awesome-service-workers) [![GitHub stars](https://img.shields.io/github/stars/TalAter/awesome-service-workers?style=flat)](https://github.com/TalAter/awesome-service-workers/stargazers) - A collection of awesome resources for learning service workers.
...
- [Awesome Service Workers](https://github.com/TalAter/awesome-service-workers/) [![GitHub stars](https://img.shields.io/github/stars/TalAter/awesome-service-workers/?style=flat)](https://github.com/TalAter/awesome-service-workers//stargazers) - A curated collection of the finest service worker resources.
...
- [Background Sync Explained](https://github.com/WICG/BackgroundSync/blob/master/explainer.md) [![GitHub stars](https://img.shields.io/github/stars/WICG/BackgroundSync/blob/master/explainer.md?style=flat)](https://github.com/WICG/BackgroundSync/blob/master/explainer.md/stargazers) - The official "explainer" document for background sync, including one-off synchronization and periodic synchronization.
...
- [web-push-libs](https://github.com/web-push-libs) [![GitHub stars](https://img.shields.io/github/stars/web-push-libs?style=flat)](https://github.com/web-push-libs/stargazers) - A collection of useful libraries for web push in different technologies (Node.js, PHP, Python, etc.)
...
- [Web Share API explainer](https://github.com/WICG/web-share/blob/master/docs/explainer.md) [![GitHub stars](https://img.shields.io/github/stars/WICG/web-share/blob/master/docs/explainer.md?style=flat)](https://github.com/WICG/web-share/blob/master/docs/explainer.md/stargazers) - An explanation of the API, along with some examples. Part of the proposal doc.
- [Web Share Target API](https://github.com/WICG/web-share-target) [![GitHub stars](https://img.shields.io/github/stars/WICG/web-share-target?style=flat)](https://github.com/WICG/web-share-target/stargazers) - The proposal for the Web Share Target API, as well as a high level [explainer](https://github.com/WICG/web-share-target/blob/master/docs/explainer.md) [![GitHub stars](https://img.shields.io/github/stars/WICG/web-share-target/blob/master/docs/explainer.md?style=flat)](https://github.com/WICG/web-share-target/blob/master/docs/explainer.md/stargazers).
