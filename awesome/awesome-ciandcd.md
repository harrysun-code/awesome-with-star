...
> 来源：[cicdops/awesome-ciandcd](https://github.com/cicdops/awesome-ciandcd)

[![GitHub stars](https://img.shields.io/github/stars/cicdops/awesome-ciandcd?style=flat)](https://github.com/cicdops/awesome-ciandcd/stargazers)
...
* [devops_roadmap](https://github.com/kamranahmedse/developer-roadmap) [![GitHub stars](https://img.shields.io/github/stars/kamranahmedse/developer-roadmap?style=flat)](https://github.com/kamranahmedse/developer-roadmap/stargazers)  
...
* [SimpleCI](https://github.com/simpleci/simpleci) [![GitHub stars](https://img.shields.io/github/stars/simpleci/simpleci?style=flat)](https://github.com/simpleci/simpleci/stargazers) Docker-based self-hosted ci system. Supports distributed build cache, external providers (GCE), real-time build log, etc.  
* [pulse](http://zutubi.com) no free version.  
* [PHP Censor](https://github.com/php-censor/php-censor) [![GitHub stars](https://img.shields.io/github/stars/php-censor/php-censor?style=flat)](https://github.com/php-censor/php-censor/stargazers) Open source self-hosted continuous integration server for PHP projects.  
...
* [T.A.D.S. boilerplate](https://github.com/Thomvaill/tads-boilerplate) [![GitHub stars](https://img.shields.io/github/stars/Thomvaill/tads-boilerplate?style=flat)](https://github.com/Thomvaill/tads-boilerplate/stargazers) A boilerplate to setup a Docker Swarm environment with Ansible
* [vagrantup](https://www.vagrantup.com/)  Create and configure lightweight, reproducible, and portable development environments.  
* [veewee](https://github.com/jedi4ever/veewee) [![GitHub stars](https://img.shields.io/github/stars/jedi4ever/veewee?style=flat)](https://github.com/jedi4ever/veewee/stargazers) Easing the building of vagrant boxes  
...
* [do](https://github.com/8gears/do) [![GitHub stars](https://img.shields.io/github/stars/8gears/do?style=flat)](https://github.com/8gears/do/stargazers)  The simplest build tool on earth. Agnostic and multipurpose build tool and a build file. Tries to be better than the usual shell hell.
...
* [Macaca](https://github.com/alibaba/macaca) [![GitHub stars](https://img.shields.io/github/stars/alibaba/macaca?style=flat)](https://github.com/alibaba/macaca/stargazers) Automation test solution for native, hybrid, mobile web and web application on mobile and desktop platforms
...
* [herd](https://github.com/russss/Herd) [![GitHub stars](https://img.shields.io/github/stars/russss/Herd?style=flat)](https://github.com/russss/Herd/stargazers) A single-command bittorrent distribution system, based on Twitter's Murder     
* [murder](https://github.com/lg/murder) [![GitHub stars](https://img.shields.io/github/stars/lg/murder?style=flat)](https://github.com/lg/murder/stargazers)  Large scale server deploys using BitTorrent and the BitTornado library from twitter.com  
...
* [awesome-shell](https://github.com/itech001/awesome-shell/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/itech001/awesome-shell/blob/master/README.md?style=flat)](https://github.com/itech001/awesome-shell/blob/master/README.md/stargazers)  
...
* [awesome-perl](https://github.com/hachiojipm/awesome-perl) [![GitHub stars](https://img.shields.io/github/stars/hachiojipm/awesome-perl?style=flat)](https://github.com/hachiojipm/awesome-perl/stargazers)  
...
* [awesome-awesome](https://github.com/emijrp/awesome-awesome) [![GitHub stars](https://img.shields.io/github/stars/emijrp/awesome-awesome?style=flat)](https://github.com/emijrp/awesome-awesome/stargazers)  
...
* [sysadmin](https://github.com/itech001/awesome-sysadmin) [![GitHub stars](https://img.shields.io/github/stars/itech001/awesome-sysadmin?style=flat)](https://github.com/itech001/awesome-sysadmin/stargazers)  
* [ci tools compare](https://en.wikipedia.org/wiki/Comparison_of_continuous_integration_software)  
* [ci tools compare2](https://github.com/ciandcd/Continuous-Integration-services/blob/master/continuous-integration-services-list.md) [![GitHub stars](https://img.shields.io/github/stars/ciandcd/Continuous-Integration-services/blob/master/continuous-integration-services-list.md?style=flat)](https://github.com/ciandcd/Continuous-Integration-services/blob/master/continuous-integration-services-list.md/stargazers)
* [ci tools compare 3](https://github.com/ligurio/Continuous-Integration-services) [![GitHub stars](https://img.shields.io/github/stars/ligurio/Continuous-Integration-services?style=flat)](https://github.com/ligurio/Continuous-Integration-services/stargazers)
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) [![GitHub stars](https://img.shields.io/github/stars/veggiemonk/awesome-docker?style=flat)](https://github.com/veggiemonk/awesome-docker/stargazers)  
*[awesome-cicd](https://github.com/awsomecicd/awesomecicd.git) [![GitHub stars](https://img.shields.io/github/stars/awsomecicd/awesomecicd.git?style=flat)](https://github.com/awsomecicd/awesomecicd.git/stargazers)
