...
> 来源：[rickstaa/awesome-adsb](https://github.com/rickstaa/awesome-adsb)

[![GitHub stars](https://img.shields.io/github/stars/rickstaa/awesome-adsb?style=flat)](https://github.com/rickstaa/awesome-adsb/stargazers)
...
- [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) [![GitHub stars](https://img.shields.io/github/stars/adsblol/globe_history?style=flat)](https://github.com/adsblol/globe_history/stargazers).
...
- [readsb](https://github.com/wiedehopf/readsb) [![GitHub stars](https://img.shields.io/github/stars/wiedehopf/readsb?style=flat)](https://github.com/wiedehopf/readsb/stargazers) - ADS-B decoder swiss knife.
- [dump1090](https://github.com/MalcolmRobb/dump1090) [![GitHub stars](https://img.shields.io/github/stars/MalcolmRobb/dump1090?style=flat)](https://github.com/MalcolmRobb/dump1090/stargazers) - A simple Mode S decoder for RTLSDR devices.
- [flightmon](https://github.com/mik3y/flightmon) [![GitHub stars](https://img.shields.io/github/stars/mik3y/flightmon?style=flat)](https://github.com/mik3y/flightmon/stargazers) - Simple command-line "GUI" for showing current dump1090/readsb data.
- [sdr-enthusiasts/plane-alert-db](https://github.com/sdr-enthusiasts/plane-alert-db) [![GitHub stars](https://img.shields.io/github/stars/sdr-enthusiasts/plane-alert-db?style=flat)](https://github.com/sdr-enthusiasts/plane-alert-db/stargazers) - A list of exciting aircraft - Governments, Dictators, Military, Historical and just plain odd.
- [junzis/pyModeS](https://github.com/junzis/pyModeS) [![GitHub stars](https://img.shields.io/github/stars/junzis/pyModeS?style=flat)](https://github.com/junzis/pyModeS/stargazers) - A python decoder for Mode S and ADS-B signals.
- [adsb_actions](https://github.com/eastham/adsb_actions) [![GitHub stars](https://img.shields.io/github/stars/eastham/adsb_actions?style=flat)](https://github.com/eastham/adsb_actions/stargazers) - Python tool to detect, act on, and visualize ADS-B traffic and events.

### Feeding

- [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) [![GitHub stars](https://img.shields.io/github/stars/sdr-enthusiasts/docker-adsb-ultrafeeder?style=flat)](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder/stargazers) - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
- [adsbfi/adsb-fi-scripts](https://github.com/adsbfi/adsb-fi-scripts) [![GitHub stars](https://img.shields.io/github/stars/adsbfi/adsb-fi-scripts?style=flat)](https://github.com/adsbfi/adsb-fi-scripts/stargazers) - Easy to use feeder install script for feeding to adsb.fi.
- [adsblol/feed](https://github.com/adsblol/feed) [![GitHub stars](https://img.shields.io/github/stars/adsblol/feed?style=flat)](https://github.com/adsblol/feed/stargazers) - Easy to use, container-based MLAT/ADS-B/ACARS/VDL2 multi feed client. Powered by [SDR-Enthusiasts](https://github.com/sdr-enthusiasts) [![GitHub stars](https://img.shields.io/github/stars/sdr-enthusiasts?style=flat)](https://github.com/sdr-enthusiasts/stargazers) images.
...
- [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) [![GitHub stars](https://img.shields.io/github/stars/wiedehopf/tar1090?style=flat)](https://github.com/wiedehopf/tar1090/stargazers) - A great way to view your ADS-B data.
- [amnesica/BelugaProject](https://github.com/amnesica/BelugaProject) [![GitHub stars](https://img.shields.io/github/stars/amnesica/BelugaProject?style=flat)](https://github.com/amnesica/BelugaProject/stargazers) - A web application that displays data of one or multiple, local ADS-B feeders and AIS-data along with additional information on a map interface in the browser.
- [Grafana](https://grafana.com/) - Open source analytics and monitoring solution for every database.

### Apps

- [d4rken/adsb-meta-tracker](https://github.com/d4rken/adsb-meta-tracker) [![GitHub stars](https://img.shields.io/github/stars/d4rken/adsb-meta-tracker?style=flat)](https://github.com/d4rken/adsb-meta-tracker/stargazers) - An Android ADS-B Meta Tracker that shows metadata about ADS-B aggregators.
- [AirPing](https://airping.app) - An iOS app that turns your tar1090 or readsb instance into a mobile flight tracker.

### Social

- [docker-planefence](https://github.com/kx1t/docker-planefence) [![GitHub stars](https://img.shields.io/github/stars/kx1t/docker-planefence?style=flat)](https://github.com/kx1t/docker-planefence/stargazers) - A little tool that can be used to log, display and tweet the aircraft that come within range of your receiver (i.e. the fence).
- [Jxck-S/plane-notify](https://github.com/Jxck-S/plane-notify) [![GitHub stars](https://img.shields.io/github/stars/Jxck-S/plane-notify?style=flat)](https://github.com/Jxck-S/plane-notify/stargazers) - Notify if a selected plane has taken off or landed using OpenSky or ADS-B Exchange data.

## ADS-B Derived Data
- [aircraft-flight-schedules](https://github.com/MrAirspace/aircraft-flight-schedules) [![GitHub stars](https://img.shields.io/github/stars/MrAirspace/aircraft-flight-schedules?style=flat)](https://github.com/MrAirspace/aircraft-flight-schedules/stargazers) - Open-source datasets featuring global, high-level flight schedules extracted from worldwide aircraft ADS-B position transmissions (2024+ onwards). Covers all flights globally as long as within coverage of the [ADSBlol](https://adsb.lol/) initiative.
...
Who else should we [be following](https://github.com/rickstaa/awesome-adsb/issues/new?assignees=&labels=&template=suggestion.yaml) [![GitHub stars](https://img.shields.io/github/stars/rickstaa/awesome-adsb/issues/new?assignees=&labels=&template=suggestion.yaml?style=flat)](https://github.com/rickstaa/awesome-adsb/issues/new?assignees=&labels=&template=suggestion.yaml/stargazers)?
...
This project exists thanks to all the people [that contributed](https://github.com/rickstaa/awesome-adsb/graphs/contributors) [![GitHub stars](https://img.shields.io/github/stars/rickstaa/awesome-adsb/graphs/contributors?style=flat)](https://github.com/rickstaa/awesome-adsb/graphs/contributors/stargazers)!
