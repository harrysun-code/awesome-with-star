...
[![GitHub stars](https://img.shields.io/github/stars/sjfricke/awesome-webgl?style=flat)](https://github.com/sjfricke/awesome-webgl/stargazers)
...
* [WebGL Month](https://github.com/lesnitsky/webgl-month) [![GitHub stars](https://img.shields.io/github/stars/lesnitsky/webgl-month?style=flat)](https://github.com/lesnitsky/webgl-month/stargazers) – Daily WebGL tutorial for a month.
...
* [WebGL Insights](https://github.com/WebGLInsights/WebGLInsights.github.io/releases/download/v1.0/WebGL.Insights.-.Patrick.Cozzi.pdf) [![GitHub stars](https://img.shields.io/github/stars/WebGLInsights/WebGLInsights.github.io/releases/download/v1.0/WebGL.Insights.-.Patrick.Cozzi.pdf?style=flat)](https://github.com/WebGLInsights/WebGLInsights.github.io/releases/download/v1.0/WebGL.Insights.-.Patrick.Cozzi.pdf/stargazers) by **Patrick Cozzi** - Presents real-world techniques for intermediate and advanced WebGL developers by assembling contributions from experienced WebGL engine and application developers, GPU vendors, browser developers, researchers, and educators.
...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) [![GitHub stars](https://img.shields.io/github/stars/KhronosGroup/WebGL/issues?style=flat)](https://github.com/KhronosGroup/WebGL/issues/stargazers) - Spec or Conformance related bugs
...
* [GLSLbin](http://glslb.in) - Fragment shader sandbox supporting [glslify](https://github.com/glslify/glslify) [![GitHub stars](https://img.shields.io/github/stars/glslify/glslify?style=flat)](https://github.com/glslify/glslify/stargazers).
...
* [Google Project ANGLE](https://github.com/google/angle) [![GitHub stars](https://img.shields.io/github/stars/google/angle?style=flat)](https://github.com/google/angle/stargazers) - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
...
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) [![GitHub stars](https://img.shields.io/github/stars/KhronosGroup/WebGL?style=flat)](https://github.com/KhronosGroup/WebGL/stargazers) - Source code to both view and contribute.
...
* [Khronos Dev Tools](https://github.com/KhronosGroup/WebGLDeveloperTools) [![GitHub stars](https://img.shields.io/github/stars/KhronosGroup/WebGLDeveloperTools?style=flat)](https://github.com/KhronosGroup/WebGLDeveloperTools/stargazers) - Useful WebGL developer tools, intended to be used as an ES6 module.
...
* [GLSL Shader Editor Extension](https://github.com/spite/ShaderEditorExtension) [![GitHub stars](https://img.shields.io/github/stars/spite/ShaderEditorExtension?style=flat)](https://github.com/spite/ShaderEditorExtension/stargazers) - Chrome DevTools extension to help you edit shaders live in the browser.
...
* [Webgl Insight](https://github.com/3Dparallax/insight) [![GitHub stars](https://img.shields.io/github/stars/3Dparallax/insight?style=flat)](https://github.com/3Dparallax/insight/stargazers) - Chrome extension WebGL debugging toolkit providing a variety of capabilities.
...
* [WebGL 2 Examples](https://github.com/tsherif/webgl2examples) [![GitHub stars](https://img.shields.io/github/stars/tsherif/webgl2examples?style=flat)](https://github.com/tsherif/webgl2examples/stargazers) - Rendering algorithms implemented in raw WebGL 2.
* [WebGL 2 & GLSL Primer: A Zero-to-Hero, Spaced-Repetition Guide](https://github.com/GregStanton/webgl2-glsl-primer) [![GitHub stars](https://img.shields.io/github/stars/GregStanton/webgl2-glsl-primer?style=flat)](https://github.com/GregStanton/webgl2-glsl-primer/stargazers) - Grok WebGL2 and GLSL through a sequence of guided lessons, each chunked into atomic Q&A cards, with hands-on projects and solution code integrated throughout.
...
> [More detailed information about the different libraries can be found in the Libraries directory.](https://github.com/sjfricke/awesome-webgl/tree/master/Libraries) [![GitHub stars](https://img.shields.io/github/stars/sjfricke/awesome-webgl/tree/master/Libraries?style=flat)](https://github.com/sjfricke/awesome-webgl/tree/master/Libraries/stargazers)

### 2D
* [p2.js](https://github.com/schteppe/p2.js) [![GitHub stars](https://img.shields.io/github/stars/schteppe/p2.js?style=flat)](https://github.com/schteppe/p2.js/stargazers) - 2D rigid body physics engine written in JavaScript.
...
* [Planck.js](https://github.com/shakiba/planck.js) [![GitHub stars](https://img.shields.io/github/stars/shakiba/planck.js?style=flat)](https://github.com/shakiba/planck.js/stargazers) - 2D physics engine for cross-platform HTML5 game development.
* [Stage.js](https://github.com/shakiba/stage.js) [![GitHub stars](https://img.shields.io/github/stars/shakiba/stage.js?style=flat)](https://github.com/shakiba/stage.js/stargazers) - 2D Library for cross-platform HTML5 game development.
...
#### Particles
* [Phenomenon](https://github.com/vaneenige/phenomenon) [![GitHub stars](https://img.shields.io/github/stars/vaneenige/phenomenon?style=flat)](https://github.com/vaneenige/phenomenon/stargazers) - Very small, low-level WebGL library that provides the essentials to deliver a high performance experience.
...
* [MapMetrics GL](https://github.com/MapMetrics/mapmetrics-gl) [![GitHub stars](https://img.shields.io/github/stars/MapMetrics/mapmetrics-gl?style=flat)](https://github.com/MapMetrics/mapmetrics-gl/stargazers) - Mapbox GL JS-compatible mapping library with built-in vector tiles, geocoding, routing, and search.
...
### Rendering
* [GLBoost](https://github.com/emadurandal/GLBoost) [![GitHub stars](https://img.shields.io/github/stars/emadurandal/GLBoost?style=flat)](https://github.com/emadurandal/GLBoost/stargazers) - Rendering library for 3D graphic geeks.
* [GrimoireGL](https://grimoire.gl/) - Bridge between Web engineers and CG engineers.
* [Hilo3d](https://github.com/hiloteam/Hilo3d) [![GitHub stars](https://img.shields.io/github/stars/hiloteam/Hilo3d?style=flat)](https://github.com/hiloteam/Hilo3d/stargazers) - WebGL rendering engine for 3D games.
...
* [A-Frame](https://aframe.io/) - Web framework for building virtual reality experiences.
  * [Awesome-AFrame](https://github.com/aframevr/awesome-aframe) [![GitHub stars](https://img.shields.io/github/stars/aframevr/awesome-aframe?style=flat)](https://github.com/aframevr/awesome-aframe/stargazers)
...
* [Primrose](https://github.com/capnmidnight/Primrose/) [![GitHub stars](https://img.shields.io/github/stars/capnmidnight/Primrose/?style=flat)](https://github.com/capnmidnight/Primrose//stargazers) - Rapidly prototype VR applications in your browser.
...
* [Lightgl.js](https://github.com/evanw/lightgl.js) [![GitHub stars](https://img.shields.io/github/stars/evanw/lightgl.js?style=flat)](https://github.com/evanw/lightgl.js/stargazers) - Lightweight and explict library to help prototype.
...
* [Pocket.gl](https://github.com/gportelli/pocket.gl) [![GitHub stars](https://img.shields.io/github/stars/gportelli/pocket.gl?style=flat)](https://github.com/gportelli/pocket.gl/stargazers) - Fully customizable webgl shader sandbox to embed in your pages.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) [![GitHub stars](https://img.shields.io/github/stars/turbulenz/turbulenz_engine?style=flat)](https://github.com/turbulenz/turbulenz_engine/stargazers) - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome-opengl](https://github.com/eug/awesome-opengl) [![GitHub stars](https://img.shields.io/github/stars/eug/awesome-opengl?style=flat)](https://github.com/eug/awesome-opengl/stargazers) - Curated list of awesome OpenGL libraries, debuggers and resources. Inspired by awesome-... stuff.
* [awesome-vulkan](https://github.com/vinjn/awesome-vulkan) [![GitHub stars](https://img.shields.io/github/stars/vinjn/awesome-vulkan?style=flat)](https://github.com/vinjn/awesome-vulkan/stargazers) - Curated list of awesome Vulkan projects and ecosystem.
...
* [glTF](https://github.com/KhronosGroup/glTF) [![GitHub stars](https://img.shields.io/github/stars/KhronosGroup/glTF?style=flat)](https://github.com/KhronosGroup/glTF/stargazers) - Runtime 3D Asset Delivery designed for the web.
...
## Contributing
Please see [CONTRIBUTING](https://github.com/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md/stargazers) for details.

## Testing
Travis CI testing automation thanks to [awesome_bot](https://github.com/dkhamsing/awesome_bot) [![GitHub stars](https://img.shields.io/github/stars/dkhamsing/awesome_bot?style=flat)](https://github.com/dkhamsing/awesome_bot/stargazers)!

## License

[![CC0](http://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

To the extent possible under law, [Spencer Fricke](https://github.com/sjfricke) [![GitHub stars](https://img.shields.io/github/stars/sjfricke?style=flat)](https://github.com/sjfricke/stargazers) has waived all copyright and related or neighboring rights to this work.
