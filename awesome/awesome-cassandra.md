...
This is a curated list of awesome [Cassandra](https://github.com/apache/cassandra) [![GitHub stars](https://img.shields.io/github/stars/apache/cassandra?style=flat)](https://github.com/apache/cassandra/stargazers) packages and resources. Maintained by Rahul Singh of [Anant](http://anant.us). Feel free contact me if you'd like to collaborate on this and other awesome lists. [Awesome Cassandra](https://github.com/Anant/awesome-cassandra) [![GitHub stars](https://img.shields.io/github/stars/Anant/awesome-cassandra?style=flat)](https://github.com/Anant/awesome-cassandra/stargazers) , [Awesome Solr](https://github.com/Anant/awesome-solr) [![GitHub stars](https://img.shields.io/github/stars/Anant/awesome-solr?style=flat)](https://github.com/Anant/awesome-solr/stargazers), [Awesome Lucene](https://github.com/Anant/awesome-lucene) [![GitHub stars](https://img.shields.io/github/stars/Anant/awesome-lucene?style=flat)](https://github.com/Anant/awesome-lucene/stargazers). This powers the *Resources* section of [Cassandra.Link](https://cassandra.link), a rich collection of blog feeds, and curated links as a searchable knowledge base.
...
- [Kaa application based on Raspberry Pi and DHT11 sensor](https://github.com/pyroalf/kaa-cassandra-sample) [![GitHub stars](https://img.shields.io/github/stars/pyroalf/kaa-cassandra-sample?style=flat)](https://github.com/pyroalf/kaa-cassandra-sample/stargazers) - Cassandra IoT usecase with Raspberry Pi and a DHT11 Sensor.
- [Simple Node.js Express 4 Cassandra Application](https://github.com/bradtraversy/mysubscribers) [![GitHub stars](https://img.shields.io/github/stars/bradtraversy/mysubscribers?style=flat)](https://github.com/bradtraversy/mysubscribers/stargazers) - MySubscribers is a very simple application (Start of an application) which allows you to create, read, update and delete users/subscribers. This application was only created to aid the YouTube course.
...
- [ScyllaDB](https://github.com/scylladb/scylla) [![GitHub stars](https://img.shields.io/github/stars/scylladb/scylla?style=flat)](https://github.com/scylladb/scylla/stargazers) - NoSQL data store using the seastar framework, compatible with Cassandra.
- [YugaByte Database](https://github.com/YugaByte/yugabyte-db) [![GitHub stars](https://img.shields.io/github/stars/YugaByte/yugabyte-db?style=flat)](https://github.com/YugaByte/yugabyte-db/stargazers) - YugaByteDB is a transactional, high-performance database for building distributed cloud services. It supports Cassandra-compatible and Redis-compatible APIs, with PostgreSQL in Beta.
...
- [Cassandra Data Copy Tool](https://github.com/wildengineer/cassandra-data-copy-tool) [![GitHub stars](https://img.shields.io/github/stars/wildengineer/cassandra-data-copy-tool?style=flat)](https://github.com/wildengineer/cassandra-data-copy-tool/stargazers) - Java tool to copy data from one cassandra table to another.
- [Spring Data Cassandra Examples](https://github.com/jxblum/spring-data-cassandra-examples) [![GitHub stars](https://img.shields.io/github/stars/jxblum/spring-data-cassandra-examples?style=flat)](https://github.com/jxblum/spring-data-cassandra-examples/stargazers) - Examples for the Spring Data Cassandra Project.
...
- [Import CSV files with spark](https://github.com/markthebault/importCSVSparkCassandra) [![GitHub stars](https://img.shields.io/github/stars/markthebault/importCSVSparkCassandra?style=flat)](https://github.com/markthebault/importCSVSparkCassandra/stargazers) - How to import a file from S3 into cassandra using Spark.
...
- [killrvideo-sample-schema](https://github.com/pmcfadin/killrvideo-sample-schema) [![GitHub stars](https://img.shields.io/github/stars/pmcfadin/killrvideo-sample-schema?style=flat)](https://github.com/pmcfadin/killrvideo-sample-schema/stargazers) - Sample Cassandra CQL Schema for a YouTube clone.
- [Spring Data Cassandra Examples](https://github.com/jxblum/spring-data-cassandra-examples/blob/master/src/main/resources/cassandra-example-schema.cql) [![GitHub stars](https://img.shields.io/github/stars/jxblum/spring-data-cassandra-examples/blob/master/src/main/resources/cassandra-example-schema.cql?style=flat)](https://github.com/jxblum/spring-data-cassandra-examples/blob/master/src/main/resources/cassandra-example-schema.cql/stargazers) - Maven project that contains examples showcasing the features and functionality of the Spring Data Cassandra project.
...
- [Scalar DB](https://github.com/scalar-labs/scalardb) [![GitHub stars](https://img.shields.io/github/stars/scalar-labs/scalardb?style=flat)](https://github.com/scalar-labs/scalardb/stargazers) - Transaction library for Cassandra that makes non-ACID distributed databases/storages ACID-compliant.
...
- [Cassandra backup util](https://github.com/instaclustr/cassandra-backup) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-backup?style=flat)](https://github.com/instaclustr/cassandra-backup/stargazers) - Instaclustr's cassandra backup tool.
- [Cassy](https://github.com/scalar-labs/cassy) [![GitHub stars](https://img.shields.io/github/stars/scalar-labs/cassy?style=flat)](https://github.com/scalar-labs/cassy/stargazers) - Simple and integrated backup tool for Cassandra.
- [Intro to CStar](https://thelastpickle.com/blog/2018/10/01/introduction-to-cstar.html) - Tutorial on how to use CStar.
- [Medusa](https://github.com/thelastpickle/cassandra-medusa) [![GitHub stars](https://img.shields.io/github/stars/thelastpickle/cassandra-medusa?style=flat)](https://github.com/thelastpickle/cassandra-medusa/stargazers) - Cassandra backup system.
...
- [Cassandra Node Diagnostics Tools](https://github.com/smartcat-labs/cassandra-diagnostics) [![GitHub stars](https://img.shields.io/github/stars/smartcat-labs/cassandra-diagnostics?style=flat)](https://github.com/smartcat-labs/cassandra-diagnostics/stargazers) - Monitoring and audit power kit for Cassandra.
...
- [Gatling DSE Stress](https://github.com/datastax/gatling-dse-stress) [![GitHub stars](https://img.shields.io/github/stars/datastax/gatling-dse-stress?style=flat)](https://github.com/datastax/gatling-dse-stress/stargazers) - Tool for stress testing DSE.
- [Gatling DSE Plugin for Gatling Load injector](https://github.com/datastax/gatling-dse-plugin) [![GitHub stars](https://img.shields.io/github/stars/datastax/gatling-dse-plugin?style=flat)](https://github.com/datastax/gatling-dse-plugin/stargazers) - Plugin for the Gatling load injector. It adds CQL support in Gatling for Datastax Enterprise. It allows for benchmarking Datastax Enterprise features, including DSE Graph Fluent API.
- [Gatling DSE Stress Simulation Catalog](https://github.com/datastax/gatling-dse-simcatalog) [![GitHub stars](https://img.shields.io/github/stars/datastax/gatling-dse-simcatalog?style=flat)](https://github.com/datastax/gatling-dse-simcatalog/stargazers) - The goal of the repo is to provide a sample of the Gatling DSE Stress Framework's usage. Feel free to submit a pull request with example simulations.
...
- [LDAP Authenticator for Cassandra](https://github.com/instaclustr/cassandra-ldap) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-ldap?style=flat)](https://github.com/instaclustr/cassandra-ldap/stargazers) - Pluggable authentication implementation for Cassandra, providing a way to authenticate and create users based on a configured LDAP server.
...
- [tlp-cluster, a tool for launching Cassandra clusters in AWS](https://github.com/thelastpickle/tlp-cluster) [![GitHub stars](https://img.shields.io/github/stars/thelastpickle/tlp-cluster?style=flat)](https://github.com/thelastpickle/tlp-cluster/stargazers) - Provisioning tool for Cassandra designed for developers looking to both benchmark and test the correctness of Cassandra. It assists with builds and starting instances on AWS.
...
- [Example code from the Docker Meet Cassandra Article](https://github.com/thelastpickle/docker-cassandra-bootstrap) [![GitHub stars](https://img.shields.io/github/stars/thelastpickle/docker-cassandra-bootstrap?style=flat)](https://github.com/thelastpickle/docker-cassandra-bootstrap/stargazers)
- [Docker-Cassandra](https://github.com/nicolasff/docker-cassandra) [![GitHub stars](https://img.shields.io/github/stars/nicolasff/docker-cassandra?style=flat)](https://github.com/nicolasff/docker-cassandra/stargazers) - Set of scripts and config files to run a Cassandra cluster from Docker.
- [Cassandra & Zeppelin Notebook on Docker](https://github.com/academyofdata/cassandra-zeppelin) [![GitHub stars](https://img.shields.io/github/stars/academyofdata/cassandra-zeppelin?style=flat)](https://github.com/academyofdata/cassandra-zeppelin/stargazers) - Docker-Compose script for Cassandra + Zeppelin setup.
- [Packer: Cassandra Image](https://github.com/cloudurable/cassandra-image) [![GitHub stars](https://img.shields.io/github/stars/cloudurable/cassandra-image?style=flat)](https://github.com/cloudurable/cassandra-image/stargazers) - Cassandra Image using Packer for Docker and EC2 AMI. Covers managing EC2 Cassandra clusters with Ansible.
- [Cassandra Docker](https://github.com/instaclustr/cassandra-docker) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-docker?style=flat)](https://github.com/instaclustr/cassandra-docker/stargazers) - Instaclustr public docker image for Cassandra. It contains docker images for Cassandra 3.0 and 3.11.1.
- [Cassandra / Elassandra Docker](https://github.com/zegelin/cassandra-docker) [![GitHub stars](https://img.shields.io/github/stars/zegelin/cassandra-docker?style=flat)](https://github.com/zegelin/cassandra-docker/stargazers) - Cassandra and Elassandra docker images.Cass Operator is maintained by a team at DataStax and it is part of what powers DataStax Astra.
...
- [Datastax - Cassandra Kubernetes Operator](https://github.com/datastax/cass-operator) [![GitHub stars](https://img.shields.io/github/stars/datastax/cass-operator?style=flat)](https://github.com/datastax/cass-operator/stargazers) - Datastax's Cassandra Kubernetes Operator which supports Datastax as well as open source Cassandra containers on Kubernetes.
- [Instaclustr - Kubernetes Operator for Cassandra](https://github.com/instaclustr/cassandra-operator) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-operator?style=flat)](https://github.com/instaclustr/cassandra-operator/stargazers) - The Cassandra operator manages Cassandra clusters deployed to Kubernetes and automates tasks related to operating an Cassandra cluster.
- [Sky UK - Cassandra Kubernetes Operator](https://github.com/sky-uk/cassandra-operator) [![GitHub stars](https://img.shields.io/github/stars/sky-uk/cassandra-operator?style=flat)](https://github.com/sky-uk/cassandra-operator/stargazers) - Kubernetes operator that manages Cassandra clusters inside Kubernetes. Well designed and organized.
- [CassKop - Cassandra operator for Kubernetes](https://github.com/Orange-OpenSource/cassandra-k8s-operator) [![GitHub stars](https://img.shields.io/github/stars/Orange-OpenSource/cassandra-k8s-operator?style=flat)](https://github.com/Orange-OpenSource/cassandra-k8s-operator/stargazers) - Kubernetes operator automates the Cassandra operations such as deploying a new rack aware cluster, adding/removing nodes, configuring the C and JVM parameters, upgrading JVM and C versions. Written in Go.
- [Strapdata - Elassandra Operator for Kubernetes](https://github.com/strapdata/elassandra-operator) [![GitHub stars](https://img.shields.io/github/stars/strapdata/elassandra-operator?style=flat)](https://github.com/strapdata/elassandra-operator/stargazers) - The Elassandra Kubernetes Operator automates the deployment and management of Elassandra clusters deployed in multiple Kubernetes clusters.
...
- [Kudo Cassandar Operator](https://github.com/mesosphere/kudo-cassandra-operator) [![GitHub stars](https://img.shields.io/github/stars/mesosphere/kudo-cassandra-operator?style=flat)](https://github.com/mesosphere/kudo-cassandra-operator/stargazers) - The KUDO Cassandra Operator makes it easy to deploy and manage Cassandra on Kubernetes.
...
- [Docker container for Kafka - Spark streaming - Cassandra](https://github.com/Yannael/kafka-sparkstreaming-cassandra) [![GitHub stars](https://img.shields.io/github/stars/Yannael/kafka-sparkstreaming-cassandra?style=flat)](https://github.com/Yannael/kafka-sparkstreaming-cassandra/stargazers) - Dockerfile that sets up a complete streaming environment for experimenting with Kafka, Spark streaming (PySpark), and Cassandra.
- [sample KafkaSparkCassandra](https://github.com/instaclustr/sample-KafkaSparkCassandra) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/sample-KafkaSparkCassandra?style=flat)](https://github.com/instaclustr/sample-KafkaSparkCassandra/stargazers) - Introductory sample scala app using Apache Spark Streaming to accept data from Kafka and write a summary to Cassandra.
- [sample Spark Cassandra with SSL](https://github.com/instaclustr/sample-SparkCassandrawithSSL) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/sample-SparkCassandrawithSSL?style=flat)](https://github.com/instaclustr/sample-SparkCassandrawithSSL/stargazers) - Simple sample job illustrating the use of Spark to execute Apache Spark analytics with Cassandra with SSL connection.
...
- [DataStax C# Driver](https://github.com/datastax/csharp-driver) [![GitHub stars](https://img.shields.io/github/stars/datastax/csharp-driver?style=flat)](https://github.com/datastax/csharp-driver/stargazers) - C# Driver for Cassandra from DataStax.
...
- [DataStax Spark Cassandra Connector](https://github.com/datastax/spark-cassandra-connector) [![GitHub stars](https://img.shields.io/github/stars/datastax/spark-cassandra-connector?style=flat)](https://github.com/datastax/spark-cassandra-connector/stargazers) - Library that lets you expose Cassandra tables as Spark RDDs, write Spark RDDs to Cassandra tables, and execute arbitrary CQL queries in your Spark applications.
- [sample Spark Job Server Cassandra](https://github.com/instaclustr/sample-SparkJobserverCassandra) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/sample-SparkJobserverCassandra?style=flat)](https://github.com/instaclustr/sample-SparkJobserverCassandra/stargazers) - Simple sample job illustrating the use of Spark Jobserver to execute Apache Spark analytics with Cassandra.
- [fluxcapacitor/pipeline](https://github.com/fluxcapacitor/pipeline) [![GitHub stars](https://img.shields.io/github/stars/fluxcapacitor/pipeline?style=flat)](https://github.com/fluxcapacitor/pipeline/stargazers) - End-to-End, Real-time, Advanced Analytics Big Data Reference Pipeline using Spark, Spark SQL, Spark ML, GraphX, Spark Streaming, Kafka, NiFi, Cassandra, ElasticSearch, Redis, Tachyon, HDFS, Zeppelin, iPython/Jupyter Notebook, Tableau, Twitter Algebird.
...
- [Cassandra Lucene Index](https://github.com/Stratio/cassandra-lucene-index) [![GitHub stars](https://img.shields.io/github/stars/Stratio/cassandra-lucene-index?style=flat)](https://github.com/Stratio/cassandra-lucene-index/stargazers) - Lucene based secondary indexes for Cassandra.
- [Elassandra](http://www.elassandra.io/) - Elassandra = Elasticsearch as a Cassandra secondary index.
- [cassandra-trigger](https://github.com/gradeup/cassandra-trigger) [![GitHub stars](https://img.shields.io/github/stars/gradeup/cassandra-trigger?style=flat)](https://github.com/gradeup/cassandra-trigger/stargazers) - Cassandra trigger to push realtime updates to elasticsearch.
...
- [cortexproject/cortex](https://github.com/cortexproject/cortex) [![GitHub stars](https://img.shields.io/github/stars/cortexproject/cortex?style=flat)](https://github.com/cortexproject/cortex/stargazers) - Horizontally scalable, highly available, multi-tenant, long term Prometheus storage.
- [filodb/FiloDB](https://github.com/filodb/FiloDB) [![GitHub stars](https://img.shields.io/github/stars/filodb/FiloDB?style=flat)](https://github.com/filodb/FiloDB/stargazers) - Distributed Prometheus time-series database compatible with Prometheus queries.
- [cybem/cyanite-iow](https://github.com/cybem/cyanite-iow) [![GitHub stars](https://img.shields.io/github/stars/cybem/cyanite-iow?style=flat)](https://github.com/cybem/cyanite-iow/stargazers) - Cassandra backed Carbon daemon and metric web service. IPONWEB repository, compatible with Carbon.

#### Custom Time Series

- [kairosdb/kairosdb](https://github.com/kairosdb/kairosdb) [![GitHub stars](https://img.shields.io/github/stars/kairosdb/kairosdb?style=flat)](https://github.com/kairosdb/kairosdb/stargazers) - Fast scalable time series database. 
...
- [OpenNMS/newts](https://github.com/OpenNMS/newts) [![GitHub stars](https://img.shields.io/github/stars/OpenNMS/newts?style=flat)](https://github.com/OpenNMS/newts/stargazers) - New-fangled Timeseries Data Store that powers OpenNMS.
- [Hawkular.org](https://www.hawkular.org/) - Time series / distributed tracing database powered by Cassandra by Redhat.
- [Hawkular GitHub](https://github.com/hawkular) [![GitHub stars](https://img.shields.io/github/stars/hawkular?style=flat)](https://github.com/hawkular/stargazers) - Hawkular's GitHub resources.
- [OpenTSDB/opentsdb](https://github.com/OpenTSDB/opentsdb) [![GitHub stars](https://img.shields.io/github/stars/OpenTSDB/opentsdb?style=flat)](https://github.com/OpenTSDB/opentsdb/stargazers) - GitHub resources for OpenTSDB. A Distributed, Scalable Monitoring System built on a Time Series Database.
...
- [Thinkaurelius/Titan](https://github.com/thinkaurelius/titan) [![GitHub stars](https://img.shields.io/github/stars/thinkaurelius/titan?style=flat)](https://github.com/thinkaurelius/titan/stargazers) - Distributed Graph Database, predecessor to DSE Graph, JanusGraph, and now HugeGraph.
- [Introduction to TitanDB](https://www.slideshare.net/knoldus/introduction-to-titandb) - Introductory slides about TitanDB.
- [JanusGraph/janusgraph](https://github.com/JanusGraph/janusgraph) [![GitHub stars](https://img.shields.io/github/stars/JanusGraph/janusgraph?style=flat)](https://github.com/JanusGraph/janusgraph/stargazers) - JanusGraph: an open-source, distributed graph database, successor to TitanDB.
...
- [Hugegraph/Hugegraph](https://github.com/hugegraph/hugegraph) [![GitHub stars](https://img.shields.io/github/stars/hugegraph/hugegraph?style=flat)](https://github.com/hugegraph/hugegraph/stargazers) - HugeGraph Database core component, including graph engine, API, and built-in backends.
...
- [Stargate](https://github.com/stargate/stargate) [![GitHub stars](https://img.shields.io/github/stars/stargate/stargate?style=flat)](https://github.com/stargate/stargate/stargazers) - Stargate is an open-source data gateway that provides REST, GraphQL and schemaless JSON interfaces to Cassandra.
...
- [Apache/Usergrid](https://github.com/apache/usergrid) [![GitHub stars](https://img.shields.io/github/stars/apache/usergrid?style=flat)](https://github.com/apache/usergrid/stargazers) - Open source Backend as a Service (BaaS) on Cassandra, Elasticsearch with client SDKs for iOS/Android/.NET/Java.
...
- [Scalar-labs/Scalardl](https://github.com/scalar-labs/scalardl) [![GitHub stars](https://img.shields.io/github/stars/scalar-labs/scalardl?style=flat)](https://github.com/scalar-labs/scalardl/stargazers) - Tamper-evident and scalable distributed ledger platform.
- [Wikimedia/Restbase](https://github.com/wikimedia/restbase) [![GitHub stars](https://img.shields.io/github/stars/wikimedia/restbase?style=flat)](https://github.com/wikimedia/restbase/stargazers) -  Distributed storage with REST API &amp; dispatcher for backend services.
- [Wikimedia/restbase-mod-table-spec](https://github.com/wikimedia/restbase-mod-table-spec) [![GitHub stars](https://img.shields.io/github/stars/wikimedia/restbase-mod-table-spec?style=flat)](https://github.com/wikimedia/restbase-mod-table-spec/stargazers) - Shared spec and tests for RESTBase table storage.

## Packages

### Libraries

- [express-cassandra](https://github.com/masumsoft/express-cassandra) [![GitHub stars](https://img.shields.io/github/stars/masumsoft/express-cassandra?style=flat)](https://github.com/masumsoft/express-cassandra/stargazers) - Cassandra ORM/ODM/OGM for Node.js with optional support for Elassandra & JanusGraph.
- [DataStax Java Driver](https://github.com/datastax/java-driver) [![GitHub stars](https://img.shields.io/github/stars/datastax/java-driver?style=flat)](https://github.com/datastax/java-driver/stargazers) - Java client driver for Cassandra.
- [DataStax C++ Driver](https://github.com/datastax/cpp-driver) [![GitHub stars](https://img.shields.io/github/stars/datastax/cpp-driver?style=flat)](https://github.com/datastax/cpp-driver/stargazers) - Modern, feature-rich, and highly tunable C/C++ client library for Cassandra (1.2+) and DataStax Enterprise (3.1+) using exclusively Cassandra's native protocol and Cassandra Query Language v3.
- [DataStax Python Driver](https://github.com/datastax/python-driver) [![GitHub stars](https://img.shields.io/github/stars/datastax/python-driver?style=flat)](https://github.com/datastax/python-driver/stargazers) - Modern, feature-rich and highly-tunable Python client library for Cassandra (2.1+) using exclusively Cassandra's binary protocol and Cassandra Query Language v3.
- [DataStax Ruby Driver](https://github.com/datastax/ruby-driver) [![GitHub stars](https://img.shields.io/github/stars/datastax/ruby-driver?style=flat)](https://github.com/datastax/ruby-driver/stargazers) - Ruby client driver for Cassandra. This driver works exclusively with the Cassandra Query Language version 3 (CQL3) and Cassandra's native protocol.
- [DataStax Node.js Driver](https://github.com/datastax/nodejs-driver) [![GitHub stars](https://img.shields.io/github/stars/datastax/nodejs-driver?style=flat)](https://github.com/datastax/nodejs-driver/stargazers) - Modern, feature-rich and highly tunable Node.js client library for Cassandra (1.2+) and DataStax Enterprise (3.1+) using exclusively Cassandra's binary protocol and Cassandra Query Language v3.
- [DataStax C# Driver](https://github.com/datastax/csharp-driver) [![GitHub stars](https://img.shields.io/github/stars/datastax/csharp-driver?style=flat)](https://github.com/datastax/csharp-driver/stargazers) - Modern, feature-rich and highly tunable C# client library for Cassandra (1.2+) and DataStax Enterprise (3.1+) using exclusively Cassandra's binary protocol and Cassandra Query Language v3.
- [DataStax PHP Driver](https://github.com/datastax/php-driver) [![GitHub stars](https://img.shields.io/github/stars/datastax/php-driver?style=flat)](https://github.com/datastax/php-driver/stargazers) - DataStax PHP Driver for Cassandra.
...
- [phpcassa](https://github.com/thobbs/phpcassa) [![GitHub stars](https://img.shields.io/github/stars/thobbs/phpcassa?style=flat)](https://github.com/thobbs/phpcassa/stargazers) - PHP client library for Cassandra.
...
- [gocql](https://github.com/gocql/gocql) [![GitHub stars](https://img.shields.io/github/stars/gocql/gocql?style=flat)](https://github.com/gocql/gocql/stargazers) - Package gocql implements a fast and robust Cassandra client for the Go programming language.
...
- [Datastax - Management API for Cassandra](https://github.com/datastax/management-api-for-apache-cassandra) [![GitHub stars](https://img.shields.io/github/stars/datastax/management-api-for-apache-cassandra?style=flat)](https://github.com/datastax/management-api-for-apache-cassandra/stargazers) - The Management API is a sidecar service layer that attempts to build a well supported set of operational actions on Cassandra® nodes that can be administered centrally.
...
- [CassandraCAS](https://github.com/Datomic/CassandraCAS) [![GitHub stars](https://img.shields.io/github/stars/Datomic/CassandraCAS?style=flat)](https://github.com/Datomic/CassandraCAS/stargazers) - Compare-and-swap tool for Cassandra created by Datomic.
- [Peloton](https://github.com/uber/peloton) [![GitHub stars](https://img.shields.io/github/stars/uber/peloton?style=flat)](https://github.com/uber/peloton/stargazers) - Unified resource scheduler created by Uber. This tool can handle many nodes and clusters through resource management and scalability.
- [Ansible-Galaxy: Cassandra GitHub](https://github.com/ansible-collections/community.cassandra) [![GitHub stars](https://img.shields.io/github/stars/ansible-collections/community.cassandra?style=flat)](https://github.com/ansible-collections/community.cassandra/stargazers) - Collection called cassandra that aims at providing all Ansible modules allowed to interact with Cassandra. 
- [Ansible-Galaxy: Cassandra](https://galaxy.ansible.com/community/cassandra) - Documentation for Ansible-Galaxy: Cassandra.
- [Ansible-dse](https://github.com/rackerlabs/ansible-dse) [![GitHub stars](https://img.shields.io/github/stars/rackerlabs/ansible-dse?style=flat)](https://github.com/rackerlabs/ansible-dse/stargazers) - Set of Ansible playbooks that will build a Datastax Enterprise cluster.
- [dseansible](https://github.com/yabinmeng/dseansible) [![GitHub stars](https://img.shields.io/github/stars/yabinmeng/dseansible?style=flat)](https://github.com/yabinmeng/dseansible/stargazers) - DSE Installation and Upgrade Ansible Playbooks/Roles for Ubuntu Linux.
...
- [cstar perf](https://github.com/datastax/cstar_perf) [![GitHub stars](https://img.shields.io/github/stars/datastax/cstar_perf?style=flat)](https://github.com/datastax/cstar_perf/stargazers) - Cassandra performance testing platform.
- [Spark Cassandra Stress](https://github.com/datastax/spark-cassandra-stress) [![GitHub stars](https://img.shields.io/github/stars/datastax/spark-cassandra-stress?style=flat)](https://github.com/datastax/spark-cassandra-stress/stargazers) - Tool for testing the DataStax Spark Connector against Cassandra or DSE.
- [cqlmigrate](https://github.com/sky-uk/cqlmigrate) [![GitHub stars](https://img.shields.io/github/stars/sky-uk/cqlmigrate?style=flat)](https://github.com/sky-uk/cqlmigrate/stargazers) -  Cassandra CQL migration tool. cqlmigrate is a library for performing schema migrations on a cassandra cluster.
- [cassandra-migration-tool-java](https://github.com/smartcat-labs/cassandra-migration-tool-java) [![GitHub stars](https://img.shields.io/github/stars/smartcat-labs/cassandra-migration-tool-java?style=flat)](https://github.com/smartcat-labs/cassandra-migration-tool-java/stargazers) - Cassandra migration tool for java is a lightweight tool used to execute schema and data migration on Cassandra database.
- [Cassalog](https://github.com/hawkular/cassalog) [![GitHub stars](https://img.shields.io/github/stars/hawkular/cassalog?style=flat)](https://github.com/hawkular/cassalog/stargazers) - Cassalog is a schema change management library and tool for Cassandra that can be used with applications running on the JVM.
- [cdeploy](https://github.com/rackerlabs/cdeploy) [![GitHub stars](https://img.shields.io/github/stars/rackerlabs/cdeploy?style=flat)](https://github.com/rackerlabs/cdeploy/stargazers) - Cdeploy is a simple tool to manage your Cassandra schema migrations in the style of dbdeploy.
...
- [CassanddraRestfulAPI](https://github.com/rohitsakala/CassandraRestfulAPI) [![GitHub stars](https://img.shields.io/github/stars/rohitsakala/CassandraRestfulAPI?style=flat)](https://github.com/rohitsakala/CassandraRestfulAPI/stargazers) - CassandraRestfulAPI project exposes the cassandra data tables with the help of Restful API.
- [Netflix: Staash](https://github.com/Netflix/staash) [![GitHub stars](https://img.shields.io/github/stars/Netflix/staash?style=flat)](https://github.com/Netflix/staash/stargazers) - Language-agnostic as well as storage-agnostic web interface for storing data into persistent storage systems, the metadata layer abstracts a lot of storage details and the pattern automation APIs take care of automating common data access patterns.
- [cql-vim](https://github.com/elubow/cql-vim) [![GitHub stars](https://img.shields.io/github/stars/elubow/cql-vim?style=flat)](https://github.com/elubow/cql-vim/stargazers) - Cassandra CQL Syntax Highlighter for Vim.
...
- [SSTable Tools](https://github.com/tolbertam/sstable-tools) [![GitHub stars](https://img.shields.io/github/stars/tolbertam/sstable-tools?style=flat)](https://github.com/tolbertam/sstable-tools/stargazers) - Toolkit for parsing, creating and doing other fun stuff with Cassandra 3.x SSTables.
- [Cassandra-Exporter](https://github.com/masumsoft/cassandra-exporter) [![GitHub stars](https://img.shields.io/github/stars/masumsoft/cassandra-exporter?style=flat)](https://github.com/masumsoft/cassandra-exporter/stargazers) - Simple Tool to Export / Import Cassandra Tables into JSON.
- [Cassandra SStable Tools](https://github.com/instaclustr/cassandra-sstable-tools) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-sstable-tools?style=flat)](https://github.com/instaclustr/cassandra-sstable-tools/stargazers) - Multiple different tools combined into one that helps admins get summaries, metadata, partition info, cell info.
- [Cassandra-Client](https://github.com/Kindrat/cassandra-client) [![GitHub stars](https://img.shields.io/github/stars/Kindrat/cassandra-client?style=flat)](https://github.com/Kindrat/cassandra-client/stargazers) - Simple gui tool for browsing tables and data in Cassandra.
...
- [Cassandra Snapshot Backup](https://github.com/avinash-mishra/cassandra_snapshot_backup) [![GitHub stars](https://img.shields.io/github/stars/avinash-mishra/cassandra_snapshot_backup?style=flat)](https://github.com/avinash-mishra/cassandra_snapshot_backup/stargazers) - Quick and easy way to snapshot files in a Cassandra database and back them up using Ansible.
- [Slothsandra](https://github.com/MacKittipat/slothsandra) [![GitHub stars](https://img.shields.io/github/stars/MacKittipat/slothsandra?style=flat)](https://github.com/MacKittipat/slothsandra/stargazers) - Integration for Cassandra with the Slack app, which stores old messages that Slack no longer does itself.
- [sandraREST](https://github.com/aksakalli/sandraREST) [![GitHub stars](https://img.shields.io/github/stars/aksakalli/sandraREST?style=flat)](https://github.com/aksakalli/sandraREST/stargazers) - Cassandra manager with a web UI for RESTful APIs.
- [Cassandra Leadership](https://github.com/paradoxical-io/cassandra.leadership) [![GitHub stars](https://img.shields.io/github/stars/paradoxical-io/cassandra.leadership?style=flat)](https://github.com/paradoxical-io/cassandra.leadership/stargazers) - Library to help elect leaders using cassandra. Uses paxos to build a leadership election module.
- [Terraform Cassandra](https://github.com/conrad-mukai/terraform-cassandra) [![GitHub stars](https://img.shields.io/github/stars/conrad-mukai/terraform-cassandra?style=flat)](https://github.com/conrad-mukai/terraform-cassandra/stargazers) - Terraform module that creates a Cassandra cluster.
...
- [Helenos](https://github.com/tomekkup/helenos) [![GitHub stars](https://img.shields.io/github/stars/tomekkup/helenos?style=flat)](https://github.com/tomekkup/helenos/stargazers) - Free web based environment that simplifies a data exploring & schema management with Cassandra database.
- [ValuStor](https://github.com/Sensaphone/ValuStor) [![GitHub stars](https://img.shields.io/github/stars/Sensaphone/ValuStor?style=flat)](https://github.com/Sensaphone/ValuStor/stargazers) - ValuStor is a key-value pair database solution.
- [Cassandra-Migration](https://github.com/hhandoko/cassandra-migration) [![GitHub stars](https://img.shields.io/github/stars/hhandoko/cassandra-migration?style=flat)](https://github.com/hhandoko/cassandra-migration/stargazers) - Cassandra / DataStax Enterprise database migration (schema evolution) library.
- [JanuesGraph-Utils](https://github.com/IBM/janusgraph-utils) [![GitHub stars](https://img.shields.io/github/stars/IBM/janusgraph-utils?style=flat)](https://github.com/IBM/janusgraph-utils/stargazers) - Tool to Develop a graph database app.
- [Scylla-Migrator](https://github.com/scylladb/scylla-migrator) [![GitHub stars](https://img.shields.io/github/stars/scylladb/scylla-migrator?style=flat)](https://github.com/scylladb/scylla-migrator/stargazers) - Migrate data extract using Spark to Scylla, normally from Cassandra.
- [Cassandra CA Manager](https://github.com/eevans/cassandra-ca-manager) [![GitHub stars](https://img.shields.io/github/stars/eevans/cassandra-ca-manager?style=flat)](https://github.com/eevans/cassandra-ca-manager/stargazers) - Create and sign Java keystores.
- [Zipkin](https://github.com/openzipkin/zipkin) [![GitHub stars](https://img.shields.io/github/stars/openzipkin/zipkin?style=flat)](https://github.com/openzipkin/zipkin/stargazers) - Distributed tracing system.
- [Instaclustr Kerberos plugin](https://github.com/instaclustr/cassandra-kerberos) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-kerberos?style=flat)](https://github.com/instaclustr/cassandra-kerberos/stargazers) - GSSAPI authentication provider for Cassandra.
- [Instaclustr Java Driver for Kerberos](https://github.com/instaclustr/cassandra-java-driver-kerberos) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-java-driver-kerberos?style=flat)](https://github.com/instaclustr/cassandra-java-driver-kerberos/stargazers) - GSSAPI authentication provider for the Cassandra Java driver.
- [Instaclustr Minotaur](https://github.com/instaclustr/instaclustr-minotaur) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/instaclustr-minotaur?style=flat)](https://github.com/instaclustr/instaclustr-minotaur/stargazers) - Command line tool for consistent rebuilding of a Cassandra cluster.
- [Instaclustr TTL Remover](https://github.com/instaclustr/cassandra-ttl-remover) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-ttl-remover?style=flat)](https://github.com/instaclustr/cassandra-ttl-remover/stargazers) - Command line tool for rewriting SSTables to remove TTLs.
- [Instaclustr SSTable Generator](https://github.com/instaclustr/cassandra-sstable-generator) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-sstable-generator?style=flat)](https://github.com/instaclustr/cassandra-sstable-generator/stargazers) - CLI tool for programmatic generation of Cassandra SSTables.
- [Instaclustr Exporter](https://github.com/instaclustr/cassandra-exporter) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/cassandra-exporter?style=flat)](https://github.com/instaclustr/cassandra-exporter/stargazers) - Java agent that exports Cassandra metrics to Prometheus.
- [Instaclustr Go Client for Instaclustr Icarus](https://github.com/instaclustr/instaclustr-icarus-go-client) [![GitHub stars](https://img.shields.io/github/stars/instaclustr/instaclustr-icarus-go-client?style=flat)](https://github.com/instaclustr/instaclustr-icarus-go-client/stargazers) - Go client for Instaclustr Icarus sidecar.

### Open Source Applications

- [Twissandra](https://github.com/twissandra/twissandra) [![GitHub stars](https://img.shields.io/github/stars/twissandra/twissandra?style=flat)](https://github.com/twissandra/twissandra/stargazers) - Twissandra is an example project, created to learn and demonstrate how to use Cassandra. Running the project will present a website that has similar functionality to Twitter.
- [ChronoServer](https://github.com/cyngn/ChronoServer) [![GitHub stars](https://img.shields.io/github/stars/cyngn/ChronoServer?style=flat)](https://github.com/cyngn/ChronoServer/stargazers) - Test server for sampling how long it takes mobile & web clients to make various types of requests to a server doing common request patterns.
- [Cassandra Cluster Admin](https://github.com/sebgiroux/Cassandra-Cluster-Admin) [![GitHub stars](https://img.shields.io/github/stars/sebgiroux/Cassandra-Cluster-Admin?style=flat)](https://github.com/sebgiroux/Cassandra-Cluster-Admin/stargazers) - Cassandra Cluster Admin is a GUI tool to help people administrate their Cassandra cluster.
- [Cassandra-Tools](https://github.com/CrowdStrike/cassandra-tools) [![GitHub stars](https://img.shields.io/github/stars/CrowdStrike/cassandra-tools?style=flat)](https://github.com/CrowdStrike/cassandra-tools/stargazers) - Python Fabric scripts to help automate the launching and managing of cluster testing on AWS.
- [Cassandra Opstools](https://github.com/spotify/cassandra-opstools) [![GitHub stars](https://img.shields.io/github/stars/spotify/cassandra-opstools?style=flat)](https://github.com/spotify/cassandra-opstools/stargazers) - Generic scripts to review and monitor cassandra, from Spotify.  
- [CCM: Cassandra Cluster Manager)](https://github.com/pcmanus/ccm) [![GitHub stars](https://img.shields.io/github/stars/pcmanus/ccm?style=flat)](https://github.com/pcmanus/ccm/stargazers) - Script/library to create, launch and remove an Cassandra cluster on localhost.
- [Netflix-Priam](https://github.com/Netflix/Priam) [![GitHub stars](https://img.shields.io/github/stars/Netflix/Priam?style=flat)](https://github.com/Netflix/Priam/stargazers) - Co-Process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
- [CStar](https://github.com/spotify/cstar) [![GitHub stars](https://img.shields.io/github/stars/spotify/cstar?style=flat)](https://github.com/spotify/cstar/stargazers) - Cassandra cluster orchestration tool for the command line.
- [CMB](https://github.com/Comcast/cmb) [![GitHub stars](https://img.shields.io/github/stars/Comcast/cmb?style=flat)](https://github.com/Comcast/cmb/stargazers) - Highly available, horizontally scalable queuing and notification service compatible with AWS SQS and SNS.
- [CassieQ](https://github.com/paradoxical-io/cassieq) [![GitHub stars](https://img.shields.io/github/stars/paradoxical-io/cassieq?style=flat)](https://github.com/paradoxical-io/cassieq/stargazers) - Distributed queue built off of Cassandra.
- [Cherami](https://eng.uber.com/cherami/) - Distributed, scalable, durable, and highly available message queue system.
- [Scheduler](https://github.com/PagerDuty/scheduler) [![GitHub stars](https://img.shields.io/github/stars/PagerDuty/scheduler?style=flat)](https://github.com/PagerDuty/scheduler/stargazers) - Scala library for scheduling arbitrary code to run at an arbitrary time.

### Logging /Metrics

- [cassandra-log4j-appender](https://github.com/datastax/cassandra-log4j-appender) [![GitHub stars](https://img.shields.io/github/stars/datastax/cassandra-log4j-appender?style=flat)](https://github.com/datastax/cassandra-log4j-appender/stargazers) - Cassandra appenders for Log4j.
- [Metrics Collector for Cassandra](https://github.com/datastax/metric-collector-for-apache-cassandra) [![GitHub stars](https://img.shields.io/github/stars/datastax/metric-collector-for-apache-cassandra?style=flat)](https://github.com/datastax/metric-collector-for-apache-cassandra/stargazers) - Metric collection and Dashboards for Cassandra (2.2, 3.0, 3.11, 4.0) clusters. Comes with dashboards for Graphana.
- [Cassandra Log Tools](https://github.com/erickramirezDSE/cass_log_tools) [![GitHub stars](https://img.shields.io/github/stars/erickramirezDSE/cass_log_tools?style=flat)](https://github.com/erickramirezDSE/cass_log_tools/stargazers) - Simple scripts for working with Cassandra logs.
- [Cassandra CFStats to CSV Parser](https://github.com/jlacefie/cfstats-csv-parser) [![GitHub stars](https://img.shields.io/github/stars/jlacefie/cfstats-csv-parser?style=flat)](https://github.com/jlacefie/cfstats-csv-parser/stargazers) - Converts the output of CFStats to CSV.
- [Cassandra Nagios](https://github.com/causes/cassandra-nagios) [![GitHub stars](https://img.shields.io/github/stars/causes/cassandra-nagios?style=flat)](https://github.com/causes/cassandra-nagios/stargazers) - Perl Based scripts to get metrics for monitoring using Jolokia.
- [ctop](https://github.com/pixonic/ctop) [![GitHub stars](https://img.shields.io/github/stars/pixonic/ctop?style=flat)](https://github.com/pixonic/ctop/stargazers) - Very simple console tool for monitoring column families read/write activities at remote cassandra host.
- [Cassandra StatD Agent](https://github.com/lookout/cassandra-statsd-agent) [![GitHub stars](https://img.shields.io/github/stars/lookout/cassandra-statsd-agent?style=flat)](https://github.com/lookout/cassandra-statsd-agent/stargazers) - Java Agent for Cassandra integration with StatsD.
...
- [HAPI Cassandra](https://github.com/victorcouste/hapi-cassandra) [![GitHub stars](https://img.shields.io/github/stars/victorcouste/hapi-cassandra?style=flat)](https://github.com/victorcouste/hapi-cassandra/stargazers) - Simple REST API with hapi Node.js framework on top of a Cassandra database.
