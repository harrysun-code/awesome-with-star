...
If you are seeking a skilled DevOps lead or architect to enhance your project, I invite you to connect with me on [LinkedIn](https://www.linkedin.com/in/filipp-frizzy-289a0360/) or explore my valuable contributions on [GitHub](https://github.com/Friz-zy/) [![GitHub stars](https://img.shields.io/github/stars/Friz-zy/?style=flat)](https://github.com/Friz-zy//stargazers). Let's collaborate and create some cool solutions together :)
...
* [Open Container Specifications](https://github.com/opencontainers/specs) [![GitHub stars](https://img.shields.io/github/stars/opencontainers/specs?style=flat)](https://github.com/opencontainers/specs/stargazers)  
This project is where the Open Container Initiative Specifications are written. This is a work in progress. 
* [App Container basics](https://github.com/coreos/rkt/blob/master/Documentation/app-container.md) [![GitHub stars](https://img.shields.io/github/stars/coreos/rkt/blob/master/Documentation/app-container.md?style=flat)](https://github.com/coreos/rkt/blob/master/Documentation/app-container.md/stargazers)  
...
* [Nulecule Specification](https://github.com/projectatomic/atomicapp/tree/master/docs/spec) [![GitHub stars](https://img.shields.io/github/stars/projectatomic/atomicapp/tree/master/docs/spec?style=flat)](https://github.com/projectatomic/atomicapp/tree/master/docs/spec/stargazers)  
...
* [Cloud Native Application Bundle Specification](https://github.com/deislabs/cnab-spec) [![GitHub stars](https://img.shields.io/github/stars/deislabs/cnab-spec?style=flat)](https://github.com/deislabs/cnab-spec/stargazers)  
...
* [Warden](https://github.com/cloudfoundry/warden) [![GitHub stars](https://img.shields.io/github/stars/cloudfoundry/warden?style=flat)](https://github.com/cloudfoundry/warden/stargazers)  
...
* [Photon](https://github.com/vmware/photon) [![GitHub stars](https://img.shields.io/github/stars/vmware/photon?style=flat)](https://github.com/vmware/photon/stargazers)  
...
* [MultiDocker](https://github.com/marty90/multidocker) [![GitHub stars](https://img.shields.io/github/stars/marty90/multidocker?style=flat)](https://github.com/marty90/multidocker/stargazers)  
Create a secure multi-user Docker machine, where each user is segregated into an indepentent container.
* [Lithos](https://github.com/tailhook/lithos/) [![GitHub stars](https://img.shields.io/github/stars/tailhook/lithos/?style=flat)](https://github.com/tailhook/lithos//stargazers)  
...
* [runc](https://github.com/opencontainers/runc) [![GitHub stars](https://img.shields.io/github/stars/opencontainers/runc?style=flat)](https://github.com/opencontainers/runc/stargazers)  
runc is a CLI tool for spawning and running containers according to the OCS specification.
* [Bocker](https://github.com/p8952/bocker) [![GitHub stars](https://img.shields.io/github/stars/p8952/bocker?style=flat)](https://github.com/p8952/bocker/stargazers)  
Docker implemented in around 100 lines of bash.
* [Rocket](https://github.com/coreos/rkt) [![GitHub stars](https://img.shields.io/github/stars/coreos/rkt?style=flat)](https://github.com/coreos/rkt/stargazers)  
...
* [LXC](https://github.com/lxc/lxc) [![GitHub stars](https://img.shields.io/github/stars/lxc/lxc?style=flat)](https://github.com/lxc/lxc/stargazers)  
LXC is the well known set of tools, templates, library and language bindings. It's pretty low level, very flexible and covers just about every containment feature supported by the upstream kernel.
* [Vagga](https://github.com/tailhook/vagga) [![GitHub stars](https://img.shields.io/github/stars/tailhook/vagga?style=flat)](https://github.com/tailhook/vagga/stargazers)  
Vagga is a fully-userspace container engine inspired by Vagrant and Docker, specialized for development environments.
* [libct](https://github.com/xemul/libct) [![GitHub stars](https://img.shields.io/github/stars/xemul/libct?style=flat)](https://github.com/xemul/libct/stargazers)  
...
* [porto](https://github.com/yandex/porto) [![GitHub stars](https://img.shields.io/github/stars/yandex/porto?style=flat)](https://github.com/yandex/porto/stargazers)  
...
* [udocker](https://github.com/indigo-dc/udocker) [![GitHub stars](https://img.shields.io/github/stars/indigo-dc/udocker?style=flat)](https://github.com/indigo-dc/udocker/stargazers)  
A basic user tool to execute simple containers in batch or interactive systems without root privileges.
* [Let Me Contain That For You](https://github.com/google/lmctfy) [![GitHub stars](https://img.shields.io/github/stars/google/lmctfy?style=flat)](https://github.com/google/lmctfy/stargazers)  
LMCTFY is the open source version of Google’s container stack, which provides Linux application containers.
* [cc-oci-runtime](https://github.com/01org/cc-oci-runtime) [![GitHub stars](https://img.shields.io/github/stars/01org/cc-oci-runtime?style=flat)](https://github.com/01org/cc-oci-runtime/stargazers)  
Intel Clear Linux OCI (Open Containers Initiative) compatible runtime.
* [railcar](https://github.com/oracle/railcar) [![GitHub stars](https://img.shields.io/github/stars/oracle/railcar?style=flat)](https://github.com/oracle/railcar/stargazers)  
...
* [plash](https://github.com/ihucos/plash/) [![GitHub stars](https://img.shields.io/github/stars/ihucos/plash/?style=flat)](https://github.com/ihucos/plash//stargazers)  
Lightweight, rootless containers.
* [runv](https://github.com/hyperhq/runv) [![GitHub stars](https://img.shields.io/github/stars/hyperhq/runv?style=flat)](https://github.com/hyperhq/runv/stargazers)  
Hypervisor-based (KVM, Xen, QEMU) Runtime for OCI. Security by isolation.
* [podman](https://github.com/containers/libpod) [![GitHub stars](https://img.shields.io/github/stars/containers/libpod?style=flat)](https://github.com/containers/libpod/stargazers)  
Full management of container lifecycle.
* [firecracker](https://github.com/firecracker-microvm/firecracker) [![GitHub stars](https://img.shields.io/github/stars/firecracker-microvm/firecracker?style=flat)](https://github.com/firecracker-microvm/firecracker/stargazers)  
Firecracker runs workloads in lightweight virtual machines, called microVMs, which combine the security and isolation properties provided by hardware virtualization technology with the speed and flexibility of containers.
* [sysbox](https://github.com/nestybox/sysbox) [![GitHub stars](https://img.shields.io/github/stars/nestybox/sysbox?style=flat)](https://github.com/nestybox/sysbox/stargazers)  
...
* [youki](https://github.com/containers/youki) [![GitHub stars](https://img.shields.io/github/stars/containers/youki?style=flat)](https://github.com/containers/youki/stargazers)  
A container runtime written in Rust.
* [footloose](https://github.com/weaveworks/footloose) [![GitHub stars](https://img.shields.io/github/stars/weaveworks/footloose?style=flat)](https://github.com/weaveworks/footloose/stargazers)  
...
* [NsJail](https://github.com/google/nsjail) [![GitHub stars](https://img.shields.io/github/stars/google/nsjail?style=flat)](https://github.com/google/nsjail/stargazers)  
...
* [Subuser](https://github.com/subuser-security/subuser) [![GitHub stars](https://img.shields.io/github/stars/subuser-security/subuser?style=flat)](https://github.com/subuser-security/subuser/stargazers)  
...
* [Bubblewrap](https://github.com/projectatomic/bubblewrap) [![GitHub stars](https://img.shields.io/github/stars/projectatomic/bubblewrap?style=flat)](https://github.com/projectatomic/bubblewrap/stargazers)  
...
* [singularity](https://github.com/singularityware/singularity) [![GitHub stars](https://img.shields.io/github/stars/singularityware/singularity?style=flat)](https://github.com/singularityware/singularity/stargazers)  
Universal application containers for Linux.
* [Lxroot](https://github.com/parke/lxroot) [![GitHub stars](https://img.shields.io/github/stars/parke/lxroot?style=flat)](https://github.com/parke/lxroot/stargazers)  
...
* [python-nsenter](https://github.com/zalando/python-nsenter) [![GitHub stars](https://img.shields.io/github/stars/zalando/python-nsenter?style=flat)](https://github.com/zalando/python-nsenter/stargazers)  
...
* [pyspaces](https://github.com/Friz-zy/pyspaces) [![GitHub stars](https://img.shields.io/github/stars/Friz-zy/pyspaces?style=flat)](https://github.com/Friz-zy/pyspaces/stargazers)  
...
* [container-diff](https://github.com/GoogleCloudPlatform/container-diff) [![GitHub stars](https://img.shields.io/github/stars/GoogleCloudPlatform/container-diff?style=flat)](https://github.com/GoogleCloudPlatform/container-diff/stargazers)  
A tool for analyzing and comparing container images.
* [buildah](https://github.com/projectatomic/buildah) [![GitHub stars](https://img.shields.io/github/stars/projectatomic/buildah?style=flat)](https://github.com/projectatomic/buildah/stargazers)  
A tool which facilitates building OCI container images.
* [skopeo](https://github.com/projectatomic/skopeo) [![GitHub stars](https://img.shields.io/github/stars/projectatomic/skopeo?style=flat)](https://github.com/projectatomic/skopeo/stargazers)  
Work with remote images registries - retrieving information, images, signing content.
* [img](https://github.com/jessfraz/img) [![GitHub stars](https://img.shields.io/github/stars/jessfraz/img?style=flat)](https://github.com/jessfraz/img/stargazers)  
Standalone, daemon-less, unprivileged Dockerfile and OCI compatible container image builder.
* [dgr](https://github.com/blablacar/dgr) [![GitHub stars](https://img.shields.io/github/stars/blablacar/dgr?style=flat)](https://github.com/blablacar/dgr/stargazers)  
...
* [Whaler](https://github.com/P3GLEG/Whaler) [![GitHub stars](https://img.shields.io/github/stars/P3GLEG/Whaler?style=flat)](https://github.com/P3GLEG/Whaler/stargazers)  
Whaler is designed to reverse engineer a Docker Image into the Dockerfile that created it.
* [dive](https://github.com/wagoodman/dive) [![GitHub stars](https://img.shields.io/github/stars/wagoodman/dive?style=flat)](https://github.com/wagoodman/dive/stargazers)  
A tool for exploring each layer in a docker image.
* [go-containerregistry](https://github.com/google/go-containerregistry) [![GitHub stars](https://img.shields.io/github/stars/google/go-containerregistry?style=flat)](https://github.com/google/go-containerregistry/stargazers)  
Go library and CLIs for working with container registries.
* [kaniko](https://github.com/GoogleContainerTools/kaniko) [![GitHub stars](https://img.shields.io/github/stars/GoogleContainerTools/kaniko?style=flat)](https://github.com/GoogleContainerTools/kaniko/stargazers)  
Kaniko is a tool to build container images from a Dockerfile, inside a container or Kubernetes cluster.
* [umoci](https://umo.ci/)  
Umoci is a tool to manipulate OCI container images, and can be used as a rudimentary build tool.
* [docker pushrm](https://github.com/christian-korneck/docker-pushrm) [![GitHub stars](https://img.shields.io/github/stars/christian-korneck/docker-pushrm?style=flat)](https://github.com/christian-korneck/docker-pushrm/stargazers)  
...
* [Liman](https://github.com/salihciftci/liman) [![GitHub stars](https://img.shields.io/github/stars/salihciftci/liman?style=flat)](https://github.com/salihciftci/liman/stargazers)  
Basic docker monitoring web application.
* [portainer](https://github.com/portainer/portainer) [![GitHub stars](https://img.shields.io/github/stars/portainer/portainer?style=flat)](https://github.com/portainer/portainer/stargazers)  
Lightweight Docker management UI.
* [swarmpit](https://github.com/swarmpit/swarmpit) [![GitHub stars](https://img.shields.io/github/stars/swarmpit/swarmpit?style=flat)](https://github.com/swarmpit/swarmpit/stargazers)  
...
* [Docker bench security](https://github.com/docker/docker-bench-security) [![GitHub stars](https://img.shields.io/github/stars/docker/docker-bench-security?style=flat)](https://github.com/docker/docker-bench-security/stargazers)  
...
* [bane](https://github.com/jfrazelle/bane) [![GitHub stars](https://img.shields.io/github/stars/jfrazelle/bane?style=flat)](https://github.com/jfrazelle/bane/stargazers)  
Custom AppArmor profile generator for docker containers.
* [OpenSCAP](https://github.com/OpenSCAP/container-compliance) [![GitHub stars](https://img.shields.io/github/stars/OpenSCAP/container-compliance?style=flat)](https://github.com/OpenSCAP/container-compliance/stargazers)  
...
* [drydock](https://github.com/zuBux/drydock) [![GitHub stars](https://img.shields.io/github/stars/zuBux/drydock?style=flat)](https://github.com/zuBux/drydock/stargazers)  
...
* [goss](https://github.com/aelsabbahy/goss) [![GitHub stars](https://img.shields.io/github/stars/aelsabbahy/goss?style=flat)](https://github.com/aelsabbahy/goss/stargazers)  
Quick and Easy server testing/validation.
* [sockguard](https://github.com/buildkite/sockguard) [![GitHub stars](https://img.shields.io/github/stars/buildkite/sockguard?style=flat)](https://github.com/buildkite/sockguard/stargazers)  
A proxy for docker.sock that enforces access control and isolated privileges.
* [gvisor](https://github.com/google/gvisor) [![GitHub stars](https://img.shields.io/github/stars/google/gvisor?style=flat)](https://github.com/google/gvisor/stargazers)  
gVisor is a user-space kernel, written in Go, that implements a substantial portion of the Linux system surface. It includes an Open Container Initiative (OCI) runtime called runsc that provides an isolation boundary between the application and the host kernel. The runsc runtime integrates with Docker and Kubernetes, making it simple to run sandboxed containers.
* [docker-explorer](https://github.com/google/docker-explorer/) [![GitHub stars](https://img.shields.io/github/stars/google/docker-explorer/?style=flat)](https://github.com/google/docker-explorer//stargazers)  
A tool to help forensicate offline docker acquisitions.
* [oci-seccomp-bpf-hook](https://github.com/containers/oci-seccomp-bpf-hook) [![GitHub stars](https://img.shields.io/github/stars/containers/oci-seccomp-bpf-hook?style=flat)](https://github.com/containers/oci-seccomp-bpf-hook/stargazers)  
...
* [sysdig-container-ecosystem](https://github.com/draios/sysdig-container-ecosystem) [![GitHub stars](https://img.shields.io/github/stars/draios/sysdig-container-ecosystem?style=flat)](https://github.com/draios/sysdig-container-ecosystem/stargazers)  
