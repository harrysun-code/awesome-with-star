...
- [Awesome Corporate Standards](https://github.com/openapi/awesome-corporate-standards) [![GitHub stars](https://img.shields.io/github/stars/openapi/awesome-corporate-standards?style=flat)](https://github.com/openapi/awesome-corporate-standards/stargazers) - International standards, frameworks, and certification bodies for organizations and businesses (quality, security, privacy, ESG, finance, and sector-specific compliance).
