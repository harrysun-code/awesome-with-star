...
> 来源：[diessica/awesome-sketch](https://github.com/diessica/awesome-sketch)

[![GitHub stars](https://img.shields.io/github/stars/diessica/awesome-sketch?style=flat)](https://github.com/diessica/awesome-sketch/stargazers)
...
###### Must-have :heart:
- [Content Generator](https://github.com/timuric/Content-generator-sketch-plugin) [![GitHub stars](https://img.shields.io/github/stars/timuric/Content-generator-sketch-plugin?style=flat)](https://github.com/timuric/Content-generator-sketch-plugin/stargazers)
- [RenameIt](https://github.com/rodi01/RenameIt) [![GitHub stars](https://img.shields.io/github/stars/rodi01/RenameIt?style=flat)](https://github.com/rodi01/RenameIt/stargazers)
- [Sketch Measure](https://github.com/utom/sketch-measure) [![GitHub stars](https://img.shields.io/github/stars/utom/sketch-measure?style=flat)](https://github.com/utom/sketch-measure/stargazers)
- [Style Inventory](https://github.com/getflourish/Sketch-Style-Inventory/) [![GitHub stars](https://img.shields.io/github/stars/getflourish/Sketch-Style-Inventory/?style=flat)](https://github.com/getflourish/Sketch-Style-Inventory//stargazers)
- [Dynamic Button](https://github.com/ddwht/sketch-dynamic-button) [![GitHub stars](https://img.shields.io/github/stars/ddwht/sketch-dynamic-button?style=flat)](https://github.com/ddwht/sketch-dynamic-button/stargazers)
- [Page Switch](https://github.com/mauehara/sketch-page-switch) [![GitHub stars](https://img.shields.io/github/stars/mauehara/sketch-page-switch?style=flat)](https://github.com/mauehara/sketch-page-switch/stargazers)
- [Sketch Flex Layout](https://github.com/hrescak/Sketch-Flex-Layout) [![GitHub stars](https://img.shields.io/github/stars/hrescak/Sketch-Flex-Layout?style=flat)](https://github.com/hrescak/Sketch-Flex-Layout/stargazers)

###### Nice-to-have :thumbsup:
- [Handy Tools](https://github.com/webpatch/Handy-Tools/) [![GitHub stars](https://img.shields.io/github/stars/webpatch/Handy-Tools/?style=flat)](https://github.com/webpatch/Handy-Tools//stargazers)
- [Easier.cc](http://easier.cc/) (Files up to 5 MB)
- [User Flow](https://github.com/abynim/UserFlows) [![GitHub stars](https://img.shields.io/github/stars/abynim/UserFlows?style=flat)](https://github.com/abynim/UserFlows/stargazers)
- [Sketch Runner](http://sketchrunner.com)
- [Efficiency](https://github.com/x-raizor/Efficiency) [![GitHub stars](https://img.shields.io/github/stars/x-raizor/Efficiency?style=flat)](https://github.com/x-raizor/Efficiency/stargazers)

##### Get more plugins
- [SketchApp Resources: Plugins for Sketch](http://www.sketchappsources.com/plugins.html)
- [Sketch Plugin Directory](https://github.com/sketchplugins/plugin-directory) [![GitHub stars](https://img.shields.io/github/stars/sketchplugins/plugin-directory?style=flat)](https://github.com/sketchplugins/plugin-directory/stargazers)
...
## Templates & UI Kits
- [Responsive Web Design Template](https://github.com/luandro/sketch-responsive-design-template) [![GitHub stars](https://img.shields.io/github/stars/luandro/sketch-responsive-design-template?style=flat)](https://github.com/luandro/sketch-responsive-design-template/stargazers), a template with [Font-Awesome](https://fortawesome.github.io/Font-Awesome/) and [Bootstrap UI Kit](http://bootstrapuikit.com/) as symbols for fast web design.
- [Sketch iOS Templates](https://github.com/nvk/sketch-ios) [![GitHub stars](https://img.shields.io/github/stars/nvk/sketch-ios?style=flat)](https://github.com/nvk/sketch-ios/stargazers), a collection of many iOS templates.
- [Teracy Wireframe Kit](https://github.com/teracyhq/wireframe) [![GitHub stars](https://img.shields.io/github/stars/teracyhq/wireframe?style=flat)](https://github.com/teracyhq/wireframe/stargazers), created to help speed up your wireframing process. Includes basics UI elements for web, mobile and other devices.
