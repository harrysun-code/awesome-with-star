...
> 来源：[phanan/htaccess](https://github.com/phanan/htaccess)

[![GitHub stars](https://img.shields.io/github/stars/phanan/htaccess?style=flat)](https://github.com/phanan/htaccess/stargazers)
...
> [!IMPORTANT]
> These snippets are for Apache 2.4. If you are still using Apache 2.2, check the [`2.2` branch](https://github.com/phanan/htaccess/tree/2.2) [![GitHub stars](https://img.shields.io/github/stars/phanan/htaccess/tree/2.2?style=flat)](https://github.com/phanan/htaccess/tree/2.2/stargazers). For details on the breaking changes between 2.2 and 2.4, see the [upgrading document](https://httpd.apache.org/docs/2.4/upgrading.html) as well as [this issue](https://github.com/phanan/htaccess/issues/2) [![GitHub stars](https://img.shields.io/github/stars/phanan/htaccess/issues/2?style=flat)](https://github.com/phanan/htaccess/issues/2/stargazers).

## Credits
What we are doing here is mostly collecting useful snippets from all over the interwebs (for example, a good chunk is from [Apache Server Configs](https://github.com/h5bp/server-configs-apache) [![GitHub stars](https://img.shields.io/github/stars/h5bp/server-configs-apache?style=flat)](https://github.com/h5bp/server-configs-apache/stargazers)) into one place. While we’ve been trying to credit where due, things might be missing. If you believe anything here is your work and credits should be given, let us know, or just send a PR.
...
```
[Source](https://github.com/h5bp/server-configs-apache) [![GitHub stars](https://img.shields.io/github/stars/h5bp/server-configs-apache?style=flat)](https://github.com/h5bp/server-configs-apache/stargazers)
...
```
[Source](https://github.com/h5bp/server-configs-apache/issues/32) [![GitHub stars](https://img.shields.io/github/stars/h5bp/server-configs-apache/issues/32?style=flat)](https://github.com/h5bp/server-configs-apache/issues/32/stargazers)
