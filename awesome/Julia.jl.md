...
+ [API](https://github.com/svaksha/Julia.jl/blob/master/API.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/API.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/API.md/stargazers) :: Language API's - C++, Fortran, Go, Java, JavaScript, MATLAB, Perl, Python, R, ...
+ [Biology](https://github.com/svaksha/Julia.jl/blob/master/Biology.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Biology.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Biology.md/stargazers) :: Bioinformatics, genomics, agriculture, food science, medicine, genetic engineering, Neuroscience, et. al...
+ [Desktop Applications](https://github.com/svaksha/Julia.jl/blob/master/DesktopApplications.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/DesktopApplications.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/DesktopApplications.md/stargazers) :: Front-end client application software, viz. Debuggers, Documentation generators, Desktop User Interface for word processors, GUI spreadsheets, etc..
+ [DevOps](https://github.com/svaksha/Julia.jl/blob/master/DevOps.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/DevOps.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/DevOps.md/stargazers) :: DevOps tools for infrastructure management, continuous integration (CI), continuous delivery (CD), package management, release engineering (RE), release management (RM), software configuration management (SCM), Test Driven Development, Sandbox, Functional/ Unit testing,... Quality-related tools, et al..
+ [Chemistry](https://github.com/svaksha/Julia.jl/blob/master/Chemistry.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Chemistry.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Chemistry.md/stargazers) :: Analytical chemistry, cheminformatics, crystallography, nanochemistry, nuclear chemistry ...
+ [Database](https://github.com/svaksha/Julia.jl/blob/master/Database.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Database.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Database.md/stargazers) :: NoSQL, RDBMS and Middleware API's.
+ [Data Science](https://github.com/svaksha/Julia.jl/blob/master/DataScience.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/DataScience.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/DataScience.md/stargazers) :: OpenData + OpenScience, Free Data Sets, Reproducible research, RDM, Clinical Research Data, Metadata, Library data, Computational reproducibility, etc.
+ [Earth Science](https://github.com/svaksha/Julia.jl/blob/master/Earth-Science.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Earth-Science.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Earth-Science.md/stargazers) :: Software related to the subcategories of cartography, climatology, geobiology, geochemistry, geography, geoinformatics, geology‎, geophysics‎, geoscience/GIS, geomathematics, meteorology, oceanography, etc...
+ [FileIO](https://github.com/svaksha/Julia.jl/blob/master/FileIO.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/FileIO.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/FileIO.md/stargazers) :: File IO (Input/Output) functionality and support for various data types and file formats.
+ [Graphics](https://github.com/svaksha/Julia.jl/blob/master/Graphics.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Graphics.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Graphics.md/stargazers) :: Plotting, Graphics and other Visualization tools.
+ [i18n-L10n](https://github.com/svaksha/Julia.jl/blob/master/i18n-L10n.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/i18n-L10n.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/i18n-L10n.md/stargazers) :: Transliteration, Internationalisation (i18n) and Localisation (L10n)
+ [Machines](https://github.com/svaksha/Julia.jl/blob/master/Machines.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Machines.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Machines.md/stargazers) :: Software for cross-platform hardware, Robotics, and other API libraries for machine-related software.
+ [Mathematics](https://github.com/svaksha/Julia.jl/blob/master/Mathematics.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Mathematics.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Mathematics.md/stargazers) :: Algebra, Geometry,... anything Math related.
+ [Optimization](https://github.com/svaksha/Julia.jl/blob/master/Optimization.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Optimization.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Optimization.md/stargazers) :: Mathematical optimization.
...
+ [Probability & Statistics](https://github.com/svaksha/Julia.jl/blob/master/Probability-Statistics.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Probability-Statistics.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Probability-Statistics.md/stargazers) :: Actuarial Science, Finance, economics, stochastic, insurance Statistics, Operations research and Benchmarks and Optimization toolkits....
+ [Super Computing](https://github.com/svaksha/Julia.jl/blob/master/Super-Computing.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Super-Computing.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Super-Computing.md/stargazers) :: HPC, Distributed Computing, Cloud computing, Cluster computing, Grid computing, Kernels and architectures like ARM, MIPS, GPU, CUDA, etc...
+ [Utilities](https://github.com/svaksha/Julia.jl/blob/master/Utilities.md) [![GitHub stars](https://img.shields.io/github/stars/svaksha/Julia.jl/blob/master/Utilities.md?style=flat)](https://github.com/svaksha/Julia.jl/blob/master/Utilities.md/stargazers) :: Handy toolkits and other general utilities for your Desktop.
