...
- [CircuitPython GitHub Repository](https://github.com/adafruit/circuitpython) [![GitHub stars](https://img.shields.io/github/stars/adafruit/circuitpython?style=flat)](https://github.com/adafruit/circuitpython/stargazers) - The source code for CircuitPython on GitHub.
- [Adafruit CircuitPython Libraries](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/blob/master/circuitpython_library_list.md) [![GitHub stars](https://img.shields.io/github/stars/adafruit/Adafruit_CircuitPython_Bundle/blob/master/circuitpython_library_list.md?style=flat)](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/blob/master/circuitpython_library_list.md/stargazers) - Current Adafruit CircuitPython Libraries. There are over 150+ libraries available. More on Libraries on [CircuitPython.org](https://circuitpython.org/libraries).
- [CircuitPython Community Libraries](https://github.com/adafruit/CircuitPython_Community_Bundle/blob/main/circuitpython_community_library_list.md) [![GitHub stars](https://img.shields.io/github/stars/adafruit/CircuitPython_Community_Bundle/blob/main/circuitpython_community_library_list.md?style=flat)](https://github.com/adafruit/CircuitPython_Community_Bundle/blob/main/circuitpython_community_library_list.md/stargazers) - CircuitPython Community Libraries. There are over 45+ libraries available.
...
- [Awesome List for the RP2040 Macropad](https://github.com/prcutler/awesome-macropad) [![GitHub stars](https://img.shields.io/github/stars/prcutler/awesome-macropad?style=flat)](https://github.com/prcutler/awesome-macropad/stargazers) - A list of awesome Macropad applications, macros, 3D printed plans, and more.
- [Tod Kurt's CircuitPython Tips and Tricks](https://github.com/todbot/circuitpython-tricks) [![GitHub stars](https://img.shields.io/github/stars/todbot/circuitpython-tricks?style=flat)](https://github.com/todbot/circuitpython-tricks/stargazers) - A collection of tips and tricks for CircuitPython. Also available as an Adafruit [Learn Guide](https://learn.adafruit.com/todbot-circuitpython-tricks?view=all).
- [Tod Kurt's CircuitPython `synthio` Tips and Tricks](https://github.com/todbot/circuitpython-synthio-tricks) [![GitHub stars](https://img.shields.io/github/stars/todbot/circuitpython-synthio-tricks?style=flat)](https://github.com/todbot/circuitpython-synthio-tricks/stargazers) - More tips and tricks from Tod Kurt about CircuitPython's `synthio` library.
...
- [Using Microsoft VSCode for CircuitPython](https://github.com/wmerkens/vscode-circuitpython) [![GitHub stars](https://img.shields.io/github/stars/wmerkens/vscode-circuitpython?style=flat)](https://github.com/wmerkens/vscode-circuitpython/stargazers) (GitHub) and [Microsoft Marketplace](https://marketplace.visualstudio.com/items?itemName=wmerkens.vscode-circuitpython-v2).
- [Thonny, a Python IDE for beginners](https://thonny.org/) - An editor with support for CircuitPython and MicroPython.
- [Glider: An app for editing Python on mobile devices wirelessly](https://github.com/adafruit/glider) [![GitHub stars](https://img.shields.io/github/stars/adafruit/glider?style=flat)](https://github.com/adafruit/glider/stargazers) - Also a [video](https://youtu.be/NYpcjDBA6xw), in development.
- [A helper for CircuitPython development with Atom](https://github.com/s-light/CircuitPython_Atom_helper) [![GitHub stars](https://img.shields.io/github/stars/s-light/CircuitPython_Atom_helper?style=flat)](https://github.com/s-light/CircuitPython_Atom_helper/stargazers) - A helper for the [Atom editor](https://atom.io/).
- [Microsoft Device Simulator Express](https://github.com/microsoft/vscode-python-devicesimulator) [![GitHub stars](https://img.shields.io/github/stars/microsoft/vscode-python-devicesimulator?style=flat)](https://github.com/microsoft/vscode-python-devicesimulator/stargazers) - Virtual Circuit Playground Express and CircuitPython programming in Visual Studio Code (no longer maintained).
...
- [Contribute to newsletter](https://github.com/adafruit/circuitpython-weekly-newsletter) [![GitHub stars](https://img.shields.io/github/stars/adafruit/circuitpython-weekly-newsletter?style=flat)](https://github.com/adafruit/circuitpython-weekly-newsletter/stargazers) - Guidelines on contributing to the newsletter.
...
1. Fork [this repository](https://github.com/adafruit/awesome-circuitpython) [![GitHub stars](https://img.shields.io/github/stars/adafruit/awesome-circuitpython?style=flat)](https://github.com/adafruit/awesome-circuitpython/stargazers) on GitHub.
