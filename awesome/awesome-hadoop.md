...
A curated list of amazingly awesome Hadoop and Hadoop ecosystem resources. Inspired by [Awesome PHP](https://github.com/ziadoz/awesome-php) [![GitHub stars](https://img.shields.io/github/stars/ziadoz/awesome-php?style=flat)](https://github.com/ziadoz/awesome-php/stargazers), [Awesome Python](https://github.com/vinta/awesome-python) [![GitHub stars](https://img.shields.io/github/stars/vinta/awesome-python?style=flat)](https://github.com/vinta/awesome-python/stargazers) and [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) [![GitHub stars](https://img.shields.io/github/stars/kahun/awesome-sysadmin?style=flat)](https://github.com/kahun/awesome-sysadmin/stargazers)
...
* [Elasticsearch Hadoop](https://github.com/elastic/elasticsearch-hadoop) [![GitHub stars](https://img.shields.io/github/stars/elastic/elasticsearch-hadoop?style=flat)](https://github.com/elastic/elasticsearch-hadoop/stargazers) - Elasticsearch real-time search and analytics natively integrated with Hadoop. Supports Map/Reduce, Cascading, Apache Hive and Apache Pig.
* [hadoopy](https://github.com/bwhite/hadoopy) [![GitHub stars](https://img.shields.io/github/stars/bwhite/hadoopy?style=flat)](https://github.com/bwhite/hadoopy/stargazers) - Python MapReduce library written in Cython. 
* [mrjob](https://github.com/Yelp/mrjob/) [![GitHub stars](https://img.shields.io/github/stars/Yelp/mrjob/?style=flat)](https://github.com/Yelp/mrjob//stargazers) - mrjob is a Python 2.5+ package that helps you write and run Hadoop Streaming jobs.
* [pydoop](http://pydoop.sourceforge.net/) - Pydoop is a package that provides a Python API for Hadoop.
* [hdfs-du](https://github.com/twitter/hdfs-du) [![GitHub stars](https://img.shields.io/github/stars/twitter/hdfs-du?style=flat)](https://github.com/twitter/hdfs-du/stargazers) - HDFS-DU is an interactive visualization of the Hadoop distributed file system. 
* [White Elephant](https://github.com/linkedin/white-elephant) [![GitHub stars](https://img.shields.io/github/stars/linkedin/white-elephant?style=flat)](https://github.com/linkedin/white-elephant/stargazers) - Hadoop log aggregator and dashboard
* [Genie](https://github.com/Netflix/genie) [![GitHub stars](https://img.shields.io/github/stars/Netflix/genie?style=flat)](https://github.com/Netflix/genie/stargazers) - Genie provides REST-ful APIs to run Hadoop, Hive and Pig jobs, and to manage multiple Hadoop resources and perform job submissions across them.
...
* [Crunch](https://github.com/jondot/crunch) [![GitHub stars](https://img.shields.io/github/stars/jondot/crunch?style=flat)](https://github.com/jondot/crunch/stargazers) - Go-based toolkit for ETL and feature extraction on Hadoop
...
* [mpich2-yarn](https://github.com/alibaba/mpich2-yarn) [![GitHub stars](https://img.shields.io/github/stars/alibaba/mpich2-yarn?style=flat)](https://github.com/alibaba/mpich2-yarn/stargazers) - Running MPICH2 on Yarn
...
* [happybase](https://github.com/wbolster/happybase) [![GitHub stars](https://img.shields.io/github/stars/wbolster/happybase?style=flat)](https://github.com/wbolster/happybase/stargazers) - A developer-friendly Python library to interact with Apache HBase.
* [Hannibal](https://github.com/sentric/hannibal) [![GitHub stars](https://img.shields.io/github/stars/sentric/hannibal?style=flat)](https://github.com/sentric/hannibal/stargazers) - Hannibal is tool to help monitor and maintain HBase-Clusters that are configured for manual splitting.
* [Haeinsa](https://github.com/VCNC/haeinsa) [![GitHub stars](https://img.shields.io/github/stars/VCNC/haeinsa?style=flat)](https://github.com/VCNC/haeinsa/stargazers) - Haeinsa is linearly scalable multi-row, multi-table transaction library for HBase
...
* [Confluent Schema registry for Kafka](https://github.com/confluentinc/schema-registry) [![GitHub stars](https://img.shields.io/github/stars/confluentinc/schema-registry?style=flat)](https://github.com/confluentinc/schema-registry/stargazers) - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
* [Hortonworks Schema Registry](https://github.com/hortonworks/registry) [![GitHub stars](https://img.shields.io/github/stars/hortonworks/registry?style=flat)](https://github.com/hortonworks/registry/stargazers) - Schema Registry is a framework to build metadata repositories.
...
* [Apache AirFlow](https://github.com/apache/incubator-airflow) [![GitHub stars](https://img.shields.io/github/stars/apache/incubator-airflow?style=flat)](https://github.com/apache/incubator-airflow/stargazers) - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
...
* [Suro](https://github.com/Netflix/suro) [![GitHub stars](https://img.shields.io/github/stars/Netflix/suro?style=flat)](https://github.com/Netflix/suro/stargazers) - Netflix's distributed Data Pipeline
* [Apache Sqoop](http://sqoop.apache.org) - Apache Sqoop
* [Apache Kafka](http://kafka.apache.org/) - Apache Kafka
* [Gobblin from LinkedIn](https://github.com/linkedin/gobblin) [![GitHub stars](https://img.shields.io/github/stars/linkedin/gobblin?style=flat)](https://github.com/linkedin/gobblin/stargazers) - Universal data ingestion framework for Hadoop
...
* [vahara](https://github.com/thedatachef/varaha) [![GitHub stars](https://img.shields.io/github/stars/thedatachef/varaha?style=flat)](https://github.com/thedatachef/varaha/stargazers) - Machine learning and natural language processing with Apache Pig
* [packetpig](https://github.com/packetloop/packetpig) [![GitHub stars](https://img.shields.io/github/stars/packetloop/packetpig?style=flat)](https://github.com/packetloop/packetpig/stargazers) - Open Source Big Data Security Analytics
* [akela](https://github.com/mozilla-metrics/akela) [![GitHub stars](https://img.shields.io/github/stars/mozilla-metrics/akela?style=flat)](https://github.com/mozilla-metrics/akela/stargazers) - Mozilla's utility library for Hadoop, HBase, Pig, etc.
...
* [Lipstick](https://github.com/Netflix/Lipstick) [![GitHub stars](https://img.shields.io/github/stars/Netflix/Lipstick?style=flat)](https://github.com/Netflix/Lipstick/stargazers) - Pig workflow visualization tool. [Introducing Lipstick on A(pache) Pig](http://techblog.netflix.com/2013/06/introducing-lipstick-on-apache-pig.html)
* [PigPen](https://github.com/Netflix/PigPen) [![GitHub stars](https://img.shields.io/github/stars/Netflix/PigPen?style=flat)](https://github.com/Netflix/PigPen/stargazers) - PigPen is map-reduce for Clojure, or distributed Clojure. It compiles to Apache Pig, but you don't need to know much about Pig to use it.

## Libraries and Tools

* [Kite Software Development Kit](http://kitesdk.org/) - A set of libraries, tools, examples, and documentation
* [gohadoop](https://github.com/hortonworks/gohadoop) [![GitHub stars](https://img.shields.io/github/stars/hortonworks/gohadoop?style=flat)](https://github.com/hortonworks/gohadoop/stargazers) - Native go clients for Apache Hadoop YARN.
...
* [Elephant Bird](https://github.com/twitter/elephant-bird) [![GitHub stars](https://img.shields.io/github/stars/twitter/elephant-bird?style=flat)](https://github.com/twitter/elephant-bird/stargazers) - Twitter's collection of LZO and Protocol Buffer-related Hadoop, Pig, Hive, and HBase code.
* [Spring for Apache Hadoop](http://projects.spring.io/spring-hadoop/)
* [hdfs - A native go client for HDFS](https://github.com/colinmarc/hdfs) [![GitHub stars](https://img.shields.io/github/stars/colinmarc/hdfs?style=flat)](https://github.com/colinmarc/hdfs/stargazers)
...
* [Schema Registry UI](https://github.com/Landoop/schema-registry-ui) [![GitHub stars](https://img.shields.io/github/stars/Landoop/schema-registry-ui?style=flat)](https://github.com/Landoop/schema-registry-ui/stargazers) - Web tool for the Confluent Schema Registry in order to create / view / search / evolve / view history & configure Avro schemas of your Kafka cluster.
...
* [ankush](https://github.com/impetus-opensource/ankush) [![GitHub stars](https://img.shields.io/github/stars/impetus-opensource/ankush?style=flat)](https://github.com/impetus-opensource/ankush/stargazers) - A big data cluster management tool that creates and manages clusters of different technologies.
...
* [inviso](https://github.com/Netflix/inviso) [![GitHub stars](https://img.shields.io/github/stars/Netflix/inviso?style=flat)](https://github.com/Netflix/inviso/stargazers) - Inviso is a lightweight tool that provides the ability to search for Hadoop jobs, visualize the performance, and view cluster utilization.
...
* [Banana](https://github.com/LucidWorks/banana) [![GitHub stars](https://img.shields.io/github/stars/LucidWorks/banana?style=flat)](https://github.com/LucidWorks/banana/stargazers) - Kibana port for Apache Solr
...
* [HiBench](https://github.com/intel-hadoop/HiBench) [![GitHub stars](https://img.shields.io/github/stars/intel-hadoop/HiBench?style=flat)](https://github.com/intel-hadoop/HiBench/stargazers)
* [YCSB](https://github.com/brianfrankcooper/YCSB) [![GitHub stars](https://img.shields.io/github/stars/brianfrankcooper/YCSB?style=flat)](https://github.com/brianfrankcooper/YCSB/stargazers) - The Yahoo! Cloud Serving Benchmark (YCSB) is an open-source specification and program suite for evaluating retrieval and maintenance capabilities of computer programs. It is often used to compare relative performance of NoSQL database management systems.
 ...
 * Libraries and tools
     ...
     * [shib](https://github.com/tagomoris/shib) [![GitHub stars](https://img.shields.io/github/stars/tagomoris/shib?style=flat)](https://github.com/tagomoris/shib/stargazers) - WebUI for query engines: Hive and Presto
     ...
     * [HiveRunner](https://github.com/klarna/HiveRunner) [![GitHub stars](https://img.shields.io/github/stars/klarna/HiveRunner?style=flat)](https://github.com/klarna/HiveRunner/stargazers) - An Open Source unit test framework for hadoop hive queries based on JUnit4
     * [Beetest](https://github.com/kawaa/Beetest) [![GitHub stars](https://img.shields.io/github/stars/kawaa/Beetest?style=flat)](https://github.com/kawaa/Beetest/stargazers) - A super simple utility for testing Apache Hive scripts locally for non-Java developers.
     * [Hive_test](https://github.com/edwardcapriolo/hive_test) [![GitHub stars](https://img.shields.io/github/stars/edwardcapriolo/hive_test?style=flat)](https://github.com/edwardcapriolo/hive_test/stargazers)- Unit test framework for hive and hive-service
* Flume Plugins
  * [Flume MongoDB Sink](https://github.com/leonlee/flume-ng-mongodb-sink) [![GitHub stars](https://img.shields.io/github/stars/leonlee/flume-ng-mongodb-sink?style=flat)](https://github.com/leonlee/flume-ng-mongodb-sink/stargazers)
  * [Flume RabbitMQ source and sink](https://github.com/jcustenborder/flume-ng-rabbitmq) [![GitHub stars](https://img.shields.io/github/stars/jcustenborder/flume-ng-rabbitmq?style=flat)](https://github.com/jcustenborder/flume-ng-rabbitmq/stargazers)
  * [Flume UDP Source](https://github.com/whitepages/flume-udp-source) [![GitHub stars](https://img.shields.io/github/stars/whitepages/flume-udp-source?style=flat)](https://github.com/whitepages/flume-udp-source/stargazers)
  * [.Net FlumeNG Clients](https://github.com/marksl/DotNetFlumeNG.Clients) [![GitHub stars](https://img.shields.io/github/stars/marksl/DotNetFlumeNG.Clients?style=flat)](https://github.com/marksl/DotNetFlumeNG.Clients/stargazers)
...
# Other Awesome Lists
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) [![GitHub stars](https://img.shields.io/github/stars/bayandin/awesome-awesomeness?style=flat)](https://github.com/bayandin/awesome-awesomeness/stargazers) and [awesome](https://github.com/sindresorhus/awesome) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers) list.
