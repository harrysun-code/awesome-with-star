...
* [GitHub repo](https://github.com/hashicorp/vagrant) [![GitHub stars](https://img.shields.io/github/stars/hashicorp/vagrant?style=flat)](https://github.com/hashicorp/vagrant/stargazers) - source code, issues discussion and collaboration.
...
* [List of available Vagrant plugins from GitHub wiki](https://github.com/hashicorp/vagrant/wiki/Available-Vagrant-Plugins) [![GitHub stars](https://img.shields.io/github/stars/hashicorp/vagrant/wiki/Available-Vagrant-Plugins?style=flat)](https://github.com/hashicorp/vagrant/wiki/Available-Vagrant-Plugins/stargazers).
* [vagrant-vbguest](https://github.com/dotless-de/vagrant-vbguest) [![GitHub stars](https://img.shields.io/github/stars/dotless-de/vagrant-vbguest?style=flat)](https://github.com/dotless-de/vagrant-vbguest/stargazers) - autoupdate VirtualBox guest additions (according to VB version).
* [vagrant-hostsupdater](https://github.com/cogitatio/vagrant-hostsupdater) [![GitHub stars](https://img.shields.io/github/stars/cogitatio/vagrant-hostsupdater?style=flat)](https://github.com/cogitatio/vagrant-hostsupdater/stargazers) - adds an entry to your /etc/hosts file on the host system.
...
* [vagrant-host-shell](https://github.com/phinze/vagrant-host-shell) [![GitHub stars](https://img.shields.io/github/stars/phinze/vagrant-host-shell?style=flat)](https://github.com/phinze/vagrant-host-shell/stargazers) - a vagrant provisioner to run commands on the host when a VM boots.
* [vagrant-ansible-local](https://github.com/jaugustin/vagrant-ansible-local) [![GitHub stars](https://img.shields.io/github/stars/jaugustin/vagrant-ansible-local?style=flat)](https://github.com/jaugustin/vagrant-ansible-local/stargazers)  allow provisioning your VM with ansible playbooks directly from the guest VM.
* [sahara](https://github.com/jedi4ever/sahara) [![GitHub stars](https://img.shields.io/github/stars/jedi4ever/sahara?style=flat)](https://github.com/jedi4ever/sahara/stargazers) - easy manage VM state (commit/rollback while experimenting with software stack).
* [vagrant-registration](https://github.com/projectatomic/adb-vagrant-registration) [![GitHub stars](https://img.shields.io/github/stars/projectatomic/adb-vagrant-registration?style=flat)](https://github.com/projectatomic/adb-vagrant-registration/stargazers) - add "register" and "unregister" capabilities to Vagrant guests for updates on systems with a subscription model(like Red Hat Enterprise Linux).
* [vagrant-service-manager](https://github.com/projectatomic/vagrant-service-manager) [![GitHub stars](https://img.shields.io/github/stars/projectatomic/vagrant-service-manager?style=flat)](https://github.com/projectatomic/vagrant-service-manager/stargazers) - enable easier access to the features and services provided by the [Atomic Developer Bundle (ADB)](https://github.com/projectatomic/adb-atomic-developer-bundle) [![GitHub stars](https://img.shields.io/github/stars/projectatomic/adb-atomic-developer-bundle?style=flat)](https://github.com/projectatomic/adb-atomic-developer-bundle/stargazers).
* [vagrant-scp](https://github.com/invernizzi/vagrant-scp) [![GitHub stars](https://img.shields.io/github/stars/invernizzi/vagrant-scp?style=flat)](https://github.com/invernizzi/vagrant-scp/stargazers) - Copy files to a Vagrant VM via SCP.
...
* [Vagrantpress](https://github.com/vagrantpress/vagrantpress) [![GitHub stars](https://img.shields.io/github/stars/vagrantpress/vagrantpress?style=flat)](https://github.com/vagrantpress/vagrantpress/stargazers) - development environment for creating and modifying WordPress sites.
* [Varying Vagrant Vagrants](https://github.com/Varying-Vagrant-Vagrants/VVV) [![GitHub stars](https://img.shields.io/github/stars/Varying-Vagrant-Vagrants/VVV?style=flat)](https://github.com/Varying-Vagrant-Vagrants/VVV/stargazers) - An open source Vagrant configuration focused on WordPress development.
* [Joomla-Vagrant](https://github.com/joomlatools/joomlatools-vagrant) [![GitHub stars](https://img.shields.io/github/stars/joomlatools/joomlatools-vagrant?style=flat)](https://github.com/joomlatools/joomlatools-vagrant/stargazers).
...
* [Try Yii2](https://github.com/iJackUA/try-yii2) [![GitHub stars](https://img.shields.io/github/stars/iJackUA/try-yii2?style=flat)](https://github.com/iJackUA/try-yii2/stargazers) - try Yii2 with Vagrant VM + Ansible provisioning = Complete readymade virtual server playground.
* [Laravel4-Vagrant](https://github.com/bryannielsen/Laravel4-Vagrant) [![GitHub stars](https://img.shields.io/github/stars/bryannielsen/Laravel4-Vagrant?style=flat)](https://github.com/bryannielsen/Laravel4-Vagrant/stargazers) - run Laravel 4 inside a Ubuntu 12.04 Vagrant Virtual Machine w/PHP 5.5.
* [OpenStack on Ansible with Vagrant](https://github.com/openstack-ansible/openstack-ansible) [![GitHub stars](https://img.shields.io/github/stars/openstack-ansible/openstack-ansible?style=flat)](https://github.com/openstack-ansible/openstack-ansible/stargazers).
