...
- [GitHub repository](https://github.com/prometheus/prometheus) [![GitHub stars](https://img.shields.io/github/stars/prometheus/prometheus?style=flat)](https://github.com/prometheus/prometheus/stargazers) - Prometheus' source code, issues discussion and collaboration.
...
- [Prometheus-Basics](https://github.com/yolossn/Prometheus-Basics) [![GitHub stars](https://img.shields.io/github/stars/yolossn/Prometheus-Basics?style=flat)](https://github.com/yolossn/Prometheus-Basics/stargazers) - Beginner friendly introduction to Prometheus by [yolossn](https://github.com/yolossn) [![GitHub stars](https://img.shields.io/github/stars/yolossn?style=flat)](https://github.com/yolossn/stargazers).
...
- [Alerting issues with Alertmanager](https://ali.sattari.me/posts/2020/alerting-issues-with-alertmanager/) - Addressing alert flapping and duplicates in Alertmanager by [Ali Sattari](https://github.com/ali-sattari) [![GitHub stars](https://img.shields.io/github/stars/ali-sattari?style=flat)](https://github.com/ali-sattari/stargazers).
...
## Deployment tools
- [Ansitheus](https://github.com/ntk148v/ansitheus) [![GitHub stars](https://img.shields.io/github/stars/ntk148v/ansitheus?style=flat)](https://github.com/ntk148v/ansitheus/stargazers) - Ansible playbook to containerize, configure and deploy Prometheus ecosystem _by ntk148v_.
- [Cloud Alchemy Ansible roles](https://github.com/cloudalchemy) [![GitHub stars](https://img.shields.io/github/stars/cloudalchemy?style=flat)](https://github.com/cloudalchemy/stargazers) - Ansible roles to manage Prometheus, Alertmanager, Grafana, and common Prometheus exporters.
- [Ansible-prometheus](https://github.com/ernestas-poskus/ansible-prometheus) [![GitHub stars](https://img.shields.io/github/stars/ernestas-poskus/ansible-prometheus?style=flat)](https://github.com/ernestas-poskus/ansible-prometheus/stargazers) - Ansible playbook for installing Prometheus monitoring system, exporters such as: node, snmp, blackbox, thus alert manager and push gateway _by Ernestas Poskus_.
- [Click-to-deploy Prometheus](https://github.com/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus) [![GitHub stars](https://img.shields.io/github/stars/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus?style=flat)](https://github.com/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus/stargazers) - Source for Google Click to Deploy Prometheus solutions listed on Google Cloud Marketplace _by GoogleCloudPlatform_.
- [Prometheus Operator](https://github.com/coreos/prometheus-operator) [![GitHub stars](https://img.shields.io/github/stars/coreos/prometheus-operator?style=flat)](https://github.com/coreos/prometheus-operator/stargazers) - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes _by CoreOS_.
...
## Exporters
The lists below contain all the official Prometheus exporters that are maintained by the [Prometheus GitHub organization](https://github.com/prometheus) [![GitHub stars](https://img.shields.io/github/stars/prometheus?style=flat)](https://github.com/prometheus/stargazers). For a complete list of exporters including any non-official exporters see [prometheus.io](https://prometheus.io/docs/instrumenting/exporters/) or [exporterhub.io](https://exporterhub.io) for a curated list of Prometheus exporters.

### Databases
- [Consul exporter](https://github.com/prometheus/consul_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/consul_exporter?style=flat)](https://github.com/prometheus/consul_exporter/stargazers) - The exporter for Consul metrics.
- [Memcached exporter](https://github.com/prometheus/memcached_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/memcached_exporter?style=flat)](https://github.com/prometheus/memcached_exporter/stargazers) - The Memcached exporter periodically scrapes Memcached stats.
- [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/mysqld_exporter?style=flat)](https://github.com/prometheus/mysqld_exporter/stargazers) - The MySQL server exporter periodically scrapes MySQL stats.

### Hardware related
- [Node/system metrics exporter](https://github.com/prometheus/node_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/node_exporter?style=flat)](https://github.com/prometheus/node_exporter/stargazers) - The Node exporter periodically scrapes system stats.

### HTTP
- [HAProxy exporter](https://github.com/prometheus/haproxy_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/haproxy_exporter?style=flat)](https://github.com/prometheus/haproxy_exporter/stargazers) - The HAProxy exporter periodically scrapes HAProxy stats.

### Other monitoring systems
- [AWS CloudWatch exporter](https://github.com/prometheus/cloudwatch_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/cloudwatch_exporter?style=flat)](https://github.com/prometheus/cloudwatch_exporter/stargazers) - The exporter for Amazon AWS CloudWatch metrics.
- [Collectd exporter](https://github.com/prometheus/collectd_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/collectd_exporter?style=flat)](https://github.com/prometheus/collectd_exporter/stargazers) - The exporter for Collectd metrics.
- [Graphite exporter](https://github.com/prometheus/graphite_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/graphite_exporter?style=flat)](https://github.com/prometheus/graphite_exporter/stargazers) - The exporter for Graphite metrics.
- [InfluxDB](https://github.com/prometheus/influxdb_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/influxdb_exporter?style=flat)](https://github.com/prometheus/influxdb_exporter/stargazers) - The exporter for InfluxDB metrics.
- [JMX exporter](https://github.com/prometheus/jmx_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/jmx_exporter?style=flat)](https://github.com/prometheus/jmx_exporter/stargazers) - The exporter for JMX metrics.
- [SNMP exporter](https://github.com/prometheus/snmp_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/snmp_exporter?style=flat)](https://github.com/prometheus/snmp_exporter/stargazers) - The exporter for SNMP metrics.
- [StatsD exporter](https://github.com/prometheus/statsd_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/statsd_exporter?style=flat)](https://github.com/prometheus/statsd_exporter/stargazers) - The exporter for StatsD metrics.

### Miscellaneous
- [Blackbox](https://github.com/prometheus/blackbox_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/blackbox_exporter?style=flat)](https://github.com/prometheus/blackbox_exporter/stargazers) - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager
- [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.
- [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) [![GitHub stars](https://img.shields.io/github/stars/samber/awesome-prometheus-alerts?style=flat)](https://github.com/samber/awesome-prometheus-alerts/stargazers) - Awesome List of Prometheus alerting rules.
- [Karma](https://github.com/prymitive/karma) [![GitHub stars](https://img.shields.io/github/stars/prymitive/karma?style=flat)](https://github.com/prymitive/karma/stargazers) - Alert dashboard for Prometheus Alertmanager.

## Proxies
- [Multi-prometheus proxy](https://github.com/matt-deboer/mpp) [![GitHub stars](https://img.shields.io/github/stars/matt-deboer/mpp?style=flat)](https://github.com/matt-deboer/mpp/stargazers) - Forwards incoming requests to one of a set of multiple Prometheus instances deployed as HA duplicates of each other using a selector strategy.
- [Promxy](https://github.com/jacksontj/promxy) [![GitHub stars](https://img.shields.io/github/stars/jacksontj/promxy?style=flat)](https://github.com/jacksontj/promxy/stargazers) - Deduplicates data from Prometheus HA pairs.
- [Trickster](https://github.com/tricksterproxy/trickster) [![GitHub stars](https://img.shields.io/github/stars/tricksterproxy/trickster?style=flat)](https://github.com/tricksterproxy/trickster/stargazers) - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
- [exporter_proxy](https://github.com/mrichar1/exporter_proxy) [![GitHub stars](https://img.shields.io/github/stars/mrichar1/exporter_proxy?style=flat)](https://github.com/mrichar1/exporter_proxy/stargazers) - A tiny, simple pure-python reverse-proxy for Prometheus exporters, with TLS support.
- [PromQL Guard](https://github.com/kfdm/promql-guard) [![GitHub stars](https://img.shields.io/github/stars/kfdm/promql-guard?style=flat)](https://github.com/kfdm/promql-guard/stargazers) - Provides a thin proxy on top of Prometheus, that allows PromQL queries to be inspected and re-written, so that a tenant can only see allowed data, even when using a shared Prometheus server.

## High Availability
- [Cortex](https://github.com/cortexproject/cortex) [![GitHub stars](https://img.shields.io/github/stars/cortexproject/cortex?style=flat)](https://github.com/cortexproject/cortex/stargazers) - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
- [Thanos](https://github.com/thanos-io/thanos) [![GitHub stars](https://img.shields.io/github/stars/thanos-io/thanos?style=flat)](https://github.com/thanos-io/thanos/stargazers) - Highly available Prometheus setup with long term storage capabilities.
- [M3DB](https://github.com/m3db/m3) [![GitHub stars](https://img.shields.io/github/stars/m3db/m3?style=flat)](https://github.com/m3db/m3/stargazers) - Scalable long-term remote storage for Prometheus.
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) [![GitHub stars](https://img.shields.io/github/stars/VictoriaMetrics/VictoriaMetrics?style=flat)](https://github.com/VictoriaMetrics/VictoriaMetrics/stargazers) - Cost-effective easy to operate remote storage for Prometheus.
