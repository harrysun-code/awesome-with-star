...
### [Hack Night](https://github.com/isislab/Hack-Night) [![GitHub stars](https://img.shields.io/github/stars/isislab/Hack-Night?style=flat)](https://github.com/isislab/Hack-Night/stargazers)
...
### [Clojure OWASP](https://github.com/nubank/clj-owasp) [![GitHub stars](https://img.shields.io/github/stars/nubank/clj-owasp?style=flat)](https://github.com/nubank/clj-owasp/stargazers) (2020)
...
### [Awesome Electron.js hacking & pentesting resources](https://github.com/doyensec/awesome-electronjs-hacking) [![GitHub stars](https://img.shields.io/github/stars/doyensec/awesome-electronjs-hacking?style=flat)](https://github.com/doyensec/awesome-electronjs-hacking/stargazers) (2020)
...
Discusses the importance of end-to-end network-layer encryption (HTTPS) as well as secure encryption for data at rest, then introduces the specific cryptography tools that developers should use for specific use cases, whether they use [libsodium](https://pecl.php.net/package/libsodium), [Defuse Security's secure PHP encryption library](https://github.com/defuse/php-encryption) [![GitHub stars](https://img.shields.io/github/stars/defuse/php-encryption?style=flat)](https://github.com/defuse/php-encryption/stargazers), or OpenSSL.
...
### [defuse/php-encryption](https://github.com/defuse/php-encryption) [![GitHub stars](https://img.shields.io/github/stars/defuse/php-encryption?style=flat)](https://github.com/defuse/php-encryption/stargazers)

Symmetric-key encryption library for PHP applications. (**Recommended** over rolling your own!)

### [ircmaxell/password_compat](https://github.com/ircmaxell/password_compat) [![GitHub stars](https://img.shields.io/github/stars/ircmaxell/password_compat?style=flat)](https://github.com/ircmaxell/password_compat/stargazers)

If you're using PHP 5.3.7+ or 5.4, use this to hash passwords

### [ircmaxell/RandomLib](https://github.com/ircmaxell/RandomLib) [![GitHub stars](https://img.shields.io/github/stars/ircmaxell/RandomLib?style=flat)](https://github.com/ircmaxell/RandomLib/stargazers)

Useful for generating random strings or numbers

### [thephpleague/oauth2-server](https://github.com/thephpleague/oauth2-server) [![GitHub stars](https://img.shields.io/github/stars/thephpleague/oauth2-server?style=flat)](https://github.com/thephpleague/oauth2-server/stargazers)

A secure OAuth2 server implementation

### [paragonie/random_compat](https://github.com/paragonie/random_compat) [![GitHub stars](https://img.shields.io/github/stars/paragonie/random_compat?style=flat)](https://github.com/paragonie/random_compat/stargazers)
...
### [psecio/gatekeeper](https://github.com/psecio/gatekeeper) [![GitHub stars](https://img.shields.io/github/stars/psecio/gatekeeper?style=flat)](https://github.com/psecio/gatekeeper/stargazers)
...
A guide to secure Ruby development by the Fedora Security Team. Also available on [Github](https://github.com/jrusnack/secure-ruby-development-guide) [![GitHub stars](https://img.shields.io/github/stars/jrusnack/secure-ruby-development-guide?style=flat)](https://github.com/jrusnack/secure-ruby-development-guide/stargazers).
