...
Awesome is awesome project started by [Sindre Sorhus](https://github.com/sindresorhus) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus?style=flat)](https://github.com/sindresorhus/stargazers) who is most popular person on  [Github](https://github.com/sindresorhus) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus?style=flat)](https://github.com/sindresorhus/stargazers). He created a project to list down coolest of links bookmarked in your machines and organized them together by compiling them at one place. Later, this projects caught fire and developers community around the world started writing awesome pages (dedicated to their favorite technology).

## What makes for an awesome list?
Read [the awesome manifesto](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-salesforce/blob/master/contributing.md?style=flat)](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md/stargazers) and ensure your list complies.
...
Pull requests might be left open for a period of time to let the community chime in and vouch for it.  An official repo from [aws](https://github.com/aws) [![GitHub stars](https://img.shields.io/github/stars/aws?style=flat)](https://github.com/aws/stargazers) or [awslabs](https://github.com/awslabs) [![GitHub stars](https://img.shields.io/github/stars/awslabs?style=flat)](https://github.com/awslabs/stargazers) can be removed if the community wishes.  Check out the [awesome manifesto](https://github.com/sindresorhus/awesome/blob/master/awesome.md) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome/blob/master/awesome.md?style=flat)](https://github.com/sindresorhus/awesome/blob/master/awesome.md/stargazers).

  Read Related Awesome Pages :
   * [Awesome Lighting](https://github.com/mailtoharshit/awesome-lighting) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-lighting?style=flat)](https://github.com/mailtoharshit/awesome-lighting/stargazers)
   * [Awesome Articles](https://github.com/mailtoharshit/awesome-salesforce-articles) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-salesforce-articles?style=flat)](https://github.com/mailtoharshit/awesome-salesforce-articles/stargazers)
   * [Awesome Browser Extensions](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-browser-extensions-for-salesforce/blob/master/README.md?style=flat)](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce/blob/master/README.md/stargazers)
   * [Awesome Heroku](https://github.com/mailtoharshit/awesome-heroku) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-heroku?style=flat)](https://github.com/mailtoharshit/awesome-heroku/stargazers)
...
* [Atom Plugin](https://github.com/joeferraro/MavensMate-Atom) [![GitHub stars](https://img.shields.io/github/stars/joeferraro/MavensMate-Atom?style=flat)](https://github.com/joeferraro/MavensMate-Atom/stargazers)- MavensMate plugin for building Salesforce.com/Force.com/Salesforce1 applications inside GitHub's Atom text editor
* Visual Studio Code
  * [Salesforce Extensions for VS Code](https://github.com/forcedotcom/salesforcedx-vscode) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/salesforcedx-vscode?style=flat)](https://github.com/forcedotcom/salesforcedx-vscode/stargazers) are the official Salesforce VS Code extensions.
  * [ForceCode](https://github.com/celador/ForceCode) [![GitHub stars](https://img.shields.io/github/stars/celador/ForceCode?style=flat)](https://github.com/celador/ForceCode/stargazers) is a Visual Studio Code extension for Salesforce development
  ...
  * [xysfdx](https://github.com/exiahuang/xysfdx) [![GitHub stars](https://img.shields.io/github/stars/exiahuang/xysfdx?style=flat)](https://github.com/exiahuang/xysfdx/stargazers) is a Visual Studio Code extension for Salesforce SFDX Development.
...
* [ApexMate](https://github.com/superfell/ApexMate) [![GitHub stars](https://img.shields.io/github/stars/superfell/ApexMate?style=flat)](https://github.com/superfell/ApexMate/stargazers)- Apex Plugin for TextMate.
...
* [HaoIDE](https://github.com/xjsender/haoide) [![GitHub stars](https://img.shields.io/github/stars/xjsender/haoide?style=flat)](https://github.com/xjsender/haoide/stargazers) - Sublime Plugin for Force.com
...
### Browser extensions for Salesforce
  Read cruciated list of [Awesome-list-of-browser-extensions-of-salesforce](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-browser-extensions-for-salesforce/blob/master/README.md?style=flat)](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce/blob/master/README.md/stargazers)

### Packages and Libraries supporting salesforce

* [Apex mocks](https://github.com/financialforcedev/fflib-apex-mocks) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/fflib-apex-mocks?style=flat)](https://github.com/financialforcedev/fflib-apex-mocks/stargazers) - ApexMocks is a mocking framework for the Force.com Apex language.It derives it's inspiration from the well known Java mocking framework Mockito
    <a href="https://githubsfdeploy.herokuapp.com?owner=financialforcedev&repo=fflib-apex-mocks">
    <img alt="Deploy to Salesforce" src="https://raw.githubusercontent.com/afawcett/githubsfdeploy/master/src/main/webapp/resources/img/deploy.png">
    </a>

* [Apex Commons](https://github.com/financialforcedev/fflib-apex-common) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/fflib-apex-common?style=flat)](https://github.com/financialforcedev/fflib-apex-common/stargazers) - Common Apex Library supporting Apex Enterprise Patterns and much more!
    Must deploy [ApexMocks](https://github.com/financialforcedev/fflib-apex-mocks) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/fflib-apex-mocks?style=flat)](https://github.com/financialforcedev/fflib-apex-mocks/stargazers) before deploying this library.Also see [MavensMate Templates](http://andyinthecloud.com/2014/05/23/mavensmate-templates-and-apex-enterprise-patterns/)<br/>
...
* [Apex Commons Sample Code](https://github.com/financialforcedev/fflib-apex-common-samplecode) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/fflib-apex-common-samplecode?style=flat)](https://github.com/financialforcedev/fflib-apex-common-samplecode/stargazers) - Samples application illustrating the Apex Enterprise Patterns library
    Must deploy [Apex Common ](https://github.com/financialforcedev/fflib-apex-common) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/fflib-apex-common?style=flat)](https://github.com/financialforcedev/fflib-apex-common/stargazers) before deploying this library<br/>
...
* [Apex Metadata API](https://github.com/financialforcedev/apex-mdapi) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/apex-mdapi?style=flat)](https://github.com/financialforcedev/apex-mdapi/stargazers) - Apex Wrapper for the Salesforce Metadata API <br/>
...
* [Apex Core HttpCallout](https://github.com/financialforcedev/ffhttp-core) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/ffhttp-core?style=flat)](https://github.com/financialforcedev/ffhttp-core/stargazers) - Apex HTTP Callout Framework.<br/>
  ...
  * [Google Cloud Print](https://github.com/financialforcedev/ffhttp-googlecloudprint) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/ffhttp-googlecloudprint?style=flat)](https://github.com/financialforcedev/ffhttp-googlecloudprint/stargazers)
  * [Google Drive](https://github.com/financialforcedev/ffhttp-googledrive) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/ffhttp-googledrive?style=flat)](https://github.com/financialforcedev/ffhttp-googledrive/stargazers)
  * [Google Mirror](https://github.com/financialforcedev/ffhttp-googlemirror) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/ffhttp-googlemirror?style=flat)](https://github.com/financialforcedev/ffhttp-googlemirror/stargazers)
  * [Google Sheets](https://github.com/financialforcedev/ffhttp-googlesheets) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/ffhttp-googlesheets?style=flat)](https://github.com/financialforcedev/ffhttp-googlesheets/stargazers)
  * [Dropbox](https://github.com/financialforcedev/ffhttp-dropbox) [![GitHub stars](https://img.shields.io/github/stars/financialforcedev/ffhttp-dropbox?style=flat)](https://github.com/financialforcedev/ffhttp-dropbox/stargazers)
...
* [Polyforce](https://github.com/mailtoharshit/polyforce) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/polyforce?style=flat)](https://github.com/mailtoharshit/polyforce/stargazers) - PolyForce is the project started as an idea with a motive create polymer applications/components that derive data from Salesforce, The idea create a robust set of polymer components that can mutually be shared with each other and on the other hand provide a working sample for developers to learn and get inspired to built more components <br/>
...
* [Salesforce to Github ](https://github.com/SalesforceFoundation/sfdo-github) [![GitHub stars](https://img.shields.io/github/stars/SalesforceFoundation/sfdo-github?style=flat)](https://github.com/SalesforceFoundation/sfdo-github/stargazers) - Github API client in Apex for Force.com <br/>
* [Apex UML Digram Maker](https://github.com/afawcett/apex-umlcanvas) [![GitHub stars](https://img.shields.io/github/stars/afawcett/apex-umlcanvas?style=flat)](https://github.com/afawcett/apex-umlcanvas/stargazers) - Create UML diagrams from Apex code using the Tooling API <br/>
* [SfApexDoc](http://force-code.com/category/sfapexdoc/) - A full-featured Apex documentation generator, similar to JavaDoc.

* [Visualforce TableGrid](https://github.com/Up2Go/visualforce-table-grid) [![GitHub stars](https://img.shields.io/github/stars/Up2Go/visualforce-table-grid?style=flat)](https://github.com/Up2Go/visualforce-table-grid/stargazers) - TableGrid is a free, open-source Force.com library, that provides users and developers a highly customizable, native-looking, sortable, filterable, editable Grid Visualforce component. This component can be used as an advanced, highly configurable (by developer and user) replacement of apex:pageBlockTables and Standard Related Lists </br>
...
* [Force.com ESAPI](https://github.com/forcedotcom/force-dot-com-esapi) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/force-dot-com-esapi?style=flat)](https://github.com/forcedotcom/force-dot-com-esapi/stargazers) - Enterprise Security API for the Apex language on the Force.com platform. This library consists of three modules - Validation, Output Encoding and Access Control(CRUD, FLS and Sharing).

* [R.apex](https://github.com/Click-to-Cloud/R.apex/) [![GitHub stars](https://img.shields.io/github/stars/Click-to-Cloud/R.apex/?style=flat)](https://github.com/Click-to-Cloud/R.apex//stargazers) - Functional library for Apex. This library, inspired by Ramda.js, offers a bunch of utility functions to manipulate Apex collections, as well as extensive support for functional programming.

* [Force DI](https://github.com/afawcett/force-di) [![GitHub stars](https://img.shields.io/github/stars/afawcett/force-di?style=flat)](https://github.com/afawcett/force-di/stargazers) - Generic [dependency injection](https://en.wikipedia.org/wiki/Dependency_injection) (DI) library with support for injecting Apex, Visualforce, Lightning, and Flows at runtime.
* [Query.apex](https://github.com/Click-to-Cloud/Query.apex/) [![GitHub stars](https://img.shields.io/github/stars/Click-to-Cloud/Query.apex/?style=flat)](https://github.com/Click-to-Cloud/Query.apex//stargazers) - SOQL query builder on Salesforce.com platform, which supports complex conditions, field and namespace management, child relationships query, and functional programming style coding.

* [Apex Chainable Batch](https://github.com/rsoesemann/apex-chainable-batch) [![GitHub stars](https://img.shields.io/github/stars/rsoesemann/apex-chainable-batch?style=flat)](https://github.com/rsoesemann/apex-chainable-batch/stargazers) - Apex Batches can be chained by calling the successor batch from the `finish()` method of the previous batch. But such hardcoding makes this model inflexible. It's hard to build the chain from outside, neighter from a central class nor on runtime dependant on business logic.

* [Apex Test Kit](https://github.com/apexfarm/ApexTestKit) [![GitHub stars](https://img.shields.io/github/stars/apexfarm/ApexTestKit?style=flat)](https://github.com/apexfarm/ApexTestKit/stargazers) - Apex Test Kit can help generate massive sObject data for Apex test classes. It is can help establish arbitrary levels of many-to-one, one-to-many relationships, and also generate field values based on simple rules automatically.
...
* [Cinnamon](https://github.com/forcedotcom/cinnamon) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/cinnamon?style=flat)](https://github.com/forcedotcom/cinnamon/stargazers)-Cinnamon is a Force.com app that enables you to build and run Selenium tests to validate custom UI pages with Visualforce/Javascript in your Salesforce org.

* [Push Notification Plugin for iOS and Android](https://github.com/forcedotcom/PushPlugin) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/PushPlugin?style=flat)](https://github.com/forcedotcom/PushPlugin/stargazers)- Cordova Push Notifications Plugin for Android, iOS, WP8 and Amazon Fire OS

* [Salesforce1-Dev-Guide-Setup-Package](https://github.com/forcedotcom/Salesforce1-Dev-Guide-Setup-Package) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/Salesforce1-Dev-Guide-Setup-Package?style=flat)](https://github.com/forcedotcom/Salesforce1-Dev-Guide-Setup-Package/stargazers)-Salesforce1-Dev-Guide-Setup-Package

* [Analytics-Cloud-Dataset-Utils](https://github.com/forcedotcom/Analytics-Cloud-Dataset-Utils) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/Analytics-Cloud-Dataset-Utils?style=flat)](https://github.com/forcedotcom/Analytics-Cloud-Dataset-Utils/stargazers)- Utility to load external data into Analytics Cloud datasets, and transform existing datasets.

* [Workbench](https://github.com/ryanbrainard/forceworkbench) [![GitHub stars](https://img.shields.io/github/stars/ryanbrainard/forceworkbench?style=flat)](https://github.com/ryanbrainard/forceworkbench/stargazers)- Workbench is a powerful, web-based suite of tools designed for administrators and developers to interact with Salesforce.com organizations via the Force.com APIs.
...
* [SoqlXplorer](https://github.com/superfell/SoqlX) [![GitHub stars](https://img.shields.io/github/stars/superfell/SoqlX?style=flat)](https://github.com/superfell/SoqlX/stargazers)- SoqlXplorer is an awesome tool for developers using the Salesforce.com platform.

* [force-dev-tool](https://github.com/amtrack/force-dev-tool) [![GitHub stars](https://img.shields.io/github/stars/amtrack/force-dev-tool?style=flat)](https://github.com/amtrack/force-dev-tool/stargazers) - Command line tool supporting the Force.com development lifecycle.
...
* [Sweet.apex](https://github.com/Click-to-Cloud/Sweet.apex/) [![GitHub stars](https://img.shields.io/github/stars/Click-to-Cloud/Sweet.apex/?style=flat)](https://github.com/Click-to-Cloud/Sweet.apex//stargazers) - Sweet.apex is the next generation of Apex development, transpiling Sweet Apex(a feature-rich Apex-like code) to Apex classes.

* [soql-parser-js](https://github.com/paustint/soql-parser-js) [![GitHub stars](https://img.shields.io/github/stars/paustint/soql-parser-js?style=flat)](https://github.com/paustint/soql-parser-js/stargazers) - JavaScript library for parsing SOQL queries, composing SOQL queries, and formatting SOQL queries.
...
* [GitIgnore for Salesforce ](https://github.com/mailtoharshit/gitignore) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/gitignore?style=flat)](https://github.com/mailtoharshit/gitignore/stargazers)- Reusable .gitIgnore file for Salesforce or Force.com Projects

### Open Source Projects Repositories from Salesforce

* [Salesforce Git Repo](https://github.com/forcedotcom) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom?style=flat)](https://github.com/forcedotcom/stargazers) - Grab all latest salesforce open source projects here, you will find awesome projects, framework, libraries that salesforce and opened for the world
* [Salesforce Labs](https://github.com/salesforcelabs) [![GitHub stars](https://img.shields.io/github/stars/salesforcelabs?style=flat)](https://github.com/salesforcelabs/stargazers) - Checkout open source and experimental projects from Salesforce Team. Get an early access to features that can qualify in feature and contribute your ideas
...
* [Salesforce Mobile UI - Polymer Elements for Salesforce](https://github.com/forcedotcom/mobile-ui-elements) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/mobile-ui-elements?style=flat)](https://github.com/forcedotcom/mobile-ui-elements/stargazers) - Mobile UI Elements is a free, open-source Force.com (unsupported) library to simplify the development of mobile apps. The library, based on the Google’s Polymer framework, provides the fundamental building blocks for creating HTML5 apps that run well on smartphones and tablets
* [ForceServer](https://github.com/ccoenraets/force-server) [![GitHub stars](https://img.shields.io/github/stars/ccoenraets/force-server?style=flat)](https://github.com/ccoenraets/force-server/stargazers) - It supportes a proxy and web server, ForceServer is a simple development server aimed at providing a simple and integrated developer experience when building applications that use Salesforce OAuth and REST services.
...
* [ForceSniffer - Device Detection Library for Salesforce](https://github.com/mailtoharshit/ForceSniffer.Js) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/ForceSniffer.Js?style=flat)](https://github.com/mailtoharshit/ForceSniffer.Js/stargazers) - Simplified Library that detect Mobile Devices, Salesforce1 App and other Saleforce Context.
* [ForceJS](https://github.com/ccoenraets/forcejs/tree/es6) [![GitHub stars](https://img.shields.io/github/stars/ccoenraets/forcejs/tree/es6?style=flat)](https://github.com/ccoenraets/forcejs/tree/es6/stargazers) - With ES6 support now, this micro library designed to use the Salesforce REST APIs in JavaScript Apps
* [nForce](https://github.com/kevinohara80/nforce) [![GitHub stars](https://img.shields.io/github/stars/kevinohara80/nforce?style=flat)](https://github.com/kevinohara80/nforce/stargazers) - nforce is a node.js salesforce REST API wrapper for force.com, database.com, and salesforce.com
* [ngForce](https://github.com/noeticpenguin/ngForce) [![GitHub stars](https://img.shields.io/github/stars/noeticpenguin/ngForce?style=flat)](https://github.com/noeticpenguin/ngForce/stargazers) -A set of Angular.js modules that facilitate quick and sustainable Angular.js application development on the Force.com Platform.
* [ForceTK](https://github.com/developerforce/Force.com-JavaScript-REST-Toolkit) [![GitHub stars](https://img.shields.io/github/stars/developerforce/Force.com-JavaScript-REST-Toolkit?style=flat)](https://github.com/developerforce/Force.com-JavaScript-REST-Toolkit/stargazers)- ForceTK - a minimal Force.com REST API for JavaScript apps
* [ForceEng](https://github.com/ccoenraets/forceng) [![GitHub stars](https://img.shields.io/github/stars/ccoenraets/forceng?style=flat)](https://github.com/ccoenraets/forceng/stargazers) - Micro-Library to use Salesforce REST API in AngularJS apps
* [Formulon](https://github.com/leifg/formulon) [![GitHub stars](https://img.shields.io/github/stars/leifg/formulon?style=flat)](https://github.com/leifg/formulon/stargazers) - Formula parser completely implemented in ES6. [See Demo](http://formulon.io)
...
* [Feather - Google Material Design Mockup for Salesforce](https://github.com/mailtoharshit/Feather/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/Feather/blob/master/README.md?style=flat)](https://github.com/mailtoharshit/Feather/blob/master/README.md/stargazers) - Library
...
* [Salesforce ReactJS SPA Starter](https://github.com/stomita/salesforce-reactjs-spa-starter) [![GitHub stars](https://img.shields.io/github/stars/stomita/salesforce-reactjs-spa-starter?style=flat)](https://github.com/stomita/salesforce-reactjs-spa-starter/stargazers) - A template project to create ReactJS-based single page application on Salesforce, with automatic build script (Gulp.js)
* [ForceSpinner](https://github.com/mailtoharshit/ForceSpinner) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/ForceSpinner?style=flat)](https://github.com/mailtoharshit/ForceSpinner/stargazers) - Loaders/Spinner collections to leverage powerful User Experience for Salesforce Projects
...
* Some other solutions from [awesome-etl list](https://github.com/pawl/awesome-etl) [![GitHub stars](https://img.shields.io/github/stars/pawl/awesome-etl?style=flat)](https://github.com/pawl/awesome-etl/stargazers).

## Salesforce Lightning
* [Awesome Lightning](https://github.com/mailtoharshit/awesome-lighting) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-lighting?style=flat)](https://github.com/mailtoharshit/awesome-lighting/stargazers): Awesome Contents for Salesforce Lightning Framework

## Salesforce Browser Extensions
* [Awesome Salesforce Browser Extensions](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-browser-extensions-for-salesforce?style=flat)](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce/stargazers): Collection of Awesome Browser Extensions for Salesforce

## Mobile Development with Salesforce

### Mobile SDK
* [Salesfoce MobileSDK for iOS](https://github.com/forcedotcom/SalesforceMobileSDK-iOS) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/SalesforceMobileSDK-iOS?style=flat)](https://github.com/forcedotcom/SalesforceMobileSDK-iOS/stargazers)-If you'd like to work with the source code of the SDK itself, you've come to the right place! You can browse sample app source code and debug down through the layers to get a feel for how everything works under the covers.

* [Salesfoce MobileSDK for Windows](https://github.com/forcedotcom/SalesforceMobileSDK-Windows) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/SalesforceMobileSDK-Windows?style=flat)](https://github.com/forcedotcom/SalesforceMobileSDK-Windows/stargazers)-Build the project normally in Visual Studio; everything should build fine. If you wish to create a new project and not use the NuGet versions of the core libraries, simply create a new project with the template, remove the NuGet reference and add references to Salesforce.SDK.Core, Salesforce.SDK.Store (for windows projects) or Salesforce.SDK.Phone for phone projects.

* [Salesfoce MobileSDK for Andriod](https://github.com/forcedotcom/SalesforceMobileSDK-Android) [![GitHub stars](https://img.shields.io/github/stars/forcedotcom/SalesforceMobileSDK-Android?style=flat)](https://github.com/forcedotcom/SalesforceMobileSDK-Android/stargazers)- Source repository for the Salesforce Mobile SDK for Android.
...
AngularJS Pack : [Get Started](https://developer.salesforce.com/mobile/getting-started/html5/#angularjs) | [Github Repo](https://github.com/developerforce/MobilePack-AngularJS) [![GitHub stars](https://img.shields.io/github/stars/developerforce/MobilePack-AngularJS?style=flat)](https://github.com/developerforce/MobilePack-AngularJS/stargazers) |  [<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Angular_full_color_logo.svg/250px-Angular_full_color_logo.svg.png" align="left" width="180">](https://developer.salesforce.com/mobile/getting-started/html5/#jquery)
...
Contributions welcome! Read the [contribution guidelines](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/mailtoharshit/awesome-salesforce/blob/master/contributing.md?style=flat)](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md/stargazers) first.
