...
- [Network Audio Controller](https://github.com/chris-ritsen/network-audio-controller) [![GitHub stars](https://img.shields.io/github/stars/chris-ritsen/network-audio-controller?style=flat)](https://github.com/chris-ritsen/network-audio-controller/stargazers) - Reverse engineered Dante Controller on the command line.
...
- [AES67 Linux Daemon](https://github.com/bondagit/aes67-linux-daemon) [![GitHub stars](https://img.shields.io/github/stars/bondagit/aes67-linux-daemon?style=flat)](https://github.com/bondagit/aes67-linux-daemon/stargazers) - Fork of Merging's driver with an open source web server.
- [AES67 Monitor](https://github.com/philhartung/aes67-monitor) [![GitHub stars](https://img.shields.io/github/stars/philhartung/aes67-monitor?style=flat)](https://github.com/philhartung/aes67-monitor/stargazers) - Cross platform AES67 monitoring app.
...
- [PAM](https://github.com/martim01/pam) [![GitHub stars](https://img.shields.io/github/stars/martim01/pam?style=flat)](https://github.com/martim01/pam/stargazers) - FOSS AES67 capable audio monitor.
- [Snapcast](https://github.com/badaix/snapcast/tree/develop) [![GitHub stars](https://img.shields.io/github/stars/badaix/snapcast/tree/develop?style=flat)](https://github.com/badaix/snapcast/tree/develop/stargazers) - FOSS project for a Sonos-like multiroom solution, using a custom TCP-based protocol.
- [Ravennakit SDK](https://github.com/soundondigital/ravennakit) [![GitHub stars](https://img.shields.io/github/stars/soundondigital/ravennakit?style=flat)](https://github.com/soundondigital/ravennakit/stargazers) - Provides a cross-platform C++ SDK for professional networked audio using AES67, RAVENNA, and ST2110-30.
- [Inferno](https://gitlab.com/lumifaza/inferno) - Open source implementation of Dante AoIP in Rust ([GitHub mirror](https://github.com/teodly/inferno/) [![GitHub stars](https://img.shields.io/github/stars/teodly/inferno/?style=flat)](https://github.com/teodly/inferno//stargazers)).
...
- [NMOS](https://github.com/AMWA-TV/nmos) [![GitHub stars](https://img.shields.io/github/stars/AMWA-TV/nmos?style=flat)](https://github.com/AMWA-TV/nmos/stargazers) - REST APIs for controlling network media devices.
...
- [Awesome Audiovisual](https://github.com/stingalleman/awesome-audiovisual) [![GitHub stars](https://img.shields.io/github/stars/stingalleman/awesome-audiovisual?style=flat)](https://github.com/stingalleman/awesome-audiovisual/stargazers) - AV list containing a little AoIP.
- [Awesome Broadcasting](https://github.com/ebu/awesome-broadcasting) [![GitHub stars](https://img.shields.io/github/stars/ebu/awesome-broadcasting?style=flat)](https://github.com/ebu/awesome-broadcasting/stargazers) - EBU list containing a little AoIP.
