...
> 来源：[kdeldycke/awesome-billing](https://github.com/kdeldycke/awesome-billing)

[![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-billing?style=flat)](https://github.com/kdeldycke/awesome-billing/stargazers)
...
Billing is one of the transversal pillar of the ecosystem, where customers, products and business meets. The [other pillar being Identity and Access Management (IAM) 👤](https://github.com/kdeldycke/awesome-iam/) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-iam/?style=flat)](https://github.com/kdeldycke/awesome-iam//stargazers).
...
- [Open guide to AWS](https://github.com/open-guides/og-aws#billing-and-cost-management) [![GitHub stars](https://img.shields.io/github/stars/open-guides/og-aws?style=flat)](https://github.com/open-guides/og-aws/stargazers) - Links to the *Billing and Cost Management* section which details the broad characteristics of billing for a cloud provider.
...
- [Lago](https://github.com/getlago/lago) [![GitHub stars](https://img.shields.io/github/stars/getlago/lago?style=flat)](https://github.com/getlago/lago/stargazers) - 💸 Open-source metering & usage-based billing in Ruby. Lago SAS sells a hosted Cloud and Premium add-ons on top of the AGPL core.

- [StripeMeter](https://github.com/geminimir/stripemeter) [![GitHub stars](https://img.shields.io/github/stars/geminimir/stripemeter?style=flat)](https://github.com/geminimir/stripemeter/stargazers) - 🆓 Open-source, Stripe-native usage metering in TypeScript. Reconciles computed usage against Stripe invoices for “pre-invoice parity”, with exactly-once processing and real-time cost projections.

- [CGRateS](https://github.com/cgrates/cgrates) [![GitHub stars](https://img.shields.io/github/stars/cgrates/cgrates?style=flat)](https://github.com/cgrates/cgrates/stargazers) - 🆓 An open-source, fast (50k+ CPS) and scalable (load-balancer + replication included) real-time billing for ISPs and Telecom Operators, written in Go. Vendor-neutral, support-only commercial model.
...
- [Lotus](https://github.com/uselotus/lotus) [![GitHub stars](https://img.shields.io/github/stars/uselotus/lotus?style=flat)](https://github.com/uselotus/lotus/stargazers) - 🆓 Open-source project to manage pricing & packaging infrastructure. Lotus Inc. only sells managed hosting on top of the MIT core.

- [`f-license`](https://github.com/furkansenharputlu/f-license) [![GitHub stars](https://img.shields.io/github/stars/furkansenharputlu/f-license?style=flat)](https://github.com/furkansenharputlu/f-license/stargazers) - 🆓 Open-source license key generation and verification tool in Go. Solo-maintainer project, no commercial offering.
...
- [`sktime`](https://github.com/alan-turing-institute/sktime) [![GitHub stars](https://img.shields.io/github/stars/alan-turing-institute/sktime?style=flat)](https://github.com/alan-turing-institute/sktime/stargazers) - 🆓 Python library for time-series machine learning, governed by the Alan Turing Institute. See the [forecasting tutorial](https://github.com/alan-turing-institute/sktime/blob/master/examples/01_forecasting.ipynb) [![GitHub stars](https://img.shields.io/github/stars/alan-turing-institute/sktime/blob/master/examples/01_forecasting.ipynb?style=flat)](https://github.com/alan-turing-institute/sktime/blob/master/examples/01_forecasting.ipynb/stargazers) and the [differences between sktime and the Prophet project](https://news.ycombinator.com/item?id=24543861).

- [Darts](https://github.com/unit8co/darts) [![GitHub stars](https://img.shields.io/github/stars/unit8co/darts?style=flat)](https://github.com/unit8co/darts/stargazers) - 🆓 Python library for user-friendly forecasting and anomaly detection on time series, stewarded by Unit8 SA which only sells consulting around it (no paid library tier). Wraps a huge number of models, including [Prophet](https://facebook.github.io/prophet/). Great for experiments, but bear in mind that all the [models in Darts expects](https://news.ycombinator.com/item?id=37665435) that your data comes at a very regular interval, and make a lot of assumptions about their shape.

- [Komiser](https://github.com/mlabouardy/komiser) [![GitHub stars](https://img.shields.io/github/stars/mlabouardy/komiser?style=flat)](https://github.com/mlabouardy/komiser/stargazers) - 💸 Open-source tool to stay under budget by uncovering hidden costs, monitoring increases in spend, and making impactful changes based on custom recommendations. Tailwarden sells a hosted SaaS on top.
...
- [Papers we love: Auctions and Bidding](https://github.com/papers-we-love/papers-we-love/tree/master/economics#auctions-and-bidding) [![GitHub stars](https://img.shields.io/github/stars/papers-we-love/papers-we-love/tree/master/economics?style=flat)](https://github.com/papers-we-love/papers-we-love/tree/master/economics/stargazers) - A collection of papers on bidding and auctions.
...
- [RTB Budget Pacing Summarized](https://github.com/PragmaticLab/RTB_Budget_Pacing_Summarized) [![GitHub stars](https://img.shields.io/github/stars/PragmaticLab/RTB_Budget_Pacing_Summarized?style=flat)](https://github.com/PragmaticLab/RTB_Budget_Pacing_Summarized/stargazers) - A reading list distilling research papers from Turn Inc., Yahoo, and LinkedIn on RTB budget pacing techniques. Static resource: dated but still a useful entry point into the literature.

- [Samsung's online ads platform/exchange war story](https://github.com/eloraiby/fs-pacer/blob/master/fs-pacer.md) [![GitHub stars](https://img.shields.io/github/stars/eloraiby/fs-pacer/blob/master/fs-pacer.md?style=flat)](https://github.com/eloraiby/fs-pacer/blob/master/fs-pacer.md/stargazers) - How to scale to 5M bid request/s, 2ms Max Response Time.

- [`RTB4Free`](https://github.com/RTB4FREE) [![GitHub stars](https://img.shields.io/github/stars/RTB4FREE?style=flat)](https://github.com/RTB4FREE/stargazers) - 🆓 Apache-2.0 OpenRTB 2.0-compliant bidder and Demand Side Platform (DSP). Largely dormant since late 2022, but the only OSS DSP reference in this niche.
...
- [Frappe Books](https://github.com/frappe/books) [![GitHub stars](https://img.shields.io/github/stars/frappe/books?style=flat)](https://github.com/frappe/books/stargazers) - 🆓 Free desktop book-keeping software for small-businesses and freelancers, with no paid edition.
...
- [TigerBeetle](https://github.com/tigerbeetle/tigerbeetle) [![GitHub stars](https://img.shields.io/github/stars/tigerbeetle/tigerbeetle?style=flat)](https://github.com/tigerbeetle/tigerbeetle/stargazers) - 🆓 A distributed financial accounting database to ensure that the money either moves, or doesn't move, that it doesn't get lost somewhere in between. All features are in the Apache-2.0 OSS repo; TigerBeetle Inc. sells managed hosting and support, not gated features. It has been [tested on Jepsen](https://jepsen.io/analyses/tigerbeetle-0.16.11), which tested its strong serializability.

- [Django Hordak](https://github.com/adamcharnock/django-hordak) [![GitHub stars](https://img.shields.io/github/stars/adamcharnock/django-hordak?style=flat)](https://github.com/adamcharnock/django-hordak/stargazers) - 🆓 Core functionality of a double entry accounting system for Django, single-maintainer MIT library.

- [Managed accounts for Django](https://github.com/django-oscar/django-oscar-accounts) [![GitHub stars](https://img.shields.io/github/stars/django-oscar/django-oscar-accounts?style=flat)](https://github.com/django-oscar/django-oscar-accounts/stargazers) - 🆓 A 'managed account' is an allocation of money that can be debited and credited. Community-maintained django-oscar extension.
...
- [{Digital,Cloud,Electronic,Online} Services VAT Rate Database](https://github.com/kdeldycke/vat-rates) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/vat-rates?style=flat)](https://github.com/kdeldycke/vat-rates/stargazers) - 🆓 Centralize applicable VAT rates on foreign online services, for each country of residence (including territorial exceptions).
...
- [Invoice Builder](https://github.com/piratuks/invoice-builder) [![GitHub stars](https://img.shields.io/github/stars/piratuks/invoice-builder?style=flat)](https://github.com/piratuks/invoice-builder/stargazers) - 🆓 Offline-first desktop app to create, manage and export invoices and quotes to PDF, with all data kept in a local database you own.

- [InvoicePlane](https://github.com/InvoicePlane/InvoicePlane) [![GitHub stars](https://img.shields.io/github/stars/InvoicePlane/InvoicePlane?style=flat)](https://github.com/InvoicePlane/InvoicePlane/stargazers) - 🆓 A self-hosted open-source application for managing your invoices, clients and payments. Community project, no paid edition.

- [klirr](https://github.com/sajjon/klirr) [![GitHub stars](https://img.shields.io/github/stars/sajjon/klirr?style=flat)](https://github.com/sajjon/klirr/stargazers) - 🆓 Zero-maintenance FOSS CLI tool for generating beautiful invoices for services and expenses.

- [InvoiceGenerator](https://github.com/by-cx/InvoiceGenerator) [![GitHub stars](https://img.shields.io/github/stars/by-cx/InvoiceGenerator?style=flat)](https://github.com/by-cx/InvoiceGenerator/stargazers) - 🆓 Python library to generate simple invoices.

- [microinvoice](https://github.com/baptistejamin/node-microinvoice) [![GitHub stars](https://img.shields.io/github/stars/baptistejamin/node-microinvoice?style=flat)](https://github.com/baptistejamin/node-microinvoice/stargazers) - 🆓 Fast Node.js library to generate PDF invoices with PDFKit, no headless browser required.

- [Ruby Invoicing Framework](https://github.com/code-mancers/invoicing) [![GitHub stars](https://img.shields.io/github/stars/code-mancers/invoicing?style=flat)](https://github.com/code-mancers/invoicing/stargazers) - 🆓 For generating and displaying invoices (ideal for commercial Rails apps). It allows for flexible business logic; provides tools for tax handling, commission calculation etc.
...
- [Factur-X](https://github.com/akretion/factur-x) [![GitHub stars](https://img.shields.io/github/stars/akretion/factur-x?style=flat)](https://github.com/akretion/factur-x/stargazers) - 🆓 Python library to support the e-invoicing standard for France and Germany.
...
- [GOBL](https://github.com/invopop/gobl) [![GitHub stars](https://img.shields.io/github/stars/invopop/gobl?style=flat)](https://github.com/invopop/gobl/stargazers) - 💸 JSON Schema, Open Source Go library, global tax database, with conversion tools, all in one. Invopop sells a managed e-invoicing SaaS implementation on top of the open spec.
...
- [Polar](https://github.com/polarsource/polar) [![GitHub stars](https://img.shields.io/github/stars/polarsource/polar?style=flat)](https://github.com/polarsource/polar/stargazers) - 💸 Open-source monetization platform to sell SaaS and digital products. Polar Software Inc. runs the hosted polar.sh service as the merchant of record, handling billing, sales tax and VAT remittance for a cut of each transaction; the self-hostable OSS ships the full stack (checkout, subscriptions, usage metering, license keys) on top of your own Stripe account.

- [moov](https://github.com/moov-io) [![GitHub stars](https://img.shields.io/github/stars/moov-io?style=flat)](https://github.com/moov-io/stargazers) - 🆓 Suite of Apache-2.0 libraries for financial technology, including [`moov-io/ach`](https://github.com/moov-io/ach) [![GitHub stars](https://img.shields.io/github/stars/moov-io/ach?style=flat)](https://github.com/moov-io/ach/stargazers), [`iso8583`](https://github.com/moov-io/iso8583) [![GitHub stars](https://img.shields.io/github/stars/moov-io/iso8583?style=flat)](https://github.com/moov-io/iso8583/stargazers), and [`watchman`](https://github.com/moov-io/watchman) [![GitHub stars](https://img.shields.io/github/stars/moov-io/watchman?style=flat)](https://github.com/moov-io/watchman/stargazers). No paid product on top.

- [Fintech Open Source Foundation](https://github.com/finos) [![GitHub stars](https://img.shields.io/github/stars/finos?style=flat)](https://github.com/finos/stargazers) - 🆓 Linux Foundation project hosting open-source projects for financial services.
...
- [Swift Codes Repository](https://github.com/PeterNotenboom/SwiftCodes) [![GitHub stars](https://img.shields.io/github/stars/PeterNotenboom/SwiftCodes?style=flat)](https://github.com/PeterNotenboom/SwiftCodes/stargazers) - 🆓 Static JSON dataset of SWIFT/BIC codes for banks worldwide, scraped from the site above. Last refreshed in 2019 but still the largest free reference; SWIFT codes change slowly so the data remains broadly usable.
...
- [Awesome List of IAM: Fraud links](https://github.com/kdeldycke/awesome-iam#fraud) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-iam?style=flat)](https://github.com/kdeldycke/awesome-iam/stargazers) - Section dedicated to fraud management related to user accounts, from our sister repository.
...
- [Awesome Fraud Detection Research Papers](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers) [![GitHub stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-fraud-detection-papers?style=flat)](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers/stargazers) - Papers sourced from several conferences on all sort of fraud: credit card, payment transactions, loans, customs inspections, money laundering networks, and more.

- [Tazama](https://github.com/tazama-lf) [![GitHub stars](https://img.shields.io/github/stars/tazama-lf?style=flat)](https://github.com/tazama-lf/stargazers) - 🆓 Open-source real-time transaction monitoring software for fraud and money laundering detection, governed by the Tazama Linux Foundation project. This is just an engine to define rules, weight them, and apply them to transactions. There is nothing specific to payments or financial transactions.

- [Mojaloop Fraud Risk Management](https://github.com/mojaloop/fraud_risk_management/tree/master/typology-214/src/rules) [![GitHub stars](https://img.shields.io/github/stars/mojaloop/fraud_risk_management/tree/master/typology-214/src/rules?style=flat)](https://github.com/mojaloop/fraud_risk_management/tree/master/typology-214/src/rules/stargazers) - 🆓 Concrete AML rule implementations from the Mojaloop Foundation: transaction mirroring (90-100% amount-match window), multi-tier payee-graph traversal for layering detection, account-dormancy reactivation, large-transaction-payer, new-payee-transfer. Repo is archived but the rules are static reference material rarely seen elsewhere in OSS.
...
- [Awesome Credit Modeling](https://github.com/mourarthur/awesome-credit-modeling#readme) [![GitHub stars](https://img.shields.io/github/stars/mourarthur/awesome-credit-modeling?style=flat)](https://github.com/mourarthur/awesome-credit-modeling/stargazers) - How to use statistical methods to classify applicants into categories to reduce risks. Lots of inspiration and research papers there to improve general scoring.
...
- [PyMC-Marketing](https://github.com/pymc-labs/pymc-marketing) [![GitHub stars](https://img.shields.io/github/stars/pymc-labs/pymc-marketing?style=flat)](https://github.com/pymc-labs/pymc-marketing/stargazers) - 🆓 A full-featured Python package to analyze your users based on their "alive" and "dead" states. Apache-2.0 library stewarded by PyMC Labs, which only sells consulting services around it (no paid library tier).
...
- [`redash`](https://github.com/getredash/redash) [![GitHub stars](https://img.shields.io/github/stars/getredash/redash?style=flat)](https://github.com/getredash/redash/stargazers) - 🆓 Connect and query your data sources, build dashboards to visualize data and share them with your company. Owned by Databricks but the hosted SaaS shut down in 2021, so the project is now community-maintained under the Databricks org with no paid Redash product.

- [Apache Superset](https://github.com/apache/superset) [![GitHub stars](https://img.shields.io/github/stars/apache/superset?style=flat)](https://github.com/apache/superset/stargazers) - 🆓 Enterprise-ready business intelligence web application, governed by the Apache Software Foundation.

- [Meltano](https://github.com/meltano/meltano) [![GitHub stars](https://img.shields.io/github/stars/meltano/meltano?style=flat)](https://github.com/meltano/meltano/stargazers) - 🆓 Open source convention-over-configuration product for the whole data lifecycle, all the way from loading data to analyzing it. Meltano only sells managed Cloud hosting and support SLA on top of the OSS core.
...
The [header image](https://github.com/kdeldycke/awesome-billing/blob/main/assets/awesome-billing-header.jpg) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-billing/blob/main/assets/awesome-billing-header.jpg?style=flat)](https://github.com/kdeldycke/awesome-billing/blob/main/assets/awesome-billing-header.jpg/stargazers) is based on a modified [photo](https://web.archive.org/web/20221210200108/https://unsplash.com/photos/u2zSzMTwIjQ) by [Denny Müller](https://web.archive.org/web/20221210200108/https://unsplash.com/@redaquamedia).
