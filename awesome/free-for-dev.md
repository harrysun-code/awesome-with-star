...
> 来源：[ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev)

[![GitHub stars](https://img.shields.io/github/stars/ripienaar/free-for-dev?style=flat)](https://github.com/ripienaar/free-for-dev/stargazers)
...
This list results from Pull Requests, reviews, ideas, and work done by 1600+ people. You can also help by sending [Pull Requests](https://github.com/ripienaar/free-for-dev) [![GitHub stars](https://img.shields.io/github/stars/ripienaar/free-for-dev?style=flat)](https://github.com/ripienaar/free-for-dev/stargazers) to add more services or remove ones whose offerings have changed or been retired.
...
## Testing
  ...
  * [Testspace.com](https://testspace.com/) - A Dashboard for publishing automated test results and a Framework for implementing manual tests as code using GitHub. The service is [free for Open Source](https://github.com/marketplace/testspace-com) [![GitHub stars](https://img.shields.io/github/stars/marketplace/testspace-com?style=flat)](https://github.com/marketplace/testspace-com/stargazers) and accounts for 450 monthly results.
...
## Generative AI
  ...
  * [Pollinations.AI](https://pollinations.ai/) - easy-to-use, free image generation AI with free API available. No signups or API keys required, and several option for integrating into a website or workflow. [#opensource](https://github.com/pollinations/pollinations) [![GitHub stars](https://img.shields.io/github/stars/pollinations/pollinations?style=flat)](https://github.com/pollinations/pollinations/stargazers)
...
## Tunneling, WebRTC, Web Socket Servers and Other Routers
  ...
  * [localtunnel](https://theboroer.github.io/localtunnel-www/) - Expose locally running servers over a tunnel to a public URL. Free hosted version, and [open source](https://github.com/localtunnel/localtunnel) [![GitHub stars](https://img.shields.io/github/stars/localtunnel/localtunnel?style=flat)](https://github.com/localtunnel/localtunnel/stargazers).
...
## Issue Tracking and Project Management
  ...
  * [GraphQL Inspector](https://github.com/marketplace/graphql-inspector) [![GitHub stars](https://img.shields.io/github/stars/marketplace/graphql-inspector?style=flat)](https://github.com/marketplace/graphql-inspector/stargazers) - GraphQL Inspector outputs a list of changes between two GraphQL schemas. Every difference is precisely explained and marked as breaking, non-breaking, or dangerous.
...
## Storage and Media Processing
  ...
  * [Imgbot](https://github.com/marketplace/imgbot) [![GitHub stars](https://img.shields.io/github/stars/marketplace/imgbot?style=flat)](https://github.com/marketplace/imgbot/stargazers) - Imgbot is a friendly robot that optimizes your images and saves you time. Optimized images mean smaller file sizes without sacrificing quality. It's free for open source.
