...
- [glslify](https://github.com/stackgl/glslify) [![GitHub stars](https://img.shields.io/github/stars/stackgl/glslify?style=flat)](https://github.com/stackgl/glslify/stargazers) - npm modules compiled into WebGL shaders
...
## sound
- [doppler](https://github.com/DanielRapp/doppler) [![GitHub stars](https://img.shields.io/github/stars/DanielRapp/doppler?style=flat)](https://github.com/DanielRapp/doppler/stargazers) - detect motion with the doppler effect using only the microphone and speakers
- [speak.js](https://github.com/mattytemple/speak-js) [![GitHub stars](https://img.shields.io/github/stars/mattytemple/speak-js?style=flat)](https://github.com/mattytemple/speak-js/stargazers) - text-to-speech on the web
...
- [vantage.js](https://github.com/dthree/vantage) [![GitHub stars](https://img.shields.io/github/stars/dthree/vantage?style=flat)](https://github.com/dthree/vantage/stargazers) - CLI + SSH + REPL for Node
- [cash](https://github.com/dthree/cash) [![GitHub stars](https://img.shields.io/github/stars/dthree/cash?style=flat)](https://github.com/dthree/cash/stargazers) - Cross-platform Linux commands in pure ES6

## virtual machines
- [jsemu](https://github.com/fcambus/jsemu) [![GitHub stars](https://img.shields.io/github/stars/fcambus/jsemu?style=flat)](https://github.com/fcambus/jsemu/stargazers) - A list of emulators written in the JavaScript
...
- [doppio](https://github.com/plasma-umass/doppio) [![GitHub stars](https://img.shields.io/github/stars/plasma-umass/doppio?style=flat)](https://github.com/plasma-umass/doppio/stargazers) - actively updated jvm in node.js, written in TypeScript
...
- [Mathias Buus](https://github.com/mafintosh) [![GitHub stars](https://img.shields.io/github/stars/mafintosh?style=flat)](https://github.com/mafintosh/stargazers) - torrents in node, fuse bindings, data replication
- [Feross Aboukhadijeh](https://github.com/feross) [![GitHub stars](https://img.shields.io/github/stars/feross?style=flat)](https://github.com/feross/stargazers) - webtorrent, bittorrent, p2p hacks
- [Max Ogden](https://github.com/maxogden) [![GitHub stars](https://img.shields.io/github/stars/maxogden?style=flat)](https://github.com/maxogden/stargazers) - streams, voxels, data replication
