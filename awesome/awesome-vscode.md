...
- [Source code](https://github.com/microsoft/vscode) [![GitHub stars](https://img.shields.io/github/stars/microsoft/vscode?style=flat)](https://github.com/microsoft/vscode/stargazers) on GitHub
- [Releases (stable channel)](https://code.visualstudio.com/download)
- [Releases (insiders channel)](https://code.visualstudio.com/insiders)
- [Monthly iteration plans](https://github.com/Microsoft/vscode/issues?utf8=%E2%9C%93&q=label%3Aiteration-plan+) [![GitHub stars](https://img.shields.io/github/stars/Microsoft/vscode/issues?utf8=%E2%9C%93&q=label%3Aiteration-plan+?style=flat)](https://github.com/Microsoft/vscode/issues?utf8=%E2%9C%93&q=label%3Aiteration-plan+/stargazers)
...
- [Wenyan](https://github.com/antfu/wenyan-lang-vscode) [![GitHub stars](https://img.shields.io/github/stars/antfu/wenyan-lang-vscode?style=flat)](https://github.com/antfu/wenyan-lang-vscode/stargazers)
...
Make sure to visit it at [Microsoft/vscode-recipes](https://github.com/Microsoft/vscode-recipes) [![GitHub stars](https://img.shields.io/github/stars/Microsoft/vscode-recipes?style=flat)](https://github.com/Microsoft/vscode-recipes/stargazers)
...
See the difference between these two [here](https://github.com/michaelgmcd/vscode-language-babel/issues/1) [![GitHub stars](https://img.shields.io/github/stars/michaelgmcd/vscode-language-babel/issues/1?style=flat)](https://github.com/michaelgmcd/vscode-language-babel/issues/1/stargazers)

### Linters

- [eslint](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint) - Linter for [eslint](https://eslint.org/).
- [XO](https://marketplace.visualstudio.com/items?itemName=samverschueren.linter-xo) - Linter for [XO](https://github.com/xojs/xo) [![GitHub stars](https://img.shields.io/github/stars/xojs/xo?style=flat)](https://github.com/xojs/xo/stargazers).
- [AVA](https://marketplace.visualstudio.com/items?itemName=samverschueren.ava) - Snippets for [AVA](https://github.com/avajs/ava) [![GitHub stars](https://img.shields.io/github/stars/avajs/ava?style=flat)](https://github.com/avajs/ava/stargazers).
- [Prettier](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode) - Opinionated code formatter for [Prettier](https://github.com/prettier/prettier-vscode) [![GitHub stars](https://img.shields.io/github/stars/prettier/prettier-vscode?style=flat)](https://github.com/prettier/prettier-vscode/stargazers).
...
> Linter for [markdownlint](https://github.com/DavidAnson/markdownlint) [![GitHub stars](https://img.shields.io/github/stars/DavidAnson/markdownlint?style=flat)](https://github.com/DavidAnson/markdownlint/stargazers).
...
![Indentation of pasted code animation](https://github.com/vikrantnegi/vscode-personal-preference-setting/blob/master/screenshots/pasteandindent.gif) [![GitHub stars](https://img.shields.io/github/stars/vikrantnegi/vscode-personal-preference-setting/blob/master/screenshots/pasteandindent.gif?style=flat)](https://github.com/vikrantnegi/vscode-personal-preference-setting/blob/master/screenshots/pasteandindent.gif/stargazers)
...
![Wraps selection or multiple selections with symbol or multiple symbols animation](https://github.com/gko/wrap/blob/master/features.gif) [![GitHub stars](https://img.shields.io/github/stars/gko/wrap/blob/master/features.gif?style=flat)](https://github.com/gko/wrap/blob/master/features.gif/stargazers)

## [Formatting Toggle](https://marketplace.visualstudio.com/items?itemName=tombonnike.vscode-status-bar-format-toggle)

> Allows you to toggle your formatter on and off with a simple click

## [shell-format](https://github.com/foxundermoon/vs-shell-format) [![GitHub stars](https://img.shields.io/github/stars/foxundermoon/vs-shell-format?style=flat)](https://github.com/foxundermoon/vs-shell-format/stargazers)
...
- [Essence](https://github.com/essence-language/vscode-extension) [![GitHub stars](https://img.shields.io/github/stars/essence-language/vscode-extension?style=flat)](https://github.com/essence-language/vscode-extension/stargazers)
...
- [Open in Code](https://github.com/sozercan/OpenInCode) [![GitHub stars](https://img.shields.io/github/stars/sozercan/OpenInCode?style=flat)](https://github.com/sozercan/OpenInCode/stargazers) - macOS Finder toolbar app to open current folder in Visual Studio Code
