...
An auxiliary list of awesome Haskell links, frameworks, libraries and software. The part of the [awesome](https://github.com/sindresorhus/awesome) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers) projects line.
...
* [hsenv](https://github.com/Paczesiowa/hsenv/) [![GitHub stars](https://img.shields.io/github/stars/Paczesiowa/hsenv/?style=flat)](https://github.com/Paczesiowa/hsenv//stargazers) - a tool to create isolated Haskell environments. This allows a project to use a GHC version different of the currently installed.
* [Stack](https://github.com/commercialhaskell/stack) [![GitHub stars](https://img.shields.io/github/stars/commercialhaskell/stack?style=flat)](https://github.com/commercialhaskell/stack/stargazers) - a cross-platform tool to help on building Haskell projects. It includes support to create isolated Haskell environments and to automatically manage the dependencies of a project.
* [Stackage](https://github.com/fpco/stackage) [![GitHub stars](https://img.shields.io/github/stars/fpco/stackage?style=flat)](https://github.com/fpco/stackage/stargazers) - "Stable Hackage," tools for creating a vetted set of packages from Hackage.
...
* [Haxl](https://github.com/facebook/Haxl) [![GitHub stars](https://img.shields.io/github/stars/facebook/Haxl?style=flat)](https://github.com/facebook/Haxl/stargazers) - a library for efficient, concurrent, concise data access.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) [![GitHub stars](https://img.shields.io/github/stars/BayesWitnesses/m2cgen?style=flat)](https://github.com/BayesWitnesses/m2cgen/stargazers) - A CLI tool to transpile trained classic ML models into a native Haskell code with zero dependencies.
...
* [Web](http://hackage.haskell.org/packages/#cat:Web) - a collaborative Hackage list of frameworks, libraries, ...
    ...
    ---
*Additional libraries*
* [HTTP](https://github.com/haskell/HTTP) [![GitHub stars](https://img.shields.io/github/stars/haskell/HTTP?style=flat)](https://github.com/haskell/HTTP/stargazers) - Haskell HTTP package. Supports client-side web programming in Haskell.
* [hoauth2](https://github.com/freizl/hoauth2) [![GitHub stars](https://img.shields.io/github/stars/freizl/hoauth2?style=flat)](https://github.com/freizl/hoauth2/stargazers) - a lightweight oauth2 haskell binding.
...
* [SimpleX Chat](https://github.com/simplex-chat/simplex-chat) [![GitHub stars](https://img.shields.io/github/stars/simplex-chat/simplex-chat?style=flat)](https://github.com/simplex-chat/simplex-chat/stargazers) - the first chat platform that is 100% private by design - it has no access to your connection graph!
...
* [amqp](https://github.com/hreinhardt/amqp) [![GitHub stars](https://img.shields.io/github/stars/hreinhardt/amqp?style=flat)](https://github.com/hreinhardt/amqp/stargazers) - client library for AMQP servers (currently only RabbitMQ).
...
* [Idris](https://github.com/idris-lang/Idris-dev) [![GitHub stars](https://img.shields.io/github/stars/idris-lang/Idris-dev?style=flat)](https://github.com/idris-lang/Idris-dev/stargazers) - A Dependently Typed Functional Programming Language
...
* [Conduit](https://github.com/snoyberg/conduit) [![GitHub stars](https://img.shields.io/github/stars/snoyberg/conduit?style=flat)](https://github.com/snoyberg/conduit/stargazers) - a streaming data library. [Resources](http://hackage.haskell.org/packages/#cat:Conduit).
* [IO-Streams](http://hackage.haskell.org/packages/#cat:IO-Streams) - a collaborative Hackage list.
* [Pipes](https://github.com/Gabriel439/Haskell-Pipes-Library) [![GitHub stars](https://img.shields.io/github/stars/Gabriel439/Haskell-Pipes-Library?style=flat)](https://github.com/Gabriel439/Haskell-Pipes-Library/stargazers) - is a clean and powerful stream processing library that lets you build and connect reusable streaming components. [Resources](http://hackage.haskell.org/packages/#cat:Pipes).
...
* [learnhaskell](https://github.com/bitemyapp/learnhaskell) [![GitHub stars](https://img.shields.io/github/stars/bitemyapp/learnhaskell?style=flat)](https://github.com/bitemyapp/learnhaskell/stargazers) - Haskell Learning (also for non-English speakers).
...
* [H-99](https://wiki.haskell.org/H-99:_Ninety-Nine_Haskell_Problems) -  Ninety-Nine Haskell Problems.
    ...
    * [Scotty-Tutorials-&-Examples](https://github.com/scotty-web/scotty/wiki/Scotty-Tutorials-&-Examples) [![GitHub stars](https://img.shields.io/github/stars/scotty-web/scotty/wiki/Scotty-Tutorials-&-Examples?style=flat)](https://github.com/scotty-web/scotty/wiki/Scotty-Tutorials-&-Examples/stargazers)
...
* [Awesome Haskell Videos](https://github.com/andys8/awesome-haskell-videos) [![GitHub stars](https://img.shields.io/github/stars/andys8/awesome-haskell-videos?style=flat)](https://github.com/andys8/awesome-haskell-videos/stargazers) - Curated list of Haskell talks and tutorials
