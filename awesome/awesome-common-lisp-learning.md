...
- [Libraries](https://github.com/CodyReichert/awesome-cl) [![GitHub stars](https://img.shields.io/github/stars/CodyReichert/awesome-cl?style=flat)](https://github.com/CodyReichert/awesome-cl/stargazers)
  - [Curated Libraries](https://github.com/vindarel/curated-awesome-cl) [![GitHub stars](https://img.shields.io/github/stars/vindarel/curated-awesome-cl?style=flat)](https://github.com/vindarel/curated-awesome-cl/stargazers) - Forked and updated from the above list.
- [Software](https://github.com/azzamsa/awesome-cl-software) [![GitHub stars](https://img.shields.io/github/stars/azzamsa/awesome-cl-software?style=flat)](https://github.com/azzamsa/awesome-cl-software/stargazers)
...
- [Common Lisp Koans](https://github.com/google/lisp-koans) [![GitHub stars](https://img.shields.io/github/stars/google/lisp-koans?style=flat)](https://github.com/google/lisp-koans/stargazers) - Not exactly a book, but a set of koans to help you learn the language.
...
- [Paradigms of Artificial Intelligence Programming by Peter Norvig](https://github.com/norvig/paip-lisp) [![GitHub stars](https://img.shields.io/github/stars/norvig/paip-lisp?style=flat)](https://github.com/norvig/paip-lisp/stargazers) - Has many interesting applications of Lisp, but is no longer a good reference for AI.
...
- [The Art of the Metaobject Protocol by Gregor Kiczales, Jim des Rivieres, and Daniel G. Bobrow](https://www.amazon.com/Art-Metaobject-Protocol-Gregor-Kiczales/dp/0262610744/) - Describes the CLOS Metaobject Protocol (MOP).
  - [Chapters 5 and 6 (available online)](http://metamodular.com/CLOS-MOP/) - The specification of a metaobject protocol extension to CLOS, by Robert Strandh.
    - Superseded by the [modern public domain CLOS MOP specification](https://clos-mop.hexstreamsoft.com/) by Jean-Philippe Paradis ([Hexstream](https://github.com/Hexstream) [![GitHub stars](https://img.shields.io/github/stars/Hexstream?style=flat)](https://github.com/Hexstream/stargazers)).
