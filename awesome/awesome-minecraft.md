...
> 来源：[bs-community/awesome-minecraft](https://github.com/bs-community/awesome-minecraft)

[![GitHub stars](https://img.shields.io/github/stars/bs-community/awesome-minecraft?style=flat)](https://github.com/bs-community/awesome-minecraft/stargazers)
...
- [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) [![GitHub stars](https://img.shields.io/github/stars/MinecraftForge/MinecraftForge?style=flat)](https://github.com/MinecraftForge/MinecraftForge/stargazers) - Modifications to the Minecraft base files to assist in compatibility between mods.
...
- [Meddle](https://github.com/FyberOptic/Meddle) [![GitHub stars](https://img.shields.io/github/stars/FyberOptic/Meddle?style=flat)](https://github.com/FyberOptic/Meddle/stargazers) - Everything related to modding 1.9/1.10 snapshots in one place.
- [RopeMC](https://github.com/RopeMC/RopeMC) [![GitHub stars](https://img.shields.io/github/stars/RopeMC/RopeMC?style=flat)](https://github.com/RopeMC/RopeMC/stargazers) - A lightweight, reflection based mod loader which aims to be user friendly and later version independent.
...
- [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) [![GitHub stars](https://img.shields.io/github/stars/CaffeineMC/sodium-fabric?style=flat)](https://github.com/CaffeineMC/sodium-fabric/stargazers) - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
- [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) [![GitHub stars](https://img.shields.io/github/stars/xfl03/MCCustomSkinLoader?style=flat)](https://github.com/xfl03/MCCustomSkinLoader/stargazers) - Custom Skin Loader for Minecraft.
- [Universal Skin Mod](https://github.com/RecursiveG/UniSkinMod) [![GitHub stars](https://img.shields.io/github/stars/RecursiveG/UniSkinMod?style=flat)](https://github.com/RecursiveG/UniSkinMod/stargazers) - A Minecraft Forge Mod allows players load custom skin & cape textures.
...
- [Botania](https://github.com/Vazkii/Botania) [![GitHub stars](https://img.shields.io/github/stars/Vazkii/Botania?style=flat)](https://github.com/Vazkii/Botania/stargazers) - Botania is a tech mod in essence. The theme is natural magic.
...
- [Railcraft](https://github.com/Railcraft/Railcraft) [![GitHub stars](https://img.shields.io/github/stars/Railcraft/Railcraft?style=flat)](https://github.com/Railcraft/Railcraft/stargazers) - Greatly expand and improve the Minecart system in Minecraft.
...
- [TNTUtils](https://github.com/ljfa-ag/TNTUtils) [![GitHub stars](https://img.shields.io/github/stars/ljfa-ag/TNTUtils?style=flat)](https://github.com/ljfa-ag/TNTUtils/stargazers) - More control over explosions in Minecraft.
...
- [WorldEdit](https://github.com/EngineHub/WorldEdit) [![GitHub stars](https://img.shields.io/github/stars/EngineHub/WorldEdit?style=flat)](https://github.com/EngineHub/WorldEdit/stargazers) - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
- [AntiCheatReloaded](https://github.com/Rammelkast/AntiCheatReloaded) [![GitHub stars](https://img.shields.io/github/stars/Rammelkast/AntiCheatReloaded?style=flat)](https://github.com/Rammelkast/AntiCheatReloaded/stargazers) - AntiCheatReloaded helps server admins easily identify and block malicious users by monitoring and analyzing the behaviour of their players.
- [ViaVersion](https://github.com/MylesIsCool/ViaVersion) [![GitHub stars](https://img.shields.io/github/stars/MylesIsCool/ViaVersion?style=flat)](https://github.com/MylesIsCool/ViaVersion/stargazers) - Allows the connection of newer clients to older server versions for Minecraft servers.
- [AdvancedKitsReloaded](https://github.com/TryHardDood/AdvancedKitsReloaded) [![GitHub stars](https://img.shields.io/github/stars/TryHardDood/AdvancedKitsReloaded?style=flat)](https://github.com/TryHardDood/AdvancedKitsReloaded/stargazers) - AdvancedKitsReloaded is a Kit managing plugin for Minecraft servers which runs Bukkit, CraftBukkit, Spigot and Paper (>1.8). With this plugin you can easily create/edit/delete your kits and you can customize it as much as you'd like.
- [WorldGuard](https://github.com/EngineHub/WorldGuard) [![GitHub stars](https://img.shields.io/github/stars/EngineHub/WorldGuard?style=flat)](https://github.com/EngineHub/WorldGuard/stargazers) - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
- [CraftBook](https://github.com/EngineHub/CraftBook) [![GitHub stars](https://img.shields.io/github/stars/EngineHub/CraftBook?style=flat)](https://github.com/EngineHub/CraftBook/stargazers) - CraftBook lets you create magically extending bridges, compact Redstone circuits, complex Minecart mechanics, and much more — all without a client mod and fully customizable by the server.
...
- [CoreProtect](https://github.com/PlayPro/CoreProtect) [![GitHub stars](https://img.shields.io/github/stars/PlayPro/CoreProtect?style=flat)](https://github.com/PlayPro/CoreProtect/stargazers) - Log everything your players do. Literally 1984.
...
- [White Wolf Shader](https://github.com/NotSnipc/WhiteWolfShaders) [![GitHub stars](https://img.shields.io/github/stars/NotSnipc/WhiteWolfShaders?style=flat)](https://github.com/NotSnipc/WhiteWolfShaders/stargazers) - Shader pack for Bedrock Edition focused on improving your gameplay experience.

## Web Applications

- [Blessing Skin Server](https://github.com/bs-community/blessing-skin-server) [![GitHub stars](https://img.shields.io/github/stars/bs-community/blessing-skin-server?style=flat)](https://github.com/bs-community/blessing-skin-server/stargazers) - A web application brings your custom skins back in offline Minecraft servers.
...
- [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) [![GitHub stars](https://img.shields.io/github/stars/itzg/docker-minecraft-server?style=flat)](https://github.com/itzg/docker-minecraft-server/stargazers) - A self-hosted Minecraft server using Docker containers.
...
- [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) [![GitHub stars](https://img.shields.io/github/stars/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate?style=flat)](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate/stargazers) - PaperMC server with out of the box Geyser and Floodgate support using docker.
- [minecraft-docker](https://github.com/tywil04/minecraft-docker) [![GitHub stars](https://img.shields.io/github/stars/tywil04/minecraft-docker?style=flat)](https://github.com/tywil04/minecraft-docker/stargazers) - Fork of [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) [![GitHub stars](https://img.shields.io/github/stars/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate?style=flat)](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate/stargazers) that embeds a discord bot for easy starting and stopping of the server.
...
- [Gate](https://github.com/minekube/gate) [![GitHub stars](https://img.shields.io/github/stars/minekube/gate?style=flat)](https://github.com/minekube/gate/stargazers) - A high performance & paralleled Minecraft proxy written in Go.

### Libraries

- [CraftLib](https://github.com/zerite/craftlib) [![GitHub stars](https://img.shields.io/github/stars/zerite/craftlib?style=flat)](https://github.com/zerite/craftlib/stargazers) - Complete [Kotlin](https://kotlinlang.org) / Java library for wrapping the entire Minecraft codebase, including protocol, NBT, schematics, chat and more.
- [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) [![GitHub stars](https://img.shields.io/github/stars/Steveice10/MCProtocolLib?style=flat)](https://github.com/Steveice10/MCProtocolLib/stargazers) - A simple library for communicating with a Minecraft client/server, written in Java.
- [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) [![GitHub stars](https://img.shields.io/github/stars/PrismarineJS/node-minecraft-protocol?style=flat)](https://github.com/PrismarineJS/node-minecraft-protocol/stargazers) - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
- [go-mcproto](https://github.com/BRA1L0R/go-mcproto) [![GitHub stars](https://img.shields.io/github/stars/BRA1L0R/go-mcproto?style=flat)](https://github.com/BRA1L0R/go-mcproto/stargazers) - Minecraft server communication protocol implementation written in Go that allows you to program your own bots.

### Utilities

- [Minecraft Command Helper](https://github.com/IceLitty/Minecraft-Command-Helper) [![GitHub stars](https://img.shields.io/github/stars/IceLitty/Minecraft-Command-Helper?style=flat)](https://github.com/IceLitty/Minecraft-Command-Helper/stargazers) - A WPF Program about generate Minecraft Command (with NBT data). (Windows Only)
- [Minecraft Command Science](https://minecraftcommand.science/) - Several Minecraft vanilla JSON generators.
- [Amidst](https://github.com/toolbox4minecraft/amidst) [![GitHub stars](https://img.shields.io/github/stars/toolbox4minecraft/amidst?style=flat)](https://github.com/toolbox4minecraft/amidst/stargazers) - Display an overview of a Minecraft world, without actually creating it.
- [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) [![GitHub stars](https://img.shields.io/github/stars/Amulet-Team/Amulet-Map-Editor?style=flat)](https://github.com/Amulet-Team/Amulet-Map-Editor/stargazers) - Map viewer/editor.
- [NBTEditor](https://github.com/Howaner/NBTEditor) [![GitHub stars](https://img.shields.io/github/stars/Howaner/NBTEditor?style=flat)](https://github.com/Howaner/NBTEditor/stargazers) - Edit NBT from .dat files.

### Launchers

- [MultiMC](https://github.com/MultiMC/MultiMC5) [![GitHub stars](https://img.shields.io/github/stars/MultiMC/MultiMC5?style=flat)](https://github.com/MultiMC/MultiMC5/stargazers) - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
...
- [HMCL](https://github.com/huanghongxun/HMCL) [![GitHub stars](https://img.shields.io/github/stars/huanghongxun/HMCL?style=flat)](https://github.com/huanghongxun/HMCL/stargazers) - A powered Minecraft launcher that supports a lot of features.
- [XMCL](https://github.com/Voxelum/x-minecraft-launcher) [![GitHub stars](https://img.shields.io/github/stars/Voxelum/x-minecraft-launcher?style=flat)](https://github.com/Voxelum/x-minecraft-launcher/stargazers) - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
- [Polymerium](https://github.com/d3ara1n/Polymerium) [![GitHub stars](https://img.shields.io/github/stars/d3ara1n/Polymerium?style=flat)](https://github.com/d3ara1n/Polymerium/stargazers) - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.

## Development

- [FML Mod Development Tutorial](https://fmltutor.ustc-zzzz.net/) - (Chinese) Minecraft 1.8.9 FML Mod Development Tutorial.
- [SchematicWebViewer](https://github.com/EngineHub/SchematicWebViewer) [![GitHub stars](https://img.shields.io/github/stars/EngineHub/SchematicWebViewer?style=flat)](https://github.com/EngineHub/SchematicWebViewer/stargazers) - A JavaScript/TypeScript library for rendering and viewing Minecraft schematic files on the web.
...
- [BON 2](https://github.com/tterrag1098/BON2) [![GitHub stars](https://img.shields.io/github/stars/tterrag1098/BON2?style=flat)](https://github.com/tterrag1098/BON2/stargazers) - A rewrite of the Bearded Octo Nemesis project with support for ForgeGradle.
- [Bearded Octo Nemesis](https://github.com/immibis/bearded-octo-nemesis) [![GitHub stars](https://img.shields.io/github/stars/immibis/bearded-octo-nemesis?style=flat)](https://github.com/immibis/bearded-octo-nemesis/stargazers) - Tool for deobfuscating with support for SRG mappings and especially the Mod Coder Pack.
