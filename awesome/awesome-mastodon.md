...
- [GitHub Repository](https://github.com/tootsuite/mastodon/) [![GitHub stars](https://img.shields.io/github/stars/tootsuite/mastodon/?style=flat)](https://github.com/tootsuite/mastodon//stargazers)
...
- [Academics On Mastodon](https://github.com/nathanlesage/academics-on-mastodon/) [![GitHub stars](https://img.shields.io/github/stars/nathanlesage/academics-on-mastodon/?style=flat)](https://github.com/nathanlesage/academics-on-mastodon//stargazers) - Markdown list of academics on Mastodon, by discipline/group/area.
...
- [Mastodon Link](https://github.com/masrly/mastodon-link/) [![GitHub stars](https://img.shields.io/github/stars/masrly/mastodon-link/?style=flat)](https://github.com/masrly/mastodon-link//stargazers) - Adds Mastodon icon links by profile to make following people on other instances easier.
- [Mastodon Redirector](https://github.com/bramus/mastodon-redirector/) [![GitHub stars](https://img.shields.io/github/stars/bramus/mastodon-redirector/?style=flat)](https://github.com/bramus/mastodon-redirector//stargazers) - Adds a button to view profiles from other instances on your profile page.
- [mastotool](https://github.com/muesli/mastotool/) [![GitHub stars](https://img.shields.io/github/stars/muesli/mastotool/?style=flat)](https://github.com/muesli/mastotool//stargazers) - Collection of command-line tools for working with Mastodon accounts.
- [Mastodon Widgets](https://github.com/splitbrain/mastodon-widget) [![GitHub stars](https://img.shields.io/github/stars/splitbrain/mastodon-widget?style=flat)](https://github.com/splitbrain/mastodon-widget/stargazers) - JavaScript Web Components to embed a Mastodon profile, timeline, follow and share button into any website. Provides an auto-completing instance selector.
...
- [Elk](https://github.com/elk-zone/elk/) [![GitHub stars](https://img.shields.io/github/stars/elk-zone/elk/?style=flat)](https://github.com/elk-zone/elk//stargazers) - A nimble Mastodon web client.
...
- [SwiftUI](https://github.com/Dimillian/IceCubesApp) [![GitHub stars](https://img.shields.io/github/stars/Dimillian/IceCubesApp?style=flat)](https://github.com/Dimillian/IceCubesApp/stargazers) - Mastodon client for iOS using SwiftUI.

## Libraries

- [Official Library List](https://docs.joinmastodon.org/client/libraries/) - Official list of Mastodon client libraries.
- [masto.js](https://github.com/neet/masto.js) [![GitHub stars](https://img.shields.io/github/stars/neet/masto.js?style=flat)](https://github.com/neet/masto.js/stargazers) - Mastodon client for JavaScript.
- [go-mastodon](https://github.com/mattn/go-mastodon) [![GitHub stars](https://img.shields.io/github/stars/mattn/go-mastodon?style=flat)](https://github.com/mattn/go-mastodon/stargazers) - Mastodon Client for golang.
...
- [Hometown](https://github.com/hometown-fork/hometown/) [![GitHub stars](https://img.shields.io/github/stars/hometown-fork/hometown/?style=flat)](https://github.com/hometown-fork/hometown//stargazers) - Mastodon Fork with local posting, following lists, customizable max toos length.
- [ecko](https://github.com/magicstone-dev/ecko/) [![GitHub stars](https://img.shields.io/github/stars/magicstone-dev/ecko/?style=flat)](https://github.com/magicstone-dev/ecko//stargazers) - Mastodon fork with local posting, toot formatting, and more granulate controls.
...
- [aerialbot](https://github.com/doersino/aerialbot) [![GitHub stars](https://img.shields.io/github/stars/doersino/aerialbot?style=flat)](https://github.com/doersino/aerialbot/stargazers) - Respond with geotagged aerial imagery of a random location in the world.
- [rust-trending](https://github.com/pbzweihander/rust-trending) [![GitHub stars](https://img.shields.io/github/stars/pbzweihander/rust-trending?style=flat)](https://github.com/pbzweihander/rust-trending/stargazers) - Post trending Rust repositories on Mastodon (inspired by TrendingGithub).
- [@TrendingBot@mastodon.social](https://mastodon.social/@TrendingBot) - Shows you what's trending on Mastodon.
- [News Bot](https://botsin.space/@newsbot) - Mirrors Twitter accounts on Mastodon (ClojureScript), source available on [GitHub](https://github.com/yogthos/mastodon-bot) [![GitHub stars](https://img.shields.io/github/stars/yogthos/mastodon-bot?style=flat)](https://github.com/yogthos/mastodon-bot/stargazers).
