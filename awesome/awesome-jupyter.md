...
- [JupyterLite](https://github.com/jupyterlite/jupyterlite) [![GitHub stars](https://img.shields.io/github/stars/jupyterlite/jupyterlite?style=flat)](https://github.com/jupyterlite/jupyterlite/stargazers) - Jupyter distribution that runs entirely in the browser.
...
- [FlexViz](https://github.com/flex-analytics/flexviz) [![GitHub stars](https://img.shields.io/github/stars/flex-analytics/flexviz?style=flat)](https://github.com/flex-analytics/flexviz/stargazers) - Interactive cross-filter dashboards for datasets that are too large for the browser.
...
- [K3D-jupyter](https://github.com/K3D-tools/K3D-jupyter) [![GitHub stars](https://img.shields.io/github/stars/K3D-tools/K3D-jupyter?style=flat)](https://github.com/K3D-tools/K3D-jupyter/stargazers) - WebGL 3D plotting: meshes, isosurfaces, volumes, voxels and point clouds from NumPy arrays.
...
- [buckaroo](https://github.com/buckaroo-data/buckaroo) [![GitHub stars](https://img.shields.io/github/stars/buckaroo-data/buckaroo?style=flat)](https://github.com/buckaroo-data/buckaroo/stargazers) - GUI Data Wrangling tool for Jupyter and pandas.
...
- [jupyter-resource-usage](https://github.com/jupyter-server/jupyter-resource-usage) [![GitHub stars](https://img.shields.io/github/stars/jupyter-server/jupyter-resource-usage?style=flat)](https://github.com/jupyter-server/jupyter-resource-usage/stargazers) - Extension to display system metrics.
...
- [jupyter-shopsavvy](https://github.com/shopsavvy/jupyter-shopsavvy) [![GitHub stars](https://img.shields.io/github/stars/shopsavvy/jupyter-shopsavvy?style=flat)](https://github.com/shopsavvy/jupyter-shopsavvy/stargazers) - Magic commands for product search, price comparison/history charts using the ShopSavvy API.
