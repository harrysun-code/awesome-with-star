...
This list is currently unmaintained, and we are looking for a new maintainer. See [here](https://github.com/fuse-compound/awesome-fuse/issues/57) [![GitHub stars](https://img.shields.io/github/stars/fuse-compound/awesome-fuse/issues/57?style=flat)](https://github.com/fuse-compound/awesome-fuse/issues/57/stargazers) for details if you're interested.
...
- [FuseCloud](https://github.com/fusetools/FuseCloud) [![GitHub stars](https://img.shields.io/github/stars/fusetools/FuseCloud?style=flat)](https://github.com/fusetools/FuseCloud/stargazers) - A SoundCloud<sup>®</sup> player that uses the free SoundCloud API [(iOS)](https://itunes.apple.com/us/app/fusecloud/id1173516856) [(Android)](https://play.google.com/store/apps/details?id=com.fuse.fusecloud&hl=en).
...
- [How to add infinite scrolling to fuse tools apps](https://www.creativitykills.co/how-to-add-infinite-scrolling-to-fuse-app/) - Written by [Neo Ighodaro](https://github.com/neoighodaro) [![GitHub stars](https://img.shields.io/github/stars/neoighodaro?style=flat)](https://github.com/neoighodaro/stargazers).
- [I made a cross-platform SoundCloud<sup>®</sup> player with Fuse](https://medium.com/@fusetools/i-made-a-cross-platform-soundcloud-player-with-fuse-9fb1e62b7db1#.5lhmtwovz) - Written by [Kristian Hasselknippe](https://github.com/kristianhasselknippe/) [![GitHub stars](https://img.shields.io/github/stars/kristianhasselknippe/?style=flat)](https://github.com/kristianhasselknippe//stargazers).
...
- [Light the fuse, using F# to write Fuse apps](http://7sharpnine.com/2016/06/03/light-the-fuse/) - Written by [7sharp9](https://github.com/7sharp9/) [![GitHub stars](https://img.shields.io/github/stars/7sharp9/?style=flat)](https://github.com/7sharp9//stargazers).
- [Making mobile apps using Fuse](https://tmn.io/read/2015-11-22-making-mobile-apps-using-Fuse) - Written by [Tri Nguyen](https://github.com/tmn/) [![GitHub stars](https://img.shields.io/github/stars/tmn/?style=flat)](https://github.com/tmn//stargazers).
- [SwiftFuse](https://github.com/YugoCode/SwiftFuse/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/YugoCode/SwiftFuse/blob/master/README.md?style=flat)](https://github.com/YugoCode/SwiftFuse/blob/master/README.md/stargazers) - Tutorial on how to use Swift with Fuse.
...
- [Samples](https://github.com/fusetools/fuse-samples/) [![GitHub stars](https://img.shields.io/github/stars/fusetools/fuse-samples/?style=flat)](https://github.com/fusetools/fuse-samples//stargazers) - Samples demonstrating the use of various Fuse and FuseJS APIs.
- [Tour De Fuse](https://github.com/englekk/TourDeFuse) [![GitHub stars](https://img.shields.io/github/stars/englekk/TourDeFuse?style=flat)](https://github.com/englekk/TourDeFuse/stargazers) - The sample for introducing functions of the Fuse.

## Open Source

- [11t](https://github.com/jeroensmeets/mastodon-app) [![GitHub stars](https://img.shields.io/github/stars/jeroensmeets/mastodon-app?style=flat)](https://github.com/jeroensmeets/mastodon-app/stargazers) - 11t is an iOS and Android app for connecting to Mastodon
- [500px Gallery Demo](https://github.com/jveres/D500px) [![GitHub stars](https://img.shields.io/github/stars/jveres/D500px?style=flat)](https://github.com/jveres/D500px/stargazers) - Nifty gallery demo app using 500px API.
- [Firebase](https://github.com/fuse-compound/Fuse.Firebase) [![GitHub stars](https://img.shields.io/github/stars/fuse-compound/Fuse.Firebase?style=flat)](https://github.com/fuse-compound/Fuse.Firebase/stargazers) - Firebase bindings for Fuse.
- [FormulaFuse](https://github.com/sanderdan/FormulaFuse) [![GitHub stars](https://img.shields.io/github/stars/sanderdan/FormulaFuse?style=flat)](https://github.com/sanderdan/FormulaFuse/stargazers) - Formula 1 Fuse application.
- [Fuse Input Validation](https://github.com/mokko-lab/fuse-input-validation) [![GitHub stars](https://img.shields.io/github/stars/mokko-lab/fuse-input-validation?style=flat)](https://github.com/mokko-lab/fuse-input-validation/stargazers) - Reusable and highly functional input validation methods in Fuse components
- [Fuse PM](https://github.com/bolav/fusepm) [![GitHub stars](https://img.shields.io/github/stars/bolav/fusepm?style=flat)](https://github.com/bolav/fusepm/stargazers) - A Fusetools package manager.
- [Fuse Pokedex](https://github.com/franzsilva/FusePokeDex) [![GitHub stars](https://img.shields.io/github/stars/franzsilva/FusePokeDex?style=flat)](https://github.com/franzsilva/FusePokeDex/stargazers) - A Pokedex created using Fuse.
- [Fuse Review](https://github.com/LuisRodriguezLD/Fuse-RequestReview) [![GitHub stars](https://img.shields.io/github/stars/LuisRodriguezLD/Fuse-RequestReview?style=flat)](https://github.com/LuisRodriguezLD/Fuse-RequestReview/stargazers) - Get reviews from your users without making them leave the app.
- [Fuse Samples](https://github.com/fusetools/fuse-samples) [![GitHub stars](https://img.shields.io/github/stars/fusetools/fuse-samples?style=flat)](https://github.com/fusetools/fuse-samples/stargazers) - A collection of smaller examples using the various features of Fuse and FuseJS.
- [Fuse Taptic-Feedback](https://github.com/LuisRodriguezLD/Fuse-TapticFeedback) [![GitHub stars](https://img.shields.io/github/stars/LuisRodriguezLD/Fuse-TapticFeedback?style=flat)](https://github.com/LuisRodriguezLD/Fuse-TapticFeedback/stargazers) - Get access to the iPhone 7's taptic engine.
- [fuse.QrScanner](https://github.com/glenfordwilliams/fuse.QrScanner) [![GitHub stars](https://img.shields.io/github/stars/glenfordwilliams/fuse.QrScanner?style=flat)](https://github.com/glenfordwilliams/fuse.QrScanner/stargazers) - A small library for scanning QrCode.
- [Fuse Tags with Firebase](https://github.com/LuisRodriguezLD/Fuse-Tags-with-Firebase) [![GitHub stars](https://img.shields.io/github/stars/LuisRodriguezLD/Fuse-Tags-with-Firebase?style=flat)](https://github.com/LuisRodriguezLD/Fuse-Tags-with-Firebase/stargazers) - Simple Tags app. Adds and retrieves tags from Firebase.
- [FuseBus](http://tmn.github.io/FuseBus/) - A simple Fuse application for testing and funtimes.
- [Haxe](https://github.com/elsassph/fusetools-haxe) [![GitHub stars](https://img.shields.io/github/stars/elsassph/fusetools-haxe?style=flat)](https://github.com/elsassph/fusetools-haxe/stargazers) - Haxe compiler for Fuse tools.
- [Hikr](https://github.com/fusetools/hikr) [![GitHub stars](https://img.shields.io/github/stars/fusetools/hikr?style=flat)](https://github.com/fusetools/hikr/stargazers) - An example app case to accompany [Fuse's end-to-end tutorial](https://www.fusetools.com/docs/tutorial/tutorial).
...
- [Motion](https://github.com/AlexGustafsson/fuse-motion) [![GitHub stars](https://img.shields.io/github/stars/AlexGustafsson/fuse-motion?style=flat)](https://github.com/AlexGustafsson/fuse-motion/stargazers) - iOS accelerometer, gyroscope, magnetometer readings and more for Fuse.
...
- [Syncano](https://github.com/Syncano/syncano-fuse-example) [![GitHub stars](https://img.shields.io/github/stars/Syncano/syncano-fuse-example?style=flat)](https://github.com/Syncano/syncano-fuse-example/stargazers) - Simple example of integration Syncano with Fuse.
- [UnityAds Sample](https://github.com/englekk/Fusetools_UnityAdsSample) [![GitHub stars](https://img.shields.io/github/stars/englekk/Fusetools_UnityAdsSample?style=flat)](https://github.com/englekk/Fusetools_UnityAdsSample/stargazers) - Simple example of integration UnityAds with Fuse.

## Plugins

- [Alfred Workflow](https://github.com/Hazealign/fuse-alfred-workflow) [![GitHub stars](https://img.shields.io/github/stars/Hazealign/fuse-alfred-workflow?style=flat)](https://github.com/Hazealign/fuse-alfred-workflow/stargazers) - Integrate Fuse on Alfred.
- [Atom](https://github.com/fusetools/Fuse.AtomPlugin) [![GitHub stars](https://img.shields.io/github/stars/fusetools/Fuse.AtomPlugin?style=flat)](https://github.com/fusetools/Fuse.AtomPlugin/stargazers) - Atom Editor plugin for Fuse.
- [Bash Completion](https://github.com/fusetools/UnoBashCompletion) [![GitHub stars](https://img.shields.io/github/stars/fusetools/UnoBashCompletion?style=flat)](https://github.com/fusetools/UnoBashCompletion/stargazers) - Simple bash completion script for UNO.
- [Emacs](https://github.com/kristianhasselknippe/fuse-mode) [![GitHub stars](https://img.shields.io/github/stars/kristianhasselknippe/fuse-mode?style=flat)](https://github.com/kristianhasselknippe/fuse-mode/stargazers) - Emacs plugin for Fuse.
- [Sublime](https://github.com/fusetools/Fuse.SublimePlugin) [![GitHub stars](https://img.shields.io/github/stars/fusetools/Fuse.SublimePlugin?style=flat)](https://github.com/fusetools/Fuse.SublimePlugin/stargazers) - Sublime Text 3 plugin for Fuse.
- [Visual Studio Code](https://github.com/Hazealign/vscode-fuse) [![GitHub stars](https://img.shields.io/github/stars/Hazealign/vscode-fuse?style=flat)](https://github.com/Hazealign/vscode-fuse/stargazers) - Fuse Helper for Visual Studio Code.
...
- [Fuse-Log](https://github.com/bstrr/vscode-fuse-log) [![GitHub stars](https://img.shields.io/github/stars/bstrr/vscode-fuse-log?style=flat)](https://github.com/bstrr/vscode-fuse-log/stargazers) - Get Fuse log messages into Visual Studio Code's output panel.

## License

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

To the extent possible under law, [Fuse Compound](https://github.com/fuse-compound) [![GitHub stars](https://img.shields.io/github/stars/fuse-compound?style=flat)](https://github.com/fuse-compound/stargazers) has waived all copyright and related or neighboring rights to this work.
