...
As you go through the curriculum, you will find completion badges that are hidden within this [`README.md`](https://github.com/brootware/Cyber-Security-University/blob/main/README.md) [![GitHub stars](https://img.shields.io/github/stars/brootware/Cyber-Security-University/blob/main/README.md?style=flat)](https://github.com/brootware/Cyber-Security-University/blob/main/README.md/stargazers) for both red and blue team path completion badges. You can copy the HTML code for them and add it to the content page below once you have completed them.
...
This project follows the [all-contributors](https://github.com/all-contributors/all-contributors) [![GitHub stars](https://img.shields.io/github/stars/all-contributors/all-contributors?style=flat)](https://github.com/all-contributors/all-contributors/stargazers) specification. Contributions of any kind are welcome!
