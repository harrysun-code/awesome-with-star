...
> 来源：[agarrharr/awesome-static-website-services](https://github.com/agarrharr/awesome-static-website-services)

[![GitHub stars](https://img.shields.io/github/stars/agarrharr/awesome-static-website-services?style=flat)](https://github.com/agarrharr/awesome-static-website-services/stargazers)
...
- [1Backend](https://github.com/1backend/1backend) [![GitHub stars](https://img.shields.io/github/stars/1backend/1backend?style=flat)](https://github.com/1backend/1backend/stargazers) - Deploy your backend in seconds. Free tier included. Open source.
...
- [Staticman](https://github.com/eduardoboucas/staticman) [![GitHub stars](https://img.shields.io/github/stars/eduardoboucas/staticman?style=flat)](https://github.com/eduardoboucas/staticman/stargazers) - Staticman is a Node.js application that receives user-generated content and uploads it as data files to a GitHub repository. In practice, this allows you to have dynamic content (e.g. blog post comments) as part of a fully static website, as long as your site automatically deploys on every push to GitHub, as seen on GitHub Pages, Netlify and others.
...
- [Gitment](https://github.com/imsun/gitment) [![GitHub stars](https://img.shields.io/github/stars/imsun/gitment?style=flat)](https://github.com/imsun/gitment/stargazers) - Comment system based on GitHub Issues, which can be used in the frontend without any server-side implementation.
- [giscus](https://github.com/laymonage/giscus) [![GitHub stars](https://img.shields.io/github/stars/laymonage/giscus?style=flat)](https://github.com/laymonage/giscus/stargazers) - A comments widget built on GitHub Discussions.
- [utterances](https://github.com/utterance) [![GitHub stars](https://img.shields.io/github/stars/utterance?style=flat)](https://github.com/utterance/stargazers) - A lightweight comments widget built on GitHub issues. 
...
- [Brisk Forms](https://github.com/stevensona/briskforms) [![GitHub stars](https://img.shields.io/github/stars/stevensona/briskforms?style=flat)](https://github.com/stevensona/briskforms/stargazers) - Free form submission service emails you responses while keeping your email address private and is open source.
...
- [GitHub Issues](https://help.github.com/articles/about-issues/) - This is an interesting way for developers to get comments/questions. See [github.com/sindresorhus/ama](https://github.com/sindresorhus/ama) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/ama?style=flat)](https://github.com/sindresorhus/ama/stargazers) for an example.
- [Utterences](https://github.com/utterance/utterances) [![GitHub stars](https://img.shields.io/github/stars/utterance/utterances?style=flat)](https://github.com/utterance/utterances/stargazers) - A lightweight comments widget built on GitHub issues.
...
- [itemsjs](https://github.com/itemsapi/itemsjs) [![GitHub stars](https://img.shields.io/github/stars/itemsapi/itemsjs?style=flat)](https://github.com/itemsapi/itemsjs/stargazers) - Full text, faceted, almost dependency free search engine in javascript
- [minisearch](https://github.com/lucaong/minisearch) [![GitHub stars](https://img.shields.io/github/stars/lucaong/minisearch?style=flat)](https://github.com/lucaong/minisearch/stargazers) - Tiny and powerful JavaScript full-text search engine for browser and Node
- [flexsearch](https://github.com/nextapps-de/flexsearch) [![GitHub stars](https://img.shields.io/github/stars/nextapps-de/flexsearch?style=flat)](https://github.com/nextapps-de/flexsearch/stargazers) - Next-Generation full text search library for Browser and Node.js
- [fuse.js](https://fusejs.io/) - Powerful, lightweight fuzzy-search library, with zero dependencies
- [static-search](https://github.com/dchest/static-search) [![GitHub stars](https://img.shields.io/github/stars/dchest/static-search?style=flat)](https://github.com/dchest/static-search/stargazers) - A Go program to generate JSON index of HTML files, and a JavaScript component with optional UI to search this index
...
- [tinysearch](https://github.com/tinysearch/tinysearch) [![GitHub stars](https://img.shields.io/github/stars/tinysearch/tinysearch?style=flat)](https://github.com/tinysearch/tinysearch/stargazers) - Tiny, full-text search engine for static websites built with Rust and Wasm
...
- [search-index](https://github.com/fergiemcdowall/search-index) [![GitHub stars](https://img.shields.io/github/stars/fergiemcdowall/search-index?style=flat)](https://github.com/fergiemcdowall/search-index/stargazers) - A persistent, network resilient, full text search library for the browser and Node.js
- [fuzzysearch](https://github.com/bevacqua/fuzzysearch) [![GitHub stars](https://img.shields.io/github/stars/bevacqua/fuzzysearch?style=flat)](https://github.com/bevacqua/fuzzysearch/stargazers) - Tiny and blazing-fast fuzzy search in JavaScript
- [fuzzy](https://github.com/mattyork/fuzzy) [![GitHub stars](https://img.shields.io/github/stars/mattyork/fuzzy?style=flat)](https://github.com/mattyork/fuzzy/stargazers) - Fuzzy search / filter for browser and node
...
- [Hulipaa](https://github.com/sambuccid/hulipaa) [![GitHub stars](https://img.shields.io/github/stars/sambuccid/hulipaa?style=flat)](https://github.com/sambuccid/hulipaa/stargazers) - Static full-text search engine capable of handling thousands of pages with a minimalist searchbar UI to add to your static website.
...
- [Awesome Static Hosting](https://github.com/b-long/awesome-static-hosting) [![GitHub stars](https://img.shields.io/github/stars/b-long/awesome-static-hosting?style=flat)](https://github.com/b-long/awesome-static-hosting/stargazers)
- [Awesome Azure Static Web Apps](https://github.com/staticwebdev/awesome-azure-static-web-apps) [![GitHub stars](https://img.shields.io/github/stars/staticwebdev/awesome-azure-static-web-apps?style=flat)](https://github.com/staticwebdev/awesome-azure-static-web-apps/stargazers)
