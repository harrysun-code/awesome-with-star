...
* [Haskell to Elm](https://github.com/eeue56/haskell-to-elm) [![GitHub stars](https://img.shields.io/github/stars/eeue56/haskell-to-elm?style=flat)](https://github.com/eeue56/haskell-to-elm/stargazers) - Collection of examples on places where Elm is different to Haskell, targeted at Elm beginners coming from Haskell backgrounds.
...
* [Codings hints](https://github.com/elm/compiler/tree/master/hints) [![GitHub stars](https://img.shields.io/github/stars/elm/compiler/tree/master/hints?style=flat)](https://github.com/elm/compiler/tree/master/hints/stargazers) - A list of README files by Evan.
...
* [Awesome Elm PLTD](https://github.com/pd-andy/awesome-elm-pltd) [![GitHub stars](https://img.shields.io/github/stars/pd-andy/awesome-elm-pltd?style=flat)](https://github.com/pd-andy/awesome-elm-pltd/stargazers) - Useful resources for programming language theory & development in Elm.
...
* [Writing native](https://github.com/NoRedInk/take-home/wiki/Writing-Native) [![GitHub stars](https://img.shields.io/github/stars/NoRedInk/take-home/wiki/Writing-Native?style=flat)](https://github.com/NoRedInk/take-home/wiki/Writing-Native/stargazers) - Learn how to create native JavaScript modules for Elm.
...
* [Elm test](https://github.com/elm-explorations/test) [![GitHub stars](https://img.shields.io/github/stars/elm-explorations/test?style=flat)](https://github.com/elm-explorations/test/stargazers) - Unit and fuzz tests
* [Elm Program test](https://github.com/avh4/elm-program-test/tree/3.0.0) [![GitHub stars](https://img.shields.io/github/stars/avh4/elm-program-test/tree/3.0.0?style=flat)](https://github.com/avh4/elm-program-test/tree/3.0.0/stargazers) - Test complete Elm programs
* [Elm Spec](https://github.com/brian-watkins/elm-spec) [![GitHub stars](https://img.shields.io/github/stars/brian-watkins/elm-spec?style=flat)](https://github.com/brian-watkins/elm-spec/stargazers) - Describe the behavior of Elm programs.
...
* [Elm Bridge](https://github.com/agrafix/elm-bridge) [![GitHub stars](https://img.shields.io/github/stars/agrafix/elm-bridge?style=flat)](https://github.com/agrafix/elm-bridge/stargazers) - Generate Elm types from Haskell
* [Elm CodeGen](https://github.com/mdgriffith/elm-codegen) [![GitHub stars](https://img.shields.io/github/stars/mdgriffith/elm-codegen?style=flat)](https://github.com/mdgriffith/elm-codegen/stargazers) - Generate Elm code
* [Elm TS Interop](https://github.com/dillonkearns/elm-ts-json) [![GitHub stars](https://img.shields.io/github/stars/dillonkearns/elm-ts-json?style=flat)](https://github.com/dillonkearns/elm-ts-json/stargazers) - Build up Encoders/Decoders between Elm and TypeScript.
* [Elm TypeScript Interop](https://github.com/dillonkearns/elm-typescript-interop) [![GitHub stars](https://img.shields.io/github/stars/dillonkearns/elm-typescript-interop?style=flat)](https://github.com/dillonkearns/elm-typescript-interop/stargazers) - Generate TypeScript definitions from Elm (`Elm TS Interop` is an improved version of this).
...
* [Protoc Gen Elm](https://github.com/andreasewering/protoc-gen-elm) [![GitHub stars](https://img.shields.io/github/stars/andreasewering/protoc-gen-elm?style=flat)](https://github.com/andreasewering/protoc-gen-elm/stargazers) - Generate Protobuf En/Decoders from .proto files
* [Quicktype](https://github.com/quicktype/quicktype) [![GitHub stars](https://img.shields.io/github/stars/quicktype/quicktype?style=flat)](https://github.com/quicktype/quicktype/stargazers) - Generate JSON decoders and encoders from JSON
* [Travelm Agency](https://github.com/andreasewering/travelm-agency) [![GitHub stars](https://img.shields.io/github/stars/andreasewering/travelm-agency?style=flat)](https://github.com/andreasewering/travelm-agency/stargazers) - Generate typesafe Elm code from translation files
...
* [elm-package](https://github.com/elm-lang/elm-package) [![GitHub stars](https://img.shields.io/github/stars/elm-lang/elm-package?style=flat)](https://github.com/elm-lang/elm-package/stargazers) - Command line tool to share Elm libraries.
...
* [create-elm-app](https://github.com/halfzebra/create-elm-app) [![GitHub stars](https://img.shields.io/github/stars/halfzebra/create-elm-app?style=flat)](https://github.com/halfzebra/create-elm-app/stargazers) - Create Elm apps with no build configuration.
* [elm-boil](https://github.com/GioPat/elm-boil) [![GitHub stars](https://img.shields.io/github/stars/GioPat/elm-boil?style=flat)](https://github.com/GioPat/elm-boil/stargazers) - Command Line Utility for creating an Elm boilerplate project easy to run, build and get deployed
* [elm-live](https://github.com/wking-io/elm-live) [![GitHub stars](https://img.shields.io/github/stars/wking-io/elm-live?style=flat)](https://github.com/wking-io/elm-live/stargazers) - A flexible dev server for Elm. Live reload included.
* [elm-webpack-4-starter](https://github.com/romariolopezc/elm-webpack-4-starter) [![GitHub stars](https://img.shields.io/github/stars/romariolopezc/elm-webpack-4-starter?style=flat)](https://github.com/romariolopezc/elm-webpack-4-starter/stargazers) - Elm webpack 4 starter template.
* [example-elm-hot-webpack](https://github.com/klazuka/example-elm-hot-webpack) [![GitHub stars](https://img.shields.io/github/stars/klazuka/example-elm-hot-webpack?style=flat)](https://github.com/klazuka/example-elm-hot-webpack/stargazers) - Example showing hot module reloading for Elm 0.19 and Webpack
* [Elm Batteries](https://github.com/cedricss/elm-batteries) [![GitHub stars](https://img.shields.io/github/stars/cedricss/elm-batteries?style=flat)](https://github.com/cedricss/elm-batteries/stargazers) - A project template and generator for Elm, Parcel, Cypress and Netlify
...
* [elm-webpack-starter](https://github.com/moarwick/elm-webpack-starter) [![GitHub stars](https://img.shields.io/github/stars/moarwick/elm-webpack-starter?style=flat)](https://github.com/moarwick/elm-webpack-starter/stargazers) - A simple Webpack setup for writing Elm apps.
* [elm-app-boilerplate](https://github.com/gkubisa/elm-app-boilerplate) [![GitHub stars](https://img.shields.io/github/stars/gkubisa/elm-app-boilerplate?style=flat)](https://github.com/gkubisa/elm-app-boilerplate/stargazers) - A fully-featured base project for Elm apps: Webpack, HMR, ES6, JS and Elm tests, Semantic UI, sample code and more.
* [elmkit](https://github.com/khusnetdinov/elmkit) [![GitHub stars](https://img.shields.io/github/stars/khusnetdinov/elmkit?style=flat)](https://github.com/khusnetdinov/elmkit/stargazers) - A lightweight Brunch based setup for web app. Includes Brunch, Hot Module Replacement, Elm, Scss, Elm tests.
* [elm-boilerplate](https://github.com/guillaumearm/elm-boilerplate) [![GitHub stars](https://img.shields.io/github/stars/guillaumearm/elm-boilerplate?style=flat)](https://github.com/guillaumearm/elm-boilerplate/stargazers) - A simple Makefile able to create Elm app.
* [elm-init](https://github.com/JustusAdam/elm-init) [![GitHub stars](https://img.shields.io/github/stars/JustusAdam/elm-init?style=flat)](https://github.com/JustusAdam/elm-init/stargazers) - Interactive setup for new Elm projects.
* [elm-new](https://github.com/simonewebdesign/elm-new) [![GitHub stars](https://img.shields.io/github/stars/simonewebdesign/elm-new?style=flat)](https://github.com/simonewebdesign/elm-new/stargazers) - Generate initial project scaffolding based on a template.
* [elm-webpack-starter-kid](https://github.com/FranzSkuffka/elm-webpack-starter-kid) [![GitHub stars](https://img.shields.io/github/stars/FranzSkuffka/elm-webpack-starter-kid?style=flat)](https://github.com/FranzSkuffka/elm-webpack-starter-kid/stargazers) - A very very basic elm + webpack 4 template.
* [generator-elm-mdl](https://github.com/ashellwig/generator-elm-mdl) [![GitHub stars](https://img.shields.io/github/stars/ashellwig/generator-elm-mdl?style=flat)](https://github.com/ashellwig/generator-elm-mdl/stargazers) - Yeoman generator for a simple elm application utilizing Material Design.
...
- [Spades](https://github.com/rogeriochaves/spades) [![GitHub stars](https://img.shields.io/github/stars/rogeriochaves/spades?style=flat)](https://github.com/rogeriochaves/spades/stargazers) - Start an Elm SPA ready to the real world.

---

## Static analysis

* [Elm Analyse](https://github.com/stil4m/elm-analyse) [![GitHub stars](https://img.shields.io/github/stars/stil4m/elm-analyse?style=flat)](https://github.com/stil4m/elm-analyse/stargazers) - Linter for the Elm programming language.
* [Elm Review](https://github.com/jfmengels/elm-review) [![GitHub stars](https://img.shields.io/github/stars/jfmengels/elm-review?style=flat)](https://github.com/jfmengels/elm-review/stargazers) - Code reviewer for the Elm programming language.
...
* [run-elm](https://github.com/jfairbank/run-elm) [![GitHub stars](https://img.shields.io/github/stars/jfairbank/run-elm?style=flat)](https://github.com/jfairbank/run-elm/stargazers) — Run Elm code from the command line
...
* [Elm Watch](https://github.com/lydell/elm-watch) [![GitHub stars](https://img.shields.io/github/stars/lydell/elm-watch?style=flat)](https://github.com/lydell/elm-watch/stargazers) - `elm make` in watch mode. Fast and reliable.
...
* [elm-compiler](https://github.com/elm/compiler) [![GitHub stars](https://img.shields.io/github/stars/elm/compiler?style=flat)](https://github.com/elm/compiler/stargazers) - The official Elm compiler.
* [elm-webpack-loader](https://github.com/elm-community/elm-webpack-loader) [![GitHub stars](https://img.shields.io/github/stars/elm-community/elm-webpack-loader?style=flat)](https://github.com/elm-community/elm-webpack-loader/stargazers) - Webpack loader Elm.
* [Parcel](https://parceljs.org/languages/elm/) - Bundle Elm using Parcel.
* [vite-plugin-elm](https://github.com/hmsk/vite-plugin-elm) [![GitHub stars](https://img.shields.io/github/stars/hmsk/vite-plugin-elm?style=flat)](https://github.com/hmsk/vite-plugin-elm/stargazers) - Vite plugin for Elm.

### Unmaintained

* [grunt-elm](https://github.com/rtfeldman/grunt-elm) [![GitHub stars](https://img.shields.io/github/stars/rtfeldman/grunt-elm?style=flat)](https://github.com/rtfeldman/grunt-elm/stargazers) - Grunt plugin that compiles Elm files to JavaScript.
...
* [elm-posix](https://github.com/albertdahlin/elm-posix) [![GitHub stars](https://img.shields.io/github/stars/albertdahlin/elm-posix?style=flat)](https://github.com/albertdahlin/elm-posix/stargazers) - Write CLI programs using Elm
* [Litvis](https://github.com/gicentre/litvis) [![GitHub stars](https://img.shields.io/github/stars/gicentre/litvis?style=flat)](https://github.com/gicentre/litvis/stargazers) - Literate Visualization with Elm
...
* [atom-elm-snippets](https://github.com/chiefGui/atom-elm-snippets) [![GitHub stars](https://img.shields.io/github/stars/chiefGui/atom-elm-snippets?style=flat)](https://github.com/chiefGui/atom-elm-snippets/stargazers) - Elm snippets for Atom.
...
* [emacs-elm-mode](https://github.com/jcollard/elm-mode) [![GitHub stars](https://img.shields.io/github/stars/jcollard/elm-mode?style=flat)](https://github.com/jcollard/elm-mode/stargazers) - Syntax highlighting, Elm REPL, Elm make and Elm format integration for the Emacs editor.

### IntelliJ

* [elm-plugin](https://github.com/klazuka/intellij-elm) [![GitHub stars](https://img.shields.io/github/stars/klazuka/intellij-elm?style=flat)](https://github.com/klazuka/intellij-elm/stargazers) - Elm plugin for IntelliJ IDEA.
...
* [theJian/elm.vim](https://github.com/theJian/elm.vim) [![GitHub stars](https://img.shields.io/github/stars/theJian/elm.vim?style=flat)](https://github.com/theJian/elm.vim/stargazers) - Elm syntax highlighting. Use with [ale or Neoformat for Neovim](https://github.com/avh4/elm-format/issues/610) [![GitHub stars](https://img.shields.io/github/stars/avh4/elm-format/issues/610?style=flat)](https://github.com/avh4/elm-format/issues/610/stargazers) since ElmCast/elm-vim does not support Elm 0.19.
* [ElmCast/elm-vim](https://github.com/ElmCast/elm-vim) [![GitHub stars](https://img.shields.io/github/stars/ElmCast/elm-vim?style=flat)](https://github.com/ElmCast/elm-vim/stargazers) - Elm 0.18 mode for Vim/Neovim.
* [vim-elm-help](https://github.com/hoelzro/vim-elm-help) [![GitHub stars](https://img.shields.io/github/stars/hoelzro/vim-elm-help?style=flat)](https://github.com/hoelzro/vim-elm-help/stargazers) - Offline Elm documentation access in your editor.
* [emmet-vim](https://github.com/mattn/emmet-vim) [![GitHub stars](https://img.shields.io/github/stars/mattn/emmet-vim?style=flat)](https://github.com/mattn/emmet-vim/stargazers) - Markup expansion with elm support.
...
* [elm-light-table](https://github.com/rundis/elm-light) [![GitHub stars](https://img.shields.io/github/stars/rundis/elm-light?style=flat)](https://github.com/rundis/elm-light/stargazers) - Syntax highlighting, REPL, autocompletion, package management and much more for Light Table.
...
* [TodoMVC/Firebase](https://github.com/ThomasWeiser/todomvc-elmfire) [![GitHub stars](https://img.shields.io/github/stars/ThomasWeiser/todomvc-elmfire?style=flat)](https://github.com/ThomasWeiser/todomvc-elmfire/stargazers) - Fork of TodoMVC demonstrating start-app, [The Elm Architecture](https://github.com/evancz/elm-architecture-tutorial) [![GitHub stars](https://img.shields.io/github/stars/evancz/elm-architecture-tutorial?style=flat)](https://github.com/evancz/elm-architecture-tutorial/stargazers) and Firebase as backend.
* [TodoMVC in Electron](https://github.com/nirgn975/Elmctron) [![GitHub stars](https://img.shields.io/github/stars/nirgn975/Elmctron?style=flat)](https://github.com/nirgn975/Elmctron/stargazers) -  Documented and tested implementation of the Elm TodoMVC app in Electron.
...
* [Pokelmon](https://github.com/brenopanzolini/pokelmon) [![GitHub stars](https://img.shields.io/github/stars/brenopanzolini/pokelmon?style=flat)](https://github.com/brenopanzolini/pokelmon/stargazers) - Elm project consuming PokéAPI.
* [JWT auth with Django + Elm](https://github.com/apirobot/django-elm-auth-with-jwt) [![GitHub stars](https://img.shields.io/github/stars/apirobot/django-elm-auth-with-jwt?style=flat)](https://github.com/apirobot/django-elm-auth-with-jwt/stargazers) - JSON Web Token (JWT) authentication using Django (backend) and Elm (frontend).
* [Bitcoin BR Chrome Extension](https://github.com/jouderianjr/bitcoin-br-chrome-extension) [![GitHub stars](https://img.shields.io/github/stars/jouderianjr/bitcoin-br-chrome-extension?style=flat)](https://github.com/jouderianjr/bitcoin-br-chrome-extension/stargazers) - Chrome extension built in Elm that shows the bitcoin value in all Brazilian exchanges.
* [Elmstagram](https://github.com/bkbooth/Elmstagram) [![GitHub stars](https://img.shields.io/github/stars/bkbooth/Elmstagram?style=flat)](https://github.com/bkbooth/Elmstagram/stargazers) - Basic UI Clone of Instagram / Articles - [Part 1](https://benbooth.dev/building-a-basic-ui-clone-of-instagram-using-elm-part-1/) [Part 2](https://benbooth.dev/building-a-basic-ui-clone-of-instagram-using-elm-part-2/) [Part 3](https://benbooth.dev/building-a-basic-ui-clone-of-instagram-using-elm-part-3/)
...
* [Regex Nodes](https://github.com/johannesvollmer/regex-nodes) [![GitHub stars](https://img.shields.io/github/stars/johannesvollmer/regex-nodes?style=flat)](https://github.com/johannesvollmer/regex-nodes/stargazers) - A [node-based visual editor for fiddling with regular expressions](https://johannesvollmer.com/regex-nodes/), built with Elm.

### Games

* [elm-games](https://github.com/rofrol/elm-games) [![GitHub stars](https://img.shields.io/github/stars/rofrol/elm-games?style=flat)](https://github.com/rofrol/elm-games/stargazers) - An excellent list of games made in Elm
* [TheSpace App](https://github.com/thematters/thespace-app) [![GitHub stars](https://img.shields.io/github/stars/thematters/thespace-app?style=flat)](https://github.com/thematters/thespace-app/stargazers) - A reddit place like DApp with blockchain and canvas(through port) integration in Elm.
...
* [Companies using Elm](https://github.com/jah2488/elm-companies) [![GitHub stars](https://img.shields.io/github/stars/jah2488/elm-companies?style=flat)](https://github.com/jah2488/elm-companies/stargazers) - A list of companies using Elm in production.
...
* [Bucklescript-TEA](https://github.com/OvermindDL1/bucklescript-tea) [![GitHub stars](https://img.shields.io/github/stars/OvermindDL1/bucklescript-tea?style=flat)](https://github.com/OvermindDL1/bucklescript-tea/stargazers) - The Elm Architecture based on OCaml / Reason and [Bucklescript](https://bucklescript.github.io/)
* [Elchemy](https://github.com/wende/elchemy) [![GitHub stars](https://img.shields.io/github/stars/wende/elchemy?style=flat)](https://github.com/wende/elchemy/stargazers) - Write Elixir code using statically-typed Elm-like syntax
* [Elmish](https://github.com/elmish/elmish) [![GitHub stars](https://img.shields.io/github/stars/elmish/elmish?style=flat)](https://github.com/elmish/elmish/stargazers) - Elm-like abstractions for F# apps
* [Fabulous](https://github.com/fsprojects/Fabulous) [![GitHub stars](https://img.shields.io/github/stars/fsprojects/Fabulous?style=flat)](https://github.com/fsprojects/Fabulous/stargazers) - F# Functional App Development, using declarative dynamic UI
* [Flame](https://github.com/easafe/purescript-flame) [![GitHub stars](https://img.shields.io/github/stars/easafe/purescript-flame?style=flat)](https://github.com/easafe/purescript-flame/stargazers) - A library that provides The Elm Architecture in PureScript.
* [Hyperapp](https://github.com/jorgebucaran/hyperapp) [![GitHub stars](https://img.shields.io/github/stars/jorgebucaran/hyperapp?style=flat)](https://github.com/jorgebucaran/hyperapp/stargazers) - A library that provide The Elm Architecture in JavaScript.
* [Iced](https://github.com/hecrj/iced) [![GitHub stars](https://img.shields.io/github/stars/hecrj/iced?style=flat)](https://github.com/hecrj/iced/stargazers) - A cross-platform GUI library for Rust, inspired by Elm
* [Indigo](https://indigoengine.io/) - Indigo is an Elm-inspired game engine for Scala.js.
* [Lustre](https://github.com/lustre-labs/lustre) [![GitHub stars](https://img.shields.io/github/stars/lustre-labs/lustre?style=flat)](https://github.com/lustre-labs/lustre/stargazers) - A library that provides The Elm Architecture in Gleam.
* [Miso](https://github.com/dmjio/miso) [![GitHub stars](https://img.shields.io/github/stars/dmjio/miso?style=flat)](https://github.com/dmjio/miso/stargazers) - A library that provides The Elm Architecture in Haskell.
* [Mobius](https://github.com/spotify/mobius) [![GitHub stars](https://img.shields.io/github/stars/spotify/mobius?style=flat)](https://github.com/spotify/mobius/stargazers) - Elm-like abstractions for android apps, created by Spotify.
* [React-tea-cup](https://github.com/vankeisb/react-tea-cup) [![GitHub stars](https://img.shields.io/github/stars/vankeisb/react-tea-cup?style=flat)](https://github.com/vankeisb/react-tea-cup/stargazers) - A thin library that provides The Elm Architecture in react, used by IBM.
* [Redux](https://redux.js.org/introduction/prior-art) - A predictable state container for JavaScript apps.
* [Roc](https://github.com/roc-lang/roc) [![GitHub stars](https://img.shields.io/github/stars/roc-lang/roc?style=flat)](https://github.com/roc-lang/roc/stargazers) - A language that targets WebAssembly and machine code inspired by Elm.
* [Sauron](https://github.com/ivanceras/sauron) [![GitHub stars](https://img.shields.io/github/stars/ivanceras/sauron?style=flat)](https://github.com/ivanceras/sauron/stargazers) - A library that provides The Elm Architecture in Rust targeting the web.
...
* [iOS](https://github.com/pzp1997/elm-ios) [![GitHub stars](https://img.shields.io/github/stars/pzp1997/elm-ios?style=flat)](https://github.com/pzp1997/elm-ios/stargazers) A POC for using Elm 0.18 for native iOS Applications
* [elmish-wasm](https://github.com/Chadtech/elmish-wasm) [![GitHub stars](https://img.shields.io/github/stars/Chadtech/elmish-wasm?style=flat)](https://github.com/Chadtech/elmish-wasm/stargazers) A POC for compiling elm to Web Assembly
* [elm-serverless](https://github.com/ktonon/elm-serverless) [![GitHub stars](https://img.shields.io/github/stars/ktonon/elm-serverless?style=flat)](https://github.com/ktonon/elm-serverless/stargazers) Run Elm 0.18 on Cloud Functions using the Serverless Frameworks
* [elm-posix](https://github.com/albertdahlin/elm-posix) [![GitHub stars](https://img.shields.io/github/stars/albertdahlin/elm-posix?style=flat)](https://github.com/albertdahlin/elm-posix/stargazers) - Write CLI programs using Elm
...
- <a href="https://github.com/sindresorhus/awesome" target="_blank">awesome</a> by [**@sindresorhus**](https://github.com/sindresorhus) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus?style=flat)](https://github.com/sindresorhus/stargazers)
- <a href="https://github.com/bayandin/awesome-awesomeness" target="_blank">awesome-awesomeness</a> by [**@bayandin**](https://github.com/bayandin) [![GitHub stars](https://img.shields.io/github/stars/bayandin?style=flat)](https://github.com/bayandin/stargazers)
