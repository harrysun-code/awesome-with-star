...
## Codes
- [BiDAF](https://github.com/allenai/bi-att-flow) [![GitHub stars](https://img.shields.io/github/stars/allenai/bi-att-flow?style=flat)](https://github.com/allenai/bi-att-flow/stargazers) - Bi-Directional Attention Flow (BIDAF) network is a multi-stage hierarchical process that represents the context at different levels of granularity and uses bi-directional attention flow mechanism to obtain a query-aware context representation without early summarization. 
  - Official; Tensorflow v1.2
  - [Paper](https://arxiv.org/pdf/1611.01603.pdf)
- [QANet](https://github.com/NLPLearn/QANet) [![GitHub stars](https://img.shields.io/github/stars/NLPLearn/QANet?style=flat)](https://github.com/NLPLearn/QANet/stargazers) - A Q&A architecture does not require recurrent networks: Its encoder consists exclusively of convolution and self-attention, where convolution models local interactions and self-attention models global interactions.
  - Google; Unofficial; Tensorflow v1.5
  - [Paper](#qanet)
- [R-Net](https://github.com/HKUST-KnowComp/R-Net) [![GitHub stars](https://img.shields.io/github/stars/HKUST-KnowComp/R-Net?style=flat)](https://github.com/HKUST-KnowComp/R-Net/stargazers) - An end-to-end neural networks model for reading comprehension style question answering, which aims to answer questions from a given passage.
...
- [R-Net-in-Keras](https://github.com/YerevaNN/R-NET-in-Keras) [![GitHub stars](https://img.shields.io/github/stars/YerevaNN/R-NET-in-Keras?style=flat)](https://github.com/YerevaNN/R-NET-in-Keras/stargazers) - R-NET re-implementation in Keras.
  - MS; Unofficial; Keras v2.0.6
  - [Paper](https://www.microsoft.com/en-us/research/wp-content/uploads/2017/05/r-net.pdf)
- [DrQA](https://github.com/hitvoice/DrQA) [![GitHub stars](https://img.shields.io/github/stars/hitvoice/DrQA?style=flat)](https://github.com/hitvoice/DrQA/stargazers) - DrQA is a system for reading comprehension applied to open-domain question answering.
  - Facebook; Official; Pytorch v0.4
  - [Paper](#drqa)
- [BERT](https://github.com/google-research/bert) [![GitHub stars](https://img.shields.io/github/stars/google-research/bert?style=flat)](https://github.com/google-research/bert/stargazers) - A new language representation model which stands for Bidirectional Encoder Representations from Transformers. Unlike recent language representation models, BERT is designed to pre-train deep bidirectional representations by jointly conditioning on both left and right context in all layers. 
...
## Slides
- [Question Answering with Knowledge Bases, Web and Beyond](https://github.com/scottyih/Slides/blob/master/QA%20Tutorial.pdf) [![GitHub stars](https://img.shields.io/github/stars/scottyih/Slides/blob/master/QA%20Tutorial.pdf?style=flat)](https://github.com/scottyih/Slides/blob/master/QA%20Tutorial.pdf/stargazers) - By Scott Wen-tau Yih & Hao Ma | Microsoft Research | 2016.
...
## Dataset Collections
- [NLIWOD's Question answering datasets](https://github.com/dice-group/NLIWOD/tree/master/qa.datasets) [![GitHub stars](https://img.shields.io/github/stars/dice-group/NLIWOD/tree/master/qa.datasets?style=flat)](https://github.com/dice-group/NLIWOD/tree/master/qa.datasets/stargazers)
- [karthinkncode's Datasets for Natural Language Processing](https://github.com/karthikncode/nlp-datasets) [![GitHub stars](https://img.shields.io/github/stars/karthikncode/nlp-datasets?style=flat)](https://github.com/karthikncode/nlp-datasets/stargazers)
...
- [CODAH Dataset](https://github.com/Websail-NU/CODAH) [![GitHub stars](https://img.shields.io/github/stars/Websail-NU/CODAH?style=flat)](https://github.com/Websail-NU/CODAH/stargazers)
- [DeepMind Q&A Dataset; CNN/Daily Mail](https://github.com/deepmind/rc-data) [![GitHub stars](https://img.shields.io/github/stars/deepmind/rc-data?style=flat)](https://github.com/deepmind/rc-data/stargazers)
...
- [ELI5](https://github.com/facebookresearch/ELI5) [![GitHub stars](https://img.shields.io/github/stars/facebookresearch/ELI5?style=flat)](https://github.com/facebookresearch/ELI5/stargazers)
  - Paper: https://arxiv.org/abs/1907.09190
- [GraphQuestions](https://github.com/ysu1989/GraphQuestions) [![GitHub stars](https://img.shields.io/github/stars/ysu1989/GraphQuestions?style=flat)](https://github.com/ysu1989/GraphQuestions/stargazers)
...
- [NarrativeQA](https://github.com/deepmind/narrativeqa) [![GitHub stars](https://img.shields.io/github/stars/deepmind/narrativeqa?style=flat)](https://github.com/deepmind/narrativeqa/stargazers)
...
- [NewsQA](https://github.com/Maluuba/newsqa) [![GitHub stars](https://img.shields.io/github/stars/Maluuba/newsqa?style=flat)](https://github.com/Maluuba/newsqa/stargazers)
...
To the extent possible under law, [seriousmac](https://github.com/seriousmac) [![GitHub stars](https://img.shields.io/github/stars/seriousmac?style=flat)](https://github.com/seriousmac/stargazers) (the maintainer) has waived all copyright and related or neighboring rights to this work.
