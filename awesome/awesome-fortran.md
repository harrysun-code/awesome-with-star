...
A curated list of awesome Fortran frameworks, libraries and software. Inspired by [awesome-swift](https://github.com/Wolg/awesome-swift) [![GitHub stars](https://img.shields.io/github/stars/Wolg/awesome-swift?style=flat)](https://github.com/Wolg/awesome-swift/stargazers) by @Wolg.
...
* [Functional Fortran](https://github.com/wavebitscientific/functional-fortran) [![GitHub stars](https://img.shields.io/github/stars/wavebitscientific/functional-fortran?style=flat)](https://github.com/wavebitscientific/functional-fortran/stargazers) - Functional programming for modern Fortran.
...
* [netCDF](https://github.com/Unidata/netcdf-fortran) [![GitHub stars](https://img.shields.io/github/stars/Unidata/netcdf-fortran?style=flat)](https://github.com/Unidata/netcdf-fortran/stargazers) - a set of software libraries and self-describing, machine-independent data formats that support the creation, access, and sharing of array-oriented scientific data.
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) [![GitHub stars](https://img.shields.io/github/stars/xianyi/OpenBLAS?style=flat)](https://github.com/xianyi/OpenBLAS/stargazers) - one of the fastest open source BLAS libraries available.  Almost as fast as Intel MKL.

## JSON Manipulation
*Libraries for JSON data manipulating with Fortran language.*

* [FSON](https://github.com/josephalevin/fson) [![GitHub stars](https://img.shields.io/github/stars/josephalevin/fson?style=flat)](https://github.com/josephalevin/fson/stargazers) - Fortran 95 JSON Parser.
* [json-fortran](https://github.com/jacobwilliams/json-fortran) [![GitHub stars](https://img.shields.io/github/stars/jacobwilliams/json-fortran?style=flat)](https://github.com/jacobwilliams/json-fortran/stargazers) - A Fortran 2008 JSON API.

## XML Manipulation
*Libraries for XML data manipulating with Fortran language.*

* [fox](https://github.com/andreww/fox) [![GitHub stars](https://img.shields.io/github/stars/andreww/fox?style=flat)](https://github.com/andreww/fox/stargazers) - Fortran XML library
...
* [datetime-fortran](https://github.com/wavebitscientific/datetime-fortran) [![GitHub stars](https://img.shields.io/github/stars/wavebitscientific/datetime-fortran?style=flat)](https://github.com/wavebitscientific/datetime-fortran/stargazers) - A Fortran 2003 date and time manipulation library, modeled after Python's datetime library.
...
* [BeFoR64](https://github.com/szaghi/BeFoR64) [![GitHub stars](https://img.shields.io/github/stars/szaghi/BeFoR64?style=flat)](https://github.com/szaghi/BeFoR64/stargazers) - Base64 encoding/decoding library for FoRtran poor men. A KISS library for base64 encoding/decoding for modern (2003+) Fortran projects.

## Portability enabling
*Libraries for enabling codes portability.*

* [PENF](https://github.com/szaghi/PENF) [![GitHub stars](https://img.shields.io/github/stars/szaghi/PENF?style=flat)](https://github.com/szaghi/PENF/stargazers) - Pure Fortran (2003+) library for ensuring codes portability.

## Command-Line parsing
*Libraries for parsing command-line and building user interfaces.*

* [FLAP](https://github.com/szaghi/FLAP) [![GitHub stars](https://img.shields.io/github/stars/szaghi/FLAP?style=flat)](https://github.com/szaghi/FLAP/stargazers) - Fortran command Line Arguments Parser for poor men. A KISS library for building easily nice Command Line Interfaces (CLI) for modern (2003+) Fortran projects.
* [options.f90](https://github.com/cngilbreth/optionsf90) [![GitHub stars](https://img.shields.io/github/stars/cngilbreth/optionsf90?style=flat)](https://github.com/cngilbreth/optionsf90/stargazers) - Options & input processing for modern Fortran.

## Compiling and building
*Libraries for compiling and building Fortran projects.*

* [FoBiS](https://github.com/szaghi/FoBiS) [![GitHub stars](https://img.shields.io/github/stars/szaghi/FoBiS?style=flat)](https://github.com/szaghi/FoBiS/stargazers) - Fortran Building System for poor men. A KISS tool for automatic building modern Fortran projects.
...
* [FORD](https://github.com/cmacmackin/ford) [![GitHub stars](https://img.shields.io/github/stars/cmacmackin/ford?style=flat)](https://github.com/cmacmackin/ford/stargazers) - An automatic documentation generator for modern Fortran programs.

## Computational Fluid Dynamics
*Libraries for CFD computations*

* [MFC](https://github.com/MFlowCode/MFC) [![GitHub stars](https://img.shields.io/github/stars/MFlowCode/MFC?style=flat)](https://github.com/MFlowCode/MFC/stargazers) - Exascale multiphase compressible flow solver with GPU acceleration via OpenACC. 2025 Gordon Bell Prize Finalist.
* [OFF](https://github.com/szaghi/OFF/tree/testing) [![GitHub stars](https://img.shields.io/github/stars/szaghi/OFF/tree/testing?style=flat)](https://github.com/szaghi/OFF/tree/testing/stargazers) - Open source Finite volume Fluid dynamics code.
...
* [Fortran Machine](https://github.com/mapmeld/fortran-machine) [![GitHub stars](https://img.shields.io/github/stars/mapmeld/fortran-machine?style=flat)](https://github.com/mapmeld/fortran-machine/stargazers) - An MVC web stack written in Fortran 90
