...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers) list project.*
...
- [Serverless working group](https://github.com/cncf/wg-serverless) [![GitHub stars](https://img.shields.io/github/stars/cncf/wg-serverless?style=flat)](https://github.com/cncf/wg-serverless/stargazers) - CNCF serverless working group.
...
- [Official joke API](https://github.com/15Dkatz/official_joke_api) [![GitHub stars](https://img.shields.io/github/stars/15Dkatz/official_joke_api?style=flat)](https://github.com/15Dkatz/official_joke_api/stargazers) - Vue Jokester application backend.
- [Event Gateway Getting Started](https://github.com/serverless/event-gateway-getting-started) [![GitHub stars](https://img.shields.io/github/stars/serverless/event-gateway-getting-started?style=flat)](https://github.com/serverless/event-gateway-getting-started/stargazers) - Walkthrough application for using the Event Gateway.
- [Utils](https://github.com/serverless/utils) [![GitHub stars](https://img.shields.io/github/stars/serverless/utils?style=flat)](https://github.com/serverless/utils/stargazers) - General Serverless utilities.
- [CloudWatch public metrics](https://github.com/RafalWilinski/cloudwatch-public-metrics) [![GitHub stars](https://img.shields.io/github/stars/RafalWilinski/cloudwatch-public-metrics?style=flat)](https://github.com/RafalWilinski/cloudwatch-public-metrics/stargazers) - Expose AWS CloudWatch metrics as a public HTML page.
- [Invoicely](https://github.com/EwanValentine/invoicely) [![GitHub stars](https://img.shields.io/github/stars/EwanValentine/invoicely?style=flat)](https://github.com/EwanValentine/invoicely/stargazers) - Invoice automation tool.
- [World Cup Slackbot](https://github.com/phstc/serverless-world-cup-slack-bot) [![GitHub stars](https://img.shields.io/github/stars/phstc/serverless-world-cup-slack-bot?style=flat)](https://github.com/phstc/serverless-world-cup-slack-bot/stargazers) - Post 2018 FIFA World Cup Russia™ matches events to Slack.
- [Serverless Express](https://github.com/mikestaub/serverless-express) [![GitHub stars](https://img.shields.io/github/stars/mikestaub/serverless-express?style=flat)](https://github.com/mikestaub/serverless-express/stargazers) - Run your unmodified express app on AWS Lambda via the Serverless Framework.
- [TypeScript composite monorepo](https://github.com/tommedema/serverless-mono-example) [![GitHub stars](https://img.shields.io/github/stars/tommedema/serverless-mono-example?style=flat)](https://github.com/tommedema/serverless-mono-example/stargazers) - Yarn / Lerna workspaces with Typescript 3.0 composite references using `nohoist` for compatible serverless application packaging.
- [Next serverless](https://github.com/cyrilwanner/next-serverless) [![GitHub stars](https://img.shields.io/github/stars/cyrilwanner/next-serverless?style=flat)](https://github.com/cyrilwanner/next-serverless/stargazers) - Deploys your next.js application to AWS Lambda.
- [Serverless Central](https://github.com/zotoio/serverless-central) [![GitHub stars](https://img.shields.io/github/stars/zotoio/serverless-central?style=flat)](https://github.com/zotoio/serverless-central/stargazers) - Sample Lambda monorepo.
- [Tipe](https://tipe.io) - Next generation serverless CMS.
- [Spiderless](https://github.com/slashbit/spider-less) [![GitHub stars](https://img.shields.io/github/stars/slashbit/spider-less?style=flat)](https://github.com/slashbit/spider-less/stargazers) - A web spider / scraper / website change detector built with Lambda, API Gateway, DynamoDB and SNS.
- [PriceTrack](https://github.com/duyetdev/pricetrack) [![GitHub stars](https://img.shields.io/github/stars/duyetdev/pricetrack?style=flat)](https://github.com/duyetdev/pricetrack/stargazers) - API / Website for E-commerce price tracking. Built with Firebase functions and Firebase Hosting.

## Related projects

- [FaaS boilerplates](https://github.com/hasura/cloud-functions-boilerplates) [![GitHub stars](https://img.shields.io/github/stars/hasura/cloud-functions-boilerplates?style=flat)](https://github.com/hasura/cloud-functions-boilerplates/stargazers) - Boilerplates for FaaS offerings that work in conjunction with Hasura GraphQL Engine's event triggers.
- [CloudCompose](https://cloudcompose.io) - An open community marketplace for serverless functions and workflows.
- [Mutton](https://github.com/hmngwy/mutton) [![GitHub stars](https://img.shields.io/github/stars/hmngwy/mutton?style=flat)](https://github.com/hmngwy/mutton/stargazers) - A Python shim library for better AWS Lambda handlers.
...
- [Handly](https://github.com/harijoe/handly) [![GitHub stars](https://img.shields.io/github/stars/harijoe/handly?style=flat)](https://github.com/harijoe/handly/stargazers) - A wrapper for serverless handlers to prevent silly mistakes.
- [Serverless boilerplate](https://github.com/harijoe/serverless-boilerplate) [![GitHub stars](https://img.shields.io/github/stars/harijoe/serverless-boilerplate?style=flat)](https://github.com/harijoe/serverless-boilerplate/stargazers) - Minimal yet super-functional Serverless boilerplate.
- [Firecracker](https://github.com/firecracker-microvm/firecracker) [![GitHub stars](https://img.shields.io/github/stars/firecracker-microvm/firecracker?style=flat)](https://github.com/firecracker-microvm/firecracker/stargazers) - Secure and fast microVMs for serverless computing.
- [Cirrus](https://github.com/ucbrise/cirrus) [![GitHub stars](https://img.shields.io/github/stars/ucbrise/cirrus?style=flat)](https://github.com/ucbrise/cirrus/stargazers) - Serverless machine learning framework.
- [OpenFaaS](https://docs.openfaas.com/) - Serverless Functions Made Simple for Docker and Kubernetes.
- [OpenFaaS Cloud](https://github.com/openfaas/openfaas-cloud) [![GitHub stars](https://img.shields.io/github/stars/openfaas/openfaas-cloud?style=flat)](https://github.com/openfaas/openfaas-cloud/stargazers) - OpenFaaS Cloud: multi-user serverless functions driven by git.

## Serverless Framework Plugins

- [Local environment](https://github.com/piercus/serverless-local-environment) [![GitHub stars](https://img.shields.io/github/stars/piercus/serverless-local-environment?style=flat)](https://github.com/piercus/serverless-local-environment/stargazers) - Set local environment variables.
- [Offline SSM](https://github.com/janders223/serverless-offline-ssm) [![GitHub stars](https://img.shields.io/github/stars/janders223/serverless-offline-ssm?style=flat)](https://github.com/janders223/serverless-offline-ssm/stargazers) - Read SSM parameters from a `.env` file instead of AWS.
- [Nocode](https://github.com/ServerlessOpsIO/serverless-nocode) [![GitHub stars](https://img.shields.io/github/stars/ServerlessOpsIO/serverless-nocode?style=flat)](https://github.com/ServerlessOpsIO/serverless-nocode/stargazers) - Deploy nocode via the Serverless Framework.
- [Canary deployments](https://github.com/davidgf/serverless-plugin-canary-deployments) [![GitHub stars](https://img.shields.io/github/stars/davidgf/serverless-plugin-canary-deployments?style=flat)](https://github.com/davidgf/serverless-plugin-canary-deployments/stargazers) - Implement canary deployments of AWS Lambda functions.
- [Flow-based programming](https://github.com/p0wl/serverless-fbp) [![GitHub stars](https://img.shields.io/github/stars/p0wl/serverless-fbp?style=flat)](https://github.com/p0wl/serverless-fbp/stargazers) - Flow-based programming plugin for Serverless.
- [Go serverless](https://github.com/thepauleh/goserverless) [![GitHub stars](https://img.shields.io/github/stars/thepauleh/goserverless?style=flat)](https://github.com/thepauleh/goserverless/stargazers) - GoFormation for the Serverless Framework. Create Serverless configs with Go structs.
- [Event Gateway](https://github.com/serverless/serverless-event-gateway-plugin) [![GitHub stars](https://img.shields.io/github/stars/serverless/serverless-event-gateway-plugin?style=flat)](https://github.com/serverless/serverless-event-gateway-plugin/stargazers) - Event Gateway plugin for the Serverless Framework.
- [Fn](https://github.com/fnproject/serverless-fn) [![GitHub stars](https://img.shields.io/github/stars/fnproject/serverless-fn?style=flat)](https://github.com/fnproject/serverless-fn/stargazers) - Fn provider plugin.
- [Cloudflare Workers](https://github.com/cloudflare/serverless-cloudflare-workers) [![GitHub stars](https://img.shields.io/github/stars/cloudflare/serverless-cloudflare-workers?style=flat)](https://github.com/cloudflare/serverless-cloudflare-workers/stargazers) - Provider plugin for Cloudflare Workers.
- [S3 Deploy](https://github.com/funkybob/serverless-s3-deploy) [![GitHub stars](https://img.shields.io/github/stars/funkybob/serverless-s3-deploy?style=flat)](https://github.com/funkybob/serverless-s3-deploy/stargazers) - Plugin to deploy files to an S3 Bucket.
...
- [Event Gateway Workshop](https://github.com/serverless/event-gateway-workshop) [![GitHub stars](https://img.shields.io/github/stars/serverless/event-gateway-workshop?style=flat)](https://github.com/serverless/event-gateway-workshop/stargazers) - Learn what the Event Gateway is, how it works and build your first event-driven multi-cloud application.
