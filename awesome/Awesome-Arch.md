...
> 来源：[PandaFoss/Awesome-Arch](https://github.com/PandaFoss/Awesome-Arch)

[![GitHub stars](https://img.shields.io/github/stars/PandaFoss/Awesome-Arch?style=flat)](https://github.com/PandaFoss/Awesome-Arch/stargazers)
...
- [PacBSD](https://github.com/pacbsd) [![GitHub stars](https://img.shields.io/github/stars/pacbsd?style=flat)](https://github.com/pacbsd/stargazers) - A lightweight and flexible BSD distribution that provides a base system for use of `pacman` package manager.
...
- [MagpieOS](https://github.com/magpie-linux) [![GitHub stars](https://img.shields.io/github/stars/magpie-linux?style=flat)](https://github.com/magpie-linux/stargazers) - Get a fresh experience of Arch.
...
- [Archfi](https://github.com/MatMoul/archfi) [![GitHub stars](https://img.shields.io/github/stars/MatMoul/archfi?style=flat)](https://github.com/MatMoul/archfi/stargazers) - Just a simple bash script wizard to install Arch Linux after you have booted on the official Arch Linux install media.
- [aui](https://github.com/helmuthdu/aui) [![GitHub stars](https://img.shields.io/github/stars/helmuthdu/aui?style=flat)](https://github.com/helmuthdu/aui/stargazers) - The Archlinux Ultimate Install comprises of two primary scripts, Lilo and Fifo, which streamline the installation process of Archlinux Base, as well as additional packages, tools, and graphical user interfaces.
...
- [Auracle](https://github.com/falconindy/auracle) [![GitHub stars](https://img.shields.io/github/stars/falconindy/auracle?style=flat)](https://github.com/falconindy/auracle/stargazers) (C++) - A flexible command line client for Arch Linux's User Repository.
...
- [repoctl](https://github.com/cassava/repoctl) [![GitHub stars](https://img.shields.io/github/stars/cassava/repoctl?style=flat)](https://github.com/cassava/repoctl/stargazers) (Go) - Make it easy to manage your local Arch Linux repository.
- [yaah](https://projects.metalgamer.eu/yaah) (Bash) - A helper for the Archlinux User Repository (AUR).

### Search and build

- [Aurutils](https://github.com/AladW/aurutils) [![GitHub stars](https://img.shields.io/github/stars/AladW/aurutils?style=flat)](https://github.com/AladW/aurutils/stargazers) (Bash) - Helper tools for the AUR.
- [Bauerbill](https://xyne.archlinux.ca/projects/bauerbill/) (Python) - An extension of Powerpill with AUR and ABS support.
- [PKGBUILDer](https://github.com/Kwpolska/pkgbuilder) [![GitHub stars](https://img.shields.io/github/stars/Kwpolska/pkgbuilder?style=flat)](https://github.com/Kwpolska/pkgbuilder/stargazers) (Python) - An AUR helper (and library) in Python 3.
- [repofish](https://git.seppia.net/repofish.git) (Bash) - Simple shell script used to manage a local archlinux repository.
- [RUA](https://github.com/vn971/rua) [![GitHub stars](https://img.shields.io/github/stars/vn971/rua?style=flat)](https://github.com/vn971/rua/stargazers) (Rust) - Build tool for Arch Linux providing control, review and jailed build options.

### Pacman wrappers

- [amethyst](https://github.com/crystal-linux/amethyst) [![GitHub stars](https://img.shields.io/github/stars/crystal-linux/amethyst?style=flat)](https://github.com/crystal-linux/amethyst/stargazers) (Rust) - A fast, efficient and lightweight AUR helper and Pacman wrapper made for Crystal, compatible with any Arch-based Linux distribution.
- [Aura](https://github.com/fosskers/aura) [![GitHub stars](https://img.shields.io/github/stars/fosskers/aura?style=flat)](https://github.com/fosskers/aura/stargazers) (Haskell) - A secure, multilingual package manager for Arch Linux and the AUR.
- [Pacaur](https://github.com/E5ten/pacaur) [![GitHub stars](https://img.shields.io/github/stars/E5ten/pacaur?style=flat)](https://github.com/E5ten/pacaur/stargazers) (Bash) - An AUR helper that minimizes user interaction.
- [Pakku](https://github.com/kitsunyan/pakku) [![GitHub stars](https://img.shields.io/github/stars/kitsunyan/pakku?style=flat)](https://github.com/kitsunyan/pakku/stargazers) (Nim) - `pacman` wrapper with AUR support.
- [Paru](https://github.com/Morganamilo/paru) [![GitHub stars](https://img.shields.io/github/stars/Morganamilo/paru?style=flat)](https://github.com/Morganamilo/paru/stargazers) (Rust) - AUR helper with all needed modern wrapper features, created by a former developer of yay.
- [pikaur](https://github.com/actionless/pikaur) [![GitHub stars](https://img.shields.io/github/stars/actionless/pikaur?style=flat)](https://github.com/actionless/pikaur/stargazers) (Python) - AUR helper with minimal dependencies. Review PKGBUILDs all in once, next build them all without user interaction.
- [Trizen](https://github.com/trizen/trizen) [![GitHub stars](https://img.shields.io/github/stars/trizen/trizen?style=flat)](https://github.com/trizen/trizen/stargazers) (Perl) - Lightweight AUR Package Manager.
- [Yay](https://github.com/Jguer/yay) [![GitHub stars](https://img.shields.io/github/stars/Jguer/yay?style=flat)](https://github.com/Jguer/yay/stargazers) (Go) - Yet another Yogurt, an AUR Helper written in Go.

### Graphical

- [Argon](https://github.com/14mRh4X0r/arch-argon) [![GitHub stars](https://img.shields.io/github/stars/14mRh4X0r/arch-argon?style=flat)](https://github.com/14mRh4X0r/arch-argon/stargazers) (Python | GTK3) - lightweight GUI package manager for Arch Linux.
- [Cylon](https://github.com/gavinlyonsrepo/cylon) [![GitHub stars](https://img.shields.io/github/stars/gavinlyonsrepo/cylon?style=flat)](https://github.com/gavinlyonsrepo/cylon/stargazers) (Bash | TUI) - A CLI TUI menu driven bash shell script supporting updates, maintenance, backups and system checks for an Arch based Linux distro.
...
- [Yup](https://github.com/ericm/yup) [![GitHub stars](https://img.shields.io/github/stars/ericm/yup?style=flat)](https://github.com/ericm/yup/stargazers) (Go | TUI) - Arch Linux AUR Helper with ncurses functionality and better searching and sorting.

### Maintenance

- [aur-out-of-date](https://github.com/simon04/aur-out-of-date) [![GitHub stars](https://img.shields.io/github/stars/simon04/aur-out-of-date?style=flat)](https://github.com/simon04/aur-out-of-date/stargazers) - Determines out-of-date AUR packages w.r.t. upstream version.
- [aurpublish](https://github.com/eli-schwartz/aurpublish) [![GitHub stars](https://img.shields.io/github/stars/eli-schwartz/aurpublish?style=flat)](https://github.com/eli-schwartz/aurpublish/stargazers) - PKGBUILD management framework for the Arch User Repository.
...
- [pkgoutofdate](https://github.com/anatol/pkgoutofdate) [![GitHub stars](https://img.shields.io/github/stars/anatol/pkgoutofdate?style=flat)](https://github.com/anatol/pkgoutofdate/stargazers) - Checks whether Arch packages are out-of-date.

### Other

- [arch-audit](https://gitlab.com/ilpianista/arch-audit) - A utility like pkg-audit based on Arch Security Team data.
- [aur-talk](https://github.com/GermainZ/aur-talk) [![GitHub stars](https://img.shields.io/github/stars/GermainZ/aur-talk?style=flat)](https://github.com/GermainZ/aur-talk/stargazers) - A script to fetch and display AUR package comments.
- [aurvote-utils](https://github.com/jadenPete/aurvote-utils) [![GitHub stars](https://img.shields.io/github/stars/jadenPete/aurvote-utils?style=flat)](https://github.com/jadenPete/aurvote-utils/stargazers) - A set of utilities for managing AUR votes.
- [haskell-aur](https://hackage.haskell.org/package/aur) - Haskell library for accessing Aurweb RPC interface.
- [package-query](https://github.com/archlinuxfr/package-query) [![GitHub stars](https://img.shields.io/github/stars/archlinuxfr/package-query?style=flat)](https://github.com/archlinuxfr/package-query/stargazers) - Tool for querying `libalpm` and the AUR.
...
- [Dotfiles Generator](https://github.com/ulises-jeremias/dotfiles) [![GitHub stars](https://img.shields.io/github/stars/ulises-jeremias/dotfiles?style=flat)](https://github.com/ulises-jeremias/dotfiles/stargazers) - Dotfiles generator that allows quick configuration of different Window Managers and tools in multiple operating systems, including any Arch Linux-based distribution.
- [JuNest](https://github.com/fsquillace/junest) [![GitHub stars](https://img.shields.io/github/stars/fsquillace/junest?style=flat)](https://github.com/fsquillace/junest/stargazers) - A lightweight Arch Linux-based distro that runs, without root privileges, upon any Linux distro.
- [makepkg-optimize](https://github.com/ptr1337/makepkg-optimize) [![GitHub stars](https://img.shields.io/github/stars/ptr1337/makepkg-optimize?style=flat)](https://github.com/ptr1337/makepkg-optimize/stargazers) - A collection of supplemental tidy, buildenv, and executable scripts for pacman which provide macros for several kinds of optimization in the build() and package() stages.
- [Termux Arch](https://termuxarch.github.io/TermuxArch/) - Run Arch Linux ARM on your mobile phone with Termux.
- [tarman](https://github.com/Alessandro-Salerno/tarman) [![GitHub stars](https://img.shields.io/github/stars/Alessandro-Salerno/tarman?style=flat)](https://github.com/Alessandro-Salerno/tarman/stargazers) -  The portable, cross-platform, extensible, and simple package manager for tarballs (and others!).
