...
For further resources related to Open Source Quantum Software Projects, please check out qosf's [repo](https://github.com/qosf/os_quantum_software) [![GitHub stars](https://img.shields.io/github/stars/qosf/os_quantum_software?style=flat)](https://github.com/qosf/os_quantum_software/stargazers).
...
- [Qiskit Tutorials](https://github.com/Qiskit/qiskit-tutorial) [![GitHub stars](https://img.shields.io/github/stars/Qiskit/qiskit-tutorial?style=flat)](https://github.com/Qiskit/qiskit-tutorial/stargazers) - Jupyter notebooks simply demonstrating how to use Qiskit.
...
- [Quantum Katas](https://github.com/Microsoft/QuantumKatas/) [![GitHub stars](https://img.shields.io/github/stars/Microsoft/QuantumKatas/?style=flat)](https://github.com/Microsoft/QuantumKatas//stargazers) - Programming exercises for learning quantum computing and Q#.
...
- [Blueqat](https://github.com/Blueqat/Blueqat) [![GitHub stars](https://img.shields.io/github/stars/Blueqat/Blueqat?style=flat)](https://github.com/Blueqat/Blueqat/stargazers) - Software development kit in Python for quantum gate computing.
- [Boulder Opal](https://q-ctrl.com/boulder-opal) - Python toolset for automating and optimizing quantum hardware performance.
- [Cirq](https://github.com/quantumlib/Cirq) [![GitHub stars](https://img.shields.io/github/stars/quantumlib/Cirq?style=flat)](https://github.com/quantumlib/Cirq/stargazers) - Python library for writing, manipulating, and optimizing NISQ circuits to run on quantum computers.
- [Covalent](https://github.com/AgnostiqHQ/covalent) [![GitHub stars](https://img.shields.io/github/stars/AgnostiqHQ/covalent?style=flat)](https://github.com/AgnostiqHQ/covalent/stargazers) - Framework for distributed computing on heterogeneous infrastructure from CPUs to GPUs to quantum computers.
...
- [NISQAI](https://github.com/quantumai-lib/nisqai) [![GitHub stars](https://img.shields.io/github/stars/quantumai-lib/nisqai?style=flat)](https://github.com/quantumai-lib/nisqai/stargazers) - Library for performing quantum artificial intelligence on near-term quantum computers.
...
- [Paddle Quantum](https://github.com/PaddlePaddle/Quantum) [![GitHub stars](https://img.shields.io/github/stars/PaddlePaddle/Quantum?style=flat)](https://github.com/PaddlePaddle/Quantum/stargazers) - Baidu's python toolkit for quantum machine learning.
...
- [pyQuil](https://github.com/rigetticomputing/pyquil) [![GitHub stars](https://img.shields.io/github/stars/rigetticomputing/pyquil?style=flat)](https://github.com/rigetticomputing/pyquil/stargazers) - Python library for quantum programming using Quil by Rigetti.
...
- [Qiskit.js](https://github.com/QISKit/qiskit-js) [![GitHub stars](https://img.shields.io/github/stars/QISKit/qiskit-js?style=flat)](https://github.com/QISKit/qiskit-js/stargazers) - Qiskit for JavaScript made by IBM.
...
- [Quantum++](https://github.com/vsoftco/qpp) [![GitHub stars](https://img.shields.io/github/stars/vsoftco/qpp?style=flat)](https://github.com/vsoftco/qpp/stargazers) - High performance modern C++11 quantum computing library.
...
- [Qurry](https://github.com/LSaldyt/Qurry) [![GitHub stars](https://img.shields.io/github/stars/LSaldyt/Qurry?style=flat)](https://github.com/LSaldyt/Qurry/stargazers) - Quantum probabilistic programming language based on functional and probabilistic paradigms.
...
- [Tequila](https://github.com/aspuru-guzik-group/tequila) [![GitHub stars](https://img.shields.io/github/stars/aspuru-guzik-group/tequila?style=flat)](https://github.com/aspuru-guzik-group/tequila/stargazers) - An Extensible Quantum Information and Learning Architecture developed by Alan Aspuru-Guzik group (University of Toronto).
...
- [Quantum Computing in Portuguese](https://github.com/smendoncabruna/ComputacaoQuantica) [![GitHub stars](https://img.shields.io/github/stars/smendoncabruna/ComputacaoQuantica?style=flat)](https://github.com/smendoncabruna/ComputacaoQuantica/stargazers) - A repository with curated content on Quantum Computing in Portuguese.

## License

[![CC0](http://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

To the extent possible under law, [Desiree Vogt-Lee](https://github.com/desireevl) [![GitHub stars](https://img.shields.io/github/stars/desireevl?style=flat)](https://github.com/desireevl/stargazers) has waived all copyright and related or neighboring rights to this work.
