...
- [Nebulosity](https://github.com/celstark/OpenNebulosity) [![GitHub stars](https://img.shields.io/github/stars/celstark/OpenNebulosity?style=flat)](https://github.com/celstark/OpenNebulosity/stargazers) - Open source, powerful, and easy to use astrophotography software.
...
- [Planetary System Stacker](https://github.com/Rolf-Hempel/PlanetarySystemStacker) [![GitHub stars](https://img.shields.io/github/stars/Rolf-Hempel/PlanetarySystemStacker?style=flat)](https://github.com/Rolf-Hempel/PlanetarySystemStacker/stargazers) - Cross-platform planetary stacker with alignment point tracking and quality-weighted stacking.
...
- [Nova DSO Tracker](https://github.com/mrantonSG/nova_DSO_tracker) [![GitHub stars](https://img.shields.io/github/stars/mrantonSG/nova_DSO_tracker?style=flat)](https://github.com/mrantonSG/nova_DSO_tracker/stargazers) - A free and open source, self-hosted web application for astrophotography planning. Features both single and multi-user modes, making it suitable for individuals or entire astronomy clubs.
...
- [SpacePixels](https://github.com/ppissias/SpacePixels) [![GitHub stars](https://img.shields.io/github/stars/ppissias/SpacePixels?style=flat)](https://github.com/ppissias/SpacePixels/stargazers) - Desktop and command-line FITS workflow for detecting moving and transient objects in aligned astronomical image sequences, aimed at asteroid, comet, satellite, and transient detection.
