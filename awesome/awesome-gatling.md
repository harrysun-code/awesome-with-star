...
- [gatling-kafka-extension](https://github.com/kbdering/GatlingMessaging) [![GitHub stars](https://img.shields.io/github/stars/kbdering/GatlingMessaging?style=flat)](https://github.com/kbdering/GatlingMessaging/stargazers) - A Gatling extension for load testing Kafka applications, with a focus on Request-Reply (RPC) patterns, Quality of Service (QoS) measurement, and resilience testing.
