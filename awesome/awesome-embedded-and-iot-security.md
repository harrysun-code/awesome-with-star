...
> 来源：[fkie-cad/awesome-embedded-and-iot-security](https://github.com/fkie-cad/awesome-embedded-and-iot-security)

[![GitHub stars](https://img.shields.io/github/stars/fkie-cad/awesome-embedded-and-iot-security?style=flat)](https://github.com/fkie-cad/awesome-embedded-and-iot-security/stargazers)
...
- [FwAnalyzer](https://github.com/cruise-automation/fwanalyzer) [![GitHub stars](https://img.shields.io/github/stars/cruise-automation/fwanalyzer?style=flat)](https://github.com/cruise-automation/fwanalyzer/stargazers) - Analyze security of firmware based on customized rules. Intended as additional step in DevSecOps, similar to CI.
- [HAL – The Hardware Analyzer](https://github.com/emsec/hal) [![GitHub stars](https://img.shields.io/github/stars/emsec/hal?style=flat)](https://github.com/emsec/hal/stargazers) - A comprehensive reverse engineering and manipulation framework for gate-level netlists.
- [HomePWN](https://github.com/ElevenPaths/HomePWN) [![GitHub stars](https://img.shields.io/github/stars/ElevenPaths/HomePWN?style=flat)](https://github.com/ElevenPaths/HomePWN/stargazers) - Swiss Army Knife for Pentesting of IoT Devices.
...
- [Killerbee](https://github.com/riverloopsec/killerbee) [![GitHub stars](https://img.shields.io/github/stars/riverloopsec/killerbee?style=flat)](https://github.com/riverloopsec/killerbee/stargazers) - Framework for Testing & Auditing ZigBee and IEEE 802.15.4 Networks.
- [PRET](https://github.com/RUB-NDS/PRET) [![GitHub stars](https://img.shields.io/github/stars/RUB-NDS/PRET?style=flat)](https://github.com/RUB-NDS/PRET/stargazers) - Printer Exploitation Toolkit.
- [Routersploit](https://github.com/threat9/routersploit) [![GitHub stars](https://img.shields.io/github/stars/threat9/routersploit?style=flat)](https://github.com/threat9/routersploit/stargazers) - Framework dedicated to exploit embedded devices.

### Analysis Tools

- [Binwalk](https://github.com/ReFirmLabs/binwalk) [![GitHub stars](https://img.shields.io/github/stars/ReFirmLabs/binwalk?style=flat)](https://github.com/ReFirmLabs/binwalk/stargazers) - Searches a binary for "interesting" stuff, as well as extracts arbitrary files.
- [cwe\_checker](https://github.com/fkie-cad/cwe_checker) [![GitHub stars](https://img.shields.io/github/stars/fkie-cad/cwe_checker?style=flat)](https://github.com/fkie-cad/cwe_checker/stargazers) - Finds vulnerable patterns in binary executables - ELF support for x86, ARM, and MIPS, experimental bare-metal support.
- [emba](https://github.com/e-m-b-a/emba) [![GitHub stars](https://img.shields.io/github/stars/e-m-b-a/emba?style=flat)](https://github.com/e-m-b-a/emba/stargazers) - Analyze Linux-based firmware of embedded devices.
- [Firmadyne](https://github.com/firmadyne/firmadyne) [![GitHub stars](https://img.shields.io/github/stars/firmadyne/firmadyne?style=flat)](https://github.com/firmadyne/firmadyne/stargazers) - Tries to emulate and pentest a firmware.
- [Firmwalker](https://github.com/craigz28/firmwalker) [![GitHub stars](https://img.shields.io/github/stars/craigz28/firmwalker?style=flat)](https://github.com/craigz28/firmwalker/stargazers) - Searches extracted firmware images for interesting files and information.
- [Firmware Slap](https://github.com/ChrisTheCoolHut/Firmware_Slap) [![GitHub stars](https://img.shields.io/github/stars/ChrisTheCoolHut/Firmware_Slap?style=flat)](https://github.com/ChrisTheCoolHut/Firmware_Slap/stargazers) - Discovering vulnerabilities in firmware through concolic analysis and function clustering.
...
- [Radare2](https://github.com/radare/radare2) [![GitHub stars](https://img.shields.io/github/stars/radare/radare2?style=flat)](https://github.com/radare/radare2/stargazers) - Software Reverse Engineering framework, also handles popular formats and arbitrary binaries, has an extensive command line toolset.
- [Trommel](https://github.com/CERTCC/trommel) [![GitHub stars](https://img.shields.io/github/stars/CERTCC/trommel?style=flat)](https://github.com/CERTCC/trommel/stargazers) - Searches extracted firmware images for interesting files and information.

### Extraction Tools

- [FACT Extractor](https://github.com/fkie-cad/fact_extractor) [![GitHub stars](https://img.shields.io/github/stars/fkie-cad/fact_extractor?style=flat)](https://github.com/fkie-cad/fact_extractor/stargazers) - Detects container format automatically and executes the corresponding extraction tool.
...
- [JTAGenum](https://github.com/cyphunk/JTAGenum) [![GitHub stars](https://img.shields.io/github/stars/cyphunk/JTAGenum?style=flat)](https://github.com/cyphunk/JTAGenum/stargazers) - Add JTAG capabilities to an Arduino.
- [OpenOCD](http://openocd.org/) - Free and Open On-Chip Debugging, In-System Programming and Boundary-Scan Testing.

### Misc Tools

- [Cotopaxi](https://github.com/Samsung/cotopaxi) [![GitHub stars](https://img.shields.io/github/stars/Samsung/cotopaxi?style=flat)](https://github.com/Samsung/cotopaxi/stargazers) - Set of tools for security testing of Internet of Things devices using specific network IoT protocols.
- [dumpflash](https://github.com/ohjeongwook/dumpflash) [![GitHub stars](https://img.shields.io/github/stars/ohjeongwook/dumpflash?style=flat)](https://github.com/ohjeongwook/dumpflash/stargazers) - Low-level NAND Flash dump and parsing utility.
- [flashrom](https://github.com/flashrom/flashrom) [![GitHub stars](https://img.shields.io/github/stars/flashrom/flashrom?style=flat)](https://github.com/flashrom/flashrom/stargazers) - Tool for detecting, reading, writing, verifying and erasing flash chips.
- [Samsung Firmware Magic](https://github.com/chrivers/samsung-firmware-magic) [![GitHub stars](https://img.shields.io/github/stars/chrivers/samsung-firmware-magic?style=flat)](https://github.com/chrivers/samsung-firmware-magic/stargazers) - Decrypt Samsung SSD firmware updates.
...
- [Glasgow](https://github.com/GlasgowEmbedded/Glasgow) [![GitHub stars](https://img.shields.io/github/stars/GlasgowEmbedded/Glasgow?style=flat)](https://github.com/GlasgowEmbedded/Glasgow/stargazers) - Tool for exploring and debugging different digital interfaces.
...
- 2018, Mark Carney: [Pentesting Hardware - A Practical Handbook (DRAFT)](https://github.com/unprovable/PentestHardware) [![GitHub stars](https://img.shields.io/github/stars/unprovable/PentestHardware?style=flat)](https://github.com/unprovable/PentestHardware/stargazers)
...
- [CSAW Embedded Security Challenge 2019](https://github.com/TrustworthyComputing/csaw_esc_2019) [![GitHub stars](https://img.shields.io/github/stars/TrustworthyComputing/csaw_esc_2019?style=flat)](https://github.com/TrustworthyComputing/csaw_esc_2019/stargazers) - CSAW 2019 Embedded Security Challenge (ESC).
- [Embedded Security CTF](https://microcorruption.com) - Microcorruption: Embedded Security CTF.
- [Hardware Hacking 101](https://github.com/rdomanski/hardware_hacking/tree/master/my_talks/Hardware_Hacking_101) [![GitHub stars](https://img.shields.io/github/stars/rdomanski/hardware_hacking/tree/master/my_talks/Hardware_Hacking_101?style=flat)](https://github.com/rdomanski/hardware_hacking/tree/master/my_talks/Hardware_Hacking_101/stargazers) - Workshop @ BSides Munich 2019.
- [IoTGoat](https://github.com/scriptingxss/IoTGoat) [![GitHub stars](https://img.shields.io/github/stars/scriptingxss/IoTGoat?style=flat)](https://github.com/scriptingxss/IoTGoat/stargazers) - IoTGoat is a deliberately insecure firmware based on OpenWrt.
- [Rhme-2015](https://github.com/Riscure/RHme-2015) [![GitHub stars](https://img.shields.io/github/stars/Riscure/RHme-2015?style=flat)](https://github.com/Riscure/RHme-2015/stargazers) - First riscure Hack me hardware CTF challenge.
- [Rhme-2016](https://github.com/Riscure/Rhme-2016) [![GitHub stars](https://img.shields.io/github/stars/Riscure/Rhme-2016?style=flat)](https://github.com/Riscure/Rhme-2016/stargazers) - Riscure Hack me 2 is a low level hardware CTF challenge.
- [Rhme-2017/2018](https://github.com/Riscure/Rhme-2017) [![GitHub stars](https://img.shields.io/github/stars/Riscure/Rhme-2017?style=flat)](https://github.com/Riscure/Rhme-2017/stargazers) - Riscure Hack Me 3 embedded hardware CTF 2017-2018.
