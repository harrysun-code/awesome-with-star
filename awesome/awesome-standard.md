...
> 来源：[standard/awesome-standard](https://github.com/standard/awesome-standard)

[![GitHub stars](https://img.shields.io/github/stars/standard/awesome-standard?style=flat)](https://github.com/standard/awesome-standard/stargazers)
...
Documenting the explosion of packages in the [`standard`](https://github.com/feross/standard) [![GitHub stars](https://img.shields.io/github/stars/feross/standard?style=flat)](https://github.com/feross/standard/stargazers) ecosystem!
...
- **[npm packages that use standard (full list)](https://github.com/feross/standard-packages/blob/master/all.json) [![GitHub stars](https://img.shields.io/github/stars/feross/standard-packages/blob/master/all.json?style=flat)](https://github.com/feross/standard-packages/blob/master/all.json/stargazers)** - List of packages that use `standard`
...
- **[prettier-standard](https://www.npmjs.com/package/prettier-standard)** - format with [prettier](https://github.com/prettier/prettier) [![GitHub stars](https://img.shields.io/github/stars/prettier/prettier?style=flat)](https://github.com/prettier/prettier/stargazers) configured to standard rules
...
- Every major text editor has a plugin or built-in support for `standard`. See the [full list](https://github.com/standard/standard#are-there-text-editor-plugins) [![GitHub stars](https://img.shields.io/github/stars/standard/standard?style=flat)](https://github.com/standard/standard/stargazers) of supported editors.
...
- Brackets: **[brackets-standard](https://github.com/ishamf/brackets-standard/) [![GitHub stars](https://img.shields.io/github/stars/ishamf/brackets-standard/?style=flat)](https://github.com/ishamf/brackets-standard//stargazers)** - linter
- Emacs: see [readme](https://github.com/standard/standard#emacs) [![GitHub stars](https://img.shields.io/github/stars/standard/standard?style=flat)](https://github.com/standard/standard/stargazers)
...
- Vim: see [readme](https://github.com/standard/standard#vim) [![GitHub stars](https://img.shields.io/github/stars/standard/standard?style=flat)](https://github.com/standard/standard/stargazers)
...
- WebStorm (PhpStorm, IntelliJ, RubyMine, JetBrains, etc.): built-in support. see [readme](https://github.com/standard/standard#webstorm-phpstorm-intellij-rubymine-jetbrains-etc) [![GitHub stars](https://img.shields.io/github/stars/standard/standard?style=flat)](https://github.com/standard/standard/stargazers)
...
- **[wemake-frontend-styleguide](https://github.com/wemake-services/wemake-frontend-styleguide) [![GitHub stars](https://img.shields.io/github/stars/wemake-services/wemake-frontend-styleguide?style=flat)](https://github.com/wemake-services/wemake-frontend-styleguide/stargazers)** - JavaScript & TypeScript & Vue & JsDoc & Scss style guides based on standard tools. Very strict!
...
- **[videojs-standard](https://www.npmjs.com/package/videojs-standard)** - fork by the [video.js](https://github.com/videojs/video.js) [![GitHub stars](https://img.shields.io/github/stars/videojs/video.js?style=flat)](https://github.com/videojs/video.js/stargazers) team
