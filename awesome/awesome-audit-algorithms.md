...
- [Remote Explainability faces the bouncer problem](https://rdcu.be/b6qB4) - (Nature Machine Intelligence volume 2, pages529–539)  [(Code)](https://github.com/erwanlemerrer/bouncer_problem) [![GitHub stars](https://img.shields.io/github/stars/erwanlemerrer/bouncer_problem?style=flat)](https://github.com/erwanlemerrer/bouncer_problem/stargazers) *Shows the impossibility (with one request) or the difficulty to spot lies on the explanations of a remote AI decision.*
- [GeoDA: a geometric framework for black-box adversarial attacks](https://openaccess.thecvf.com/content_CVPR_2020/papers/Rahmati_GeoDA_A_Geometric_Framework_for_Black-Box_Adversarial_Attacks_CVPR_2020_paper.pdf) - (CVPR)  [(Code)](https://github.com/thisisalirah/GeoDA) [![GitHub stars](https://img.shields.io/github/stars/thisisalirah/GeoDA?style=flat)](https://github.com/thisisalirah/GeoDA/stargazers) *Crafts adversarial examples to fool models, in a pure blackbox setup (no gradients, inferred class only).*
- [The Imitation Game: Algorithm Selectionby Exploiting Black-Box Recommender](https://github.com/erwanlemerrer/erwanlemerrer.github.io/raw/master/files/imitation_blackbox_recommenders_netys-2020.pdf) [![GitHub stars](https://img.shields.io/github/stars/erwanlemerrer/erwanlemerrer.github.io/raw/master/files/imitation_blackbox_recommenders_netys-2020.pdf?style=flat)](https://github.com/erwanlemerrer/erwanlemerrer.github.io/raw/master/files/imitation_blackbox_recommenders_netys-2020.pdf/stargazers) - (Netys)  [(Code)](https://github.com/gdamaskinos/RecRank) [![GitHub stars](https://img.shields.io/github/stars/gdamaskinos/RecRank?style=flat)](https://github.com/gdamaskinos/RecRank/stargazers) *Parametrize a local recommendation algorithm by imitating the decision of a remote and better trained one.*
...
- [Towards Reverse-Engineering Black-Box Neural Networks](https://arxiv.org/abs/1711.01768) - (ICLR) [(Code)](https://github.com/coallaoh/WhitenBlackBox) [![GitHub stars](https://img.shields.io/github/stars/coallaoh/WhitenBlackBox?style=flat)](https://github.com/coallaoh/WhitenBlackBox/stargazers) *Infer inner hyperparameters (eg number of layers, non-linear activation type) of a remote neural network model by analysing its response patterns to certain inputs.*
...
- [Copycat CNN: Stealing Knowledge by Persuading Confession with Random Non-Labeled Data](https://arxiv.org/abs/1806.05476) - (IJCNN)  [(Code)](https://github.com/jeiks/Stealing_DL_Models) [![GitHub stars](https://img.shields.io/github/stars/jeiks/Stealing_DL_Models?style=flat)](https://github.com/jeiks/Stealing_DL_Models/stargazers) *Stealing black-box models (CNNs) knowledge by querying them with random natural images (ImageNet and Microsoft-COCO).*
...
- [Stealing Machine Learning Models via Prediction APIs](https://www.usenix.org/conference/usenixsecurity16/technical-sessions/presentation/tramer) - (Usenix Security)  [(Code)](https://github.com/ftramer/Steal-ML) [![GitHub stars](https://img.shields.io/github/stars/ftramer/Steal-ML?style=flat)](https://github.com/ftramer/Steal-ML/stargazers) *Aims at extracting machine learning models in use by remote services.*
- [“Why Should I Trust You?”Explaining the Predictions of Any Classifier](https://arxiv.org/pdf/1602.04938v3.pdf) - (arXiv)  [(Code)](https://github.com/marcotcr/lime-experiments) [![GitHub stars](https://img.shields.io/github/stars/marcotcr/lime-experiments?style=flat)](https://github.com/marcotcr/lime-experiments/stargazers) *Explains a blackbox classifier model by sampling around data instances.*
...
### 2014
- [A peek into the black box: exploring classifiers by randomization]() - (Data Mining and Knowledge Discovery journal) ([code](https://github.com/tsabsch/goldeneye) [![GitHub stars](https://img.shields.io/github/stars/tsabsch/goldeneye?style=flat)](https://github.com/tsabsch/goldeneye/stargazers)) *Finds groups of features that can be permuted without changing the output label of predicted samples*
