...
- [Sentinel](https://github.com/sentinel-cli/sentinel) [![GitHub stars](https://img.shields.io/github/stars/sentinel-cli/sentinel?style=flat)](https://github.com/sentinel-cli/sentinel/stargazers) - Local pre-commit secret scanner using an Aho-Corasick automaton.
