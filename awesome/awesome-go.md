...
> 来源：[avelino/awesome-go](https://github.com/avelino/awesome-go)
...
- [agent-sdk-go](https://github.com/agenticenv/agent-sdk-go) [![GitHub stars](https://img.shields.io/github/stars/agenticenv/agent-sdk-go?style=flat)](https://github.com/agenticenv/agent-sdk-go/stargazers) - Framework for building stateful AI agents in Go.
- [agy-mcp](https://github.com/tphakala/agy-mcp) [![GitHub stars](https://img.shields.io/github/stars/tphakala/agy-mcp?style=flat)](https://github.com/tphakala/agy-mcp/stargazers) - Model Context Protocol (MCP) server wrapping the Antigravity CLI to run prompts and peer reviews.
...
- [ai-gateway](https://github.com/ferro-labs/ai-gateway) [![GitHub stars](https://img.shields.io/github/stars/ferro-labs/ai-gateway?style=flat)](https://github.com/ferro-labs/ai-gateway/stargazers) - OpenAI-compatible LLM gateway that routes requests across 30 providers with fallback, rate limiting, budgets, guardrails, and observability.
...
- [crewai-go](https://github.com/rhgs/crewai-go) [![GitHub stars](https://img.shields.io/github/stars/rhgs/crewai-go?style=flat)](https://github.com/rhgs/crewai-go/stargazers) - Idiomatic Go port of CrewAI (multi-agent orchestration). Zero dependencies, stdlib only.
...
- [GoModel](https://github.com/ENTERPILOT/GoModel) [![GitHub stars](https://img.shields.io/github/stars/ENTERPILOT/GoModel?style=flat)](https://github.com/ENTERPILOT/GoModel/stargazers) - AI gateway exposing a unified OpenAI-compatible API across OpenAI, Anthropic, Gemini, Groq, xAI, Ollama and other providers, with routing, usage tracking, rate limits, and guardrails.
...
- [jargo](https://github.com/gojargo/jargo) [![GitHub stars](https://img.shields.io/github/stars/gojargo/jargo?style=flat)](https://github.com/gojargo/jargo/stargazers) - Framework for building real-time voice AI agents over WebRTC, wiring speech-to-text, LLMs, and text-to-speech into a streaming pipeline.
- [keen-code](https://github.com/mochow13/keen-code) [![GitHub stars](https://img.shields.io/github/stars/mochow13/keen-code?style=flat)](https://github.com/mochow13/keen-code/stargazers) - A context-efficient terminal-based AI coding agent. Provider agnostic, supports MCPs, Agent Skills, Subagents, and more. Comes with a simple and straightforward TUI.
...
- [llm-box](https://github.com/alib8b8/llm-box) [![GitHub stars](https://img.shields.io/github/stars/alib8b8/llm-box?style=flat)](https://github.com/alib8b8/llm-box/stargazers) - Terminal-based AI workflow engine with YAML-driven pipelines, 20+ LLM providers (DeepSeek, Qwen, GLM, Mistral, etc.), and a TUI for workflow management.
...
- [semantic-search](https://github.com/DavidBelicza/semantic-search) [![GitHub stars](https://img.shields.io/github/stars/DavidBelicza/semantic-search?style=flat)](https://github.com/DavidBelicza/semantic-search/stargazers) - Meaning-based search over PDF, Markdown, DOCX, source code, and other file types, using generative AI embedding models to vectorize files into a vector database.
- [skillreaper](https://github.com/thousandflowers/skillreaper) [![GitHub stars](https://img.shields.io/github/stars/thousandflowers/skillreaper?style=flat)](https://github.com/thousandflowers/skillreaper/stargazers) - CLI that scans AI agent session transcripts to identify and safely quarantine unused skills, MCP servers, and agents across Claude Code, Codex CLI, Hermes, OpenCode, Cursor, and OpenClaw.
- [Smeldr](https://github.com/Smeldr/core) [![GitHub stars](https://img.shields.io/github/stars/Smeldr/core?style=flat)](https://github.com/Smeldr/core/stargazers) - AI-native content backend with typed lifecycle management, native MCP tools for every content type, and zero runtime dependencies.
- [snip](https://github.com/edouard-claude/snip) [![GitHub stars](https://img.shields.io/github/stars/edouard-claude/snip?style=flat)](https://github.com/edouard-claude/snip/stargazers) - CLI proxy that reduces LLM token usage by 60-90% with declarative YAML filters. Drop-in for Claude Code, Cursor, Copilot, and Gemini. rtk alternative in Go.
...
- [go-aac](https://github.com/tphakala/go-aac) [![GitHub stars](https://img.shields.io/github/stars/tphakala/go-aac?style=flat)](https://github.com/tphakala/go-aac/stargazers) - Pure-Go AAC-LC encoder and decoder ported from FFmpeg.
- [go-audio-resampler](https://github.com/tphakala/go-audio-resampler) [![GitHub stars](https://img.shields.io/github/stars/tphakala/go-audio-resampler?style=flat)](https://github.com/tphakala/go-audio-resampler/stargazers) - Pure-Go, high-quality audio resampler with SIMD acceleration.
- [go-flac](https://github.com/tphakala/go-flac) [![GitHub stars](https://img.shields.io/github/stars/tphakala/go-flac?style=flat)](https://github.com/tphakala/go-flac/stargazers) - Native Go FLAC encoder and decoder with SIMD acceleration.
...
- [go-opus](https://github.com/tphakala/go-opus) [![GitHub stars](https://img.shields.io/github/stars/tphakala/go-opus?style=flat)](https://github.com/tphakala/go-opus/stargazers) - Native Go implementation of the Opus audio codec (RFC 6716) with RFC-compliant decoder.
- [go-resample](https://github.com/gojargo/go-resample) [![GitHub stars](https://img.shields.io/github/stars/gojargo/go-resample?style=flat)](https://github.com/gojargo/go-resample/stargazers) - Pure-Go (no cgo) audio sample-rate converter with sinc, linear, and zero-order-hold converters.
- [go-wav](https://github.com/tphakala/go-wav) [![GitHub stars](https://img.shields.io/github/stars/tphakala/go-wav?style=flat)](https://github.com/tphakala/go-wav/stargazers) - Pure-Go WAV/RIFF reader and writer with RF64 and BW64 support for files larger than 4 GiB.
...
- [melange](https://github.com/pthm/melange) [![GitHub stars](https://img.shields.io/github/stars/pthm/melange?style=flat)](https://github.com/pthm/melange/stargazers) - Compiles OpenFGA authorization schemas into PL/pgSQL functions that run fine-grained relationship-based access control checks inside PostgreSQL.
...
- [pactus](https://github.com/pactus-project/pactus) [![GitHub stars](https://img.shields.io/github/stars/pactus-project/pactus?style=flat)](https://github.com/pactus-project/pactus/stargazers) - A full-node implementation of the Pactus blockchain in Go.
...
- [teleflow](https://github.com/kslamph/teleflow) [![GitHub stars](https://img.shields.io/github/stars/kslamph/teleflow?style=flat)](https://github.com/kslamph/teleflow/stargazers) - Simple, type-safe Telegram bot framework with fluent flows and automatic state management.
...
- [lazyteams](https://github.com/agmonetti/lazyteams) [![GitHub stars](https://img.shields.io/github/stars/agmonetti/lazyteams?style=flat)](https://github.com/agmonetti/lazyteams/stargazers) - Keyboard-driven terminal user interface for Microsoft Teams.
...
- [go-arch](https://github.com/SalvucciFacundo/go-arch) [![GitHub stars](https://img.shields.io/github/stars/SalvucciFacundo/go-arch?style=flat)](https://github.com/SalvucciFacundo/go-arch/stargazers) - CLI tool for scaffolding Go applications with Minimalist, Standard, and Hexagonal architecture patterns.
...
- [OpenCLI](https://github.com/bcdxn/opencli) [![GitHub stars](https://img.shields.io/github/stars/bcdxn/opencli?style=flat)](https://github.com/bcdxn/opencli/stargazers) - OpenAPI-style specification for CLIs; define your interface in a language-agnostic document to generate documentation and framework boilerplate code.
...
- [goenv](https://github.com/psyb0t/goenv) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/goenv?style=flat)](https://github.com/psyb0t/goenv/stargazers) - Reads the ENV environment variable and reports whether the process is running in production or development.
...
- [gonfiguration](https://github.com/psyb0t/gonfiguration) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/gonfiguration?style=flat)](https://github.com/psyb0t/gonfiguration/stargazers) - Loads configuration from environment variables into structs via reflection, with struct-tag defaults and required fields.
...
- [muffet](https://github.com/raviqqe/muffet) [![GitHub stars](https://img.shields.io/github/stars/raviqqe/muffet?style=flat)](https://github.com/raviqqe/muffet/stargazers) - Fast website link checker in Go, see [alternatives](https://github.com/lycheeverse/lychee#features) [![GitHub stars](https://img.shields.io/github/stars/lycheeverse/lychee?style=flat)](https://github.com/lycheeverse/lychee/stargazers).
...
- [genericsyncmap](https://github.com/donomii/genericsyncmap) [![GitHub stars](https://img.shields.io/github/stars/donomii/genericsyncmap?style=flat)](https://github.com/donomii/genericsyncmap/stargazers) - Type-safe generic wrapper for `sync.Map` with full method parity and zero dependencies.
...
- [skiplist](https://github.com/huandu/skiplist) [![GitHub stars](https://img.shields.io/github/stars/huandu/skiplist?style=flat)](https://github.com/huandu/skiplist/stargazers) - Fast and easy-to-use skip list for Go.
...
- [easycache](https://github.com/hugocarreira/easycache) [![GitHub stars](https://img.shields.io/github/stars/hugocarreira/easycache?style=flat)](https://github.com/hugocarreira/easycache/stargazers) - A simple way to use in-memory cache in Golang (TTL/FIFO/LRU/LFU).
...
- [gedb](https://github.com/vinicius-lino-figueiredo/gedb) [![GitHub stars](https://img.shields.io/github/stars/vinicius-lino-figueiredo/gedb?style=flat)](https://github.com/vinicius-lino-figueiredo/gedb/stargazers) - MongoDB-like embedded database, written in pure-go. Supports indexing and complex queries.
...
- [MemHop](https://github.com/qyiun666/MemHop) [![GitHub stars](https://img.shields.io/github/stars/qyiun666/MemHop?style=flat)](https://github.com/qyiun666/MemHop/stargazers) - Embedded cognitive memory database for AI agents. Six-layer architecture (L0-L5), Dream consolidation pipeline, three-channel RRF retrieval (BM25 + f16 vector + entity), single .meh file, pure Go, zero infrastructure.
...
- [db-migrator.go](https://github.com/raoptimus/db-migrator.go) [![GitHub stars](https://img.shields.io/github/stars/raoptimus/db-migrator.go?style=flat)](https://github.com/raoptimus/db-migrator.go/stargazers) - CLI for versioned database schema migrations with support for PostgreSQL, MySQL, ClickHouse, Tarantool, and Apache Iceberg.
...
- [clickhouse-sql-parser](https://github.com/AfterShip/clickhouse-sql-parser) [![GitHub stars](https://img.shields.io/github/stars/AfterShip/clickhouse-sql-parser?style=flat)](https://github.com/AfterShip/clickhouse-sql-parser/stargazers) - Parser for ClickHouse-dialect SQL that produces a typed AST, with traversal helpers, round-trip formatting, and a CLI.
...
- [filesql](https://github.com/nao1215/filesql) [![GitHub stars](https://img.shields.io/github/stars/nao1215/filesql?style=flat)](https://github.com/nao1215/filesql/stargazers) - Query CSV, TSV, LTSV, JSON, JSONL, Parquet, Excel, ACH, and Fedwire files with SQL through the database/sql API, backed by in-memory SQLite.
...
- [sqly](https://github.com/nao1215/sqly) [![GitHub stars](https://img.shields.io/github/stars/nao1215/sqly?style=flat)](https://github.com/nao1215/sqly/stargazers) - Execute SQL against CSV, TSV, LTSV, JSON, Parquet, and Excel files in an interactive shell, backed by in-memory SQLite.
...
- [xsql](https://github.com/zx06/xsql) [![GitHub stars](https://img.shields.io/github/stars/zx06/xsql?style=flat)](https://github.com/zx06/xsql/stargazers) - AI-first cross-database CLI tool with read-only protection and structured JSON output.
...
- [go-mssqldb](https://github.com/microsoft/go-mssqldb) [![GitHub stars](https://img.shields.io/github/stars/microsoft/go-mssqldb?style=flat)](https://github.com/microsoft/go-mssqldb/stargazers) - Microsoft's official Go driver for SQL Server, Azure SQL, Azure Synapse, SQL database in Fabric, and Fabric Data Warehouse. Supports Azure AD, Always Encrypted, bulk operations.
...
- [servicepack](https://github.com/psyb0t/servicepack) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/servicepack?style=flat)](https://github.com/psyb0t/servicepack/stargazers) - Framework for running multiple services concurrently in a single binary, locally or distributed across machines.
...
- [go-spamcheck](https://github.com/psyb0t/go-spamcheck) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/go-spamcheck?style=flat)](https://github.com/psyb0t/go-spamcheck/stargazers) - Client for Postmark's SpamCheck API that scores a raw email against SpamAssassin rules.
...
- [ctxerrors](https://github.com/psyb0t/ctxerrors) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/ctxerrors?style=flat)](https://github.com/psyb0t/ctxerrors/stargazers) - Wrap errors with the file, line, and function name of each call site.
...
- [gopdfrab](https://github.com/voidrab/gopdfrab) [![GitHub stars](https://img.shields.io/github/stars/voidrab/gopdfrab?style=flat)](https://github.com/voidrab/gopdfrab/stargazers) - PDF/A processing for Go.
...
- [bingx-go](https://github.com/tigusigalpa/bingx-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/bingx-go?style=flat)](https://github.com/tigusigalpa/bingx-go/stargazers) - Go client for BingX API v3 with 260+ methods, USDT-M/Coin-M futures, spot, TradFi, WebSocket streams, and copy trading.
- [bitget-go](https://github.com/tigusigalpa/bitget-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/bitget-go?style=flat)](https://github.com/tigusigalpa/bitget-go/stargazers) - Go client for Bitget UTA API v3 with typed models, string-based prices, auto-reconnecting WebSocket, and demo trading.
- [bybit-go](https://github.com/tigusigalpa/bybit-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/bybit-go?style=flat)](https://github.com/tigusigalpa/bybit-go/stargazers) - Go client for Bybit V5 API with HMAC/RSA authentication, WebSocket streams, demo trading, and TradFi instruments.
- [cnn-fear-and-greed-parse](https://github.com/wildsurfer/cnn-fear-and-greed-parse) [![GitHub stars](https://img.shields.io/github/stars/wildsurfer/cnn-fear-and-greed-parse?style=flat)](https://github.com/wildsurfer/cnn-fear-and-greed-parse/stargazers) - Client for CNN's Fear & Greed Index with the seven component indicators and about a year of daily history.
...
- [decimal](https://github.com/klokare/decimal) [![GitHub stars](https://img.shields.io/github/stars/klokare/decimal?style=flat)](https://github.com/klokare/decimal/stargazers) - A fixed-size, no allocation decimal type for when you don't need arbitrary precision.
- [eu-vat-rates-data-go](https://github.com/vatnode/eu-vat-rates-data-go) [![GitHub stars](https://img.shields.io/github/stars/vatnode/eu-vat-rates-data-go?style=flat)](https://github.com/vatnode/eu-vat-rates-data-go/stargazers) - VAT rates and VAT number formats for 45 European countries, embedded at compile time and refreshed daily from the European Commission TEDB.
...
- [glassnode-go](https://github.com/tigusigalpa/glassnode-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/glassnode-go?style=flat)](https://github.com/tigusigalpa/glassnode-go/stargazers) - Go client for Glassnode Basic API with 25 metric categories, typed structs, bulk endpoints, Point-in-Time data, and zero dependencies.
...
- [kucoin-go](https://github.com/tigusigalpa/kucoin-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/kucoin-go?style=flat)](https://github.com/tigusigalpa/kucoin-go/stargazers) - Go client for KuCoin UTA and Classic REST & WebSocket APIs with HMAC-SHA256 auth, string-typed prices, and typed error hierarchy.
...
- [okx-go](https://github.com/tigusigalpa/okx-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/okx-go?style=flat)](https://github.com/tigusigalpa/okx-go/stargazers) - Go client for OKX v5 API with 335 REST endpoints, 53 WebSocket channels, generics support and auto-reconnect.
...
- [orderbook](https://github.com/intrepidkarthi/orderbook) [![GitHub stars](https://img.shields.io/github/stars/intrepidkarthi/orderbook?style=flat)](https://github.com/intrepidkarthi/orderbook/stargazers) - Embeddable limit order book and matching engine with integer-exact pricing, a single-writer core, and write-ahead-log crash recovery.
...
- [telegram-wallet-go](https://github.com/tigusigalpa/telegram-wallet-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/telegram-wallet-go?style=flat)](https://github.com/tigusigalpa/telegram-wallet-go/stargazers) - Go client for Telegram Wallet Pay API with HMAC-SHA256 webhook verification, middleware for net/http, Gin, and Echo.
...
- [sceneCamera](https://github.com/donomii/sceneCamera) [![GitHub stars](https://img.shields.io/github/stars/donomii/sceneCamera?style=flat)](https://github.com/donomii/sceneCamera/stargazers) - Camera movement and view/projection matrices for museum, FPS, RTS, and stereo rendering modes.
...
- [apispec](https://github.com/ehabterra/apispec) [![GitHub stars](https://img.shields.io/github/stars/ehabterra/apispec?style=flat)](https://github.com/ehabterra/apispec/stargazers) - Generate OpenAPI 3.1 specs from Go code without annotations, plus a browser UI to configure, preview, and explore the call graph.
...
- [powerlock](https://github.com/donomii/powerlock) [![GitHub stars](https://img.shields.io/github/stars/donomii/powerlock?style=flat)](https://github.com/donomii/powerlock/stargazers) - Named FIFO mutexes with context cancellation, bounded wait queues, watchdog diagnostics, pprof profiles, and Prometheus metrics.
...
- [eagle-image-api](https://github.com/nicobistolfi/eagle-image-api) [![GitHub stars](https://img.shields.io/github/stars/nicobistolfi/eagle-image-api?style=flat)](https://github.com/nicobistolfi/eagle-image-api/stargazers) - Image optimization and transformation API using libvips, deployable to AWS Lambda and CloudFront.
...
- [silentjson](https://github.com/GenshIv/silentjson) [![GitHub stars](https://img.shields.io/github/stars/GenshIv/silentjson?style=flat)](https://github.com/GenshIv/silentjson/stargazers) - Zero-allocation JSON boundary scanner and splitter utilizing AVX2 SIMD instructions.
...
- [go-log4g](https://github.com/go-log4g/core) [![GitHub stars](https://img.shields.io/github/stars/go-log4g/core?style=flat)](https://github.com/go-log4g/core/stargazers) - Log4g provides Log4j-style configuration and pattern layouts for Go's standard log/slog logging facade.
...
- [slog-configurator](https://github.com/psyb0t/slog-configurator) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/slog-configurator?style=flat)](https://github.com/psyb0t/slog-configurator/stargazers) - Configures the standard library log/slog logger from environment variables: level, format, source location, and stdout/stderr split.
- [slog-datadog](https://github.com/samber/slog-datadog) [![GitHub stars](https://img.shields.io/github/stars/samber/slog-datadog?style=flat)](https://github.com/samber/slog-datadog/stargazers) - A slog handler for Datadog.
...
- [slog-logrus](https://github.com/samber/slog-logrus) [![GitHub stars](https://img.shields.io/github/stars/samber/slog-logrus?style=flat)](https://github.com/samber/slog-logrus/stargazers) - A slog handler for Logrus.
- [slog-loki](https://github.com/samber/slog-loki) [![GitHub stars](https://img.shields.io/github/stars/samber/slog-loki?style=flat)](https://github.com/samber/slog-loki/stargazers) - A slog handler for Grafana Loki.
...
- [slog-sentry](https://github.com/samber/slog-sentry) [![GitHub stars](https://img.shields.io/github/stars/samber/slog-sentry?style=flat)](https://github.com/samber/slog-sentry/stargazers) - A slog handler for Sentry.
- [slog-slack](https://github.com/samber/slog-slack) [![GitHub stars](https://img.shields.io/github/stars/samber/slog-slack?style=flat)](https://github.com/samber/slog-slack/stargazers) - A slog handler for Slack.
- [slog-zap](https://github.com/samber/slog-zap) [![GitHub stars](https://img.shields.io/github/stars/samber/slog-zap?style=flat)](https://github.com/samber/slog-zap/stargazers) - A slog handler for Zap.
- [slog-zerolog](https://github.com/samber/slog-zerolog) [![GitHub stars](https://img.shields.io/github/stars/samber/slog-zerolog?style=flat)](https://github.com/samber/slog-zerolog/stargazers) - A slog handler for Zerolog.
...
- [ardanlabs/service](https://github.com/ardanlabs/service) [![GitHub stars](https://img.shields.io/github/stars/ardanlabs/service?style=flat)](https://github.com/ardanlabs/service/stargazers) - A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications.
...
- [go-ddd](https://github.com/sklinkert/go-ddd) [![GitHub stars](https://img.shields.io/github/stars/sklinkert/go-ddd?style=flat)](https://github.com/sklinkert/go-ddd/stargazers) - Domain-Driven Design template with CQRS, value objects, idempotent commands, and a transactional outbox.
- [go-grpc-bazel-example](https://github.com/esurdam/go-grpc-bazel-example) [![GitHub stars](https://img.shields.io/github/stars/esurdam/go-grpc-bazel-example?style=flat)](https://github.com/esurdam/go-grpc-bazel-example/stargazers) - Example monorepo for Go gRPC microservices with Bazel, grpc-gateway, OpenAPI, and Kubernetes.
...
- [chicha-ip-proxy](https://github.com/matveynator/chicha-ip-proxy) [![GitHub stars](https://img.shields.io/github/stars/matveynator/chicha-ip-proxy?style=flat)](https://github.com/matveynator/chicha-ip-proxy/stargazers) - Zero-configuration TCP/UDP port proxy with autostart, IP-based access control, and OS-level network stack tuning.
...
- [netchan](https://github.com/matveynator/netchan) [![GitHub stars](https://img.shields.io/github/stars/matveynator/netchan?style=flat)](https://github.com/matveynator/netchan/stargazers) - Network Channels (netchan) for Golang: Secure, cluster-ready, supports nested channels & any data type. Inspired by Rob Pike.
- [nethawk](https://github.com/Flowtriq/nethawk) [![GitHub stars](https://img.shields.io/github/stars/Flowtriq/nethawk?style=flat)](https://github.com/Flowtriq/nethawk/stargazers) - Terminal UI for real-time network traffic capture, analysis, and attack detection with JSON output mode.
...
- [proxq](https://github.com/psyb0t/docker-proxq) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/docker-proxq?style=flat)](https://github.com/psyb0t/docker-proxq/stargazers) - Asynchronous reverse proxy that queues each request in Redis and returns a job ID to poll for the response, with path-prefix routing, retries, and caching.
...
- [roamr](https://github.com/sourabh-khot65/roamr) [![GitHub stars](https://img.shields.io/github/stars/sourabh-khot65/roamr?style=flat)](https://github.com/sourabh-khot65/roamr/stargazers) - CLI that scores nearby saved WiFi networks and tells you which to use, and why.
...
- [ws-reconnect](https://github.com/sing198/ws-reconnect) [![GitHub stars](https://img.shields.io/github/stars/sing198/ws-reconnect?style=flat)](https://github.com/sing198/ws-reconnect/stargazers) - Resilient WebSocket client with automatic reconnection, exponential backoff, and heartbeat management.
...
- [httpretry](https://github.com/ybbus/httpretry) [![GitHub stars](https://img.shields.io/github/stars/ybbus/httpretry?style=flat)](https://github.com/ybbus/httpretry/stargazers) - Enriches the default go HTTP client with retry functionality.
 - [impersonate-http](https://github.com/North-web-dev/impersonate-http) [![GitHub stars](https://img.shields.io/github/stars/North-web-dev/impersonate-http?style=flat)](https://github.com/North-web-dev/impersonate-http/stargazers) - Drop-in net/http.Client with a byte-exact browser TLS (JA3/JA4) and HTTP/2 (Akamai) fingerprint.
...
- [GoooQo](https://github.com/doytowin/goooqo) [![GitHub stars](https://img.shields.io/github/stars/doytowin/goooqo?style=flat)](https://github.com/doytowin/goooqo/stargazers) - A database access framework based on declarative query model.
...
- [simd](https://github.com/tphakala/simd) [![GitHub stars](https://img.shields.io/github/stars/tphakala/simd?style=flat)](https://github.com/tphakala/simd/stargazers) - Native Go vector and SIMD operations on slices with multi-architecture assembly acceleration.
...
- [acme-proxy](https://github.com/esnet/acme-proxy) [![GitHub stars](https://img.shields.io/github/stars/esnet/acme-proxy?style=flat)](https://github.com/esnet/acme-proxy/stargazers) - Solve ACME http-01 challenge without opening port 80 to the internet, obtain certs from an external certificate authority.
...
- [caddy-waf](https://github.com/fabriziosalmi/caddy-waf) [![GitHub stars](https://img.shields.io/github/stars/fabriziosalmi/caddy-waf?style=flat)](https://github.com/fabriziosalmi/caddy-waf/stargazers) - Web Application Firewall middleware for the Caddy server, with a regex rule engine, anomaly scoring, IP/DNS/ASN/country blacklists and rate limiting.
...
- [Crenox](https://github.com/crenoxhq/crenox) [![GitHub stars](https://img.shields.io/github/stars/crenoxhq/crenox?style=flat)](https://github.com/crenoxhq/crenox/stargazers) - Zero-dependency pre-commit secret scanner using Aho-Corasick for high-performance credentials leak detection.
- [deidentify](https://github.com/aliengiraffe/deidentify) [![GitHub stars](https://img.shields.io/github/stars/aliengiraffe/deidentify?style=flat)](https://github.com/aliengiraffe/deidentify/stargazers) - Deterministic, format-preserving removal of personally identifiable information from text and structured data.
...
- [mcprobe](https://github.com/tamish560/mcprobe) [![GitHub stars](https://img.shields.io/github/stars/tamish560/mcprobe?style=flat)](https://github.com/tamish560/mcprobe/stargazers) - Security scanner for MCP servers with prompt injection detection, tool shadowing, and SARIF output.
...
- [secretgenerator](https://github.com/rafaelperoco/secretgenerator) [![GitHub stars](https://img.shields.io/github/stars/rafaelperoco/secretgenerator?style=flat)](https://github.com/rafaelperoco/secretgenerator/stargazers) - CSPRNG-backed credential generator with a versioned JSON schema for passwords, passphrases, secrets, API keys, and PINs.
...
- [Casdoor](https://github.com/casdoor/casdoor) [![GitHub stars](https://img.shields.io/github/stars/casdoor/casdoor?style=flat)](https://github.com/casdoor/casdoor/stargazers) - Identity and access management (IAM) and single sign-on (SSO) server with a web UI, supporting OAuth 2.0, OIDC, SAML, CAS and LDAP.
...
- [flue](https://github.com/karnstack/flue) [![GitHub stars](https://img.shields.io/github/stars/karnstack/flue?style=flat)](https://github.com/karnstack/flue/stargazers) - Self-hosted daemon that serves terminal sessions to a browser tab. Sessions keep running after the tab is closed.
...
- [relay](https://github.com/valtors/relay) [![GitHub stars](https://img.shields.io/github/stars/valtors/relay?style=flat)](https://github.com/valtors/relay/stargazers) - MCP server with 40+ tools for AI agents. File operations, web search, screenshots, multi-agent coordination. Single Go binary.
...
- [whois](https://github.com/KincaidYang/whois) [![GitHub stars](https://img.shields.io/github/stars/KincaidYang/whois?style=flat)](https://github.com/KincaidYang/whois/stargazers) - Self-hosted WHOIS/RDAP query service and MCP server for domains, IPv4/IPv6 addresses, CIDRs and ASNs.
...
- [fabricator](https://github.com/Goldziher/fabricator) [![GitHub stars](https://img.shields.io/github/stars/Goldziher/fabricator?style=flat)](https://github.com/Goldziher/fabricator/stargazers) - Type-safe factories for generating mock and fake data in Go, inspired by factory_boy and interface-forge.
...
- [wsmock](https://github.com/sing198/wsmock) [![GitHub stars](https://img.shields.io/github/stars/sing198/wsmock?style=flat)](https://github.com/sing198/wsmock/stargazers) - Expressive, zero-boilerplate WebSocket mock server for testing with fault injection and assertions.
...
- [markdown](https://github.com/nao1215/markdown) [![GitHub stars](https://img.shields.io/github/stars/nao1215/markdown?style=flat)](https://github.com/nao1215/markdown/stargazers) - Markdown builder that generates GitHub Flavored Markdown and mermaid diagrams through method chaining.
...
- [doc-scraper](https://github.com/Sriram-PR/doc-scraper) [![GitHub stars](https://img.shields.io/github/stars/Sriram-PR/doc-scraper?style=flat)](https://github.com/Sriram-PR/doc-scraper/stargazers) - Web crawler that converts documentation sites to clean Markdown and JSONL for LLM ingestion (RAG, training data).
...
- [birdeye-go](https://github.com/tigusigalpa/birdeye-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/birdeye-go?style=flat)](https://github.com/tigusigalpa/birdeye-go/stargazers) - Go client for Birdeye DeFi API with typed spot prices, OHLCV candles, historical data, and raw request escape hatch.
...
- [coinglass-go](https://github.com/tigusigalpa/coinglass-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/coinglass-go?style=flat)](https://github.com/tigusigalpa/coinglass-go/stargazers) - Go client for Coinglass API v4 with zero dependencies, WebSocket streams, and typed endpoints for futures, spot, options, ETF, and indicators.
...
- [httpsms-go](https://github.com/NdoleStudio/httpsms-go) [![GitHub stars](https://img.shields.io/github/stars/NdoleStudio/httpsms-go?style=flat)](https://github.com/NdoleStudio/httpsms-go/stargazers) - Go client for the httpSMS API.
...
- [lemonsqueezy-go](https://github.com/NdoleStudio/lemonsqueezy-go) [![GitHub stars](https://img.shields.io/github/stars/NdoleStudio/lemonsqueezy-go?style=flat)](https://github.com/NdoleStudio/lemonsqueezy-go/stargazers) - Go client for the Lemon Squeezy API.
...
- [manus-ai-go](https://github.com/tigusigalpa/manus-ai-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/manus-ai-go?style=flat)](https://github.com/tigusigalpa/manus-ai-go/stargazers) - Go client for Manus AI API v2 with task automation, file management, webhooks, and type-safe models.
...
- [nansen-go](https://github.com/tigusigalpa/nansen-go) [![GitHub stars](https://img.shields.io/github/stars/tigusigalpa/nansen-go?style=flat)](https://github.com/tigusigalpa/nansen-go/stargazers) - Go client for Nansen AI API with Smart Money analytics, token screener, profiler, and zero dependencies.
...
- [sonarqube-client-go](https://github.com/BoxBoxJason/sonarqube-client-go) [![GitHub stars](https://img.shields.io/github/stars/BoxBoxJason/sonarqube-client-go?style=flat)](https://github.com/BoxBoxJason/sonarqube-client-go/stargazers) - Go client library and command-line client for the SonarQube Web API.
...
- [go-utils](https://github.com/Goldziher/go-utils) [![GitHub stars](https://img.shields.io/github/stars/Goldziher/go-utils?style=flat)](https://github.com/Goldziher/go-utils/stargazers) - Simple, performant generic utilities for Go inspired by JavaScript and Python (map, filter, reduce, and more).
...
- [LAN Orangutan](https://github.com/291-Group/LAN-Orangutan) [![GitHub stars](https://img.shields.io/github/stars/291-Group/LAN-Orangutan?style=flat)](https://github.com/291-Group/LAN-Orangutan/stargazers) - Network device discovery and inventory with persistent labeling, multi-network scanning, and Tailscale integration.
...
- [checker](https://github.com/cinar/checker) [![GitHub stars](https://img.shields.io/github/stars/cinar/checker?style=flat)](https://github.com/cinar/checker/stargazers) - Zero-dependency input validation and in-place normalization with struct tags, 23 locales, and JSON Schema generation.
...
* [mosaic](https://github.com/farshidrezaei/mosaic) [![GitHub stars](https://img.shields.io/github/stars/farshidrezaei/mosaic?style=flat)](https://github.com/farshidrezaei/mosaic/stargazers) - Predictable, production-ready Adaptive Bitrate (ABR) video packaging for Go (HLS & DASH CMAF).
...
- [mpeg-ts-analyzer](https://github.com/small-teton/mpeg-ts-analyzer) [![GitHub stars](https://img.shields.io/github/stars/small-teton/mpeg-ts-analyzer?style=flat)](https://github.com/small-teton/mpeg-ts-analyzer/stargazers) - Analyzer for MPEG-2 Transport Streams that checks PCR timing compliance and dumps low-level TS, PSI, and PES structures.
...
- [aichteeteapee](https://github.com/psyb0t/aichteeteapee) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/aichteeteapee?style=flat)](https://github.com/psyb0t/aichteeteapee/stargazers) - Batteries-included HTTP server library with a router, middleware stack, WebSocket hubs, file uploads, and OpenAPI validation.
- [Andurel](https://github.com/mbvlabs/andurel) [![GitHub stars](https://img.shields.io/github/stars/mbvlabs/andurel?style=flat)](https://github.com/mbvlabs/andurel/stargazers) - Rails-inspired full-stack Go web framework with scaffolding, database tooling, and server-rendered or Inertia frontends.
...
- [Goshtoso](https://github.com/araihu/goshtoso) [![GitHub stars](https://img.shields.io/github/stars/araihu/goshtoso?style=flat)](https://github.com/araihu/goshtoso/stargazers) - Server-rendered UI components for Go applications, built with templ, Tailwind CSS, HTMX, and Alpine.js.
...
- [ast-metrics](https://github.com/ast-metrics/ast-metrics) [![GitHub stars](https://img.shields.io/github/stars/ast-metrics/ast-metrics?style=flat)](https://github.com/ast-metrics/ast-metrics/stargazers) - Static code analyzer for Go and other languages: complexity, coupling, cohesion and maintainability metrics, with HTML, JSON, Markdown and SARIF reports.
...
- [deadmono](https://github.com/arxeiss/deadmono) [![GitHub stars](https://img.shields.io/github/stars/arxeiss/deadmono?style=flat)](https://github.com/arxeiss/deadmono/stargazers) - Wrapper around deadcode for detection of dead code in Go monorepo.
...
- [oapixconstgen](https://github.com/psyb0t/oapixconstgen) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/oapixconstgen?style=flat)](https://github.com/psyb0t/oapixconstgen/stargazers) - Generate typed Go constants from an OpenAPI spec's x-constants extension.
...
- [gofindimpl](https://github.com/psyb0t/gofindimpl) [![GitHub stars](https://img.shields.io/github/stars/psyb0t/gofindimpl?style=flat)](https://github.com/psyb0t/gofindimpl/stargazers) - Find all structs that implement a given Go interface across a codebase.
...
- [docklite](https://github.com/benzjeremy/docklite) [![GitHub stars](https://img.shields.io/github/stars/benzjeremy/docklite?style=flat)](https://github.com/benzjeremy/docklite/stargazers) - Lightweight Portainer alternative for Docker container management with real-time SSE metrics.
...
- [gitl](https://github.com/akomyagin/gitl) [![GitHub stars](https://img.shields.io/github/stars/akomyagin/gitl?style=flat)](https://github.com/akomyagin/gitl/stargazers) - AI review of git commit ranges with risk scoring (low/medium/high), changelog generation, and multi-repo activity digest. GitHub Action included.
...
- [mq-studio](https://github.com/amigoer/mq-studio) [![GitHub stars](https://img.shields.io/github/stars/amigoer/mq-studio?style=flat)](https://github.com/amigoer/mq-studio/stargazers) - Cross-platform desktop client for managing and monitoring RocketMQ, RabbitMQ, Kafka, Pulsar, Redis Stream, MQTT, NATS, and ActiveMQ clusters.
...
- [Chapar](https://github.com/chapar-rest/chapar) [![GitHub stars](https://img.shields.io/github/stars/chapar-rest/chapar?style=flat)](https://github.com/chapar-rest/chapar/stargazers) - Chapar is a cross-platform Postman alternative built with go, aims to help developers to test their api endpoints. it support http and grpc protocols.
...
- [chicha-isotope-map](https://github.com/matveynator/chicha-isotope-map) [![GitHub stars](https://img.shields.io/github/stars/matveynator/chicha-isotope-map?style=flat)](https://github.com/matveynator/chicha-isotope-map/stargazers) - Self-hosted public radiation map for importing, analyzing, and visualizing measurement tracks.
...
- [dispositio](https://github.com/tsraveling/dispositio) [![GitHub stars](https://img.shields.io/github/stars/tsraveling/dispositio?style=flat)](https://github.com/tsraveling/dispositio/stargazers) - Terminal tool for planning large projects in simple markdown.
...
- [GURL](https://github.com/matveynator/gurl) [![GitHub stars](https://img.shields.io/github/stars/matveynator/gurl?style=flat)](https://github.com/matveynator/gurl/stargazers) - When CURL says your SSL library is too old — use GURL. One file. Zero SSL dependencies.
...
- [KeibiDrop](https://github.com/KeibiSoft/KeibiDrop) [![GitHub stars](https://img.shields.io/github/stars/KeibiSoft/KeibiDrop?style=flat)](https://github.com/KeibiSoft/KeibiDrop/stargazers) - On-demand peer-to-peer filesystem that mounts a remote folder and hides link latency with read-ahead, end-to-end encrypted with hybrid X25519 and ML-KEM-1024.
...
- [LightCMS](https://github.com/jonradoff/lightcms) [![GitHub stars](https://img.shields.io/github/stars/jonradoff/lightcms?style=flat)](https://github.com/jonradoff/lightcms/stargazers) - Self-hosted content management system with static page generation, role-based access control, and an MCP server for agent-driven content operations.
...
- [ScheduleGate](https://github.com/gjunqueira-sys/ScheduleGate) [![GitHub stars](https://img.shields.io/github/stars/gjunqueira-sys/ScheduleGate?style=flat)](https://github.com/gjunqueira-sys/ScheduleGate/stargazers) - DCMA 14-point schedule assessment CLI for MS Project Excel/CSV exports.
...
- [spotify-screensaver](https://github.com/benzjeremy/spotify-screensaver) [![GitHub stars](https://img.shields.io/github/stars/benzjeremy/spotify-screensaver?style=flat)](https://github.com/benzjeremy/spotify-screensaver/stargazers) - Desktop screensaver for Spotify with digital OLED clock, canvas audio visualizer, and MPRIS controls.
...
- [untis-go](https://github.com/benzjeremy/untis-go) [![GitHub stars](https://img.shields.io/github/stars/benzjeremy/untis-go?style=flat)](https://github.com/benzjeremy/untis-go/stargazers) - Fast, native WebUntis desktop client for students and teachers. Sidebar navigation, timetables, homework, absences & messages. AES-256-GCM encrypted credentials, SQLite cache-first, random port security.
