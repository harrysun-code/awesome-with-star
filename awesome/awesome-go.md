...
* [relay](https://github.com/valtors/relay) [![GitHub stars](https://img.shields.io/github/stars/valtors/relay?style=flat)](https://github.com/valtors/relay/stargazers) - MCP server with 40 tools for AI agents. Memory, web fetch, search, file ops, screenshots, and multi-agent coordination in one Go binary.
