...
- [Foundation for Emails](https://github.com/zurb/foundation-emails) [![GitHub stars](https://img.shields.io/github/stars/zurb/foundation-emails?style=flat)](https://github.com/zurb/foundation-emails/stargazers) - Quickly create responsive HTML emails that work on any device & client. Even Outlook.
...
- [Campaign](https://github.com/bevacqua/campaign) [![GitHub stars](https://img.shields.io/github/stars/bevacqua/campaign?style=flat)](https://github.com/bevacqua/campaign/stargazers) - Compose responsive email templates easily, fill them with models, and send them out.
- [Sendwithus](https://www.sendwithus.com/resources/templates) - Open source email templates.
- [Mailchimp Email Blueprints](https://github.com/mailchimp/Email-Blueprints) [![GitHub stars](https://img.shields.io/github/stars/mailchimp/Email-Blueprints?style=flat)](https://github.com/mailchimp/Email-Blueprints/stargazers) - Email Blueprints is a collection of HTML email templates that can serve as a solid foundation and starting point for the design of emails.
...
- [Responsive Transactional HTML Email Templates](https://github.com/mailgun/transactional-email-templates) [![GitHub stars](https://img.shields.io/github/stars/mailgun/transactional-email-templates?style=flat)](https://github.com/mailgun/transactional-email-templates/stargazers) - Each template is responsive and each has been tested in all the popular email clients.
- [Cerberus](https://github.com/TedGoas/Cerberus) [![GitHub stars](https://img.shields.io/github/stars/TedGoas/Cerberus?style=flat)](https://github.com/TedGoas/Cerberus/stargazers) - Few responsive email patterns.
- [Antwort](https://github.com/internations/antwort) [![GitHub stars](https://img.shields.io/github/stars/internations/antwort?style=flat)](https://github.com/internations/antwort/stargazers) - Antwort offers responsive layouts for Email that both fits and adapts to client widths.
- [Responsive HTML Template](https://github.com/charlesmudy/responsive-html-email-template) [![GitHub stars](https://img.shields.io/github/stars/charlesmudy/responsive-html-email-template?style=flat)](https://github.com/charlesmudy/responsive-html-email-template/stargazers) - This template is designed to work on all major email platforms and it is built with media query, making it responsive for smartphones that supports media query.
...
- [Grunt Email Boilerplate](https://github.com/dwightjack/grunt-email-boilerplate) [![GitHub stars](https://img.shields.io/github/stars/dwightjack/grunt-email-boilerplate?style=flat)](https://github.com/dwightjack/grunt-email-boilerplate/stargazers) - A Grunt template to create emails.
- [Responsive Email Patterns](http://responsiveemailpatterns.com/) - A collection of patterns & modules for responsive emails.
- [Email boilerplate](https://github.com/seanpowell/Email-Boilerplate) [![GitHub stars](https://img.shields.io/github/stars/seanpowell/Email-Boilerplate?style=flat)](https://github.com/seanpowell/Email-Boilerplate/stargazers) - The email boilerplate for sending out nicely formatted messages.
- [htmlemail](https://htmlemail.io/) - Responsive HTML email templates for startups & developers.
- [Postmark Transactional Email Templates](https://github.com/wildbit/postmark-templates) [![GitHub stars](https://img.shields.io/github/stars/wildbit/postmark-templates?style=flat)](https://github.com/wildbit/postmark-templates/stargazers) - Rock-solid email templates for applications.
...
- [Lee Munroe's Grunt Email Design](https://github.com/leemunroe/grunt-email-workflow) [![GitHub stars](https://img.shields.io/github/stars/leemunroe/grunt-email-workflow?style=flat)](https://github.com/leemunroe/grunt-email-workflow/stargazers) - A Grunt workflow for designing and testing responsive HTML email templates with SCSS.
...
- [email-verifier](https://github.com/AfterShip/email-verifier) [![GitHub stars](https://img.shields.io/github/stars/AfterShip/email-verifier?style=flat)](https://github.com/AfterShip/email-verifier/stargazers) - A tool for email verification without sending any emails.
...
- [Postal](https://github.com/atech/postal) [![GitHub stars](https://img.shields.io/github/stars/atech/postal?style=flat)](https://github.com/atech/postal/stargazers) - A fully featured open source mail delivery platform for incoming & outgoing e-mail.
...
- [SimpleLogin](https://github.com/simple-login/app) [![GitHub stars](https://img.shields.io/github/stars/simple-login/app?style=flat)](https://github.com/simple-login/app/stargazers) - Self-hosted email alias solution.
...
- [Darylldoyle Gulp workflow](https://github.com/darylldoyle/Gulp-Email-Creator) [![GitHub stars](https://img.shields.io/github/stars/darylldoyle/Gulp-Email-Creator?style=flat)](https://github.com/darylldoyle/Gulp-Email-Creator/stargazers) - Gulp Email Creator is a gulp workflow inspired by Lee Munroe's grunt-email-design workflow.
...
- [Email marketing regulations](https://github.com/threeheartsdigital/email-marketing-regulations) [![GitHub stars](https://img.shields.io/github/stars/threeheartsdigital/email-marketing-regulations?style=flat)](https://github.com/threeheartsdigital/email-marketing-regulations/stargazers) - A guide to email marketing regulations around the world.
...
- [MailHog](https://github.com/mailhog/MailHog) [![GitHub stars](https://img.shields.io/github/stars/mailhog/MailHog?style=flat)](https://github.com/mailhog/MailHog/stargazers) A local fake SMTP server (based on Go).
...
If you want to contribute, please read the [contribution guidelines](https://github.com/jonathandion/awesome-emails/blob/master/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/jonathandion/awesome-emails/blob/master/contributing.md?style=flat)](https://github.com/jonathandion/awesome-emails/blob/master/contributing.md/stargazers).

### Check Also

- [Awesome JS Books](https://github.com/jonathandion/awesome-js-books) [![GitHub stars](https://img.shields.io/github/stars/jonathandion/awesome-js-books?style=flat)](https://github.com/jonathandion/awesome-js-books/stargazers) - This is a curated list of all the best JavaScript books.
- [Web Configs](https://github.com/jonathandion/web-configs) [![GitHub stars](https://img.shields.io/github/stars/jonathandion/web-configs?style=flat)](https://github.com/jonathandion/web-configs/stargazers) - Monorepo for all common configurations for building web apps.
- [My Neovim Config](https://github.com/jonathandion/web-dev.nvim) [![GitHub stars](https://img.shields.io/github/stars/jonathandion/web-dev.nvim?style=flat)](https://github.com/jonathandion/web-dev.nvim/stargazers) - Small Neovim configuration written in Lua that is specifically designed for web development.
