...
- [Codaptor](https://github.com/180Protocol/codaptor) [![GitHub stars](https://img.shields.io/github/stars/180Protocol/codaptor?style=flat)](https://github.com/180Protocol/codaptor/stargazers) - Create REST API for any CorDapp running on a Corda node automatically.
- [Corbeans](https://manosbatsis.github.io/corbeans) - Corda integration for Spring Boot.
- [Cordage](https://github.com/LayerXcom/cordage) [![GitHub stars](https://img.shields.io/github/stars/LayerXcom/cordage?style=flat)](https://github.com/LayerXcom/cordage/stargazers) - Provide modules that make the interoperability possible between Corda and other blockchains without further trusted third party.
- [Cordalo](https://github.com/cordalo-ch) [![GitHub stars](https://img.shields.io/github/stars/cordalo-ch?style=flat)](https://github.com/cordalo-ch/stargazers) - Provide Corda frameworks to speed up your development in the decentralized space.
...
- [Cordentity](https://github.com/hyperledger-labs/cordentity) [![GitHub stars](https://img.shields.io/github/stars/hyperledger-labs/cordentity?style=flat)](https://github.com/hyperledger-labs/cordentity/stargazers) - Integrate [Hyperledger Indy](https://www.hyperledger.org/projects/hyperledger-indy) capabilities into Corda.
- [DAML for Corda](https://github.com/chainstack/awesome-corda) [![GitHub stars](https://img.shields.io/github/stars/chainstack/awesome-corda?style=flat)](https://github.com/chainstack/awesome-corda/stargazers) - DAML smart contracts for Corda.
...
- [PyCorda](https://github.com/chainhaus/pycorda) [![GitHub stars](https://img.shields.io/github/stars/chainhaus/pycorda?style=flat)](https://github.com/chainhaus/pycorda/stargazers) - Access node and vault data for analytics using pandas DataFrames.
...
- [Testacles](https://github.com/manosbatsis/corda-testacles) [![GitHub stars](https://img.shields.io/github/stars/manosbatsis/corda-testacles?style=flat)](https://github.com/manosbatsis/corda-testacles/stargazers) - Tools to grow CorDapp test suites.
- [Vaultaire](https://manosbatsis.github.io/vaultaire/) - Query DSL and data access utilities for Corda developers.
- [VS Code Corda extension](https://github.com/corda/vscode-corda) [![GitHub stars](https://img.shields.io/github/stars/corda/vscode-corda?style=flat)](https://github.com/corda/vscode-corda/stargazers) - VS Code tools for developing CorDapps on the Corda platform.
...
- [Splunk App for Corda](https://github.com/splunkdlt/splunk-app-for-corda) [![GitHub stars](https://img.shields.io/github/stars/splunkdlt/splunk-app-for-corda?style=flat)](https://github.com/splunkdlt/splunk-app-for-corda/stargazers) - Splunk official integration app for Corda monitoring. 

## Tutorials

- [Official Corda tutorials](https://docs.corda.net/tutorials-index.html) - Learn to build and run CorDapps.
- [Sample CorDapps](https://github.com/corda/samples/) [![GitHub stars](https://img.shields.io/github/stars/corda/samples/?style=flat)](https://github.com/corda/samples//stargazers) - Explore the code of sample CorDapps targeting various uses.
...
- [Credit scoring](https://github.com/rafaelazeredo/creditbank) [![GitHub stars](https://img.shields.io/github/stars/rafaelazeredo/creditbank?style=flat)](https://github.com/rafaelazeredo/creditbank/stargazers) - A credit scoring service between the user and retail banks.
- [Auction](https://github.com/ashutoshmeher-r3/auction-cordapp) [![GitHub stars](https://img.shields.io/github/stars/ashutoshmeher-r3/auction-cordapp?style=flat)](https://github.com/ashutoshmeher-r3/auction-cordapp/stargazers) - A demo auction CorDapp.
- [Private health insurance management](https://github.com/corda-codeclub/marge) [![GitHub stars](https://img.shields.io/github/stars/corda-codeclub/marge?style=flat)](https://github.com/corda-codeclub/marge/stargazers) - A private health insurance CorDapp.
- [Sustainable fishing rights](https://github.com/joeldudleyr3/olive-oyl) [![GitHub stars](https://img.shields.io/github/stars/joeldudleyr3/olive-oyl?style=flat)](https://github.com/joeldudleyr3/olive-oyl/stargazers) - A CorDapp to manage fishing rights.
