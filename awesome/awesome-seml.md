...
> 来源：[SE-ML/awesome-seml](https://github.com/SE-ML/awesome-seml)

[![GitHub stars](https://img.shields.io/github/stars/SE-ML/awesome-seml?style=flat)](https://github.com/SE-ML/awesome-seml/stargazers)
...
- [Machine Learning Interviews](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf) [![GitHub stars](https://img.shields.io/github/stars/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf?style=flat)](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf/stargazers)
...
- [Alibi Detect](https://github.com/SeldonIO/alibi-detect) [![GitHub stars](https://img.shields.io/github/stars/SeldonIO/alibi-detect?style=flat)](https://github.com/SeldonIO/alibi-detect/stargazers) - Python library focused on outlier, adversarial and drift detection.
- [Archai](https://github.com/microsoft/archai) [![GitHub stars](https://img.shields.io/github/stars/microsoft/archai?style=flat)](https://github.com/microsoft/archai/stargazers) - Neural architecture search.
...
- [Great Expectations](https://github.com/great-expectations/great_expectations) [![GitHub stars](https://img.shields.io/github/stars/great-expectations/great_expectations?style=flat)](https://github.com/great-expectations/great_expectations/stargazers) - Data validation and testing with integration in pipelines.
- [HParams](https://github.com/PetrochukM/HParams) [![GitHub stars](https://img.shields.io/github/stars/PetrochukM/HParams?style=flat)](https://github.com/PetrochukM/HParams/stargazers) - A thoughtful approach to configuration management for machine learning projects.
- [Kubeflow](https://www.kubeflow.org/) - A platform for data scientists who want to build and experiment with ML pipelines.
- [Label Studio](https://github.com/heartexlabs/label-studio) [![GitHub stars](https://img.shields.io/github/stars/heartexlabs/label-studio?style=flat)](https://github.com/heartexlabs/label-studio/stargazers) - A multi-type data labeling and annotation tool with standardized output format.
- [LiFT](https://github.com/linkedin/LiFT) [![GitHub stars](https://img.shields.io/github/stars/linkedin/LiFT?style=flat)](https://github.com/linkedin/LiFT/stargazers) - Linkedin fairness toolkit.
- [MLFlow](https://mlflow.org/) - Manage the ML lifecycle, including experimentation, deployment, and a central model registry.
- [Model Card Toolkit](https://github.com/tensorflow/model-card-toolkit) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/model-card-toolkit?style=flat)](https://github.com/tensorflow/model-card-toolkit/stargazers) - Streamlines and automates the generation of model cards; for model documentation.
- [Neptune.ai](https://neptune.ai/) - Experiment tracking tool bringing organization and collaboration to data science projects.
- [Neuraxle](https://github.com/Neuraxio/Neuraxle) [![GitHub stars](https://img.shields.io/github/stars/Neuraxio/Neuraxle?style=flat)](https://github.com/Neuraxio/Neuraxle/stargazers) -  Sklearn-like framework for hyperparameter tuning and AutoML in deep learning projects.
- [OpenML](https://www.openml.org) - An inclusive movement to build an open, organized, online ecosystem for machine learning.
- [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) [![GitHub stars](https://img.shields.io/github/stars/PyTorchLightning/pytorch-lightning?style=flat)](https://github.com/PyTorchLightning/pytorch-lightning/stargazers) - The lightweight PyTorch wrapper for high-performance AI research. Scale your models, not the boilerplate.
- [REVISE: REvealing VIsual biaSEs](https://github.com/princetonvisualai/revise-tool) [![GitHub stars](https://img.shields.io/github/stars/princetonvisualai/revise-tool?style=flat)](https://github.com/princetonvisualai/revise-tool/stargazers) - Automatically detect bias in visual data sets.
- [Robustness Metrics](https://github.com/google-research/robustness_metrics) [![GitHub stars](https://img.shields.io/github/stars/google-research/robustness_metrics?style=flat)](https://github.com/google-research/robustness_metrics/stargazers) - Lightweight modules to evaluate the robustness of classification models.
- [Seldon Core](https://github.com/SeldonIO/seldon-core) [![GitHub stars](https://img.shields.io/github/stars/SeldonIO/seldon-core?style=flat)](https://github.com/SeldonIO/seldon-core/stargazers) - An MLOps framework to package, deploy, monitor and manage thousands of production machine learning models on Kubernetes.
...
- [Tensorflow Data Validation (TFDV)](https://github.com/tensorflow/data-validation) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/data-validation?style=flat)](https://github.com/tensorflow/data-validation/stargazers) - Library for exploring and validating machine learning data. Similar to Great Expectations, but for Tensorflow data.
