...
> 来源：[kdeldycke/awesome-engineering-team-management](https://github.com/kdeldycke/awesome-engineering-team-management)

[![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-engineering-team-management?style=flat)](https://github.com/kdeldycke/awesome-engineering-team-management/stargazers)
...
- [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) [![GitHub stars](https://img.shields.io/github/stars/papers-we-love/papers-we-love/tree/master/software_engineering_orgs?style=flat)](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs/stargazers) - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
- [Engineering Manager Resources](https://github.com/ryanburgess/engineer-manager) [![GitHub stars](https://img.shields.io/github/stars/ryanburgess/engineer-manager?style=flat)](https://github.com/ryanburgess/engineer-manager/stargazers) - Huge list, but need some curation.
...
- [Awesome Job Boards](https://github.com/tramcar/awesome-job-boards) [![GitHub stars](https://img.shields.io/github/stars/tramcar/awesome-job-boards?style=flat)](https://github.com/tramcar/awesome-job-boards/stargazers) - Niche job boards by domains, technology, roles and area.

- [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) [![GitHub stars](https://img.shields.io/github/stars/poteto/hiring-without-whiteboards?style=flat)](https://github.com/poteto/hiring-without-whiteboards/stargazers) - List of companies without the kind of CS trivia questions that are associated with bad interview practices.
...
- [Open Sourced Interview Process](https://github.com/cockroachlabs/open-sourced-interview-process) [![GitHub stars](https://img.shields.io/github/stars/cockroachlabs/open-sourced-interview-process?style=flat)](https://github.com/cockroachlabs/open-sourced-interview-process/stargazers) - Cockroach Labs published their process “to create familiarity for candidates and account for bias, resulting in a better candidate experience and hiring decisions.”
...
- [Back-End Developer Interview Questions](https://github.com/arialdomartini/Back-End-Developer-Interview-Questions) [![GitHub stars](https://img.shields.io/github/stars/arialdomartini/Back-End-Developer-Interview-Questions?style=flat)](https://github.com/arialdomartini/Back-End-Developer-Interview-Questions/stargazers) - A great source of inspiration.

- [Reverse interview](https://github.com/viraptor/reverse-interview) [![GitHub stars](https://img.shields.io/github/stars/viraptor/reverse-interview?style=flat)](https://github.com/viraptor/reverse-interview/stargazers) - Questions to ask the company during your interview. Be prepared to answer them as a manager.
...
- [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) [![GitHub stars](https://img.shields.io/github/stars/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition?style=flat)](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition/stargazers) - A satire of over-engineering for the sake of enterprise-grade software.

- [Awesome Interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) [![GitHub stars](https://img.shields.io/github/stars/MaximAbramchuck/awesome-interview-questions?style=flat)](https://github.com/MaximAbramchuck/awesome-interview-questions/stargazers) - A huge database of questions sorted by topic to get inspiration from.
...
- [hacker-laws](https://github.com/dwmkerr/hacker-laws) [![GitHub stars](https://img.shields.io/github/stars/dwmkerr/hacker-laws?style=flat)](https://github.com/dwmkerr/hacker-laws/stargazers) - Laws, Theories, Principles and Patterns that developers will find useful.
...
- [High Performance Organizations Reading List](https://github.com/pdfernhout/High-Performance-Organizations-Reading-List) [![GitHub stars](https://img.shields.io/github/stars/pdfernhout/High-Performance-Organizations-Reading-List?style=flat)](https://github.com/pdfernhout/High-Performance-Organizations-Reading-List/stargazers) - A list of books, web pages, and videos about how to design better organizations, divided into 3 categories: organization and motivation, health and wellness, and software development specific.
...
- [Awesome Concepts](https://github.com/lukasz-madon/awesome-concepts) [![GitHub stars](https://img.shields.io/github/stars/lukasz-madon/awesome-concepts?style=flat)](https://github.com/lukasz-madon/awesome-concepts/stargazers) - Laws, principles, mental models and cognitive biases.
...
- [The Efficiency-Destroying Magic of Tidying Up](https://flocrivello.com/the-efficiency-destroying-magic-of-tidying-up/) - “Efficiency tends to look messy, and good looks tend to be inefficient.” A reminder that sometimes we should just accept [the messiness of the world](https://github.com/kdeldycke/awesome-falsehood) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-falsehood?style=flat)](https://github.com/kdeldycke/awesome-falsehood/stargazers).
...
- [Code reviews at Google](https://github.com/google/eng-practices/blob/master/review/reviewer/speed.md#why-should-code-reviews-be-fast-why) [![GitHub stars](https://img.shields.io/github/stars/google/eng-practices/blob/master/review/reviewer/speed.md?style=flat)](https://github.com/google/eng-practices/blob/master/review/reviewer/speed.md/stargazers) - “Why Should Code Reviews Be Fast? (…) To optimize for the speed at which a team of developers can produce a product together, as opposed to optimizing for the speed at which an individual developer can write code.”
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) [![GitHub stars](https://img.shields.io/github/stars/lukasz-madon/awesome-remote-job?style=flat)](https://github.com/lukasz-madon/awesome-remote-job/stargazers) - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
- [1 on 1 Meeting Questions](https://github.com/VGraupera/1on1-questions) [![GitHub stars](https://img.shields.io/github/stars/VGraupera/1on1-questions?style=flat)](https://github.com/VGraupera/1on1-questions/stargazers) - A mega list in which most of them are great starters for conversation, some others are clearly bad ideas. A great source of inspiration nonetheless, but choose carefully.
...
- [Awesome Product Management](https://github.com/dend/awesome-product-management) [![GitHub stars](https://img.shields.io/github/stars/dend/awesome-product-management?style=flat)](https://github.com/dend/awesome-product-management/stargazers) - A reference. All the missing pieces are found below.

- [Open Product Management](https://github.com/tron1991/open-product-management) [![GitHub stars](https://img.shields.io/github/stars/tron1991/open-product-management?style=flat)](https://github.com/tron1991/open-product-management/stargazers) - Resources, interviews, case studies, sample products & projects, communities, open source tools, free & paid services on product management, for technical people to learn the field.
...
- [How to exit vim, the Product Manager way](https://github.com/hakluke/how-to-exit-vim/blob/master/README.md#the-product-manager-way) [![GitHub stars](https://img.shields.io/github/stars/hakluke/how-to-exit-vim/blob/master/README.md?style=flat)](https://github.com/hakluke/how-to-exit-vim/blob/master/README.md/stargazers) - A satire with a grain of truth, especially the comparison between the basic vs experienced level.
...
- [Marketing for Engineers](https://github.com/LisaDziuba/Marketing-for-Engineers) [![GitHub stars](https://img.shields.io/github/stars/LisaDziuba/Marketing-for-Engineers?style=flat)](https://github.com/LisaDziuba/Marketing-for-Engineers/stargazers) - Lots of resources to help bootstrap your marketing activities and solve practical tasks.
...
- [Awesome OKR](https://github.com/domenicosolazzo/awesome-okr) [![GitHub stars](https://img.shields.io/github/stars/domenicosolazzo/awesome-okr?style=flat)](https://github.com/domenicosolazzo/awesome-okr/stargazers) - There is no shortage of content on how to measure and communicate objectives.
...
The [header image](https://github.com/kdeldycke/awesome-engineering-team-management/blob/main/assets/awesome-management-header.png) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-engineering-team-management/blob/main/assets/awesome-management-header.png?style=flat)](https://github.com/kdeldycke/awesome-engineering-team-management/blob/main/assets/awesome-management-header.png/stargazers) is based on a modified [photo taken in November 2017](https://unsplash.com/photos/6dDHofabCQ8) by [Werner Du plessis](https://unsplash.com/@werner01).
