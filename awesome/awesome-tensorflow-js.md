...
TensorFlow.js is [an open source software library](https://github.com/tensorflow/tfjs) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/tfjs?style=flat)](https://github.com/tensorflow/tfjs/stargazers) to develop machine learning models in JavaScript, and use machine learning
...
- [TensorFlow.js gallery](https://github.com/tensorflow/tfjs/blob/master/GALLERY.md) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/tfjs/blob/master/GALLERY.md?style=flat)](https://github.com/tensorflow/tfjs/blob/master/GALLERY.md/stargazers) -  A collection of TensorFlow.js projects, tutorials, videos, and more.
...
- [Official tfjs models on TensorFlow.js repo](https://github.com/tensorflow/tfjs-models) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/tfjs-models?style=flat)](https://github.com/tensorflow/tfjs-models/stargazers) - Pretrained models for TensorFlow.js.
...
- [Official tfjs examples repo](https://github.com/tensorflow/tfjs-examples) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/tfjs-examples?style=flat)](https://github.com/tensorflow/tfjs-examples/stargazers) - Examples built with TensorFlow.js!
...
- [Learning Tensorflow.js: Powerful Machine Learning in JavaScript](https://amzn.to/3dR3vpY) - In this guide, author [Gant Laborde](https://github.com/gantman) [![GitHub stars](https://img.shields.io/github/stars/gantman?style=flat)](https://github.com/gantman/stargazers) provides a hands-on, end-to-end approach to TensorFlow.js fundamentals for a broad technical audience that includes data scientists, engineers, web developers, students, and researchers.
...
- [Handwritten Digit Classification](https://github.com/aaronhma/ngconf-2020) [![GitHub stars](https://img.shields.io/github/stars/aaronhma/ngconf-2020?style=flat)](https://github.com/aaronhma/ngconf-2020/stargazers) - A showcase project for [NgConf 2020](https://www.ng-conf.org/) talk on **A Journey into the World of Machine Learning with TensorFlow.js**.
- [NSFWJS - Indecent Content Checker](https://github.com/infinitered/nsfwjs) [![GitHub stars](https://img.shields.io/github/stars/infinitered/nsfwjs?style=flat)](https://github.com/infinitered/nsfwjs/stargazers) - A friendly library to check images to see if they are indecent content on either the client or the server!
...
- [TensorFlow.js](https://github.com/tensorflow/tfjs) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/tfjs?style=flat)](https://github.com/tensorflow/tfjs/stargazers) - A WebGL accelerated JavaScript library for training and deploying ML models.
- [ml5.js](https://ml5js.org/) - Friendly machine learning for the web.
- [face-api.js](https://github.com/justadudewhohacks/face-api.js) [![GitHub stars](https://img.shields.io/github/stars/justadudewhohacks/face-api.js?style=flat)](https://github.com/justadudewhohacks/face-api.js/stargazers) - JavaScript API for face detection and face recognition in the browser and Node.js with tensorflow.js.
- [handtrack.js](https://github.com/victordibia/handtrack.js/) [![GitHub stars](https://img.shields.io/github/stars/victordibia/handtrack.js/?style=flat)](https://github.com/victordibia/handtrack.js//stargazers) - A library for prototyping realtime hand detection (bounding box), directly in the browser.
...
**NOTE: In order to create an community that is welcome for all, ALL contributors MUST agree to the [Code of Conduct](https://github.com/aaronhma/awesome-tensorflow-js/blob/master/CODE_OF_CONDUCT.md) [![GitHub stars](https://img.shields.io/github/stars/aaronhma/awesome-tensorflow-js/blob/master/CODE_OF_CONDUCT.md?style=flat)](https://github.com/aaronhma/awesome-tensorflow-js/blob/master/CODE_OF_CONDUCT.md/stargazers).**
