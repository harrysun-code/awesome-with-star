...
## Open source code
- [Canvas Quiz](https://github.com/googlecreativelab/aog-canvas-quiz) [![GitHub stars](https://img.shields.io/github/stars/googlecreativelab/aog-canvas-quiz?style=flat)](https://github.com/googlecreativelab/aog-canvas-quiz/stargazers) - It is a starter kit for developers to make custom, voice-enabled question-answer games for the Google Assistant.
- [Interactive Canvas editor](https://github.com/actions-on-google-labs/interactive-canvas-editor-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google-labs/interactive-canvas-editor-nodejs?style=flat)](https://github.com/actions-on-google-labs/interactive-canvas-editor-nodejs/stargazers) - Editor to create a web app for Interactive Canvas that is immediately loaded onto a smart display device. This allows for quick prototyping of web apps for Interactive Canvas.
- [Virtual Pet](https://github.com/actions-on-google-labs/virtual-pet-game-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google-labs/virtual-pet-game-nodejs?style=flat)](https://github.com/actions-on-google-labs/virtual-pet-game-nodejs/stargazers) - It is built with interactive canvas. In this game, you will adopt and take care of a hamster just like you would in real life, except through Google Assistant.
- [Spellcast](https://github.com/actions-on-google-labs/dialogflow-spellcast-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google-labs/dialogflow-spellcast-nodejs?style=flat)](https://github.com/actions-on-google-labs/dialogflow-spellcast-nodejs/stargazers) - Experimental Interactive Canvas game for the Google Assistant.
- Silly Name Maker [(Node.js)](https://github.com/actions-on-google/dialogflow-silly-name-maker-webhook-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-silly-name-maker-webhook-nodejs?style=flat)](https://github.com/actions-on-google/dialogflow-silly-name-maker-webhook-nodejs/stargazers) [(Java)](https://github.com/actions-on-google/dialogflow-silly-name-maker-webhook-java) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-silly-name-maker-webhook-java?style=flat)](https://github.com/actions-on-google/dialogflow-silly-name-maker-webhook-java/stargazers) - Parameters sample (using Dialogflow).
- Facts about Google [(Node.js)](https://github.com/actions-on-google/dialogflow-facts-about-google-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-facts-about-google-nodejs?style=flat)](https://github.com/actions-on-google/dialogflow-facts-about-google-nodejs/stargazers) [(Java)](https://github.com/actions-on-google/dialogflow-silly-name-maker-webhook-java) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-silly-name-maker-webhook-java?style=flat)](https://github.com/actions-on-google/dialogflow-silly-name-maker-webhook-java/stargazers) - Custom Entities, Contexts, and Deep Links sample (using Dialogflow).
- Name Psychic [(Node.js)](https://github.com/actions-on-google/dialogflow-name-psychic-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-name-psychic-nodejs?style=flat)](https://github.com/actions-on-google/dialogflow-name-psychic-nodejs/stargazers) [(Java)](https://github.com/actions-on-google/dialogflow-name-psychic-java) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-name-psychic-java?style=flat)](https://github.com/actions-on-google/dialogflow-name-psychic-java/stargazers) - Permissions and Google Maps Static API sample (using Dialogflow).
- Number Genie [(Node.js)](https://github.com/actions-on-google/dialogflow-number-genie-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-number-genie-nodejs?style=flat)](https://github.com/actions-on-google/dialogflow-number-genie-nodejs/stargazers) [(Java)](https://github.com/actions-on-google/dialogflow-number-genie-java) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-number-genie-java?style=flat)](https://github.com/actions-on-google/dialogflow-number-genie-java/stargazers) - Localization sample.
- [GDG Action](https://github.com/actions-on-google/dialogflow-gdg-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/dialogflow-gdg-nodejs?style=flat)](https://github.com/actions-on-google/dialogflow-gdg-nodejs/stargazers) - This sample demonstrates Actions on Google features for use on Google Assistant including localization (i18n-node), conversation design, rich responses, and API integrations.
- Say Number [(Node.js)](https://github.com/actions-on-google/actionssdk-say-number-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/actionssdk-say-number-nodejs?style=flat)](https://github.com/actions-on-google/actionssdk-say-number-nodejs/stargazers) [(Java)](https://github.com/actions-on-google/actionssdk-say-number-java) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/actionssdk-say-number-java?style=flat)](https://github.com/actions-on-google/actionssdk-say-number-java/stargazers) - Say a number Actions SDK sample for Actions on Google.
- [Smart Home sample](https://github.com/actions-on-google/smart-home-nodejs) [![GitHub stars](https://img.shields.io/github/stars/actions-on-google/smart-home-nodejs?style=flat)](https://github.com/actions-on-google/smart-home-nodejs/stargazers) - A sample of the Smart Home device control APIs in Actions on Google.
- [PDPU Scheduler](https://github.com/nish17/scheduler) [![GitHub stars](https://img.shields.io/github/stars/nish17/scheduler?style=flat)](https://github.com/nish17/scheduler/stargazers) - It's a Google Assistant action for PDPU that tells you about which classes and labs you have today.
- [karaoke](https://github.com/amdcaruso/karaoke) [![GitHub stars](https://img.shields.io/github/stars/amdcaruso/karaoke?style=flat)](https://github.com/amdcaruso/karaoke/stargazers) - [Amanda Cavallaro](https://github.com/amdcaruso) [![GitHub stars](https://img.shields.io/github/stars/amdcaruso?style=flat)](https://github.com/amdcaruso/stargazers) - Conversational App to buid your own karaoke using GCP, YouTube API and Actions on Google.
