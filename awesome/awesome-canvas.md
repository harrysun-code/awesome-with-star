...
A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) [![GitHub stars](https://img.shields.io/github/stars/vinta/awesome-python?style=flat)](https://github.com/vinta/awesome-python/stargazers).

## Contributing

Please take a quick gander at the [contribution guidelines](https://github.com/raphamorim/awesome-canvas/blob/master/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/raphamorim/awesome-canvas/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/raphamorim/awesome-canvas/blob/master/CONTRIBUTING.md/stargazers) first.
...
* [Cloth Effect](http://raphamorim.io/canvas-experiments/cloth) [[show me the code](https://github.com/raphamorim/canvas-experiments) [![GitHub stars](https://img.shields.io/github/stars/raphamorim/canvas-experiments?style=flat)](https://github.com/raphamorim/canvas-experiments/stargazers)] • A cloth 3D effect fork.
* [Colorful Particles](http://raphamorim.io/canvas-experiments/particles) [[show me the code](https://github.com/raphamorim/canvas-experiments) [![GitHub stars](https://img.shields.io/github/stars/raphamorim/canvas-experiments?style=flat)](https://github.com/raphamorim/canvas-experiments/stargazers)] • Experiment show how to generates random particles. Very simple code for assimilate.
* [Distance Field Waves](http://www.kevs3d.co.uk/dev/shaders/distancefield3.html) [[show me the code](https://github.com/kevinroast/webglshaders/blob/master/distancefield3.html) [![GitHub stars](https://img.shields.io/github/stars/kevinroast/webglshaders/blob/master/distancefield3.html?style=flat)](https://github.com/kevinroast/webglshaders/blob/master/distancefield3.html/stargazers)] • A example about GPU rendering shader experiments with procedural 3D scene generation using ray marching and distance field (also known as 'sphere tracing') rendering techniques.
* [Draw Table](http://raphamorim.io/canvas-experiments/draw) - [[show me the code](https://github.com/raphamorim/canvas-experiments) [![GitHub stars](https://img.shields.io/github/stars/raphamorim/canvas-experiments?style=flat)](https://github.com/raphamorim/canvas-experiments/stargazers)] • A simple example about events using canvas.
...
* [Inception](http://raphamorim.io/canvas-experiments/inception) [[show me the code](https://github.com/raphamorim/canvas-experiments) [![GitHub stars](https://img.shields.io/github/stars/raphamorim/canvas-experiments?style=flat)](https://github.com/raphamorim/canvas-experiments/stargazers)] • Generates a scrawl of a city, a canvas HTML5 experiment. Based on Inception movie 
...
* [Just Canvas](http://raphamorim.io/just-canvas/) [[show me the code](https://github.com/raphamorim/just-canvas) [![GitHub stars](https://img.shields.io/github/stars/raphamorim/just-canvas?style=flat)](https://github.com/raphamorim/just-canvas/stargazers)]• This is a JavaScript experiment to capture movements. Just Dance Idea + HTML5 Canvas Implementation.
...
* [Matrix Animation](https://matrix.dotglitch.dev/) [[show me the code](https://github.com/knackstedt/matrix-animation) [![GitHub stars](https://img.shields.io/github/stars/knackstedt/matrix-animation?style=flat)](https://github.com/knackstedt/matrix-animation/stargazers)] • A Matrix Rain animation using canvas.
...
* [PixelCraft](https://github.com/rgab1508/PixelCraft) [![GitHub stars](https://img.shields.io/github/stars/rgab1508/PixelCraft?style=flat)](https://github.com/rgab1508/PixelCraft/stargazers) • A pixel-art editor made using canvas
* [Raining Day](http://raphamorim.io/raining-day/) [[show me the code](https://github.com/raphamorim/canvas-experiments) [![GitHub stars](https://img.shields.io/github/stars/raphamorim/canvas-experiments?style=flat)](https://github.com/raphamorim/canvas-experiments/stargazers)] • Raindrops using canvas. It's Neatnait Canvas Rain fork.
* [Space Noodles](http://www.spielzeugz.de/html5/space-noodles/) • Amazing example about line movement and animation.
* [Star Time Lapse Effect](https://fralonra.github.io/star-time-lapse/demo/) [[show me the code](https://github.com/fralonra/star-time-lapse) [![GitHub stars](https://img.shields.io/github/stars/fralonra/star-time-lapse?style=flat)](https://github.com/fralonra/star-time-lapse/stargazers)] • An example about creating a star time-lapse sky using canvas.
...
* [Trigonoparty!](https://ramesaliyev.com/trigonoparty) [[show me the code](https://github.com/ramesaliyev/trigonoparty) [![GitHub stars](https://img.shields.io/github/stars/ramesaliyev/trigonoparty?style=flat)](https://github.com/ramesaliyev/trigonoparty/stargazers)] • Simple trigonometry visualisation.
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) [![GitHub stars](https://img.shields.io/github/stars/matteobruni/tsparticles?style=flat)](https://github.com/matteobruni/tsparticles/stargazers) particles animations samples
...
- [Chart.js](https://github.com/chartjs/Chart.js) [![GitHub stars](https://img.shields.io/github/stars/chartjs/Chart.js?style=flat)](https://github.com/chartjs/Chart.js/stargazers) is a lightweight JavaScript library for creating dynamic and visually appealing charts using the HTML5 Canvas element.
...
- [d3](https://github.com/d3/d3) [![GitHub stars](https://img.shields.io/github/stars/d3/d3?style=flat)](https://github.com/d3/d3/stargazers) (or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
...
- [iio.js](https://github.com/iioinc/iio.js) [![GitHub stars](https://img.shields.io/github/stars/iioinc/iio.js?style=flat)](https://github.com/iioinc/iio.js/stargazers) - A javascript library that speeds the creation and deployment of HTML5 Canvas applications
- [isomerjs](http://jdan.github.io/isomer/) - An isometric graphics library for HTML5 canvas
- [Javascript-Voronoi](https://github.com/gorhill/Javascript-Voronoi) [![GitHub stars](https://img.shields.io/github/stars/gorhill/Javascript-Voronoi?style=flat)](https://github.com/gorhill/Javascript-Voronoi/stargazers) - A Javascript implementation of Fortune's algorithm to compute Voronoi cells 
- [Konva](https://github.com/konvajs/konva) [![GitHub stars](https://img.shields.io/github/stars/konvajs/konva?style=flat)](https://github.com/konvajs/konva/stargazers) - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications. 
- [Origami.js](https://github.com/raphamorim/origami.js) [![GitHub stars](https://img.shields.io/github/stars/raphamorim/origami.js?style=flat)](https://github.com/raphamorim/origami.js/stargazers) - JS Lib to redesign canvas API interface
- [p5.js](https://p5js.org) - p5.js is a JS client-side library for creating graphic and interactive experiences
- [Paper.js](https://github.com/paperjs/paper.js) [![GitHub stars](https://img.shields.io/github/stars/paperjs/paper.js?style=flat)](https://github.com/paperjs/paper.js/stargazers) - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
- [Proton](https://github.com/a-jie/Proton) [![GitHub stars](https://img.shields.io/github/stars/a-jie/Proton?style=flat)](https://github.com/a-jie/Proton/stargazers) is a lightweight and powerful javascript particle engine. With it you can easily create countless cool effects 
...
- [Sketch](https://github.com/soulwire/sketch.js) [![GitHub stars](https://img.shields.io/github/stars/soulwire/sketch.js?style=flat)](https://github.com/soulwire/sketch.js/stargazers) - Cross-Platform JavaScript Creative Coding Framework
...
- [textmode.js](https://github.com/humanbydefinition/textmode.js) [![GitHub stars](https://img.shields.io/github/stars/humanbydefinition/textmode.js?style=flat)](https://github.com/humanbydefinition/textmode.js/stargazers) is a lightweight, framework-agnostic creative coding library for real-time ASCII and textmode graphics in the browser.
...
- [Visualize](https://github.com/filamentgroup/jQuery-Visualize) [![GitHub stars](https://img.shields.io/github/stars/filamentgroup/jQuery-Visualize?style=flat)](https://github.com/filamentgroup/jQuery-Visualize/stargazers) is a JQuery plugin who creates charts and graphs from tabular data using the HTML canvas element.
- [zDog](https://github.com/metafizzy/zdog) [![GitHub stars](https://img.shields.io/github/stars/metafizzy/zdog?style=flat)](https://github.com/metafizzy/zdog/stargazers) - Flat, round, designer-friendly pseudo-3D engine for canvas & SVG
...
- [zrender](https://github.com/ecomfe/zrender) [![GitHub stars](https://img.shields.io/github/stars/ecomfe/zrender?style=flat)](https://github.com/ecomfe/zrender/stargazers) - A lightweight canvas library which providing 2d draw for Apache ECharts (incubating)

### For other purposes, but still use canvas
- [React Canvas](https://github.com/Flipboard/react-canvas) [![GitHub stars](https://img.shields.io/github/stars/Flipboard/react-canvas?style=flat)](https://github.com/Flipboard/react-canvas/stargazers) - High performance <canvas> rendering for React components.
...
* [@jeresig](https://twitter.com/jeresig) - Creator of [Processing.js](https://github.com/jeresig/processing-js) [![GitHub stars](https://img.shields.io/github/stars/jeresig/processing-js?style=flat)](https://github.com/jeresig/processing-js/stargazers)
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) [![GitHub stars](https://img.shields.io/github/stars/mrdoob/three.js?style=flat)](https://github.com/mrdoob/three.js/stargazers)
* [@soulwire](https://twitter.com/soulwire) - Creator of [sketch.js](https://github.com/soulwire/sketch.js) [![GitHub stars](https://img.shields.io/github/stars/soulwire/sketch.js?style=flat)](https://github.com/soulwire/sketch.js/stargazers) and actively creating and sharing canvas/WebGL experiments
