...
>
> Source code: [github.com/szenergy/awesome-lidar](https://github.com/szenergy/awesome-lidar) [![GitHub stars](https://img.shields.io/github/stars/szenergy/awesome-lidar?style=flat)](https://github.com/szenergy/awesome-lidar/stargazers)
...
- [OSSDC SIM](https://github.com/OSSDC/OSSDC-SIM) [![GitHub stars](https://img.shields.io/github/stars/OSSDC/OSSDC-SIM?style=flat)](https://github.com/OSSDC/OSSDC-SIM/stargazers) - Unity Engine based simulator for automotive applications, based on the suspended LGSVL simulator, but an active development. Compatible with Autoware, Baidu Apollo and ROS/ROS 2.
...
## Others
- [ARHeadsetKit](https://github.com/philipturner/ARHeadsetKit) [![GitHub stars](https://img.shields.io/github/stars/philipturner/ARHeadsetKit?style=flat)](https://github.com/philipturner/ARHeadsetKit/stargazers) - Using $5 Google Cardboard to replicate Microsoft Hololens. Hosts the source code for research on [scene color reconstruction](https://github.com/philipturner/scene-color-reconstruction) [![GitHub stars](https://img.shields.io/github/stars/philipturner/scene-color-reconstruction?style=flat)](https://github.com/philipturner/scene-color-reconstruction/stargazers).
...
- [Lichtblick suite](https://github.com/lichtblick-suite) [![GitHub stars](https://img.shields.io/github/stars/lichtblick-suite?style=flat)](https://github.com/lichtblick-suite/stargazers) - Lichtblick is an open-source alternative to Foxglove Studio for visualizing and analyzing robotics data.
...
- [CloudPeek](https://github.com/Geekgineer/CloudPeek) [![GitHub stars](https://img.shields.io/github/stars/Geekgineer/CloudPeek?style=flat)](https://github.com/Geekgineer/CloudPeek/stargazers) is a lightweight, c++ single-header, cross-platform point cloud viewer, designed for simplicity and efficiency without relying on heavy external libraries like PCL or Open3D.
