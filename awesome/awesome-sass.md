...
- [Bootstrap 4](https://github.com/twbs/bootstrap) [![GitHub stars](https://img.shields.io/github/stars/twbs/bootstrap?style=flat)](https://github.com/twbs/bootstrap/stargazers) - Bootstrap version 4, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
- [Bootstrap-sass](https://github.com/twbs/bootstrap-sass) [![GitHub stars](https://img.shields.io/github/stars/twbs/bootstrap-sass?style=flat)](https://github.com/twbs/bootstrap-sass/stargazers) - Official Sass port of Bootstrap 2 and 3.
- [Bulma](https://github.com/jgthms/bulma) [![GitHub stars](https://img.shields.io/github/stars/jgthms/bulma?style=flat)](https://github.com/jgthms/bulma/stargazers) - Modern CSS framework based on Flexbox.
- [Cirrus](https://github.com/Spiderpig86/Cirrus) [![GitHub stars](https://img.shields.io/github/stars/Spiderpig86/Cirrus?style=flat)](https://github.com/Spiderpig86/Cirrus/stargazers) - A component and utility centric SCSS framework designed for rapid prototyping.
- [Foundation for Sites](https://github.com/zurb/foundation-sites) [![GitHub stars](https://img.shields.io/github/stars/zurb/foundation-sites?style=flat)](https://github.com/zurb/foundation-sites/stargazers) - The most advanced responsive front-end framework in the world. Quickly create prototypes and production code for sites that work on any kind of device.
...
- [Jeet](https://github.com/mojotech/jeet) [![GitHub stars](https://img.shields.io/github/stars/mojotech/jeet?style=flat)](https://github.com/mojotech/jeet/stargazers) - Simple fractional grid system for Sass and Stylus.
...
- [Susy](https://github.com/oddbird/susy) [![GitHub stars](https://img.shields.io/github/stars/oddbird/susy?style=flat)](https://github.com/oddbird/susy/stargazers) - Responsive layout toolkit for Sass.
...
### Media Queries
- [Breakpoint](https://github.com/at-import/breakpoint) [![GitHub stars](https://img.shields.io/github/stars/at-import/breakpoint?style=flat)](https://github.com/at-import/breakpoint/stargazers) - Breakpoint makes writing media queries in Sass super simple.
- [include-media](https://eduardoboucas.github.io/include-media/) - Simple, elegant and maintainable media queries.
- [mq-scss](https://github.com/Dan503/mq-scss) [![GitHub stars](https://img.shields.io/github/stars/Dan503/mq-scss?style=flat)](https://github.com/Dan503/mq-scss/stargazers) - An extreamly powerful but easy to use Sass media query mixin.
...
- [Sassy-Gridlover](https://github.com/hiulit/Sassy-Gridlover) [![GitHub stars](https://img.shields.io/github/stars/hiulit/Sassy-Gridlover?style=flat)](https://github.com/hiulit/Sassy-Gridlover/stargazers) - Super easy to use Sass mixins to establish a typographic system with modular scale and vertical rhythm. Based on the Gridlover app.
- [Shevy](http://kyleshevlin.github.io/shevy/) - Typography made easy. A vertical rhythm library.
- [Typi](https://github.com/zellwk/typi) [![GitHub stars](https://img.shields.io/github/stars/zellwk/typi?style=flat)](https://github.com/zellwk/typi/stargazers) - Sass mixin to make responsive typography easy.

### Animation
- [Animate.scss](https://github.com/geoffgraham/animate.scss) [![GitHub stars](https://img.shields.io/github/stars/geoffgraham/animate.scss?style=flat)](https://github.com/geoffgraham/animate.scss/stargazers) -  Port of Dan Eden's [Animate.css](https://daneden.github.io/animate.css/) for SASS.
...
- [Sass Burger](https://github.com/jorenvanhee/sass-burger) [![GitHub stars](https://img.shields.io/github/stars/jorenvanhee/sass-burger?style=flat)](https://github.com/jorenvanhee/sass-burger/stargazers) - Sass mixin for creating animated hamburger icon.
- [SpinThatShit](https://matejkustec.github.io/SpinThatShit/) - Set of SCSS mixins for single element loaders and spinners.

### Miscellaneous
- [Angled Edges](https://github.com/josephfusco/angled-edges) [![GitHub stars](https://img.shields.io/github/stars/josephfusco/angled-edges?style=flat)](https://github.com/josephfusco/angled-edges/stargazers) - Sass mixin for creating angled edges on sections by dynamically encoding SVGs.
- [Bourbon](http://bourbon.io/) - Simple and lightweight mixin library for Sass.
- [Buttono](https://github.com/hsnaydd/buttono) [![GitHub stars](https://img.shields.io/github/stars/hsnaydd/buttono?style=flat)](https://github.com/hsnaydd/buttono/stargazers) - A flexible Sass mixin for creating BEM-style buttons.
- [Buttons](https://github.com/alexwolfe/Buttons) [![GitHub stars](https://img.shields.io/github/stars/alexwolfe/Buttons?style=flat)](https://github.com/alexwolfe/Buttons/stargazers) - CSS button library built using Sass and Compass.
...
- [Modular Scale](https://github.com/modularscale/modularscale-sass) [![GitHub stars](https://img.shields.io/github/stars/modularscale/modularscale-sass?style=flat)](https://github.com/modularscale/modularscale-sass/stargazers) - Modular scale calculator built into your Sass.
- [normalize-scss](https://github.com/JohnAlbin/normalize-scss) [![GitHub stars](https://img.shields.io/github/stars/JohnAlbin/normalize-scss?style=flat)](https://github.com/JohnAlbin/normalize-scss/stargazers) -  Sass/Compass version of Normalize.css, a collection of HTML element and attribute rulesets to normalize styles across all browsers.
- [Pretty checkbox](https://github.com/lokesh-coder/pretty-checkbox) [![GitHub stars](https://img.shields.io/github/stars/lokesh-coder/pretty-checkbox?style=flat)](https://github.com/lokesh-coder/pretty-checkbox/stargazers) -  SCSS/CSS library to beautify checkbox and radio buttons.
...
- [Sass Deprecate](https://github.com/salesforce-ux/sass-deprecate) [![GitHub stars](https://img.shields.io/github/stars/salesforce-ux/sass-deprecate?style=flat)](https://github.com/salesforce-ux/sass-deprecate/stargazers) - Sass mixin that helps managing code deprecation.
- [Sass flexbox mixin](https://github.com/mastastealth/sass-flex-mixin) [![GitHub stars](https://img.shields.io/github/stars/mastastealth/sass-flex-mixin?style=flat)](https://github.com/mastastealth/sass-flex-mixin/stargazers) - Set of mixins for those who want to mess around with flexbox using the native support of current browsers.
- [Sassdash](https://github.com/davidkpiano/sassdash) [![GitHub stars](https://img.shields.io/github/stars/davidkpiano/sassdash?style=flat)](https://github.com/davidkpiano/sassdash/stargazers) - The Sass implementation of lodash ([API documentation](http://davidkpiano.github.io/sassdash)).
- [Scut](https://github.com/davidtheclark/scut) [![GitHub stars](https://img.shields.io/github/stars/davidtheclark/scut?style=flat)](https://github.com/davidtheclark/scut/stargazers) - Collection of Sass utilities to ease and improve the implementations of common style-code patterns.

## Style Guides
- [Hugo Giraudel's Sass Guidelines](https://sass-guidelin.es/) - Guidelines for writing sane, maintainable and scalable Sass.
- [BigCommerce Sass Coding Guidelines](https://github.com/bigcommerce/sass-style-guide) [![GitHub stars](https://img.shields.io/github/stars/bigcommerce/sass-style-guide?style=flat)](https://github.com/bigcommerce/sass-style-guide/stargazers) - Guidelines in use at BigCommerce.
- [Airbnb Sass and CSS Style Guide](https://github.com/airbnb/css) [![GitHub stars](https://img.shields.io/github/stars/airbnb/css?style=flat)](https://github.com/airbnb/css/stargazers) - Sass and CSS style guide by Airbnb.
- [Dropbox (S)CSS Style Guide](https://github.com/dropbox/css-style-guide) [![GitHub stars](https://img.shields.io/github/stars/dropbox/css-style-guide?style=flat)](https://github.com/dropbox/css-style-guide/stargazers) - Dropbox’s (S)CSS authoring style guide.

## Articles
- [Hugo Giraudel Personal Awesome Sass List](https://github.com/HugoGiraudel/awesome-sass) [![GitHub stars](https://img.shields.io/github/stars/HugoGiraudel/awesome-sass?style=flat)](https://github.com/HugoGiraudel/awesome-sass/stargazers) - Records of Hugo Giraudel's works on Sass.
...
## Tools
- [dart-sass](https://github.com/sass/dart-sass) [![GitHub stars](https://img.shields.io/github/stars/sass/dart-sass?style=flat)](https://github.com/sass/dart-sass/stargazers) - Dart implementation of Sass.
- [diamond](https://diamond.js.org) - Dependency management built for Sass, Less, and CSS.
- [libsass-python](https://github.com/dahlia/libsass-python) [![GitHub stars](https://img.shields.io/github/stars/dahlia/libsass-python?style=flat)](https://github.com/dahlia/libsass-python/stargazers) - Binding of libsass for Python.
- [libsass](https://github.com/sass/libsass) [![GitHub stars](https://img.shields.io/github/stars/sass/libsass?style=flat)](https://github.com/sass/libsass/stargazers) - C/C++ implementation of a Sass compiler.
- [node-sass-magic-importer](https://github.com/maoberlehner/node-sass-magic-importer) [![GitHub stars](https://img.shields.io/github/stars/maoberlehner/node-sass-magic-importer?style=flat)](https://github.com/maoberlehner/node-sass-magic-importer/stargazers) - Custom node-sass importer for selector specific imports, node importing, module importing, globbing support and importing files only once.
- [node-sass](https://github.com/sass/node-sass) [![GitHub stars](https://img.shields.io/github/stars/sass/node-sass?style=flat)](https://github.com/sass/node-sass/stargazers) - Node.js bindings to libsass.
- [OctoLinker](https://github.com/OctoLinker/browser-extension) [![GitHub stars](https://img.shields.io/github/stars/OctoLinker/browser-extension?style=flat)](https://github.com/OctoLinker/browser-extension/stargazers) - Navigate through *.scss and *.sass files efficiently with the OctoLinker browser extension for GitHub.
- [sass-extract](https://github.com/jgranstrom/sass-extract) [![GitHub stars](https://img.shields.io/github/stars/jgranstrom/sass-extract?style=flat)](https://github.com/jgranstrom/sass-extract/stargazers) - Extract variables from scss files. Use scss to describe styles for use in javascript by extracting computed styles into js objects. Supports imports and advanced language features.
- [sass-loader](https://github.com/jtangelder/sass-loader) [![GitHub stars](https://img.shields.io/github/stars/jtangelder/sass-loader?style=flat)](https://github.com/jtangelder/sass-loader/stargazers) - Sass loader for webpack.
