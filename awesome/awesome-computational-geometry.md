...
- [CGViz: Computational Geometry Interactive Visualizations](https://jes24.github.io/CGViz/) ([GitHub](https://github.com/JeS24/CGViz) [![GitHub stars](https://img.shields.io/github/stars/JeS24/CGViz?style=flat)](https://github.com/JeS24/CGViz/stargazers)) - CGViz is a FOSS web app for step-by-step visualizations of many algorithms, designed for exploration, teaching, and creating exportable visuals.
...
- [geometry3Sharp](https://github.com/gradientspace/geometry3Sharp) [![GitHub stars](https://img.shields.io/github/stars/gradientspace/geometry3Sharp?style=flat)](https://github.com/gradientspace/geometry3Sharp/stargazers) - Open-Source, Boost-licensed C# library for geometric computing.
...
- [hull.js](https://github.com/AndriiHeonia/hull) [![GitHub stars](https://img.shields.io/github/stars/AndriiHeonia/hull?style=flat)](https://github.com/AndriiHeonia/hull/stargazers) - JavaScript library that builds the convex hull of a set of points.
- [S2 Geometry Library](https://github.com/google/s2geometry) [![GitHub stars](https://img.shields.io/github/stars/google/s2geometry?style=flat)](https://github.com/google/s2geometry/stargazers) - A package for manipulating geometric shapes. Unlike many geometry libraries, S2 is primarily designed to work with spherical geometry, i.e., shapes drawn on a sphere rather than on a planar 2D map. This makes it especially suitable for working with geographic data.
- [Computational Geometry Unity Library](https://github.com/Habrador/Computational-geometry) [![GitHub stars](https://img.shields.io/github/stars/Habrador/Computational-geometry?style=flat)](https://github.com/Habrador/Computational-geometry/stargazers) - A library of computational geometry algorithms for Unity.
