...
> 来源：[willianjusten/awesome-audio-visualization](https://github.com/willianjusten/awesome-audio-visualization)

[![GitHub stars](https://img.shields.io/github/stars/willianjusten/awesome-audio-visualization?style=flat)](https://github.com/willianjusten/awesome-audio-visualization/stargazers)
...
- [Cava](https://github.com/karlstav/cava#latency-notes) [![GitHub stars](https://img.shields.io/github/stars/karlstav/cava?style=flat)](https://github.com/karlstav/cava/stargazers) - A cross-platform terminal visualizer. 


## Experiments

- [Master Pro Audio Analyzer Suite](https://github.com/varunmaurya-git/Master-Pro-Audio-Analyzer) [![GitHub stars](https://img.shields.io/github/stars/varunmaurya-git/Master-Pro-Audio-Analyzer?style=flat)](https://github.com/varunmaurya-git/Master-Pro-Audio-Analyzer/stargazers) - 100% private, client-side Web Audio analyzer with 8192-FFT Spectrogram, RTA, and Phase Scope.
...
- - [Multitrack Audio Visualizer](https://github.com/geoffmyers/multitrack-audio-visualizer) [![GitHub stars](https://img.shields.io/github/stars/geoffmyers/multitrack-audio-visualizer?style=flat)](https://github.com/geoffmyers/multitrack-audio-visualizer/stargazers) - A real-time audio/music visualizer that displays multi-track waveforms with customizable colors and can export high-quality MP4/H.265 videos.
...
- [VR Ondes Martenot](https://github.com/elifer5000/vr-ondes-martenot) [![GitHub stars](https://img.shields.io/github/stars/elifer5000/vr-ondes-martenot?style=flat)](https://github.com/elifer5000/vr-ondes-martenot/stargazers) - A playable rendition of the Ondes Martenot in Virtual Reality.
...
- [Weekly Music Visualizations](https://github.com/surayashivji/WeeklyGraphics) [![GitHub stars](https://img.shields.io/github/stars/surayashivji/WeeklyGraphics?style=flat)](https://github.com/surayashivji/WeeklyGraphics/stargazers) Weekly music visualization experiments built with Three.js and p5.js by Suraya Shivji.
- [Audio Visualizer](https://github.com/Teoxoy/audio-visualizer) [![GitHub stars](https://img.shields.io/github/stars/Teoxoy/audio-visualizer?style=flat)](https://github.com/Teoxoy/audio-visualizer/stargazers) - An interesting web audio visualizer built with Pixi.js.
- [YouTube Musical Spectrum](https://github.com/mfcc64/youtube-musical-spectrum) [![GitHub stars](https://img.shields.io/github/stars/mfcc64/youtube-musical-spectrum?style=flat)](https://github.com/mfcc64/youtube-musical-spectrum/stargazers) - A browser extension that offers audio visualization on your YouTube page with nice musical notes.
...
- [p5.js Audio Visualizer](https://amandayehh.github.io/audio-visualizer/) - A powerful, beat- and amplitude-responsive audio visualizer created with [p5.sound](https://github.com/processing/p5.js-sound) [![GitHub stars](https://img.shields.io/github/stars/processing/p5.js-sound?style=flat)](https://github.com/processing/p5.js-sound/stargazers), on an HTML5 Canvas by Amanda Yeh.
...
- [osci-render](https://github.com/jameshball/osci-render) [![GitHub stars](https://img.shields.io/github/stars/jameshball/osci-render?style=flat)](https://github.com/jameshball/osci-render/stargazers) - Software for making music by visualising objects, images, and Blender scenes on an oscilloscope using audio.
...
- [web-audio-analyser](https://github.com/hughsk/web-audio-analyser) [![GitHub stars](https://img.shields.io/github/stars/hughsk/web-audio-analyser?style=flat)](https://github.com/hughsk/web-audio-analyser/stargazers) - A thin wrapper around the Web Audio API that takes an <audio> element and gives you its waveform/frequency data in return.
- [web-audio-player](https://github.com/Jam3/web-audio-player) [![GitHub stars](https://img.shields.io/github/stars/Jam3/web-audio-player?style=flat)](https://github.com/Jam3/web-audio-player/stargazers) - A cross-browser Web Audio player.
- [web-media-playback](https://github.com/hughsk/web-media-playback) [![GitHub stars](https://img.shields.io/github/stars/hughsk/web-media-playback?style=flat)](https://github.com/hughsk/web-media-playback/stargazers) - Retrieve playback and buffering information about audio or video playing in the browser.
- [Pizzicato.js](https://alemangui.github.io/pizzicato/) - Simplify the way you create and manipulate sounds via the Web Audio API.
- [ThreeAudio.js](https://github.com/unconed/ThreeAudio.js) [![GitHub stars](https://img.shields.io/github/stars/unconed/ThreeAudio.js?style=flat)](https://github.com/unconed/ThreeAudio.js/stargazers) - Helps you create music visualizations in Three.js or tQuery.
- [Beeplay.js](https://watilde.github.io/beeplay/) - Write a song In JavaScript.
- [MIDI.js](https://github.com/mudcube/MIDI.js/) [![GitHub stars](https://img.shields.io/github/stars/mudcube/MIDI.js/?style=flat)](https://github.com/mudcube/MIDI.js//stargazers) - Making life easy to create a MIDI-app on the web.
- [Beep.js](https://github.com/stewdio/beep.js) [![GitHub stars](https://img.shields.io/github/stars/stewdio/beep.js?style=flat)](https://github.com/stewdio/beep.js/stargazers) - A JavaScript toolkit for building browser-based synthesizers.
- [p5.sound](https://github.com/processing/p5.js-sound) [![GitHub stars](https://img.shields.io/github/stars/processing/p5.js-sound?style=flat)](https://github.com/processing/p5.js-sound/stargazers) - Brings the Processing approach to Web Audio and p5.js.
...
- [audio-render](https://github.com/audio-lab/render) [![GitHub stars](https://img.shields.io/github/stars/audio-lab/render?style=flat)](https://github.com/audio-lab/render/stargazers) - A pass-through audio stream, providing structure for rendering stream audio data.
- [Octavian](https://github.com/stevekinney/octavian) [![GitHub stars](https://img.shields.io/github/stars/stevekinney/octavian?style=flat)](https://github.com/stevekinney/octavian/stargazers) - Utilities for reasoning about musical notes, frequencies, and intervals
...
- [audiowaveform](https://github.com/bbc/audiowaveform) [![GitHub stars](https://img.shields.io/github/stars/bbc/audiowaveform?style=flat)](https://github.com/bbc/audiowaveform/stargazers) - C++ program to generate waveform data and render waveform images from audio files.
- [Aubio](https://aubio.org) - C library for realtime audio labeling with bindings for Python and PD, support for ofx and Vamp.
- [audio](https://github.com/go-audio/audio) [![GitHub stars](https://img.shields.io/github/stars/go-audio/audio?style=flat)](https://github.com/go-audio/audio/stargazers) - Generic Go package designed to define a common interface to analyze and/or process audio data
- [wav](https://github.com/go-audio/wav) [![GitHub stars](https://img.shields.io/github/stars/go-audio/wav?style=flat)](https://github.com/go-audio/wav/stargazers) - Battle tested Wav decoder/encoder
- [standardized-audio-context](https://github.com/chrisguttandin/standardized-audio-context) [![GitHub stars](https://img.shields.io/github/stars/chrisguttandin/standardized-audio-context?style=flat)](https://github.com/chrisguttandin/standardized-audio-context/stargazers) - A cross-browser implementation of the AudioContext which aims to closely follow the standard.
- [web-audio-beat-detector](https://github.com/chrisguttandin/web-audio-beat-detector) [![GitHub stars](https://img.shields.io/github/stars/chrisguttandin/web-audio-beat-detector?style=flat)](https://github.com/chrisguttandin/web-audio-beat-detector/stargazers) - A beat detection utility which is using the Web Audio API.
- [meyda](https://github.com/meyda/meyda) [![GitHub stars](https://img.shields.io/github/stars/meyda/meyda?style=flat)](https://github.com/meyda/meyda/stargazers) - Audio feature extraction for JavaScript.
...
- [Pixi.js](https://github.com/pixijs/pixi.js/) [![GitHub stars](https://img.shields.io/github/stars/pixijs/pixi.js/?style=flat)](https://github.com/pixijs/pixi.js//stargazers) - A fast lightweight 2D library that works across all devices. The Pixi renderer allows everyone to enjoy the power of hardware acceleration without prior knowledge of WebGL.
...
- [Web Audio Extension](https://github.com/spite/WebAudioExtension) [![GitHub stars](https://img.shields.io/github/stars/spite/WebAudioExtension?style=flat)](https://github.com/spite/WebAudioExtension/stargazers) - A Chrome extension to play with Web Audio.
...
- [The Force](https://github.com/shawnlawson/The_Force) [![GitHub stars](https://img.shields.io/github/stars/shawnlawson/The_Force?style=flat)](https://github.com/shawnlawson/The_Force/stargazers) - Live coded shader editing with audio input.
- [Hylogen](https://github.com/sleexyz/hylogen) [![GitHub stars](https://img.shields.io/github/stars/sleexyz/hylogen?style=flat)](https://github.com/sleexyz/hylogen/stargazers) - Purely functional language embedded in Haskell for expressive live coding of fragment shaders (with audio input).
...
- [Clubber.js](https://github.com/wizgrav/clubber) [![GitHub stars](https://img.shields.io/github/stars/wizgrav/clubber?style=flat)](https://github.com/wizgrav/clubber/stargazers) - Application of music theory in audio reactive visualizations.
...
- [wavebell](https://github.com/skylerlee/wavebell) [![GitHub stars](https://img.shields.io/github/stars/skylerlee/wavebell?style=flat)](https://github.com/skylerlee/wavebell/stargazers) - A javascript voice recorder with realtime waveform, using web microphone
- [Circular Audio Wave](https://github.com/kelvinau/circular-audio-wave) [![GitHub stars](https://img.shields.io/github/stars/kelvinau/circular-audio-wave?style=flat)](https://github.com/kelvinau/circular-audio-wave/stargazers) - A JS library for audio visualization in circular wave using Web Audio API and ECharts
- [Slang](https://github.com/kylestetz/slang) [![GitHub stars](https://img.shields.io/github/stars/kylestetz/slang?style=flat)](https://github.com/kylestetz/slang/stargazers) - An audio programming language built in JS
...
- [Chris Wilson](https://github.com/cwilso/) [![GitHub stars](https://img.shields.io/github/stars/cwilso/?style=flat)](https://github.com/cwilso//stargazers) - Open Web Guy, formerly of Microsoft and now working as a Developer Advocate at Google.
- [Jason Sigal](https://github.com/therewasaguy) [![GitHub stars](https://img.shields.io/github/stars/therewasaguy?style=flat)](https://github.com/therewasaguy/stargazers) - Creative Coder in residence at NYU's and creator of web audio library for p5.js.
- [Shawn Lawson](http://shawnlawson.com/) - An experiential media artist creating the computational sublime.
- [Matt DesLauriers](https://github.com/mattdesl) [![GitHub stars](https://img.shields.io/github/stars/mattdesl?style=flat)](https://github.com/mattdesl/stargazers) - Creative coder at Jam 3.
...
- [Yannis Gravezas](https://github.com/wizgrav) [![GitHub stars](https://img.shields.io/github/stars/wizgrav?style=flat)](https://github.com/wizgrav/stargazers) - A creative coder with several projects featured in chrome experiments, fwa and elsewhere.
...
Your contributions are always welcome! [Click here to read the guidelines](https://github.com/willianjusten/awesome-audio-visualization/blob/master/Contributing.md) [![GitHub stars](https://img.shields.io/github/stars/willianjusten/awesome-audio-visualization/blob/master/Contributing.md?style=flat)](https://github.com/willianjusten/awesome-audio-visualization/blob/master/Contributing.md/stargazers).
...
|:---------------------:|:-------------------:|:-------------------:|
|  [Willian Justen](https://github.com/willianjusten/) [![GitHub stars](https://img.shields.io/github/stars/willianjusten/?style=flat)](https://github.com/willianjusten//stargazers)   |     [Luis Henrique](https://github.com/lhbzr) [![GitHub stars](https://img.shields.io/github/stars/lhbzr?style=flat)](https://github.com/lhbzr/stargazers)    |    [Márcio Ribeiro](https://github.com/marcioshiz) [![GitHub stars](https://img.shields.io/github/stars/marcioshiz?style=flat)](https://github.com/marcioshiz/stargazers)
