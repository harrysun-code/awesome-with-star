...
- [PlotterXY](https://github.com/jamescarruthers/PlotterXY) [![GitHub stars](https://img.shields.io/github/stars/jamescarruthers/PlotterXY?style=flat)](https://github.com/jamescarruthers/PlotterXY/stargazers) - A coreXY plotter made from extrusion, 3d-printed parts, and an inexpensive 3d-printer control board.
...
- [openBrushograph](https://github.com/openBrushograph/openBrushograph_hardware) [![GitHub stars](https://img.shields.io/github/stars/openBrushograph/openBrushograph_hardware?style=flat)](https://github.com/openBrushograph/openBrushograph_hardware/stargazers) - Open source 3d-printable XY gantry and Z-stage designed for automated brush and pen painting.
- [Lego-Pen-Plotter](https://github.com/Jormono1/Lego-Pen-Plotter) [![GitHub stars](https://img.shields.io/github/stars/Jormono1/Lego-Pen-Plotter?style=flat)](https://github.com/Jormono1/Lego-Pen-Plotter/stargazers) - Pen plotter built entirely of LEGO and programmed with PyBricks and Python.
...
- [Apple-410](https://github.com/phooky/Apple-410) [![GitHub stars](https://img.shields.io/github/stars/phooky/Apple-410?style=flat)](https://github.com/phooky/Apple-410/stargazers) - Apple 410 Color Plotter documentation, drivers, and ROM dumps.

### Motor Controllers

Hardware for driving stepper motors and controlling pen plotters.

- [grblShield](https://github.com/synthetos/grblShield) [![GitHub stars](https://img.shields.io/github/stars/synthetos/grblShield?style=flat)](https://github.com/synthetos/grblShield/stargazers) - All the stepper motor control hardware needed to turn an [Arduino](https://www.arduino.cc) into a G-code-based motion controller using the grbl firmware. ([adafruit](https://www.adafruit.com/product/1750))
- [TinyG](https://github.com/synthetos/TinyG) [![GitHub stars](https://img.shields.io/github/stars/synthetos/TinyG?style=flat)](https://github.com/synthetos/TinyG/stargazers) - More featureful and robust 6-axis G-code-based motion control hardware. ([adafruit](https://www.adafruit.com/product/1749))
...
- [Chiplotle](https://github.com/drepetto/chiplotle) [![GitHub stars](https://img.shields.io/github/stars/drepetto/chiplotle?style=flat)](https://github.com/drepetto/chiplotle/stargazers) - Python library for generating HPGL and interfacing with serial plotters.
- [Chiplotle3](https://github.com/cyprienh/chiplotle3) [![GitHub stars](https://img.shields.io/github/stars/cyprienh/chiplotle3?style=flat)](https://github.com/cyprienh/chiplotle3/stargazers) - Chiplotle fork updated for Python 3.x compatibility.
...
- [djipco/hpgl](https://github.com/djipco/hpgl) [![GitHub stars](https://img.shields.io/github/stars/djipco/hpgl?style=flat)](https://github.com/djipco/hpgl/stargazers) - A Node.js library to communicate with HPGL-compatible plotters and printers.
...
- [vec](https://github.com/anachrocomputer/vec) [![GitHub stars](https://img.shields.io/github/stars/anachrocomputer/vec?style=flat)](https://github.com/anachrocomputer/vec/stargazers) - Example C code for generating HPGL, with a turtle graphics interface.
- [d3-hpgl](https://github.com/aubergene/d3-hpgl) [![GitHub stars](https://img.shields.io/github/stars/aubergene/d3-hpgl?style=flat)](https://github.com/aubergene/d3-hpgl/stargazers) - An adapter for the HTML Canvas API so you can output HPGL using the popular [D3](https://d3js.org) library.
- [HPGL Viewer](https://github.com/drskullster/HPGLViewer) [![GitHub stars](https://img.shields.io/github/stars/drskullster/HPGLViewer?style=flat)](https://github.com/drskullster/HPGLViewer/stargazers) - An HPGL Viewer using JavaScript and HTML5 canvas.
- [HPGL Sender](https://github.com/LgHS/hpgl-sender) [![GitHub stars](https://img.shields.io/github/stars/LgHS/hpgl-sender?style=flat)](https://github.com/LgHS/hpgl-sender/stargazers) - A web interface for previewing HPGL and sending it to your plotter.
- [HPGLGraphics](https://github.com/ciaron/HPGLGraphics) [![GitHub stars](https://img.shields.io/github/stars/ciaron/HPGLGraphics?style=flat)](https://github.com/ciaron/HPGLGraphics/stargazers) - A Processing library for writing HPGL files.
- [processing2hpgl](https://github.com/awdriggs/processing2hpgl) [![GitHub stars](https://img.shields.io/github/stars/awdriggs/processing2hpgl?style=flat)](https://github.com/awdriggs/processing2hpgl/stargazers) - A Processing library that allows for direct communication with HPGL pen plotters from within a Processing sketch.
...
- [grbl](https://github.com/grbl/grbl) [![GitHub stars](https://img.shields.io/github/stars/grbl/grbl?style=flat)](https://github.com/grbl/grbl/stargazers) - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
- [cncjs](https://github.com/cncjs/cncjs) [![GitHub stars](https://img.shields.io/github/stars/cncjs/cncjs?style=flat)](https://github.com/cncjs/cncjs/stargazers) - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
- [node-gcode](https://github.com/ryansturmer/node-gcode) [![GitHub stars](https://img.shields.io/github/stars/ryansturmer/node-gcode?style=flat)](https://github.com/ryansturmer/node-gcode/stargazers) - Node.js G-code interpreter and simulator.
- [svg2gcode](https://github.com/em/svg2gcode) [![GitHub stars](https://img.shields.io/github/stars/em/svg2gcode?style=flat)](https://github.com/em/svg2gcode/stargazers) - Node.js command line utility for converting SVG to G-code.
- [svg2gcode](https://github.com/vishpat/svg2gcode) [![GitHub stars](https://img.shields.io/github/stars/vishpat/svg2gcode?style=flat)](https://github.com/vishpat/svg2gcode/stargazers) - Python utility for fast SVG to G-code conversion.
- [jscut](http://jscut.org/) - A web-based utility for converting SVG to G-code.
- [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) [![GitHub stars](https://img.shields.io/github/stars/winder/Universal-G-Code-Sender?style=flat)](https://github.com/winder/Universal-G-Code-Sender/stargazers) - Java-based grbl-compatible cross-platform G-code sender.
- [ChiliPeppr Hardware Fiddle](http://chilipeppr.com) - Modular web-based workspaces to visualize G-code and control hardware.
- [gcode-generative-for-processing](https://github.com/o0morgan0o/gcode-generative-for-processing) [![GitHub stars](https://img.shields.io/github/stars/o0morgan0o/gcode-generative-for-processing?style=flat)](https://github.com/o0morgan0o/gcode-generative-for-processing/stargazers) - Processing library, aiming to create gcode from simple shapes. (Designed for usage with the Creality CR10)
- [gcodeplot](https://github.com/arpruss/gcodeplot) [![GitHub stars](https://img.shields.io/github/stars/arpruss/gcodeplot?style=flat)](https://github.com/arpruss/gcodeplot/stargazers) - Python utility to convert SVG and HPGL to G-code for a 3-axis CNC machine.
...
- [axidraw](https://github.com/evil-mad/axidraw) [![GitHub stars](https://img.shields.io/github/stars/evil-mad/axidraw?style=flat)](https://github.com/evil-mad/axidraw/stargazers) - Official AxiDraw extensions for Inkscape.
- [axi](https://github.com/fogleman/axi) [![GitHub stars](https://img.shields.io/github/stars/fogleman/axi?style=flat)](https://github.com/fogleman/axi/stargazers) - Unofficial Python library for the AxiDraw v3.
- [bCNC](https://github.com/vlachoudis/bCNC) [![GitHub stars](https://img.shields.io/github/stars/vlachoudis/bCNC?style=flat)](https://github.com/vlachoudis/bCNC/stargazers) - Cross-platform G-code sender and CNC control software for grbl.
- [xy](https://github.com/fogleman/xy) [![GitHub stars](https://img.shields.io/github/stars/fogleman/xy?style=flat)](https://github.com/fogleman/xy/stargazers) - Utilities for the Makeblock XY Plotter Robot Kit.
- [LaserGRBL](https://github.com/arkypita/LaserGRBL) [![GitHub stars](https://img.shields.io/github/stars/arkypita/LaserGRBL?style=flat)](https://github.com/arkypita/LaserGRBL/stargazers) - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
- [Line-us Inkscape Plugin](https://github.com/Line-us/Inkscape-Plugin) [![GitHub stars](https://img.shields.io/github/stars/Line-us/Inkscape-Plugin?style=flat)](https://github.com/Line-us/Inkscape-Plugin/stargazers) - Sends drawings to the Line-us plotter directly from Inkscape.
- [Line-us API Examples](https://github.com/Line-us/Line-us-Programming) [![GitHub stars](https://img.shields.io/github/stars/Line-us/Line-us-Programming?style=flat)](https://github.com/Line-us/Line-us-Programming/stargazers) - Example code for the Line-us plotter's G-code-based API.
- [@beardicus/line-us](https://github.com/beardicus/line-us) [![GitHub stars](https://img.shields.io/github/stars/beardicus/line-us?style=flat)](https://github.com/beardicus/line-us/stargazers) - JavaScript library for controlling the Line-us machine from Node or the browser.
- [PenPlotter](https://github.com/RickMcConney/PenPlotter) [![GitHub stars](https://img.shields.io/github/stars/RickMcConney/PenPlotter?style=flat)](https://github.com/RickMcConney/PenPlotter/stargazers) - Polargraph controller that uses repetier firmware.
- [Makelangelo-firmware](https://github.com/MarginallyClever/Makelangelo-firmware) [![GitHub stars](https://img.shields.io/github/stars/MarginallyClever/Makelangelo-firmware?style=flat)](https://github.com/MarginallyClever/Makelangelo-firmware/stargazers) - Firmware for the Makelangelo polargraph robot.
- [RoboPaint](https://github.com/evil-mad/robopaint) [![GitHub stars](https://img.shields.io/github/stars/evil-mad/robopaint?style=flat)](https://github.com/evil-mad/robopaint/stargazers) - Software for the WaterColorBot.
- [AxiTurtle](https://github.com/ralphcrutzen/AxiTurtle) [![GitHub stars](https://img.shields.io/github/stars/ralphcrutzen/AxiTurtle?style=flat)](https://github.com/ralphcrutzen/AxiTurtle/stargazers) - Turtle graphics for AxiDraw in Processing.
- [GRBL-Plotter](https://github.com/svenhb/GRBL-Plotter) [![GitHub stars](https://img.shields.io/github/stars/svenhb/GRBL-Plotter?style=flat)](https://github.com/svenhb/GRBL-Plotter/stargazers) - Plotter-optimized Windows GUI for grbl controller with SVG and DXF import, and flexible pen up/down control.
- [saxi](https://github.com/nornagon/saxi) [![GitHub stars](https://img.shields.io/github/stars/nornagon/saxi?style=flat)](https://github.com/nornagon/saxi/stargazers) - Driver and library for the AxiDraw. Uses constant-acceleration motion planning and automatically resizes to paper.
- [MP2300-Tools](https://github.com/Jan--Henrik/MP2300-Tools) [![GitHub stars](https://img.shields.io/github/stars/Jan--Henrik/MP2300-Tools?style=flat)](https://github.com/Jan--Henrik/MP2300-Tools/stargazers) - Software for converting HPGL to Graphtec's GPGL format, as well as CAD files for a Graphtec plotter pen adapter.
- [Inkcut](https://github.com/inkcut/inkcut) [![GitHub stars](https://img.shields.io/github/stars/inkcut/inkcut?style=flat)](https://github.com/inkcut/inkcut/stargazers) - Application for controlling 2D plotters, cutters, engravers, and CNC machines.
- [plottie](https://github.com/mossblaser/plottie) [![GitHub stars](https://img.shields.io/github/stars/mossblaser/plottie?style=flat)](https://github.com/mossblaser/plottie/stargazers) - Command-line tool for controlling Silhouette plotters and cutters with SVG input.
- [py_silhouette](https://github.com/mossblaser/py_silhouette) [![GitHub stars](https://img.shields.io/github/stars/mossblaser/py_silhouette?style=flat)](https://github.com/mossblaser/py_silhouette/stargazers) - Python library for controlling Silhouette plotters and cutters.
- [pypenwriter](https://github.com/Lana-chan/pypenwriter) [![GitHub stars](https://img.shields.io/github/stars/Lana-chan/pypenwriter?style=flat)](https://github.com/Lana-chan/pypenwriter/stargazers) - Python script to convert and send SVG drawings to the Panasonic PenWriter family of typewriter plotters.
...
- [ln](https://github.com/fogleman/ln) [![GitHub stars](https://img.shields.io/github/stars/fogleman/ln?style=flat)](https://github.com/fogleman/ln/stargazers) - Vector-based 3D renderer written in Go.
- [autotrace](https://github.com/autotrace/autotrace) [![GitHub stars](https://img.shields.io/github/stars/autotrace/autotrace?style=flat)](https://github.com/autotrace/autotrace/stargazers) - Converts bitmap images to vector graphics.
- [stipplegen](https://github.com/evil-mad/stipplegen) [![GitHub stars](https://img.shields.io/github/stars/evil-mad/stipplegen?style=flat)](https://github.com/evil-mad/stipplegen/stargazers) - Creates interesting stippled drawings from bitmap images. ([blog post](https://www.evilmadscientist.com/2012/stipplegen2))
- [SquiggleDraw](https://github.com/gwygonik/SquiggleDraw/commits/master) [![GitHub stars](https://img.shields.io/github/stars/gwygonik/SquiggleDraw/commits/master?style=flat)](https://github.com/gwygonik/SquiggleDraw/commits/master/stargazers) - "SquiggleDraw will create a SVG file from an image, using the brightness to change the amplitude of sine waves".
- [svgurt](https://svgurt.com) - Web-based PNG to SVG creative noodler.
- [maptrace](https://github.com/mzucker/maptrace) [![GitHub stars](https://img.shields.io/github/stars/mzucker/maptrace?style=flat)](https://github.com/mzucker/maptrace/stargazers) - Produce watertight polygonal vector maps by tracing raster images.
- [Drawbot_image_to_gcode_v2](https://github.com/Scott-Cooper/Drawbot_image_to_gcode_v2) [![GitHub stars](https://img.shields.io/github/stars/Scott-Cooper/Drawbot_image_to_gcode_v2?style=flat)](https://github.com/Scott-Cooper/Drawbot_image_to_gcode_v2/stargazers) - Creates G-code for use on drawbots.
- [blackstripes](https://github.com/fullscreennl/blackstripes-python-extensions) [![GitHub stars](https://img.shields.io/github/stars/fullscreennl/blackstripes-python-extensions?style=flat)](https://github.com/fullscreennl/blackstripes-python-extensions/stargazers) - Turns a PNG image into a SVG line drawing.
- [penplot](https://github.com/mattdesl/penplot) [![GitHub stars](https://img.shields.io/github/stars/mattdesl/penplot?style=flat)](https://github.com/mattdesl/penplot/stargazers) - A development environment for plotter art in JavaScript.
- [penkit](https://github.com/paulgb/penkit) [![GitHub stars](https://img.shields.io/github/stars/paulgb/penkit?style=flat)](https://github.com/paulgb/penkit/stargazers) - A Python library for creating line-based SVG graphics.
- [generativeExamples](https://github.com/digitalcoleman/generativeExamples) [![GitHub stars](https://img.shields.io/github/stars/digitalcoleman/generativeExamples?style=flat)](https://github.com/digitalcoleman/generativeExamples/stargazers) - Example Processing code that generates plottable PDFs.
...
- [scribbleplot](https://github.com/bleeptrack/scribbleplot) [![GitHub stars](https://img.shields.io/github/stars/bleeptrack/scribbleplot?style=flat)](https://github.com/bleeptrack/scribbleplot/stargazers) - Scribbly image transformations in Processing.
...
- [cozyvec](https://github.com/brubsby/cozyvec) [![GitHub stars](https://img.shields.io/github/stars/brubsby/cozyvec?style=flat)](https://github.com/brubsby/cozyvec/stargazers) - Web/Standalone terminal environment for plotter art and tweet plots.
...
- [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) [![GitHub stars](https://img.shields.io/github/stars/SonarSonic/DrawingBotV3?style=flat)](https://github.com/SonarSonic/DrawingBotV3/stargazers) - Cross-platform software for converting images to line drawings.
- [linedraw](https://github.com/LingDong-/linedraw) [![GitHub stars](https://img.shields.io/github/stars/LingDong-/linedraw?style=flat)](https://github.com/LingDong-/linedraw/stargazers) - Python tool to convert images to sketchy vector line drawings.
...
- [plotting-maps](https://github.com/piebro/plotting-maps) [![GitHub stars](https://img.shields.io/github/stars/piebro/plotting-maps?style=flat)](https://github.com/piebro/plotting-maps/stargazers) - A simple web tool to create OpenStreetMap SVG maps for plotting.
- [ThreadPlotter](https://github.com/LiciaHe/threadPlotter) [![GitHub stars](https://img.shields.io/github/stars/LiciaHe/threadPlotter?style=flat)](https://github.com/LiciaHe/threadPlotter/stargazers) - "A toolkit for the design and fabrication of delicate punch needle embroidery using X-Y plotters".
...
- [svgsort](https://github.com/inconvergent/svgsort) [![GitHub stars](https://img.shields.io/github/stars/inconvergent/svgsort?style=flat)](https://github.com/inconvergent/svgsort/stargazers) - Path planning for plotting SVG files, reduces time spent moving with the pen up.
- [svgoutline](https://github.com/mossblaser/svgoutline) [![GitHub stars](https://img.shields.io/github/stars/mossblaser/svgoutline?style=flat)](https://github.com/mossblaser/svgoutline/stargazers) - Python library to extract strokes and outlines from SVGs as line segments.
- [svgo](https://github.com/svg/svgo) [![GitHub stars](https://img.shields.io/github/stars/svg/svgo?style=flat)](https://github.com/svg/svgo/stargazers) - Node.js-based tool for optimizing SVG files.
- [Polargraph Optimizer](https://github.com/ezheidtmann/polargraph-optimizer) [![GitHub stars](https://img.shields.io/github/stars/ezheidtmann/polargraph-optimizer?style=flat)](https://github.com/ezheidtmann/polargraph-optimizer/stargazers) - Optimize drawing plan for a polargraph.
- [penkit-optimize](https://github.com/paulgb/penkit/tree/master/optimizer) [![GitHub stars](https://img.shields.io/github/stars/paulgb/penkit/tree/master/optimizer?style=flat)](https://github.com/paulgb/penkit/tree/master/optimizer/stargazers) - An SVG optimizer that uses a vehicle routing solver to minimize plot time.
- [svg-crowbar](https://github.com/NYTimes/svg-crowbar) [![GitHub stars](https://img.shields.io/github/stars/NYTimes/svg-crowbar?style=flat)](https://github.com/NYTimes/svg-crowbar/stargazers) - Chrome-only bookmarklet for extracting SVG from an HTML document.
- [vpype](https://github.com/abey79/vpype) [![GitHub stars](https://img.shields.io/github/stars/abey79/vpype?style=flat)](https://github.com/abey79/vpype/stargazers) - Plotter-focused Python-based CLI utility for generating and manipulating SVGs, including scaling and optimizing paths.
...
- [hershey-fonts](https://github.com/kamalmostafa/hershey-fonts) [![GitHub stars](https://img.shields.io/github/stars/kamalmostafa/hershey-fonts?style=flat)](https://github.com/kamalmostafa/hershey-fonts/stargazers) - C library and original font data for the Hershey fonts.
...
- [hf2gcode](https://github.com/Andy1978/hf2gcode) [![GitHub stars](https://img.shields.io/github/stars/Andy1978/hf2gcode?style=flat)](https://github.com/Andy1978/hf2gcode/stargazers) - Generates G-code from text with a Hershey font.
- [FifteenTwenty: Commodore 1520 plotter font](https://github.com/scruss/FifteenTwenty) [![GitHub stars](https://img.shields.io/github/stars/scruss/FifteenTwenty?style=flat)](https://github.com/scruss/FifteenTwenty/stargazers) - [Blog post](https://scruss.com/blog/2016/04/23/fifteentwenty-commodore-1520-plotter-font/) about the creation of this font from the original ROM.
...
- [Roland DPX-3300 Operation Manual (GitHub)](https://github.com/sismoke/Roland-DPX-3300/blob/master/manual/DPX-3300.pdf) [![GitHub stars](https://img.shields.io/github/stars/sismoke/Roland-DPX-3300/blob/master/manual/DPX-3300.pdf?style=flat)](https://github.com/sismoke/Roland-DPX-3300/blob/master/manual/DPX-3300.pdf/stargazers)
...
- [awesome-generative-art](https://github.com/kosmos/awesome-generative-art) [![GitHub stars](https://img.shields.io/github/stars/kosmos/awesome-generative-art?style=flat)](https://github.com/kosmos/awesome-generative-art/stargazers)
- [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) [![GitHub stars](https://img.shields.io/github/stars/terkelg/awesome-creative-coding?style=flat)](https://github.com/terkelg/awesome-creative-coding/stargazers)
- [awesome-3d-engines-for-plotters](https://github.com/msurguy/awesome-3d-engines-for-plotters) [![GitHub stars](https://img.shields.io/github/stars/msurguy/awesome-3d-engines-for-plotters?style=flat)](https://github.com/msurguy/awesome-3d-engines-for-plotters/stargazers)
