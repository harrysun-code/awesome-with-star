...
- [Waves on GitHub](https://github.com/wavesplatform/) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/?style=flat)](https://github.com/wavesplatform//stargazers)
- [Documentation](https://docs.wavesprotocol.org/)

## Learn

- [Ride introduction](https://github.com/wavesplatform/ride-introduction) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/ride-introduction?style=flat)](https://github.com/wavesplatform/ride-introduction/stargazers) - Shortest and simplest explanation of Ride.\
...
- [WavesFX](https://github.com/wavesfx/wavesfx) [![GitHub stars](https://img.shields.io/github/stars/wavesfx/wavesfx?style=flat)](https://github.com/wavesfx/wavesfx/stargazers) - A community-driven native desktop wallet for Windows, macOS and Linux, which offers users multi-network and multi-address functionality.
...
- [w8io](https://w8io.ru/) - Blockchain explorer by [deemru](https://github.com/deemru) [![GitHub stars](https://img.shields.io/github/stars/deemru?style=flat)](https://github.com/deemru/stargazers).
...
- [Node](https://github.com/wavesplatform/Waves) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/Waves?style=flat)](https://github.com/wavesplatform/Waves/stargazers) - Waves Node repository on GitHub.
- [GRPC Server](https://grpc.wavesnodes.com:6870) - Public GRPC interface for Mainnet.
- [Go Node](https://github.com/wavesplatform/gowaves) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/gowaves?style=flat)](https://github.com/wavesplatform/gowaves/stargazers) - Go libraries and tools for Waves blockchain, alternative implementation of Node (work in progress).
...
- [ride-examples](https://github.com/wavesplatform/ride-examples) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/ride-examples?style=flat)](https://github.com/wavesplatform/ride-examples/stargazers) - Examples of scripts for accounts and assets using Ride.
...
- [vim-ride](https://github.com/rosmanov/vim-ride) [![GitHub stars](https://img.shields.io/github/stars/rosmanov/vim-ride?style=flat)](https://github.com/rosmanov/vim-ride/stargazers) - Vim plugin for Ride syntax highlighting.
- [surfboard](https://github.com/wavesplatform/Surfboard) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/Surfboard?style=flat)](https://github.com/wavesplatform/Surfboard/stargazers) - CLI to work with the Ride language and testing.
- [Paddle](https://github.com/msmolyakov/paddle) [![GitHub stars](https://img.shields.io/github/stars/msmolyakov/paddle?style=flat)](https://github.com/msmolyakov/paddle/stargazers) - Java library to write tests for your dApps and other smart contracts.

### Client libraries
#### C/C++
- [waves-c](https://github.com/wavesplatform/waves-c) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/waves-c?style=flat)](https://github.com/wavesplatform/waves-c/stargazers) - C library to work with Waves.
- [wavespp](https://github.com/wavesplatform/wavespp) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/wavespp?style=flat)](https://github.com/wavesplatform/wavespp/stargazers) - C++ wrapper for the [waves-c](https://github.com/wavesplatform/waves-c) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/waves-c?style=flat)](https://github.com/wavesplatform/waves-c/stargazers) library.
- [nanos-app-waves](https://github.com/wavesplatform/nanos-app-waves) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/nanos-app-waves?style=flat)](https://github.com/wavesplatform/nanos-app-waves/stargazers) - Waves wallet application for Ledger Nano S.
#### C#
- [WavesCS](https://github.com/wavesplatform/WavesCS) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/WavesCS?style=flat)](https://github.com/wavesplatform/WavesCS/stargazers) - C# library to interact with the Waves blockchain.
#### Java/Kotlin
- [WavesSDK-android](https://github.com/wavesplatform/WavesSDK-android) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/WavesSDK-android?style=flat)](https://github.com/wavesplatform/WavesSDK-android/stargazers) - Kotlin SDK for Mobile Apps on Android.
- [WavesJ](https://github.com/wavesplatform/WavesJ) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/WavesJ?style=flat)](https://github.com/wavesplatform/WavesJ/stargazers) - Java library to interact with the Waves blockchain and DEX.
- [waves-crypto-java](https://github.com/msmolyakov/waves-crypto-java) [![GitHub stars](https://img.shields.io/github/stars/msmolyakov/waves-crypto-java?style=flat)](https://github.com/msmolyakov/waves-crypto-java/stargazers) - Library to work with cryptographic primitives used in the Waves blockchain.
#### JavaScript/TypeScript
- [Waves Signer](https://github.com/wavesplatform/signer) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/signer?style=flat)](https://github.com/wavesplatform/signer/stargazers) - library to interact with the Waves blockchain from your web app ([example provider](https://github.com/waves-exchange/provider-web) [![GitHub stars](https://img.shields.io/github/stars/waves-exchange/provider-web?style=flat)](https://github.com/waves-exchange/provider-web/stargazers)).
- [vue-waves-signer](https://github.com/opensolutionsweb3/vue-waves-signer) [![GitHub stars](https://img.shields.io/github/stars/opensolutionsweb3/vue-waves-signer?style=flat)](https://github.com/opensolutionsweb3/vue-waves-signer/stargazers) - Waves Signer implementation for Vue.js.
- [pay-crypto-widget](https://github.com/vlzhr/pay-crypto-widget) [![GitHub stars](https://img.shields.io/github/stars/vlzhr/pay-crypto-widget?style=flat)](https://github.com/vlzhr/pay-crypto-widget/stargazers) - JS widget for accepting crypto payments on your website.
- [crypto-donate](https://github.com/vlzhr/crypto-donate) [![GitHub stars](https://img.shields.io/github/stars/vlzhr/crypto-donate?style=flat)](https://github.com/vlzhr/crypto-donate/stargazers) - HTML widget allowing to donate Waves tokens to content authors.
- [waves-transactions](https://github.com/wavesplatform/waves-transactions) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/waves-transactions?style=flat)](https://github.com/wavesplatform/waves-transactions/stargazers) - JS library to build and sign transactions.
- [ts-lib-crypto](https://github.com/wavesplatform/ts-lib-crypto) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/ts-lib-crypto?style=flat)](https://github.com/wavesplatform/ts-lib-crypto/stargazers) - Typescript implementations like signature verification and protocol entries used in Waves protocol.
#### Go
- [go-lib-crypto](https://github.com/wavesplatform/go-lib-crypto) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/go-lib-crypto?style=flat)](https://github.com/wavesplatform/go-lib-crypto/stargazers) - GoLang implementation of the unified crypto primitives for Waves.
#### PHP
- [WavesKit](https://github.com/deemru/WavesKit) [![GitHub stars](https://img.shields.io/github/stars/deemru/WavesKit?style=flat)](https://github.com/deemru/WavesKit/stargazers) - All-in-one Waves Platform development kit for the PHP language.
#### Python
- [PyWaves](https://github.com/PyWaves/PyWaves) [![GitHub stars](https://img.shields.io/github/stars/PyWaves/PyWaves?style=flat)](https://github.com/PyWaves/PyWaves/stargazers) - Object-oriented library for the Waves blockchain platform.
- [ERC20 Gateway Framework](https://github.com/PyWaves/Waves-ERC20-Gateway) [![GitHub stars](https://img.shields.io/github/stars/PyWaves/Waves-ERC20-Gateway?style=flat)](https://github.com/PyWaves/Waves-ERC20-Gateway/stargazers) - Allows to easily establish a gateway between any ERC-20 token and the Waves blockchain ([example](https://github.com/iammortimer/TN-WAVES-Gateway) [![GitHub stars](https://img.shields.io/github/stars/iammortimer/TN-WAVES-Gateway?style=flat)](https://github.com/iammortimer/TN-WAVES-Gateway/stargazers)).
- [Waves-Gateway-Framework](https://github.com/jansenmarc/WavesGatewayFramework) [![GitHub stars](https://img.shields.io/github/stars/jansenmarc/WavesGatewayFramework?style=flat)](https://github.com/jansenmarc/WavesGatewayFramework/stargazers) - A framework to connect other cryptocurrencies to the Waves blockchain ([LTC example](https://github.com/jansenmarc/WavesGatewayLTCExample) [![GitHub stars](https://img.shields.io/github/stars/jansenmarc/WavesGatewayLTCExample?style=flat)](https://github.com/jansenmarc/WavesGatewayLTCExample/stargazers)).
#### Rust
- [WavesRS](https://github.com/petermz/WavesRs) [![GitHub stars](https://img.shields.io/github/stars/petermz/WavesRs?style=flat)](https://github.com/petermz/WavesRs/stargazers) - A Rust interface for the Waves blockchain.
- [waves-lib-rust](https://github.com/waves-rust/waves-lib-rust) [![GitHub stars](https://img.shields.io/github/stars/waves-rust/waves-lib-rust?style=flat)](https://github.com/waves-rust/waves-lib-rust/stargazers) - Library to work with Waves blockchain.
#### Swift
- [WavesSDK-iOS](https://github.com/wavesplatform/WavesSDK-iOS) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/WavesSDK-iOS?style=flat)](https://github.com/wavesplatform/WavesSDK-iOS/stargazers) - SDK for Mobile Apps on iOS.

### Blockchain utils
- [chaincmp](https://github.com/wavesplatform/gowaves/blob/master/cmd/chaincmp) [![GitHub stars](https://img.shields.io/github/stars/wavesplatform/gowaves/blob/master/cmd/chaincmp?style=flat)](https://github.com/wavesplatform/gowaves/blob/master/cmd/chaincmp/stargazers) - Utility to compare blockchains on a different nodes.
- [Node Tools extension](https://github.com/msmolyakov/waves-node-tools-extension) [![GitHub stars](https://img.shields.io/github/stars/msmolyakov/waves-node-tools-extension?style=flat)](https://github.com/msmolyakov/waves-node-tools-extension/stargazers) - Waves Node extension to allow miner to automate payouts for its lessors and to receive notifications about mining progress.
- [Nodes on map](http://waves-nodes-map.ikardanov.com/) - All nodes of the Waves Mainnet on the world map.

### Other tools
- [sh-Ride-brush](https://github.com/msmolyakov/sh-Ride-brush) [![GitHub stars](https://img.shields.io/github/stars/msmolyakov/sh-Ride-brush?style=flat)](https://github.com/msmolyakov/sh-Ride-brush/stargazers) - SyntaxHighlighter brush for the Ride language.
- [Ride for Pygments](https://github.com/pygments/pygments/blob/master/pygments/lexers/ride.py) [![GitHub stars](https://img.shields.io/github/stars/pygments/pygments/blob/master/pygments/lexers/ride.py?style=flat)](https://github.com/pygments/pygments/blob/master/pygments/lexers/ride.py/stargazers) - The [Pygments](https://github.com/pygments/pygments) [![GitHub stars](https://img.shields.io/github/stars/pygments/pygments?style=flat)](https://github.com/pygments/pygments/stargazers) highlighter oficially supports the Ride out of the box.
...
- [Neutrino](https://github.com/ventuary-lab/neutrino-contract) [![GitHub stars](https://img.shields.io/github/stars/ventuary-lab/neutrino-contract?style=flat)](https://github.com/ventuary-lab/neutrino-contract/stargazers) - An algorithmic price-stable cryptocurrency protocol collateralized by WAVES token.
...
- [WavesAffi](https://github.com/bettexproject/WavesAffi) [![GitHub stars](https://img.shields.io/github/stars/bettexproject/WavesAffi?style=flat)](https://github.com/bettexproject/WavesAffi/stargazers) - Decentralized affiliate program on Waves blockchain.
