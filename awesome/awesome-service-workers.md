...
- [Service Workers Explained](https://github.com/slightlyoff/ServiceWorker/blob/master/explainer.md) [![GitHub stars](https://img.shields.io/github/stars/slightlyoff/ServiceWorker/blob/master/explainer.md?style=flat)](https://github.com/slightlyoff/ServiceWorker/blob/master/explainer.md/stargazers) - Service workers explained by [Alex Russell](https://github.com/slightlyoff) [![GitHub stars](https://img.shields.io/github/stars/slightlyoff?style=flat)](https://github.com/slightlyoff/stargazers).
...
- [Service Workers 101](https://github.com/delapuente/service-workers-101) [![GitHub stars](https://img.shields.io/github/stars/delapuente/service-workers-101?style=flat)](https://github.com/delapuente/service-workers-101/stargazers) - An infographic summarizing the most important parts of service workers API.
- [ServiceWorker Cookbook by Mozilla](https://serviceworke.rs/) - A collection of recipes for different use cases.
- [The copy & paste guide to your first Service Worker](https://remysharp.com/2016/03/22/the-copy--paste-guide-to-your-first-service-worker) - Shortest available introduction, by [Remy Sharp](https://github.com/remy) [![GitHub stars](https://img.shields.io/github/stars/remy?style=flat)](https://github.com/remy/stargazers).
...
- [sw-toolbox](https://github.com/GoogleChrome/sw-toolbox/) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/sw-toolbox/?style=flat)](https://github.com/GoogleChrome/sw-toolbox//stargazers) - A collection of simple helpers to simplify implementing common runtime caching patterns.
...
- [sw-precache](https://github.com/GoogleChrome/sw-precache/) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/sw-precache/?style=flat)](https://github.com/GoogleChrome/sw-precache//stargazers) - Generates a service worker to cache your local App Shell resources.
