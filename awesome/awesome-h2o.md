...
> 来源：[h2oai/awesome-h2o](https://github.com/h2oai/awesome-h2o)

[![GitHub stars](https://img.shields.io/github/stars/h2oai/awesome-h2o?style=flat)](https://github.com/h2oai/awesome-h2o/stargazers)
...
[<img src="https://rawgit.com/h2oai/awesome-h2o/master/h2o_logo.png" align="right" width="100">](https://github.com/h2oai/h2o-3) [![GitHub stars](https://img.shields.io/github/stars/h2oai/h2o-3?style=flat)](https://github.com/h2oai/h2o-3/stargazers)

Below is a curated list of all the awesome projects, applications, research, tutorials, courses and books that use [H2O](https://github.com/h2oai/h2o-3) [![GitHub stars](https://img.shields.io/github/stars/h2oai/h2o-3?style=flat)](https://github.com/h2oai/h2o-3/stargazers), an open source, distributed machine learning platform.  H2O offers parallelized implementations of many supervised and unsupervised machine learning algorithms such as Generalized Linear Models, Gradient Boosting Machines (including XGBoost), Random Forests, Deep Neural Networks (Deep Learning), Stacked Ensembles, Naive Bayes, Cox Proportional Hazards, K-means, PCA, Word2Vec, as well as a fully automatic machine learning algorithm (AutoML).

[H2O.ai](http://www.h2o.ai/about/) produces many [tutorials](https://github.com/h2oai/h2o-tutorials) [![GitHub stars](https://img.shields.io/github/stars/h2oai/h2o-tutorials?style=flat)](https://github.com/h2oai/h2o-tutorials/stargazers), [blog posts](http://blog.h2o.ai/), [presentations](https://github.com/h2oai/h2o-meetups) [![GitHub stars](https://img.shields.io/github/stars/h2oai/h2o-meetups?style=flat)](https://github.com/h2oai/h2o-meetups/stargazers) and [videos](https://www.youtube.com/user/0xdata) about H2O, but the list below is comprised of awesome content produced by the greater H2O user community.
...
If you think H2O is awesome too, please ⭐ the [H2O GitHub repository](https://github.com/h2oai/h2o-3/) [![GitHub stars](https://img.shields.io/github/stars/h2oai/h2o-3/?style=flat)](https://github.com/h2oai/h2o-3//stargazers).
...
- [Stock Market Analysis using Stacked Ensemble Learning Method](https://github.com/malhartakle/MastersDissertation/blob/master/Research%20Project%20Report.pdf) [![GitHub stars](https://img.shields.io/github/stars/malhartakle/MastersDissertation/blob/master/Research%20Project%20Report.pdf?style=flat)](https://github.com/malhartakle/MastersDissertation/blob/master/Research%20Project%20Report.pdf/stargazers)  Malkar Takle. (2020)
...
- [Understanding random forests: from theory to practice](https://github.com/glouppe/phd-thesis) [![GitHub stars](https://img.shields.io/github/stars/glouppe/phd-thesis?style=flat)](https://github.com/glouppe/phd-thesis/stargazers) Gilles Louppe. (2014)
...
- [Szilard's machine learning benchmark](https://github.com/szilard/benchm-ml) [![GitHub stars](https://img.shields.io/github/stars/szilard/benchm-ml?style=flat)](https://github.com/szilard/benchm-ml/stargazers) - Benchmarks of Random Forest, GBM, Deep Learning and GLM implementations in common open source ML frameworks. Jul 3, 2015
...
- [University of San Francisco (USF) Distributed Data System Class (MSDS 697)](https://github.com/dianewoodbridge/2020-msds697-example) [![GitHub stars](https://img.shields.io/github/stars/dianewoodbridge/2020-msds697-example?style=flat)](https://github.com/dianewoodbridge/2020-msds697-example/stargazers) - Master of Science in Data Science Program.
...
- [UCLA: Tools in Data Science (STATS 418)](https://github.com/szilard/teach-data-science-UCLA-master-appl-stats) [![GitHub stars](https://img.shields.io/github/stars/szilard/teach-data-science-UCLA-master-appl-stats?style=flat)](https://github.com/szilard/teach-data-science-UCLA-master-appl-stats/stargazers) - Masters of Applied Statistics Program.
- [GWU: Data Mining (Decision Sciences 6279)](https://github.com/jphall663/GWU_data_mining) [![GitHub stars](https://img.shields.io/github/stars/jphall663/GWU_data_mining?style=flat)](https://github.com/jphall663/GWU_data_mining/stargazers) - Masters of Science in Business Analytics.
...
- [Evaporate](https://github.com/ML4LHS/Evaporate) [![GitHub stars](https://img.shields.io/github/stars/ML4LHS/Evaporate?style=flat)](https://github.com/ML4LHS/Evaporate/stargazers): Run H2O models in the browser via Javascript.  More info [here](https://twitter.com/kdpsinghlab/status/1367992786239242248).
- [splash R package](https://github.com/ML4LHS/splash) [![GitHub stars](https://img.shields.io/github/stars/ML4LHS/splash?style=flat)](https://github.com/ML4LHS/splash/stargazers): Splashing a User Interface onto H2O MOJO Files.  More info [here](https://twitter.com/kdpsinghlab/status/1367809740705792008).
- [h2oparsnip R package](https://github.com/stevenpawley/h2oparsnip) [![GitHub stars](https://img.shields.io/github/stars/stevenpawley/h2oparsnip?style=flat)](https://github.com/stevenpawley/h2oparsnip/stargazers): Set of wrappers to bind h2o algorthms with the [parsnip](https://parsnip.tidymodels.org/) package.
- [Spin up PySpark and PySparkling on AWS](https://github.com/kcrandall/EMR_Spark_Automation) [![GitHub stars](https://img.shields.io/github/stars/kcrandall/EMR_Spark_Automation?style=flat)](https://github.com/kcrandall/EMR_Spark_Automation/stargazers)
- [Forecast the US demand for electricity](https://github.com/RamiKrispin/USelectricity) [![GitHub stars](https://img.shields.io/github/stars/RamiKrispin/USelectricity?style=flat)](https://github.com/RamiKrispin/USelectricity/stargazers): A real-time [dashboard](https://ramikrispin.github.io/USelectricity/) of the US electricity demand (forecast using H2O GLM)
- [h2o3-pam](https://github.com/navdeep-G/h2o3-pam) [![GitHub stars](https://img.shields.io/github/stars/navdeep-G/h2o3-pam?style=flat)](https://github.com/navdeep-G/h2o3-pam/stargazers): Partition Around Mediods (PAM) clustering algorithm in H2O-3
- [h2o3-gapstat](https://github.com/navdeep-G/h2o3-gapstat) [![GitHub stars](https://img.shields.io/github/stars/navdeep-G/h2o3-gapstat?style=flat)](https://github.com/navdeep-G/h2o3-gapstat/stargazers): Gap Statistic algorithm in H2O-3
