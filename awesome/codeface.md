...
Each typeface directory in the repository now includes a vertical metrics table (`vertical_metrics.txt`).  Combine the data in these reference tables with the new [`font-line` tool](https://github.com/source-foundry/font-line) [![GitHub stars](https://img.shields.io/github/stars/source-foundry/font-line?style=flat)](https://github.com/source-foundry/font-line/stargazers) to modify any font to the line spacing that suits your needs.  Tighten up or keep it loose.
...
| Archive  | SHA1  | Size |
| :------------: |:---------------:| :-----:|
| [codeface-fonts.zip](https://github.com/chrissimpkins/codeface/releases/download/font-collection/codeface-fonts.zip) [![GitHub stars](https://img.shields.io/github/stars/chrissimpkins/codeface/releases/download/font-collection/codeface-fonts.zip?style=flat)](https://github.com/chrissimpkins/codeface/releases/download/font-collection/codeface-fonts.zip/stargazers) | `4709e7b6f63d1e2c31f7af0d56b7e1f75a846476` | 31.4 MB |
| [codeface-fonts.tar.xz](https://github.com/chrissimpkins/codeface/releases/download/font-collection/codeface-fonts.tar.xz) [![GitHub stars](https://img.shields.io/github/stars/chrissimpkins/codeface/releases/download/font-collection/codeface-fonts.tar.xz?style=flat)](https://github.com/chrissimpkins/codeface/releases/download/font-collection/codeface-fonts.tar.xz/stargazers) | `e4416c72e331d71e55fd56f2fba38cfda7672f85` | 16.5 MB |
