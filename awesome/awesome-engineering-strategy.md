...
- [Context mapping](https://github.com/ddd-crew/context-mapping) [![GitHub stars](https://img.shields.io/github/stars/ddd-crew/context-mapping?style=flat)](https://github.com/ddd-crew/context-mapping/stargazers) - Visualize the contract between bounded contexts and teams with a collection of patterns.
- [Core domain charts](https://github.com/ddd-crew/core-domain-charts) [![GitHub stars](https://img.shields.io/github/stars/ddd-crew/core-domain-charts?style=flat)](https://github.com/ddd-crew/core-domain-charts/stargazers) - Help you to visualise the strategic importance of each (sub)domain or business capability in your architecture allowing you to make business model-aligned architectural decisions.
