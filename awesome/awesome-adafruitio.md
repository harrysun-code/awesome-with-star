...
- [Adafruit IO Arduino Library](https://github.com/adafruit/Adafruit_IO_Arduino) [![GitHub stars](https://img.shields.io/github/stars/adafruit/Adafruit_IO_Arduino?style=flat)](https://github.com/adafruit/Adafruit_IO_Arduino/stargazers) - An Arduino client for Adafruit IO.
- [Adafruit IO CircuitPython Library](https://github.com/adafruit/Adafruit_CircuitPython_AdafruitIO) [![GitHub stars](https://img.shields.io/github/stars/adafruit/Adafruit_CircuitPython_AdafruitIO?style=flat)](https://github.com/adafruit/Adafruit_CircuitPython_AdafruitIO/stargazers) - A CircuitPython client for Adafruit IO.
- [Adafruit IO Python Library](https://github.com/adafruit/Adafruit_IO_Python) [![GitHub stars](https://img.shields.io/github/stars/adafruit/Adafruit_IO_Python?style=flat)](https://github.com/adafruit/Adafruit_IO_Python/stargazers) - A Python client for Adafruit IO.
- [Adafruit IO Ruby Library](https://github.com/adafruit/io-client-ruby) [![GitHub stars](https://img.shields.io/github/stars/adafruit/io-client-ruby?style=flat)](https://github.com/adafruit/io-client-ruby/stargazers) - A Ruby client for Adafruit IO.
- [Adafruit IO Node.js Library](https://github.com/adafruit/adafruit-io-node) [![GitHub stars](https://img.shields.io/github/stars/adafruit/adafruit-io-node?style=flat)](https://github.com/adafruit/adafruit-io-node/stargazers) - A Node.js Adafruit IO client, local server, and TLS Tunnel.
- [Adafruit IO Go Library](https://github.com/adafruit/io-client-go) [![GitHub stars](https://img.shields.io/github/stars/adafruit/io-client-go?style=flat)](https://github.com/adafruit/io-client-go/stargazers) - A Go client for Adafruit IO.
