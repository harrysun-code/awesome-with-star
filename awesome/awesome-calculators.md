...
> 来源：[xxczaki/awesome-calculators](https://github.com/xxczaki/awesome-calculators)

[![GitHub stars](https://img.shields.io/github/stars/xxczaki/awesome-calculators?style=flat)](https://github.com/xxczaki/awesome-calculators/stargazers)

# Awesome Calculators [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

[<img src="https://i.imgur.com/9q98DcX.png" align="right" width="120">](https://github.com/xxczaki/awesome-calculators) [![GitHub stars](https://img.shields.io/github/stars/xxczaki/awesome-calculators?style=flat)](https://github.com/xxczaki/awesome-calculators/stargazers)

> A curated list of resources related to calculators!

Is your project mentioned in this list? See [mentioned.md](https://github.com/xxczaki/awesome-calculators/blob/master/mentioned.md) [![GitHub stars](https://img.shields.io/github/stars/xxczaki/awesome-calculators/blob/master/mentioned.md?style=flat)](https://github.com/xxczaki/awesome-calculators/blob/master/mentioned.md/stargazers)!
...
- [Droid48 (src)](https://github.com/shagr4th/droid48/tree/master/app/src/main) [![GitHub stars](https://img.shields.io/github/stars/shagr4th/droid48/tree/master/app/src/main?style=flat)](https://github.com/shagr4th/droid48/tree/master/app/src/main/stargazers), [Droid48 (app)](https://play.google.com/store/apps/details?id=org.ab.x48) - Android port of x48, the awesome HP48GX/SX emulator
...
### Windows
- [Windows Calculator](https://github.com/Microsoft/calculator) [![GitHub stars](https://img.shields.io/github/stars/Microsoft/calculator?style=flat)](https://github.com/Microsoft/calculator/stargazers) - Simple yet powerful calculator that ships with Windows
...
- [in-line calculator (AutoHotkey Calculator)](https://github.com/davebrny/in-line-calculator) [![GitHub stars](https://img.shields.io/github/stars/davebrny/in-line-calculator?style=flat)](https://github.com/davebrny/in-line-calculator/stargazers) - Interface-less calculator for Windows that lets you do basic math without having to leave the line you're typing on.
...
### Linux
- [Galculator](https://github.com/galculator/galculator) [![GitHub stars](https://img.shields.io/github/stars/galculator/galculator?style=flat)](https://github.com/galculator/galculator/stargazers) - GTK 2  / GTK 3 based scientific calculator.
- [KCalc](https://github.com/KDE/kcalc) [![GitHub stars](https://img.shields.io/github/stars/KDE/kcalc?style=flat)](https://github.com/KDE/kcalc/stargazers) - Calculator which offers many more mathematical functions than meet the eye on a first glance.
- [x48](https://github.com/gwenhael-le-moine/x48) [![GitHub stars](https://img.shields.io/github/stars/gwenhael-le-moine/x48?style=flat)](https://github.com/gwenhael-le-moine/x48/stargazers) - Emulate the HP48GX/SX, one of the best engineering calculators ever.

### Cross-Platform
- [Parsify Desktop](https://parsify.app) - Extendable calculator for the 21st Century.
- [Simple Electron Calculator](https://github.com/DCKT/electron-calculator) [![GitHub stars](https://img.shields.io/github/stars/DCKT/electron-calculator?style=flat)](https://github.com/DCKT/electron-calculator/stargazers) - Basic, cross-platform calculator made with Electron.
- [elcalc](https://github.com/xxczaki/elcalc) [![GitHub stars](https://img.shields.io/github/stars/xxczaki/elcalc?style=flat)](https://github.com/xxczaki/elcalc/stargazers) - Calculator with simple & beautiful interface.
- [Material Design Calculator](https://github.com/lirios/calculator) [![GitHub stars](https://img.shields.io/github/stars/lirios/calculator?style=flat)](https://github.com/lirios/calculator/stargazers) - Cross-platform material design calculator.
...
- [mdlt](https://github.com/metadelta/mdlt) [![GitHub stars](https://img.shields.io/github/stars/metadelta/mdlt?style=flat)](https://github.com/metadelta/mdlt/stargazers) - Command-line utility for quick math.
- [calc](https://github.com/alfredxing/calc) [![GitHub stars](https://img.shields.io/github/stars/alfredxing/calc?style=flat)](https://github.com/alfredxing/calc/stargazers) - Simple, fast and intuitive command-line calculator written in Go.
- [J# Calculator Barebones](https://github.com/KrzysztofSzewczyk/JSharpCalculator) [![GitHub stars](https://img.shields.io/github/stars/KrzysztofSzewczyk/JSharpCalculator?style=flat)](https://github.com/KrzysztofSzewczyk/JSharpCalculator/stargazers) - Very simple calculator written in J#. Made as program for J# newcomers to extend and learn from.
