...
> 来源：[hobbyquaker/awesome-mqtt](https://github.com/hobbyquaker/awesome-mqtt)
...
- [Keel MQTT Gateway](https://github.com/keel-iot/keel-mqtt-gateway) [![GitHub stars](https://img.shields.io/github/stars/keel-iot/keel-mqtt-gateway?style=flat)](https://github.com/keel-iot/keel-mqtt-gateway/stargazers) - Distributed, cloud-native MQTT broker in Go built on mochi-mqtt, using Raft for strongly-consistent session ownership and ACL, with a gossip-backed routing table (Olric).
...
- [TrailMQ](https://github.com/RainerGewalt/TrailMQ) [![GitHub stars](https://img.shields.io/github/stars/RainerGewalt/TrailMQ?style=flat)](https://github.com/RainerGewalt/TrailMQ/stargazers) - Self-hosted MQTT broker with policy enforcement and a reviewable record of broker decisions, for regulated and industrial systems.
...
- [IoT DC3](https://github.com/pnoker/iot-dc3) [![GitHub stars](https://img.shields.io/github/stars/pnoker/iot-dc3?style=flat)](https://github.com/pnoker/iot-dc3/stargazers) - Fully open-source, distributed industrial IoT platform built on Spring Cloud, with 28 built-in protocol drivers (including MQTT), AI-powered operations via Spring AI, and microservice architecture. ([Docs](https://docs.dc3.site))
...
- [LazyMQTT](https://github.com/ScottFelder/lazymqtt) [![GitHub stars](https://img.shields.io/github/stars/ScottFelder/lazymqtt?style=flat)](https://github.com/ScottFelder/lazymqtt/stargazers) - A fast, terminal-UI MQTT client written in Rust — inspired by MQTT Explorer, but keyboard-driven and living in your terminal.
...
- [MQTTForge](https://github.com/ibrahimilkhan/mqtt-forge) [![GitHub stars](https://img.shields.io/github/stars/ibrahimilkhan/mqtt-forge?style=flat)](https://github.com/ibrahimilkhan/mqtt-forge/stargazers) - Test console that builds a broker's topics into a live tree, shows every frame on the wire, and publishes by hand. Desktop app for macOS, Windows and Linux, or a single Docker image.
...
- [mqtt-typed-client](https://github.com/holovskyi/mqtt-typed-client) [![GitHub stars](https://img.shields.io/github/stars/holovskyi/mqtt-typed-client?style=flat)](https://github.com/holovskyi/mqtt-typed-client/stargazers) - Type-safe async MQTT client built on rumqttc, with derive macros for typed topics, automatic (de)serialization, and tree-based message routing.
...
- [she - smart home engine](https://github.com/hobbyquaker/she) [![GitHub stars](https://img.shields.io/github/stars/hobbyquaker/she?style=flat)](https://github.com/hobbyquaker/she/stargazers) - Scriptable smart home automation engine with AI assistance.
...
- [Feezal](https://github.com/feezal/feezal) [![GitHub stars](https://img.shields.io/github/stars/feezal/feezal?style=flat)](https://github.com/feezal/feezal/stargazers) - Dashboard editor powered by Web Components and MQTT.
...
- [mqtt-dashboard](https://github.com/jmischler72/mqtt-dashboard) [![GitHub stars](https://img.shields.io/github/stars/jmischler72/mqtt-dashboard?style=flat)](https://github.com/jmischler72/mqtt-dashboard/stargazers) - Self-hostable MQTT dashboard/explorer with drag-and-drop panels like cron, button, log and topic browser to help interact and monitor MQTT topics.
