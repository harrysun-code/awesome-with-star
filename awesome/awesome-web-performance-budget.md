...
- [Falco](https://github.com/theodo/falco) [![GitHub stars](https://img.shields.io/github/stars/theodo/falco?style=flat)](https://github.com/theodo/falco/stargazers) - Helps you monitor, analyze, and optimize your websites.

## Build Tools to set up performance budget

- [Bundle Size](https://github.com/siddharthkp/bundlesize) [![GitHub stars](https://img.shields.io/github/stars/siddharthkp/bundlesize?style=flat)](https://github.com/siddharthkp/bundlesize/stargazers) - Keep your bundle size in check.
...
- [Grunt-perfbudget](https://github.com/tkadlec/grunt-perfbudget) [![GitHub stars](https://img.shields.io/github/stars/tkadlec/grunt-perfbudget?style=flat)](https://github.com/tkadlec/grunt-perfbudget/stargazers) - Grunt task for performance budgeting.
- [Size Limit](https://github.com/ai/size-limit) [![GitHub stars](https://img.shields.io/github/stars/ai/size-limit?style=flat)](https://github.com/ai/size-limit/stargazers) - Calculate the real cost to run your JS app or lib to keep good performance. Show error in pull request if the cost exceeds the limit.
- [Size Plugin](https://github.com/GoogleChromeLabs/size-plugin) [![GitHub stars](https://img.shields.io/github/stars/GoogleChromeLabs/size-plugin?style=flat)](https://github.com/GoogleChromeLabs/size-plugin/stargazers) - Track compressed Webpack asset sizes over time.
- [Performance Budget Builder](https://github.com/GoogleChromeLabs/pr-bot) [![GitHub stars](https://img.shields.io/github/stars/GoogleChromeLabs/pr-bot?style=flat)](https://github.com/GoogleChromeLabs/pr-bot/stargazers) - Lay out your template types, set a size budget for each template type, then plug in the sizes for each asset category that will load in the template.
- [Progressive Web Metrics](https://github.com/paulirish/pwmetrics) [![GitHub stars](https://img.shields.io/github/stars/paulirish/pwmetrics?style=flat)](https://github.com/paulirish/pwmetrics/stargazers) - Lay out your template types, set a size budget for each template type, then plug in the sizes for each asset category that will load in the template. 
- [rollup-plugin-size-snapshot](https://github.com/TrySound/rollup-plugin-size-snapshot) [![GitHub stars](https://img.shields.io/github/stars/TrySound/rollup-plugin-size-snapshot?style=flat)](https://github.com/TrySound/rollup-plugin-size-snapshot/stargazers) - CLI tool and lib to gather performance metrics via Lighthouse.
...
- [webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) [![GitHub stars](https://img.shields.io/github/stars/webpack-contrib/webpack-bundle-analyzer?style=flat)](https://github.com/webpack-contrib/webpack-bundle-analyzer/stargazers) - Webpack plugin and CLI utility that represents bundle content as convenient interactive zoomable treemap.
- [Disc](http://hughsk.io/disc/) - Visualise the module tree of browserify project bundles and track down bloat. 
- [lasso-analyzer](https://github.com/ajay2507/lasso-analyzer) [![GitHub stars](https://img.shields.io/github/stars/ajay2507/lasso-analyzer?style=flat)](https://github.com/ajay2507/lasso-analyzer/stargazers) - Analyze and Visualise project bundles created by Lasso.
- [Rollup Visualizer](https://github.com/btd/rollup-plugin-visualizer) [![GitHub stars](https://img.shields.io/github/stars/btd/rollup-plugin-visualizer?style=flat)](https://github.com/btd/rollup-plugin-visualizer/stargazers) - Visualize and analyze your Rollup bundle to see which modules are taking up space.
- [Parcel plugin Visualizer](https://github.com/gregtillbrook/parcel-plugin-bundle-visualiser) [![GitHub stars](https://img.shields.io/github/stars/gregtillbrook/parcel-plugin-bundle-visualiser?style=flat)](https://github.com/gregtillbrook/parcel-plugin-bundle-visualiser/stargazers) - A plugin for the parcel bundler to visualise bundle contents.
- [CSS Analyzer](https://github.com/macbre/analyze-css) [![GitHub stars](https://img.shields.io/github/stars/macbre/analyze-css?style=flat)](https://github.com/macbre/analyze-css/stargazers) - CSS selectors complexity and performance analyzer.
