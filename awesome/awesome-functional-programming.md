...
> 来源：[lucasviola/awesome-functional-programming](https://github.com/lucasviola/awesome-functional-programming)

[![GitHub stars](https://img.shields.io/github/stars/lucasviola/awesome-functional-programming?style=flat)](https://github.com/lucasviola/awesome-functional-programming/stargazers)
...
Based on the [Awesome](https://github.com/sindresorhus/awesome/) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome/?style=flat)](https://github.com/sindresorhus/awesome//stargazers) project
...
Want to contribute? Please refer to [this](https://github.com/lucasviola/awesome-functional-programming/blob/master/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/lucasviola/awesome-functional-programming/blob/master/contributing.md?style=flat)](https://github.com/lucasviola/awesome-functional-programming/blob/master/contributing.md/stargazers) first.
...
### Repos
- [Idris Koans](https://github.com/idris-hackers/idris-koans) [![GitHub stars](https://img.shields.io/github/stars/idris-hackers/idris-koans?style=flat)](https://github.com/idris-hackers/idris-koans/stargazers) - Project for teaching Idris. A General Purpose Functional Programming with Dependent Types
- [Functional Javascript Workshop](https://github.com/timoxley/functional-javascript-workshop) [![GitHub stars](https://img.shields.io/github/stars/timoxley/functional-javascript-workshop?style=flat)](https://github.com/timoxley/functional-javascript-workshop/stargazers) - A functional Javascript workshop.
- [J-Bob](https://github.com/the-little-prover/j-bob) [![GitHub stars](https://img.shields.io/github/stars/the-little-prover/j-bob?style=flat)](https://github.com/the-little-prover/j-bob/stargazers) - The proof assistant from the book `The Little Prover`
- [Haskell Must Watch](https://github.com/olehkuchuk/haskell-must-watch) [![GitHub stars](https://img.shields.io/github/stars/olehkuchuk/haskell-must-watch?style=flat)](https://github.com/olehkuchuk/haskell-must-watch/stargazers) - A list of videos, talks and courses on Haskell.
- [Intro SML](http://www.it.dtu.dk/introSML/) - Code, corrections and info on the book: `Introduction to Programming using SML`
- [Functional Programming In JavaScript](https://github.com/busypeoples/functional-programming-javascript) [![GitHub stars](https://img.shields.io/github/stars/busypeoples/functional-programming-javascript?style=flat)](https://github.com/busypeoples/functional-programming-javascript/stargazers) - List of functional programming resources in JavaScript.
- [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) [![GitHub stars](https://img.shields.io/github/stars/hemanth/functional-programming-jargon?style=flat)](https://github.com/hemanth/functional-programming-jargon/stargazers) - Project for providing a glossary for FP, and make learning FP easier.
- [Bow](https://github.com/bow-swift/bow) [![GitHub stars](https://img.shields.io/github/stars/bow-swift/bow?style=flat)](https://github.com/bow-swift/bow/stargazers) - Companion library for Typed Functional Programming in Swift.
- [Parsing With Haskell Parser Combinators](https://github.com/lettier/parsing-with-haskell-parser-combinators) [![GitHub stars](https://img.shields.io/github/stars/lettier/parsing-with-haskell-parser-combinators?style=flat)](https://github.com/lettier/parsing-with-haskell-parser-combinators/stargazers) - A step-by-step guide to parsing using Haskell parser combinators.
- [Functional Programming Learning Path](https://github.com/imteekay/functional-programming-learning-path.git) [![GitHub stars](https://img.shields.io/github/stars/imteekay/functional-programming-learning-path.git?style=flat)](https://github.com/imteekay/functional-programming-learning-path.git/stargazers) - A Learning Path for Functional Programming
### People
