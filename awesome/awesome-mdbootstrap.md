...
> 来源：[mdbootstrap/awesome-mdbootstrap](https://github.com/mdbootstrap/awesome-mdbootstrap)

[![GitHub stars](https://img.shields.io/github/stars/mdbootstrap/awesome-mdbootstrap?style=flat)](https://github.com/mdbootstrap/awesome-mdbootstrap/stargazers)
...
[MDBootstrap](https://github.com/mdbootstrap/mdb-ui-kit) [![GitHub stars](https://img.shields.io/github/stars/mdbootstrap/mdb-ui-kit?style=flat)](https://github.com/mdbootstrap/mdb-ui-kit/stargazers) is a set of slick, responsive page templates, layouts, components, and widgets to rapidly build web pages.
...
- [Visual Studio Code snippets](https://github.com/mdbootstrap/MDB-VSCode-snippets) [![GitHub stars](https://img.shields.io/github/stars/mdbootstrap/MDB-VSCode-snippets?style=flat)](https://github.com/mdbootstrap/MDB-VSCode-snippets/stargazers) - An extension that allows you to add useful snippets of the most popular MDB 5 components to Visual Studio Code.
- [Angular Visual Studio Code snippets](https://github.com/mdbootstrap/mdb-angular-vscode-snippets) [![GitHub stars](https://img.shields.io/github/stars/mdbootstrap/mdb-angular-vscode-snippets?style=flat)](https://github.com/mdbootstrap/mdb-angular-vscode-snippets/stargazers) - This extension adds snippets for MDB Angular - Angular Bootstrap UI KIT.
- [Webpack starter](https://github.com/mdbootstrap/mdb-webpack-starter) [![GitHub stars](https://img.shields.io/github/stars/mdbootstrap/mdb-webpack-starter?style=flat)](https://github.com/mdbootstrap/mdb-webpack-starter/stargazers) - This guide describes in detail the capabilities of Webpack Starter.
