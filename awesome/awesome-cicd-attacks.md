...
- [GitLab Secrets](https://github.com/RichardoC/gitlab-secrets) [![GitHub stars](https://img.shields.io/github/stars/RichardoC/gitlab-secrets?style=flat)](https://github.com/RichardoC/gitlab-secrets/stargazers) - A tool that can reveal deleted GitLab commits that potentially contain sensitive information and are not accessible via the public Git history.
...
- [ActionsTOCTOU (Time Of Check to Time Of Use)](https://github.com/AdnaneKhan/ActionsTOCTOU/) [![GitHub stars](https://img.shields.io/github/stars/AdnaneKhan/ActionsTOCTOU/?style=flat)](https://github.com/AdnaneKhan/ActionsTOCTOU//stargazers) - A tool to monitor for an approval event and then quickly replace a file in the PR head with a local file specified as a parameter.
...
- [Living off the pipeline](https://github.com/boostsecurityio/lotp) [![GitHub stars](https://img.shields.io/github/stars/boostsecurityio/lotp?style=flat)](https://github.com/boostsecurityio/lotp/stargazers) - Inventory how development tools (typically CLIs), have lesser-known RCE-By-Design features.
...
- [PR sneaking](https://github.com/mortenson/pr-sneaking) [![GitHub stars](https://img.shields.io/github/stars/mortenson/pr-sneaking?style=flat)](https://github.com/mortenson/pr-sneaking/stargazers) - Methods of sneaking malicious code into GitHub pull requests.
...
## Tools
- [ADOKit](https://github.com/xforcered/ADOKit) [![GitHub stars](https://img.shields.io/github/stars/xforcered/ADOKit?style=flat)](https://github.com/xforcered/ADOKit/stargazers) - Azure DevOps Services Attack Toolkit.
- [Gato](https://github.com/praetorian-inc/gato) [![GitHub stars](https://img.shields.io/github/stars/praetorian-inc/gato?style=flat)](https://github.com/praetorian-inc/gato/stargazers) - GitHub Attack Toolkit.
- [Gato-X](https://github.com/AdnaneKhan/Gato-X) [![GitHub stars](https://img.shields.io/github/stars/AdnaneKhan/Gato-X?style=flat)](https://github.com/AdnaneKhan/Gato-X/stargazers) - GitHub Attack Toolkit - Extreme Edition.
...
- [git-dumper](https://github.com/arthaud/git-dumper) [![GitHub stars](https://img.shields.io/github/stars/arthaud/git-dumper?style=flat)](https://github.com/arthaud/git-dumper/stargazers) - Dump Git repository from a website.
- [GitFive](https://github.com/mxrch/gitfive) [![GitHub stars](https://img.shields.io/github/stars/mxrch/gitfive?style=flat)](https://github.com/mxrch/gitfive/stargazers) - OSINT tool to investigate GitHub profiles.
- [Grep.app](https://grep.app/) - Search GitHub using regex.
- [Jenkins Attack Framework](https://github.com/Accenture/jenkins-attack-framework) [![GitHub stars](https://img.shields.io/github/stars/Accenture/jenkins-attack-framework?style=flat)](https://github.com/Accenture/jenkins-attack-framework/stargazers) - This tool can manage Jenkins tasks, like listing jobs, dumping credentials, running commands/scripts, and managing API tokens.
- [Nord Stream](https://github.com/synacktiv/nord-stream) [![GitHub stars](https://img.shields.io/github/stars/synacktiv/nord-stream?style=flat)](https://github.com/synacktiv/nord-stream/stargazers) - A tool to extract secrets stored inside CI/CD environments.
- [pwn_jenkins](https://github.com/gquere/pwn_jenkins) [![GitHub stars](https://img.shields.io/github/stars/gquere/pwn_jenkins?style=flat)](https://github.com/gquere/pwn_jenkins/stargazers) - Notes about attacking Jenkins servers.
- [Secrets Patterns Database](https://github.com/mazen160/secrets-patterns-db) [![GitHub stars](https://img.shields.io/github/stars/mazen160/secrets-patterns-db?style=flat)](https://github.com/mazen160/secrets-patterns-db/stargazers) - The largest open-source database for detecting secrets, API keys, passwords, tokens, and more.
...
- [zizmor](https://github.com/zizmorcore/zizmor) [![GitHub stars](https://img.shields.io/github/stars/zizmorcore/zizmor?style=flat)](https://github.com/zizmorcore/zizmor/stargazers) - Static analysis for GitHub Actions.
...
- [GitHub Actions Attack Diagram](https://github.com/jstawinski/GitHub-Actions-Attack-Diagram) [![GitHub stars](https://img.shields.io/github/stars/jstawinski/GitHub-Actions-Attack-Diagram?style=flat)](https://github.com/jstawinski/GitHub-Actions-Attack-Diagram/stargazers) - Includes public vulnerability research presented at Black Hat USA 2024 and DEF CON 32.
...
## Similar Projects
- [Common Threat Matrix for CI/CD Pipeline](https://github.com/rung/threat-matrix-cicd) [![GitHub stars](https://img.shields.io/github/stars/rung/threat-matrix-cicd?style=flat)](https://github.com/rung/threat-matrix-cicd/stargazers)
...
- [SDLC Infrastructure Threat Framework (SITF)](https://github.com/wiz-sec-public/SITF) [![GitHub stars](https://img.shields.io/github/stars/wiz-sec-public/SITF?style=flat)](https://github.com/wiz-sec-public/SITF/stargazers) - A comprehensive framework for analyzing and defending against attacks targeting Software Development Life Cycle Infrastructure.
