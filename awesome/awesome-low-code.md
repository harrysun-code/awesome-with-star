...
> 来源：[zenitysec/awesome-low-code](https://github.com/zenitysec/awesome-low-code)

[![GitHub stars](https://img.shields.io/github/stars/zenitysec/awesome-low-code?style=flat)](https://github.com/zenitysec/awesome-low-code/stargazers)
...
- [XrmToolBox](https://github.com/MscrmTools/XrmToolBox) [![GitHub stars](https://img.shields.io/github/stars/MscrmTools/XrmToolBox?style=flat)](https://github.com/MscrmTools/XrmToolBox/stargazers) - An application that gather multiple tools to ease the customization and configuration of Microsoft Dynamics CRM/365/Dataverse/PowerApps.
- [Levelup for Dynamics CRM](https://github.com/rajyraman/Levelup-for-Dynamics-CRM) [![GitHub stars](https://img.shields.io/github/stars/rajyraman/Levelup-for-Dynamics-CRM?style=flat)](https://github.com/rajyraman/Levelup-for-Dynamics-CRM/stargazers) - Chrome, Edge Chromium and Firefox Extension for Dynamics CRM/365/Power Apps Power users.
- [Power Platform Adoption Framework](https://github.com/PowerPlatformAF/PowerPlatformAF) [![GitHub stars](https://img.shields.io/github/stars/PowerPlatformAF/PowerPlatformAF?style=flat)](https://github.com/PowerPlatformAF/PowerPlatformAF/stargazers) - The framework that enables people to create beautiful and useful things on Power Platform deployed in large, enterprise-grade organizations.
- [Flow & Power Apps Migrator](https://github.com/Zerg00s/FlowPowerAppsMigrator) [![GitHub stars](https://img.shields.io/github/stars/Zerg00s/FlowPowerAppsMigrator?style=flat)](https://github.com/Zerg00s/FlowPowerAppsMigrator/stargazers) - Converts SharePoint Data sources for the MS Flow and PowerApps to a new tenant of your choice.
- [SharePoint Workflow Converter](https://github.com/TracyGH/SharePointWorkflowConverter) [![GitHub stars](https://img.shields.io/github/stars/TracyGH/SharePointWorkflowConverter?style=flat)](https://github.com/TracyGH/SharePointWorkflowConverter/stargazers) - A proof-of-concept C# console application for retrieving legacy 2010 & 2013 custom SharePoint workflow definition files, and creating new Power Automate flows programmatically.

## Reference Resources

### Power Platform (Microsoft)

- [Power Platform Connectors](https://github.com/microsoft/PowerPlatformConnectors) [![GitHub stars](https://img.shields.io/github/stars/microsoft/PowerPlatformConnectors?style=flat)](https://github.com/microsoft/PowerPlatformConnectors/stargazers) - This is a repository for Microsoft Power Automate, Power Apps, and Azure Logic Apps connectors.
- [Microsoft Power Fx](https://github.com/microsoft/Power-Fx) [![GitHub stars](https://img.shields.io/github/stars/microsoft/Power-Fx?style=flat)](https://github.com/microsoft/Power-Fx/stargazers) - Power Fx Low Code programming language.

### Workato

- [Custom Connector Docs](https://github.com/workato/custom_connector_docs) [![GitHub stars](https://img.shields.io/github/stars/workato/custom_connector_docs?style=flat)](https://github.com/workato/custom_connector_docs/stargazers) - Source files for Workato custom connector documentation.

## Learning Resources

### Power Platform (Microsoft)

- [Power Fx Samples](https://github.com/pnp/powerfx-samples) [![GitHub stars](https://img.shields.io/github/stars/pnp/powerfx-samples?style=flat)](https://github.com/pnp/powerfx-samples/stargazers) - This repository contains samples for Power Fx Low Code programming language.
- [Power Apps & Azure Lab](https://github.com/microsoft/PowerApps-Azure-Lab) [![GitHub stars](https://img.shields.io/github/stars/microsoft/PowerApps-Azure-Lab?style=flat)](https://github.com/microsoft/PowerApps-Azure-Lab/stargazers) - Repository to host the PowerApps Azure Lab.
- [PL-900: Power Platform Fundamentals](https://github.com/MicrosoftLearning/PL-900-Microsoft-Power-Platform-Fundamentals) [![GitHub stars](https://img.shields.io/github/stars/MicrosoftLearning/PL-900-Microsoft-Power-Platform-Fundamentals?style=flat)](https://github.com/MicrosoftLearning/PL-900-Microsoft-Power-Platform-Fundamentals/stargazers) - Power Platform Fundamentals course materials.

### Workato

- [Embedding Guide](https://github.com/workato/full-embed-sample) [![GitHub stars](https://img.shields.io/github/stars/workato/full-embed-sample?style=flat)](https://github.com/workato/full-embed-sample/stargazers) - A guided example on how to use Workato embedded.

## Samples, Templates and Solutions

### Power Platform (Microsoft)

- [Power Apps Samples](https://github.com/pnp/powerapps-samples) [![GitHub stars](https://img.shields.io/github/stars/pnp/powerapps-samples?style=flat)](https://github.com/pnp/powerapps-samples/stargazers) - Contains curated community Microsoft Power App samples.
- [PowerApps Samples](https://github.com/Eickhel/PowerApps-samples) [![GitHub stars](https://img.shields.io/github/stars/Eickhel/PowerApps-samples?style=flat)](https://github.com/Eickhel/PowerApps-samples/stargazers) - Power Apps samples by Power Nimbus.
- [Power Apps Branding Template](https://github.com/iAmManCat/PowerApps-Branding-Template) [![GitHub stars](https://img.shields.io/github/stars/iAmManCat/PowerApps-Branding-Template?style=flat)](https://github.com/iAmManCat/PowerApps-Branding-Template/stargazers) - A template to empower developers and reduce time wasted on control changes.
- [SharePoint Power Platform Solutions](https://github.com/pnp/sp-power-platform-solutions) [![GitHub stars](https://img.shields.io/github/stars/pnp/sp-power-platform-solutions?style=flat)](https://github.com/pnp/sp-power-platform-solutions/stargazers) - Sample PowerApps solutions designed to be used in SharePoint context.
- [Power Automate Samples](https://github.com/pnp/powerautomate-samples) [![GitHub stars](https://img.shields.io/github/stars/pnp/powerautomate-samples?style=flat)](https://github.com/pnp/powerautomate-samples/stargazers) - Contains curated community samples for Microsoft Power Automate.
- [Automatic travel time](https://github.com/wortell/PowerAutomate-AutomatischeReistijd) [![GitHub stars](https://img.shields.io/github/stars/wortell/PowerAutomate-AutomatischeReistijd?style=flat)](https://github.com/wortell/PowerAutomate-AutomatischeReistijd/stargazers) - Adds automatic travel time to your Office 365 calendar.
- [Message Center in Teams](https://github.com/ericsche/MCinTeams) [![GitHub stars](https://img.shields.io/github/stars/ericsche/MCinTeams?style=flat)](https://github.com/ericsche/MCinTeams/stargazers) - A simple PowerAutomate solution to gather Message Center announcements and post them in a Teams channel.
- [Consume Power BI](https://github.com/ferrybouwman/Power-BI-Read-Only-REST-API) [![GitHub stars](https://img.shields.io/github/stars/ferrybouwman/Power-BI-Read-Only-REST-API?style=flat)](https://github.com/ferrybouwman/Power-BI-Read-Only-REST-API/stargazers) - Solution based on either Powershell or Power Automate (Flow) to consume the recently released Power BI Asynchronous Unified Scanning API.
- [Post List Item To Twitter](https://github.com/vaibhav21791/PostListItemToTwitter) [![GitHub stars](https://img.shields.io/github/stars/vaibhav21791/PostListItemToTwitter?style=flat)](https://github.com/vaibhav21791/PostListItemToTwitter/stargazers) - A Microsoft Power Automate Flow to Post a SharePoint List Item to Twitter along with media content.
...
- [Awesome Microsoft Power Platform](https://github.com/Power-Maverick/awesome-power-platform) [![GitHub stars](https://img.shields.io/github/stars/Power-Maverick/awesome-power-platform?style=flat)](https://github.com/Power-Maverick/awesome-power-platform/stargazers) - A collection of awesome things regarding the Power Platform ecosystem.
- [Awesome No Code Low Code](https://github.com/valentin-vogel/awesome-nocode-lowcode) [![GitHub stars](https://img.shields.io/github/stars/valentin-vogel/awesome-nocode-lowcode?style=flat)](https://github.com/valentin-vogel/awesome-nocode-lowcode/stargazers) - A collection of awesome No Code and Low Code resources.
