...
> 来源：[balintkissdev/awesome-dos](https://github.com/balintkissdev/awesome-dos)

[![GitHub stars](https://img.shields.io/github/stars/balintkissdev/awesome-dos?style=flat)](https://github.com/balintkissdev/awesome-dos/stargazers)
...
[<img src="logo.svg" align="right" width="100">](https://github.com/balintkissdev/awesome-dos) [![GitHub stars](https://img.shields.io/github/stars/balintkissdev/awesome-dos?style=flat)](https://github.com/balintkissdev/awesome-dos/stargazers)
...
- [Open Watcom V2](https://github.com/open-watcom/open-watcom-v2) [![GitHub stars](https://img.shields.io/github/stars/open-watcom/open-watcom-v2?style=flat)](https://github.com/open-watcom/open-watcom-v2/stargazers) - GitHub fork which is actively maintained and is
...
- [SmallerC](https://github.com/alexfru/SmallerC.git) [![GitHub stars](https://img.shields.io/github/stars/alexfru/SmallerC.git?style=flat)](https://github.com/alexfru/SmallerC.git/stargazers) - Portable self-hosting C compiler capable of producing executables for a number of platforms, including real and protected mode DOS programs, by Alexei A. Frounze.
- [Small-C Toolkit](https://github.com/humbertocsjr/Small-C.git) [![GitHub stars](https://img.shields.io/github/stars/humbertocsjr/Small-C.git?style=flat)](https://github.com/humbertocsjr/Small-C.git/stargazers) - A self-hosting Small-C Compiler Toolkit for DOS(8086) with: K&R C Compiler, Make, Linker, Assembler. First released in 1982 by Jim E. Hendrix.

### Memory managers

- [386MAX](https://github.com/sudleyplace/386MAX) [![GitHub stars](https://img.shields.io/github/stars/sudleyplace/386MAX?style=flat)](https://github.com/sudleyplace/386MAX/stargazers) - Memory manager for DOS PCs with 386 or higher CPUs, [released by Qualitas company in 1992](https://winworldpc.com/product/386max/6x). Source code was released in June 2022 on GitHub with GPL-3.0 license.

### Scripting languages and interpreters for DOS

- [DOjS](https://github.com/SuperIlu/DOjS) [![GitHub stars](https://img.shields.io/github/stars/SuperIlu/DOjS?style=flat)](https://github.com/SuperIlu/DOjS/stargazers) - JavaScript programming environment for MS-DOS, FreeDOS or any DOS-based Windows (like 95, 98, ME).
- [Lua for DOS](https://archive.org/details/lua5.3.5) - Online demo of Lua 5.3.5, compiled for MS-DOS on the Intel 80486 processor.
- [Micropython for FreeDOS](https://github.com/pohmelie/micropython-freedos) [![GitHub stars](https://img.shields.io/github/stars/pohmelie/micropython-freedos?style=flat)](https://github.com/pohmelie/micropython-freedos/stargazers) - FreeDOS ad-hoc module for [micropython](https://github.com/micropython/micropython) [![GitHub stars](https://img.shields.io/github/stars/micropython/micropython?style=flat)](https://github.com/micropython/micropython/stargazers).
...
- [MS-DOS](https://github.com/microsoft/MS-DOS) [![GitHub stars](https://img.shields.io/github/stars/microsoft/MS-DOS?style=flat)](https://github.com/microsoft/MS-DOS/stargazers) - GitHub repository of the original source code for MS-DOS v1.25, v2.0 and v4.0, open-sourced by Microsoft.
...
- [Allegro 4.2](https://github.com/liballeg/allegro5/tree/v4-2-3-1) [![GitHub stars](https://img.shields.io/github/stars/liballeg/allegro5/tree/v4-2-3-1?style=flat)](https://github.com/liballeg/allegro5/tree/v4-2-3-1/stargazers) - Game development library for DOS, Windows and Linux. 4.2 version supports DOS platform.
  - [Allegro 4.2.1 PDF documentation.](https://download.tuxfamily.org/allegro/allegro-manual/4.2.1/allegro-manual-4.2.1.en.pdf)
- [LoveDOS](https://github.com/rxi/lovedos) [![GitHub stars](https://img.shields.io/github/stars/rxi/lovedos?style=flat)](https://github.com/rxi/lovedos/stargazers) - A framework for making 2D DOS games in Lua. API based on a subset of the LÖVE API.
- [DOS-VGA-Game](https://github.com/marcomarrero/DOS-VGA-Game) [![GitHub stars](https://img.shields.io/github/stars/marcomarrero/DOS-VGA-Game?style=flat)](https://github.com/marcomarrero/DOS-VGA-Game/stargazers) - Marco A. Marrero's DOS VGA/hardware library implemented in assembly and Turbo Pascal.
- [DIGPAK sound drivers source code](https://github.com/jratcliff63367/digpak) [![GitHub stars](https://img.shields.io/github/stars/jratcliff63367/digpak?style=flat)](https://github.com/jratcliff63367/digpak/stargazers) - Original source code for the DIGPAK sound drivers uploaded to GitHub by John W. Ratcliff.
...
- [DOS Defender](https://github.com/skeeto/dosdefender-ld31) [![GitHub stars](https://img.shields.io/github/stars/skeeto/dosdefender-ld31?style=flat)](https://github.com/skeeto/dosdefender-ld31/stargazers) - Christopher Wellons's x86 real mode DOS Asteroids clone created as an entry for Lundum Dare #31.
- [Dungeons of Noudar](https://github.com/TheFakeMontyOnTheRun/dungeons-of-noudar) [![GitHub stars](https://img.shields.io/github/stars/TheFakeMontyOnTheRun/dungeons-of-noudar?style=flat)](https://github.com/TheFakeMontyOnTheRun/dungeons-of-noudar/stargazers) - First-person 2.5D dungeon-crawler on protected mode. Written in C++, includes software rendering, fixed point math, test coverage and sound (PC speaker, Adlib, OPL2LPT).
...
- [Floppy Bird](https://github.com/icebreaker/floppybird) [![GitHub stars](https://img.shields.io/github/stars/icebreaker/floppybird?style=flat)](https://github.com/icebreaker/floppybird/stargazers) - Flappy Bird clone written in 16 bit assembly. Not a DOS program, but a PC-Booter application instead (although it's also possible to build a COM executable for DOS).
...
- [Gridfighter 3D](https://porta2note.itch.io/gridfighter-3d) - '80s style arcade shooter written in Quickbasic. Also the very first known DOS game that supports Oculus Rift VR headset.
  - [GitHub repository](https://github.com/porta2note/gridfighter3d) [![GitHub stars](https://img.shields.io/github/stars/porta2note/gridfighter3d?style=flat)](https://github.com/porta2note/gridfighter3d/stargazers)
...
- [NetHack](https://github.com/NetHack/NetHack) [![GitHub stars](https://img.shields.io/github/stars/NetHack/NetHack?style=flat)](https://github.com/NetHack/NetHack/stargazers) - Descendant of the original [NetHack](https://en.wikipedia.org/wiki/NetHack) rougelike game first released in 1987 available on multiple platforms.
- [Piskworks](https://github.com/berk76/piskworks) [![GitHub stars](https://img.shields.io/github/stars/berk76/piskworks?style=flat)](https://github.com/berk76/piskworks/stargazers) - Gomoku clone written in C. Works on DOS, ZX Spectrum, ZX81, ZX80, APPLE1, AS400 and Windows.
- [Plutonium Caverns](https://github.com/jani-nykanen/plutonium-caverns) [![GitHub stars](https://img.shields.io/github/stars/jani-nykanen/plutonium-caverns?style=flat)](https://github.com/jani-nykanen/plutonium-caverns/stargazers) - Overhead puzzle game written in C. Web version uses [DOSBox ported to Emscripten](https://github.com/dreamlayers/em-dosbox) [![GitHub stars](https://img.shields.io/github/stars/dreamlayers/em-dosbox?style=flat)](https://github.com/dreamlayers/em-dosbox/stargazers) to embed DOSBox into HTML5. However, the original executable is also downloadable and buildable with Open Watcom.
- [Ptakovina](https://github.com/berk76/tetris) [![GitHub stars](https://img.shields.io/github/stars/berk76/tetris?style=flat)](https://github.com/berk76/tetris/stargazers) - Tetris clone written in C. Runs on DOS, Unix/Linux, ZX Spectrum and Windows.
...
- [Towers of Hanoi](https://github.com/sblendorio/hanoi-dos) [![GitHub stars](https://img.shields.io/github/stars/sblendorio/hanoi-dos?style=flat)](https://github.com/sblendorio/hanoi-dos/stargazers) - [Tower of Hanoi](https://en.wikipedia.org/wiki/Tower_of_Hanoi) puzzle game written in Turbo Pascal. Originally released in 1996.
- [x86 pong](https://github.com/spacerace/x86-pong) [![GitHub stars](https://img.shields.io/github/stars/spacerace/x86-pong?style=flat)](https://github.com/spacerace/x86-pong/stargazers) - Text-mode Pong clone written in C. Runs as PC-Booter game and under DOS.
...
- [Catacomb](https://github.com/CatacombGames/Catacomb) [![GitHub stars](https://img.shields.io/github/stars/CatacombGames/Catacomb?style=flat)](https://github.com/CatacombGames/Catacomb/stargazers) - 2D top-down shooter developed by Softdisk (later becoming id Software). Supports EGA and CGA graphics. Written in Turbo Pascal and assembly.
- [Catacomb 3D](https://github.com/CatacombGames/Catacomb3D) [![GitHub stars](https://img.shields.io/github/stars/CatacombGames/Catacomb3D?style=flat)](https://github.com/CatacombGames/Catacomb3D/stargazers) - First-person shooter in fantasy setting developed by Softdisk (later becoming id Software). Features pseudo-3D graphics with raycasting technique. Supports EGA graphics. Written in C and assembly. Compiled with Borland C++ 3.1.
- [Commander Keen in Keen Dreams](https://github.com/keendreams/keen) [![GitHub stars](https://img.shields.io/github/stars/keendreams/keen?style=flat)](https://github.com/keendreams/keen/stargazers) - Side-scrolling platform game developed by id Software. Keen Dreams is the Commander Keen game created between Keen 3 and Keen 4 (often considered "Keen 3.5"), but was not widely released. Written in C and assembly.
- [Descent](https://github.com/videogamepreservation/descent) [![GitHub stars](https://img.shields.io/github/stars/videogamepreservation/descent?style=flat)](https://github.com/videogamepreservation/descent/stargazers) - First sci-fi FPS/space shooter to feature entirely true 3D graphics. Written in C and assembly.
- [Descent II](https://github.com/videogamepreservation/descent2) [![GitHub stars](https://img.shields.io/github/stars/videogamepreservation/descent2?style=flat)](https://github.com/videogamepreservation/descent2/stargazers) - Sequel to Descent. Written in C and assembly.
- [Doom](https://github.com/id-Software/DOOM) [![GitHub stars](https://img.shields.io/github/stars/id-Software/DOOM?style=flat)](https://github.com/id-Software/DOOM/stargazers) - Sci-fi FPS developed by id Software where you fight demons from hell on Mars. The DOS-specific code for Doom could not be published because of a dependency to the licensed DMX sound library, hence why it's cleaned up and only the Linux source is there. However, the Heretic and Hexen projects contain the original DOS code in a way where DMX-related code is removed.
...
- [Heretic](https://github.com/OpenSourcedGames/Heretic) [![GitHub stars](https://img.shields.io/github/stars/OpenSourcedGames/Heretic?style=flat)](https://github.com/OpenSourcedGames/Heretic/stargazers) - Dark fantasy FPS running on id Software's Doom engine.
- [Hexen: Beyond Heretic](https://github.com/OpenSourcedGames/Hexen) [![GitHub stars](https://img.shields.io/github/stars/OpenSourcedGames/Hexen?style=flat)](https://github.com/OpenSourcedGames/Hexen/stargazers) - Indirect sequel to Heretic.
  - Original [SourceForge link](https://sourceforge.net/projects/heretic/files/) for Heretic/Hexen.
- [Hovertank 3D](https://github.com/FlatRockSoft/Hovertank3D) [![GitHub stars](https://img.shields.io/github/stars/FlatRockSoft/Hovertank3D?style=flat)](https://github.com/FlatRockSoft/Hovertank3D/stargazers) - FPS developed by id Software. Features pseudo-3D graphics with raycasting technique, before Catacomb 3D and Wolfeinstein 3D. Written in C and assembly.
- [Quake](https://github.com/id-Software/Quake) [![GitHub stars](https://img.shields.io/github/stars/id-Software/Quake?style=flat)](https://github.com/id-Software/Quake/stargazers) - FPS developed by id Software set in a fully 3D world. Written in C. Compiled with DJGPP for DOS.
  - [Quake Engine Code Review series](https://fabiensanglard.net/quakeSource/index.php) - Code analysis by Fabien Sanglard.
- [Rise of the Triad: Dark War](https://github.com/videogamepreservation/rott) [![GitHub stars](https://img.shields.io/github/stars/videogamepreservation/rott?style=flat)](https://github.com/videogamepreservation/rott/stargazers) - FPS developed by Apogee. It was developed as a follow-up to Wolfenstein 3D, but was altered and became a standalone game instead. Uses a heavily modified Wolfenstein 3D engine. Written in C.
...
- [Wolfenstein 3D](https://github.com/id-Software/wolf3d) [![GitHub stars](https://img.shields.io/github/stars/id-Software/wolf3d?style=flat)](https://github.com/id-Software/wolf3d/stargazers) - FPS developed by id Software set in the Nazi German prison Castle Wolfenstein. Features pseudo-3D graphics with raycasting technique. Written in C and assembly.

## Drivers and emulators

### Sound card emulators

- [SBEMU](https://github.com/crazii/SBEMU) [![GitHub stars](https://img.shields.io/github/stars/crazii/SBEMU?style=flat)](https://github.com/crazii/SBEMU/stargazers) - A TSR that emulates Sound Blaster and OPL3 in pure DOS using modern PCI-based (onboard and add-in card) sound cards. Supports both real mode and protected mode games!
- [VSB](https://github.com/Baron-von-Riedesel/VSBHDA) [![GitHub stars](https://img.shields.io/github/stars/Baron-von-Riedesel/VSBHDA?style=flat)](https://github.com/Baron-von-Riedesel/VSBHDA/stargazers) - A fork of SBEMU (see above), which also aims to offer Sound Blaster emulation for modern PC hardware, in both real mode and protected mode games.
