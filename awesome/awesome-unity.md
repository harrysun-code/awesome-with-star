...
Suggestions and contributions are always welcome! Make sure to read the [contribution guidelines](https://github.com/RyanNielson/awesome-unity/blob/master/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/RyanNielson/awesome-unity/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/RyanNielson/awesome-unity/blob/master/CONTRIBUTING.md/stargazers) for more information before submitting a pull request.

Thanks to all the [contributors](https://github.com/ryannielson/awesome-unity/graphs/contributors) [![GitHub stars](https://img.shields.io/github/stars/ryannielson/awesome-unity/graphs/contributors?style=flat)](https://github.com/ryannielson/awesome-unity/graphs/contributors/stargazers), this wouldn't be possible without you!
...
* [Pixel Camera 2D](https://github.com/RyanNielson/PixelCamera2D) [![GitHub stars](https://img.shields.io/github/stars/RyanNielson/PixelCamera2D?style=flat)](https://github.com/RyanNielson/PixelCamera2D/stargazers) - A simple pixel perfect camera with scaling options for 2D Games.
...
* [UnityTiled](https://github.com/nickgravelyn/UnityTiled) [![GitHub stars](https://img.shields.io/github/stars/nickgravelyn/UnityTiled?style=flat)](https://github.com/nickgravelyn/UnityTiled/stargazers) - An importer for [Tiled](http://www.mapeditor.org) maps.
...
* [Crystal AI](https://github.com/igiagkiozis/CrystalAI) [![GitHub stars](https://img.shields.io/github/stars/igiagkiozis/CrystalAI?style=flat)](https://github.com/igiagkiozis/CrystalAI/stargazers) - Crystal is a fast, scalable and extensible utility based AI framework for C# and Unity.
...
* [CharacterController2D](https://github.com/prime31/CharacterController2D) [![GitHub stars](https://img.shields.io/github/stars/prime31/CharacterController2D?style=flat)](https://github.com/prime31/CharacterController2D/stargazers) - A 2D controller that behaves very similarly to Unity's CharacterController component.

## Frameworks

* [Fungus](https://github.com/snozbot/fungus) [![GitHub stars](https://img.shields.io/github/stars/snozbot/fungus?style=flat)](https://github.com/snozbot/fungus/stargazers) - An easy to use Unity 3D library for creating illustrated Interactive Fiction games.
...
* [InControl](https://github.com/pbhogan/InControl) [![GitHub stars](https://img.shields.io/github/stars/pbhogan/InControl?style=flat)](https://github.com/pbhogan/InControl/stargazers) - An input manager that tames makes handler cross-platform. controller input easy.
* [InputBinder](https://github.com/RyanNielson/InputBinder) [![GitHub stars](https://img.shields.io/github/stars/RyanNielson/InputBinder?style=flat)](https://github.com/RyanNielson/InputBinder/stargazers) - Bind game inputs to methods via code or using the inspector to add event driven input handling to your project.
* [TouchKit](https://github.com/prime31/TouchKit) [![GitHub stars](https://img.shields.io/github/stars/prime31/TouchKit?style=flat)](https://github.com/prime31/TouchKit/stargazers) - Makes it easy to recognize gestures and other touch input.
* [TouchScript](https://github.com/TouchScript/TouchScript) [![GitHub stars](https://img.shields.io/github/stars/TouchScript/TouchScript?style=flat)](https://github.com/TouchScript/TouchScript/stargazers) - Makes handling complex gesture interactions on any touch surface much easier.
...
* [Nakama](https://assetstore.unity.com/packages/tools/network/nakama-81338) - Build social and realtime games with an open-source [distributed server](https://github.com/heroiclabs/nakama) [![GitHub stars](https://img.shields.io/github/stars/heroiclabs/nakama?style=flat)](https://github.com/heroiclabs/nakama/stargazers).
...
* [GoKit](https://github.com/prime31/GoKit) [![GitHub stars](https://img.shields.io/github/stars/prime31/GoKit?style=flat)](https://github.com/prime31/GoKit/stargazers) - An open source, lightweight tween library aimed at making tweening objects dead simple.
...
* [Consolation](https://github.com/mminer/consolation) [![GitHub stars](https://img.shields.io/github/stars/mminer/consolation?style=flat)](https://github.com/mminer/consolation/stargazers) - In-game debug console that displays output from `Debug.Log`.
...
* [Scene View Bookmarks](https://github.com/mminer/scene-view-bookmarks) [![GitHub stars](https://img.shields.io/github/stars/mminer/scene-view-bookmarks?style=flat)](https://github.com/mminer/scene-view-bookmarks/stargazers) - Editor extension to bookmark and later recall scene views.
...
* [UniRx](https://github.com/neuecc/UniRx) [![GitHub stars](https://img.shields.io/github/stars/neuecc/UniRx?style=flat)](https://github.com/neuecc/UniRx/stargazers) - UniRx (Reactive Extensions for Unity) is a reimplementation of the .NET Reactive Extensions. Rx cures the "asynchronous blues" without async/await.
* [UnityToolbag](https://github.com/nickgravelyn/unitytoolbag) [![GitHub stars](https://img.shields.io/github/stars/nickgravelyn/unitytoolbag?style=flat)](https://github.com/nickgravelyn/unitytoolbag/stargazers) - Collection of miscellaneous open source scripts and helpers for Unity 5.0.

## Video

* [Vimeo Unity SDK](https://github.com/vimeo/vimeo-unity-sdk) [![GitHub stars](https://img.shields.io/github/stars/vimeo/vimeo-unity-sdk?style=flat)](https://github.com/vimeo/vimeo-unity-sdk/stargazers) - Easily stream your Vimeo videos into Unity or record and publish out to Vimeo.
...
* [Nodulus](https://github.com/Hyperparticle/nodulus) [![GitHub stars](https://img.shields.io/github/stars/Hyperparticle/nodulus?style=flat)](https://github.com/Hyperparticle/nodulus/stargazers) - A complete puzzle game with a clever twist. Play it online.
...
* [Unity Labs' Super Science](https://github.com/Unity-Technologies/SuperScience) [![GitHub stars](https://img.shields.io/github/stars/Unity-Technologies/SuperScience?style=flat)](https://github.com/Unity-Technologies/SuperScience/stargazers) - Gems of Unity Labs for user education.
...
# Contributing
Please see [CONTRIBUTING](https://github.com/RyanNielson/awesome-unity/blob/master/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/RyanNielson/awesome-unity/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/RyanNielson/awesome-unity/blob/master/CONTRIBUTING.md/stargazers) for details.
