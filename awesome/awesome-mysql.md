...
- [StackRender](https://github.com/stackrender/stackrender) [![GitHub stars](https://img.shields.io/github/stars/stackrender/stackrender?style=flat)](https://github.com/stackrender/stackrender/stargazers) - Free and open-source database schema design and SQL migration generator for MySQL. 
...
- [LibreDB Studio](https://github.com/libredb/libredb-studio) [![GitHub stars](https://img.shields.io/github/stars/libredb/libredb-studio?style=flat)](https://github.com/libredb/libredb-studio/stargazers) - Browser-based SQL IDE for MySQL and nine other engines, deployed as a container or Helm chart next to the database.
...
* [sqlaxe](https://github.com/djberube/sqlaxe) [![GitHub stars](https://img.shields.io/github/stars/djberube/sqlaxe?style=flat)](https://github.com/djberube/sqlaxe/stargazers) - CLI tool for searching, filtering, formatting, and splitting SQL files.
