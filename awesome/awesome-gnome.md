...
- [Netsleuth](https://github.com/vmkspv/netsleuth) [![GitHub stars](https://img.shields.io/github/stars/vmkspv/netsleuth?style=flat)](https://github.com/vmkspv/netsleuth/stargazers) - Utility for the calculation and analysis of IP subnet values.
...
- [Newelle](https://github.com/qwersyk/Newelle) [![GitHub stars](https://img.shields.io/github/stars/qwersyk/Newelle?style=flat)](https://github.com/qwersyk/Newelle/stargazers) - Virtual assistant (local, based on GPT4All) that interacts with the system by running shell commands and execute Python code.
...
- [Dynamic Gnome Wallpapers](https://github.com/manishprivet/dynamic-gnome-wallpapers) [![GitHub stars](https://img.shields.io/github/stars/manishprivet/dynamic-gnome-wallpapers?style=flat)](https://github.com/manishprivet/dynamic-gnome-wallpapers/stargazers) - Gallery of MacOS like dynamic wallpapers, and easy scripts to install them
- [GDM Settings](https://gdm-settings.github.io) - A settings app for GDM (GNOME's Login Screen a.k.a GNOME Display Manager).
- [AdwSteamGtk](https://flathub.org/apps/io.github.Foldex.AdwSteamGtk) - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) [![GitHub stars](https://img.shields.io/github/stars/tkashkin/Adwaita-for-Steam?style=flat)](https://github.com/tkashkin/Adwaita-for-Steam/stargazers) skin installer.
...
- [Luminance](https://github.com/sidevesh/Luminance) [![GitHub stars](https://img.shields.io/github/stars/sidevesh/Luminance?style=flat)](https://github.com/sidevesh/Luminance/stargazers) - Simple application to control brightness of displays (including external) supporting DDC/CI.
...
- [Lan Mouse](https://github.com/feschber/lan-mouse) [![GitHub stars](https://img.shields.io/github/stars/feschber/lan-mouse?style=flat)](https://github.com/feschber/lan-mouse/stargazers) - Mouse and keyboard sharing software (software KVM switch).
...
- [Escambo](https://github.com/CleoMenezesJr/escambo) [![GitHub stars](https://img.shields.io/github/stars/CleoMenezesJr/escambo?style=flat)](https://github.com/CleoMenezesJr/escambo/stargazers) - HTTP-based APIs test application.
...
- [MoreWaita](https://github.com/somepaulo/MoreWaita) [![GitHub stars](https://img.shields.io/github/stars/somepaulo/MoreWaita?style=flat)](https://github.com/somepaulo/MoreWaita/stargazers) - An Adwaita-style icon theme for Gnome Shell.
- [GNOME++](https://github.com/Bonandry/gnome-plus) [![GitHub stars](https://img.shields.io/github/stars/Bonandry/gnome-plus?style=flat)](https://github.com/Bonandry/gnome-plus/stargazers) - Third-party application icons compatible with GNOME's current guidelines.
- [Pop!](https://github.com/pop-os/icon-theme) [![GitHub stars](https://img.shields.io/github/stars/pop-os/icon-theme?style=flat)](https://github.com/pop-os/icon-theme/stargazers) - Official icon theme of Pop!\_OS by System76.
...
- [La Capitaine](https://github.com/keeferrourke/la-capitaine-icon-theme) [![GitHub stars](https://img.shields.io/github/stars/keeferrourke/la-capitaine-icon-theme?style=flat)](https://github.com/keeferrourke/la-capitaine-icon-theme/stargazers) - Icon inspired by macOS and Material Design guidelines.

#### Homogeneous Icons

- [Obsidian](https://github.com/madmaxms/iconpack-obsidian) [![GitHub stars](https://img.shields.io/github/stars/madmaxms/iconpack-obsidian?style=flat)](https://github.com/madmaxms/iconpack-obsidian/stargazers) - Continuation of the famous Faenza theme.
- [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) [![GitHub stars](https://img.shields.io/github/stars/numixproject/numix-icon-theme-circle?style=flat)](https://github.com/numixproject/numix-icon-theme-circle/stargazers) - Flat rounded icon theme.
- [Numix Square](https://github.com/numixproject/numix-icon-theme-square) [![GitHub stars](https://img.shields.io/github/stars/numixproject/numix-icon-theme-square?style=flat)](https://github.com/numixproject/numix-icon-theme-square/stargazers) - Flat square icon theme.

#### Skeumorphic Icons

- [Elementary XFCE](https://github.com/shimmerproject/elementary-xfce) [![GitHub stars](https://img.shields.io/github/stars/shimmerproject/elementary-xfce?style=flat)](https://github.com/shimmerproject/elementary-xfce/stargazers) - Desktop-agnostic version of the icons of elementary OS.

### Cursors

- [ComixCursors](https://www.gnome-look.org/p/999996) - X11 mouse theme with a comics feeling.
- [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) [![GitHub stars](https://img.shields.io/github/stars/KaizIqbal/Bibata_Cursor?style=flat)](https://github.com/KaizIqbal/Bibata_Cursor/stargazers) - Silm material-based cursor theme.
- [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) [![GitHub stars](https://img.shields.io/github/stars/keeferrourke/capitaine-cursors?style=flat)](https://github.com/keeferrourke/capitaine-cursors/stargazers) - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons.

### Themes for non-GTK apps

- [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) [![GitHub stars](https://img.shields.io/github/stars/tkashkin/Adwaita-for-Steam?style=flat)](https://github.com/tkashkin/Adwaita-for-Steam/stargazers) - Skin to make Steam look more like a native GNOME app.
- [Adwaita theme for VS Code](https://github.com/piousdeer/vscode-adwaita) [![GitHub stars](https://img.shields.io/github/stars/piousdeer/vscode-adwaita?style=flat)](https://github.com/piousdeer/vscode-adwaita/stargazers) - Dark and light themes for VS Code based on GNOME's look and GNOME Builder's syntax highlighting.
- [Discord GNOME Theme](https://github.com/ricewind012/discord-gnome-theme) [![GitHub stars](https://img.shields.io/github/stars/ricewind012/discord-gnome-theme?style=flat)](https://github.com/ricewind012/discord-gnome-theme/stargazers) - A GNOME theme for Discord, following the Adwaita style & GNOME Human Interface Guidelines.
- [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) [![GitHub stars](https://img.shields.io/github/stars/rafaelmardojai/firefox-gnome-theme?style=flat)](https://github.com/rafaelmardojai/firefox-gnome-theme/stargazers) - Integrate Firefox into GNOME-based desktop using Adwaita.
- [Thunderbird GNOME Theme](https://github.com/rafaelmardojai/thunderbird-gnome-theme) [![GitHub stars](https://img.shields.io/github/stars/rafaelmardojai/thunderbird-gnome-theme?style=flat)](https://github.com/rafaelmardojai/thunderbird-gnome-theme/stargazers) - Integrate Thunderbird into GNOME-based desktop using Adwaita.
- [Obsidian Adwaita Theme](https://github.com/birneee/obsidian-adwaita-theme) [![GitHub stars](https://img.shields.io/github/stars/birneee/obsidian-adwaita-theme?style=flat)](https://github.com/birneee/obsidian-adwaita-theme/stargazers) - [Obsidian](https://obsidian.md) theme in the style of GNOME Adwaita.
...
- [Awesome-GTK](https://github.com/valpackett/awesome-gtk) [![GitHub stars](https://img.shields.io/github/stars/valpackett/awesome-gtk?style=flat)](https://github.com/valpackett/awesome-gtk/stargazers) - Collections of awesome native open-source GTK (4 and 3) applications.
