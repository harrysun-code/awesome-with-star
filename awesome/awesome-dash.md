...
Dash.
- [Awesome React Components](https://github.com/brillout/awesome-react-components) [![GitHub stars](https://img.shields.io/github/stars/brillout/awesome-react-components?style=flat)](https://github.com/brillout/awesome-react-components/stargazers) - Catalog of React.js components potentially interesting to be wrapped into Dash components.
- [Awesome React](https://github.com/enaqx/awesome-react) [![GitHub stars](https://img.shields.io/github/stars/enaqx/awesome-react?style=flat)](https://github.com/enaqx/awesome-react/stargazers) - Helpful resources for developing React.js components.
- [Dash Core Components](https://github.com/plotly/dash-core-components) [![GitHub stars](https://img.shields.io/github/stars/plotly/dash-core-components?style=flat)](https://github.com/plotly/dash-core-components/stargazers)
...
- [Dash HTML Components](https://github.com/plotly/dash-html-components) [![GitHub stars](https://img.shields.io/github/stars/plotly/dash-html-components?style=flat)](https://github.com/plotly/dash-html-components/stargazers)
- [mydcc](https://github.com/jimmybow/mydcc) [![GitHub stars](https://img.shields.io/github/stars/jimmybow/mydcc?style=flat)](https://github.com/jimmybow/mydcc/stargazers) - Extension of Dash Core Components.
- [sd-material-ui](https://github.com/StratoDem/sd-material-ui) [![GitHub stars](https://img.shields.io/github/stars/StratoDem/sd-material-ui?style=flat)](https://github.com/StratoDem/sd-material-ui/stargazers) - StratoDem Analytics implementations of material-ui components for Dash.
- [sd-range-slider](https://github.com/StratoDem/sd-range-slider) [![GitHub stars](https://img.shields.io/github/stars/StratoDem/sd-range-slider?style=flat)](https://github.com/StratoDem/sd-range-slider/stargazers) - Range Slider Dash component.
- [dj-plotly-dash](https://github.com/pikhovkin/dj-plotly-dash) [![GitHub stars](https://img.shields.io/github/stars/pikhovkin/dj-plotly-dash?style=flat)](https://github.com/pikhovkin/dj-plotly-dash/stargazers) - Plotly Dash fork for Django.
- [dash-flexbox-grid](https://github.com/pikhovkin/dash-flexbox-grid) [![GitHub stars](https://img.shields.io/github/stars/pikhovkin/dash-flexbox-grid?style=flat)](https://github.com/pikhovkin/dash-flexbox-grid/stargazers) - Wrapper around react-flexbox-grid for Plotly Dash.
- [dash-color-picker](https://github.com/vivekvs1/dash-color-picker) [![GitHub stars](https://img.shields.io/github/stars/vivekvs1/dash-color-picker?style=flat)](https://github.com/vivekvs1/dash-color-picker/stargazers) - Wrapper around react-color.
- [dash-dual-listbox](https://github.com/vivekvs1/dash-dual-listbox) [![GitHub stars](https://img.shields.io/github/stars/vivekvs1/dash-dual-listbox?style=flat)](https://github.com/vivekvs1/dash-dual-listbox/stargazers) - Wrapper around react-duallist.
- [dash-bootstrap-components](https://dash-bootstrap-components.opensource.faculty.ai/) - Bootstrap components for Dash.
- [dash-uploader](https://github.com/np-8/dash-uploader) [![GitHub stars](https://img.shields.io/github/stars/np-8/dash-uploader?style=flat)](https://github.com/np-8/dash-uploader/stargazers) - Upload component for Dash. Supports large data files.
- [Dash Mantine Components](https://github.com/snehilvj/dash-mantine-components) [![GitHub stars](https://img.shields.io/github/stars/snehilvj/dash-mantine-components?style=flat)](https://github.com/snehilvj/dash-mantine-components/stargazers) - Collection of 40+ Dash components based on Mantine React Components library.
- [plotly-resampler](https://github.com/predict-idlab/plotly-resampler) [![GitHub stars](https://img.shields.io/github/stars/predict-idlab/plotly-resampler?style=flat)](https://github.com/predict-idlab/plotly-resampler/stargazers) - Wrapper for plotly figures that adds data downsampling (aggregating) functionality, enabling the visualization of large datasets.
- [dash-vega-components](https://github.com/altair-viz/dash-vega-components) [![GitHub stars](https://img.shields.io/github/stars/altair-viz/dash-vega-components?style=flat)](https://github.com/altair-viz/dash-vega-components/stargazers) - Dash component for Vega-Altair, Vega-Lite, and Vega charts.

## App Examples

- [Oil and Gas Explorer](https://dash.gallery/dash-oil-and-gas/) - Explore oil and gas production over time and with linked visualisations. [Source Code.](https://github.com/plotly/dash-oil-and-gas-demo) [![GitHub stars](https://img.shields.io/github/stars/plotly/dash-oil-and-gas-demo?style=flat)](https://github.com/plotly/dash-oil-and-gas-demo/stargazers)
- [Uber Rides](https://dash.gallery/dash-uber-rides-demo/) - Displays all of the Uber rides in New York City in 2014. Pandas on the backend filters a 0.5gig datafile. [Source Code.](https://github.com/plotly/dash-sample-apps/tree/main/apps/dash-uber-rides-demo) [![GitHub stars](https://img.shields.io/github/stars/plotly/dash-sample-apps/tree/main/apps/dash-uber-rides-demo?style=flat)](https://github.com/plotly/dash-sample-apps/tree/main/apps/dash-uber-rides-demo/stargazers)
- [Drug Discovery](https://dash.gallery/dash-drug-discovery/) - Displays a description of the drug as you hover over points in the graph. [Source Code.](https://github.com/plotly/dash-sample-apps/tree/main/apps/dash-drug-discovery) [![GitHub stars](https://img.shields.io/github/stars/plotly/dash-sample-apps/tree/main/apps/dash-drug-discovery?style=flat)](https://github.com/plotly/dash-sample-apps/tree/main/apps/dash-drug-discovery/stargazers)
- [Live Wind Streaming](https://dash.gallery/dash-wind-streaming/) - Continually queries a SQL database and displays live charts of wind speed and wind direction. [Source Code.](https://github.com/plotly/dash-sample-apps/tree/main/apps/dash-wind-streaming) [![GitHub stars](https://img.shields.io/github/stars/plotly/dash-sample-apps/tree/main/apps/dash-wind-streaming?style=flat)](https://github.com/plotly/dash-sample-apps/tree/main/apps/dash-wind-streaming/stargazers)
- [3D Yield Curve](https://dash.gallery/dash-yield-curve/) - Adapted from NYTimes's excellent [A 3-D View of a Chart That Predicts The Economic Future: The Yield Curve](https://www.nytimes.com/interactive/2015/03/19/upshot/3d-yield-curve-economic-growth.html). [Source Code.](https://github.com/plotly/dash-sample-apps/tree/main/apps/dash-yield-curve) [![GitHub stars](https://img.shields.io/github/stars/plotly/dash-sample-apps/tree/main/apps/dash-yield-curve?style=flat)](https://github.com/plotly/dash-sample-apps/tree/main/apps/dash-yield-curve/stargazers)
- [Visualize Earthquakes with Plotly Dash](https://dash-earthquakes-production-45eyyotfta-ey.a.run.app/) - Great UI and usage of geospatial analytics with Dash. Includes [basic unit tests](https://github.com/jackdbd/dash-earthquakes/tree/master/tests) [![GitHub stars](https://img.shields.io/github/stars/jackdbd/dash-earthquakes/tree/master/tests?style=flat)](https://github.com/jackdbd/dash-earthquakes/tree/master/tests/stargazers). [Source Code.](https://github.com/jackdbd/dash-earthquakes) [![GitHub stars](https://img.shields.io/github/stars/jackdbd/dash-earthquakes?style=flat)](https://github.com/jackdbd/dash-earthquakes/stargazers)
- [GutenSearch](https://gutensearch.com/) - Look inside the books of Project Gutenberg. [Source Code.](https://github.com/cordb/gutensearch) [![GitHub stars](https://img.shields.io/github/stars/cordb/gutensearch?style=flat)](https://github.com/cordb/gutensearch/stargazers)

## Idiomatic examples
- [Dash recipes](https://github.com/plotly/dash-recipes) [![GitHub stars](https://img.shields.io/github/stars/plotly/dash-recipes?style=flat)](https://github.com/plotly/dash-recipes/stargazers) - A collection of scripts and examples created of the plotly team while answering questions from the greater Dash community.
...
- [Chris Parmer](https://github.com/chriddyp) [![GitHub stars](https://img.shields.io/github/stars/chriddyp?style=flat)](https://github.com/chriddyp/stargazers)
- [Sergey Pikhovkin](https://github.com/pikhovkin) [![GitHub stars](https://img.shields.io/github/stars/pikhovkin?style=flat)](https://github.com/pikhovkin/stargazers)
- [Pascal Bugnion](https://pascalbugnion.net)
- [Florian Kromer](https://github.com/fkromer) [![GitHub stars](https://img.shields.io/github/stars/fkromer?style=flat)](https://github.com/fkromer/stargazers)
- [Elias Dabbas](https://www.dashboardom.com)
- [vaexio](https://github.com/vaexio) [![GitHub stars](https://img.shields.io/github/stars/vaexio?style=flat)](https://github.com/vaexio/stargazers)
- [Fanchao MENG](https://github.com/pingf) [![GitHub stars](https://img.shields.io/github/stars/pingf?style=flat)](https://github.com/pingf/stargazers)
- [Snehil Vijay](https://github.com/snehilvj) [![GitHub stars](https://img.shields.io/github/stars/snehilvj?style=flat)](https://github.com/snehilvj/stargazers)
- [Eduardo Blancas](https://github.com/edublancas) [![GitHub stars](https://img.shields.io/github/stars/edublancas?style=flat)](https://github.com/edublancas/stargazers)
