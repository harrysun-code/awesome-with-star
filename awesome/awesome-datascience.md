...
| Link | Preview |
| --- | --- |
| [Data Science For Beginners](https://github.com/microsoft/Data-Science-For-Beginners) [![GitHub stars](https://img.shields.io/github/stars/microsoft/Data-Science-For-Beginners?style=flat)](https://github.com/microsoft/Data-Science-For-Beginners/stargazers) | Microsoft are pleased to offer a 10-week, 20-lesson curriculum all about Data Science. |
...
- [Chunk Tuner](https://github.com/shantanu-deshmukh/chunktuner) [![GitHub stars](https://img.shields.io/github/stars/shantanu-deshmukh/chunktuner?style=flat)](https://github.com/shantanu-deshmukh/chunktuner/stargazers) - Open-source Python library and MCP server to benchmark document chunking strategies for RAG, score retrieval quality, and recommend configurations for a corpus.
- [II-Commons](https://github.com/Intelligent-Internet/II-Commons-Skills) [![GitHub stars](https://img.shields.io/github/stars/Intelligent-Internet/II-Commons-Skills?style=flat)](https://github.com/Intelligent-Internet/II-Commons-Skills/stargazers) - Daily-updated skill and CLI for deterministic retrieval across arXiv, PubMed/PMC, and supported US policy corpora.
- [Spraay x402 Gateway](https://docs.spraay.app/#cat-research) - x402 payment gateway with 23 Research & Reference endpoints for AI agents: Wikipedia, arXiv, PubMed, Wikidata, academic citation lookup, entity extraction, and more. Pay-per-call in USDC on Base & Solana — no API keys or subscriptions. Also serves 150+ endpoints across 39 categories including geospatial, AI inference, DeFi, and compute. [GitHub](https://github.com/plagtech) [![GitHub stars](https://img.shields.io/github/stars/plagtech?style=flat)](https://github.com/plagtech/stargazers)
...
- [#tidytuesday](https://github.com/rfordatascience/tidytuesday) [![GitHub stars](https://img.shields.io/github/stars/rfordatascience/tidytuesday?style=flat)](https://github.com/rfordatascience/tidytuesday/stargazers) - A weekly data project aimed at the R ecosystem.
- [Data science your way](https://github.com/jadianes/data-science-your-way) [![GitHub stars](https://img.shields.io/github/stars/jadianes/data-science-your-way?style=flat)](https://github.com/jadianes/data-science-your-way/stargazers)
- [DataCamp Cheatsheets](https://www.datacamp.com/cheat-sheet) Cheatsheets for data science.
- [PySpark Cheatsheet](https://github.com/kevinschaich/pyspark-cheatsheet) [![GitHub stars](https://img.shields.io/github/stars/kevinschaich/pyspark-cheatsheet?style=flat)](https://github.com/kevinschaich/pyspark-cheatsheet/stargazers)
- [Machine Learning, Data Science and Deep Learning with Python ](https://www.manning.com/livevideo/machine-learning-data-science-and-deep-learning-with-python)
- [TutorialSearch](https://tutorialsearch.io/) - Free cross-platform search engine indexing 50,000+ tutorials from Udemy, Skillshare, Pluralsight, and other major learning platforms across 45+ categories.
- [Your Guide to Latent Dirichlet Allocation](https://medium.com/@lettier/how-does-lda-work-ill-explain-using-emoji-108abf40fa7d)
- [Tutorials of source code from the book Genetic Algorithms with Python by Clinton Sheppard](https://github.com/handcraftsman/GeneticAlgorithmsWithPython) [![GitHub stars](https://img.shields.io/github/stars/handcraftsman/GeneticAlgorithmsWithPython?style=flat)](https://github.com/handcraftsman/GeneticAlgorithmsWithPython/stargazers)
- [Tutorials to get started on signal processing for machine learning](https://github.com/jinglescode/python-signal-processing) [![GitHub stars](https://img.shields.io/github/stars/jinglescode/python-signal-processing?style=flat)](https://github.com/jinglescode/python-signal-processing/stargazers)
...
- [Minimum Viable Study Plan for Machine Learning Interviews](https://github.com/khangich/machine-learning-interview) [![GitHub stars](https://img.shields.io/github/stars/khangich/machine-learning-interview?style=flat)](https://github.com/khangich/machine-learning-interview/stargazers)
...
- [Train LLM From Scratch](https://github.com/FareedKhan-dev/train-llm-from-scratch) [![GitHub stars](https://img.shields.io/github/stars/FareedKhan-dev/train-llm-from-scratch?style=flat)](https://github.com/FareedKhan-dev/train-llm-from-scratch/stargazers) - A straightforward method for training your LLM, from downloading data to generating text.

### Free Courses
**[`^        back to top        ^`](#awesome-data-science)**

- [Data Science](https://github.com/ossu/data-science) [![GitHub stars](https://img.shields.io/github/stars/ossu/data-science?style=flat)](https://github.com/ossu/data-science/stargazers) - Open Source Society University
...
- [AI Expert Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap) [![GitHub stars](https://img.shields.io/github/stars/AMAI-GmbH/AI-Expert-Roadmap?style=flat)](https://github.com/AMAI-GmbH/AI-Expert-Roadmap/stargazers) - Roadmap to becoming an Artificial Intelligence Expert
...
- [Data Science Specialization](https://github.com/DataScienceSpecialization/courses) [![GitHub stars](https://img.shields.io/github/stars/DataScienceSpecialization/courses?style=flat)](https://github.com/DataScienceSpecialization/courses/stargazers)
...
- [A list of colleges and universities offering degrees in data science.](https://github.com/ryanswanstrom/awesome-datascience-colleges) [![GitHub stars](https://img.shields.io/github/stars/ryanswanstrom/awesome-datascience-colleges?style=flat)](https://github.com/ryanswanstrom/awesome-datascience-colleges/stargazers)
...
### Comparison
- [datacompy](https://github.com/capitalone/datacompy) [![GitHub stars](https://img.shields.io/github/stars/capitalone/datacompy?style=flat)](https://github.com/capitalone/datacompy/stargazers) - DataComPy is a package to compare two Pandas DataFrames.
...
* [scikit-multilearn](https://github.com/scikit-multilearn/scikit-multilearn) [![GitHub stars](https://img.shields.io/github/stars/scikit-multilearn/scikit-multilearn?style=flat)](https://github.com/scikit-multilearn/scikit-multilearn/stargazers)
* [sklearn-expertsys](https://github.com/tmadl/sklearn-expertsys) [![GitHub stars](https://img.shields.io/github/stars/tmadl/sklearn-expertsys?style=flat)](https://github.com/tmadl/sklearn-expertsys/stargazers)
* [scikit-feature](https://github.com/jundongl/scikit-feature) [![GitHub stars](https://img.shields.io/github/stars/jundongl/scikit-feature?style=flat)](https://github.com/jundongl/scikit-feature/stargazers)
* [scikit-rebate](https://github.com/EpistasisLab/scikit-rebate) [![GitHub stars](https://img.shields.io/github/stars/EpistasisLab/scikit-rebate?style=flat)](https://github.com/EpistasisLab/scikit-rebate/stargazers)
* [seqlearn](https://github.com/larsmans/seqlearn) [![GitHub stars](https://img.shields.io/github/stars/larsmans/seqlearn?style=flat)](https://github.com/larsmans/seqlearn/stargazers)
* [sklearn-bayes](https://github.com/AmazaspShumik/sklearn-bayes) [![GitHub stars](https://img.shields.io/github/stars/AmazaspShumik/sklearn-bayes?style=flat)](https://github.com/AmazaspShumik/sklearn-bayes/stargazers)
* [sklearn-crfsuite](https://github.com/TeamHG-Memex/sklearn-crfsuite) [![GitHub stars](https://img.shields.io/github/stars/TeamHG-Memex/sklearn-crfsuite?style=flat)](https://github.com/TeamHG-Memex/sklearn-crfsuite/stargazers)
* [sklearn-deap](https://github.com/rsteca/sklearn-deap) [![GitHub stars](https://img.shields.io/github/stars/rsteca/sklearn-deap?style=flat)](https://github.com/rsteca/sklearn-deap/stargazers)
* [sigopt_sklearn](https://github.com/sigopt/sigopt-sklearn) [![GitHub stars](https://img.shields.io/github/stars/sigopt/sigopt-sklearn?style=flat)](https://github.com/sigopt/sigopt-sklearn/stargazers)
* [sklearn-evaluation](https://github.com/edublancas/sklearn-evaluation) [![GitHub stars](https://img.shields.io/github/stars/edublancas/sklearn-evaluation?style=flat)](https://github.com/edublancas/sklearn-evaluation/stargazers)
* [scikit-image](https://github.com/scikit-image/scikit-image) [![GitHub stars](https://img.shields.io/github/stars/scikit-image/scikit-image?style=flat)](https://github.com/scikit-image/scikit-image/stargazers)
...
* [cuML](https://github.com/rapidsai/cuml) [![GitHub stars](https://img.shields.io/github/stars/rapidsai/cuml?style=flat)](https://github.com/rapidsai/cuml/stargazers)
* [causalml](https://github.com/uber/causalml) [![GitHub stars](https://img.shields.io/github/stars/uber/causalml?style=flat)](https://github.com/uber/causalml/stargazers)
* [mlpack](https://github.com/mlpack/mlpack) [![GitHub stars](https://img.shields.io/github/stars/mlpack/mlpack?style=flat)](https://github.com/mlpack/mlpack/stargazers)
* [MLxtend](https://github.com/rasbt/mlxtend) [![GitHub stars](https://img.shields.io/github/stars/rasbt/mlxtend?style=flat)](https://github.com/rasbt/mlxtend/stargazers)
* [modAL](https://github.com/modAL-python/modAL) [![GitHub stars](https://img.shields.io/github/stars/modAL-python/modAL?style=flat)](https://github.com/modAL-python/modAL/stargazers)
* [Sparkit-learn](https://github.com/lensacom/sparkit-learn) [![GitHub stars](https://img.shields.io/github/stars/lensacom/sparkit-learn?style=flat)](https://github.com/lensacom/sparkit-learn/stargazers)
* [hyperlearn](https://github.com/danielhanchen/hyperlearn) [![GitHub stars](https://img.shields.io/github/stars/danielhanchen/hyperlearn?style=flat)](https://github.com/danielhanchen/hyperlearn/stargazers)
* [dlib](https://github.com/davisking/dlib) [![GitHub stars](https://img.shields.io/github/stars/davisking/dlib?style=flat)](https://github.com/davisking/dlib/stargazers)
* [imodels](https://github.com/csinva/imodels) [![GitHub stars](https://img.shields.io/github/stars/csinva/imodels?style=flat)](https://github.com/csinva/imodels/stargazers)
...
* [RuleFit](https://github.com/christophM/rulefit) [![GitHub stars](https://img.shields.io/github/stars/christophM/rulefit?style=flat)](https://github.com/christophM/rulefit/stargazers)
* [pyGAM](https://github.com/dswah/pyGAM) [![GitHub stars](https://img.shields.io/github/stars/dswah/pyGAM?style=flat)](https://github.com/dswah/pyGAM/stargazers)
* [Deepchecks](https://github.com/deepchecks/deepchecks) [![GitHub stars](https://img.shields.io/github/stars/deepchecks/deepchecks?style=flat)](https://github.com/deepchecks/deepchecks/stargazers)
...
* [CatBoost](https://github.com/catboost/catboost) [![GitHub stars](https://img.shields.io/github/stars/catboost/catboost?style=flat)](https://github.com/catboost/catboost/stargazers)
* [PerpetualBooster](https://github.com/perpetual-ml/perpetual) [![GitHub stars](https://img.shields.io/github/stars/perpetual-ml/perpetual?style=flat)](https://github.com/perpetual-ml/perpetual/stargazers)
* [JAX](https://github.com/google/jax) [![GitHub stars](https://img.shields.io/github/stars/google/jax?style=flat)](https://github.com/google/jax/stargazers)
* [PhilanthroPy](https://github.com/PhilanthroPy-Project/PhilanthroPy) [![GitHub stars](https://img.shields.io/github/stars/PhilanthroPy-Project/PhilanthroPy?style=flat)](https://github.com/PhilanthroPy-Project/PhilanthroPy/stargazers) - Scikit-learn native toolkit for nonprofit fundraising analytics: leakage-safe donor propensity, lapse, planned-giving, wealth-screening and revenue-forecasting estimators.
...
* [ignite](https://github.com/pytorch/ignite) [![GitHub stars](https://img.shields.io/github/stars/pytorch/ignite?style=flat)](https://github.com/pytorch/ignite/stargazers)
* [PyTorchNet](https://github.com/pytorch/tnt) [![GitHub stars](https://img.shields.io/github/stars/pytorch/tnt?style=flat)](https://github.com/pytorch/tnt/stargazers)
* [PyToune](https://github.com/GRAAL-Research/poutyne) [![GitHub stars](https://img.shields.io/github/stars/GRAAL-Research/poutyne?style=flat)](https://github.com/GRAAL-Research/poutyne/stargazers)
* [skorch](https://github.com/skorch-dev/skorch) [![GitHub stars](https://img.shields.io/github/stars/skorch-dev/skorch?style=flat)](https://github.com/skorch-dev/skorch/stargazers)
* [PyVarInf](https://github.com/ctallec/pyvarinf) [![GitHub stars](https://img.shields.io/github/stars/ctallec/pyvarinf?style=flat)](https://github.com/ctallec/pyvarinf/stargazers)
* [pytorch_geometric](https://github.com/pyg-team/pytorch_geometric) [![GitHub stars](https://img.shields.io/github/stars/pyg-team/pytorch_geometric?style=flat)](https://github.com/pyg-team/pytorch_geometric/stargazers)
* [GPyTorch](https://github.com/cornellius-gp/gpytorch) [![GitHub stars](https://img.shields.io/github/stars/cornellius-gp/gpytorch?style=flat)](https://github.com/cornellius-gp/gpytorch/stargazers)
* [pyro](https://github.com/pyro-ppl/pyro) [![GitHub stars](https://img.shields.io/github/stars/pyro-ppl/pyro?style=flat)](https://github.com/pyro-ppl/pyro/stargazers)
* [Catalyst](https://github.com/catalyst-team/catalyst) [![GitHub stars](https://img.shields.io/github/stars/catalyst-team/catalyst?style=flat)](https://github.com/catalyst-team/catalyst/stargazers)
* [pytorch_tabular](https://github.com/manujosephv/pytorch_tabular) [![GitHub stars](https://img.shields.io/github/stars/manujosephv/pytorch_tabular?style=flat)](https://github.com/manujosephv/pytorch_tabular/stargazers)
...
* [TensorLayer](https://github.com/tensorlayer/TensorLayer) [![GitHub stars](https://img.shields.io/github/stars/tensorlayer/TensorLayer?style=flat)](https://github.com/tensorlayer/TensorLayer/stargazers)
* [TFLearn](https://github.com/tflearn/tflearn) [![GitHub stars](https://img.shields.io/github/stars/tflearn/tflearn?style=flat)](https://github.com/tflearn/tflearn/stargazers)
* [Sonnet](https://github.com/deepmind/sonnet) [![GitHub stars](https://img.shields.io/github/stars/deepmind/sonnet?style=flat)](https://github.com/deepmind/sonnet/stargazers)
* [tensorpack](https://github.com/tensorpack/tensorpack) [![GitHub stars](https://img.shields.io/github/stars/tensorpack/tensorpack?style=flat)](https://github.com/tensorpack/tensorpack/stargazers)
* [TRFL](https://github.com/deepmind/trfl) [![GitHub stars](https://img.shields.io/github/stars/deepmind/trfl?style=flat)](https://github.com/deepmind/trfl/stargazers)
* [Polyaxon](https://github.com/polyaxon/polyaxon) [![GitHub stars](https://img.shields.io/github/stars/polyaxon/polyaxon?style=flat)](https://github.com/polyaxon/polyaxon/stargazers)
* [NeuPy](https://github.com/itdxer/neupy) [![GitHub stars](https://img.shields.io/github/stars/itdxer/neupy?style=flat)](https://github.com/itdxer/neupy/stargazers)
* [tfdeploy](https://github.com/riga/tfdeploy) [![GitHub stars](https://img.shields.io/github/stars/riga/tfdeploy?style=flat)](https://github.com/riga/tfdeploy/stargazers)
* [tensorflow-upstream](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) [![GitHub stars](https://img.shields.io/github/stars/ROCmSoftwarePlatform/tensorflow-upstream?style=flat)](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream/stargazers)
* [TensorFlow Fold](https://github.com/tensorflow/fold) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/fold?style=flat)](https://github.com/tensorflow/fold/stargazers)
* [tensorlm](https://github.com/batzner/tensorlm) [![GitHub stars](https://img.shields.io/github/stars/batzner/tensorlm?style=flat)](https://github.com/batzner/tensorlm/stargazers)
* [TensorLight](https://github.com/bsautermeister/tensorlight) [![GitHub stars](https://img.shields.io/github/stars/bsautermeister/tensorlight?style=flat)](https://github.com/bsautermeister/tensorlight/stargazers)
* [Mesh TensorFlow](https://github.com/tensorflow/mesh) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/mesh?style=flat)](https://github.com/tensorflow/mesh/stargazers)
* [Ludwig](https://github.com/ludwig-ai/ludwig) [![GitHub stars](https://img.shields.io/github/stars/ludwig-ai/ludwig?style=flat)](https://github.com/ludwig-ai/ludwig/stargazers)
* [TF-Agents](https://github.com/tensorflow/agents) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/agents?style=flat)](https://github.com/tensorflow/agents/stargazers)
* [TensorForce](https://github.com/tensorforce/tensorforce) [![GitHub stars](https://img.shields.io/github/stars/tensorforce/tensorforce?style=flat)](https://github.com/tensorforce/tensorforce/stargazers)

#### Keras Ecosystem

* [Keras](https://keras.io)
* [keras-contrib](https://github.com/keras-team/keras-contrib) [![GitHub stars](https://img.shields.io/github/stars/keras-team/keras-contrib?style=flat)](https://github.com/keras-team/keras-contrib/stargazers)
* [Hyperas](https://github.com/maxpumperla/hyperas) [![GitHub stars](https://img.shields.io/github/stars/maxpumperla/hyperas?style=flat)](https://github.com/maxpumperla/hyperas/stargazers)
* [Elephas](https://github.com/maxpumperla/elephas) [![GitHub stars](https://img.shields.io/github/stars/maxpumperla/elephas?style=flat)](https://github.com/maxpumperla/elephas/stargazers)
* [Hera](https://github.com/keplr-io/hera) [![GitHub stars](https://img.shields.io/github/stars/keplr-io/hera?style=flat)](https://github.com/keplr-io/hera/stargazers)
* [Spektral](https://github.com/danielegrattarola/spektral) [![GitHub stars](https://img.shields.io/github/stars/danielegrattarola/spektral?style=flat)](https://github.com/danielegrattarola/spektral/stargazers)
* [qkeras](https://github.com/google/qkeras) [![GitHub stars](https://img.shields.io/github/stars/google/qkeras?style=flat)](https://github.com/google/qkeras/stargazers)
* [keras-rl](https://github.com/keras-rl/keras-rl) [![GitHub stars](https://img.shields.io/github/stars/keras-rl/keras-rl?style=flat)](https://github.com/keras-rl/keras-rl/stargazers)
* [Talos](https://github.com/autonomio/talos) [![GitHub stars](https://img.shields.io/github/stars/autonomio/talos?style=flat)](https://github.com/autonomio/talos/stargazers)
...
- [nvd3](https://nvd3.org/)
- [Netron](https://github.com/lutzroeder/netron) [![GitHub stars](https://img.shields.io/github/stars/lutzroeder/netron?style=flat)](https://github.com/lutzroeder/netron/stargazers)
- [Openrefine](https://openrefine.org/)
- [plot.ly](https://plot.ly/)
- [raw](https://rawgraphs.io)
- [Resseract Lite](https://github.com/abistarun/resseract-lite) [![GitHub stars](https://img.shields.io/github/stars/abistarun/resseract-lite?style=flat)](https://github.com/abistarun/resseract-lite/stargazers)
- [Seaborn](https://seaborn.pydata.org/)
- [techanjs](https://techanjs.org/)
- [Timeline](https://timeline.knightlab.com/)
- [variancecharts](https://variancecharts.com/index.html)
- [vida](https://vida.io/)
- [vizzu](https://github.com/vizzuhq/vizzu-lib) [![GitHub stars](https://img.shields.io/github/stars/vizzuhq/vizzu-lib?style=flat)](https://github.com/vizzuhq/vizzu-lib/stargazers)
...
- [C3](https://c3js.org/)
- [TensorWatch](https://github.com/microsoft/tensorwatch) [![GitHub stars](https://img.shields.io/github/stars/microsoft/tensorwatch?style=flat)](https://github.com/microsoft/tensorwatch/stargazers)
...
| Link | Description |
| --- | --- |
| [The Data Science Lifecycle Process](https://github.com/dslp/dslp) [![GitHub stars](https://img.shields.io/github/stars/dslp/dslp?style=flat)](https://github.com/dslp/dslp/stargazers) | The Data Science Lifecycle Process is a process for taking data science teams from Idea to Value repeatedly and sustainably. The process is documented in this repo  |
| [Data Science Lifecycle Template Repo](https://github.com/dslp/dslp-repo-template) [![GitHub stars](https://img.shields.io/github/stars/dslp/dslp-repo-template?style=flat)](https://github.com/dslp/dslp-repo-template/stargazers) | Template repository for data science lifecycle project  |
...
| [FileShot.io](https://github.com/FileShot/FileShotZKE) [![GitHub stars](https://img.shields.io/github/stars/FileShot/FileShotZKE?style=flat)](https://github.com/FileShot/FileShotZKE/stargazers) | Secure zero-knowledge encrypted file sharing (AES-256-GCM in-browser). No account required, MIT licensed, self-hostable, optional link expiry. |
...
| [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) [![GitHub stars](https://img.shields.io/github/stars/benedekrozemberczki/pytorch_geometric_temporal?style=flat)](https://github.com/benedekrozemberczki/pytorch_geometric_temporal/stargazers) | Representation learning on dynamic graphs.  |
| [Little Ball of Fur](https://github.com/benedekrozemberczki/littleballoffur) [![GitHub stars](https://img.shields.io/github/stars/benedekrozemberczki/littleballoffur?style=flat)](https://github.com/benedekrozemberczki/littleballoffur/stargazers) | A graph sampling library for NetworkX with a Scikit-Learn like API.  |
...
| [steppy](https://github.com/minerva-ml/steppy) [![GitHub stars](https://img.shields.io/github/stars/minerva-ml/steppy?style=flat)](https://github.com/minerva-ml/steppy/stargazers) | Lightweight, Python library for fast and reproducible machine learning experimentation. Introduces very simple interface that enables clean machine learning pipeline design. |
| [steppy-toolkit](https://github.com/minerva-ml/steppy-toolkit) [![GitHub stars](https://img.shields.io/github/stars/minerva-ml/steppy-toolkit?style=flat)](https://github.com/minerva-ml/steppy-toolkit/stargazers) | Curated collection of the neural networks, transformers and models that make your machine learning work faster and more effective. |
...
| [Hydrosphere Mist](https://github.com/Hydrospheredata/mist) [![GitHub stars](https://img.shields.io/github/stars/Hydrospheredata/mist?style=flat)](https://github.com/Hydrospheredata/mist/stargazers) | a service for exposing Apache Spark analytics jobs and machine learning models as realtime, batch or reactive web services. |
...
| [Nervana's python based Deep Learning Framework](https://github.com/NervanaSystems/neon) [![GitHub stars](https://img.shields.io/github/stars/NervanaSystems/neon?style=flat)](https://github.com/NervanaSystems/neon/stargazers) | Intel® Nervana™ reference deep learning framework committed to best performance on all hardware. |
| [Skale](https://github.com/skale-me/skale) [![GitHub stars](https://img.shields.io/github/stars/skale-me/skale?style=flat)](https://github.com/skale-me/skale/stargazers) | High performance distributed data processing in NodeJS |
| [Aerosolve](https://airbnb.io/aerosolve/) | A machine learning package built for humans. |
| [Intel framework](https://github.com/intel/idlf) [![GitHub stars](https://img.shields.io/github/stars/intel/idlf?style=flat)](https://github.com/intel/idlf/stargazers) | Intel® Deep Learning Framework |
| [Datawrapper](https://www.datawrapper.de/) | An open source data visualization platform helping everyone to create simple, correct and embeddable charts. Also at [github.com](https://github.com/datawrapper/datawrapper) [![GitHub stars](https://img.shields.io/github/stars/datawrapper/datawrapper?style=flat)](https://github.com/datawrapper/datawrapper/stargazers) |
...
| [FunASR](https://github.com/modelscope/FunASR) [![GitHub stars](https://img.shields.io/github/stars/modelscope/FunASR?style=flat)](https://github.com/modelscope/FunASR/stargazers) | Industrial-grade speech recognition toolkit supporting 50+ languages with built-in VAD, punctuation, speaker diarization, and emotion detection. OpenAI-compatible API server included. |
...
| [IJulia](https://github.com/JuliaLang/IJulia.jl) [![GitHub stars](https://img.shields.io/github/stars/JuliaLang/IJulia.jl?style=flat)](https://github.com/JuliaLang/IJulia.jl/stargazers) | a Julia-language backend combined with the Jupyter interactive environment |
...
| [Featuretools](https://github.com/alteryx/featuretools) [![GitHub stars](https://img.shields.io/github/stars/alteryx/featuretools?style=flat)](https://github.com/alteryx/featuretools/stargazers) | An open source framework for automated feature engineering written in python |
| [Optimus](https://github.com/hi-primus/optimus) [![GitHub stars](https://img.shields.io/github/stars/hi-primus/optimus?style=flat)](https://github.com/hi-primus/optimus/stargazers) | Cleansing, pre-processing, feature engineering, exploratory data analysis and easy ML with PySpark backend.  |
| [Albumentations](https://github.com/albumentations-team/albumentations) [![GitHub stars](https://img.shields.io/github/stars/albumentations-team/albumentations?style=flat)](https://github.com/albumentations-team/albumentations/stargazers) | А fast and framework agnostic image augmentation library that implements a diverse set of augmentation techniques. Supports classification, segmentation, and detection out of the box. Was used to win a number of Deep Learning competitions at Kaggle, Topcoder and those that were a part of the CVPR workshops. |
| [DVC](https://github.com/iterative/dvc) [![GitHub stars](https://img.shields.io/github/stars/iterative/dvc?style=flat)](https://github.com/iterative/dvc/stargazers) | An open-source data science version control system. It helps track, organize and make data science projects reproducible. In its very basic scenario it helps version control and share large data and model files. |
| [Lambdo](https://github.com/asavinov/lambdo) [![GitHub stars](https://img.shields.io/github/stars/asavinov/lambdo?style=flat)](https://github.com/asavinov/lambdo/stargazers) | is a workflow engine that significantly simplifies data analysis by combining in one analysis pipeline (i) feature engineering and machine learning (ii) model training and prediction (iii) table population and column evaluation. |
| [Feast](https://github.com/feast-dev/feast) [![GitHub stars](https://img.shields.io/github/stars/feast-dev/feast?style=flat)](https://github.com/feast-dev/feast/stargazers) | A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving. |
...
| [Trains](https://github.com/allegroai/clearml) [![GitHub stars](https://img.shields.io/github/stars/allegroai/clearml?style=flat)](https://github.com/allegroai/clearml/stargazers) | Auto-Magical Experiment Manager, Version Control & DevOps for AI |
| [Hopsworks](https://github.com/logicalclocks/hopsworks) [![GitHub stars](https://img.shields.io/github/stars/logicalclocks/hopsworks?style=flat)](https://github.com/logicalclocks/hopsworks/stargazers) | Open-source data-intensive machine learning platform with a feature store. Ingest and manage features for both online (MySQL Cluster)  and offline (Apache Hive) access, train and serve models at scale. |
| [MindsDB](https://github.com/mindsdb/mindsdb) [![GitHub stars](https://img.shields.io/github/stars/mindsdb/mindsdb?style=flat)](https://github.com/mindsdb/mindsdb/stargazers) | MindsDB is an Explainable AutoML framework for developers. With MindsDB you can build, train and use state of the art ML models in as simple as one line of code. |
| [Lightwood](https://github.com/mindsdb/lightwood) [![GitHub stars](https://img.shields.io/github/stars/mindsdb/lightwood?style=flat)](https://github.com/mindsdb/lightwood/stargazers) | A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with an objective to build predictive models with one line of code. |
| [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) [![GitHub stars](https://img.shields.io/github/stars/awslabs/aws-data-wrangler?style=flat)](https://github.com/awslabs/aws-data-wrangler/stargazers) | An open-source Python package that extends the power of Pandas library to AWS connecting DataFrames and AWS data related services (Amazon Redshift, AWS Glue, Amazon Athena, Amazon EMR, etc). |
...
| [CML](https://github.com/iterative/cml) [![GitHub stars](https://img.shields.io/github/stars/iterative/cml?style=flat)](https://github.com/iterative/cml/stargazers) | An open source toolkit for using continuous integration in data science projects. Automatically train and test models in production-like environments with GitHub Actions & GitLab CI, and autogenerate visual reports on pull/merge requests. |
...
| [DuckDB](https://github.com/duckdb/duckdb) [![GitHub stars](https://img.shields.io/github/stars/duckdb/duckdb?style=flat)](https://github.com/duckdb/duckdb/stargazers) | An in-process SQL OLAP database management system |
...
| [Grid Studio](https://github.com/ricklamers/gridstudio) [![GitHub stars](https://img.shields.io/github/stars/ricklamers/gridstudio?style=flat)](https://github.com/ricklamers/gridstudio/stargazers) | Grid studio is a web-based spreadsheet application with full integration of the Python programming language. |
|[Python Data Science Handbook](https://github.com/jakevdp/PythonDataScienceHandbook) [![GitHub stars](https://img.shields.io/github/stars/jakevdp/PythonDataScienceHandbook?style=flat)](https://github.com/jakevdp/PythonDataScienceHandbook/stargazers)|Python Data Science Handbook: full text in Jupyter Notebooks|
...
| [cleanlab](https://github.com/cleanlab/cleanlab) [![GitHub stars](https://img.shields.io/github/stars/cleanlab/cleanlab?style=flat)](https://github.com/cleanlab/cleanlab/stargazers) | Python library for data-centric AI and automatically detecting various issues in ML datasets |
| [AutoGluon](https://github.com/awslabs/autogluon) [![GitHub stars](https://img.shields.io/github/stars/awslabs/autogluon?style=flat)](https://github.com/awslabs/autogluon/stargazers) | AutoML to easily produce accurate predictions for image, text, tabular, time-series, and multi-modal data |
...
| [Comet](https://github.com/comet-ml/comet-examples) [![GitHub stars](https://img.shields.io/github/stars/comet-ml/comet-examples?style=flat)](https://github.com/comet-ml/comet-examples/stargazers) | An MLOps platform with experiment tracking, model production management, a model registry, and full data lineage to support your ML workflow from training straight through to production. |
| [Opik](https://github.com/comet-ml/opik) [![GitHub stars](https://img.shields.io/github/stars/comet-ml/opik?style=flat)](https://github.com/comet-ml/opik/stargazers) | Evaluate, test, and ship LLM applications across your dev and production lifecycles. |
...
| [teeplot](https://github.com/mmore500/teeplot) [![GitHub stars](https://img.shields.io/github/stars/mmore500/teeplot?style=flat)](https://github.com/mmore500/teeplot/stargazers) | Workflow tool to automatically organize data visualization output |
| [Streamlit](https://github.com/streamlit/streamlit) [![GitHub stars](https://img.shields.io/github/stars/streamlit/streamlit?style=flat)](https://github.com/streamlit/streamlit/stargazers) | App framework for Machine Learning and Data Science projects |
| [Gradio](https://github.com/gradio-app/gradio) [![GitHub stars](https://img.shields.io/github/stars/gradio-app/gradio?style=flat)](https://github.com/gradio-app/gradio/stargazers) | Create customizable UI components around machine learning models |
| [Weights & Biases](https://github.com/wandb/wandb) [![GitHub stars](https://img.shields.io/github/stars/wandb/wandb?style=flat)](https://github.com/wandb/wandb/stargazers) | Experiment tracking, dataset versioning, and model management |
| [DVC](https://github.com/iterative/dvc) [![GitHub stars](https://img.shields.io/github/stars/iterative/dvc?style=flat)](https://github.com/iterative/dvc/stargazers) | Open-source version control system for machine learning projects |
| [Optuna](https://github.com/optuna/optuna) [![GitHub stars](https://img.shields.io/github/stars/optuna/optuna?style=flat)](https://github.com/optuna/optuna/stargazers) | Automatic hyperparameter optimization software framework |
| [Ray Tune](https://github.com/ray-project/ray) [![GitHub stars](https://img.shields.io/github/stars/ray-project/ray?style=flat)](https://github.com/ray-project/ray/stargazers) | Scalable hyperparameter tuning library |
| [Apache Airflow](https://github.com/apache/airflow) [![GitHub stars](https://img.shields.io/github/stars/apache/airflow?style=flat)](https://github.com/apache/airflow/stargazers) | Platform to programmatically author, schedule, and monitor workflows |
| [Prefect](https://github.com/PrefectHQ/prefect) [![GitHub stars](https://img.shields.io/github/stars/PrefectHQ/prefect?style=flat)](https://github.com/PrefectHQ/prefect/stargazers) | Workflow management system for modern data stacks |
| [Kedro](https://github.com/kedro-org/kedro) [![GitHub stars](https://img.shields.io/github/stars/kedro-org/kedro?style=flat)](https://github.com/kedro-org/kedro/stargazers) | Open-source Python framework for creating reproducible, maintainable data science code |
| [Hamilton](https://github.com/dagworks-inc/hamilton) [![GitHub stars](https://img.shields.io/github/stars/dagworks-inc/hamilton?style=flat)](https://github.com/dagworks-inc/hamilton/stargazers) | Lightweight library to author and manage reliable data transformations |
| [SHAP](https://github.com/slundberg/shap) [![GitHub stars](https://img.shields.io/github/stars/slundberg/shap?style=flat)](https://github.com/slundberg/shap/stargazers) | Game theoretic approach to explain the output of any machine learning model |
...
| [LIME](https://github.com/marcotcr/lime) [![GitHub stars](https://img.shields.io/github/stars/marcotcr/lime?style=flat)](https://github.com/marcotcr/lime/stargazers) | Explaining the predictions of any machine learning classifier |
| [flyte](https://github.com/flyteorg/flyte) [![GitHub stars](https://img.shields.io/github/stars/flyteorg/flyte?style=flat)](https://github.com/flyteorg/flyte/stargazers) | Workflow automation platform for machine learning |
...
| [Desbordante](https://github.com/desbordante/desbordante-core/) [![GitHub stars](https://img.shields.io/github/stars/desbordante/desbordante-core/?style=flat)](https://github.com/desbordante/desbordante-core//stargazers) | An open-source data profiler specifically focused on discovery and validation of complex patterns, such as [numerical association rules](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Numerical_Association_Rules.ipynb), [differential dependencies](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Differential_Dependencies.ipynb), [denial constraints](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Denial_Constraints.ipynb), and more. |
...
| [RunMat](https://github.com/runmat-org/runmat) [![GitHub stars](https://img.shields.io/github/stars/runmat-org/runmat?style=flat)](https://github.com/runmat-org/runmat/stargazers) | Fast MATLAB-syntax runtime with automatic CPU/GPU execution and fused array kernels. |
| [Turbostream](https://github.com/turboline-ai/turbostream) [![GitHub stars](https://img.shields.io/github/stars/turboline-ai/turbostream?style=flat)](https://github.com/turboline-ai/turbostream/stargazers) | A terminal UI for experimenting with custom rule engines and selective LLM analysis on real-time data streams, without worrying about streaming infra or backpressure. |
| [WFGY ProblemMap](https://github.com/onestardao/WFGY/blob/main/ProblemMap/README.md) [![GitHub stars](https://img.shields.io/github/stars/onestardao/WFGY/blob/main/ProblemMap/README.md?style=flat)](https://github.com/onestardao/WFGY/blob/main/ProblemMap/README.md/stargazers) | Open source “failure atlas” of 16 recurring issues in LLM and RAG pipelines, with observable symptoms and suggested fixes for data science teams. |
| [Deploybase](https://deploybase.ai/) | Track real-time GPU and LLM pricing across all cloud and inference providers. |
| [DeepAnalyze](https://github.com/ruc-datalab/DeepAnalyze) [![GitHub stars](https://img.shields.io/github/stars/ruc-datalab/DeepAnalyze?style=flat)](https://github.com/ruc-datalab/DeepAnalyze/stargazers) | An agentic LLM for autonomous data science, which can autonomously complete a wide range of data science tasks without human intervention. |
| [Disco](https://github.com/leap-laboratories/discovery-engine) [![GitHub stars](https://img.shields.io/github/stars/leap-laboratories/discovery-engine?style=flat)](https://github.com/leap-laboratories/discovery-engine/stargazers) | Superhuman exploratory data analysis. Finds the feature interactions and subgroup effects in tabular data that LLMs and manual exploration miss — with p-values, effect sizes, and literature citations. Free for public data. |
...
| [Crypto Pump Scanner](https://github.com/stefanoviana/deepalpha) [![GitHub stars](https://img.shields.io/github/stars/stefanoviana/deepalpha?style=flat)](https://github.com/stefanoviana/deepalpha/stargazers) | AI-powered cryptocurrency trading bot with LSTM neural network (84.6% accuracy). Real-time pump detection, walk-forward validated models, multi-exchange support (Bybit, Binance, OKX, Gate.io). Open source. |
| [Future AGI](https://github.com/future-agi/future-agi) [![GitHub stars](https://img.shields.io/github/stars/future-agi/future-agi?style=flat)](https://github.com/future-agi/future-agi/stargazers) | Open-source platform to simulate, evaluate, trace, guardrail, route, and optimize LLM and AI agent apps in one feedback loop, so agents don't just get monitored, they self-improve. Self-hostable. Apache-2.0. |
...
- [How to Share Data with a Statistician](https://github.com/jtleek/datasharing) [![GitHub stars](https://img.shields.io/github/stars/jtleek/datasharing?style=flat)](https://github.com/jtleek/datasharing/stargazers)
...
### GitHub Groups
- [Berkeley Institute for Data Science](https://github.com/BIDS) [![GitHub stars](https://img.shields.io/github/stars/BIDS?style=flat)](https://github.com/BIDS/stargazers)
...
- [College ROI Dataset](https://github.com/thomasthinks/college-roi-data) [![GitHub stars](https://img.shields.io/github/stars/thomasthinks/college-roi-data?style=flat)](https://github.com/thomasthinks/college-roi-data/stargazers) - Lifetime return-on-investment estimates for ~30K US bachelor's programs across 1,775 institutions, built from FREOPP, IPEDS, and BEA regional price data. 5 CSVs with data dictionary, CC BY 4.0, Zenodo DOI.
...
- [Pokemon Card Centering Measurements](https://github.com/rrh1441/pokemon-card-centering-measurements) [![GitHub stars](https://img.shields.io/github/stars/rrh1441/pokemon-card-centering-measurements?style=flat)](https://github.com/rrh1441/pokemon-card-centering-measurements/stargazers) - 320 measured PSA-style centering annotations (left/right and top/bottom border percentages, tilt) across 302 real eBay-listed Pokemon cards. CSV, CC BY 4.0, Zenodo DOI.
- [Pokemon Card Sold-Price Reference by Grade](https://github.com/rrh1441/pokemon-card-sold-price-reference) [![GitHub stars](https://img.shields.io/github/stars/rrh1441/pokemon-card-sold-price-reference?style=flat)](https://github.com/rrh1441/pokemon-card-sold-price-reference/stargazers) - Median sold price by grade (raw, PSA 9, PSA 10) for 486 Pokemon cards, with sample size and confidence flag per card. CSV, CC BY 4.0, Zenodo DOI.
...
- [Open Data Sources](https://github.com/datasciencemasters/data) [![GitHub stars](https://img.shields.io/github/stars/datasciencemasters/data?style=flat)](https://github.com/datasciencemasters/data/stargazers)
...
- [Public Git Archive](https://github.com/src-d/datasets/tree/master/PublicGitArchive) [![GitHub stars](https://img.shields.io/github/stars/src-d/datasets/tree/master/PublicGitArchive?style=flat)](https://github.com/src-d/datasets/tree/master/PublicGitArchive/stargazers)
- [GHTorrent](https://ghtorrent.org/)
- [Microsoft Research Open Data](https://msropendata.com/)
- [Open Government Data Platform India](https://data.gov.in/)
- [Google Dataset Search (beta)](https://datasetsearch.research.google.com/)
- [NAYN.CO Turkish News with categories](https://github.com/naynco/nayn.data) [![GitHub stars](https://img.shields.io/github/stars/naynco/nayn.data?style=flat)](https://github.com/naynco/nayn.data/stargazers)
- [Covid-19](https://github.com/datasets/covid-19) [![GitHub stars](https://img.shields.io/github/stars/datasets/covid-19?style=flat)](https://github.com/datasets/covid-19/stargazers)
- [Covid-19 Google](https://github.com/google-research/open-covid-19-data) [![GitHub stars](https://img.shields.io/github/stars/google-research/open-covid-19-data?style=flat)](https://github.com/google-research/open-covid-19-data/stargazers)
- [Enron Email Dataset](https://www.cs.cmu.edu/~./enron/)
- [5000 Images of Clothes](https://github.com/alexeygrigorev/clothing-dataset) [![GitHub stars](https://img.shields.io/github/stars/alexeygrigorev/clothing-dataset?style=flat)](https://github.com/alexeygrigorev/clothing-dataset/stargazers)
...
- [HDD Price Index](https://github.com/AdamDudley/hddhunt-price-index) [![GitHub stars](https://img.shields.io/github/stars/AdamDudley/hddhunt-price-index?style=flat)](https://github.com/AdamDudley/hddhunt-price-index/stargazers) - Daily open dataset of the cheapest new internal 3.5" SATA hard-drive price per terabyte (USD/TB) by capacity tier on Amazon US, with a historical time series. CSV, JSON and JSONL, no login, CC BY 4.0.
...
- [FirstData](https://github.com/MLT-OSS/FirstData) [![GitHub stars](https://img.shields.io/github/stars/MLT-OSS/FirstData?style=flat)](https://github.com/MLT-OSS/FirstData/stargazers) - The world's most comprehensive authoritative data source knowledge base. 210+ curated sources from governments, international organizations, and research institutions. MCP integration for AI agents. MIT licensed.
...
- Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) [![GitHub stars](https://img.shields.io/github/stars/bayandin/awesome-awesomeness?style=flat)](https://github.com/bayandin/awesome-awesomeness/stargazers)
- [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) [![GitHub stars](https://img.shields.io/github/stars/josephmisiti/awesome-machine-learning?style=flat)](https://github.com/josephmisiti/awesome-machine-learning/stargazers)
...
- [awesome-dataviz](https://github.com/javierluraschi/awesome-dataviz) [![GitHub stars](https://img.shields.io/github/stars/javierluraschi/awesome-dataviz?style=flat)](https://github.com/javierluraschi/awesome-dataviz/stargazers)
- [awesome-python](https://github.com/vinta/awesome-python) [![GitHub stars](https://img.shields.io/github/stars/vinta/awesome-python?style=flat)](https://github.com/vinta/awesome-python/stargazers)
- [Data Science IPython Notebooks.](https://github.com/donnemartin/data-science-ipython-notebooks) [![GitHub stars](https://img.shields.io/github/stars/donnemartin/data-science-ipython-notebooks?style=flat)](https://github.com/donnemartin/data-science-ipython-notebooks/stargazers)
- [awesome-r](https://github.com/qinwf/awesome-R) [![GitHub stars](https://img.shields.io/github/stars/qinwf/awesome-R?style=flat)](https://github.com/qinwf/awesome-R/stargazers)
- [awesome-datasets](https://github.com/awesomedata/awesome-public-datasets) [![GitHub stars](https://img.shields.io/github/stars/awesomedata/awesome-public-datasets?style=flat)](https://github.com/awesomedata/awesome-public-datasets/stargazers)
- [awesome-Machine Learning & Deep Learning Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/ujjwalkarn/Machine-Learning-Tutorials/blob/master/README.md?style=flat)](https://github.com/ujjwalkarn/Machine-Learning-Tutorials/blob/master/README.md/stargazers)
- [Awesome Data Science Ideas](https://github.com/JosPolfliet/awesome-ai-usecases) [![GitHub stars](https://img.shields.io/github/stars/JosPolfliet/awesome-ai-usecases?style=flat)](https://github.com/JosPolfliet/awesome-ai-usecases/stargazers)
...
- [Awesome Machine Learning On Source Code](https://github.com/src-d/awesome-machine-learning-on-source-code) [![GitHub stars](https://img.shields.io/github/stars/src-d/awesome-machine-learning-on-source-code?style=flat)](https://github.com/src-d/awesome-machine-learning-on-source-code/stargazers)
- [Awesome Community Detection](https://github.com/benedekrozemberczki/awesome-community-detection) [![GitHub stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-community-detection?style=flat)](https://github.com/benedekrozemberczki/awesome-community-detection/stargazers)
- [Awesome Graph Classification](https://github.com/benedekrozemberczki/awesome-graph-classification) [![GitHub stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-graph-classification?style=flat)](https://github.com/benedekrozemberczki/awesome-graph-classification/stargazers)
- [Awesome Decision Tree Papers](https://github.com/benedekrozemberczki/awesome-decision-tree-papers) [![GitHub stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-decision-tree-papers?style=flat)](https://github.com/benedekrozemberczki/awesome-decision-tree-papers/stargazers)
- [Awesome Fraud Detection Papers](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers) [![GitHub stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-fraud-detection-papers?style=flat)](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers/stargazers)
- [Awesome Gradient Boosting Papers](https://github.com/benedekrozemberczki/awesome-gradient-boosting-papers) [![GitHub stars](https://img.shields.io/github/stars/benedekrozemberczki/awesome-gradient-boosting-papers?style=flat)](https://github.com/benedekrozemberczki/awesome-gradient-boosting-papers/stargazers)
- [Awesome Computer Vision Models](https://github.com/nerox8664/awesome-computer-vision-models) [![GitHub stars](https://img.shields.io/github/stars/nerox8664/awesome-computer-vision-models?style=flat)](https://github.com/nerox8664/awesome-computer-vision-models/stargazers)
...
- [Awesome Drug Synergy, Interaction and Polypharmacy Prediction](https://github.com/AstraZeneca/awesome-drug-pair-scoring) [![GitHub stars](https://img.shields.io/github/stars/AstraZeneca/awesome-drug-pair-scoring?style=flat)](https://github.com/AstraZeneca/awesome-drug-pair-scoring/stargazers)
...
- [Data Science Projects](https://github.com/veb-101/Data-Science-Projects) [![GitHub stars](https://img.shields.io/github/stars/veb-101/Data-Science-Projects?style=flat)](https://github.com/veb-101/Data-Science-Projects/stargazers)
...
- [Awesome Data Analysis](https://github.com/PavelGrigoryevDS/awesome-data-analysis) [![GitHub stars](https://img.shields.io/github/stars/PavelGrigoryevDS/awesome-data-analysis?style=flat)](https://github.com/PavelGrigoryevDS/awesome-data-analysis/stargazers) -  A curated list of data analysis tools, libraries and resources.
- [Awesome Evidence Synthesis](https://github.com/evidencesynthesis-tools/awesome-evidence-synthesis) [![GitHub stars](https://img.shields.io/github/stars/evidencesynthesis-tools/awesome-evidence-synthesis?style=flat)](https://github.com/evidencesynthesis-tools/awesome-evidence-synthesis/stargazers) - A curated list of open-source tools for systematic reviews, meta-analysis, and evidence synthesis.
- [AI Dev Jobs](https://aidevboard.com/) - Job board focused on AI/ML engineering roles with 5,400+ listings and a free REST API.


### Hobby
- [Awesome Music Production](https://github.com/ad-si/awesome-music-production) [![GitHub stars](https://img.shields.io/github/stars/ad-si/awesome-music-production?style=flat)](https://github.com/ad-si/awesome-music-production/stargazers)
