...
- Agent Skills
  ...
  - [graphify](https://github.com/safishamsi/graphify) [![GitHub stars](https://img.shields.io/github/stars/safishamsi/graphify?style=flat)](https://github.com/safishamsi/graphify/stargazers) - Turn any folder of code, SQL schemas, docs, papers, images, or videos into a queryable knowledge graph.
  - [nuwa-skill](https://github.com/alchaincyf/nuwa-skill/blob/main/README_EN.md) [![GitHub stars](https://img.shields.io/github/stars/alchaincyf/nuwa-skill/blob/main/README_EN.md?style=flat)](https://github.com/alchaincyf/nuwa-skill/blob/main/README_EN.md/stargazers) - Nuwa distills the thinking of anyone — let Musk, Naval, Munger, and Feynman work for you.
...
- Orchestration
  - [ag2](https://github.com/ag2ai/ag2) [![GitHub stars](https://img.shields.io/github/stars/ag2ai/ag2?style=flat)](https://github.com/ag2ai/ag2/stargazers) - An open-source AgentOS for multi-agent orchestration and building agentic AI systems.
  - [autogen](https://github.com/microsoft/autogen) [![GitHub stars](https://img.shields.io/github/stars/microsoft/autogen?style=flat)](https://github.com/microsoft/autogen/stargazers) - A programming framework for building agentic AI applications.
  - [bernstein](https://github.com/sipyourdrink-ltd/bernstein) [![GitHub stars](https://img.shields.io/github/stars/sipyourdrink-ltd/bernstein?style=flat)](https://github.com/sipyourdrink-ltd/bernstein/stargazers) - A deterministic Python orchestrator for CLI coding agents (Claude Code, Codex, Gemini CLI, and 40+ more) with parallel git worktrees and an HMAC-signed audit chain.
  - [bindu](https://github.com/getbindu/Bindu) [![GitHub stars](https://img.shields.io/github/stars/getbindu/Bindu?style=flat)](https://github.com/getbindu/Bindu/stargazers) - A framework that wraps any agent handler with DID-based cryptographic identity, A2A JSON-RPC over HTTP, OAuth2 auth, x402 (USDC) payments, and a built-in operator inbox.
  - [bub](https://github.com/bubbuild/bub) [![GitHub stars](https://img.shields.io/github/stars/bubbuild/bub?style=flat)](https://github.com/bubbuild/bub/stargazers) - A lightweight, hook-first Python framework for channel-native agents that live alongside people.
  ...
  - [hermes-agent](https://github.com/nousresearch/hermes-agent) [![GitHub stars](https://img.shields.io/github/stars/nousresearch/hermes-agent?style=flat)](https://github.com/nousresearch/hermes-agent/stargazers) - An adaptive AI agent framework that grows with you.
  ...
  - [livetalking](https://github.com/lipku/livetalking) [![GitHub stars](https://img.shields.io/github/stars/lipku/livetalking?style=flat)](https://github.com/lipku/livetalking/stargazers) - A framework for real time interactive streaming digital human.
...
- Data Layer
  ...
  - [lumen](https://github.com/holoviz/lumen) [![GitHub stars](https://img.shields.io/github/stars/holoviz/lumen?style=flat)](https://github.com/holoviz/lumen/stargazers) - An agent framework for conversational analysis of SQL, dataframe and multidimensional array data.
  ...
  - [outlines](https://github.com/dottxt-ai/outlines) [![GitHub stars](https://img.shields.io/github/stars/dottxt-ai/outlines?style=flat)](https://github.com/dottxt-ai/outlines/stargazers) - Structured text generation for LLMs with JSON schema, regex, and grammar-constrained decoding.
- Pre-trained Models and Inference
  ...
  - [liter-llm](https://github.com/xberg-io/liter-llm) [![GitHub stars](https://img.shields.io/github/stars/xberg-io/liter-llm?style=flat)](https://github.com/xberg-io/liter-llm/stargazers) - A universal LLM API client with a Rust core, calling 142+ providers through a single OpenAI-compatible interface, with a built-in proxy and MCP server.
...
- Speech
  ...
  - [SenseVoice](https://github.com/FunAudioLLM/SenseVoice) [![GitHub stars](https://img.shields.io/github/stars/FunAudioLLM/SenseVoice?style=flat)](https://github.com/FunAudioLLM/SenseVoice/stargazers) - A multilingual speech understanding model for speech recognition, language identification, emotion recognition, and audio event detection.
  ...
  - [voxcpm](https://github.com/OpenBMB/VoxCPM) [![GitHub stars](https://img.shields.io/github/stars/OpenBMB/VoxCPM?style=flat)](https://github.com/OpenBMB/VoxCPM/stargazers) - A tokenizer-free text-to-speech foundation model for multilingual speech generation and voice cloning.
...
- [spark.ml](https://github.com/apache/spark) [![GitHub stars](https://img.shields.io/github/stars/apache/spark?style=flat)](https://github.com/apache/spark/stargazers) - [Apache Spark](https://spark.apache.org/)'s scalable [Machine Learning library](https://spark.apache.org/docs/latest/ml-guide.html) for distributed computing.
- [TabGAN](https://github.com/Diyago/Tabular-data-generation) [![GitHub stars](https://img.shields.io/github/stars/Diyago/Tabular-data-generation?style=flat)](https://github.com/Diyago/Tabular-data-generation/stargazers) - Synthetic tabular data generation using GANs, Diffusion Models, and LLMs.
...
- Chinese
  - [funnlp](https://github.com/fighting41love/funNLP) [![GitHub stars](https://img.shields.io/github/stars/fighting41love/funNLP?style=flat)](https://github.com/fighting41love/funNLP/stargazers) - A collection of tools and datasets for Chinese NLP.
...
- [opencv](https://github.com/opencv/opencv-python) [![GitHub stars](https://img.shields.io/github/stars/opencv/opencv-python?style=flat)](https://github.com/opencv/opencv-python/stargazers) - Open Source Computer Vision Library.
...
- Synchronous
  ...
  - [masonite](https://github.com/MasoniteFramework/masonite) [![GitHub stars](https://img.shields.io/github/stars/MasoniteFramework/masonite?style=flat)](https://github.com/MasoniteFramework/masonite/stargazers) - The modern and developer centric Python web framework.
- Asynchronous
  ...
  - [microdot](https://github.com/miguelgrinberg/microdot) [![GitHub stars](https://img.shields.io/github/stars/miguelgrinberg/microdot?style=flat)](https://github.com/miguelgrinberg/microdot/stargazers) - The impossibly small web framework for Python and MicroPython.
  ...
  - [robyn](https://github.com/sparckles/Robyn) [![GitHub stars](https://img.shields.io/github/stars/sparckles/Robyn?style=flat)](https://github.com/sparckles/Robyn/stargazers) - A high-performance async Python web framework with a Rust runtime.
...
- Framework Agnostic
  ...
  - [falcon](https://github.com/falconry/falcon) [![GitHub stars](https://img.shields.io/github/stars/falconry/falcon?style=flat)](https://github.com/falconry/falcon/stargazers) - A high-performance framework for building cloud APIs and web app backends.
  ...
  - [sanic](https://github.com/sanic-org/sanic) [![GitHub stars](https://img.shields.io/github/stars/sanic-org/sanic?style=flat)](https://github.com/sanic-org/sanic/stargazers) - A Python web server and web framework that's written to go fast.
  ...
  - [webargs](https://github.com/marshmallow-code/webargs) [![GitHub stars](https://img.shields.io/github/stars/marshmallow-code/webargs?style=flat)](https://github.com/marshmallow-code/webargs/stargazers) - A friendly library for parsing HTTP request arguments with built-in support for popular web frameworks.
...
- ASGI
  - [daphne](https://github.com/django/daphne) [![GitHub stars](https://img.shields.io/github/stars/django/daphne?style=flat)](https://github.com/django/daphne/stargazers) - An HTTP, HTTP/2 and WebSocket protocol server for ASGI and ASGI-HTTP.
...
- WSGI
  ...
  - [uwsgi](https://github.com/unbit/uwsgi) [![GitHub stars](https://img.shields.io/github/stars/unbit/uwsgi?style=flat)](https://github.com/unbit/uwsgi/stargazers) - A project aims at developing a full stack for building hosting services, written in C.
...
- RPC
  ...
  - [rpyc](https://github.com/tomerfiliba-org/rpyc) [![GitHub stars](https://img.shields.io/github/stars/tomerfiliba-org/rpyc?style=flat)](https://github.com/tomerfiliba-org/rpyc/stargazers) (Remote Python Call) - A transparent and symmetric RPC library for Python.
...
- [picows](https://github.com/tarasko/picows) [![GitHub stars](https://img.shields.io/github/stars/tarasko/picows?style=flat)](https://github.com/tarasko/picows/stargazers) - Fastest WebSocket clients and servers with a frame level interface for the most demanding use-cases.
...
- [ajenti](https://github.com/ajenti/ajenti) [![GitHub stars](https://img.shields.io/github/stars/ajenti/ajenti?style=flat)](https://github.com/ajenti/ajenti/stargazers) - The admin panel your servers deserve.
...
- [flower](https://github.com/mher/flower) [![GitHub stars](https://img.shields.io/github/stars/mher/flower?style=flat)](https://github.com/mher/flower/stargazers) - Real-time monitor and web admin for Celery.
- [func-to-web](https://github.com/offerrall/FuncToWeb) [![GitHub stars](https://img.shields.io/github/stars/offerrall/FuncToWeb?style=flat)](https://github.com/offerrall/FuncToWeb/stargazers) - Instantly create web UIs from Python functions using type hints. Zero frontend code required.
- [jet-bridge](https://github.com/jet-admin/jet-bridge) [![GitHub stars](https://img.shields.io/github/stars/jet-admin/jet-bridge?style=flat)](https://github.com/jet-admin/jet-bridge/stargazers) - Admin panel framework for any application with nice UI (ex Jet Django).
...
- [indico](https://github.com/indico/indico) [![GitHub stars](https://img.shields.io/github/stars/indico/indico?style=flat)](https://github.com/indico/indico/stargazers) - A feature-rich event management system, made @ [CERN](https://en.wikipedia.org/wiki/CERN).
...
- [lektor](https://github.com/lektor/lektor) [![GitHub stars](https://img.shields.io/github/stars/lektor/lektor?style=flat)](https://github.com/lektor/lektor/stargazers) - An easy to use static CMS and blog engine.
...
- [furl](https://github.com/gruns/furl) [![GitHub stars](https://img.shields.io/github/stars/gruns/furl?style=flat)](https://github.com/gruns/furl/stargazers) - A small Python library that makes parsing and manipulating URLs easy.
- [httptap](https://github.com/ozeranskii/httptap) [![GitHub stars](https://img.shields.io/github/stars/ozeranskii/httptap?style=flat)](https://github.com/ozeranskii/httptap/stargazers) - Dissects an HTTP request into DNS, TCP, TLS, wait, and transfer phases and renders the timings as a waterfall.
...
- Content Extraction
  ...
  - [micawber](https://github.com/coleifer/micawber) [![GitHub stars](https://img.shields.io/github/stars/coleifer/micawber?style=flat)](https://github.com/coleifer/micawber/stargazers) - A small library for extracting rich content from URLs.
  - [sumy](https://github.com/miso-belica/sumy) [![GitHub stars](https://img.shields.io/github/stars/miso-belica/sumy?style=flat)](https://github.com/miso-belica/sumy/stargazers) - A module for automatic summarization of text documents and HTML pages.
...
- [modoboa](https://github.com/modoboa/modoboa) [![GitHub stars](https://img.shields.io/github/stars/modoboa/modoboa?style=flat)](https://github.com/modoboa/modoboa/stargazers) - A mail hosting and management platform including a modern Web UI.
...
- Relational Databases
  ...
  - [dataset](https://github.com/pudo/dataset) [![GitHub stars](https://img.shields.io/github/stars/pudo/dataset?style=flat)](https://github.com/pudo/dataset/stargazers) - Store Python dicts in a database - works with SQLite, MySQL, and PostgreSQL.
  ...
  - [pony](https://github.com/ponyorm/pony/) [![GitHub stars](https://img.shields.io/github/stars/ponyorm/pony/?style=flat)](https://github.com/ponyorm/pony//stargazers) - ORM that provides a generator-oriented interface to SQL.
  ...
  - [tortoise-orm](https://github.com/tortoise/tortoise-orm) [![GitHub stars](https://img.shields.io/github/stars/tortoise/tortoise-orm?style=flat)](https://github.com/tortoise/tortoise-orm/stargazers) - An easy-to-use asyncio ORM inspired by Django, with relations support.
- NoSQL Databases
...
- NoSQL Databases
  ...
  - [redis-py](https://github.com/redis/redis-py) [![GitHub stars](https://img.shields.io/github/stars/redis/redis-py?style=flat)](https://github.com/redis/redis-py/stargazers) - The Python client for Redis.
...
- [python-diskcache](https://github.com/grantjenks/python-diskcache) [![GitHub stars](https://img.shields.io/github/stars/grantjenks/python-diskcache?style=flat)](https://github.com/grantjenks/python-diskcache/stargazers) - SQLite and file backed cache backend with faster lookups than memcached and redis.
...
- [elasticsearch-py](https://github.com/elastic/elasticsearch-py) [![GitHub stars](https://img.shields.io/github/stars/elastic/elasticsearch-py?style=flat)](https://github.com/elastic/elasticsearch-py/stargazers) - The official low-level Python client for [Elasticsearch](https://www.elastic.co/products/elasticsearch).
- [pysolr](https://github.com/django-haystack/pysolr) [![GitHub stars](https://img.shields.io/github/stars/django-haystack/pysolr?style=flat)](https://github.com/django-haystack/pysolr/stargazers) - A lightweight Python wrapper for [Apache Solr](https://lucene.apache.org/solr/).
...
- Financial Data
  ...
  - [lumibot](https://github.com/Lumiwealth/lumibot) [![GitHub stars](https://img.shields.io/github/stars/Lumiwealth/lumibot?style=flat)](https://github.com/Lumiwealth/lumibot/stargazers) - Algorithmic trading framework for backtesting and live deployment across stocks, options, crypto, futures, and forex.
...
- [cerberus](https://github.com/pyeve/cerberus) [![GitHub stars](https://img.shields.io/github/stars/pyeve/cerberus?style=flat)](https://github.com/pyeve/cerberus/stargazers) - A lightweight and extensible data validation library.
...
- [voluptuous](https://github.com/alecthomas/voluptuous) [![GitHub stars](https://img.shields.io/github/stars/alecthomas/voluptuous?style=flat)](https://github.com/alecthomas/voluptuous/stargazers) - A Python data validation library primarily intended for validating data from untrusted sources.
...
- Plotting
  ...
  - [bqplot](https://github.com/bqplot/bqplot) [![GitHub stars](https://img.shields.io/github/stars/bqplot/bqplot?style=flat)](https://github.com/bqplot/bqplot/stargazers) - Interactive Plotting Library for the Jupyter Notebook.
  ...
  - [plotnine](https://github.com/has2k1/plotnine) [![GitHub stars](https://img.shields.io/github/stars/has2k1/plotnine?style=flat)](https://github.com/has2k1/plotnine/stargazers) - A grammar of graphics for Python based on ggplot2.
  - [pygal](https://github.com/Kozea/pygal) [![GitHub stars](https://img.shields.io/github/stars/Kozea/pygal?style=flat)](https://github.com/Kozea/pygal/stargazers) - A Python SVG Charts Creator.
  - [pyqtgraph](https://github.com/pyqtgraph/pyqtgraph) [![GitHub stars](https://img.shields.io/github/stars/pyqtgraph/pyqtgraph?style=flat)](https://github.com/pyqtgraph/pyqtgraph/stargazers) - Interactive and realtime 2D/3D/Image plotting and science/engineering widgets.
  ...
  - [ultraplot](https://github.com/ultraplot/UltraPlot) [![GitHub stars](https://img.shields.io/github/stars/ultraplot/UltraPlot?style=flat)](https://github.com/ultraplot/UltraPlot/stargazers) - Matplotlib wrapper for publication-ready scientific figures with minimal code. Includes advanced subplot management, panel layouts, and batteries-included geoscience plotting.
  - [vispy](https://github.com/vispy/vispy) [![GitHub stars](https://img.shields.io/github/stars/vispy/vispy?style=flat)](https://github.com/vispy/vispy/stargazers) - High-performance scientific visualization based on OpenGL.
- Specialized
...
- [django-countries](https://github.com/SmileyChris/django-countries) [![GitHub stars](https://img.shields.io/github/stars/SmileyChris/django-countries?style=flat)](https://github.com/SmileyChris/django-countries/stargazers) - A Django app that provides a country field for models and forms.
...
- Biology and Chemistry
  ...
  - [cclib](https://github.com/cclib/cclib) [![GitHub stars](https://img.shields.io/github/stars/cclib/cclib?style=flat)](https://github.com/cclib/cclib/stargazers) - A library for parsing and interpreting the results of computational chemistry packages.
  - [openbabel](https://github.com/openbabel/openbabel) [![GitHub stars](https://img.shields.io/github/stars/openbabel/openbabel?style=flat)](https://github.com/openbabel/openbabel/stargazers) - A chemical toolbox designed to speak the many languages of chemical data.
...
- Physics and Engineering
  ...
  - [pydy](https://github.com/pydy/pydy) [![GitHub stars](https://img.shields.io/github/stars/pydy/pydy?style=flat)](https://github.com/pydy/pydy/stargazers) - Short for Python Dynamics, used to assist with workflow in the modeling of dynamic motion.
  - [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) [![GitHub stars](https://img.shields.io/github/stars/AtsushiSakai/PythonRobotics?style=flat)](https://github.com/AtsushiSakai/PythonRobotics/stargazers) - This is a compilation of various robotics algorithms with visualizations.
- Simulation and Modeling
  ...
  - [pathsim](https://github.com/pathsim/pathsim) [![GitHub stars](https://img.shields.io/github/stars/pathsim/pathsim?style=flat)](https://github.com/pathsim/pathsim/stargazers) - A block-based system modeling and simulation framework with a browser-based visual editor.
...
- Other
  - [colour](https://github.com/colour-science/colour) [![GitHub stars](https://img.shields.io/github/stars/colour-science/colour?style=flat)](https://github.com/colour-science/colour/stargazers) - Implementing a comprehensive number of colour theory transformations and algorithms.
...
- Code Analysis
  - [code2flow](https://github.com/scottrogowski/code2flow) [![GitHub stars](https://img.shields.io/github/stars/scottrogowski/code2flow?style=flat)](https://github.com/scottrogowski/code2flow/stargazers) - Turn your Python and JavaScript code into DOT flowcharts.
...
- Type Checkers - [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) [![GitHub stars](https://img.shields.io/github/stars/typeddjango/awesome-python-typing?style=flat)](https://github.com/typeddjango/awesome-python-typing/stargazers)
  ...
  - [typeshed](https://github.com/python/typeshed) [![GitHub stars](https://img.shields.io/github/stars/python/typeshed?style=flat)](https://github.com/python/typeshed/stargazers) - Collection of library stubs for Python, with static types.
- Type Annotations Generators
  ...
  - [pytype](https://github.com/google/pytype) [![GitHub stars](https://img.shields.io/github/stars/google/pytype?style=flat)](https://github.com/google/pytype/stargazers) - Pytype checks and infers types for Python code - without requiring type annotations.
...
- Frameworks
  ...
  - [scanapi](https://github.com/scanapi/scanapi) [![GitHub stars](https://img.shields.io/github/stars/scanapi/scanapi?style=flat)](https://github.com/scanapi/scanapi/stargazers) - Automated Testing and Documentation for your REST API.
...
- GUI / Web Testing
  ...
  - [pyautogui](https://github.com/asweigart/pyautogui) [![GitHub stars](https://img.shields.io/github/stars/asweigart/pyautogui?style=flat)](https://github.com/asweigart/pyautogui/stargazers) - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
...
- Mock
  ...
  - [mocket](https://github.com/mindflayer/python-mocket) [![GitHub stars](https://img.shields.io/github/stars/mindflayer/python-mocket?style=flat)](https://github.com/mindflayer/python-mocket/stargazers) - A socket mock framework with gevent/asyncio/SSL support.
...
- Tracing
  - [manhole](https://github.com/ionelmc/python-manhole) [![GitHub stars](https://img.shields.io/github/stars/ionelmc/python-manhole?style=flat)](https://github.com/ionelmc/python-manhole/stargazers) - Debugging UNIX socket connections and present the stacktraces for all threads and an interactive prompt.
  - [python-hunter](https://github.com/ionelmc/python-hunter) [![GitHub stars](https://img.shields.io/github/stars/ionelmc/python-hunter?style=flat)](https://github.com/ionelmc/python-hunter/stargazers) - A flexible code tracing toolkit.
- Profiler
...
- Others
  ...
  - [memory_graph](https://github.com/bterwijn/memory_graph) [![GitHub stars](https://img.shields.io/github/stars/bterwijn/memory_graph?style=flat)](https://github.com/bterwijn/memory_graph/stargazers) - Visualize Python data at runtime to debug references, mutability, and aliasing.
...
- Configuration Management
  ...
  - [cloudinit](https://github.com/canonical/cloud-init) [![GitHub stars](https://img.shields.io/github/stars/canonical/cloud-init?style=flat)](https://github.com/canonical/cloud-init/stargazers) - A multi-distribution package that handles early initialization of a cloud instance.
  - [openstack](https://github.com/openstack/openstack) [![GitHub stars](https://img.shields.io/github/stars/openstack/openstack?style=flat)](https://github.com/openstack/openstack/stargazers) - Open source software for building private and public clouds.
  ...
  - [saltstack](https://github.com/saltstack/salt) [![GitHub stars](https://img.shields.io/github/stars/saltstack/salt?style=flat)](https://github.com/saltstack/salt/stargazers) - Infrastructure automation and management system.
- Deployment
...
- Monitoring and Processes
  ...
  - [sentry-python](https://github.com/getsentry/sentry-python) [![GitHub stars](https://img.shields.io/github/stars/getsentry/sentry-python?style=flat)](https://github.com/getsentry/sentry-python/stargazers) - Sentry SDK for Python.
...
- Other
  - [borg](https://github.com/borgbackup/borg) [![GitHub stars](https://img.shields.io/github/stars/borgbackup/borg?style=flat)](https://github.com/borgbackup/borg/stargazers) - A deduplicating archiver with compression and encryption.
  ...
  - [kubesdk](https://github.com/puzl-cloud/kubesdk) [![GitHub stars](https://img.shields.io/github/stars/puzl-cloud/kubesdk?style=flat)](https://github.com/puzl-cloud/kubesdk/stargazers) - A modern async-first Kubernetes client and API model generator.
...
- Batch Processing
  ...
  - [luigi](https://github.com/spotify/luigi) [![GitHub stars](https://img.shields.io/github/stars/spotify/luigi?style=flat)](https://github.com/spotify/luigi/stargazers) - A module that helps you build complex pipelines of batch jobs.
...
- [airflow](https://github.com/apache/airflow) [![GitHub stars](https://img.shields.io/github/stars/apache/airflow?style=flat)](https://github.com/apache/airflow/stargazers) - Airflow is a platform to programmatically author, schedule and monitor workflows.
...
- [SpiffWorkflow](https://github.com/sartography/SpiffWorkflow) [![GitHub stars](https://img.shields.io/github/stars/sartography/SpiffWorkflow?style=flat)](https://github.com/sartography/SpiffWorkflow/stargazers) - A powerful workflow engine implemented in pure Python.

### Logging

_Libraries for generating and working with logs._

- [logfmter](https://github.com/josheppinette/python-logfmter) [![GitHub stars](https://img.shields.io/github/stars/josheppinette/python-logfmter?style=flat)](https://github.com/josheppinette/python-logfmter/stargazers) - A standard library compatible logfmt formatter.
...
- [mininet](https://github.com/mininet/mininet) [![GitHub stars](https://img.shields.io/github/stars/mininet/mininet?style=flat)](https://github.com/mininet/mininet/stargazers) - A popular network emulator and API written in Python.
...
- CLI Development
  ...
  - [cement](https://github.com/datafolklabs/cement) [![GitHub stars](https://img.shields.io/github/stars/datafolklabs/cement?style=flat)](https://github.com/datafolklabs/cement/stargazers) - CLI Application Framework for Python.
  ...
  - [python-fire](https://github.com/google/python-fire) [![GitHub stars](https://img.shields.io/github/stars/google/python-fire?style=flat)](https://github.com/google/python-fire/stargazers) - A library for creating command line interfaces from absolutely any Python object.
  - [python-prompt-toolkit](https://github.com/prompt-toolkit/python-prompt-toolkit) [![GitHub stars](https://img.shields.io/github/stars/prompt-toolkit/python-prompt-toolkit?style=flat)](https://github.com/prompt-toolkit/python-prompt-toolkit/stargazers) - A library for building powerful interactive command lines.
...
- Productivity Tools
  ...
  - [doitlive](https://github.com/sloria/doitlive) [![GitHub stars](https://img.shields.io/github/stars/sloria/doitlive?style=flat)](https://github.com/sloria/doitlive/stargazers) - A tool for live presentations in the terminal.
  - [kaydet](https://github.com/miratcan/kaydet) [![GitHub stars](https://img.shields.io/github/stars/miratcan/kaydet?style=flat)](https://github.com/miratcan/kaydet/stargazers) - Queryable personal database and terminal diary with SQLite search, tags, metadata, and AI integration via MCP.
  - [thefuck](https://github.com/nvbn/thefuck) [![GitHub stars](https://img.shields.io/github/stars/nvbn/thefuck?style=flat)](https://github.com/nvbn/thefuck/stargazers) - Correcting your previous console command.
...
- Desktop
  ...
  - [enaml](https://github.com/nucleic/enaml) [![GitHub stars](https://img.shields.io/github/stars/nucleic/enaml?style=flat)](https://github.com/nucleic/enaml/stargazers) - Creating beautiful user-interfaces with Declarative Syntax like QML.
...
- General
  ...
  - [textdistance](https://github.com/life4/textdistance) [![GitHub stars](https://img.shields.io/github/stars/life4/textdistance?style=flat)](https://github.com/life4/textdistance/stargazers) - Compute distance between sequences with 30+ algorithms.
...
- Parser
  ...
  - [python-nameparser](https://github.com/derek73/python-nameparser) [![GitHub stars](https://img.shields.io/github/stars/derek73/python-nameparser?style=flat)](https://github.com/derek73/python-nameparser/stargazers) - Parsing human names into their individual components.
  - [python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) [![GitHub stars](https://img.shields.io/github/stars/daviddrysdale/python-phonenumbers?style=flat)](https://github.com/daviddrysdale/python-phonenumbers/stargazers) - Parsing, formatting, storing and validating international phone numbers.
  - [python-user-agents](https://github.com/selwin/python-user-agents) [![GitHub stars](https://img.shields.io/github/stars/selwin/python-user-agents?style=flat)](https://github.com/selwin/python-user-agents/stargazers) - Browser user agent parser.
  ...
  - [tree-sitter-language-pack](https://github.com/xberg-io/tree-sitter-language-pack) [![GitHub stars](https://img.shields.io/github/stars/xberg-io/tree-sitter-language-pack?style=flat)](https://github.com/xberg-io/tree-sitter-language-pack/stargazers) - A comprehensive collection of tree-sitter parsers for 300+ languages, distributed as prebuilt wheels.
...
- [pyquery](https://github.com/gawel/pyquery) [![GitHub stars](https://img.shields.io/github/stars/gawel/pyquery?style=flat)](https://github.com/gawel/pyquery/stargazers) - A jQuery-like library for parsing HTML.
- [tinycss2](https://github.com/Kozea/tinycss2) [![GitHub stars](https://img.shields.io/github/stars/Kozea/tinycss2?style=flat)](https://github.com/Kozea/tinycss2/stargazers) - A low-level CSS parser and generator written in Python.
...
- MS Office
  - [docxtpl](https://github.com/elapouya/python-docx-template) [![GitHub stars](https://img.shields.io/github/stars/elapouya/python-docx-template?style=flat)](https://github.com/elapouya/python-docx-template/stargazers) - Editing a docx document by jinja2 template
  - [openpyxl](https://openpyxl.readthedocs.io/en/stable/) - A library for reading and writing Excel 2010 xlsx/xlsm/xltx/xltm files.
  - [pyexcel](https://github.com/pyexcel/pyexcel) [![GitHub stars](https://img.shields.io/github/stars/pyexcel/pyexcel?style=flat)](https://github.com/pyexcel/pyexcel/stargazers) - Providing one API for reading, manipulating and writing csv, ods, xls, xlsx and xlsm files.
  ...
  - [xlwings](https://github.com/xlwings/xlwings) [![GitHub stars](https://img.shields.io/github/stars/xlwings/xlwings?style=flat)](https://github.com/xlwings/xlwings/stargazers) - A BSD-licensed library that makes it easy to call Python from Excel and vice versa.
- PDF
  - [pdf_oxide](https://github.com/yfedoseev/pdf_oxide) [![GitHub stars](https://img.shields.io/github/stars/yfedoseev/pdf_oxide?style=flat)](https://github.com/yfedoseev/pdf_oxide/stargazers) - A fast PDF library for text extraction, image extraction, and markdown conversion, powered by Rust.
  ...
  - [pikepdf](https://github.com/pikepdf/pikepdf) [![GitHub stars](https://img.shields.io/github/stars/pikepdf/pikepdf?style=flat)](https://github.com/pikepdf/pikepdf/stargazers) - A powerful library for reading and editing PDF files, based on qpdf.
...
- Data Formats
  - [csvkit](https://github.com/wireservice/csvkit) [![GitHub stars](https://img.shields.io/github/stars/wireservice/csvkit?style=flat)](https://github.com/wireservice/csvkit/stargazers) - Utilities for converting to and working with CSV.
...
- [pymatting](https://github.com/pymatting/pymatting) [![GitHub stars](https://img.shields.io/github/stars/pymatting/pymatting?style=flat)](https://github.com/pymatting/pymatting/stargazers) - A library for alpha matting.
...
- [python-qrcode](https://github.com/lincolnloop/python-qrcode) [![GitHub stars](https://img.shields.io/github/stars/lincolnloop/python-qrcode?style=flat)](https://github.com/lincolnloop/python-qrcode/stargazers) - A pure Python QR Code generator.
...
- Audio
  - [birdnet](https://github.com/birdnet-team/BirdNET-Analyzer) [![GitHub stars](https://img.shields.io/github/stars/birdnet-team/BirdNET-Analyzer?style=flat)](https://github.com/birdnet-team/BirdNET-Analyzer/stargazers) - Deep learning framework for acoustic species detection; identifies bird species from audio recordings using TensorFlow.
  ...
  - [matchering](https://github.com/sergree/matchering) [![GitHub stars](https://img.shields.io/github/stars/sergree/matchering?style=flat)](https://github.com/sergree/matchering/stargazers) - A library for automated reference audio mastering.
...
- [py-sdl2](https://github.com/py-sdl/py-sdl2) [![GitHub stars](https://img.shields.io/github/stars/py-sdl/py-sdl2?style=flat)](https://github.com/py-sdl/py-sdl2/stargazers) - A ctypes based wrapper for the SDL2 library.
...
- [pyopengl](https://github.com/mcfletch/pyopengl) [![GitHub stars](https://img.shields.io/github/stars/mcfletch/pyopengl?style=flat)](https://github.com/mcfletch/pyopengl/stargazers) - Python ctypes bindings for OpenGL and it's related APIs.
...
- [ironpython](https://github.com/IronLanguages/ironpython3) [![GitHub stars](https://img.shields.io/github/stars/IronLanguages/ironpython3?style=flat)](https://github.com/IronLanguages/ironpython3/stargazers) - Implementation of the Python programming language written in C#.
...
- [box](https://github.com/cdgriffith/Box) [![GitHub stars](https://img.shields.io/github/stars/cdgriffith/Box?style=flat)](https://github.com/cdgriffith/Box/stargazers) - Python dictionaries with advanced dot notation access.
...
- [coconut](https://github.com/evhub/coconut) [![GitHub stars](https://img.shields.io/github/stars/evhub/coconut?style=flat)](https://github.com/evhub/coconut/stargazers) - A variant of Python built for simple, elegant, Pythonic functional programming.
...
- [dateutil](https://github.com/dateutil/dateutil) [![GitHub stars](https://img.shields.io/github/stars/dateutil/dateutil?style=flat)](https://github.com/dateutil/dateutil/stargazers) - Extensions to the standard Python [datetime](https://docs.python.org/3/library/datetime.html) module.
...
- [KillPy](https://github.com/Tlaloc-Es/killpy) [![GitHub stars](https://img.shields.io/github/stars/Tlaloc-Es/killpy?style=flat)](https://github.com/Tlaloc-Es/killpy/stargazers) - Analyze, detect, and clean unused Python environments and pipx packages.
...
- [pyenv-win](https://github.com/pyenv-win/pyenv-win) [![GitHub stars](https://img.shields.io/github/stars/pyenv-win/pyenv-win?style=flat)](https://github.com/pyenv-win/pyenv-win/stargazers) - Pyenv for Windows.
...
- [hydra](https://github.com/facebookresearch/hydra) [![GitHub stars](https://img.shields.io/github/stars/facebookresearch/hydra?style=flat)](https://github.com/facebookresearch/hydra/stargazers) - Hydra is a framework for elegantly configuring complex applications.
- [python-decouple](https://github.com/HBNetwork/python-decouple) [![GitHub stars](https://img.shields.io/github/stars/HBNetwork/python-decouple?style=flat)](https://github.com/HBNetwork/python-decouple/stargazers) - Strict separation of settings from code.
...
- [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) [![GitHub stars](https://img.shields.io/github/stars/trustedsec/social-engineer-toolkit?style=flat)](https://github.com/trustedsec/social-engineer-toolkit/stargazers) - A toolkit for social engineering.
- [sherlock](https://github.com/sherlock-project/sherlock) [![GitHub stars](https://img.shields.io/github/stars/sherlock-project/sherlock?style=flat)](https://github.com/sherlock-project/sherlock/stargazers) - Hunt down social media accounts by username across social networks.
...
- [synology-api](https://github.com/N4S4/synology-api) [![GitHub stars](https://img.shields.io/github/stars/N4S4/synology-api?style=flat)](https://github.com/N4S4/synology-api/stargazers) - Python wrapper for Synology NAS APIs: Surveillance Station, File Station, Download Station, Docker, and 50+ other endpoints.
...
- [tryton](https://github.com/tryton/tryton) [![GitHub stars](https://img.shields.io/github/stars/tryton/tryton?style=flat)](https://github.com/tryton/tryton/stargazers) - A general-purpose business framework.
