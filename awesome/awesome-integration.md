...
> 来源：[stn1slv/awesome-integration](https://github.com/stn1slv/awesome-integration)

[![GitHub stars](https://img.shields.io/github/stars/stn1slv/awesome-integration?style=flat)](https://github.com/stn1slv/awesome-integration/stargazers)
...
- [agentgateway (⭐4.2k)](https://github.com/agentgateway/agentgateway) [![GitHub stars](https://img.shields.io/github/stars/agentgateway/agentgateway?style=flat)](https://github.com/agentgateway/agentgateway/stargazers) - An open-source data plane for agentic AI connectivity, providing security, observability, and governance for agent-to-tool (MCP) and agent-to-agent (A2A) communication.
- [Bifrost (⭐7.2k)](https://github.com/maximhq/bifrost) [![GitHub stars](https://img.shields.io/github/stars/maximhq/bifrost?style=flat)](https://github.com/maximhq/bifrost/stargazers) - A high-performance AI gateway written in Go that unifies more than 20 model providers behind a single OpenAI-compatible API, with failover, load balancing, semantic caching, and governance.
- [Docker MCP Gateway (⭐1.5k)](https://github.com/docker/mcp-gateway) [![GitHub stars](https://img.shields.io/github/stars/docker/mcp-gateway?style=flat)](https://github.com/docker/mcp-gateway/stargazers) - Runs MCP servers as isolated containers with restricted privileges and managed secrets, exposing them to AI clients through one gateway endpoint.
- [Envoy AI Gateway (⭐1.9k)](https://github.com/envoyproxy/ai-gateway) [![GitHub stars](https://img.shields.io/github/stars/envoyproxy/ai-gateway?style=flat)](https://github.com/envoyproxy/ai-gateway/stargazers) - An open-source gateway built on Envoy Proxy to manage request traffic from application clients to GenAI services with unified API access and usage limits.
- [IBM ContextForge (⭐4.2k)](https://github.com/IBM/mcp-context-forge) [![GitHub stars](https://img.shields.io/github/stars/IBM/mcp-context-forge?style=flat)](https://github.com/IBM/mcp-context-forge/stargazers) - An AI gateway, registry, and proxy that federates MCP, A2A, and REST services behind a single endpoint with governance and observability.
...
- [LiteLLM (⭐56k)](https://github.com/BerriAI/litellm) [![GitHub stars](https://img.shields.io/github/stars/BerriAI/litellm?style=flat)](https://github.com/BerriAI/litellm/stargazers) - An LLM gateway that exposes 100+ model providers through a unified OpenAI-compatible API, with spend tracking, fallbacks, and rate limiting.
- [MCPJungle (⭐1.1k)](https://github.com/mcpjungle/MCPJungle) [![GitHub stars](https://img.shields.io/github/stars/mcpjungle/MCPJungle?style=flat)](https://github.com/mcpjungle/MCPJungle/stargazers) - A self-hosted MCP gateway and registry that centralises multiple MCP servers behind one endpoint for AI agents.
- [Obot (⭐937)](https://github.com/obot-platform/obot) [![GitHub stars](https://img.shields.io/github/stars/obot-platform/obot?style=flat)](https://github.com/obot-platform/obot/stargazers) - An open-source MCP platform that combines server hosting, a registry, a gateway, and a chat client with access control and audit logging.
- [Portkey AI Gateway (⭐12k)](https://github.com/Portkey-AI/gateway) [![GitHub stars](https://img.shields.io/github/stars/Portkey-AI/gateway?style=flat)](https://github.com/Portkey-AI/gateway/stargazers) - A fast AI gateway that routes to 250+ LLMs with guardrails, caching, retries, and load balancing via a single API.
...
- [Gravitee.io API Management (⭐439)](https://github.com/gravitee-io/gravitee-api-management) [![GitHub stars](https://img.shields.io/github/stars/gravitee-io/gravitee-api-management?style=flat)](https://github.com/gravitee-io/gravitee-api-management/stargazers) - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
- [WSO2 API Manager (⭐1k)](https://github.com/wso2/product-apim) [![GitHub stars](https://img.shields.io/github/stars/wso2/product-apim?style=flat)](https://github.com/wso2/product-apim/stargazers) - A fully open-source API platform offering robust governance, flexible deployment, and community-driven innovation.
...
- [Apicurio Studio (⭐1k)](https://github.com/apicurio/apicurio-studio) [![GitHub stars](https://img.shields.io/github/stars/apicurio/apicurio-studio?style=flat)](https://github.com/apicurio/apicurio-studio/stargazers) - A web-based, open-source API design tool that leverages the OpenAPI specification.
- [Dredd (⭐4.2k)](https://github.com/apiaryio/dredd) [![GitHub stars](https://img.shields.io/github/stars/apiaryio/dredd?style=flat)](https://github.com/apiaryio/dredd/stargazers) - Validate API description docs against backend implementation using this language-agnostic CLI tool.
- [Kiota (⭐3.7k)](https://github.com/microsoft/kiota) [![GitHub stars](https://img.shields.io/github/stars/microsoft/kiota?style=flat)](https://github.com/microsoft/kiota/stargazers) - A command-line generator from Microsoft that turns an OpenAPI description into a lightweight, strongly typed API client in many languages.
- [oasdiff (⭐1.3k)](https://github.com/oasdiff/oasdiff) [![GitHub stars](https://img.shields.io/github/stars/oasdiff/oasdiff?style=flat)](https://github.com/oasdiff/oasdiff/stargazers) - Compare OpenAPI specs and detect breaking changes, with changelog generation in multiple output formats.
- [OpenAPI Diff (⭐1k)](https://github.com/OpenAPITools/openapi-diff) [![GitHub stars](https://img.shields.io/github/stars/OpenAPITools/openapi-diff?style=flat)](https://github.com/OpenAPITools/openapi-diff/stargazers) - Compare OpenAPI specs with version control and visualize the differences in HTML or Markdown format.
- [OpenAPI Generator (⭐26k)](https://github.com/OpenAPITools/openapi-generator) [![GitHub stars](https://img.shields.io/github/stars/OpenAPITools/openapi-generator?style=flat)](https://github.com/OpenAPITools/openapi-generator/stargazers) - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
- [OpenAPI Style Validator (⭐236)](https://github.com/OpenAPITools/openapi-style-validator) [![GitHub stars](https://img.shields.io/github/stars/OpenAPITools/openapi-style-validator?style=flat)](https://github.com/OpenAPITools/openapi-style-validator/stargazers) - Ensure that your OpenAPI specs meet your organization's standards with this flexible and customizable style validator.
- [OpenAPI-GUI (⭐1.4k)](https://github.com/Mermade/openapi-gui) [![GitHub stars](https://img.shields.io/github/stars/Mermade/openapi-gui?style=flat)](https://github.com/Mermade/openapi-gui/stargazers) - Create and validate OpenAPI specs with ease using this intuitive graphical user interface.
- [Redocly CLI (⭐1.4k)](https://github.com/Redocly/redocly-cli) [![GitHub stars](https://img.shields.io/github/stars/Redocly/redocly-cli?style=flat)](https://github.com/Redocly/redocly-cli/stargazers) - Lint, bundle, and preview OpenAPI descriptions with configurable rulesets and plugins.
- [Spectral (⭐3.1k)](https://github.com/stoplightio/spectral) [![GitHub stars](https://img.shields.io/github/stars/stoplightio/spectral?style=flat)](https://github.com/stoplightio/spectral/stargazers) - Detect and fix errors in your JSON/YAML files using this linter tool that supports OpenAPI 3.0 & 2.0 and AsyncAPI.
- [Swagger Editor (⭐9.4k)](https://github.com/swagger-api/swagger-editor) [![GitHub stars](https://img.shields.io/github/stars/swagger-api/swagger-editor?style=flat)](https://github.com/swagger-api/swagger-editor/stargazers) - Create, describe, and document your API with ease using this open source editor built specifically for OpenAPI-based APIs.
- [vacuum (⭐1.1k)](https://github.com/daveshanley/vacuum) [![GitHub stars](https://img.shields.io/github/stars/daveshanley/vacuum?style=flat)](https://github.com/daveshanley/vacuum/stargazers) - An ultra-fast OpenAPI linter and quality analysis tool, compatible with Spectral rulesets.
- [Zally (⭐945)](https://github.com/zalando/zally) [![GitHub stars](https://img.shields.io/github/stars/zalando/zally?style=flat)](https://github.com/zalando/zally/stargazers) - Ensure the quality of your OpenAPI specs with this linter tool that provides extensive analysis and feedback.
...
- [DapperDox (⭐416)](https://github.com/DapperDox/dapperdox) [![GitHub stars](https://img.shields.io/github/stars/DapperDox/dapperdox?style=flat)](https://github.com/DapperDox/dapperdox/stargazers) - Generates elegant, interactive API documentation from OpenAPI/Swagger specs with easy customization and automated updates.
- [Fern (⭐3.7k)](https://github.com/fern-api/fern) [![GitHub stars](https://img.shields.io/github/stars/fern-api/fern?style=flat)](https://github.com/fern-api/fern/stargazers) - Generates SDKs and interactive API documentation from OpenAPI or its own API definition format.
- [OpenAPI Explorer (⭐352)](https://github.com/Rhosys/openapi-explorer) [![GitHub stars](https://img.shields.io/github/stars/Rhosys/openapi-explorer?style=flat)](https://github.com/Rhosys/openapi-explorer/stargazers) - Creates intuitive, interactive user interfaces from OpenAPI specs, simplifying API exploration and testing.
- [RapiDoc (⭐1.8k)](https://github.com/rapi-doc/RapiDoc) [![GitHub stars](https://img.shields.io/github/stars/rapi-doc/RapiDoc?style=flat)](https://github.com/rapi-doc/RapiDoc/stargazers) - Produces highly customizable, interactive API documentation with responsive design and rich configuration options.
...
- [Redoc (⭐25k)](https://github.com/Redocly/redoc) [![GitHub stars](https://img.shields.io/github/stars/Redocly/redoc?style=flat)](https://github.com/Redocly/redoc/stargazers) - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
- [Scalar (⭐15k)](https://github.com/scalar/scalar) [![GitHub stars](https://img.shields.io/github/stars/scalar/scalar?style=flat)](https://github.com/scalar/scalar/stargazers) - Renders modern, interactive API references from OpenAPI/Swagger documents, with an integrated API client and broad framework integrations.
- [Slate (⭐36k)](https://github.com/slatedocs/slate) [![GitHub stars](https://img.shields.io/github/stars/slatedocs/slate?style=flat)](https://github.com/slatedocs/slate/stargazers) - Converts markdown into stylish, static API documentation with intuitive navigation and clear code examples.
- [SpectaQL (⭐1.2k)](https://github.com/anvilco/spectaql) [![GitHub stars](https://img.shields.io/github/stars/anvilco/spectaql?style=flat)](https://github.com/anvilco/spectaql/stargazers) - Generates static, customizable documentation for GraphQL schemas, making complex API structures easy to understand.
- [Stoplight Elements (⭐2.4k)](https://github.com/stoplightio/elements) [![GitHub stars](https://img.shields.io/github/stars/stoplightio/elements?style=flat)](https://github.com/stoplightio/elements/stargazers) - Provides modular, attractive UI components for building comprehensive API reference and tutorial documentation.
...
- [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) [![GitHub stars](https://img.shields.io/github/stars/swagger-api/swagger-ui?style=flat)](https://github.com/swagger-api/swagger-ui/stargazers) - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
- [Zudoku (⭐575)](https://github.com/zuplo/zudoku) [![GitHub stars](https://img.shields.io/github/stars/zuplo/zudoku?style=flat)](https://github.com/zuplo/zudoku/stargazers) - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
- [Apinto (⭐1.6k)](https://github.com/eolinker/apinto) [![GitHub stars](https://img.shields.io/github/stars/eolinker/apinto?style=flat)](https://github.com/eolinker/apinto/stargazers) - A Golang-based gateway that offers dynamic routing, multi-tenancy, and robust API access control for modern architectures.
...
- [Apache APISIX (⭐16k)](https://github.com/apache/apisix) [![GitHub stars](https://img.shields.io/github/stars/apache/apisix?style=flat)](https://github.com/apache/apisix/stargazers) - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
- [Apache ShenYu (⭐8.8k)](https://github.com/apache/shenyu) [![GitHub stars](https://img.shields.io/github/stars/apache/shenyu?style=flat)](https://github.com/apache/shenyu/stargazers) - A Java-native gateway excelling in protocol conversion, service proxying, and comprehensive API governance.
- [Envoy Gateway (⭐2.9k)](https://github.com/envoyproxy/gateway) [![GitHub stars](https://img.shields.io/github/stars/envoyproxy/gateway?style=flat)](https://github.com/envoyproxy/gateway/stargazers) - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
- [Higress (⭐9k)](https://github.com/higress-group/higress) [![GitHub stars](https://img.shields.io/github/stars/higress-group/higress?style=flat)](https://github.com/higress-group/higress/stargazers) - A next-generation cloud-native gateway based on Envoy and Istio, offering high performance, easy-to-use, and rich plugin extensibility.
- [kgateway (⭐5.6k)](https://github.com/kgateway-dev/kgateway) [![GitHub stars](https://img.shields.io/github/stars/kgateway-dev/kgateway?style=flat)](https://github.com/kgateway-dev/kgateway/stargazers) - A CNCF Envoy-based, Kubernetes-native API gateway built around the Kubernetes Gateway API, and the successor to the Gloo open-source project.
- [Kong API Gateway (⭐43k)](https://github.com/Kong/kong) [![GitHub stars](https://img.shields.io/github/stars/Kong/kong?style=flat)](https://github.com/Kong/kong/stargazers) - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
- [KrakenD API Gateway (⭐2.6k)](https://github.com/krakend/krakend-ce) [![GitHub stars](https://img.shields.io/github/stars/krakend/krakend-ce?style=flat)](https://github.com/krakend/krakend-ce/stargazers) - An ultra-high performance gateway with efficient middleware configuration, robust security, and seamless scaling.
- [Ocelot (⭐8.7k)](https://github.com/ThreeMammals/Ocelot) [![GitHub stars](https://img.shields.io/github/stars/ThreeMammals/Ocelot?style=flat)](https://github.com/ThreeMammals/Ocelot/stargazers) - A .NET-based gateway offering intuitive routing and easy integration for lightweight API management.
- [Spring Cloud Gateway (⭐4.9k)](https://github.com/spring-cloud/spring-cloud-gateway) [![GitHub stars](https://img.shields.io/github/stars/spring-cloud/spring-cloud-gateway?style=flat)](https://github.com/spring-cloud/spring-cloud-gateway/stargazers) - Leverages the Spring ecosystem to deliver robust routing, filtering, and security for microservices.
- [Traefik API Gateway (⭐64k)](https://github.com/traefik/traefik) [![GitHub stars](https://img.shields.io/github/stars/traefik/traefik?style=flat)](https://github.com/traefik/traefik/stargazers) - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
- [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) [![GitHub stars](https://img.shields.io/github/stars/TykTechnologies/tyk?style=flat)](https://github.com/TykTechnologies/tyk/stargazers) - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
...
- API clients
   - [Bruno (⭐46k)](https://github.com/usebruno/bruno) [![GitHub stars](https://img.shields.io/github/stars/usebruno/bruno?style=flat)](https://github.com/usebruno/bruno/stargazers) - A fast, offline API client designed for git-friendly workflows and seamless testing.
   - [curl (⭐42k)](https://github.com/curl/curl) [![GitHub stars](https://img.shields.io/github/stars/curl/curl?style=flat)](https://github.com/curl/curl/stargazers) - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
   - [curlie (⭐3.7k)](https://github.com/rs/curlie) [![GitHub stars](https://img.shields.io/github/stars/rs/curlie?style=flat)](https://github.com/rs/curlie/stargazers) - A modern, user-friendly frontend to curl that combines simplicity with powerful performance.
   - [gRPC UI (⭐5.9k)](https://github.com/fullstorydev/grpcui) [![GitHub stars](https://img.shields.io/github/stars/fullstorydev/grpcui?style=flat)](https://github.com/fullstorydev/grpcui/stargazers) - An interactive web-based tool for gRPC APIs, providing a browser-based interface for testing and exploring gRPC services with dynamic form generation.
   - [grpcurl (⭐12k)](https://github.com/fullstorydev/grpcurl) [![GitHub stars](https://img.shields.io/github/stars/fullstorydev/grpcurl?style=flat)](https://github.com/fullstorydev/grpcurl/stargazers) - A command-line tool for interacting with gRPC servers, enabling inspection and invocation of RPC methods with support for server reflection and protocol buffer files.
   - [Hoppscotch (⭐80k)](https://github.com/hoppscotch/hoppscotch) [![GitHub stars](https://img.shields.io/github/stars/hoppscotch/hoppscotch?style=flat)](https://github.com/hoppscotch/hoppscotch/stargazers) - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
   - [HTTPie (⭐38k)](https://github.com/httpie/httpie) [![GitHub stars](https://img.shields.io/github/stars/httpie/httpie?style=flat)](https://github.com/httpie/httpie/stargazers) - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
   - [HttpMaster](https://www.httpmaster.net/) - Free and lightweight desktop tool for HTTP testing and debugging.
   - [Insomnia (⭐39k)](https://github.com/Kong/insomnia) [![GitHub stars](https://img.shields.io/github/stars/Kong/insomnia?style=flat)](https://github.com/Kong/insomnia/stargazers) - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
   - [posting (⭐12k)](https://github.com/darrenburns/posting) [![GitHub stars](https://img.shields.io/github/stars/darrenburns/posting?style=flat)](https://github.com/darrenburns/posting/stargazers) - A modern, terminal-based API client designed for efficient and seamless API interactions.
   ...
   - [Requestly (⭐6.7k)](https://github.com/requestly/requestly) [![GitHub stars](https://img.shields.io/github/stars/requestly/requestly?style=flat)](https://github.com/requestly/requestly/stargazers) - Lightweight Git-Friendly API Client Built for Modern Developers.
   - [resty (⭐2.6k)](https://github.com/micha/resty) [![GitHub stars](https://img.shields.io/github/stars/micha/resty?style=flat)](https://github.com/micha/resty/stargazers) - A tiny command-line REST client implemented as shell functions around curl, handy for quick API exploration from the terminal.
   - [SoapUI (⭐1.7k)](https://github.com/SmartBear/soapui) [![GitHub stars](https://img.shields.io/github/stars/SmartBear/soapui?style=flat)](https://github.com/SmartBear/soapui/stargazers) - A comprehensive open-source solution for testing both SOAP and REST web services with extensive automation features.
   - [Wombat (⭐1.4k)](https://github.com/rogchap/wombat) [![GitHub stars](https://img.shields.io/github/stars/rogchap/wombat?style=flat)](https://github.com/rogchap/wombat/stargazers) - A cross-platform desktop gRPC client with automatic proto parsing, TLS support, and intuitive UI for testing unary, streaming, and bidirectional gRPC requests.
   - [xh (⭐8k)](https://github.com/ducaale/xh) [![GitHub stars](https://img.shields.io/github/stars/ducaale/xh?style=flat)](https://github.com/ducaale/xh/stargazers) - A fast, friendly CLI HTTP client that reimplements HTTPie's design with improved performance, HTTP/2 support, and built-in curl translation.
   - [Yaade (⭐1.9k)](https://github.com/EsperoTech/yaade) [![GitHub stars](https://img.shields.io/github/stars/EsperoTech/yaade?style=flat)](https://github.com/EsperoTech/yaade/stargazers) - A self-hosted, collaborative API development environment designed for team sharing with multi-user support, persistent storage, and support for REST, WebSockets, and Markdown documentation.
   - [Yaak (⭐18k)](https://github.com/mountain-loop/yaak) [![GitHub stars](https://img.shields.io/github/stars/mountain-loop/yaak?style=flat)](https://github.com/mountain-loop/yaak/stargazers) - A fast, privacy-first desktop API client for REST, GraphQL, WebSocket, Server-Sent Events, and gRPC with offline-first design, built with Tauri and React.
- Contract testing
   ...
   - [Specmatic (⭐393)](https://github.com/specmatic/specmatic) [![GitHub stars](https://img.shields.io/github/stars/specmatic/specmatic?style=flat)](https://github.com/specmatic/specmatic/stargazers) - Turns OpenAPI, AsyncAPI, and gRPC specifications into executable contracts for contract-driven development and testing.
   - [Spring Cloud Contract (⭐732)](https://github.com/spring-cloud/spring-cloud-contract) [![GitHub stars](https://img.shields.io/github/stars/spring-cloud/spring-cloud-contract?style=flat)](https://github.com/spring-cloud/spring-cloud-contract/stargazers) - Consumer-driven contract testing for JVM applications, generating tests and stubs from Groovy or YAML contract definitions.
- MQ clients
   - [JMSToolBox (⭐235)](https://github.com/jmstoolbox/jmstoolbox) [![GitHub stars](https://img.shields.io/github/stars/jmstoolbox/jmstoolbox?style=flat)](https://github.com/jmstoolbox/jmstoolbox/stargazers) - A universal JMS client offering broad compatibility and streamlined messaging testing across various brokers.
   - [kcat (⭐5.7k)](https://github.com/edenhill/kcat) [![GitHub stars](https://img.shields.io/github/stars/edenhill/kcat?style=flat)](https://github.com/edenhill/kcat/stargazers) - A lightweight command-line tool for Apache Kafka (formerly named kafkacat), providing efficient message production and consumption.
   - [MQTT Explorer (⭐4k)](https://github.com/thomasnordquist/MQTT-Explorer) [![GitHub stars](https://img.shields.io/github/stars/thomasnordquist/MQTT-Explorer?style=flat)](https://github.com/thomasnordquist/MQTT-Explorer/stargazers) - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
   ...
   - [Service Bus Explorer (⭐2.2k)](https://github.com/paolosalvatori/ServiceBusExplorer) [![GitHub stars](https://img.shields.io/github/stars/paolosalvatori/ServiceBusExplorer?style=flat)](https://github.com/paolosalvatori/ServiceBusExplorer/stargazers) - An advanced GUI for Azure Service Bus that enables in-depth testing and seamless management of topics, queues, and subscriptions.
- Mocking tools
   - [Hoverfly (⭐2.5k)](https://github.com/SpectoLabs/hoverfly) [![GitHub stars](https://img.shields.io/github/stars/SpectoLabs/hoverfly?style=flat)](https://github.com/SpectoLabs/hoverfly/stargazers) - A lightweight API simulation tool that enables rapid HTTP(S) service virtualization for efficient testing.
   - [Imposter (⭐414)](https://github.com/outofcoffee/imposter) [![GitHub stars](https://img.shields.io/github/stars/outofcoffee/imposter?style=flat)](https://github.com/outofcoffee/imposter/stargazers) - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
   - [Microcks (⭐2k)](https://github.com/microcks/microcks) [![GitHub stars](https://img.shields.io/github/stars/microcks/microcks?style=flat)](https://github.com/microcks/microcks/stargazers) - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
   - [Mock Service Worker (MSW) (⭐18k)](https://github.com/mswjs/msw) [![GitHub stars](https://img.shields.io/github/stars/mswjs/msw?style=flat)](https://github.com/mswjs/msw/stargazers) - A seamless API mocking library for browser and Node.js that intercepts requests at the network level.
   ...
   - [Mockbin (⭐140)](https://github.com/zuplo/mockbin) [![GitHub stars](https://img.shields.io/github/stars/zuplo/mockbin?style=flat)](https://github.com/zuplo/mockbin/stargazers) - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
   - [Mockoon (⭐8.3k)](https://github.com/mockoon/mockoon) [![GitHub stars](https://img.shields.io/github/stars/mockoon/mockoon?style=flat)](https://github.com/mockoon/mockoon/stargazers) - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
   - [MockServer (⭐4.9k)](https://github.com/mock-server/mockserver) [![GitHub stars](https://img.shields.io/github/stars/mock-server/mockserver?style=flat)](https://github.com/mock-server/mockserver/stargazers) - A powerful solution for mocking any HTTP/HTTPS-based service, streamlining integration testing.
   - [Mocky (⭐2k)](https://github.com/MockyAbstract/Mocky) [![GitHub stars](https://img.shields.io/github/stars/MockyAbstract/Mocky?style=flat)](https://github.com/MockyAbstract/Mocky/stargazers) - A free online service that generates custom HTTP responses for testing API endpoints.
   - [Prism (⭐5k)](https://github.com/stoplightio/prism) [![GitHub stars](https://img.shields.io/github/stars/stoplightio/prism?style=flat)](https://github.com/stoplightio/prism/stargazers) - An open-source HTTP mock server that replicates API behavior for early testing and validation.
   - [WireMock (⭐7.3k)](https://github.com/wiremock/wiremock) [![GitHub stars](https://img.shields.io/github/stars/wiremock/wiremock?style=flat)](https://github.com/wiremock/wiremock/stargazers) - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
- Testing tools and frameworks
   - [Apache JMeter (⭐9.5k)](https://github.com/apache/jmeter) [![GitHub stars](https://img.shields.io/github/stars/apache/jmeter?style=flat)](https://github.com/apache/jmeter/stargazers) - A feature-rich tool for load testing and performance analysis across diverse web applications and services.
   - [Artillery (⭐9k)](https://github.com/artilleryio/artillery) [![GitHub stars](https://img.shields.io/github/stars/artilleryio/artillery?style=flat)](https://github.com/artilleryio/artillery/stargazers) - A complete load testing platform supporting HTTP, WebSocket, Socket.io, gRPC, and more, with cloud-native serverless scaling on AWS Lambda and Fargate.
   - [Gatling (⭐6.9k)](https://github.com/gatling/gatling) [![GitHub stars](https://img.shields.io/github/stars/gatling/gatling?style=flat)](https://github.com/gatling/gatling/stargazers) - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
   - [Hurl (⭐19k)](https://github.com/Orange-OpenSource/hurl) [![GitHub stars](https://img.shields.io/github/stars/Orange-OpenSource/hurl?style=flat)](https://github.com/Orange-OpenSource/hurl/stargazers) - A command-line tool for running HTTP requests with plain text syntax, excellent for both API testing and CI/CD integration with support for chaining, capturing values, and comprehensive assertions.
   - [Keploy (⭐18k)](https://github.com/keploy/keploy) [![GitHub stars](https://img.shields.io/github/stars/keploy/keploy?style=flat)](https://github.com/keploy/keploy/stargazers) - A developer-centric API and integration testing tool that auto-generates tests and data-mocks from real traffic using eBPF, supporting any language without code changes.
   - [ghz (⭐3.3k)](https://github.com/bojand/ghz) [![GitHub stars](https://img.shields.io/github/stars/bojand/ghz?style=flat)](https://github.com/bojand/ghz/stargazers) - A simple gRPC benchmarking and load testing tool with support for various load schedules, concurrency control, and detailed performance metrics.
   - [Grafana k6 (⭐31k)](https://github.com/grafana/k6) [![GitHub stars](https://img.shields.io/github/stars/grafana/k6?style=flat)](https://github.com/grafana/k6/stargazers) - Open-source, JS-scriptable load-testing tool for CI/CD.
   - [Karate (⭐8.9k)](https://github.com/karatelabs/karate) [![GitHub stars](https://img.shields.io/github/stars/karatelabs/karate?style=flat)](https://github.com/karatelabs/karate/stargazers) - A unified testing framework that merges API automation, mocking, and performance testing with simple, expressive syntax.
   - [Pyresttest (⭐1.1k)](https://github.com/svanoort/pyresttest) [![GitHub stars](https://img.shields.io/github/stars/svanoort/pyresttest?style=flat)](https://github.com/svanoort/pyresttest/stargazers) - A Python-based testing tool offering easy YAML/JSON-driven REST API testing and microbenchmarking.
   - [REST Assured (⭐7.1k)](https://github.com/rest-assured/rest-assured) [![GitHub stars](https://img.shields.io/github/stars/rest-assured/rest-assured?style=flat)](https://github.com/rest-assured/rest-assured/stargazers) - A Java DSL that simplifies REST API testing with intuitive syntax and seamless integration into CI pipelines.
   - [RESTler (⭐2.9k)](https://github.com/microsoft/restler-fuzzer) [![GitHub stars](https://img.shields.io/github/stars/microsoft/restler-fuzzer?style=flat)](https://github.com/microsoft/restler-fuzzer/stargazers) - A stateful REST API fuzzing tool that automatically discovers security and reliability bugs by intelligently inferring producer-consumer dependencies from OpenAPI specifications.
   - [Schemathesis (⭐3.5k)](https://github.com/schemathesis/schemathesis) [![GitHub stars](https://img.shields.io/github/stars/schemathesis/schemathesis?style=flat)](https://github.com/schemathesis/schemathesis/stargazers) - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
   - [Taurus (⭐2.1k)](https://github.com/Blazemeter/taurus) [![GitHub stars](https://img.shields.io/github/stars/Blazemeter/taurus?style=flat)](https://github.com/Blazemeter/taurus/stargazers) - An open-source automation framework that simplifies continuous testing with intuitive configuration and integration support.
...
- [OpenAS2 (⭐235)](https://github.com/OpenAS2/OpenAs2App) [![GitHub stars](https://img.shields.io/github/stars/OpenAS2/OpenAs2App?style=flat)](https://github.com/OpenAS2/OpenAs2App/stargazers) - Java-based open-source implementation of the AS2 protocol for secure, signed, and encrypted document exchange over HTTP.
- [phase4 (⭐234)](https://github.com/phax/phase4) [![GitHub stars](https://img.shields.io/github/stars/phax/phase4?style=flat)](https://github.com/phax/phase4/stargazers) - Embeddable, lightweight Java library implementing the AS4 messaging protocol, including the Peppol and CEF/eDelivery profiles.
- [Smooks (⭐417)](https://github.com/smooks/smooks) [![GitHub stars](https://img.shields.io/github/stars/smooks/smooks?style=flat)](https://github.com/smooks/smooks/stargazers) - Extensible Java framework for processing and transforming structured data such as EDI, XML, CSV, and JSON.
...
- [Drools (⭐6.2k)](https://github.com/apache/incubator-kie-drools) [![GitHub stars](https://img.shields.io/github/stars/apache/incubator-kie-drools?style=flat)](https://github.com/apache/incubator-kie-drools/stargazers) - Open-source engine that supports advanced Decision Model and Notation (DMN) with Eclipse IDE integration for efficient rule development.
...
- [NxBRE (⭐133)](https://github.com/ddossot/NxBRE) [![GitHub stars](https://img.shields.io/github/stars/ddossot/NxBRE?style=flat)](https://github.com/ddossot/NxBRE/stargazers) - Specialized .NET open-source rule engine offering efficient rule processing tailored for Microsoft environments.
- [OpenL Tablets (⭐201)](https://github.com/openl-tablets/openl-tablets) [![GitHub stars](https://img.shields.io/github/stars/openl-tablets/openl-tablets?style=flat)](https://github.com/openl-tablets/openl-tablets/stargazers) - Flexible open-source decision management system that simplifies defining and executing business rules and decision tables.
...
- [ZEN Engine (⭐1.8k)](https://github.com/gorules/zen) [![GitHub stars](https://img.shields.io/github/stars/gorules/zen?style=flat)](https://github.com/gorules/zen/stargazers) - A cross-platform, open-source Business Rules Engine written in Rust that executes JSON Decision Models through interconnected graphs of decision tables, functions, and expressions.
...
- [Debezium (⭐13k)](https://github.com/debezium/debezium) [![GitHub stars](https://img.shields.io/github/stars/debezium/debezium?style=flat)](https://github.com/debezium/debezium/stargazers) - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
...
- [Maxwell's daemon (⭐4.2k)](https://github.com/zendesk/maxwell) [![GitHub stars](https://img.shields.io/github/stars/zendesk/maxwell?style=flat)](https://github.com/zendesk/maxwell/stargazers) - An open-source CDC tool for MySQL that reads database binlogs and streams row-level changes as JSON to systems like Kafka, Kinesis, or other destinations.
...
- [PeerDB (⭐3.2k)](https://github.com/PeerDB-io/peerdb) [![GitHub stars](https://img.shields.io/github/stars/PeerDB-io/peerdb?style=flat)](https://github.com/PeerDB-io/peerdb/stargazers) - Postgres-first CDC platform for fast, simple replication from PostgreSQL to data warehouses, queues, and storage.
...
- [Sequin (⭐2.1k)](https://github.com/sequinstream/sequin) [![GitHub stars](https://img.shields.io/github/stars/sequinstream/sequin?style=flat)](https://github.com/sequinstream/sequin/stargazers) - PostgreSQL change data capture platform that streams row-level changes to Kafka, SQS, Redis, NATS, RabbitMQ, HTTP endpoints, and search indexes with exactly-once processing.
...
- [Airbyte (⭐21k)](https://github.com/airbytehq/airbyte) [![GitHub stars](https://img.shields.io/github/stars/airbytehq/airbyte?style=flat)](https://github.com/airbytehq/airbyte/stargazers) - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
- [Apache InLong (⭐1.4k)](https://github.com/apache/inlong) [![GitHub stars](https://img.shields.io/github/stars/apache/inlong?style=flat)](https://github.com/apache/inlong/stargazers) - One-stop, full-scenario integration framework for massive data that supports data ingestion, synchronization, and subscription with real-time ETL capabilities.
- [Apache NiFi (⭐6.1k)](https://github.com/apache/nifi) [![GitHub stars](https://img.shields.io/github/stars/apache/nifi?style=flat)](https://github.com/apache/nifi/stargazers) - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
- [Apache SeaTunnel (⭐9.5k)](https://github.com/apache/seatunnel) [![GitHub stars](https://img.shields.io/github/stars/apache/seatunnel?style=flat)](https://github.com/apache/seatunnel/stargazers) - High-performance, distributed data integration platform supporting batch and streaming synchronization across hundreds of connectors.
...
- [Conduit (⭐605)](https://github.com/ConduitIO/conduit) [![GitHub stars](https://img.shields.io/github/stars/ConduitIO/conduit?style=flat)](https://github.com/ConduitIO/conduit/stargazers) - Lightweight data integration tool written in Go that streams data between systems using built-in or standalone connectors, with Kafka Connect compatibility.
- [dlt (⭐5.7k)](https://github.com/dlt-hub/dlt) [![GitHub stars](https://img.shields.io/github/stars/dlt-hub/dlt?style=flat)](https://github.com/dlt-hub/dlt/stargazers) - Open-source Python library for building data pipelines as code, with schema evolution and incremental loading out of the box.
- [Estuary Flow (⭐960)](https://github.com/estuary/flow) [![GitHub stars](https://img.shields.io/github/stars/estuary/flow?style=flat)](https://github.com/estuary/flow/stargazers) - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
...
- [Meltano (⭐2.5k)](https://github.com/meltano/meltano) [![GitHub stars](https://img.shields.io/github/stars/meltano/meltano?style=flat)](https://github.com/meltano/meltano/stargazers) - Declarative, code-first data integration engine that runs Singer taps and targets with version-controlled pipeline configuration.
...
- [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) [![GitHub stars](https://img.shields.io/github/stars/pentaho/pentaho-kettle?style=flat)](https://github.com/pentaho/pentaho-kettle/stargazers) - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
...
- [Singer (⭐1.3k)](https://github.com/singer-io/getting-started) [![GitHub stars](https://img.shields.io/github/stars/singer-io/getting-started?style=flat)](https://github.com/singer-io/getting-started/stargazers) - Open-source standard for writing scripts that move data, defining a JSON-based protocol between extraction "taps" and loading "targets".
- [Sling (⭐885)](https://github.com/slingdata-io/sling-cli) [![GitHub stars](https://img.shields.io/github/stars/slingdata-io/sling-cli?style=flat)](https://github.com/slingdata-io/sling-cli/stargazers) - Fast ELT command-line tool and Go library for moving data between databases, files, and cloud storage across a wide set of connectors.
...
- [AtlasMap (⭐213)](https://github.com/atlasmap/atlasmap) [![GitHub stars](https://img.shields.io/github/stars/atlasmap/atlasmap?style=flat)](https://github.com/atlasmap/atlasmap/stargazers) - Interactive web-based tool that simplifies mapping across Java, XML, CSV, and JSON data sources with an intuitive interface.
- [DataSonnet (⭐37)](https://github.com/datasonnet/datasonnet-mapper) [![GitHub stars](https://img.shields.io/github/stars/datasonnet/datasonnet-mapper?style=flat)](https://github.com/datasonnet/datasonnet-mapper/stargazers) - A template-based data transformation library built on Jsonnet, tailored for system integration.
- [JOLT (⭐1.6k)](https://github.com/bazaarvoice/jolt) [![GitHub stars](https://img.shields.io/github/stars/bazaarvoice/jolt?style=flat)](https://github.com/bazaarvoice/jolt/stargazers) - Java-based JSON transformation library that uses a specification-driven approach for effortless JSON-to-JSON conversions.
- [JSLT (⭐698)](https://github.com/schibsted/jslt) [![GitHub stars](https://img.shields.io/github/stars/schibsted/jslt?style=flat)](https://github.com/schibsted/jslt/stargazers) - Powerful JSON query and transformation language inspired by jq and XPath, designed for rapid and flexible data manipulation.
- [JSONata (⭐2.6k)](https://github.com/jsonata-js/jsonata) [![GitHub stars](https://img.shields.io/github/stars/jsonata-js/jsonata?style=flat)](https://github.com/jsonata-js/jsonata/stargazers) - Lightweight query and transformation language for JSON data.
- [Kaoto (⭐112)](https://github.com/KaotoIO/kaoto) [![GitHub stars](https://img.shields.io/github/stars/KaotoIO/kaoto?style=flat)](https://github.com/KaotoIO/kaoto/stargazers) - Visual data mapper for Apache Camel with a drag-and-drop interface supporting XML, JSON, CSV, and XSLT transformations. Successor to AtlasMap.
...
- [NServiceBus (⭐2.1k)](https://github.com/Particular/NServiceBus) [![GitHub stars](https://img.shields.io/github/stars/Particular/NServiceBus?style=flat)](https://github.com/Particular/NServiceBus/stargazers) - Developer-friendly, .NET-based service bus that simplifies messaging and orchestrates service integration efficiently.
...
- [WSO2 Integrator: MI (⭐258)](https://github.com/wso2/product-integrator-mi) [![GitHub stars](https://img.shields.io/github/stars/wso2/product-integrator-mi?style=flat)](https://github.com/wso2/product-integrator-mi/stargazers) - The configuration-driven integration runtime of the WSO2 Integrator platform, supporting enterprise integration patterns in centralised and containerised deployments.
...
- [Apache Camel (⭐6.2k)](https://github.com/apache/camel) [![GitHub stars](https://img.shields.io/github/stars/apache/camel?style=flat)](https://github.com/apache/camel/stargazers) - Integration framework with 300+ connectors for databases, messaging, APIs, cloud services, and enterprise systems. Supports both Spring Boot and Quarkus runtimes, and includes AI agent interoperability via the A2A and MCP protocols.
- [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) [![GitHub stars](https://img.shields.io/github/stars/ballerina-platform/ballerina-lang?style=flat)](https://github.com/ballerina-platform/ballerina-lang/stargazers) - Innovative programming language designed for effortless creation and integration of network services and APIs.
- [Frank!Framework (⭐165)](https://github.com/frankframework/frankframework) [![GitHub stars](https://img.shields.io/github/stars/frankframework/frankframework?style=flat)](https://github.com/frankframework/frankframework/stargazers) - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
- [MassTransit (⭐7.7k)](https://github.com/MassTransit/MassTransit) [![GitHub stars](https://img.shields.io/github/stars/MassTransit/MassTransit?style=flat)](https://github.com/MassTransit/MassTransit/stargazers) - Distributed application framework for .NET that provides a consistent messaging abstraction on top of transports such as RabbitMQ, Azure Service Bus, and Amazon SQS.
- [Spring Cloud Stream (⭐1k)](https://github.com/spring-cloud/spring-cloud-stream) [![GitHub stars](https://img.shields.io/github/stars/spring-cloud/spring-cloud-stream?style=flat)](https://github.com/spring-cloud/spring-cloud-stream/stargazers) - Framework for building event-driven microservices connected to shared messaging systems through binder abstractions for Kafka, RabbitMQ, and more.
- [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) [![GitHub stars](https://img.shields.io/github/stars/spring-projects/spring-integration?style=flat)](https://github.com/spring-projects/spring-integration/stargazers) - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
- [Wolverine (⭐2.3k)](https://github.com/JasperFx/wolverine) [![GitHub stars](https://img.shields.io/github/stars/JasperFx/wolverine?style=flat)](https://github.com/JasperFx/wolverine/stargazers) - Low-ceremony messaging and command-bus framework for .NET with built-in durable messaging and transports like RabbitMQ and Kafka.
...
- [Camel K (⭐926)](https://github.com/apache/camel-k) [![GitHub stars](https://img.shields.io/github/stars/apache/camel-k?style=flat)](https://github.com/apache/camel-k/stargazers) - Lightweight Kubernetes-native integration platform built on Apache Camel that runs integration routes directly on Kubernetes and OpenShift as cloud-native serverless services.
...
- [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) [![GitHub stars](https://img.shields.io/github/stars/apache/activemq?style=flat)](https://github.com/apache/activemq/stargazers) - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
- [Apache ActiveMQ Artemis (⭐1k)](https://github.com/apache/activemq-artemis) [![GitHub stars](https://img.shields.io/github/stars/apache/activemq-artemis?style=flat)](https://github.com/apache/activemq-artemis/stargazers) - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
- [Apache EventMesh (⭐1.7k)](https://github.com/apache/eventmesh) [![GitHub stars](https://img.shields.io/github/stars/apache/eventmesh?style=flat)](https://github.com/apache/eventmesh/stargazers) - A dynamic event-driven application runtime that acts as a serverless event middleware for decoupling applications and backend brokers.
- [Apache Iggy (⭐4.4k)](https://github.com/apache/iggy) [![GitHub stars](https://img.shields.io/github/stars/apache/iggy?style=flat)](https://github.com/apache/iggy/stargazers) - Persistent message streaming platform written in Rust, supporting QUIC, TCP, and HTTP transports with high throughput and low latency.
- [Apache Kafka (⭐33k)](https://github.com/apache/kafka) [![GitHub stars](https://img.shields.io/github/stars/apache/kafka?style=flat)](https://github.com/apache/kafka/stargazers) - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
- [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) [![GitHub stars](https://img.shields.io/github/stars/apache/pulsar?style=flat)](https://github.com/apache/pulsar/stargazers) - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
- [Apache Qpid (⭐70)](https://github.com/apache/qpid-broker-j) [![GitHub stars](https://img.shields.io/github/stars/apache/qpid-broker-j?style=flat)](https://github.com/apache/qpid-broker-j/stargazers) - AMQP-compliant messaging tool with multi-language support for enterprise-grade message delivery.
- [Apache RocketMQ (⭐22k)](https://github.com/apache/rocketmq) [![GitHub stars](https://img.shields.io/github/stars/apache/rocketmq?style=flat)](https://github.com/apache/rocketmq/stargazers) - High-performance distributed messaging platform engineered for low latency and high throughput.
- [AutoMQ (⭐10k)](https://github.com/AutoMQ/automq) [![GitHub stars](https://img.shields.io/github/stars/AutoMQ/automq?style=flat)](https://github.com/AutoMQ/automq/stargazers) - Stateless, Kafka-compatible broker that runs on S3-class object storage for elastic scaling and reduced cost.
- [BlazingMQ (⭐3.2k)](https://github.com/bloomberg/blazingmq) [![GitHub stars](https://img.shields.io/github/stars/bloomberg/blazingmq?style=flat)](https://github.com/bloomberg/blazingmq/stargazers) - Distributed message queuing system focused on efficiency and reliability for modern workflow needs.
- [Centrifugo (⭐10k)](https://github.com/centrifugal/centrifugo) [![GitHub stars](https://img.shields.io/github/stars/centrifugal/centrifugo?style=flat)](https://github.com/centrifugal/centrifugo/stargazers) - Scalable real-time messaging server that minimizes delay in delivering events to online users.
- [Eclipse Mosquitto (⭐11k)](https://github.com/eclipse-mosquitto/mosquitto) [![GitHub stars](https://img.shields.io/github/stars/eclipse-mosquitto/mosquitto?style=flat)](https://github.com/eclipse-mosquitto/mosquitto/stargazers) - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
- [ElasticMQ (⭐2.9k)](https://github.com/softwaremill/elasticmq) [![GitHub stars](https://img.shields.io/github/stars/softwaremill/elasticmq?style=flat)](https://github.com/softwaremill/elasticmq/stargazers) - In-memory message queue with an Amazon SQS-compatible interface, offering stand-alone or embedded deployment with optional UI and queue persistence.
- [EMQX (⭐16k)](https://github.com/emqx/emqx) [![GitHub stars](https://img.shields.io/github/stars/emqx/emqx?style=flat)](https://github.com/emqx/emqx/stargazers) - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
- [HiveMQ (⭐1.2k)](https://github.com/hivemq/hivemq-community-edition) [![GitHub stars](https://img.shields.io/github/stars/hivemq/hivemq-community-edition?style=flat)](https://github.com/hivemq/hivemq-community-edition/stargazers) - MQTT broker built for reliable IoT messaging at scale, with an open-source community edition and a rich extension system.
...
- [LavinMQ (⭐987)](https://github.com/cloudamqp/lavinmq) [![GitHub stars](https://img.shields.io/github/stars/cloudamqp/lavinmq?style=flat)](https://github.com/cloudamqp/lavinmq/stargazers) - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
- [Magistrala (⭐2.6k)](https://github.com/absmach/magistrala) [![GitHub stars](https://img.shields.io/github/stars/absmach/magistrala?style=flat)](https://github.com/absmach/magistrala/stargazers) - Distributed, event-driven infrastructure for messaging supporting multiple protocols (HTTP, MQTT, WebSocket, CoAP) with strong security and IoT capabilities.
- [NATS (⭐20k)](https://github.com/nats-io/nats-server) [![GitHub stars](https://img.shields.io/github/stars/nats-io/nats-server?style=flat)](https://github.com/nats-io/nats-server/stargazers) - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
- [NSQ (⭐25k)](https://github.com/nsqio/nsq) [![GitHub stars](https://img.shields.io/github/stars/nsqio/nsq?style=flat)](https://github.com/nsqio/nsq/stargazers) - Realtime distributed messaging platform designed to operate at scale, handling billions of messages per day with decentralized topology.
...
- [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) [![GitHub stars](https://img.shields.io/github/stars/rabbitmq/rabbitmq-server?style=flat)](https://github.com/rabbitmq/rabbitmq-server/stargazers) - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
...
- [Redpanda (⭐12k)](https://github.com/redpanda-data/redpanda) [![GitHub stars](https://img.shields.io/github/stars/redpanda-data/redpanda?style=flat)](https://github.com/redpanda-data/redpanda/stargazers) - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
- [RMQ (⭐1.6k)](https://github.com/wellle/rmq) [![GitHub stars](https://img.shields.io/github/stars/wellle/rmq?style=flat)](https://github.com/wellle/rmq/stargazers) - Redis-backed message queue written in Go, providing flexible queue management, batch consumers, and efficient delivery patterns.
...
- [VerneMQ (⭐3.6k)](https://github.com/vernemq/vernemq) [![GitHub stars](https://img.shields.io/github/stars/vernemq/vernemq?style=flat)](https://github.com/vernemq/vernemq/stargazers) - High-performance distributed MQTT broker designed for scalable and efficient message delivery in modern environments.
- [ZeroMQ (⭐10k)](https://github.com/zeromq/libzmq) [![GitHub stars](https://img.shields.io/github/stars/zeromq/libzmq?style=flat)](https://github.com/zeromq/libzmq/stargazers) - High-performance asynchronous messaging library providing broker-less, socket-based messaging patterns for distributed applications.
...
- [OpenRPA (⭐3k)](https://github.com/open-rpa/openrpa) [![GitHub stars](https://img.shields.io/github/stars/open-rpa/openrpa?style=flat)](https://github.com/open-rpa/openrpa/stargazers) - Enterprise-grade, open-source robotic process automation suite. 
- [Robot Framework (⭐11k)](https://github.com/robotframework/robotframework) [![GitHub stars](https://img.shields.io/github/stars/robotframework/robotframework?style=flat)](https://github.com/robotframework/robotframework/stargazers) - An open-source automation framework with human-friendly keyword syntax that enables both technical and non-technical users to create test scripts and automate business processes cost-effectively, supporting web, API, mobile, and database automation through extensive libraries and integrations.
- [TagUI (⭐6.3k)](https://github.com/aisingapore/TagUI) [![GitHub stars](https://img.shields.io/github/stars/aisingapore/TagUI?style=flat)](https://github.com/aisingapore/TagUI/stargazers) - An open-source RPA tool that democratizes automation through natural language scripting in 20+ human languages, enabling non-programmers to automate web, desktop, and data tasks while integrating AI/ML capabilities via Python and R for intelligent process automation.
...
- [Apicurio Registry (⭐902)](https://github.com/Apicurio/apicurio-registry) [![GitHub stars](https://img.shields.io/github/stars/Apicurio/apicurio-registry?style=flat)](https://github.com/Apicurio/apicurio-registry/stargazers) - Open-source registry for API designs and schemas, supporting Avro, Protobuf, JSON Schema, OpenAPI, and AsyncAPI artifacts with configurable compatibility rules.
...
- [Confluent Schema Registry (⭐2.4k)](https://github.com/confluentinc/schema-registry) [![GitHub stars](https://img.shields.io/github/stars/confluentinc/schema-registry?style=flat)](https://github.com/confluentinc/schema-registry/stargazers) - Widely used registry for Kafka, providing a RESTful interface and compatibility checks for Avro, JSON Schema, and Protobuf schemas.
- [Karapace (⭐625)](https://github.com/Aiven-Open/karapace) [![GitHub stars](https://img.shields.io/github/stars/Aiven-Open/karapace?style=flat)](https://github.com/Aiven-Open/karapace/stargazers) - Open-source, drop-in replacement for Confluent Schema Registry and the Kafka REST API.
...
- [Activepieces (⭐23k)](https://github.com/activepieces/activepieces) [![GitHub stars](https://img.shields.io/github/stars/activepieces/activepieces?style=flat)](https://github.com/activepieces/activepieces/stargazers) - Open-source, self-hostable automation platform with a no-code visual builder and hundreds of connectors ("pieces"), positioned as a Zapier alternative.
- [Automatisch (⭐13k)](https://github.com/automatisch/automatisch) [![GitHub stars](https://img.shields.io/github/stars/automatisch/automatisch?style=flat)](https://github.com/automatisch/automatisch/stargazers) - Open-source business automation tool that connects popular services without sharing your data with third parties.
- [Huginn (⭐49k)](https://github.com/huginn/huginn) [![GitHub stars](https://img.shields.io/github/stars/huginn/huginn?style=flat)](https://github.com/huginn/huginn/stargazers) - Self-hosted system for building agents that monitor services and act on your behalf, like a hackable version of IFTTT.
...
- [n8n (⭐200k)](https://github.com/n8n-io/n8n) [![GitHub stars](https://img.shields.io/github/stars/n8n-io/n8n?style=flat)](https://github.com/n8n-io/n8n/stargazers) - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
- [Node-RED (⭐23k)](https://github.com/node-red/node-red) [![GitHub stars](https://img.shields.io/github/stars/node-red/node-red?style=flat)](https://github.com/node-red/node-red/stargazers) - Low-code, flow-based programming tool for wiring together hardware devices, APIs, and online services through a browser-based visual editor.
- [Pipedream (⭐11k)](https://github.com/PipedreamHQ/pipedream) [![GitHub stars](https://img.shields.io/github/stars/PipedreamHQ/pipedream?style=flat)](https://github.com/PipedreamHQ/pipedream/stargazers) - Developer-centric integration platform that combines thousands of prebuilt triggers and actions with code-level control in Node.js, Python, Go, and Bash.
...
- [Apache Beam (⭐8.6k)](https://github.com/apache/beam) [![GitHub stars](https://img.shields.io/github/stars/apache/beam?style=flat)](https://github.com/apache/beam/stargazers) - Unified programming model for batch and streaming pipelines, portable across runners such as Flink, Spark, and Google Cloud Dataflow.
- [Apache Flink (⭐26k)](https://github.com/apache/flink) [![GitHub stars](https://img.shields.io/github/stars/apache/flink?style=flat)](https://github.com/apache/flink/stargazers) - Distributed stream processing framework with stateful computations, exactly-once semantics, and event-time processing at scale.
- [Apache Spark (⭐43k)](https://github.com/apache/spark) [![GitHub stars](https://img.shields.io/github/stars/apache/spark?style=flat)](https://github.com/apache/spark/stargazers) - Unified analytics engine whose Structured Streaming API provides scalable, fault-tolerant stream processing on the Spark SQL engine.
- [Arroyo (⭐4.9k)](https://github.com/ArroyoSystems/arroyo) [![GitHub stars](https://img.shields.io/github/stars/ArroyoSystems/arroyo?style=flat)](https://github.com/ArroyoSystems/arroyo/stargazers) - Rust-native stream processing engine that lets users build real-time pipelines with SQL, designed for serverless operation.
- [Bytewax (⭐2k)](https://github.com/bytewax/bytewax) [![GitHub stars](https://img.shields.io/github/stars/bytewax/bytewax?style=flat)](https://github.com/bytewax/bytewax/stargazers) - Python stream processing framework built on Timely Dataflow, combining Python's ecosystem with Rust performance.
...
- [ksqlDB (⭐314)](https://github.com/confluentinc/ksql) [![GitHub stars](https://img.shields.io/github/stars/confluentinc/ksql?style=flat)](https://github.com/confluentinc/ksql/stargazers) - Database purpose-built for stream processing applications on Kafka, queried with SQL.
- [Numaflow (⭐2.8k)](https://github.com/numaproj/numaflow) [![GitHub stars](https://img.shields.io/github/stars/numaproj/numaflow?style=flat)](https://github.com/numaproj/numaflow/stargazers) - Kubernetes-native, serverless platform for massively parallel stream and data processing, with exactly-once semantics and language-agnostic user code.
- [Redpanda Connect (⭐8.7k)](https://github.com/redpanda-data/connect) [![GitHub stars](https://img.shields.io/github/stars/redpanda-data/connect?style=flat)](https://github.com/redpanda-data/connect/stargazers) - Declarative stream processor and connector toolkit (formerly Benthos) for transforming and routing data between systems.
- [RisingWave (⭐9.2k)](https://github.com/risingwavelabs/risingwave) [![GitHub stars](https://img.shields.io/github/stars/risingwavelabs/risingwave?style=flat)](https://github.com/risingwavelabs/risingwave/stargazers) - Postgres-compatible streaming database for incremental, real-time materialized views over event streams.
...
- [Convoy (⭐2.8k)](https://github.com/frain-dev/convoy) [![GitHub stars](https://img.shields.io/github/stars/frain-dev/convoy?style=flat)](https://github.com/frain-dev/convoy/stargazers) - Open-source webhooks gateway for sending and receiving webhooks with retries, rate limiting, and a management dashboard.
...
- [Svix (⭐3.3k)](https://github.com/svix/svix-webhooks) [![GitHub stars](https://img.shields.io/github/stars/svix/svix-webhooks?style=flat)](https://github.com/svix/svix-webhooks/stargazers) - Webhook sending service with an open-source server, handling signing, retries, and endpoint management for webhook providers.
...
- [Activiti (⭐10k)](https://github.com/Activiti/Activiti) [![GitHub stars](https://img.shields.io/github/stars/Activiti/Activiti?style=flat)](https://github.com/Activiti/Activiti/stargazers) - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
- [Apache Airflow (⭐46k)](https://github.com/apache/airflow) [![GitHub stars](https://img.shields.io/github/stars/apache/airflow?style=flat)](https://github.com/apache/airflow/stargazers) - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
- [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) [![GitHub stars](https://img.shields.io/github/stars/argoproj/argo-workflows?style=flat)](https://github.com/argoproj/argo-workflows/stargazers) - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
...
- [Azkaban (⭐4.5k)](https://github.com/azkaban/azkaban) [![GitHub stars](https://img.shields.io/github/stars/azkaban/azkaban?style=flat)](https://github.com/azkaban/azkaban/stargazers) - Distributed scheduler that simplifies managing job dependencies in large-scale data processing environments.
- [Bonita (⭐174)](https://github.com/bonitasoft/bonita-engine) [![GitHub stars](https://img.shields.io/github/stars/bonitasoft/bonita-engine?style=flat)](https://github.com/bonitasoft/bonita-engine/stargazers) - Open-source BPMN engine with a designer interface to build and automate complex business processes.
- [Cadence (⭐9.4k)](https://github.com/uber/cadence) [![GitHub stars](https://img.shields.io/github/stars/uber/cadence?style=flat)](https://github.com/uber/cadence/stargazers) - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
- [Camunda (⭐4.2k)](https://github.com/camunda/camunda) [![GitHub stars](https://img.shields.io/github/stars/camunda/camunda?style=flat)](https://github.com/camunda/camunda/stargazers) - Process orchestration platform built on the horizontally scalable Zeebe engine, with full BPMN and DMN support.
- [Conductor (⭐32k)](https://github.com/conductor-oss/conductor) [![GitHub stars](https://img.shields.io/github/stars/conductor-oss/conductor?style=flat)](https://github.com/conductor-oss/conductor/stargazers) - Durable workflow orchestration engine originally built at Netflix, now maintained by the community after the original repository was archived.
- [Dagster (⭐15k)](https://github.com/dagster-io/dagster) [![GitHub stars](https://img.shields.io/github/stars/dagster-io/dagster?style=flat)](https://github.com/dagster-io/dagster/stargazers) - Data orchestrator with a declarative, asset-based programming model for building and observing data pipelines.
- [Elsa Core (⭐7.8k)](https://github.com/elsa-workflows/elsa-core) [![GitHub stars](https://img.shields.io/github/stars/elsa-workflows/elsa-core?style=flat)](https://github.com/elsa-workflows/elsa-core/stargazers) - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
- [Flowable (⭐9.4k)](https://github.com/flowable/flowable-engine) [![GitHub stars](https://img.shields.io/github/stars/flowable/flowable-engine?style=flat)](https://github.com/flowable/flowable-engine/stargazers) - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
...
- [Inngest (⭐5.7k)](https://github.com/inngest/inngest) [![GitHub stars](https://img.shields.io/github/stars/inngest/inngest?style=flat)](https://github.com/inngest/inngest/stargazers) - Event-driven durable execution platform that runs reliable step functions inside your existing services.
- [jBPM (⭐1.7k)](https://github.com/kiegroup/jbpm) [![GitHub stars](https://img.shields.io/github/stars/kiegroup/jbpm?style=flat)](https://github.com/kiegroup/jbpm/stargazers) - Comprehensive toolkit for automating business processes and decisions with robust workflow management capabilities.
- [Kestra (⭐27k)](https://github.com/kestra-io/kestra) [![GitHub stars](https://img.shields.io/github/stars/kestra-io/kestra?style=flat)](https://github.com/kestra-io/kestra/stargazers) - Event-driven declarative orchestrator with workflows defined in YAML and hundreds of plugins for data and infrastructure automation.
- [LittleHorse (⭐392)](https://github.com/littlehorse-enterprises/littlehorse) [![GitHub stars](https://img.shields.io/github/stars/littlehorse-enterprises/littlehorse?style=flat)](https://github.com/littlehorse-enterprises/littlehorse/stargazers) - High-throughput, low-latency microservice orchestration engine built on Kafka Streams, with SDKs in multiple languages.
- [Prefect (⭐23k)](https://github.com/PrefectHQ/prefect) [![GitHub stars](https://img.shields.io/github/stars/PrefectHQ/prefect?style=flat)](https://github.com/PrefectHQ/prefect/stargazers) - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
- [Restate (⭐4.2k)](https://github.com/restatedev/restate) [![GitHub stars](https://img.shields.io/github/stars/restatedev/restate?style=flat)](https://github.com/restatedev/restate/stargazers) - Durable execution engine for building resilient workflows, event-driven services, and stateful handlers as plain code.
- [StackStorm (⭐6.5k)](https://github.com/StackStorm/st2) [![GitHub stars](https://img.shields.io/github/stars/StackStorm/st2?style=flat)](https://github.com/StackStorm/st2/stargazers) - Robust automation engine that combines sensors, triggers, and workflows to orchestrate complex IT processes.
- [Temporal (⭐22k)](https://github.com/temporalio/temporal) [![GitHub stars](https://img.shields.io/github/stars/temporalio/temporal?style=flat)](https://github.com/temporalio/temporal/stargazers) - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
- [Windmill (⭐17k)](https://github.com/windmill-labs/windmill) [![GitHub stars](https://img.shields.io/github/stars/windmill-labs/windmill?style=flat)](https://github.com/windmill-labs/windmill/stargazers) - Open-source developer platform that turns scripts in Python, TypeScript, Go, and more into workflows, internal UIs, and scheduled jobs.
...
- [API-led Connectivity pattern](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/API-led-Connectivity-Pattern.md) [![GitHub stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/API-led-Connectivity-Pattern.md?style=flat)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/API-led-Connectivity-Pattern.md/stargazers) - Use APIs to connect different systems and applications.
- [Anti Corruption Layer Pattern](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Anti-Corruption-Layer-Pattern.md) [![GitHub stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Anti-Corruption-Layer-Pattern.md?style=flat)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Anti-Corruption-Layer-Pattern.md/stargazers) - Add a layer to isolate and transform data between systems.
- [Change Data Capture Pattern](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Introduction-to-Change-Data-Capture.md) [![GitHub stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Introduction-to-Change-Data-Capture.md?style=flat)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Introduction-to-Change-Data-Capture.md/stargazers) - Capture and propagate changes made to a database or data source in real-time.
- [Hybrid API Management pattern](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-API-Management-Pattern.md) [![GitHub stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-API-Management-Pattern.md?style=flat)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-API-Management-Pattern.md/stargazers) - Manage APIs that span both cloud and on-premises environments using a central control plane.
- [Hybrid Integration pattern](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-Integration-Pattern.md) [![GitHub stars](https://img.shields.io/github/stars/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-Integration-Pattern.md?style=flat)](https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-Integration-Pattern.md/stargazers) - Integrate systems and applications that are deployed both on-premises and in the cloud using a combination of integration technologies.
...
### API Specification
- [API Blueprint (⭐8.6k)](https://github.com/apiaryio/api-blueprint) [![GitHub stars](https://img.shields.io/github/stars/apiaryio/api-blueprint?style=flat)](https://github.com/apiaryio/api-blueprint/stargazers) - A powerful high-level language for designing and documenting APIs that allows software engineers to easily collaborate and create efficient APIs.
- [Arazzo Specification (⭐459)](https://github.com/OAI/Arazzo-Specification) [![GitHub stars](https://img.shields.io/github/stars/OAI/Arazzo-Specification?style=flat)](https://github.com/OAI/Arazzo-Specification/stargazers) - A standard, programming language-agnostic representation for describing sequences of API calls (workflows) and their dependencies.
- [AsyncAPI (⭐5.2k)](https://github.com/asyncapi/spec) [![GitHub stars](https://img.shields.io/github/stars/asyncapi/spec?style=flat)](https://github.com/asyncapi/spec/stargazers) - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
- [CloudEvents (⭐5.8k)](https://github.com/cloudevents/spec) [![GitHub stars](https://img.shields.io/github/stars/cloudevents/spec?style=flat)](https://github.com/cloudevents/spec/stargazers) -  A specification for describing event data in common formats to provide interoperability across services, platforms and systems.
- [GraphQL (⭐14k)](https://github.com/graphql/graphql-spec) [![GitHub stars](https://img.shields.io/github/stars/graphql/graphql-spec?style=flat)](https://github.com/graphql/graphql-spec/stargazers) - A sophisticated query language and runtime for building efficient APIs that empowers engineers to retrieve data from existing systems with ease.
- [JSON:API (⭐7.7k)](https://github.com/json-api/json-api) [![GitHub stars](https://img.shields.io/github/stars/json-api/json-api?style=flat)](https://github.com/json-api/json-api/stargazers) - A standardized specification for building APIs that simplifies the representation of resources, relationships, and metadata, making it easier for software engineers to create efficient APIs.
- [OpenAPI (ex.Swagger) (⭐31k)](https://github.com/OAI/OpenAPI-Specification) [![GitHub stars](https://img.shields.io/github/stars/OAI/OpenAPI-Specification?style=flat)](https://github.com/OAI/OpenAPI-Specification/stargazers) - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
- [RAML (⭐3.8k)](https://github.com/raml-org/raml-spec) [![GitHub stars](https://img.shields.io/github/stars/raml-org/raml-spec?style=flat)](https://github.com/raml-org/raml-spec/stargazers) - A RESTful API Modeling Language that allows software engineers to design and create efficient APIs by modeling resources, endpoints, and interactions.
- [Standard Webhooks (⭐1.7k)](https://github.com/standard-webhooks/standard-webhooks) [![GitHub stars](https://img.shields.io/github/stars/standard-webhooks/standard-webhooks?style=flat)](https://github.com/standard-webhooks/standard-webhooks/stargazers) - Open source tools and guidelines for sending webhooks easily, securely, and reliably.
- [TypeSpec (⭐5.8k)](https://github.com/microsoft/typespec) [![GitHub stars](https://img.shields.io/github/stars/microsoft/typespec?style=flat)](https://github.com/microsoft/typespec/stargazers) - A highly extensible language for describing API data shapes and protocols, capable of compiling to OpenAPI, JSON Schema, Protobuf, and other formats.
...
- [Microsoft REST API Guidelines (⭐23k)](https://github.com/microsoft/api-guidelines) [![GitHub stars](https://img.shields.io/github/stars/microsoft/api-guidelines?style=flat)](https://github.com/microsoft/api-guidelines/stargazers) - Microsoft's company-wide guidelines for designing consistent REST APIs, including a Microsoft Graph-specific addendum.
...
<!--lint enable-->
### Articles
- [API-Security-Checklist (⭐23k)](https://github.com/shieldfy/API-Security-Checklist) [![GitHub stars](https://img.shields.io/github/stars/shieldfy/API-Security-Checklist?style=flat)](https://github.com/shieldfy/API-Security-Checklist/stargazers) - Best practices about REST API security.
...
<!--lint enable-->
### Data Formats
- [Apache Arrow (⭐17k)](https://github.com/apache/arrow) [![GitHub stars](https://img.shields.io/github/stars/apache/arrow?style=flat)](https://github.com/apache/arrow/stargazers) - Language-agnostic columnar in-memory format for fast data interchange, including the Arrow IPC format and Flight RPC for moving data between systems.
- [Apache Avro (⭐3.2k)](https://github.com/apache/avro) [![GitHub stars](https://img.shields.io/github/stars/apache/avro?style=flat)](https://github.com/apache/avro/stargazers) - Data serialization system that provides compact, fast, and efficient serialization of structured data. It supports schema evolution, allows for efficient data compression, and is designed to work well with big data processing frameworks.
- [Apache Fory (⭐4.4k)](https://github.com/apache/fory) [![GitHub stars](https://img.shields.io/github/stars/apache/fory?style=flat)](https://github.com/apache/fory/stargazers) - Fast multi-language serialization framework that uses just-in-time compilation and zero-copy techniques, with a cache-friendly row format. Formerly named Apache Fury.
- [Apache Thrift (⭐10k)](https://github.com/apache/thrift) [![GitHub stars](https://img.shields.io/github/stars/apache/thrift?style=flat)](https://github.com/apache/thrift/stargazers) - A serialization and RPC framework originally developed at Facebook that generates cross-language bindings from a single interface definition file.
...
- [Cap'n Proto (⭐13k)](https://github.com/capnproto/capnproto) [![GitHub stars](https://img.shields.io/github/stars/capnproto/capnproto?style=flat)](https://github.com/capnproto/capnproto/stargazers) - An extremely fast data interchange format and RPC system whose zero-copy encoding doubles as both wire format and in-memory representation.
...
- [FlatBuffers (⭐26k)](https://github.com/google/flatbuffers) [![GitHub stars](https://img.shields.io/github/stars/google/flatbuffers?style=flat)](https://github.com/google/flatbuffers/stargazers) - An efficient cross-platform serialization library from Google that allows direct access to serialized data without parsing or unpacking.
- [JSON](https://datatracker.ietf.org/doc/html/rfc8259) - A lightweight and easy-to-read data format that is widely used for data exchange. It supports a wide range of data types and is compatible with many programming languages.
   - [NDJSON (⭐843)](https://github.com/ndjson/ndjson-spec) [![GitHub stars](https://img.shields.io/github/stars/ndjson/ndjson-spec?style=flat)](https://github.com/ndjson/ndjson-spec/stargazers) - A standard for delimiting JSON objects in stream protocols. It allows for efficient processing of large JSON datasets and is widely used in big data processing.
...
- [MessagePack (⭐7.4k)](https://github.com/msgpack/msgpack) [![GitHub stars](https://img.shields.io/github/stars/msgpack/msgpack?style=flat)](https://github.com/msgpack/msgpack/stargazers) - An efficient binary serialization format that lets you exchange data among multiple languages like JSON, but smaller and faster.
- [Protocol Buffers (⭐71k)](https://github.com/protocolbuffers/protobuf) [![GitHub stars](https://img.shields.io/github/stars/protocolbuffers/protobuf?style=flat)](https://github.com/protocolbuffers/protobuf/stargazers) - A language-neutral and platform-neutral serialization mechanism that is designed to be highly efficient and extensible. It supports rich data types and is widely used in distributed systems, such as gRPC and Apache Kafka.
...
- [YAML (⭐497)](https://github.com/yaml/yaml-spec) [![GitHub stars](https://img.shields.io/github/stars/yaml/yaml-spec?style=flat)](https://github.com/yaml/yaml-spec/stargazers) - A human-friendly and easy-to-read data serialization format that is widely used for configuration files and data exchange. It supports rich data types and is compatible with most programming languages.
...
- [OpenMessaging (⭐287)](https://github.com/openmessaging/specification) [![GitHub stars](https://img.shields.io/github/stars/openmessaging/specification?style=flat)](https://github.com/openmessaging/specification/stargazers) - A cloud native, vendor-neutral open specification for distributed messaging.
...
- [JSON Schema (⭐5.1k)](https://github.com/json-schema-org/json-schema-spec) [![GitHub stars](https://img.shields.io/github/stars/json-schema-org/json-schema-spec?style=flat)](https://github.com/json-schema-org/json-schema-spec/stargazers) - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
...
<!--lint enable-->
## Contributing
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/stn1slv/awesome-integration/blob/main/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/stn1slv/awesome-integration/blob/main/CONTRIBUTING.md?style=flat)](https://github.com/stn1slv/awesome-integration/blob/main/CONTRIBUTING.md/stargazers) first.

## About the author
This list is maintained by [Stanislav Deviatov](https://github.com/stn1slv) [![GitHub stars](https://img.shields.io/github/stars/stn1slv?style=flat)](https://github.com/stn1slv/stargazers), a solution architect working on enterprise integration and API architecture. He also publishes [API & Integration Digest](https://www.linkedin.com/build-relation/newsletter-follow?entityUrn=7263963549411004416), a LinkedIn newsletter with news on API management, iPaaS, ESB, integration frameworks, message brokers, and related topics.
