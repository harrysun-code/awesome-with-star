...
> 来源：[stetso/awesome-gideros](https://github.com/stetso/awesome-gideros)

[![GitHub stars](https://img.shields.io/github/stars/stetso/awesome-gideros?style=flat)](https://github.com/stetso/awesome-gideros/stargazers)
...
### Input
- [GidSwipe](https://github.com/stetso/GidSwipe) [![GitHub stars](https://img.shields.io/github/stars/stetso/GidSwipe?style=flat)](https://github.com/stetso/GidSwipe/stargazers) - Easy to use tap and swipe manager for mobile.
...
- [Spriteheet animation class](https://github.com/nascode/gideros_animsheet) [![GitHub stars](https://img.shields.io/github/stars/nascode/gideros_animsheet?style=flat)](https://github.com/nascode/gideros_animsheet/stargazers) - Class that helps with creating and playing animations from spritesheets.
...
### GUI
- [Layout](https://github.com/Nlcke/layout) [![GitHub stars](https://img.shields.io/github/stars/Nlcke/layout?style=flat)](https://github.com/Nlcke/layout/stargazers) - Comprehensive Gideors GUI framework ([forum entry](http://giderosmobile.com/forum/discussion/6651/layout-gideros-gui-framework#Item_23)).
...
### Plugins
- [SKStoreReview](https://github.com/mertkurum/GiderosStoreReview) [![GitHub stars](https://img.shields.io/github/stars/mertkurum/GiderosStoreReview?style=flat)](https://github.com/mertkurum/GiderosStoreReview/stargazers) - Gideros Plugin for SKStoreReviewController iOS 10.3+.
...
- [lume](https://github.com/rxi/lume) [![GitHub stars](https://img.shields.io/github/stars/rxi/lume?style=flat)](https://github.com/rxi/lume/stargazers) - Great collection of functions that are useful for game development.
- [inspect](https://github.com/kikito/inspect.lua) [![GitHub stars](https://img.shields.io/github/stars/kikito/inspect.lua?style=flat)](https://github.com/kikito/inspect.lua/stargazers) - Easily pretty-print your tables to the console in a readable way.
- [jumper](http://yonaba.github.io/Jumper/) - Super-fast grid-based pathfinding for Lua.
- [bump](https://github.com/kikito/bump.lua) [![GitHub stars](https://img.shields.io/github/stars/kikito/bump.lua?style=flat)](https://github.com/kikito/bump.lua/stargazers) - Simple, flexible and fast library for collision detection using axis-aligned bounding boxes (from version 2017.8 onwards Gideros contains a C-port of the library with the same API that should be used instead [cbump](https://wiki.giderosmobile.com/index.php/Bump).
- [Bresenham](https://github.com/rm-code/Bresenham) [![GitHub stars](https://img.shields.io/github/stars/rm-code/Bresenham?style=flat)](https://github.com/rm-code/Bresenham/stargazers) - Bresenham's line algorithm, implemented in Lua.

## Related Awesome Lists
- [awesome-lua](https://github.com/LewisJEllis/awesome-lua) [![GitHub stars](https://img.shields.io/github/stars/LewisJEllis/awesome-lua?style=flat)](https://github.com/LewisJEllis/awesome-lua/stargazers)
- [awesome-love2d](https://github.com/love2d-community/awesome-love2d) [![GitHub stars](https://img.shields.io/github/stars/love2d-community/awesome-love2d?style=flat)](https://github.com/love2d-community/awesome-love2d/stargazers)
- [awesome-gamedev](https://github.com/mbrukman/awesome-gamedev) [![GitHub stars](https://img.shields.io/github/stars/mbrukman/awesome-gamedev?style=flat)](https://github.com/mbrukman/awesome-gamedev/stargazers)
