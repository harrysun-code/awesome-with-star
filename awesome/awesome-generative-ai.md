...
[![GitHub stars](https://img.shields.io/github/stars/steven2358/awesome-generative-ai?style=flat)](https://github.com/steven2358/awesome-generative-ai/stargazers)
...
Contributions to this list are welcome. Before submitting your suggestions, please review the [Contribution Guidelines](CONTRIBUTING.md) to ensure your entries meet the criteria. Add links through [pull requests](https://github.com/steven2358/awesome-generative-ai/pulls) [![GitHub stars](https://img.shields.io/github/stars/steven2358/awesome-generative-ai/pulls?style=flat)](https://github.com/steven2358/awesome-generative-ai/pulls/stargazers) or create an [issue](https://github.com/steven2358/awesome-generative-ai/issues) [![GitHub stars](https://img.shields.io/github/stars/steven2358/awesome-generative-ai/issues?style=flat)](https://github.com/steven2358/awesome-generative-ai/issues/stargazers) to start a discussion. More projects can be found in the [Discoveries List](DISCOVERIES.md), where we showcase a wide range of up-and-coming Generative AI projects.
...
- [Grok](https://grok.x.ai/) - An LLM by xAI with [open source](https://github.com/xai-org/grok-1) [![GitHub stars](https://img.shields.io/github/stars/xai-org/grok-1?style=flat)](https://github.com/xai-org/grok-1/stargazers) and open weights. #opensource
- [Qwen](https://qwenlm.github.io/) - A series of LLMs independently developed by Alibaba Cloud. [#opensource](https://github.com/QwenLM/Qwen) [![GitHub stars](https://img.shields.io/github/stars/QwenLM/Qwen?style=flat)](https://github.com/QwenLM/Qwen/stargazers)
- [DeepSeek](https://huggingface.co/deepseek-ai) - A series of open-source LLMs by DeepSeek AI. [#opensource](https://github.com/deepseek-ai) [![GitHub stars](https://img.shields.io/github/stars/deepseek-ai?style=flat)](https://github.com/deepseek-ai/stargazers)
- [MiniMax](https://www.minimax.io/) - Multimodal foundation models for text, speech, video, and music generation
- [Kimi K2](https://github.com/moonshotai/Kimi-K2) [![GitHub stars](https://img.shields.io/github/stars/moonshotai/Kimi-K2?style=flat)](https://github.com/moonshotai/Kimi-K2/stargazers) - A series of open-source MoE language models by Moonshot AI for agentic tasks. #opensource
- [GLM](https://github.com/zai-org/GLM-5) [![GitHub stars](https://img.shields.io/github/stars/zai-org/GLM-5?style=flat)](https://github.com/zai-org/GLM-5/stargazers) - A series of open-source MoE language models by Z.ai for agentic tasks. #opensource
...
- [LibreChat](https://librechat.ai/) - LibreChat is a free and open-source chat interface for assistant AIs. [#opensource](https://github.com/danny-avila/LibreChat) [![GitHub stars](https://img.shields.io/github/stars/danny-avila/LibreChat?style=flat)](https://github.com/danny-avila/LibreChat/stargazers).
- [Chatbot UI](https://www.chatbotui.com/) - An open source ChatGPT UI. [#opensource](https://github.com/mckaywrigley/chatbot-ui) [![GitHub stars](https://img.shields.io/github/stars/mckaywrigley/chatbot-ui?style=flat)](https://github.com/mckaywrigley/chatbot-ui/stargazers).
...
- [privateGPT](https://github.com/zylon-ai/private-gpt) [![GitHub stars](https://img.shields.io/github/stars/zylon-ai/private-gpt?style=flat)](https://github.com/zylon-ai/private-gpt/stargazers) - Ask questions to your documents without an internet connection, using the power of LLMs.
- [quivr](https://github.com/QuivrHQ/quivr) [![GitHub stars](https://img.shields.io/github/stars/QuivrHQ/quivr?style=flat)](https://github.com/QuivrHQ/quivr/stargazers) - Dump all your files and chat with it using your generative AI second brain using LLMs & embeddings.
...
- [ChatGPT for Jupyter](https://github.com/TiesdeKok/chat-gpt-jupyter-extension) [![GitHub stars](https://img.shields.io/github/stars/TiesdeKok/chat-gpt-jupyter-extension?style=flat)](https://github.com/TiesdeKok/chat-gpt-jupyter-extension/stargazers) - Add various helper functions in Jupyter Notebooks and Jupyter Lab, powered by ChatGPT.
...
- [Open Notebook](https://www.open-notebook.ai) - An open source implementation of NotebookLM with more flexibility and features. [#opensource](https://github.com/lfnovo/open-notebook) [![GitHub stars](https://img.shields.io/github/stars/lfnovo/open-notebook?style=flat)](https://github.com/lfnovo/open-notebook/stargazers)
- [Screenpipe](https://github.com/screenpipe/screenpipe) [![GitHub stars](https://img.shields.io/github/stars/screenpipe/screenpipe?style=flat)](https://github.com/screenpipe/screenpipe/stargazers) - An open-source tool for recording screen and audio activity with AI-powered search, automations, and support for local LLMs. #opensource
...
- [STORM](https://storm.genie.stanford.edu/) - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations. [#opensource](https://github.com/stanford-oval/storm/) [![GitHub stars](https://img.shields.io/github/stars/stanford-oval/storm/?style=flat)](https://github.com/stanford-oval/storm//stargazers)
...
- [GitHub Copilot](https://github.com/features/copilot) [![GitHub stars](https://img.shields.io/github/stars/features/copilot?style=flat)](https://github.com/features/copilot/stargazers) - GitHub Copilot uses the OpenAI Codex to suggest code and entire functions in real-time, right from your editor.
...
- [PR-Agent](https://github.com/The-PR-Agent/pr-agent) [![GitHub stars](https://img.shields.io/github/stars/The-PR-Agent/pr-agent?style=flat)](https://github.com/The-PR-Agent/pr-agent/stargazers) - AI-powered tool for automated PR analysis, feedback, suggestions and more.
- [TurboPilot](https://github.com/ravenscroftj/turbopilot) [![GitHub stars](https://img.shields.io/github/stars/ravenscroftj/turbopilot?style=flat)](https://github.com/ravenscroftj/turbopilot/stargazers) - A self-hosted copilot clone which uses the library behind llama.cpp to run the 6 billion parameter Salesforce Codegen model in 4 GB of RAM.
- [GPT-Code UI](https://github.com/ricklamers/gpt-code-ui) [![GitHub stars](https://img.shields.io/github/stars/ricklamers/gpt-code-ui?style=flat)](https://github.com/ricklamers/gpt-code-ui/stargazers) - An open source implementation of OpenAI's ChatGPT Code interpreter. #opensource
- [Open Interpreter](https://github.com/openinterpreter/open-interpreter) [![GitHub stars](https://img.shields.io/github/stars/openinterpreter/open-interpreter?style=flat)](https://github.com/openinterpreter/open-interpreter/stargazers) - OpenAI's Code Interpreter in your terminal, running locally.
- [Continue](https://www.continue.dev/) - Open-source AI code assistant. Connect any model and any context to create custom autocomplete and chat experiences inside the IDE. [#opensource](https://github.com/continuedev/continue) [![GitHub stars](https://img.shields.io/github/stars/continuedev/continue?style=flat)](https://github.com/continuedev/continue/stargazers)
- [RooCode](https://github.com/RooCodeInc/Roo-Code) [![GitHub stars](https://img.shields.io/github/stars/RooCodeInc/Roo-Code?style=flat)](https://github.com/RooCodeInc/Roo-Code/stargazers) - An AI-powered autonomous coding agent integrated directly into VS Code. [#opensource](https://github.com/RooCodeInc/Roo-Code) [![GitHub stars](https://img.shields.io/github/stars/RooCodeInc/Roo-Code?style=flat)](https://github.com/RooCodeInc/Roo-Code/stargazers)
...
- [Plandex](https://github.com/plandex-ai/plandex) [![GitHub stars](https://img.shields.io/github/stars/plandex-ai/plandex?style=flat)](https://github.com/plandex-ai/plandex/stargazers) - Open source, terminal-based AI programming engine for complex tasks. [#opensource](https://github.com/plandex-ai/plandex) [![GitHub stars](https://img.shields.io/github/stars/plandex-ai/plandex?style=flat)](https://github.com/plandex-ai/plandex/stargazers)
- [Jupyter AI](https://github.com/jupyterlab/jupyter-ai) [![GitHub stars](https://img.shields.io/github/stars/jupyterlab/jupyter-ai?style=flat)](https://github.com/jupyterlab/jupyter-ai/stargazers) - An open-source, configurable AI assistant in Jupyter Notebook and JupyterLab that supports 100+ LLMs, including locally-hosted models from Ollama and GPT4All. #opensource
- [DataLine](https://dataline.app) - An AI-driven data analysis and visualization tool. [#opensource](https://github.com/RamiAwar/dataline) [![GitHub stars](https://img.shields.io/github/stars/RamiAwar/dataline?style=flat)](https://github.com/RamiAwar/dataline/stargazers)
...
- [aider](https://aider.chat/) - AI pair programming in your terminal, supporting multiple LLM providers. [#opensource](https://github.com/paul-gauthier/aider) [![GitHub stars](https://img.shields.io/github/stars/paul-gauthier/aider?style=flat)](https://github.com/paul-gauthier/aider/stargazers)
- [Kilo](https://kilo.ai/) - Open-source AI coding assistant for VS Code, JetBrains, and the CLI. [#opensource](https://github.com/Kilo-Org/kilocode) [![GitHub stars](https://img.shields.io/github/stars/Kilo-Org/kilocode?style=flat)](https://github.com/Kilo-Org/kilocode/stargazers)
...
- [gpt4all](https://github.com/nomic-ai/gpt4all) [![GitHub stars](https://img.shields.io/github/stars/nomic-ai/gpt4all?style=flat)](https://github.com/nomic-ai/gpt4all/stargazers) - A chatbot trained on a massive collection of clean assistant data including code, stories and dialogue.
- [LLM App](https://github.com/pathwaycom/llm-app) [![GitHub stars](https://img.shields.io/github/stars/pathwaycom/llm-app?style=flat)](https://github.com/pathwaycom/llm-app/stargazers) - Open-source Python library to build real-time LLM-enabled data pipeline.
...
- [SymbolicAI](https://github.com/ExtensityAI/symbolicai) [![GitHub stars](https://img.shields.io/github/stars/ExtensityAI/symbolicai?style=flat)](https://github.com/ExtensityAI/symbolicai/stargazers) - A neuro-symbolic framework for building applications with LLMs at the core.
- [Vanna.ai](https://vanna.ai/) - An open-source Python RAG framework for SQL generation and related functionality. [#opensource](https://github.com/vanna-ai/vanna) [![GitHub stars](https://img.shields.io/github/stars/vanna-ai/vanna?style=flat)](https://github.com/vanna-ai/vanna/stargazers)
- [Portkey](https://portkey.ai/) - A full-stack LLMOps platform for LLM monitoring, caching, and management.
- [agenta](https://github.com/agenta-ai/agenta) [![GitHub stars](https://img.shields.io/github/stars/agenta-ai/agenta?style=flat)](https://github.com/agenta-ai/agenta/stargazers) - An open-source end-to-end LLMOps platform for prompt engineering, evaluation, and deployment. #opensource
...
- [Gitingest](https://gitingest.com/) - Turn any Git repository into a simple text digest of its codebase so it can be fed into any LLM. [#opensource](https://github.com/cyclotruc/gitingest) [![GitHub stars](https://img.shields.io/github/stars/cyclotruc/gitingest?style=flat)](https://github.com/cyclotruc/gitingest/stargazers)
- [Repomix](https://repomix.com/) - Pack your codebase into AI-friendly formats. [#opensource](https://github.com/yamadashy/repomix) [![GitHub stars](https://img.shields.io/github/stars/yamadashy/repomix?style=flat)](https://github.com/yamadashy/repomix/stargazers)
- [llama.cpp](https://github.com/ggml-org/llama.cpp) [![GitHub stars](https://img.shields.io/github/stars/ggml-org/llama.cpp?style=flat)](https://github.com/ggml-org/llama.cpp/stargazers) - Inference of Meta's LLaMA model (and others) in pure C/C++. #opensource
- [bitnet.cpp](https://github.com/microsoft/BitNet) [![GitHub stars](https://img.shields.io/github/stars/microsoft/BitNet?style=flat)](https://github.com/microsoft/BitNet/stargazers) - Official inference framework for 1-bit LLMs, by Microsoft. [#opensource](https://github.com/microsoft/BitNet) [![GitHub stars](https://img.shields.io/github/stars/microsoft/BitNet?style=flat)](https://github.com/microsoft/BitNet/stargazers)
- [OpenRouter](https://openrouter.ai/) - A unified interface for LLMs. [#opensource](https://github.com/OpenRouterTeam) [![GitHub stars](https://img.shields.io/github/stars/OpenRouterTeam?style=flat)](https://github.com/OpenRouterTeam/stargazers)
- [Ludwig](https://github.com/ludwig-ai/ludwig) [![GitHub stars](https://img.shields.io/github/stars/ludwig-ai/ludwig?style=flat)](https://github.com/ludwig-ai/ludwig/stargazers) - A low-code framework for building custom AI models like LLMs and other deep neural networks. [#opensource](https://github.com/ludwig-ai/ludwig) [![GitHub stars](https://img.shields.io/github/stars/ludwig-ai/ludwig?style=flat)](https://github.com/ludwig-ai/ludwig/stargazers)
- [Unsloth](https://unsloth.ai) - A Python library for fine-tuning LLMs [#opensource](https://github.com/unslothai/unsloth) [![GitHub stars](https://img.shields.io/github/stars/unslothai/unsloth?style=flat)](https://github.com/unslothai/unsloth/stargazers).
- [OpenLIT](https://github.com/openlit/openlit) [![GitHub stars](https://img.shields.io/github/stars/openlit/openlit?style=flat)](https://github.com/openlit/openlit/stargazers) - Open-source GenAI and LLM observability platform native to OpenTelemetry with traces and metrics. #opensource
- [Helicone AI](https://helicone.ai/) - Open-source LLM observability platform for logging, monitoring, and debugging AI applications. [#opensource](https://github.com/Helicone/helicone) [![GitHub stars](https://img.shields.io/github/stars/Helicone/helicone?style=flat)](https://github.com/Helicone/helicone/stargazers)
- [Wren AI](https://www.getwren.ai/oss) - An open-source text-to-SQL and generative BI agent with a semantic layer. [#opensource](https://github.com/Canner/WrenAI) [![GitHub stars](https://img.shields.io/github/stars/Canner/WrenAI?style=flat)](https://github.com/Canner/WrenAI/stargazers)
- [Cleanlab](https://cleanlab.ai/tlm/) - An API for detecting and scoring hallucinations in LLM outputs.
- [Opik](https://github.com/comet-ml/opik) [![GitHub stars](https://img.shields.io/github/stars/comet-ml/opik?style=flat)](https://github.com/comet-ml/opik/stargazers) - An open-source platform for tracing, evaluating, and monitoring LLM applications. [#opensource](https://github.com/comet-ml/opik) [![GitHub stars](https://img.shields.io/github/stars/comet-ml/opik?style=flat)](https://github.com/comet-ml/opik/stargazers)
- [Langfuse](https://langfuse.com/) - An open-source LLM engineering platform for tracing, evaluation, prompt management, and metrics. [#opensource](https://github.com/langfuse/langfuse) [![GitHub stars](https://img.shields.io/github/stars/langfuse/langfuse?style=flat)](https://github.com/langfuse/langfuse/stargazers)
- [MLflow](https://mlflow.org/) - An open-source platform for tracking ML experiments, evaluating models and prompts, deploying models, and adding LLM observability. [#opensource](https://github.com/mlflow/mlflow) [![GitHub stars](https://img.shields.io/github/stars/mlflow/mlflow?style=flat)](https://github.com/mlflow/mlflow/stargazers)
- [rehydra](https://github.com/rehydra-ai/rehydra-sdk) [![GitHub stars](https://img.shields.io/github/stars/rehydra-ai/rehydra-sdk?style=flat)](https://github.com/rehydra-ai/rehydra-sdk/stargazers) - A zero-trust SDK for anonymizing PII locally before sending prompts to LLMs and seamlessly rehydrating the response.
- [Agentset](https://agentset.ai/) - An open-source platform for building and evaluating RAG and agentic applications. [#opensource](https://github.com/agentset-ai/agentset) [![GitHub stars](https://img.shields.io/github/stars/agentset-ai/agentset?style=flat)](https://github.com/agentset-ai/agentset/stargazers)
- [Manifest](https://manifest.build) - An open-source LLM router that routes agent requests to the most cost-effective model, with usage limits and model benchmarking. [#opensource](https://github.com/mnfst/manifest) [![GitHub stars](https://img.shields.io/github/stars/mnfst/manifest?style=flat)](https://github.com/mnfst/manifest/stargazers)
- [ai-i18n](https://github.com/i18n-actions/ai-i18n) [![GitHub stars](https://img.shields.io/github/stars/i18n-actions/ai-i18n?style=flat)](https://github.com/i18n-actions/ai-i18n/stargazers) - A GitHub Action that uses LLMs (Claude, GPT, Ollama) to automatically translate i18n localization files. #opensource
...
- [GitHub Models](https://github.com/marketplace/models) [![GitHub stars](https://img.shields.io/github/stars/marketplace/models?style=flat)](https://github.com/marketplace/models/stargazers) - Find and experiment with AI models to develop a generative AI application.

### Local LLM Deployment

- [Ollama](https://github.com/ollama/ollama) [![GitHub stars](https://img.shields.io/github/stars/ollama/ollama?style=flat)](https://github.com/ollama/ollama/stargazers) - Get up and running with large language models locally.
- [Open WebUI](https://github.com/open-webui/open-webui) [![GitHub stars](https://img.shields.io/github/stars/open-webui/open-webui?style=flat)](https://github.com/open-webui/open-webui/stargazers) - An extensible, feature-rich, and user-friendly self-hosted AI platform designed to operate entirely offline. #opensource
- [Jan](https://jan.ai/) - Run LLMs like Mistral or Llama2 locally and offline on your computer, or connect to remote AI APIs. [#opensource](https://github.com/janhq/jan) [![GitHub stars](https://img.shields.io/github/stars/janhq/jan?style=flat)](https://github.com/janhq/jan/stargazers)
...
- [LLM](https://llm.datasette.io/) - A CLI utility and Python library for interacting with Large Language Models, remote and local. [#opensource](https://github.com/simonw/llm) [![GitHub stars](https://img.shields.io/github/stars/simonw/llm?style=flat)](https://github.com/simonw/llm/stargazers)
...
- [Auto-GPT](https://github.com/Significant-Gravitas/AutoGPT) [![GitHub stars](https://img.shields.io/github/stars/Significant-Gravitas/AutoGPT?style=flat)](https://github.com/Significant-Gravitas/AutoGPT/stargazers) - An experimental open-source attempt to make GPT-4 fully autonomous.
- [babyagi](https://github.com/yoheinakajima/babyagi) [![GitHub stars](https://img.shields.io/github/stars/yoheinakajima/babyagi?style=flat)](https://github.com/yoheinakajima/babyagi/stargazers) - An AI-powered task management system.
- [AgentGPT](https://github.com/reworkd/AgentGPT) [![GitHub stars](https://img.shields.io/github/stars/reworkd/AgentGPT?style=flat)](https://github.com/reworkd/AgentGPT/stargazers) - Assemble, configure, and deploy autonomous AI Agents in your browser.
- [GPT Engineer](https://github.com/AntonOsika/gpt-engineer) [![GitHub stars](https://img.shields.io/github/stars/AntonOsika/gpt-engineer?style=flat)](https://github.com/AntonOsika/gpt-engineer/stargazers) - Specify what you want it to build, the AI asks for clarification, and then builds it.
- [GPT Prompt Engineer](https://github.com/mshumer/gpt-prompt-engineer) [![GitHub stars](https://img.shields.io/github/stars/mshumer/gpt-prompt-engineer?style=flat)](https://github.com/mshumer/gpt-prompt-engineer/stargazers) - Automated prompt engineering. It generates, tests, and ranks prompts to find the best ones.
- [MetaGPT](https://github.com/FoundationAgents/MetaGPT) [![GitHub stars](https://img.shields.io/github/stars/FoundationAgents/MetaGPT?style=flat)](https://github.com/FoundationAgents/MetaGPT/stargazers) - The Multi-Agent Framework: Given one line requirement, return PRD, design, tasks, repo.
- [AutoGen](https://github.com/microsoft/autogen) [![GitHub stars](https://img.shields.io/github/stars/microsoft/autogen?style=flat)](https://github.com/microsoft/autogen/stargazers) - AutoGen is a framework that enables the development of LLM applications using multiple agents that can converse with each other to solve tasks.
- [GPT Pilot](https://github.com/Pythagora-io/gpt-pilot) [![GitHub stars](https://img.shields.io/github/stars/Pythagora-io/gpt-pilot?style=flat)](https://github.com/Pythagora-io/gpt-pilot/stargazers) - Dev tool that writes scalable apps from scratch while the developer oversees the implementation.
- [Devin](https://devin.ai/) - An autonomous AI software engineer by Cognition Labs.
- [OpenHands](https://github.com/OpenHands/OpenHands) [![GitHub stars](https://img.shields.io/github/stars/OpenHands/OpenHands?style=flat)](https://github.com/OpenHands/OpenHands/stargazers) - An autonomous agent designed to navigate the complexities of software engineering. #opensource
- [Davika](https://github.com/stitionai/devika) [![GitHub stars](https://img.shields.io/github/stars/stitionai/devika?style=flat)](https://github.com/stitionai/devika/stargazers) - An agentic AI software engineer. #opensource
...
- [Gemini CLI](https://geminicli.com) - An open-source AI agent that brings the power of Gemini directly into your terminal. [#opensource](https://github.com/google-gemini/gemini-cli) [![GitHub stars](https://img.shields.io/github/stars/google-gemini/gemini-cli?style=flat)](https://github.com/google-gemini/gemini-cli/stargazers)
- [OpenCode](https://opencode.ai) - The open-source AI coding agent. [#opensource](https://github.com/anomalyco/opencode) [![GitHub stars](https://img.shields.io/github/stars/anomalyco/opencode?style=flat)](https://github.com/anomalyco/opencode/stargazers)
- [Mastra](https://mastra.ai) - A TypeScript framework for building AI agents, workflows, and applications. [#opensource](https://github.com/mastra-ai/mastra) [![GitHub stars](https://img.shields.io/github/stars/mastra-ai/mastra?style=flat)](https://github.com/mastra-ai/mastra/stargazers)
- [OpenClaw](https://openclaw.ai) - A personal AI assistant you run on your own devices. [#opensource](https://github.com/openclaw/openclaw) [![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=flat)](https://github.com/openclaw/openclaw/stargazers)
...
- [Agent Skills](https://agentskills.io) - Open format and reference SDK for packaging reusable capabilities and expertise for AI agents. [#opensource](https://github.com/agentskills/agentskills) [![GitHub stars](https://img.shields.io/github/stars/agentskills/agentskills?style=flat)](https://github.com/agentskills/agentskills/stargazers)
- [PraisonAI](https://github.com/MervinPraison/PraisonAI) [![GitHub stars](https://img.shields.io/github/stars/MervinPraison/PraisonAI?style=flat)](https://github.com/MervinPraison/PraisonAI/stargazers) - A framework for building multi-agent AI systems with workflows, tool integrations, and memory. #opensource
- [Hermes Agent](https://hermes-agent.nousresearch.com) - A self-improving personal agent with memory, messaging integrations, and sandboxed tool execution. [#opensource](https://github.com/NousResearch/hermes-agent) [![GitHub stars](https://img.shields.io/github/stars/NousResearch/hermes-agent?style=flat)](https://github.com/NousResearch/hermes-agent/stargazers)
- [OpenAgents](https://github.com/openagents-org/openagents) [![GitHub stars](https://img.shields.io/github/stars/openagents-org/openagents?style=flat)](https://github.com/openagents-org/openagents/stargazers) - Open-source platform for building AI agent networks with multi-protocol support (WebSocket, gRPC, HTTP, MCP, A2A). #opensource
- [Dorothy](https://github.com/Charlie85270/Dorothy) [![GitHub stars](https://img.shields.io/github/stars/Charlie85270/Dorothy?style=flat)](https://github.com/Charlie85270/Dorothy/stargazers) - An open-source desktop app to orchestrate multiple AI CLI agents simultaneously with automations and Kanban management. #opensource
- [Hive](https://github.com/aden-hive/hive) [![GitHub stars](https://img.shields.io/github/stars/aden-hive/hive?style=flat)](https://github.com/aden-hive/hive/stargazers) - An open-source multi-agent framework with auto-generated graphs, evolution loops, and MCP integration. #opensource
...
- [DragGAN](https://github.com/XingangPan/DragGAN) [![GitHub stars](https://img.shields.io/github/stars/XingangPan/DragGAN?style=flat)](https://github.com/XingangPan/DragGAN/stargazers) - Drag Your GAN: Interactive Point-based Manipulation on the Generative Image Manifold.
- [Flux](https://github.com/black-forest-labs/flux) [![GitHub stars](https://img.shields.io/github/stars/black-forest-labs/flux?style=flat)](https://github.com/black-forest-labs/flux/stargazers) - Text-to-image models by Black Forest Labs with high-quality photorealistic output. #opensource
...
- [Hugging Face Diffusion Models Course](https://github.com/huggingface/diffusion-models-class) [![GitHub stars](https://img.shields.io/github/stars/huggingface/diffusion-models-class?style=flat)](https://github.com/huggingface/diffusion-models-class/stargazers) - Python materials for the online course on diffusion models by [@huggingface](https://github.com/huggingface) [![GitHub stars](https://img.shields.io/github/stars/huggingface?style=flat)](https://github.com/huggingface/stargazers).
- [ComfyUI](https://github.com/comfyanonymous/ComfyUI) [![GitHub stars](https://img.shields.io/github/stars/comfyanonymous/ComfyUI?style=flat)](https://github.com/comfyanonymous/ComfyUI/stargazers) - A node-based interface for building and running Stable Diffusion workflows. [#opensource](https://github.com/comfyanonymous/ComfyUI) [![GitHub stars](https://img.shields.io/github/stars/comfyanonymous/ComfyUI?style=flat)](https://github.com/comfyanonymous/ComfyUI/stargazers)
...
- [HyperFrames](https://hyperframes.heygen.com/) - A framework for AI agents to render videos by writing HTML, CSS, and JavaScript. [#opensource](https://github.com/heygen-com/hyperframes) [![GitHub stars](https://img.shields.io/github/stars/heygen-com/hyperframes?style=flat)](https://github.com/heygen-com/hyperframes/stargazers)
...
- [TorToiSe](https://github.com/neonbjb/tortoise-tts) [![GitHub stars](https://img.shields.io/github/stars/neonbjb/tortoise-tts?style=flat)](https://github.com/neonbjb/tortoise-tts/stargazers) - A multi-voice text-to-speech system trained with an emphasis on quality. #opensource
- [Bark](https://github.com/suno-ai/bark) [![GitHub stars](https://img.shields.io/github/stars/suno-ai/bark?style=flat)](https://github.com/suno-ai/bark/stargazers) - A transformer-based text-to-audio model. #opensource
- [TTS WebUI](https://github.com/rsxdalv/TTS-WebUI) [![GitHub stars](https://img.shields.io/github/stars/rsxdalv/TTS-WebUI?style=flat)](https://github.com/rsxdalv/TTS-WebUI/stargazers) - Web UI for running multiple text-to-speech, music generation, and audio tools. #opensource

### Speech-to-text

- [Whisper](https://openai.com/index/whisper/) - Robust speech recognition via large-scale weak supervision. [#opensource](https://github.com/openai/whisper) [![GitHub stars](https://img.shields.io/github/stars/openai/whisper?style=flat)](https://github.com/openai/whisper/stargazers)
...
- [Teleprompter](https://github.com/danielgross/teleprompter) [![GitHub stars](https://img.shields.io/github/stars/danielgross/teleprompter?style=flat)](https://github.com/danielgross/teleprompter/stargazers) - An on-device AI for your meetings that listens to you and makes charismatic quote suggestions.
...
- [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) [![GitHub stars](https://img.shields.io/github/stars/dair-ai/Prompt-Engineering-Guide?style=flat)](https://github.com/dair-ai/Prompt-Engineering-Guide/stargazers) - Guide and resources for prompt engineering.
...
- [OpenAI Cookbook](https://github.com/openai/openai-cookbook) [![GitHub stars](https://img.shields.io/github/stars/openai/openai-cookbook?style=flat)](https://github.com/openai/openai-cookbook/stargazers) - Examples and guides for using the OpenAI API.
...
- [Anthropic courses](https://github.com/anthropics/courses) [![GitHub stars](https://img.shields.io/github/stars/anthropics/courses?style=flat)](https://github.com/anthropics/courses/stargazers) - Anthropic's educational courses.
...
- [AnimatedLLM](https://animatedllm.github.io/) - Interactive visualizations explaining how large language models work. [#opensource](https://github.com/kasnerz/animated-llm) [![GitHub stars](https://img.shields.io/github/stars/kasnerz/animated-llm?style=flat)](https://github.com/kasnerz/animated-llm/stargazers)
- [Transformer Explainer](https://poloclub.github.io/transformer-explainer/) - Interactive visualization of how transformer-based LLMs work, running a live GPT-2 model in the browser. [#opensource](https://github.com/poloclub/transformer-explainer) [![GitHub stars](https://img.shields.io/github/stars/poloclub/transformer-explainer?style=flat)](https://github.com/poloclub/transformer-explainer/stargazers)
...
- [Generative Deep Art](https://github.com/filipecalegario/awesome-generative-ai) [![GitHub stars](https://img.shields.io/github/stars/filipecalegario/awesome-generative-ai?style=flat)](https://github.com/filipecalegario/awesome-generative-ai/stargazers) - A curated list of generative deep learning tools, works, models, etc. for artistic uses, by [@filipecalegario](https://github.com/filipecalegario/) [![GitHub stars](https://img.shields.io/github/stars/filipecalegario/?style=flat)](https://github.com/filipecalegario//stargazers).
...
- [The Generative AI Landscape](https://github.com/ai-collection/ai-collection) [![GitHub stars](https://img.shields.io/github/stars/ai-collection/ai-collection?style=flat)](https://github.com/ai-collection/ai-collection/stargazers) - A Collection of Awesome Generative AI Applications.
- [Molecular design](https://github.com/AspirinCode/papers-for-molecular-design-using-DL) [![GitHub stars](https://img.shields.io/github/stars/AspirinCode/papers-for-molecular-design-using-DL?style=flat)](https://github.com/AspirinCode/papers-for-molecular-design-using-DL/stargazers) - List of molecular design using Generative AI and Deep Learning.
- [Open LLMs](https://github.com/eugeneyan/open-llms) [![GitHub stars](https://img.shields.io/github/stars/eugeneyan/open-llms?style=flat)](https://github.com/eugeneyan/open-llms/stargazers) - A list of open LLMs available for commercial use.
- [Awesome Music AI](https://github.com/steven2358/awesome-music-ai) [![GitHub stars](https://img.shields.io/github/stars/steven2358/awesome-music-ai?style=flat)](https://github.com/steven2358/awesome-music-ai/stargazers) - A curated list of AI tools for music composition, generation, and analysis.
- [Awesome AI Market Maps](https://github.com/joylarkin/Awesome-AI-Market-Maps) [![GitHub stars](https://img.shields.io/github/stars/joylarkin/Awesome-AI-Market-Maps?style=flat)](https://github.com/joylarkin/Awesome-AI-Market-Maps/stargazers) - A curated list of AI market maps from 2026, 2025, and 2024, by [Joy Larkin](https://twitter.com/joy).
- [Awesome RAG Production](https://github.com/Yigtwxx/Awesome-RAG-Production) [![GitHub stars](https://img.shields.io/github/stars/Yigtwxx/Awesome-RAG-Production?style=flat)](https://github.com/Yigtwxx/Awesome-RAG-Production/stargazers) - A curated list of tools and resources for building production RAG systems.

### Lists on ChatGPT

- [Awesome ChatGPT](https://github.com/humanloop/awesome-chatgpt) [![GitHub stars](https://img.shields.io/github/stars/humanloop/awesome-chatgpt?style=flat)](https://github.com/humanloop/awesome-chatgpt/stargazers) - A curated list of awesome tools, demos, docs for ChatGPT and GPT-3, by [@jordn](https://github.com/jordn) [![GitHub stars](https://img.shields.io/github/stars/jordn?style=flat)](https://github.com/jordn/stargazers).
- [Awesome ChatGPT Prompts](https://github.com/f/prompts.chat) [![GitHub stars](https://img.shields.io/github/stars/f/prompts.chat?style=flat)](https://github.com/f/prompts.chat/stargazers) - A collection of prompt examples to be used with the ChatGPT model.
- [FlowGPT](https://flowgpt.com/) - Amplify your workflow with the best prompts.
- [ChatGPT Prompts for Data Science](https://github.com/travistangvh/ChatGPT-Data-Science-Prompts) [![GitHub stars](https://img.shields.io/github/stars/travistangvh/ChatGPT-Data-Science-Prompts?style=flat)](https://github.com/travistangvh/ChatGPT-Data-Science-Prompts/stargazers) - A repository of useful data science prompts for ChatGPT.
- [Awesome ChatGPT](https://github.com/sindresorhus/awesome-chatgpt) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome-chatgpt?style=flat)](https://github.com/sindresorhus/awesome-chatgpt/stargazers) - Another awesome list for ChatGPT.
