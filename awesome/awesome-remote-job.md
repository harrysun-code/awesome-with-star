...
## Job boards
  ...
  1. [remote-es/remotes](https://github.com/remote-es/remotes) [![GitHub stars](https://img.shields.io/github/stars/remote-es/remotes?style=flat)](https://github.com/remote-es/remotes/stargazers) - Repository listing companies which offer full-time remote jobs with Spanish contracts
  1. [thatmlopsguy/remote-pt](https://github.com/thatmlopsguy/remote-pt) [![GitHub stars](https://img.shields.io/github/stars/thatmlopsguy/remote-pt?style=flat)](https://github.com/thatmlopsguy/remote-pt/stargazers) - Repository listing companies which offer full-time remote jobs with Portuguese contracts
  1. [remote-jobs](https://github.com/remoteintech/remote-jobs) [![GitHub stars](https://img.shields.io/github/stars/remoteintech/remote-jobs?style=flat)](https://github.com/remoteintech/remote-jobs/stargazers) - A list of semi to fully remote-friendly companies in tech
...
## Interviewing
  1. [andreis/interview](https://github.com/Olshansk/interview) [![GitHub stars](https://img.shields.io/github/stars/Olshansk/interview?style=flat)](https://github.com/Olshansk/interview/stargazers) - Everything you need to kick ass on your coding interview
  1. [awesome-interviews](https://github.com/DopplerHQ/awesome-interview-questions) [![GitHub stars](https://img.shields.io/github/stars/DopplerHQ/awesome-interview-questions?style=flat)](https://github.com/DopplerHQ/awesome-interview-questions/stargazers) - A curated awesome list of lists of interview questions
...
## Companies with "remote DNA"
  ...
  1. [Sourcegraph](https://github.com/sourcegraph/careers) [![GitHub stars](https://img.shields.io/github/stars/sourcegraph/careers?style=flat)](https://github.com/sourcegraph/careers/stargazers) - Code search and navigation for teams (self-hosted, OSS). Fully remote (across time zones).
...
## Communities
  ...
  1. [##remotes](https://github.com/remotesclub/remotes) [![GitHub stars](https://img.shields.io/github/stars/remotesclub/remotes?style=flat)](https://github.com/remotesclub/remotes/stargazers) - IRC channel 
...
#### Communication
  ...
  1. [Hopp](https://github.com/gethopp/hopp) [![GitHub stars](https://img.shields.io/github/stars/gethopp/hopp?style=flat)](https://github.com/gethopp/hopp/stargazers) - Open source remote pair programming app.
  ...
  1. [Matrix](https://github.com/ResultadosDigitais/matrix) [![GitHub stars](https://img.shields.io/github/stars/ResultadosDigitais/matrix?style=flat)](https://github.com/ResultadosDigitais/matrix/stargazers) – Matrix is the online open-source workplace for distributed teams.
...
## Others
  1. [awesome-digital-nomads](https://github.com/cbovis/awesome-digital-nomads) [![GitHub stars](https://img.shields.io/github/stars/cbovis/awesome-digital-nomads?style=flat)](https://github.com/cbovis/awesome-digital-nomads/stargazers) - 🏝 A curated list of awesome resources for Digital Nomads.
  1. [Established Remote](https://github.com/yanirs/established-remote) [![GitHub stars](https://img.shields.io/github/stars/yanirs/established-remote?style=flat)](https://github.com/yanirs/established-remote/stargazers) - A list of established remote companies
  ...
  1. [Remote Working](https://github.com/greatghoul/remote-working) [![GitHub stars](https://img.shields.io/github/stars/greatghoul/remote-working?style=flat)](https://github.com/greatghoul/remote-working/stargazers) - A list of remote working resources for Chinese.
  1. [WorkFrom](https://workfrom.co/) - Find coffee shops that are good to work from.
  2. [Websoft9](https://github.com/Websoft9/websoft9) [![GitHub stars](https://img.shields.io/github/stars/Websoft9/websoft9?style=flat)](https://github.com/Websoft9/websoft9/stargazers) - Open source software self-hosting platform, one-click to install 200+ application includes remote tools like Jiti Meet, Rocket.chat, GitLab, Mattermost.

## License

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

To the extent possible under law, [Lukasz Madon](https://github.com/lukasz-madon) [![GitHub stars](https://img.shields.io/github/stars/lukasz-madon?style=flat)](https://github.com/lukasz-madon/stargazers) has waived all copyright and related or neighboring rights to this work.
