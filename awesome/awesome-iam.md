...
> 来源：[kdeldycke/awesome-iam](https://github.com/kdeldycke/awesome-iam)

[![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-iam?style=flat)](https://github.com/kdeldycke/awesome-iam/stargazers)
...
[IAM](https://en.wikipedia.org/wiki/Identity_management) stands for Identity and Access Management. It is a complex domain which covers **user accounts, authentication, authorization, roles, permissions and privacy**. It is an essential pillar of the cloud stack, where users, products and security meets. The [other pillar being billing & payments 💰](https://github.com/kdeldycke/awesome-billing/) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-billing/?style=flat)](https://github.com/kdeldycke/awesome-billing//stargazers).
...
- [Kratos](https://github.com/ory/kratos) [![GitHub stars](https://img.shields.io/github/stars/ory/kratos?style=flat)](https://github.com/ory/kratos/stargazers) - 💸 User login, user registration, 2FA and profile management.

- [UserFrosting](https://github.com/userfrosting/UserFrosting) [![GitHub stars](https://img.shields.io/github/stars/userfrosting/UserFrosting?style=flat)](https://github.com/userfrosting/UserFrosting/stargazers) - 🆓 Modern PHP user login and management framework.
...
- [Papers we love: Cryptography](https://github.com/papers-we-love/papers-we-love/blob/master/cryptography/README.md) [![GitHub stars](https://img.shields.io/github/stars/papers-we-love/papers-we-love/blob/master/cryptography/README.md?style=flat)](https://github.com/papers-we-love/papers-we-love/blob/master/cryptography/README.md/stargazers) - Foundational papers of cryptography.
...
- [Awesome GUID](https://github.com/secretGeek/AwesomeGUID) [![GitHub stars](https://img.shields.io/github/stars/secretGeek/AwesomeGUID?style=flat)](https://github.com/secretGeek/AwesomeGUID/stargazers) - Funny take on the global aspect of unique identifiers.
...
- [oathkeeper](https://github.com/ory/oathkeeper) [![GitHub stars](https://img.shields.io/github/stars/ory/oathkeeper?style=flat)](https://github.com/ory/oathkeeper/stargazers) - 💸 Identity & Access Proxy and Access Control Decision API that authenticates, authorizes, and mutates incoming HTTP requests. Inspired by the BeyondCorp / Zero Trust white paper.

- [Pomerium](https://github.com/pomerium/pomerium) [![GitHub stars](https://img.shields.io/github/stars/pomerium/pomerium?style=flat)](https://github.com/pomerium/pomerium/stargazers) - 💸 An identity-aware proxy that enables secure access to internal applications.

- [heimdall](https://github.com/dadrus/heimdall) [![GitHub stars](https://img.shields.io/github/stars/dadrus/heimdall?style=flat)](https://github.com/dadrus/heimdall/stargazers) - 🆓 A cloud-native, identity-aware proxy and policy enforcement point that orchestrates authentication and authorization systems via versatile rules, supporting protocol-agnostic identity propagation.
...
- [SPIFFE/SPIRE](https://github.com/spiffe/spire) [![GitHub stars](https://img.shields.io/github/stars/spiffe/spire?style=flat)](https://github.com/spiffe/spire/stargazers) - 🆓 A CNCF framework issuing short-lived, cryptographically-verifiable identities (SVIDs) to workloads across heterogeneous environments.

- [NanoMDM](https://github.com/micromdm/nanomdm) [![GitHub stars](https://img.shields.io/github/stars/micromdm/nanomdm?style=flat)](https://github.com/micromdm/nanomdm/stargazers) - 🆓 Minimalist Apple MDM server and library to enroll and manage the identity of Apple devices, inspired by MicroMDM.
...
- [Kanidm](https://github.com/kanidm/kanidm) [![GitHub stars](https://img.shields.io/github/stars/kanidm/kanidm?style=flat)](https://github.com/kanidm/kanidm/stargazers) - 🆓 Simple, secure and fast identity management platform.
...
- [OpenSK](https://github.com/google/OpenSK) [![GitHub stars](https://img.shields.io/github/stars/google/OpenSK?style=flat)](https://github.com/google/OpenSK/stargazers) - 🆓 Open-source implementation for security keys written in Rust that supports both FIDO U2F and FIDO2 standards.

- [YubiKey Guide](https://github.com/drduh/YubiKey-Guide) [![GitHub stars](https://img.shields.io/github/stars/drduh/YubiKey-Guide?style=flat)](https://github.com/drduh/YubiKey-Guide/stargazers) - Guide to using YubiKey as a SmartCard for storing GPG encryption, signing and authentication keys, which can also be used for SSH. Many of the principles in this document are applicable to other smart card devices.
...
- [`lemur`](https://github.com/Netflix/lemur) [![GitHub stars](https://img.shields.io/github/stars/Netflix/lemur?style=flat)](https://github.com/Netflix/lemur/stargazers) - 🆓 Acts as a broker between CAs and environments, providing a central portal for developers to issue TLS certificates with 'sane' defaults.

- [CFSSL](https://github.com/cloudflare/cfssl) [![GitHub stars](https://img.shields.io/github/stars/cloudflare/cfssl?style=flat)](https://github.com/cloudflare/cfssl/stargazers) - 🆓 A swiss army knife for PKI/TLS by CloudFlare. Command line tool and an HTTP API server for signing, verifying, and bundling TLS certificates.

- [JA4+](https://github.com/FoxIO-LLC/ja4) [![GitHub stars](https://img.shields.io/github/stars/FoxIO-LLC/ja4?style=flat)](https://github.com/FoxIO-LLC/ja4/stargazers) - 💸 A suite of network fingerprinting methods to facilitate threat-hunting and analysis.
...
- [Learn how to use JWT for Authentication](https://github.com/dwyl/learn-json-web-tokens) [![GitHub stars](https://img.shields.io/github/stars/dwyl/learn-json-web-tokens?style=flat)](https://github.com/dwyl/learn-json-web-tokens/stargazers) - Learn how to use JWT to secure your web app.
...
- [Cerbos](https://github.com/cerbos/cerbos) [![GitHub stars](https://img.shields.io/github/stars/cerbos/cerbos?style=flat)](https://github.com/cerbos/cerbos/stargazers) - 💸 An authorization endpoint to write context-aware access control policies.

- [FerrisKey](https://github.com/ferriskey/ferriskey) [![GitHub stars](https://img.shields.io/github/stars/ferriskey/ferriskey?style=flat)](https://github.com/ferriskey/ferriskey/stargazers) - 🆓 Self-hosted, open-source, RBAC system written in Rust.
...
- [SpiceDB](https://github.com/authzed/spicedb) [![GitHub stars](https://img.shields.io/github/stars/authzed/spicedb?style=flat)](https://github.com/authzed/spicedb/stargazers) - 💸 An open source database system for managing security-critical application permissions inspired by Zanzibar.

- [Permify](https://github.com/Permify/permify) [![GitHub stars](https://img.shields.io/github/stars/Permify/permify?style=flat)](https://github.com/Permify/permify/stargazers) - 💸 Another open-source authorization as a service inspired by Google Zanzibar, and see [how it compares to other Zanzibar-inspired tools](https://permify.notion.site/Differentiation-Between-Zanzibar-Products-ad4732da62e64655bc82d3abe25f48b6).

- [Topaz](https://github.com/aserto-dev/topaz) [![GitHub stars](https://img.shields.io/github/stars/aserto-dev/topaz?style=flat)](https://github.com/aserto-dev/topaz/stargazers) - 💸 An open-source project which combines the policy-as-code and decision logging of OPA with a Zanzibar-modeled directory.

- [Open Policy Administration Layer](https://github.com/permitio/opal) [![GitHub stars](https://img.shields.io/github/stars/permitio/opal?style=flat)](https://github.com/permitio/opal/stargazers) - 💸 Open Source administration layer for OPA, detecting changes to both policy and policy data in realtime and pushing live updates to OPA agents. OPAL brings open-policy up to the speed needed by live applications.
...
- [Policy Sentry](https://github.com/salesforce/policy_sentry) [![GitHub stars](https://img.shields.io/github/stars/salesforce/policy_sentry?style=flat)](https://github.com/salesforce/policy_sentry/stargazers) - 🆓 Writing security-conscious IAM Policies by hand can be very tedious and inefficient. Policy Sentry helps users to create least-privilege policies in a matter of seconds.

- [IAM Floyd](https://github.com/udondan/iam-floyd) [![GitHub stars](https://img.shields.io/github/stars/udondan/iam-floyd?style=flat)](https://github.com/udondan/iam-floyd/stargazers) - 🆓 AWS IAM policy statement generator with fluent interface. Helps with creating type safe IAM policies and writing more restrictive/secure statements by offering conditions and ARN generation via IntelliSense. Available for Node.js, Python, .Net and Java.

- [IAMbic](https://github.com/noqdev/iambic) [![GitHub stars](https://img.shields.io/github/stars/noqdev/iambic?style=flat)](https://github.com/noqdev/iambic/stargazers) - 💸 GitOps for IAM. The Terraform of Cloud IAM. IAMbic is a multi-cloud identity and access management (IAM) control plane that centralizes and simplifies cloud access and permissions. It maintains an eventually consistent, human-readable, bi-directional representation of IAM in version control.
...
- [Gubernator](https://github.com/gubernator-io/gubernator) [![GitHub stars](https://img.shields.io/github/stars/gubernator-io/gubernator?style=flat)](https://github.com/gubernator-io/gubernator/stargazers) - 🆓 High performance rate-limiting micro-service and library.
...
- [Hydra](https://github.com/ory/hydra) [![GitHub stars](https://img.shields.io/github/stars/ory/hydra?style=flat)](https://github.com/ory/hydra/stargazers) - 💸 Open-source OIDC & OAuth2 Server Provider.
...
- [ZITADEL](https://github.com/zitadel/zitadel) [![GitHub stars](https://img.shields.io/github/stars/zitadel/zitadel?style=flat)](https://github.com/zitadel/zitadel/stargazers) - 💸 An Open-Source solution built with Go and Angular to manage all your systems, users and service accounts together with their roles and external identities. ZITADEL provides you with OIDC, OAuth 2.0, login & register flows, passwordless and MFA authentication. All this is built on top of eventsourcing in combination with CQRS to provide a great audit trail.

- [obligator](https://github.com/lastlogin-net/obligator) [![GitHub stars](https://img.shields.io/github/stars/lastlogin-net/obligator?style=flat)](https://github.com/lastlogin-net/obligator/stargazers) - 🆓 Simple and opinionated OpenID Connect server designed for self-hosters. Single static binary with flat-file or SQLite storage.
...
- [HashiCorp Vault](https://github.com/hashicorp/vault) [![GitHub stars](https://img.shields.io/github/stars/hashicorp/vault?style=flat)](https://github.com/hashicorp/vault/stargazers) - 💸 Secure, store and tightly control access to tokens, passwords, certificates, encryption keys.
...
- [Keystone](https://github.com/keystone-enclave/keystone) [![GitHub stars](https://img.shields.io/github/stars/keystone-enclave/keystone?style=flat)](https://github.com/keystone-enclave/keystone/stargazers) - 🆓 Open-source project for building trusted execution environments (TEE) with secure hardware enclaves, based on the RISC-V architecture.

- [Project Oak](https://github.com/project-oak/oak) [![GitHub stars](https://img.shields.io/github/stars/project-oak/oak?style=flat)](https://github.com/project-oak/oak/stargazers) - 🆓 A specification and a reference implementation for the secure transfer, storage and processing of data.
...
- [Awesome List of Billing and Payments: Fraud links](https://github.com/kdeldycke/awesome-billing#fraud) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-billing?style=flat)](https://github.com/kdeldycke/awesome-billing/stargazers) - Section dedicated to fraud management for billing and payment, from our sister repository.
...
- [Statistically Likely Usernames](https://github.com/insidetrust/statistically-likely-usernames) [![GitHub stars](https://img.shields.io/github/stars/insidetrust/statistically-likely-usernames?style=flat)](https://github.com/insidetrust/statistically-likely-usernames/stargazers) - 🆓 Wordlists for creating statistically likely usernames for use in username-enumeration, simulated password-attacks and other security testing tasks.
...
- [Ballerine](https://github.com/ballerine-io/ballerine) [![GitHub stars](https://img.shields.io/github/stars/ballerine-io/ballerine?style=flat)](https://github.com/ballerine-io/ballerine/stargazers) - 💸 An open-source infrastructure for user identity and risk management.
...
- [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) [![GitHub stars](https://img.shields.io/github/stars/hslatman/awesome-threat-intelligence?style=flat)](https://github.com/hslatman/awesome-threat-intelligence/stargazers) - “A concise definition of Threat Intelligence: evidence-based knowledge, including context, mechanisms, indicators, implications and actionable advice, about an existing or emerging menace or hazard to assets that can be used to inform decisions regarding the subject's response to that menace or hazard.”

- [SpiderFoot](https://github.com/poppopjmp/spiderfoot) [![GitHub stars](https://img.shields.io/github/stars/poppopjmp/spiderfoot?style=flat)](https://github.com/poppopjmp/spiderfoot/stargazers) - 🆓 An open source intelligence (OSINT) automation tool. It integrates with just about every data source available and uses a range of methods for data analysis, making that data easy to navigate.

- [OSINT Stuff Tool Collection](https://github.com/cipher387/osint_stuff_tool_collection) [![GitHub stars](https://img.shields.io/github/stars/cipher387/osint_stuff_tool_collection?style=flat)](https://github.com/cipher387/osint_stuff_tool_collection/stargazers) - “A collection of several hundred online tools for OSINT”: domain, IP, email, username and social-network lookups useful for unmasking fraud and abuse.

- [Maigret](https://github.com/soxoj/maigret) [![GitHub stars](https://img.shields.io/github/stars/soxoj/maigret?style=flat)](https://github.com/soxoj/maigret/stargazers) - 🆓 “Collect a dossier on a person by username from 3000+ sites”, useful for account enumeration and unmasking fraud or abuse.
...
- [The challenges of file formats](https://speakerdeck.com/ange/the-challenges-of-file-formats) - At one point you will let users upload files in your system. Here is a [corpus of suspicious media files](https://github.com/corkami/pocs) [![GitHub stars](https://img.shields.io/github/stars/corkami/pocs?style=flat)](https://github.com/corkami/pocs/stargazers) that can be leveraged by scammers =to bypass security or fool users.

- [SecLists](https://github.com/danielmiessler/SecLists) [![GitHub stars](https://img.shields.io/github/stars/danielmiessler/SecLists?style=flat)](https://github.com/danielmiessler/SecLists/stargazers) - 🆓 Collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.

- [PhishingKitTracker](https://github.com/neonprimetime/PhishingKitTracker) [![GitHub stars](https://img.shields.io/github/stars/neonprimetime/PhishingKitTracker?style=flat)](https://github.com/neonprimetime/PhishingKitTracker/stargazers) - 🆓 CSV database of email addresses used by threat actor in phishing kits.

- [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) [![GitHub stars](https://img.shields.io/github/stars/sundowndev/PhoneInfoga?style=flat)](https://github.com/sundowndev/PhoneInfoga/stargazers) - 🆓 Tools to scan phone numbers using only free resources. The goal is to first gather standard information such as country, area, carrier and line type on any international phone numbers with a very good accuracy. Then search for footprints on search engines to try to find the VoIP provider or identify the owner.
...
- [Awesome Captcha](https://github.com/ZYSzys/awesome-captcha) [![GitHub stars](https://img.shields.io/github/stars/ZYSzys/awesome-captcha?style=flat)](https://github.com/ZYSzys/awesome-captcha/stargazers) - Reference all open-source captcha libraries, integration, alternatives and cracking tools.
...
- [Anubis](https://github.com/TecharoHQ/anubis) [![GitHub stars](https://img.shields.io/github/stars/TecharoHQ/anubis?style=flat)](https://github.com/TecharoHQ/anubis/stargazers) - 🆓 An open-source solution to protect upstream resources from scraper bots.
...
- [`hosts`](https://github.com/StevenBlack/hosts) [![GitHub stars](https://img.shields.io/github/stars/StevenBlack/hosts?style=flat)](https://github.com/StevenBlack/hosts/stargazers) - 🆓 Consolidates reputable hosts files, and merges them into a unified hosts file with duplicates removed.

- [`nextdns/metadata`](https://github.com/nextdns/metadata) [![GitHub stars](https://img.shields.io/github/stars/nextdns/metadata?style=flat)](https://github.com/nextdns/metadata/stargazers) - 💸 Extensive collection of list for security, privacy and parental control.

- [The Public Suffix List](https://github.com/publicsuffix/list) [![GitHub stars](https://img.shields.io/github/stars/publicsuffix/list?style=flat)](https://github.com/publicsuffix/list/stargazers) - 🆓 Mozilla's registry of public suffixes, under which Internet users can (or historically could) directly register names.

- [Country IP Blocks](https://github.com/herrbischoff/country-ip-blocks) [![GitHub stars](https://img.shields.io/github/stars/herrbischoff/country-ip-blocks?style=flat)](https://github.com/herrbischoff/country-ip-blocks/stargazers) - 🆓 CIDR country-level IP data, straight from the Regional Internet Registries, updated hourly.

- Subdomain denylists: [#1](https://gist.github.com/artgon/5366868), [#2](https://github.com/sandeepshetty/subdomain-blacklist/blob/master/subdomain-blacklist.txt) [![GitHub stars](https://img.shields.io/github/stars/sandeepshetty/subdomain-blacklist/blob/master/subdomain-blacklist.txt?style=flat)](https://github.com/sandeepshetty/subdomain-blacklist/blob/master/subdomain-blacklist.txt/stargazers), [#3](https://github.com/nccgroup/typofinder/blob/master/TypoMagic/datasources/subdomains.txt) [![GitHub stars](https://img.shields.io/github/stars/nccgroup/typofinder/blob/master/TypoMagic/datasources/subdomains.txt?style=flat)](https://github.com/nccgroup/typofinder/blob/master/TypoMagic/datasources/subdomains.txt/stargazers).
...
- [`check-if-email-exists`](https://github.com/reacherhq/check-if-email-exists) [![GitHub stars](https://img.shields.io/github/stars/reacherhq/check-if-email-exists?style=flat)](https://github.com/reacherhq/check-if-email-exists/stargazers) - 💸 Verify an email address's reachability over SMTP without sending anything, catching typos, disposable domains and role accounts at signup.
...
- [`gman`](https://github.com/benbalter/gman) [![GitHub stars](https://img.shields.io/github/stars/benbalter/gman?style=flat)](https://github.com/benbalter/gman/stargazers) - 🆓 “A Ruby gem to check if the owner of a given email address or website is working for THE MAN (a.k.a verifies government domains).” Good resource to hunt for potential government customers in your user base.
...
- [List of Dirty, Naughty, Obscene, and Otherwise Bad Words](https://github.com/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words) [![GitHub stars](https://img.shields.io/github/stars/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words?style=flat)](https://github.com/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words/stargazers) - 🆓 Profanity blocklist from Shutterstock.

- [`profanity-check`](https://github.com/vzhou842/profanity-check) [![GitHub stars](https://img.shields.io/github/stars/vzhou842/profanity-check?style=flat)](https://github.com/vzhou842/profanity-check/stargazers) - 🆓 Uses a linear SVM model trained on 200k human-labeled samples of clean and profane text strings.

## Privacy

As the guardian of user's data, the IAM stack is deeply bounded by the respect of privacy.

- [Paper we love: Privacy](https://github.com/papers-we-love/papers-we-love/tree/master/privacy) [![GitHub stars](https://img.shields.io/github/stars/papers-we-love/papers-we-love/tree/master/privacy?style=flat)](https://github.com/papers-we-love/papers-we-love/tree/master/privacy/stargazers) - A collection of scientific studies of schemes providing privacy by design.
...
- [Email marketing regulations around the world](https://github.com/threeheartsdigital/email-marketing-regulations) [![GitHub stars](https://img.shields.io/github/stars/threeheartsdigital/email-marketing-regulations?style=flat)](https://github.com/threeheartsdigital/email-marketing-regulations/stargazers) - 🆓 As the world becomes increasingly connected, the email marketing regulation landscape becomes more and more complex.
...
- [GDPR Developer Guide](https://github.com/LINCnil/GDPR-Developer-Guide) [![GitHub stars](https://img.shields.io/github/stars/LINCnil/GDPR-Developer-Guide?style=flat)](https://github.com/LINCnil/GDPR-Developer-Guide/stargazers) - Best practices for developers.
...
- [Best-of Digital Identity](https://github.com/jruizaranguren/best-of-digital-identity) [![GitHub stars](https://img.shields.io/github/stars/jruizaranguren/best-of-digital-identity?style=flat)](https://github.com/jruizaranguren/best-of-digital-identity/stargazers) - Ranking, popularity and activity status of open-source digital identity projects.
...
The [header image](https://github.com/kdeldycke/awesome-iam/blob/main/assets/awesome-iam-header.jpg) [![GitHub stars](https://img.shields.io/github/stars/kdeldycke/awesome-iam/blob/main/assets/awesome-iam-header.jpg?style=flat)](https://github.com/kdeldycke/awesome-iam/blob/main/assets/awesome-iam-header.jpg/stargazers) is based on a modified [photo](https://web.archive.org/web/20230919012225/https://unsplash.com/photos/2LowviVHZ-E) by [Ben Sweet](https://web.archive.org/web/20260303063416/https://unsplash.com/@benjaminsweet).
