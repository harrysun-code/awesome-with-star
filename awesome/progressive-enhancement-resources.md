...
* [State of Web Type](https://github.com/bramstein/stateofwebtype) [![GitHub stars](https://img.shields.io/github/stars/bramstein/stateofwebtype?style=flat)](https://github.com/bramstein/stateofwebtype/stargazers) - Support tables for type and typographic features on the web.
...
* [MDN Browser Compat Data](https://github.com/mdn/browser-compat-data) [![GitHub stars](https://img.shields.io/github/stars/mdn/browser-compat-data?style=flat)](https://github.com/mdn/browser-compat-data/stargazers) - npm module powering the MDN Compatibility tables.
* [Device Bugs & Quirks](https://github.com/scottjehl/Device-Bugs) [![GitHub stars](https://img.shields.io/github/stars/scottjehl/Device-Bugs?style=flat)](https://github.com/scottjehl/Device-Bugs/stargazers) - Crowd sourced collection of weird HTML, CSS, and JS quirks in mobile devices, which you won't find in the other support tables.
...
* [Configure *Desired Capabilities* in Selenium](https://github.com/SeleniumHQ/selenium/wiki/DesiredCapabilities) [![GitHub stars](https://img.shields.io/github/stars/SeleniumHQ/selenium/wiki/DesiredCapabilities?style=flat)](https://github.com/SeleniumHQ/selenium/wiki/DesiredCapabilities/stargazers) - Run automated browser tests in different scenarios.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/lighthouse?style=flat)](https://github.com/GoogleChrome/lighthouse/stargazers) - Audit and meassure performance of Progressive Web Apps (via cli or [Chrome extension](https://chrome.google.com/webstore/detail/lighthouse/blipmdconlkpinefehnmjammfjpmpbjk)).
...
* [jQuery slider](https://github.com/filamentgroup/jQuery-Slider) [![GitHub stars](https://img.shields.io/github/stars/filamentgroup/jQuery-Slider?style=flat)](https://github.com/filamentgroup/jQuery-Slider/stargazers) - Accessible, custom slider widget based on a standard HTML select.
...
* [React isomorphic form](https://github.com/ghengeveld/react-isomorphic-form/) [![GitHub stars](https://img.shields.io/github/stars/ghengeveld/react-isomorphic-form/?style=flat)](https://github.com/ghengeveld/react-isomorphic-form//stargazers) - Set of React form components which can be pre-rendered & handled server-side. They are enhanced client-side without losing state.
...
* [Lazy Progressive Enhancement](https://github.com/tvler/lazy-progressive-enhancement) [![GitHub stars](https://img.shields.io/github/stars/tvler/lazy-progressive-enhancement?style=flat)](https://github.com/tvler/lazy-progressive-enhancement/stargazers) - Lazy load images inside `<noscript>` tags. (note: Evergreen browsers only)
...
* [SmoothState.js](https://github.com/miguel-perez/smoothState.js) [![GitHub stars](https://img.shields.io/github/stars/miguel-perez/smoothState.js?style=flat)](https://github.com/miguel-perez/smoothState.js/stargazers) - Add page transitions with event hooks, cache and prefetch support. (requires jQuery).
* [jquery-pjax](https://github.com/defunkt/jquery-pjax) [![GitHub stars](https://img.shields.io/github/stars/defunkt/jquery-pjax?style=flat)](https://github.com/defunkt/jquery-pjax/stargazers) - Add page transitions with support for multiple containers / content slots (requires jQuery).
* [MoOx/pjax](https://github.com/MoOx/pjax) [![GitHub stars](https://img.shields.io/github/stars/MoOx/pjax?style=flat)](https://github.com/MoOx/pjax/stargazers) - Similar tot jquery-pjax, but without the jQuery dependency.
* [Turbolinks](https://github.com/turbolinks/turbolinks) [![GitHub stars](https://img.shields.io/github/stars/turbolinks/turbolinks?style=flat)](https://github.com/turbolinks/turbolinks/stargazers) - Add page transitions with event hooks and cache support. Has adapters to bind to native navigation controls on iOS and Android.
