...
- [Web Vitals](https://github.com/GoogleChrome/web-vitals) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/web-vitals?style=flat)](https://github.com/GoogleChrome/web-vitals/stargazers) - Open Source Library to collect Field Data.
...
- [Spec - Layout Instability API - W3C](https://github.com/WICG/layout-instability) [![GitHub stars](https://img.shields.io/github/stars/WICG/layout-instability?style=flat)](https://github.com/WICG/layout-instability/stargazers)
...
- Lab: WPT
- Field: Chrome 77+
- [Docs - Last Painted Hero - WPT](https://github.com/WPO-Foundation/webpagetest/blob/master/docs/Metrics/HeroElements.md) [![GitHub stars](https://img.shields.io/github/stars/WPO-Foundation/webpagetest/blob/master/docs/Metrics/HeroElements.md?style=flat)](https://github.com/WPO-Foundation/webpagetest/blob/master/docs/Metrics/HeroElements.md/stargazers)
...
- [Polyfill - FID](https://github.com/GoogleChromeLabs/first-input-delay) [![GitHub stars](https://img.shields.io/github/stars/GoogleChromeLabs/first-input-delay?style=flat)](https://github.com/GoogleChromeLabs/first-input-delay/stargazers)
...
- [Which third party scripts are most excessive](https://github.com/patrickhulce/third-party-web) [![GitHub stars](https://img.shields.io/github/stars/patrickhulce/third-party-web?style=flat)](https://github.com/patrickhulce/third-party-web/stargazers)
