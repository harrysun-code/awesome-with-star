...
I ([Guillaume Chevalier](https://github.com/guillaume-chevalier) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier?style=flat)](https://github.com/guillaume-chevalier/stargazers)) have built this list and got through all of the content listed here, carefully.
...
- [Neuraxle, a framwework for machine learning pipelines](https://github.com/Neuraxio/Neuraxle) [![GitHub stars](https://img.shields.io/github/stars/Neuraxio/Neuraxle?style=flat)](https://github.com/Neuraxio/Neuraxle/stargazers) - The best framework for structuring and deploying your machine learning projects, and which is also compatible with most framework (e.g.: Scikit-Learn, TensorFlow, PyTorch, Keras, and so forth).
- [TensorFlow's GitHub repository](https://github.com/tensorflow/tensorflow) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/tensorflow?style=flat)](https://github.com/tensorflow/tensorflow/stargazers) - Most known deep learning framework, both high-level and low-level while staying flexible.
- [skflow](https://github.com/tensorflow/skflow) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/skflow?style=flat)](https://github.com/tensorflow/skflow/stargazers) - TensorFlow wrapper à la scikit-learn.
- [Keras](https://keras.io/) - Keras is another intersting deep learning framework like TensorFlow, it is mostly high-level.
- [carpedm20's repositories](https://github.com/carpedm20) [![GitHub stars](https://img.shields.io/github/stars/carpedm20?style=flat)](https://github.com/carpedm20/stargazers) - Many interesting neural network architectures are implemented by the Korean guy Taehoon Kim, A.K.A. carpedm20.
- [carpedm20/NTM-tensorflow](https://github.com/carpedm20/NTM-tensorflow) [![GitHub stars](https://img.shields.io/github/stars/carpedm20/NTM-tensorflow?style=flat)](https://github.com/carpedm20/NTM-tensorflow/stargazers) - Neural Turing Machine TensorFlow implementation.
...
- [LSTM for Human Activity Recognition (HAR)](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier/LSTM-Human-Activity-Recognition?style=flat)](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition/stargazers) - Tutorial of mine on using LSTMs on time series for classification.
- [Deep stacked residual bidirectional LSTMs for HAR](https://github.com/guillaume-chevalier/HAR-stacked-residual-bidir-LSTMs) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier/HAR-stacked-residual-bidir-LSTMs?style=flat)](https://github.com/guillaume-chevalier/HAR-stacked-residual-bidir-LSTMs/stargazers) - Improvements on the previous project.
- [Sequence to Sequence (seq2seq) Recurrent Neural Network (RNN) for Time Series Prediction](https://github.com/guillaume-chevalier/seq2seq-signal-prediction) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier/seq2seq-signal-prediction?style=flat)](https://github.com/guillaume-chevalier/seq2seq-signal-prediction/stargazers) - Tutorial of mine on how to predict temporal sequences of numbers - that may be multichannel.
- [Hyperopt for a Keras CNN on CIFAR-100](https://github.com/guillaume-chevalier/Hyperopt-Keras-CNN-CIFAR-100) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier/Hyperopt-Keras-CNN-CIFAR-100?style=flat)](https://github.com/guillaume-chevalier/Hyperopt-Keras-CNN-CIFAR-100/stargazers) - Auto (meta) optimizing a neural net (and its architecture) on the CIFAR-100 dataset.
- [ML / DL repositories I starred](https://github.com/guillaume-chevalier?direction=desc&page=1&q=machine+OR+deep+OR+learning+OR+rnn+OR+lstm+OR+cnn&sort=stars&tab=stars&utf8=%E2%9C%93) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier?direction=desc&page=1&q=machine+OR+deep+OR+learning+OR+rnn+OR+lstm+OR+cnn&sort=stars&tab=stars&utf8=%E2%9C%93?style=flat)](https://github.com/guillaume-chevalier?direction=desc&page=1&q=machine+OR+deep+OR+learning+OR+rnn+OR+lstm+OR+cnn&sort=stars&tab=stars&utf8=%E2%9C%93/stargazers) - GitHub is full of nice code samples & projects.
- [Smoothly Blend Image Patches](https://github.com/guillaume-chevalier/Smoothly-Blend-Image-Patches) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier/Smoothly-Blend-Image-Patches?style=flat)](https://github.com/guillaume-chevalier/Smoothly-Blend-Image-Patches/stargazers) - Smooth patch merger for [semantic segmentation with a U-Net](https://vooban.com/en/tips-articles-geek-stuff/satellite-image-segmentation-workflow-with-u-net/).
- [Self Governing Neural Networks (SGNN): the Projection Layer](https://github.com/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer?style=flat)](https://github.com/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer/stargazers) - With this, you can use words in your deep learning models without training nor loading embeddings.
- [Neuraxle](https://github.com/Neuraxio/Neuraxle) [![GitHub stars](https://img.shields.io/github/stars/Neuraxio/Neuraxle?style=flat)](https://github.com/Neuraxio/Neuraxle/stargazers) - Neuraxle is a Machine Learning (ML) library for building neat pipelines, providing the right abstractions to both ease research, development, and deployment of your ML applications.
- [Clean Machine Learning, a Coding Kata](https://github.com/Neuraxio/Kata-Clean-Machine-Learning-From-Dirty-Code) [![GitHub stars](https://img.shields.io/github/stars/Neuraxio/Kata-Clean-Machine-Learning-From-Dirty-Code?style=flat)](https://github.com/Neuraxio/Kata-Clean-Machine-Learning-From-Dirty-Code/stargazers) - Learn the good design patterns to use for doing Machine Learning the good way, by practicing.
...
- [Awesome Public Datasets](https://github.com/caesar0301/awesome-public-datasets) [![GitHub stars](https://img.shields.io/github/stars/caesar0301/awesome-public-datasets?style=flat)](https://github.com/caesar0301/awesome-public-datasets/stargazers) - An awesome list of public datasets.
...
- [Filtering signal, plotting the STFT and the Laplace transform](https://github.com/guillaume-chevalier/filtering-stft-and-laplace-transform) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier/filtering-stft-and-laplace-transform?style=flat)](https://github.com/guillaume-chevalier/filtering-stft-and-laplace-transform/stargazers) - Simple Python demo on signal processing.
...
- [Self-Governing Neural Networks for On-Device Short Text Classification](http://aclweb.org/anthology/D18-1105) - This paper is the sequel to the ProjectionNet just above. The SGNN is elaborated on the ProjectionNet, and the optimizations are detailed more in-depth (also see my [attempt to reproduce the paper in code](https://github.com/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer?style=flat)](https://github.com/guillaume-chevalier/SGNN-Self-Governing-Neural-Networks-Projection-Layer/stargazers) and watch [the talks' recording](https://vimeo.com/305197775)).
...
- [Awesome Neuraxle](https://github.com/Neuraxio/Awesome-Neuraxle) [![GitHub stars](https://img.shields.io/github/stars/Neuraxio/Awesome-Neuraxle?style=flat)](https://github.com/Neuraxio/Awesome-Neuraxle/stargazers) - An awesome list for Neuraxle, a ML Framework for coding clean production-level ML pipelines.
...
To the extent possible under law, [Guillaume Chevalier](https://github.com/guillaume-chevalier) [![GitHub stars](https://img.shields.io/github/stars/guillaume-chevalier?style=flat)](https://github.com/guillaume-chevalier/stargazers) has waived all copyright and related or neighboring rights to this work.
