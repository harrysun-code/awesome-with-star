...
- :earth_americas: [Awesome executable packing](https://github.com/packing-box/awesome-executable-packing) [![GitHub stars](https://img.shields.io/github/stars/packing-box/awesome-executable-packing?style=flat)](https://github.com/packing-box/awesome-executable-packing/stargazers)
- :earth_americas: [Awesome LLVM security](https://github.com/gmh5225/awesome-llvm-security) [![GitHub stars](https://img.shields.io/github/stars/gmh5225/awesome-llvm-security?style=flat)](https://github.com/gmh5225/awesome-llvm-security/stargazers)
...
- :earth_americas: [Mach-O file format reference](https://github.com/aidansteele/osx-abi-macho-file-format-reference) [![GitHub stars](https://img.shields.io/github/stars/aidansteele/osx-abi-macho-file-format-reference?style=flat)](https://github.com/aidansteele/osx-abi-macho-file-format-reference/stargazers)
...
- :earth_americas: [OllyDbg OEP finder scripts](https://github.com/dubuqingfeng/ollydbg-script) [![GitHub stars](https://img.shields.io/github/stars/dubuqingfeng/ollydbg-script?style=flat)](https://github.com/dubuqingfeng/ollydbg-script/stargazers)
...
- :pushpin: [Packer detection tool evaluation](https://github.com/FFRI/PackerDetectionToolEvaluation) [![GitHub stars](https://img.shields.io/github/stars/FFRI/PackerDetectionToolEvaluation?style=flat)](https://github.com/FFRI/PackerDetectionToolEvaluation/stargazers)
...
- :pushpin: [Writing a simple PE packer in detail](https://github.com/levanvn/Packer_Simple-1) [![GitHub stars](https://img.shields.io/github/stars/levanvn/Packer_Simple-1?style=flat)](https://github.com/levanvn/Packer_Simple-1/stargazers)
...
- [BODMAS](https://github.com/whyisyoung/BODMAS) [![GitHub stars](https://img.shields.io/github/stars/whyisyoung/BODMAS?style=flat)](https://github.com/whyisyoung/BODMAS/stargazers) - Code for our DLS'21 paper - BODMAS: An Open Dataset for Learning based Temporal Analysis of PE Malware.
...
- [Dataset of Packed ELF](https://github.com/dhondta/dataset-packed-elf) [![GitHub stars](https://img.shields.io/github/stars/dhondta/dataset-packed-elf?style=flat)](https://github.com/dhondta/dataset-packed-elf/stargazers) - Compilation of packed ELF samples.
- [Dataset of Packed PE](https://github.com/dhondta/dataset-packed-pe) [![GitHub stars](https://img.shields.io/github/stars/dhondta/dataset-packed-pe?style=flat)](https://github.com/dhondta/dataset-packed-pe/stargazers) - Sanitized version of the original dataset, PackingData, removing packed samples from the Notpacked folder but also samples in packer folders that failed to be packed (having a same hash as the original unpacked executable).
- [Ember](https://github.com/elastic/ember) [![GitHub stars](https://img.shields.io/github/stars/elastic/ember?style=flat)](https://github.com/elastic/ember/stargazers) - Collection of features from PE files that serve as a benchmark dataset for researchers.
- [Ember2024](https://github.com/futurecomputing4ai/ember2024) [![GitHub stars](https://img.shields.io/github/stars/futurecomputing4ai/ember2024?style=flat)](https://github.com/futurecomputing4ai/ember2024/stargazers) - Update to the EMBER2017 and EMBER2018 datasets.
- [FFRI Dataset Scripts](https://github.com/FFRI/ffridataset-scripts) [![GitHub stars](https://img.shields.io/github/stars/FFRI/ffridataset-scripts?style=flat)](https://github.com/FFRI/ffridataset-scripts/stargazers) - Make datasets like FFRI Dataset.
- [MaleX](https://github.com/Mayachitra-Inc/MaleX) [![GitHub stars](https://img.shields.io/github/stars/Mayachitra-Inc/MaleX?style=flat)](https://github.com/Mayachitra-Inc/MaleX/stargazers) - Curated dataset of malware and benign Windows executable samples for malware researchers containing 1,044,394 Windows executable binaries and corresponding image representations with 864,669 labelled as malware and 179,725 as benign.
...
- [Malware Archive](https://github.com/jstrosch/malware-samples) [![GitHub stars](https://img.shields.io/github/stars/jstrosch/malware-samples?style=flat)](https://github.com/jstrosch/malware-samples/stargazers) - Malware samples, analysis exercises and other interesting resources.
...
- [MalwareSamples](https://github.com/MalwareSamples) [![GitHub stars](https://img.shields.io/github/stars/MalwareSamples?style=flat)](https://github.com/MalwareSamples/stargazers) - Bringing you the best of the worst files on the Internet.
...
- [PackingData](https://github.com/chesvectain/PackingData) [![GitHub stars](https://img.shields.io/github/stars/chesvectain/PackingData?style=flat)](https://github.com/chesvectain/PackingData/stargazers) - Original dataset with sample PE files packed with a large variety of packers, including ASPack, BeRoEXEPacker, exe32pack, eXpressor, FSG, JDPack, MEW, Molebox, MPRESS, Neolite, NSPack, Pckman, PECompact, PEtite, RLPack, UPX, WinUpack, Yoda's Crypter and Yoda's Protector.
- [Packware](https://github.com/ucsb-seclab/packware) [![GitHub stars](https://img.shields.io/github/stars/ucsb-seclab/packware?style=flat)](https://github.com/ucsb-seclab/packware/stargazers) - Datasets and codes that are needed to reproduce the experiments in the paper "When Malware is Packing Heat".
- [RCE Lab](https://github.com/apuromafo/RCE_Lab) [![GitHub stars](https://img.shields.io/github/stars/apuromafo/RCE_Lab?style=flat)](https://github.com/apuromafo/RCE_Lab/stargazers) - Crackme's, keygenme's, serialme's ; the "tuts4you" folder contains many packed binaries.
...
- [SOREL](https://github.com/sophos-ai/SOREL-20M) [![GitHub stars](https://img.shields.io/github/stars/sophos-ai/SOREL-20M?style=flat)](https://github.com/sophos-ai/SOREL-20M/stargazers) - Sophos-ReversingLabs 20 Million dataset.
- [theZoo](https://github.com/ytisf/theZoo) [![GitHub stars](https://img.shields.io/github/stars/ytisf/theZoo?style=flat)](https://github.com/ytisf/theZoo/stargazers) - Project created to make the possibility of malware analysis open and available to the public.
...
- [ASM Guard](https://github.com/DosX-dev/ASM-Guard) [![GitHub stars](https://img.shields.io/github/stars/DosX-dev/ASM-Guard?style=flat)](https://github.com/DosX-dev/ASM-Guard/stargazers) - Packer utility for compressing and complicating reversing compiled native code (native files), protecting resources, adding DRM, and packing into an optimized loader.
...
- [Astral-PE](https://github.com/DosX-dev/Astral-PE) [![GitHub stars](https://img.shields.io/github/stars/DosX-dev/Astral-PE?style=flat)](https://github.com/DosX-dev/Astral-PE/stargazers) - Low-level mutator (Headers/EP obfuscator) for native Windows PE files (x32/x64).
...
- [Backpack](https://github.com/Enelg52/Backpack) [![GitHub stars](https://img.shields.io/github/stars/Enelg52/Backpack?style=flat)](https://github.com/Enelg52/Backpack/stargazers)
- [BangCle](https://github.com/woxihuannisja/Bangcle) [![GitHub stars](https://img.shields.io/github/stars/woxihuannisja/Bangcle?style=flat)](https://github.com/woxihuannisja/Bangcle/stargazers) - Protection tool using the second generation Android Hardening Protection, loading the encrypted DEX file from memory dynamically.
...
- [ConfuserEx](https://github.com/mkaring/ConfuserEx) [![GitHub stars](https://img.shields.io/github/stars/mkaring/ConfuserEx?style=flat)](https://github.com/mkaring/ConfuserEx/stargazers) - An open-source, free protector for .NET applications.
- [Crinkler](https://github.com/runestubbe/Crinkler) [![GitHub stars](https://img.shields.io/github/stars/runestubbe/Crinkler?style=flat)](https://github.com/runestubbe/Crinkler/stargazers) - Compressing linker for Windows, specifically targeted towards executables with a size of just a few kilobytes.
...
- [ELF Packer](https://github.com/telepath9000/elf-packer) [![GitHub stars](https://img.shields.io/github/stars/telepath9000/elf-packer?style=flat)](https://github.com/telepath9000/elf-packer/stargazers) - Encrypts 64-bit elf files that decrypt at runtime.
...
- [ELF-Packer](https://github.com/glen-mac/ELF-Packer) [![GitHub stars](https://img.shields.io/github/stars/glen-mac/ELF-Packer?style=flat)](https://github.com/glen-mac/ELF-Packer/stargazers) - Simple Polymorphic x86_64 Runtime Code Segment Cryptor.
- [ELFCrypt](https://github.com/droberson/ELFcrypt) [![GitHub stars](https://img.shields.io/github/stars/droberson/ELFcrypt?style=flat)](https://github.com/droberson/ELFcrypt/stargazers) - Simple ELF crypter using RC4 encryption.
- [ELFkickers](https://github.com/BR903/ELFkickers) [![GitHub stars](https://img.shields.io/github/stars/BR903/ELFkickers?style=flat)](https://github.com/BR903/ELFkickers/stargazers) - A collection of programs that access and manipulate ELF files.
- [ELFuck](https://github.com/timhsutw/elfuck) [![GitHub stars](https://img.shields.io/github/stars/timhsutw/elfuck?style=flat)](https://github.com/timhsutw/elfuck/stargazers) - ELF packer for i386 original version from sk2 by sd.
...
- [Eronona-Packer](https://github.com/Eronana/packer) [![GitHub stars](https://img.shields.io/github/stars/Eronana/packer?style=flat)](https://github.com/Eronana/packer/stargazers) - This is a packer for exe under win32.
...
- [Ezuri](https://github.com/guitmz/ezuri/blob/master/ezuri.go) [![GitHub stars](https://img.shields.io/github/stars/guitmz/ezuri/blob/master/ezuri.go?style=flat)](https://github.com/guitmz/ezuri/blob/master/ezuri.go/stargazers) - A Simple Linux ELF Runtime Crypter.
- [GzExe](https://git.savannah.gnu.org/cgit/gzip.git) - Utility that allows to compress executables as a shell script.
- [hXOR-Packer](https://github.com/rurararura/hXOR-Packer) [![GitHub stars](https://img.shields.io/github/stars/rurararura/hXOR-Packer?style=flat)](https://github.com/rurararura/hXOR-Packer/stargazers) - PE packer with Huffman compression and XOR encryption.
- [Hyperion](https://github.com/nullsecuritynet/tools/tree/main/binary/hyperion) [![GitHub stars](https://img.shields.io/github/stars/nullsecuritynet/tools/tree/main/binary/hyperion?style=flat)](https://github.com/nullsecuritynet/tools/tree/main/binary/hyperion/stargazers)
...
- [LZPACK](https://github.com/johnsonjh/lzpack) [![GitHub stars](https://img.shields.io/github/stars/johnsonjh/lzpack?style=flat)](https://github.com/johnsonjh/lzpack/stargazers) - LZPACK - PopCom!-compatible CP/M-80 executable compressor in ANSI C, runs on 48K CP/M-80, CP/M-86, MS-DOS, UNIX, and other platforms.
- [m0dern_p4cker](https://github.com/n4sm/m0dern_p4cker) [![GitHub stars](https://img.shields.io/github/stars/n4sm/m0dern_p4cker?style=flat)](https://github.com/n4sm/m0dern_p4cker/stargazers) - Just a modern packer for elf binaries ( works on Linux executables only ).
- [MidgetPack](https://github.com/arisada/midgetpack) [![GitHub stars](https://img.shields.io/github/stars/arisada/midgetpack?style=flat)](https://github.com/arisada/midgetpack/stargazers) - ELF binary packer, such as burneye, upx or other tools.
...
- [NetCrypt](https://github.com/friedkiwi/netcrypt) [![GitHub stars](https://img.shields.io/github/stars/friedkiwi/netcrypt?style=flat)](https://github.com/friedkiwi/netcrypt/stargazers) - A proof-of-concept packer for .NET executables, designed to provide a starting point to explain the basic principles of runtime packing.
...
- [oplzkwp](https://github.com/tweksteen/oplzkwp) [![GitHub stars](https://img.shields.io/github/stars/tweksteen/oplzkwp?style=flat)](https://github.com/tweksteen/oplzkwp/stargazers) - Library for ELF obfuscation ; it uses PRESENT and blake244 to encrypt your payload on the fly.
- [Origami](https://github.com/dr4k0nia/Origami) [![GitHub stars](https://img.shields.io/github/stars/dr4k0nia/Origami?style=flat)](https://github.com/dr4k0nia/Origami/stargazers) - Packer compressing .net assemblies, (ab)using the PE format for data storage.
...
- [Pakkero](https://github.com/89luca89/pakkero) [![GitHub stars](https://img.shields.io/github/stars/89luca89/pakkero?style=flat)](https://github.com/89luca89/pakkero/stargazers) - Binary packer written in Go made for fun and educational purpose.
- [Pakr](https://github.com/iangcarroll/pakr) [![GitHub stars](https://img.shields.io/github/stars/iangcarroll/pakr?style=flat)](https://github.com/iangcarroll/pakr/stargazers) - In-memory packer for macOS Mach-O bundles.
- [Papaw](https://github.com/dimkr/papaw) [![GitHub stars](https://img.shields.io/github/stars/dimkr/papaw?style=flat)](https://github.com/dimkr/papaw/stargazers) - Permissively-licensed packer for ELF executables using LZMA Zstandard or Deflate compression.
- [PE-Packer](https://github.com/czs108/PE-Packer) [![GitHub stars](https://img.shields.io/github/stars/czs108/PE-Packer?style=flat)](https://github.com/czs108/PE-Packer/stargazers) - Simple packer for Windows 32-bits PE files.
- [PE-Toy](https://github.com/r0ngwe1/petoy) [![GitHub stars](https://img.shields.io/github/stars/r0ngwe1/petoy?style=flat)](https://github.com/r0ngwe1/petoy/stargazers) - A PE file packer.
...
- [PePacker](https://github.com/SamLarenN/PePacker) [![GitHub stars](https://img.shields.io/github/stars/SamLarenN/PePacker?style=flat)](https://github.com/SamLarenN/PePacker/stargazers) - Simple PE Packer Which Encrypts .text Section I release a simple PE file packer which encrypts the .text section and adds a decryption stub to the end of the last section.
...
- [PEzor](https://github.com/phra/PEzor) [![GitHub stars](https://img.shields.io/github/stars/phra/PEzor?style=flat)](https://github.com/phra/PEzor/stargazers) - Open-Source Shellcode & PE Packer.
- [pocrypt](https://github.com/picoflamingo/pocrypt) [![GitHub stars](https://img.shields.io/github/stars/picoflamingo/pocrypt?style=flat)](https://github.com/picoflamingo/pocrypt/stargazers) - Naive Proof of Concept Crypter for GNU/Linux ELF64.
- [ProtectMyTooling](https://github.com/mgeeky/ProtectMyTooling) [![GitHub stars](https://img.shields.io/github/stars/mgeeky/ProtectMyTooling?style=flat)](https://github.com/mgeeky/ProtectMyTooling/stargazers) - Multi-Packer wrapper letting us daisy-chain various packers, obfuscators and other Red Team oriented weaponry.
- [ps2-packer](https://github.com/ps2dev/ps2-packer) [![GitHub stars](https://img.shields.io/github/stars/ps2dev/ps2-packer?style=flat)](https://github.com/ps2dev/ps2-packer/stargazers) - Create packed ELF files to run on the PS2.
...
- [sherlocked](https://github.com/elfmaster/sherlocked) [![GitHub stars](https://img.shields.io/github/stars/elfmaster/sherlocked?style=flat)](https://github.com/elfmaster/sherlocked/stargazers)
- [Silent-Packer](https://github.com/SilentVoid13/Silent_Packer) [![GitHub stars](https://img.shields.io/github/stars/SilentVoid13/Silent_Packer?style=flat)](https://github.com/SilentVoid13/Silent_Packer/stargazers) - Silent Packer is an ELF / PE packer written in pure C.
- [Simple-PE32-Packer](https://github.com/z3r0d4y5/Simple-PE32-Packer) [![GitHub stars](https://img.shields.io/github/stars/z3r0d4y5/Simple-PE32-Packer?style=flat)](https://github.com/z3r0d4y5/Simple-PE32-Packer/stargazers) - Simple PE32 Packer with aPLib compression library.
- [SimpleDPack](https://github.com/YuriSizuku/SimpleDpack) [![GitHub stars](https://img.shields.io/github/stars/YuriSizuku/SimpleDpack?style=flat)](https://github.com/YuriSizuku/SimpleDpack/stargazers) - A very simple windows EXE packing tool for learning or investigating PE structure.
...
- [theArk](https://github.com/aaaddress1/theArk) [![GitHub stars](https://img.shields.io/github/stars/aaaddress1/theArk?style=flat)](https://github.com/aaaddress1/theArk/stargazers) - Windows x86 PE Packer In C++.
...
- [TinyLoad](https://github.com/iamsopotatoe-coder/TinyLoad) [![GitHub stars](https://img.shields.io/github/stars/iamsopotatoe-coder/TinyLoad?style=flat)](https://github.com/iamsopotatoe-coder/TinyLoad/stargazers) - Simple PE packer for Windows that compresses and encrypts executables with a custom virtual machine into a self-extracting stub.
...
- [Ward](https://github.com/ex0dus-0x/ward) [![GitHub stars](https://img.shields.io/github/stars/ex0dus-0x/ward?style=flat)](https://github.com/ex0dus-0x/ward/stargazers) - Simple implementation of an ELF packer that creates stealthy droppers for loading malicious ELFs in-memory.
- [Woody Wood Packer](https://github.com/Jibus22/woody_woodpacker) [![GitHub stars](https://img.shields.io/github/stars/Jibus22/woody_woodpacker?style=flat)](https://github.com/Jibus22/woody_woodpacker/stargazers) - ELF packer - encrypt and inject self-decryption code into executable ELF binary target.
- [xorPacker](https://github.com/nqntmqmqmb/xorPacker) [![GitHub stars](https://img.shields.io/github/stars/nqntmqmqmb/xorPacker?style=flat)](https://github.com/nqntmqmqmb/xorPacker/stargazers) - Simple packer working with all PE files which cipher your exe with a XOR implementation.
- [XyrisPack](https://github.com/01Xyris/XyrisPack) [![GitHub stars](https://img.shields.io/github/stars/01Xyris/XyrisPack?style=flat)](https://github.com/01Xyris/XyrisPack/stargazers)
- [zELF](https://github.com/seb3773/zelf) [![GitHub stars](https://img.shields.io/github/stars/seb3773/zelf?style=flat)](https://github.com/seb3773/zelf/stargazers) - A modular ELF64 packer for Linux x86_64 featuring 22 compression codecs, ML-based codec selection, and support for both static and PIE binaries.
...
- [Morphine](https://github.com/bowlofstew/rootkit.com/blob/master/hf/Morphine27) [![GitHub stars](https://img.shields.io/github/stars/bowlofstew/rootkit.com/blob/master/hf/Morphine27?style=flat)](https://github.com/bowlofstew/rootkit.com/blob/master/hf/Morphine27/stargazers) - Application for PE files encryption.
...
- [Android Unpacker](https://github.com/strazzere/android-unpacker) [![GitHub stars](https://img.shields.io/github/stars/strazzere/android-unpacker?style=flat)](https://github.com/strazzere/android-unpacker/stargazers) - Presented at Defcon 22: Android Hacker Protection Level 0.
...
- [APKiD](https://github.com/rednaga/APKiD) [![GitHub stars](https://img.shields.io/github/stars/rednaga/APKiD?style=flat)](https://github.com/rednaga/APKiD/stargazers) - Android application Identifier for packers, protectors, obfuscators and oddities - PEiD for Android.
- [aPLib](https://ibsensoftware.com/products_aPLib.html) - Compression library based on the algorithm used in aPACK.
- [AppSpear](https://github.com/UchihaL/AppSpear) [![GitHub stars](https://img.shields.io/github/stars/UchihaL/AppSpear?style=flat)](https://github.com/UchihaL/AppSpear/stargazers) - Universal and automated unpacking system suitable for both Dalvik and ART.
...
- [AVClass](https://github.com/malicialab/avclass) [![GitHub stars](https://img.shields.io/github/stars/malicialab/avclass?style=flat)](https://github.com/malicialab/avclass/stargazers) - Python tools to tag / label malware samples.
- [Bintropy](https://github.com/dhondta/bintropy) [![GitHub stars](https://img.shields.io/github/stars/dhondta/bintropy?style=flat)](https://github.com/dhondta/bintropy/stargazers) - Prototype analysis tool that estimates the likelihood that a binary file contains compressed or encrypted bytes.
...
- [Capa](https://github.com/mandiant/capa) [![GitHub stars](https://img.shields.io/github/stars/mandiant/capa?style=flat)](https://github.com/mandiant/capa/stargazers) - Open-source tool to identify capabilities in PE, ELF or .NET executable files.
- [Capstone](https://www.capstone-engine.org) - Lightweight multi-platform, multi-architecture disassembly framework.
- [Cave-Finder](https://github.com/adamhlt/Cave-Finder) [![GitHub stars](https://img.shields.io/github/stars/adamhlt/Cave-Finder?style=flat)](https://github.com/adamhlt/Cave-Finder/stargazers) - Tool to find code cave in PE image (x86 / x64) - Find empty space to place code in PE files.
...
- [de4js](https://github.com/lelinhtinh/de4js) [![GitHub stars](https://img.shields.io/github/stars/lelinhtinh/de4js?style=flat)](https://github.com/lelinhtinh/de4js/stargazers) - JavaScript Deobfuscator and Unpacker.
...
- [EXEInfo-PE](https://github.com/ExeinfoASL/ASL) [![GitHub stars](https://img.shields.io/github/stars/ExeinfoASL/ASL?style=flat)](https://github.com/ExeinfoASL/ASL/stargazers) - Fast detector for executable PE files.
...
- [FUU](https://github.com/crackinglandia/fuu) [![GitHub stars](https://img.shields.io/github/stars/crackinglandia/fuu?style=flat)](https://github.com/crackinglandia/fuu/stargazers) - Fast Universal Unpacker.
...
- [Gym-Malware](https://github.com/endgameinc/gym-malware) [![GitHub stars](https://img.shields.io/github/stars/endgameinc/gym-malware?style=flat)](https://github.com/endgameinc/gym-malware/stargazers) - This is a malware manipulation environment for OpenAI's gym.
- [IDR](https://github.com/crypto2011/IDR) [![GitHub stars](https://img.shields.io/github/stars/crypto2011/IDR?style=flat)](https://github.com/crypto2011/IDR/stargazers) - Interactive Delphi Reconstructor.
...
- [LIEF](https://github.com/lief-project/LIEF) [![GitHub stars](https://img.shields.io/github/stars/lief-project/LIEF?style=flat)](https://github.com/lief-project/LIEF/stargazers) - Library to Instrument Executable Formats ; Python package for parsing PE, ELF, Mach-O and DEX formats, modifying and rebuilding executables.
...
- [Malheur](https://github.com/rieck/malheur) [![GitHub stars](https://img.shields.io/github/stars/rieck/malheur?style=flat)](https://github.com/rieck/malheur/stargazers) - Tool for the automatic analysis of malware behavior (recorded from malicious software in a sandbox environment).
- [MalUnpack](https://github.com/hasherezade/mal_unpack) [![GitHub stars](https://img.shields.io/github/stars/hasherezade/mal_unpack?style=flat)](https://github.com/hasherezade/mal_unpack/stargazers) - Dynamic unpacker based on PE-sieve.
- [Manalyze](https://github.com/JusticeRage/Manalyze) [![GitHub stars](https://img.shields.io/github/stars/JusticeRage/Manalyze?style=flat)](https://github.com/JusticeRage/Manalyze/stargazers) - Robust parser for PE files with a flexible plugin architecture which allows users to statically analyze files in-depth.
...
- [.NET Deobfuscator](https://github.com/NotPrab/.NET-Deobfuscator) [![GitHub stars](https://img.shields.io/github/stars/NotPrab/.NET-Deobfuscator?style=flat)](https://github.com/NotPrab/.NET-Deobfuscator/stargazers) - List of .NET Deobfuscators and Unpackers.
- [NotPacked++](https://github.com/packing-box/packer-masking-tool) [![GitHub stars](https://img.shields.io/github/stars/packing-box/packer-masking-tool?style=flat)](https://github.com/packing-box/packer-masking-tool/stargazers) - Attack tool for altering packed samples so that they evade static packing detection.
- [Oedipus](https://github.com/tum-i4/Oedipus) [![GitHub stars](https://img.shields.io/github/stars/tum-i4/Oedipus?style=flat)](https://github.com/tum-i4/Oedipus/stargazers) - A Python framework that uses machine learning algorithms to implement the metadata recovery attack against obfuscated programs.
- [OEPdet](https://ieeexplore.ieee.org/abstract/document/7782073) - Automated original-entry-point detector.
- [OllyDbg Scripts](https://github.com/xshows/ollydbg-script) [![GitHub stars](https://img.shields.io/github/stars/xshows/ollydbg-script?style=flat)](https://github.com/xshows/ollydbg-script/stargazers) - Collection of OllyDbg scripts for unpacking many different packers.
...
- [PackerAttacker](https://github.com/BromiumLabs/PackerAttacker) [![GitHub stars](https://img.shields.io/github/stars/BromiumLabs/PackerAttacker?style=flat)](https://github.com/BromiumLabs/PackerAttacker/stargazers) - Tool that uses memory and code hooks to detect packers.
...
- [PackerGrind](https://github.com/rewhy/adaptiveunpacker) [![GitHub stars](https://img.shields.io/github/stars/rewhy/adaptiveunpacker?style=flat)](https://github.com/rewhy/adaptiveunpacker/stargazers) - Adaptive unpacking tool for tracking packing bahaviors and unpacking Android packed apps.
- [PackerID](https://github.com/sooshie/packerid) [![GitHub stars](https://img.shields.io/github/stars/sooshie/packerid?style=flat)](https://github.com/sooshie/packerid/stargazers) - Fork of packerid.py using PEid signatures and featuring additional output types, formats, digital signature extraction, and disassembly support.
- [PackID](https://github.com/mesaleh/PackiD) [![GitHub stars](https://img.shields.io/github/stars/mesaleh/PackiD?style=flat)](https://github.com/mesaleh/PackiD/stargazers) - Packer identification multiplatform tool/library using the same database syntax as PEiD.
- [Packing-Box](https://github.com/dhondta/docker-packing-box) [![GitHub stars](https://img.shields.io/github/stars/dhondta/docker-packing-box?style=flat)](https://github.com/dhondta/docker-packing-box/stargazers) - Docker image gathering many packing-related tools and for making datasets of packed executables for use with machine learning.
- [PANDA](https://github.com/panda-re/panda) [![GitHub stars](https://img.shields.io/github/stars/panda-re/panda?style=flat)](https://github.com/panda-re/panda/stargazers) - Platform for Architecture-Neutral Dynamic Analysis.
- [PANDI](https://github.com/dimitriwauters/PANDI) [![GitHub stars](https://img.shields.io/github/stars/dimitriwauters/PANDI?style=flat)](https://github.com/dimitriwauters/PANDI/stargazers) - Dynamic packing detection solution built on top of PANDA.
...
- [PE-bear](https://github.com/hasherezade/pe-bear-releases) [![GitHub stars](https://img.shields.io/github/stars/hasherezade/pe-bear-releases?style=flat)](https://github.com/hasherezade/pe-bear-releases/stargazers) - Freeware reversing tool for PE files aimed to deliver fast and flexible “first view” for malware analysts, stable and capable to handle malformed PE files.
- [PEdump](https://pedump.me/) - Dump windows PE files using Ruby.
- [Pefeats](https://github.com/roussieau/masterthesis/tree/master/src/detector/tools/pefeats) [![GitHub stars](https://img.shields.io/github/stars/roussieau/masterthesis/tree/master/src/detector/tools/pefeats?style=flat)](https://github.com/roussieau/masterthesis/tree/master/src/detector/tools/pefeats/stargazers) - Utility for extracting 119 features from a PE file for use with machine learning algorithms.
- [Pefile](https://github.com/erocarrera/pefile) [![GitHub stars](https://img.shields.io/github/stars/erocarrera/pefile?style=flat)](https://github.com/erocarrera/pefile/stargazers) - Multi-platform Python module to parse and work with Portable Executable files.
- [PEFrame](https://github.com/guelfoweb/peframe) [![GitHub stars](https://img.shields.io/github/stars/guelfoweb/peframe?style=flat)](https://github.com/guelfoweb/peframe/stargazers) - Tool for performing static analysis on PE malware and generic suspicious files.
- [PEiD](https://web.archive.org/web/20070529035022/https://www.secretashell.com/codomain/peid/) - Packed Executable iDentifier.
- [PEiD (CLI)](https://github.com/dhondta/peid) [![GitHub stars](https://img.shields.io/github/stars/dhondta/peid?style=flat)](https://github.com/dhondta/peid/stargazers) - Python implementation of PEiD featuring an additional tool for making new signatures.
- [PEiD (yara)](https://github.com/K-atc/PEiD) [![GitHub stars](https://img.shields.io/github/stars/K-atc/PEiD?style=flat)](https://github.com/K-atc/PEiD/stargazers) - Yet another implementation of PEiD with yara.
- [PeLib](https://github.com/avast/pelib) [![GitHub stars](https://img.shields.io/github/stars/avast/pelib?style=flat)](https://github.com/avast/pelib/stargazers) - PE file manipulation library.
- [PEPack](https://github.com/mentebinaria/readpe) [![GitHub stars](https://img.shields.io/github/stars/mentebinaria/readpe?style=flat)](https://github.com/mentebinaria/readpe/stargazers) - PE file packer detection tool, part of the Unix package "pev".
- [PEscan](https://tzworks.com/prototype_page.php?proto_id=15) - CLI tool to scan PE files to identify how they were constructed.
- [PETools](https://github.com/petoolse/petools) [![GitHub stars](https://img.shields.io/github/stars/petoolse/petools?style=flat)](https://github.com/petoolse/petools/stargazers) - Old-school reverse engineering tool (with a long history since 2002) for manipulating PE files.
...
- [PINdemonium](https://github.com/Phat3/PINdemonium) [![GitHub stars](https://img.shields.io/github/stars/Phat3/PINdemonium?style=flat)](https://github.com/Phat3/PINdemonium/stargazers) - Unpacker for PE files exploiting the capabilities of PIN.
- [PolyUnpack](https://github.com/PlatonovIvan/PolyUnpack) [![GitHub stars](https://img.shields.io/github/stars/PlatonovIvan/PolyUnpack?style=flat)](https://github.com/PlatonovIvan/PolyUnpack/stargazers) - Implemention attempt of the general approach for extracting the original hidden code of PE files without any heuristic assumptions.
- [PortEx](https://github.com/katjahahn/PortEx) [![GitHub stars](https://img.shields.io/github/stars/katjahahn/PortEx?style=flat)](https://github.com/katjahahn/PortEx/stargazers) - Java library for static malware analysis of PE files with a focus on PE malformation robustness and anomaly detection.
...
- [PyPackerDetect](https://github.com/cylance/PyPackerDetect) [![GitHub stars](https://img.shields.io/github/stars/cylance/PyPackerDetect?style=flat)](https://github.com/cylance/PyPackerDetect/stargazers) - Small Python script/library to detect whether an executable is packed.
- [PyPackerDetect (refactored)](https://github.com/dhondta/PyPackerDetect) [![GitHub stars](https://img.shields.io/github/stars/dhondta/PyPackerDetect?style=flat)](https://github.com/dhondta/PyPackerDetect/stargazers) - A complete refactoring of the original project to a Python package with a console script to detect whether an executable is packed.
- [PyPeid](https://github.com/FFRI/pypeid) [![GitHub stars](https://img.shields.io/github/stars/FFRI/pypeid?style=flat)](https://github.com/FFRI/pypeid/stargazers) - Yet another implementation of PEiD with yara-python.
...
- [Reko](https://github.com/uxmal/reko) [![GitHub stars](https://img.shields.io/github/stars/uxmal/reko?style=flat)](https://github.com/uxmal/reko/stargazers) - Free decompiler for machine code binaries.
- [REMINDer](https://github.com/packing-box/reminder) [![GitHub stars](https://img.shields.io/github/stars/packing-box/reminder?style=flat)](https://github.com/packing-box/reminder/stargazers) - Packing detection tool based on the entropy value of the entry point section and the WRITE attribute.
...
- [RetDec](https://github.com/avast/retdec) [![GitHub stars](https://img.shields.io/github/stars/avast/retdec?style=flat)](https://github.com/avast/retdec/stargazers) - Retargetable machine-code decompiler based on LLVM.
...
- [SecML Malware](https://github.com/pralab/secml_malware) [![GitHub stars](https://img.shields.io/github/stars/pralab/secml_malware?style=flat)](https://github.com/pralab/secml_malware/stargazers) - Create adversarial attacks against machine learning Windows malware detectors.
- [ShowStopper](https://github.com/CheckPointSW/showstopper) [![GitHub stars](https://img.shields.io/github/stars/CheckPointSW/showstopper?style=flat)](https://github.com/CheckPointSW/showstopper/stargazers) - Tool to help malware researchers explore and test anti-debug techniques or verify debugger plugins or other solutions that clash with standard anti-debug methods.
...
- [Triton](https://github.com/jonathansalwan/Triton) [![GitHub stars](https://img.shields.io/github/stars/jonathansalwan/Triton?style=flat)](https://github.com/jonathansalwan/Triton/stargazers) - Dynamic binary analysis library.
...
- [Unipacker](https://github.com/unipacker/unipacker) [![GitHub stars](https://img.shields.io/github/stars/unipacker/unipacker?style=flat)](https://github.com/unipacker/unipacker/stargazers) - Automatic and platform-independent unpacker for Windows binaries based on emulation.
...
- [VMHunt](https://github.com/s3team/VMHunt) [![GitHub stars](https://img.shields.io/github/stars/s3team/VMHunt?style=flat)](https://github.com/s3team/VMHunt/stargazers) - Set of tools for analyzing virtualized binary code ; now only supports 32 bit traces.
...
- [Winbindex](https://github.com/m417z/winbindex) [![GitHub stars](https://img.shields.io/github/stars/m417z/winbindex?style=flat)](https://github.com/m417z/winbindex/stargazers) - An index of Windows binaries, including download links for executables such as EXE, DLL and SYS files.
- [yarGen](https://github.com/Neo23x0/yarGen) [![GitHub stars](https://img.shields.io/github/stars/Neo23x0/yarGen?style=flat)](https://github.com/Neo23x0/yarGen/stargazers) - Generator for YARA rules - The main principle is the creation of yara rules from strings found in malware files while removing all strings that also appear in goodware files.
