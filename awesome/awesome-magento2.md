...
[![GitHub stars](https://img.shields.io/github/stars/DavidLambauer/awesome-magento2?style=flat)](https://github.com/DavidLambauer/awesome-magento2/stargazers)
...
[![Enrich](https://github.com/run-as-root/awesome-magento2/actions/workflows/enrich.yml/badge.svg) [![GitHub stars](https://img.shields.io/github/stars/run-as-root/awesome-magento2/actions/workflows/enrich.yml/badge.svg?style=flat)](https://github.com/run-as-root/awesome-magento2/actions/workflows/enrich.yml/badge.svg/stargazers)](https://github.com/run-as-root/awesome-magento2/actions/workflows/enrich.yml)
[![Discover](https://github.com/run-as-root/awesome-magento2/actions/workflows/discover.yml/badge.svg) [![GitHub stars](https://img.shields.io/github/stars/run-as-root/awesome-magento2/actions/workflows/discover.yml/badge.svg?style=flat)](https://github.com/run-as-root/awesome-magento2/actions/workflows/discover.yml/badge.svg/stargazers)](https://github.com/run-as-root/awesome-magento2/actions/workflows/discover.yml)
...
- [DDEV](https://github.com/ddev/ddev) [![GitHub stars](https://img.shields.io/github/stars/ddev/ddev?style=flat)](https://github.com/ddev/ddev/stargazers) 🔥 🫡 - Open source tool for launching local web development environments in minutes. Supports PHP, Node.js and Python.
- [markshust/docker-magento](https://github.com/markshust/docker-magento) [![GitHub stars](https://img.shields.io/github/stars/markshust/docker-magento?style=flat)](https://github.com/markshust/docker-magento/stargazers) 🫡 - Mark Shust's Docker configuration for Magento.
- [n98-magerun2](https://github.com/netz98/n98-magerun2) [![GitHub stars](https://img.shields.io/github/stars/netz98/n98-magerun2?style=flat)](https://github.com/netz98/n98-magerun2/stargazers) 🫡 - The CLI Swiss Army Knife for Magento 2.
- [Warden](https://github.com/wardenenv/warden) [![GitHub stars](https://img.shields.io/github/stars/wardenenv/warden?style=flat)](https://github.com/wardenenv/warden/stargazers) 🫡 - CLI utility for working with docker-compose environments by David Alger.
- [PhpStorm Magento2 Extension](https://github.com/magento/magento2-phpstorm-plugin) [![GitHub stars](https://img.shields.io/github/stars/magento/magento2-phpstorm-plugin?style=flat)](https://github.com/magento/magento2-phpstorm-plugin/stargazers) 🫡 - Official PhpStorm Magento 2 extension.
- [Magento 2 Url Data Integrity Checker](https://github.com/baldwin-agency/magento2-module-url-data-integrity-checker) [![GitHub stars](https://img.shields.io/github/stars/baldwin-agency/magento2-module-url-data-integrity-checker?style=flat)](https://github.com/baldwin-agency/magento2-module-url-data-integrity-checker/stargazers) 🫡 - Magento 2 module that finds potential URL-related problems in your catalog data.
- [Mage](https://github.com/GrimLink/mage) [![GitHub stars](https://img.shields.io/github/stars/GrimLink/mage?style=flat)](https://github.com/GrimLink/mage/stargazers) 🫡 - Simplifies bin/magento commands with shortcuts and productivity helpers.
- [MageForge](https://github.com/OpenForgeProject/mageforge) [![GitHub stars](https://img.shields.io/github/stars/OpenForgeProject/mageforge?style=flat)](https://github.com/OpenForgeProject/mageforge/stargazers) 🫡 - Magento 2 CLI automatic theme builder (Hyvä ready).
- [Mage Chrome Toolbar](https://github.com/magespecialist/mage-chrome-toolbar) [![GitHub stars](https://img.shields.io/github/stars/magespecialist/mage-chrome-toolbar?style=flat)](https://github.com/magespecialist/mage-chrome-toolbar/stargazers) - Chrome extension for Magento 2 development by MageSpecialist.
- [AmpersandHQ/ampersand-magento2-upgrade-patch-helper](https://github.com/AmpersandHQ/ampersand-magento2-upgrade-patch-helper) [![GitHub stars](https://img.shields.io/github/stars/AmpersandHQ/ampersand-magento2-upgrade-patch-helper?style=flat)](https://github.com/AmpersandHQ/ampersand-magento2-upgrade-patch-helper/stargazers) - Helper script to aid upgrading Magento 2 websites by detecting overrides.
- [MageSpecialist DevTools for Magento 2](https://github.com/magespecialist/m2-MSP_DevTools) [![GitHub stars](https://img.shields.io/github/stars/magespecialist/m2-MSP_DevTools?style=flat)](https://github.com/magespecialist/m2-MSP_DevTools/stargazers) - Developer toolbar for Magento 2.
- [Tango](https://github.com/roma-glushko/tango) [![GitHub stars](https://img.shields.io/github/stars/roma-glushko/tango?style=flat)](https://github.com/roma-glushko/tango/stargazers) - CLI for analyzing access logs.
- [Migrate DB Magento 2 Commerce to Magento 2 Open-Source](https://github.com/opengento/magento2-downgrade-ee-ce) [![GitHub stars](https://img.shields.io/github/stars/opengento/magento2-downgrade-ee-ce?style=flat)](https://github.com/opengento/magento2-downgrade-ee-ce/stargazers) - Migrate a Magento 2 Commerce database to Magento 2 Open Source.
- [Magento 2 Database Synchronizer](https://github.com/jellesiderius/mage-db-sync) [![GitHub stars](https://img.shields.io/github/stars/jellesiderius/mage-db-sync?style=flat)](https://github.com/jellesiderius/mage-db-sync/stargazers) - Database synchronizer for Magento 2 (and WordPress), based on Magerun2. Keeps development, staging and production in sync.
- [RabbitMQ Retry Mechanism](https://github.com/run-as-root/magento2-message-queue-retry) [![GitHub stars](https://img.shields.io/github/stars/run-as-root/magento2-message-queue-retry?style=flat)](https://github.com/run-as-root/magento2-message-queue-retry/stargazers) - Magento 2 extension that brings possibility to retry RabbitMQ failed messages.
- [Mage Wizard](https://github.com/clickAndMortar/mage-wizard) [![GitHub stars](https://img.shields.io/github/stars/clickAndMortar/mage-wizard?style=flat)](https://github.com/clickAndMortar/mage-wizard/stargazers) - Local web UI to view and create modules, plugins, configs, observers, commands, crontabs directly in a Magento 2 codebase.
- [magento2docker](https://github.com/aliuosio/magento2docker) [![GitHub stars](https://img.shields.io/github/stars/aliuosio/magento2docker?style=flat)](https://github.com/aliuosio/magento2docker/stargazers) - MariaDB, PHP, Redis, ElasticSearch in one Dockerfile for fast demo/development environments.
...
- [Pestle](https://github.com/astorm/pestle) [![GitHub stars](https://img.shields.io/github/stars/astorm/pestle?style=flat)](https://github.com/astorm/pestle/stargazers) - Code generation tool by Alan Storm.
- [Masquerade](https://github.com/elgentos/masquerade) [![GitHub stars](https://img.shields.io/github/stars/elgentos/masquerade?style=flat)](https://github.com/elgentos/masquerade/stargazers) - Faker-driven, configuration-based, platform-agnostic, locale-compatible data faker tool.
- [Subodha Magento2 Gulp Integration](https://github.com/subodha/magento-2-gulp) [![GitHub stars](https://img.shields.io/github/stars/subodha/magento-2-gulp?style=flat)](https://github.com/subodha/magento-2-gulp/stargazers) - Magento 2 Gulp integration.
- [Documentation Search for Alfred](https://github.com/DavidLambauer/Alfred-Workflow-Magento-2-DevDocs-Search) [![GitHub stars](https://img.shields.io/github/stars/DavidLambauer/Alfred-Workflow-Magento-2-DevDocs-Search?style=flat)](https://github.com/DavidLambauer/Alfred-Workflow-Magento-2-DevDocs-Search/stargazers) - Alfred workflow integrating the official Magento 2 documentation search.
...
- [Yireo LokiComponents](https://github.com/yireo/Yireo_LokiComponents) [![GitHub stars](https://img.shields.io/github/stars/yireo/Yireo_LokiComponents?style=flat)](https://github.com/yireo/Yireo_LokiComponents/stargazers) 🫡 - A library for building AJAX-driven form components with ease. Used by the Yireo Loki Checkout.
- [Developer Toolbar](https://github.com/mgtcommerce/Mgt_Developertoolbar) [![GitHub stars](https://img.shields.io/github/stars/mgtcommerce/Mgt_Developertoolbar?style=flat)](https://github.com/mgtcommerce/Mgt_Developertoolbar/stargazers) - Magento 2 Developer Toolbar.
- [Advanced Template Hints](https://github.com/ho-nl/magento2-Ho_Templatehints) [![GitHub stars](https://img.shields.io/github/stars/ho-nl/magento2-Ho_Templatehints?style=flat)](https://github.com/ho-nl/magento2-Ho_Templatehints/stargazers) - Magento 2 Template Hints Helper.
- [MageVulnDB](https://github.com/gwillem/magevulndb) [![GitHub stars](https://img.shields.io/github/stars/gwillem/magevulndb?style=flat)](https://github.com/gwillem/magevulndb/stargazers) - Central repository for third-party Magento extensions with known security issues.
...
- [Magento 2 PHPStorm File Templates](https://github.com/lfolco/phpstorm-m2-filetemplates) [![GitHub stars](https://img.shields.io/github/stars/lfolco/phpstorm-m2-filetemplates?style=flat)](https://github.com/lfolco/phpstorm-m2-filetemplates/stargazers) - PHPStorm Magento 2 File Templates.
...
- [Magento 2 Deployer Plus](https://github.com/jalogut/magento2-deployer-plus) [![GitHub stars](https://img.shields.io/github/stars/jalogut/magento2-deployer-plus?style=flat)](https://github.com/jalogut/magento2-deployer-plus/stargazers) - Tool based on deployer.org to perform zero-downtime deployments of Magento 2 projects.

</details>

### Localization

- [de_DE](https://github.com/splendidinternet/Magento2_German_LocalePack_de_DE) [![GitHub stars](https://img.shields.io/github/stars/splendidinternet/Magento2_German_LocalePack_de_DE?style=flat)](https://github.com/splendidinternet/Magento2_German_LocalePack_de_DE/stargazers) 🔥 - German Language Package.
- [pl_PL](https://github.com/SnowdogApps/magento2-pl_pl) [![GitHub stars](https://img.shields.io/github/stars/SnowdogApps/magento2-pl_pl?style=flat)](https://github.com/SnowdogApps/magento2-pl_pl/stargazers) - Polish Language Package.
- [it_IT](https://github.com/mageplaza/magento-2-italian-language-pack) [![GitHub stars](https://img.shields.io/github/stars/mageplaza/magento-2-italian-language-pack?style=flat)](https://github.com/mageplaza/magento-2-italian-language-pack/stargazers) - Italian Language Package.
- [nl_NL](https://github.com/magento-l10n/language-nl_NL) [![GitHub stars](https://img.shields.io/github/stars/magento-l10n/language-nl_NL?style=flat)](https://github.com/magento-l10n/language-nl_NL/stargazers) - Dutch Language Package.
- [da_DK](https://magentodanmark.dk/) - Danish Language Package.
- [fi_FL](https://github.com/mageplaza/magento-2-finnish-language-pack) [![GitHub stars](https://img.shields.io/github/stars/mageplaza/magento-2-finnish-language-pack?style=flat)](https://github.com/mageplaza/magento-2-finnish-language-pack/stargazers) - Finnish Language Package.
- [hr_HR](https://marketplace.magento.com/inchoo-language-hr-hr.html) - Croatian Language Package.

<details>
<summary>🪦 Graveyard — projects no longer recommended</summary>

- [pt_BR](https://github.com/rafaelstz/traducao_magento2_pt_br) [![GitHub stars](https://img.shields.io/github/stars/rafaelstz/traducao_magento2_pt_br?style=flat)](https://github.com/rafaelstz/traducao_magento2_pt_br/stargazers) - Portuguese Brazil Language Package.
- [fr_FR](https://github.com/Imaginaerum/magento2-language-fr-fr) [![GitHub stars](https://img.shields.io/github/stars/Imaginaerum/magento2-language-fr-fr?style=flat)](https://github.com/Imaginaerum/magento2-language-fr-fr/stargazers) - French Language Package.
- [tr_TR](https://github.com/hidonet/magento2-language-tr_tr) [![GitHub stars](https://img.shields.io/github/stars/hidonet/magento2-language-tr_tr?style=flat)](https://github.com/hidonet/magento2-language-tr_tr/stargazers) - Turkish Language Package.
- [es_ES](https://github.com/eusonlito/magento2-language-es_es) [![GitHub stars](https://img.shields.io/github/stars/eusonlito/magento2-language-es_es?style=flat)](https://github.com/eusonlito/magento2-language-es_es/stargazers) - Spanish Language Package.
- [sl_SI](https://github.com/symfony-si/magento2-sl-si) [![GitHub stars](https://img.shields.io/github/stars/symfony-si/magento2-sl-si?style=flat)](https://github.com/symfony-si/magento2-sl-si/stargazers) - Slovenian Language Package.
- [ro_RO](https://github.com/EaDesgin/magento2-romanian-language-pack) [![GitHub stars](https://img.shields.io/github/stars/EaDesgin/magento2-romanian-language-pack?style=flat)](https://github.com/EaDesgin/magento2-romanian-language-pack/stargazers) - Romanian Language Package.
- [de_CH](https://github.com/staempfli/magento2-language-de-ch) [![GitHub stars](https://img.shields.io/github/stars/staempfli/magento2-language-de-ch?style=flat)](https://github.com/staempfli/magento2-language-de-ch/stargazers) - Swiss Language Package.
- [ko_KR](https://github.com/mageplaza/magento-2-korean-language-pack) [![GitHub stars](https://img.shields.io/github/stars/mageplaza/magento-2-korean-language-pack?style=flat)](https://github.com/mageplaza/magento-2-korean-language-pack/stargazers) - Korean Language Package.
- [en_GB](https://github.com/cubewebsites/magento2-language-en-gb) [![GitHub stars](https://img.shields.io/github/stars/cubewebsites/magento2-language-en-gb?style=flat)](https://github.com/cubewebsites/magento2-language-en-gb/stargazers) - British Language Package.
- [es_AR](https://github.com/SemExpert/Magento2-language-es_ar) [![GitHub stars](https://img.shields.io/github/stars/SemExpert/Magento2-language-es_ar?style=flat)](https://github.com/SemExpert/Magento2-language-es_ar/stargazers) - Spanish (Argentina) Language Package.
- [sk_SK](https://github.com/mageplaza/magento-2-slovak-language-pack) [![GitHub stars](https://img.shields.io/github/stars/mageplaza/magento-2-slovak-language-pack?style=flat)](https://github.com/mageplaza/magento-2-slovak-language-pack/stargazers) - Slovakian Language Package.
...
- [Opengento GDPR](https://github.com/opengento/magento2-gdpr) [![GitHub stars](https://img.shields.io/github/stars/opengento/magento2-gdpr?style=flat)](https://github.com/opengento/magento2-gdpr/stargazers) - Magento 2 GDPR module to help be GDPR compliant.
- [hyva-ai-tools](https://github.com/hyva-themes/hyva-ai-tools) [![GitHub stars](https://img.shields.io/github/stars/hyva-themes/hyva-ai-tools?style=flat)](https://github.com/hyva-themes/hyva-ai-tools/stargazers) - AI-powered skills for Magento 2 development with Hyva Theme. These skills extend AI coding assistants with specialized knowledge for creating Hyva themes, modules, and CMS components.
...
- [Magento 2 PDF](https://github.com/staempfli/magento2-module-pdf) [![GitHub stars](https://img.shields.io/github/stars/staempfli/magento2-module-pdf?style=flat)](https://github.com/staempfli/magento2-module-pdf/stargazers) - PDF Generator based on wkhtmltopdf.
...
- [shkoliar/magento-grid-colors](https://github.com/shkoliar/magento-grid-colors) [![GitHub stars](https://img.shields.io/github/stars/shkoliar/magento-grid-colors?style=flat)](https://github.com/shkoliar/magento-grid-colors/stargazers) - Magento 2 Grid Colors module for colorizing admin grids. Supports saving of states with the help of grid bookmarks by Dmitry Shkoliar.
- [extdn/extension-dashboard-m2](https://github.com/extdn/extension-dashboard-m2) [![GitHub stars](https://img.shields.io/github/stars/extdn/extension-dashboard-m2?style=flat)](https://github.com/extdn/extension-dashboard-m2/stargazers) - A Magento 2 dashboard to display installed extensions by the Magento Extension Developers Network.
- [Reset Customer Password](https://github.com/Vinai/module-customer-password-command) [![GitHub stars](https://img.shields.io/github/stars/Vinai/module-customer-password-command?style=flat)](https://github.com/Vinai/module-customer-password-command/stargazers) - Set a customer password with bin/magento by Vinai Kopp.
- [hivecommerce/magento2-content-fuzzyfyr](https://github.com/hivecommerce/magento2-content-fuzzyfyr) [![GitHub stars](https://img.shields.io/github/stars/hivecommerce/magento2-content-fuzzyfyr?style=flat)](https://github.com/hivecommerce/magento2-content-fuzzyfyr/stargazers) - The Content Fuzzyfyr module for Magento 2 replaces real content with dummy content — useful for development, test data, and matching GDPR restrictions.
...
- [PAYONE](https://github.com/PAYONE-GmbH/magento-2) [![GitHub stars](https://img.shields.io/github/stars/PAYONE-GmbH/magento-2?style=flat)](https://github.com/PAYONE-GmbH/magento-2/stargazers) 🫡 - PAYONE Payment Integration.
...
- [Stripe](https://github.com/pmclain/module-stripe) [![GitHub stars](https://img.shields.io/github/stars/pmclain/module-stripe?style=flat)](https://github.com/pmclain/module-stripe/stargazers) - Stripe Payments for Magento 2.

</details>

### Infrastructure

- [Ethan3600/magento2-CronjobManager](https://github.com/Ethan3600/magento2-CronjobManager) [![GitHub stars](https://img.shields.io/github/stars/Ethan3600/magento2-CronjobManager?style=flat)](https://github.com/Ethan3600/magento2-CronjobManager/stargazers) 🔥 - Cron Job Manager for Magento 2.
- [magento-cache-clean](https://github.com/mage-os/magento-cache-clean) [![GitHub stars](https://img.shields.io/github/stars/mage-os/magento-cache-clean?style=flat)](https://github.com/mage-os/magento-cache-clean/stargazers) 🫡 - A faster drop in replacement for bin/magento cache:clean with file watcher
- [module-theme-optimization](https://github.com/mage-os/module-theme-optimization) [![GitHub stars](https://img.shields.io/github/stars/mage-os/module-theme-optimization?style=flat)](https://github.com/mage-os/module-theme-optimization/stargazers) 🫡 - bfcache, speculative loading, and view transitions for Magento
...
- [graphcommerce](https://github.com/graphcommerce-org/graphcommerce) [![GitHub stars](https://img.shields.io/github/stars/graphcommerce-org/graphcommerce?style=flat)](https://github.com/graphcommerce-org/graphcommerce/stargazers) 🫡 - GraphCommerce® is a headless storefront replacement for Magento 2 (PWA), that delivers a faster, better user experience. Fully customizable (React, Next.js) and open-source.
- [magento2-default-theme](https://github.com/hyva-themes/magento2-default-theme) [![GitHub stars](https://img.shields.io/github/stars/hyva-themes/magento2-default-theme?style=flat)](https://github.com/hyva-themes/magento2-default-theme/stargazers) - A Magento theme built with Tailwind
- [magento2-theme-module](https://github.com/hyva-themes/magento2-theme-module) [![GitHub stars](https://img.shields.io/github/stars/hyva-themes/magento2-theme-module?style=flat)](https://github.com/hyva-themes/magento2-theme-module/stargazers) - Magento Tailwind Theme companion module
- [magento2-default-theme-csp](https://github.com/hyva-themes/magento2-default-theme-csp) [![GitHub stars](https://img.shields.io/github/stars/hyva-themes/magento2-default-theme-csp?style=flat)](https://github.com/hyva-themes/magento2-default-theme-csp/stargazers) - A strict CSP compatible Magento theme built with Tailwind and Alpine.js
...
- [magento-notes/magento2-exam-notes](https://github.com/magento-notes/magento2-exam-notes) [![GitHub stars](https://img.shields.io/github/stars/magento-notes/magento2-exam-notes?style=flat)](https://github.com/magento-notes/magento2-exam-notes/stargazers) - Preparation notes for the Magento 2 Certified Professional Developer exam.
...
- [Magento GitHub Repository](https://github.com/magento/magento2) [![GitHub stars](https://img.shields.io/github/stars/magento/magento2?style=flat)](https://github.com/magento/magento2/stargazers) 🫡 - Magento 2 GitHub repository.
...
- [The Extension Lab](https://github.com/theextensionlab/) [![GitHub stars](https://img.shields.io/github/stars/theextensionlab/?style=flat)](https://github.com/theextensionlab//stargazers) - The Extension Lab on GitHub.
...
- [Alessandro Ronchi](https://github.com/aleron75) [![GitHub stars](https://img.shields.io/github/stars/aleron75?style=flat)](https://github.com/aleron75/stargazers) - Co-founder of ExtDN; maintainer of Mageres.
- [Anna Völkl](https://github.com/avoelkl) [![GitHub stars](https://img.shields.io/github/stars/avoelkl?style=flat)](https://github.com/avoelkl/stargazers) - integer_net; regular speaker and language-pack contributor.
...
- [Fabian Schmengler](https://github.com/schmengler) [![GitHub stars](https://img.shields.io/github/stars/schmengler?style=flat)](https://github.com/schmengler/stargazers) - integer_net; frequent conference speaker on Magento 2 architecture.
- [Ivan Chepurnyi](https://github.com/EcomDev) [![GitHub stars](https://img.shields.io/github/stars/EcomDev?style=flat)](https://github.com/EcomDev/stargazers) - Long-time core contributor; speaker.
- [Jisse Reitsma](https://github.com/jreitsma) [![GitHub stars](https://img.shields.io/github/stars/jreitsma?style=flat)](https://github.com/jreitsma/stargazers) - Founder of Yireo; trainer and book author.
...
- [Mathias Elle](https://github.com/MathiasElle) [![GitHub stars](https://img.shields.io/github/stars/MathiasElle?style=flat)](https://github.com/MathiasElle/stargazers) - Author of the Magento Log Viewer VS Code extension.
- [Max Pronko](https://github.com/maxpronko) [![GitHub stars](https://img.shields.io/github/stars/maxpronko?style=flat)](https://github.com/maxpronko/stargazers) - Trainer; runs the DevChannel YouTube series.
- [Peter Jaap Blaakmeer](https://github.com/peterjaap) [![GitHub stars](https://img.shields.io/github/stars/peterjaap?style=flat)](https://github.com/peterjaap/stargazers) - CTO at elgentos; open-source contributor.
- [Phillip Jackson](http://magetalk.com/) - Co-host of MageTalk podcast.
- [Riccardo Tempesta](https://github.com/rpanarin) [![GitHub stars](https://img.shields.io/github/stars/rpanarin?style=flat)](https://github.com/rpanarin/stargazers) - MageSpecialist; creator of MSP_DevTools.
- [Roma Glushko](https://github.com/roma-glushko) [![GitHub stars](https://img.shields.io/github/stars/roma-glushko?style=flat)](https://github.com/roma-glushko/stargazers) - Maintains magento2-dev-plus-exam notes and the Tango CLI.
- [Sander Mangel](https://github.com/sandermangel) [![GitHub stars](https://img.shields.io/github/stars/sandermangel?style=flat)](https://github.com/sandermangel/stargazers) - Organiser of MageUnconference NL; language-pack co-maintainer.
- [Vinai Kopp](https://github.com/Vinai) [![GitHub stars](https://img.shields.io/github/stars/Vinai?style=flat)](https://github.com/Vinai/stargazers) - Trainer and author of Mage2Katas; deep Magento 2 internals expertise.

---

## Other Magento 2 related Awesome Lists

- [Awesome PHP](https://github.com/ziadoz/awesome-php) [![GitHub stars](https://img.shields.io/github/stars/ziadoz/awesome-php?style=flat)](https://github.com/ziadoz/awesome-php/stargazers) - A curated list of awesome PHP resources.
- [Mageres](https://github.com/aleron75/mageres) [![GitHub stars](https://img.shields.io/github/stars/aleron75/mageres?style=flat)](https://github.com/aleron75/mageres/stargazers) - Alessandro Ronchi's list of resources for Magento 1 and Magento 2.

<details>
<summary>🪦 Graveyard — projects no longer recommended</summary>

- [Awesome Magento](https://github.com/sunel/awesome-magento) [![GitHub stars](https://img.shields.io/github/stars/sunel/awesome-magento?style=flat)](https://github.com/sunel/awesome-magento/stargazers) - An awesome Magento list with mixed M1 and M2 content by sunel.
...
Thanks [Anna Völkl](https://github.com/avoelkl) [![GitHub stars](https://img.shields.io/github/stars/avoelkl?style=flat)](https://github.com/avoelkl/stargazers) & [Sander Mangel](https://github.com/sandermangel) [![GitHub stars](https://img.shields.io/github/stars/sandermangel?style=flat)](https://github.com/sandermangel/stargazers) for collecting all
the language packs!
