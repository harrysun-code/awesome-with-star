...
* [Adobe After Effects](https://www.adobe.com/products/aftereffects.htm) – The industry-standard animation and creative compositing app lets you design and deliver professional motion graphics and visual effects for film, TV, video and web:
  ...
  * [BodyMovin](https://github.com/bodymovin/bodymovin) [![GitHub stars](https://img.shields.io/github/stars/bodymovin/bodymovin?style=flat)](https://github.com/bodymovin/bodymovin/stargazers) – Converter from AE to SVG/canvas.
...
* [Mo.js](https://github.com/mojs/mojs) [![GitHub stars](https://img.shields.io/github/stars/mojs/mojs?style=flat)](https://github.com/mojs/mojs/stargazers) – Motion graphics toolbelt for the web.
...
* [Animate Plus](https://github.com/bendc/animateplus) [![GitHub stars](https://img.shields.io/github/stars/bendc/animateplus?style=flat)](https://github.com/bendc/animateplus/stargazers) – CSS and SVG animation library for modern browsers, performant and lightweight (3KB gzipped), making it particularly well-suited for mobile.
* [Gravitas.js](https://github.com/iamralpht/gravitas.js) [![GitHub stars](https://img.shields.io/github/stars/iamralpht/gravitas.js?style=flat)](https://github.com/iamralpht/gravitas.js/stargazers) – Super fast physics simulations for JavaScript.
...
**Collected with :heart: by Artur Kornakov and [these awesome guys](https://github.com/fliptheweb/motion-ui-design/graphs/contributors) [![GitHub stars](https://img.shields.io/github/stars/fliptheweb/motion-ui-design/graphs/contributors?style=flat)](https://github.com/fliptheweb/motion-ui-design/graphs/contributors/stargazers)**
