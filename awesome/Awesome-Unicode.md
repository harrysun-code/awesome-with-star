...
- **Similarily, reversing strings often is a non-trivial task.** Again, surrogate pairs and diacritics must be reversed together. [ES Reverser](https://github.com/mathiasbynens/esrever) [![GitHub stars](https://img.shields.io/github/stars/mathiasbynens/esrever?style=flat)](https://github.com/mathiasbynens/esrever/stargazers) provides a pretty good solution.
...
- [PhantomScript](https://github.com/jagracey/PhantomScript) [![GitHub stars](https://img.shields.io/github/stars/jagracey/PhantomScript?style=flat)](https://github.com/jagracey/PhantomScript/stargazers) - :ghost: :flashlight: Invisible JavaScript code execution & social engineering
- [ESReverser](https://github.com/mathiasbynens/esrever) [![GitHub stars](https://img.shields.io/github/stars/mathiasbynens/esrever?style=flat)](https://github.com/mathiasbynens/esrever/stargazers) - A Unicode-aware string reverser written in JavaScript.
- [mimic](https://github.com/reinderien/mimic) [![GitHub stars](https://img.shields.io/github/stars/reinderien/mimic?style=flat)](https://github.com/reinderien/mimic/stargazers) - [ab]using Unicode to create tragedy
- [python-ftfy](https://github.com/LuminosoInsight/python-ftfy) [![GitHub stars](https://img.shields.io/github/stars/LuminosoInsight/python-ftfy?style=flat)](https://github.com/LuminosoInsight/python-ftfy/stargazers) - Given Unicode text, make its representation consistent and possibly less broken.
- [vim-troll-stopper](https://github.com/vim-utils/vim-troll-stopper) [![GitHub stars](https://img.shields.io/github/stars/vim-utils/vim-troll-stopper?style=flat)](https://github.com/vim-utils/vim-troll-stopper/stargazers) - Stop Unicode trolls from messing with your code.
