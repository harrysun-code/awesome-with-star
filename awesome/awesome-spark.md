...
* [Advanced Analytics with Spark](http://shop.oreilly.com/product/0636920035091.do) - Useful collection of Spark processing patterns. Accompanying GitHub repository: [sryza/aas](https://github.com/sryza/aas) [![GitHub stars](https://img.shields.io/github/stars/sryza/aas?style=flat)](https://github.com/sryza/aas/stargazers).
* [Mastering Apache Spark](https://jaceklaskowski.gitbooks.io/mastering-apache-spark/) - Interesting compilation of notes by [Jacek Laskowski](https://github.com/jaceklaskowski) [![GitHub stars](https://img.shields.io/github/stars/jaceklaskowski?style=flat)](https://github.com/jaceklaskowski/stargazers). Focused on different aspects of Spark internals.
* [Spark in Action](https://www.manning.com/books/spark-in-action) - New book in the Manning's "in action" family with +400 pages. Starts gently, step-by-step and covers large number of topics. Free excerpt on how to [setup Eclipse for Spark application development](http://freecontent.manning.com/how-to-start-developing-spark-applications-in-eclipse/) and how to bootstrap a new application using the provided Maven Archetype. You can find the accompanying GitHub repo [here](https://github.com/spark-in-action/first-edition) [![GitHub stars](https://img.shields.io/github/stars/spark-in-action/first-edition?style=flat)](https://github.com/spark-in-action/first-edition/stargazers).
...
* [Oryx 2](https://github.com/OryxProject/oryx) [![GitHub stars](https://img.shields.io/github/stars/OryxProject/oryx?style=flat)](https://github.com/OryxProject/oryx/stargazers) - [Lambda architecture](http://lambda-architecture.net/) platform built on Apache Spark and [Apache Kafka](http://kafka.apache.org/) with specialization for real-time large scale machine learning.
* [Photon ML](https://github.com/linkedin/photon-ml) [![GitHub stars](https://img.shields.io/github/stars/linkedin/photon-ml?style=flat)](https://github.com/linkedin/photon-ml/stargazers) - A machine learning library supporting classical Generalized Mixed Model and Generalized Additive Mixed Effect Model.
...
* [Crossdata](https://github.com/Stratio/Crossdata) [![GitHub stars](https://img.shields.io/github/stars/Stratio/Crossdata?style=flat)](https://github.com/Stratio/Crossdata/stargazers) - Data integration platform with extended DataSource API and multi-user environment.


### Docker Images

- [apache/spark](https://hub.docker.com/r/apache/spark) - Apache Spark Official Docker images.
- [jupyter/docker-stacks/pyspark-notebook](https://github.com/jupyter/docker-stacks/tree/master/pyspark-notebook) [![GitHub stars](https://img.shields.io/github/stars/jupyter/docker-stacks/tree/master/pyspark-notebook?style=flat)](https://github.com/jupyter/docker-stacks/tree/master/pyspark-notebook/stargazers) - PySpark with Jupyter Notebook and Mesos client.
- [sequenceiq/docker-spark](https://github.com/sequenceiq/docker-spark) [![GitHub stars](https://img.shields.io/github/stars/sequenceiq/docker-spark?style=flat)](https://github.com/sequenceiq/docker-spark/stargazers) - Yarn images from [SequenceIQ](http://www.sequenceiq.com/).
...
- [Spark with Scala Gitter channel](https://gitter.im/spark-scala/Lobby) - "_A place to discuss and ask questions about using Scala for Spark programming_" started by [@deanwampler](https://github.com/deanwampler) [![GitHub stars](https://img.shields.io/github/stars/deanwampler?style=flat)](https://github.com/deanwampler/stargazers).
...
Inspired by [sindresorhus/awesome](https://github.com/sindresorhus/awesome) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers).
