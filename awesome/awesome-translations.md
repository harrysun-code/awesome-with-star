...
- [English](https://github.com/mbiesiad/awesome-translations) [![GitHub stars](https://img.shields.io/github/stars/mbiesiad/awesome-translations?style=flat)](https://github.com/mbiesiad/awesome-translations/stargazers)
- [Polish](https://github.com/mbiesiad/awesome-translations/tree/pl_PL) [![GitHub stars](https://img.shields.io/github/stars/mbiesiad/awesome-translations/tree/pl_PL?style=flat)](https://github.com/mbiesiad/awesome-translations/tree/pl_PL/stargazers)
- [Spanish](https://web.archive.org/web/20220511155347/https://github.com/JoseDeFreitas/awesome-translations/tree/es_ES)
- [Italian](https://github.com/niedev/awesome-translations/tree/it_IT) [![GitHub stars](https://img.shields.io/github/stars/niedev/awesome-translations/tree/it_IT?style=flat)](https://github.com/niedev/awesome-translations/tree/it_IT/stargazers)
- [French](https://github.com/alexture/awesome-translations/tree/fr_FR) [![GitHub stars](https://img.shields.io/github/stars/alexture/awesome-translations/tree/fr_FR?style=flat)](https://github.com/alexture/awesome-translations/tree/fr_FR/stargazers)
...
- [LRM](https://github.com/nickprotop/LocalizationManager) [![GitHub stars](https://img.shields.io/github/stars/nickprotop/LocalizationManager?style=flat)](https://github.com/nickprotop/LocalizationManager/stargazers) - Self-hosted CLI/TUI localization manager supporting .resx and JSON (i18next) with multiple translation providers including free options.
...
- [Traduora](https://github.com/traduora/traduora) [![GitHub stars](https://img.shields.io/github/stars/traduora/traduora?style=flat)](https://github.com/traduora/traduora/stargazers) - A platform to manage translation workflow in teams.
...
- [RTranslator](https://github.com/niedev/RTranslator) [![GitHub stars](https://img.shields.io/github/stars/niedev/RTranslator?style=flat)](https://github.com/niedev/RTranslator/stargazers) - A simultaneous translator app for Android based on NLLB and Whisper that runs locally.
- [Crow Translate](https://github.com/crow-translate/crow-translate) [![GitHub stars](https://img.shields.io/github/stars/crow-translate/crow-translate?style=flat)](https://github.com/crow-translate/crow-translate/stargazers) - A simple and lightweight translator for Linux and Windows that allows to translate and speak text using Google, Yandex and Bing translate API.
- [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) [![GitHub stars](https://img.shields.io/github/stars/CopyTranslator/CopyTranslator?style=flat)](https://github.com/CopyTranslator/CopyTranslator/stargazers) - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
- [LibreTranslate](https://github.com/uav4geo/LibreTranslate) [![GitHub stars](https://img.shields.io/github/stars/uav4geo/LibreTranslate?style=flat)](https://github.com/uav4geo/LibreTranslate/stargazers) - 100% Self-Hosted web app to translate text, based on Argos Translate.

### Translation software
- [OmegaT](https://omegat.org/) - Free translation memory / CAT software that works on Windows, macOS and Linux.
- [Argos Translate](https://github.com/argosopentech/argos-translate) [![GitHub stars](https://img.shields.io/github/stars/argosopentech/argos-translate?style=flat)](https://github.com/argosopentech/argos-translate/stargazers) - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
- [Bergamot](https://github.com/browsermt) [![GitHub stars](https://img.shields.io/github/stars/browsermt?style=flat)](https://github.com/browsermt/stargazers) - Client-side translation in the browser.
...
- [deep-translator](https://github.com/nidhaloff/deep-translator) [![GitHub stars](https://img.shields.io/github/stars/nidhaloff/deep-translator?style=flat)](https://github.com/nidhaloff/deep-translator/stargazers) - A flexible free and unlimited (depending on the translator used) library written in Python to translate between different languages in a simple way using multiple translators, it can also be used directly in the prompt.
- [Translator](https://github.com/UlionTse/translators) [![GitHub stars](https://img.shields.io/github/stars/UlionTse/translators?style=flat)](https://github.com/UlionTse/translators/stargazers) - A translator library based on the translation interface of Google, Yandex, Microsoft (Bing), Baidu, Alibaba, Tencent, NetEase (Youdao), Sogou, Deepl, etc.
...
- [i18n Ally](https://github.com/antfu/i18n-ally) [![GitHub stars](https://img.shields.io/github/stars/antfu/i18n-ally?style=flat)](https://github.com/antfu/i18n-ally/stargazers) - Extension for VSCode, all in one about i18n.
- [Translate](https://github.com/translate/translate) [![GitHub stars](https://img.shields.io/github/stars/translate/translate?style=flat)](https://github.com/translate/translate/stargazers) - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
...
- [Polyglot](https://github.com/untra/polyglot) [![GitHub stars](https://img.shields.io/github/stars/untra/polyglot?style=flat)](https://github.com/untra/polyglot/stargazers) - A fast, painless, open-source internationalization plugin for Jekyll blogs.
...
- [sphinx-intl](https://github.com/sphinx-doc/sphinx-intl) [![GitHub stars](https://img.shields.io/github/stars/sphinx-doc/sphinx-intl?style=flat)](https://github.com/sphinx-doc/sphinx-intl/stargazers) - A Sphinx utility that make it easy to translate and to apply translations.

### Machine translation for developers
- [SwiftGoogleTranslate](https://github.com/maximbilan/SwiftGoogleTranslate) [![GitHub stars](https://img.shields.io/github/stars/maximbilan/SwiftGoogleTranslate?style=flat)](https://github.com/maximbilan/SwiftGoogleTranslate/stargazers) - A framework to use cloud translation API by Google in Swift.
- [attranslate](https://github.com/fkirc/attranslate) [![GitHub stars](https://img.shields.io/github/stars/fkirc/attranslate?style=flat)](https://github.com/fkirc/attranslate/stargazers) - A tool for semi-automated translations of cross-platform apps or websites.
...
- [Pootle](https://github.com/translate/pootle) [![GitHub stars](https://img.shields.io/github/stars/translate/pootle?style=flat)](https://github.com/translate/pootle/stargazers) - An online translation management tool with a translation interface focused on localization of applications' graphical user interfaces. It is used by LibreOffice.
- [Globalize](https://github.com/globalizejs/globalize) [![GitHub stars](https://img.shields.io/github/stars/globalizejs/globalize?style=flat)](https://github.com/globalizejs/globalize/stargazers) - A JavaScript library for internationalization and localization that leverage the official Unicode CLDR JSON data.
- [SimpleLocalize CLI](https://github.com/simplelocalize/simplelocalize-cli) [![GitHub stars](https://img.shields.io/github/stars/simplelocalize/simplelocalize-cli?style=flat)](https://github.com/simplelocalize/simplelocalize-cli/stargazers) - A CLI for finding translation keys in project files.
...
- [Awesome New Languages in Machine Translation](https://github.com/slone-nlp/awesome-new-languages-in-machine-translation) [![GitHub stars](https://img.shields.io/github/stars/slone-nlp/awesome-new-languages-in-machine-translation?style=flat)](https://github.com/slone-nlp/awesome-new-languages-in-machine-translation/stargazers) - A list of initiatives for supporting MT (mostly with opensource models) for new languages (mostly lower-resourced ones).
...
- [Glocalization Strategy Playbook](https://github.com/GILT-Forum/Globalization-Strategy-Playbook) [![GitHub stars](https://img.shields.io/github/stars/GILT-Forum/Globalization-Strategy-Playbook?style=flat)](https://github.com/GILT-Forum/Globalization-Strategy-Playbook/stargazers) - A Guide for Localization and Globalization Professionals by the GILT forum.
