...
- [Literate Programming With Jupyter Notebooks and Quarto](https://www.rstudio.com/conference/2022/talks/literate-programming-quarto/) - Talk by Hamel Husain at RStudio::conf(2022) describing the integration between [Nbdev](https://github.com/fastai/nbdev) [![GitHub stars](https://img.shields.io/github/stars/fastai/nbdev?style=flat)](https://github.com/fastai/nbdev/stargazers) and Quarto (materials: <https://github.com/fastai/nbdev-demo>).
...
- [DocumenterQuarto](https://github.com/cadojo/DocumenterQuarto.jl) [![GitHub stars](https://img.shields.io/github/stars/cadojo/DocumenterQuarto.jl?style=flat)](https://github.com/cadojo/DocumenterQuarto.jl/stargazers) - A Julia package to generate documentation for Julia packages using Quarto and Documenter.
...
- [Quarto Agent Skills](https://github.com/posit-dev/skills/tree/main/quarto) [![GitHub stars](https://img.shields.io/github/stars/posit-dev/skills/tree/main/quarto?style=flat)](https://github.com/posit-dev/skills/tree/main/quarto/stargazers) - A collection of Claude/Agent Skills from Posit for Quarto, covering authoring, `brand.yml`, and alt text, that extend AI coding agents with Quarto-specific knowledge and workflows; usable from Claude Code, Claude.ai, and other agents (Cursor, Codex, Cline) via `npx skills add`.
...
- [rlille.fr](https://github.com/RLille/rlille.fr) [![GitHub stars](https://img.shields.io/github/stars/RLille/rlille.fr?style=flat)](https://github.com/RLille/rlille.fr/stargazers) - The R Lille (R User Group) website using Quarto.
...
- [R for Social Scientists workshop](https://github.com/pittmethods/r4ss) [![GitHub stars](https://img.shields.io/github/stars/pittmethods/r4ss?style=flat)](https://github.com/pittmethods/r4ss/stargazers) - A Quarto website for a workshop which includes Quarto Reveal JS presentations embedded in it.
