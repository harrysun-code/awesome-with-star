...
This list covers only Python, as many are already familiar with this language. [Data Science tutorials using R](https://github.com/ujjwalkarn/DataScienceR) [![GitHub stars](https://img.shields.io/github/stars/ujjwalkarn/DataScienceR?style=flat)](https://github.com/ujjwalkarn/DataScienceR/stargazers).
...
- [Pandas cheatsheet](https://github.com/pandas-dev/pandas/blob/master/doc/cheatsheet/Pandas_Cheat_Sheet.pdf) [![GitHub stars](https://img.shields.io/github/stars/pandas-dev/pandas/blob/master/doc/cheatsheet/Pandas_Cheat_Sheet.pdf?style=flat)](https://github.com/pandas-dev/pandas/blob/master/doc/cheatsheet/Pandas_Cheat_Sheet.pdf/stargazers) - Quick overview over the most important functions.
...
- [Template folder structure for organizing Data Science projects](https://github.com/drivendata/cookiecutter-data-science) [![GitHub stars](https://img.shields.io/github/stars/drivendata/cookiecutter-data-science?style=flat)](https://github.com/drivendata/cookiecutter-data-science/stargazers)
...
- [LightGBM gradient boosting framework](https://github.com/Microsoft/LightGBM) [![GitHub stars](https://img.shields.io/github/stars/Microsoft/LightGBM?style=flat)](https://github.com/Microsoft/LightGBM/stargazers) - Successfully used in many Kaggle challenges.
...
- [Data Science Python](https://github.com/ujjwalkarn/DataSciencePython) [![GitHub stars](https://img.shields.io/github/stars/ujjwalkarn/DataSciencePython?style=flat)](https://github.com/ujjwalkarn/DataSciencePython/stargazers)
- [Machine Learning Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials) [![GitHub stars](https://img.shields.io/github/stars/ujjwalkarn/Machine-Learning-Tutorials?style=flat)](https://github.com/ujjwalkarn/Machine-Learning-Tutorials/stargazers)
