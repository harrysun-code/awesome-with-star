...
> 来源：[jaredthecoder/awesome-vehicle-security](https://github.com/jaredthecoder/awesome-vehicle-security)

[![GitHub stars](https://img.shields.io/github/stars/jaredthecoder/awesome-vehicle-security?style=flat)](https://github.com/jaredthecoder/awesome-vehicle-security/stargazers)
...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md?style=flat)](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md/stargazers)
...
- [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) [![GitHub stars](https://img.shields.io/github/stars/iDoka/awesome-canbus?style=flat)](https://github.com/iDoka/awesome-canbus/stargazers)
- [Awesome LIN Bus - an awesome list just for LIN-Bus related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-linbus) [![GitHub stars](https://img.shields.io/github/stars/iDoka/awesome-linbus?style=flat)](https://github.com/iDoka/awesome-linbus/stargazers)
...
- [Udacity's Self Driving Car Engineer Course](https://github.com/udacity/self-driving-car) [![GitHub stars](https://img.shields.io/github/stars/udacity/self-driving-car?style=flat)](https://github.com/udacity/self-driving-car/stargazers) - The content for Udacity's self driving car software engineer course. The actual course on Udacity's website is [here](https://www.udacity.com/course/self-driving-car-engineer-nanodegree--nd013).
...
- [OpenGarages](https://github.com/opengarages) [![GitHub stars](https://img.shields.io/github/stars/opengarages?style=flat)](https://github.com/opengarages/stargazers) - Provides public access, documentation and tools necessary to understand today's modern vehicle systems.
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md?style=flat)](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md/stargazers)!
...
## Miscellaneous
- [Reverse Engineering Resources](https://github.com/ps1337/automotive-security-research) [![GitHub stars](https://img.shields.io/github/stars/ps1337/automotive-security-research?style=flat)](https://github.com/ps1337/automotive-security-research/stargazers)
...
- [Open Vehicle Monitoring System](https://github.com/openvehicles/Open-Vehicle-Monitoring-System) [![GitHub stars](https://img.shields.io/github/stars/openvehicles/Open-Vehicle-Monitoring-System?style=flat)](https://github.com/openvehicles/Open-Vehicle-Monitoring-System/stargazers) - A community project building a hardware module for your car, a server to talk to it, and a mobile app to talk to the server, in order to allow developers and enthusiasts to add more functionality to their car and control it remotely.
- [Open Source Car Control Project](https://github.com/PolySync/OSCC) [![GitHub stars](https://img.shields.io/github/stars/PolySync/OSCC?style=flat)](https://github.com/PolySync/OSCC/stargazers) - The Open Source Car Control Project is a hardware and software project detailing the conversion of a late model vehicle into an autonomous driving research and development vehicle.
...
- [Arduino](https://www.arduino.cc/) - Arduino boards have a number of shields you can attach to connect to CAN-enabled devices.
    - [CANdiy-Shield](https://github.com/watterott/CANdiy-Shield) [![GitHub stars](https://img.shields.io/github/stars/watterott/CANdiy-Shield?style=flat)](https://github.com/watterott/CANdiy-Shield/stargazers)
    ...
    - [arduino-canbus-monitor](https://github.com/latonita/arduino-canbus-monitor) [![GitHub stars](https://img.shields.io/github/stars/latonita/arduino-canbus-monitor?style=flat)](https://github.com/latonita/arduino-canbus-monitor/stargazers) - No matter which shield is selected you will need your own sniffer. This is implementation of standard Lawicel/SLCAN protocol for Arduino + any MCP CAN Shield to use with many standard CAN bus analysis software packages or SocketCAN
...
- [PiCCANTE](https://github.com/Alia5/PiCCANTE) [![GitHub stars](https://img.shields.io/github/stars/Alia5/PiCCANTE?style=flat)](https://github.com/Alia5/PiCCANTE/stargazers) - Open-source CAN hacking tool based on Raspberry Pi Pico [2] (W) - Up to 3x CAN interfaces, includes ELM327 emulator. 
- [AutoPi](https://github.com/autopi-io/autopi-core) [![GitHub stars](https://img.shields.io/github/stars/autopi-io/autopi-core?style=flat)](https://github.com/autopi-io/autopi-core/stargazers) - Open-source core software for the AutoPi dongle, a Raspberry Pi-based OBD-II device for vehicle telematics, CAN bus data collection, and automotive IoT applications.
...
- [UDSim](https://github.com/zombieCraig/UDSim/) [![GitHub stars](https://img.shields.io/github/stars/zombieCraig/UDSim/?style=flat)](https://github.com/zombieCraig/UDSim//stargazers) - GUI tool that can monitor a CAN bus and automatically learn the devices attached to it by watching communications.
...
- [CANToolz](https://github.com/eik00d/CANToolz) [![GitHub stars](https://img.shields.io/github/stars/eik00d/CANToolz?style=flat)](https://github.com/eik00d/CANToolz/stargazers) - CANToolz is a framework for analysing CAN networks and devices. It is based on several modules which can be assembled in a pipeline.
...
- [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) [![GitHub stars](https://img.shields.io/github/stars/bad-antics/blackflag-ecu?style=flat)](https://github.com/bad-antics/blackflag-ecu/stargazers) - Professional ECU diagnostics and tuning suite with OBD-II scanning, DTC reading, live sensor monitoring, and reflash capabilities.
...
- [openpilot](https://github.com/commaai/openpilot) [![GitHub stars](https://img.shields.io/github/stars/commaai/openpilot?style=flat)](https://github.com/commaai/openpilot/stargazers) - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
- [openalpr](https://github.com/openalpr/openalpr) [![GitHub stars](https://img.shields.io/github/stars/openalpr/openalpr?style=flat)](https://github.com/openalpr/openalpr/stargazers) - An open source Automatic License Plate Recognition library written in C++ with bindings in C#, Java, Node.js, Go, and Python.
...
- [mazda_getInfo](https://github.com/shipcod3/mazda_getInfo) [![GitHub stars](https://img.shields.io/github/stars/shipcod3/mazda_getInfo?style=flat)](https://github.com/shipcod3/mazda_getInfo/stargazers) - A PoC that the USB port is an attack surface for a Mazda car's infotainment system and how Mazda hacks are made (known bug in the CMU).
- [talking-with-cars](https://github.com/P1kachu/talking-with-cars) [![GitHub stars](https://img.shields.io/github/stars/P1kachu/talking-with-cars?style=flat)](https://github.com/P1kachu/talking-with-cars/stargazers) - CAN related scripts, and scripts to use a car as a gamepad
- [CANalyzat0r](https://github.com/schutzwerk/CANalyzat0r) [![GitHub stars](https://img.shields.io/github/stars/schutzwerk/CANalyzat0r?style=flat)](https://github.com/schutzwerk/CANalyzat0r/stargazers) - A security analysis toolkit for proprietary car protocols.
- [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) [![GitHub stars](https://img.shields.io/github/stars/hypery11/flipper-tesla-fsd?style=flat)](https://github.com/hypery11/flipper-tesla-fsd/stargazers) - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).

## Libraries and Tools

Libraries and tools that don't fall under the larger class of applications above.

[Custom Applications SDK for Mazda Connect Infotainment System](https://github.com/flyandi/mazda-custom-application-sdk) [![GitHub stars](https://img.shields.io/github/stars/flyandi/mazda-custom-application-sdk?style=flat)](https://github.com/flyandi/mazda-custom-application-sdk/stargazers) - A micro framework that allows you to write and deploy custom applications for the Mazda Infotainment System.

### C

- [SocketCAN Utils](https://github.com/linux-can/can-utils) [![GitHub stars](https://img.shields.io/github/stars/linux-can/can-utils?style=flat)](https://github.com/linux-can/can-utils/stargazers) - Userspace utilites for SocketCAN on Linux.
- [vircar](https://github.com/dn5/vircar) [![GitHub stars](https://img.shields.io/github/stars/dn5/vircar?style=flat)](https://github.com/dn5/vircar/stargazers) - a Virtual car userspace that sends CAN messages based on SocketCAN
- [dbcc](https://github.com/howerj/dbcc) [![GitHub stars](https://img.shields.io/github/stars/howerj/dbcc?style=flat)](https://github.com/howerj/dbcc/stargazers) - "dbcc is a program for converting a DBC file primarily into into C code that can serialize and deserialize CAN messages." With existing DBC files from a vehicle, this file allows you to convert them to C code that extracts the CAN messages and properties of the CAN environment.

### C++

- [High Level ViWi Service](https://github.com/iotbzh/high-level-viwi-service) [![GitHub stars](https://img.shields.io/github/stars/iotbzh/high-level-viwi-service?style=flat)](https://github.com/iotbzh/high-level-viwi-service/stargazers) - High level Volkswagen CAN signaling protocol implementation.
- [CanCat](https://github.com/atlas0fd00m/CanCat) [![GitHub stars](https://img.shields.io/github/stars/atlas0fd00m/CanCat?style=flat)](https://github.com/atlas0fd00m/CanCat/stargazers) - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
- [CANdevStudio](https://github.com/GENIVI/CANdevStudio) [![GitHub stars](https://img.shields.io/github/stars/GENIVI/CANdevStudio?style=flat)](https://github.com/GENIVI/CANdevStudio/stargazers) - Development tool for CAN bus simulation. CANdevStudio enables to simulate CAN signals such as ignition status, doors status or reverse gear by every automotive developer.
- [UnlockECU](https://github.com/jglim/UnlockECU) [![GitHub stars](https://img.shields.io/github/stars/jglim/UnlockECU?style=flat)](https://github.com/jglim/UnlockECU/stargazers) - Free, open-source ECU seed-key unlocking tool.

### Java
- [ITS Geonetworking](https://github.com/alexvoronov/geonetworking) [![GitHub stars](https://img.shields.io/github/stars/alexvoronov/geonetworking?style=flat)](https://github.com/alexvoronov/geonetworking/stargazers) - ETSI ITS G5 GeoNetworking stack, in Java: CAM-DENM / ASN.1 PER / BTP / GeoNetworking

### Python

- [CANard](https://github.com/ericevenchick/canard) [![GitHub stars](https://img.shields.io/github/stars/ericevenchick/canard?style=flat)](https://github.com/ericevenchick/canard/stargazers) - A Python framework for Controller Area Network applications.
- [Caring Caribou](https://github.com/CaringCaribou/caringcaribou/) [![GitHub stars](https://img.shields.io/github/stars/CaringCaribou/caringcaribou/?style=flat)](https://github.com/CaringCaribou/caringcaribou//stargazers) - Intended to be the *nmap of vehicle security*.
- [c0f](https://github.com/zombieCraig/c0f/) [![GitHub stars](https://img.shields.io/github/stars/zombieCraig/c0f/?style=flat)](https://github.com/zombieCraig/c0f//stargazers) - A fingerprinting tool for CAN communications that can be used to find a specific signal on a CAN network when testing interactions with a vehicle.
- [Python-CAN](https://github.com/hardbyte/python-can) [![GitHub stars](https://img.shields.io/github/stars/hardbyte/python-can?style=flat)](https://github.com/hardbyte/python-can/stargazers) - Python interface to various CAN implementations, including SocketCAN. Allows you to use Python 2.7.x or 3.3.x+ to communicate over CAN networks.
- [Python-OBD](https://github.com/brendan-w/python-OBD) [![GitHub stars](https://img.shields.io/github/stars/brendan-w/python-OBD?style=flat)](https://github.com/brendan-w/python-OBD/stargazers) - A Python module for handling realtime sensor data from OBD-II vehicle ports. Works with ELM327 OBD-II adapters, and is fit for the Raspberry Pi.
- [CanCat](https://github.com/atlas0fd00m/CanCat) [![GitHub stars](https://img.shields.io/github/stars/atlas0fd00m/CanCat?style=flat)](https://github.com/atlas0fd00m/CanCat/stargazers) - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
- [Scapy](https://github.com/secdev/scapy) [![GitHub stars](https://img.shields.io/github/stars/secdev/scapy?style=flat)](https://github.com/secdev/scapy/stargazers) - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
- [CanoPy](https://github.com/tbruno25/canopy) [![GitHub stars](https://img.shields.io/github/stars/tbruno25/canopy?style=flat)](https://github.com/tbruno25/canopy/stargazers) - A python gui used to visualize and plot message payloads in real time.
- [canTot](https://github.com/shipcod3/canTot) [![GitHub stars](https://img.shields.io/github/stars/shipcod3/canTot?style=flat)](https://github.com/shipcod3/canTot/stargazers) - A python-based cli framework based on sploitkit and is easy to use because it similar to working with Metasploit. This similar to an exploit framework but focused on known CAN Bus vulnerabilities or fun CAN Bus hacks.
- [SocketCAN](https://python-can.readthedocs.io/en/master/interfaces/socketcan.html) Python interface to SocketCAN
- [canmatrix](https://github.com/ebroecker/canmatrix) [![GitHub stars](https://img.shields.io/github/stars/ebroecker/canmatrix?style=flat)](https://github.com/ebroecker/canmatrix/stargazers) Python module to work with CAN matrix files
...
- [cantools](https://github.com/eerimoq/cantools) [![GitHub stars](https://img.shields.io/github/stars/eerimoq/cantools?style=flat)](https://github.com/eerimoq/cantools/stargazers) Python module to decode and encode CAN messages using a DBC file
- [Caring Caribou Next](https://github.com/Cr0wTom/caringcaribounext) [![GitHub stars](https://img.shields.io/github/stars/Cr0wTom/caringcaribounext?style=flat)](https://github.com/Cr0wTom/caringcaribounext/stargazers) - Upgraded and optimized version of the original Caring Caribou project.
- [canarchy](https://github.com/hexsecs/canarchy) [![GitHub stars](https://img.shields.io/github/stars/hexsecs/canarchy?style=flat)](https://github.com/hexsecs/canarchy/stargazers) - CANarchy is a stream-first CAN analysis and manipulation runtime designed for automation, security research, and agent-driven workflows.


### Go

- [CANNiBUS](https://github.com/Hive13/CANiBUS/) [![GitHub stars](https://img.shields.io/github/stars/Hive13/CANiBUS/?style=flat)](https://github.com/Hive13/CANiBUS//stargazers) - A Go server that allows a room full of researchers to simultaneously work on the same vehicle, whether for instructional purposes or team reversing sessions.
- [CAN Simulator](https://github.com/carloop/simulator-program) [![GitHub stars](https://img.shields.io/github/stars/carloop/simulator-program?style=flat)](https://github.com/carloop/simulator-program/stargazers) - A Go based CAN simulator for the Raspberry Pi to be used with PiCAN2 or the open source [CAN Simulator board](https://github.com/carloop/simulator) [![GitHub stars](https://img.shields.io/github/stars/carloop/simulator?style=flat)](https://github.com/carloop/simulator/stargazers)

### JavaScript

- [NodeJS extension to SocketCAN](https://github.com/sebi2k1/node-can) [![GitHub stars](https://img.shields.io/github/stars/sebi2k1/node-can?style=flat)](https://github.com/sebi2k1/node-can/stargazers) - Allows you to communicate over CAN networks with simple JavaScript functions.
...
- Security
  - [Application Security](https://github.com/paragonie/awesome-appsec) [![GitHub stars](https://img.shields.io/github/stars/paragonie/awesome-appsec?style=flat)](https://github.com/paragonie/awesome-appsec/stargazers)
  - [Security](https://github.com/sbilly/awesome-security) [![GitHub stars](https://img.shields.io/github/stars/sbilly/awesome-security?style=flat)](https://github.com/sbilly/awesome-security/stargazers)
  - [Capture the Flag](https://github.com/apsdehal/awesome-ctf) [![GitHub stars](https://img.shields.io/github/stars/apsdehal/awesome-ctf?style=flat)](https://github.com/apsdehal/awesome-ctf/stargazers)
  - [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) [![GitHub stars](https://img.shields.io/github/stars/rshipp/awesome-malware-analysis?style=flat)](https://github.com/rshipp/awesome-malware-analysis/stargazers)
  - [Android Security](https://github.com/ashishb/android-security-awesome) [![GitHub stars](https://img.shields.io/github/stars/ashishb/android-security-awesome?style=flat)](https://github.com/ashishb/android-security-awesome/stargazers)
  - [Hacking](https://github.com/carpedm20/awesome-hacking) [![GitHub stars](https://img.shields.io/github/stars/carpedm20/awesome-hacking?style=flat)](https://github.com/carpedm20/awesome-hacking/stargazers)
  - [Honeypots](https://github.com/paralax/awesome-honeypots) [![GitHub stars](https://img.shields.io/github/stars/paralax/awesome-honeypots?style=flat)](https://github.com/paralax/awesome-honeypots/stargazers)
  - [Incident Response](https://github.com/meirwah/awesome-incident-response) [![GitHub stars](https://img.shields.io/github/stars/meirwah/awesome-incident-response?style=flat)](https://github.com/meirwah/awesome-incident-response/stargazers)
- Meta
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md?style=flat)](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md/stargazers) first.
