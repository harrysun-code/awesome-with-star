 ...
 * [ISLE](https://github.com/nasa/isle) [![GitHub stars](https://img.shields.io/github/stars/nasa/isle?style=flat)](https://github.com/nasa/isle/stargazers) - Open-source laboratory equipment inventory management system developed by NASA.
 ...
 * [RapidPro](https://github.com/rapidpro/rapidpro) [![GitHub stars](https://img.shields.io/github/stars/rapidpro/rapidpro?style=flat)](https://github.com/rapidpro/rapidpro/stargazers) - An open-source platform for building scalable applications that users can interact with via SMS.
 * [eu-citizen.science](https://eu-citizen.science/) - links to 200 projects
 * [Zooniverse](https://github.com/zooniverse) [![GitHub stars](https://img.shields.io/github/stars/zooniverse?style=flat)](https://github.com/zooniverse/stargazers) - website for zoo & universe projects
 ...
 * [IMGtoKMZ](https://github.com/s5rt/IMGtoKMZ) [![GitHub stars](https://img.shields.io/github/stars/s5rt/IMGtoKMZ?style=flat)](https://github.com/s5rt/IMGtoKMZ/stargazers) - A simple tool to convert a batch of geotagged images into a KMZ file, with one placemark per photograph.
 ...
 * **Familiar with GitHub?** Send a pull request with your suggestions. Please also see the [contribution guidelines](https://github.com/dylanrees/toolsforcitizenscience/blob/master/contributing.md) [![GitHub stars](https://img.shields.io/github/stars/dylanrees/toolsforcitizenscience/blob/master/contributing.md?style=flat)](https://github.com/dylanrees/toolsforcitizenscience/blob/master/contributing.md/stargazers).
