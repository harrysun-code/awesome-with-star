...
- [gatevay](https://github.com/tailsmails/gatevay) [![GitHub stars](https://img.shields.io/github/stars/tailsmails/gatevay?style=flat)](https://github.com/tailsmails/gatevay/stargazers) - A lightweight, multi-gateway SOCKS5 proxy tool.
...
- [oscall](https://github.com/tailsmails/oscall) [![GitHub stars](https://img.shields.io/github/stars/tailsmails/oscall?style=flat)](https://github.com/tailsmails/oscall/stargazers) - A native, low-level CLI utility written in V for inspecting, loading, and dynamically executing arbitrary C/C++ functions.
...
- [pixviper](https://github.com/tailsmails/pixviper) [![GitHub stars](https://img.shields.io/github/stars/tailsmails/pixviper?style=flat)](https://github.com/tailsmails/pixviper/stargazers) - A parallel template matching and de-redaction investigation tool written in V.
...
- [vsnap](https://github.com/skandhas/vsnap) [![GitHub stars](https://img.shields.io/github/stars/skandhas/vsnap?style=flat)](https://github.com/skandhas/vsnap/stargazers) - A tiny local snapshot tool for saving and restoring files before risky edits, lighter than Git and built around explicit paths.
...
- [rxv](https://github.com/ulises-jeremias/rxv) [![GitHub stars](https://img.shields.io/github/stars/ulises-jeremias/rxv?style=flat)](https://github.com/ulises-jeremias/rxv/stargazers) - Reactive Extensions for the V language. Compose async event streams with creation, filtering, transformation, aggregation, timing, and combination operators.
...
- [vsl.vcl](https://github.com/vlang/vsl/tree/main/vcl#readme) [![GitHub stars](https://img.shields.io/github/stars/vlang/vsl/tree/main/vcl?style=flat)](https://github.com/vlang/vsl/tree/main/vcl/stargazers) - VCL is a high level way of writing programs with OpenCL using V. These are highly opinionated OpenCL bindings for V. It tries to make GPU computing easy, with some sugar abstraction, V's concurrency and channels.
- [vsl.plot](https://github.com/vlang/vsl/tree/main/plot#readme) [![GitHub stars](https://img.shields.io/github/stars/vlang/vsl/tree/main/plot?style=flat)](https://github.com/vlang/vsl/tree/main/plot/stargazers) - Plotting module for VSL with 85+ examples. Create line charts, scatter plots, 3D surfaces, bar charts, box plots, histograms, heatmaps, and more.
...
- [rgc](https://github.com/tailsmails/rgc) [![GitHub stars](https://img.shields.io/github/stars/tailsmails/rgc?style=flat)](https://github.com/tailsmails/rgc/stargazers) - A lightweight, concurrent resource garbage collector for V.
- [vcomp](https://github.com/tailsmails/vcomp) [![GitHub stars](https://img.shields.io/github/stars/tailsmails/vcomp?style=flat)](https://github.com/tailsmails/vcomp/stargazers) - A lightweight Linux Seccomp (Secure Computing Mode) BPF filter wrapper for vlang.
...
- [vsl.fft](https://github.com/vlang/vsl/tree/main/fft#readme) [![GitHub stars](https://img.shields.io/github/stars/vlang/vsl/tree/main/fft?style=flat)](https://github.com/vlang/vsl/tree/main/fft/stargazers) - Fast Fourier Transform module for VSL. Includes real and complex FFT with multiple backend options.
- [vsl.ml](https://github.com/vlang/vsl/tree/main/ml#readme) [![GitHub stars](https://img.shields.io/github/stars/vlang/vsl/tree/main/ml?style=flat)](https://github.com/vlang/vsl/tree/main/ml/stargazers) - Machine Learning module for VSL with K-means, KNN, linear/logistic regression, SVM, decision trees, random forest, and more.
- [vsl.quaternion](https://github.com/vlang/vsl/tree/main/quaternion#readme) [![GitHub stars](https://img.shields.io/github/stars/vlang/vsl/tree/main/quaternion?style=flat)](https://github.com/vlang/vsl/tree/main/quaternion/stargazers) - Quaternion math module for VSL. Supports 3D rotations, spherical linear interpolation (slerp), and Julia fractal generation.
...
- [vtl.autograd](https://github.com/vlang/vtl/tree/main/autograd#readme) [![GitHub stars](https://img.shields.io/github/stars/vlang/vtl/tree/main/autograd?style=flat)](https://github.com/vlang/vtl/tree/main/autograd/stargazers) - Automatic differentiation module for VTL. Enables gradient computation for machine learning and optimization.
- [vtl.datasets](https://github.com/vlang/vtl/tree/main/datasets#readme) [![GitHub stars](https://img.shields.io/github/stars/vlang/vtl/tree/main/datasets?style=flat)](https://github.com/vlang/vtl/tree/main/datasets/stargazers) - Datasets module for VTL providing built-in datasets for ML benchmarking and tutorials.
- [vtl.nn](https://github.com/vlang/vtl/tree/main/nn#readme) [![GitHub stars](https://img.shields.io/github/stars/vlang/vtl/tree/main/nn?style=flat)](https://github.com/vlang/vtl/tree/main/nn/stargazers) - Neural Networks module for VTL. Build and train deep learning models with layers, activations, and optimizers.
...
- [v-hash](https://github.com/deatil/v-hash) [![GitHub stars](https://img.shields.io/github/stars/deatil/v-hash?style=flat)](https://github.com/deatil/v-hash/stargazers) - A hash library for vlang.
- [v-rsa](https://github.com/deatil/v-rsa) [![GitHub stars](https://img.shields.io/github/stars/deatil/v-rsa?style=flat)](https://github.com/deatil/v-rsa/stargazers) - A RSA library for vlang.
...
- [vop](https://github.com/tailsmails/vop) [![GitHub stars](https://img.shields.io/github/stars/tailsmails/vop?style=flat)](https://github.com/tailsmails/vop/stargazers) - A message-passing object protocol providing dynamic property management and closure-based state encapsulation.
...
- [setup-v](https://github.com/vlang/setup-v) [![GitHub stars](https://img.shields.io/github/stars/vlang/setup-v?style=flat)](https://github.com/vlang/setup-v/stargazers) - GitHub Action to install and use V in your workflow. Available on the [marketplace](https://github.com/marketplace/actions/setup-vlang) [![GitHub stars](https://img.shields.io/github/stars/marketplace/actions/setup-vlang?style=flat)](https://github.com/marketplace/actions/setup-vlang/stargazers).
