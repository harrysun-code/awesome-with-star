...
- [PiSpot Show](https://github.com/GeiserX/PiSpot-Show) [![GitHub stars](https://img.shields.io/github/stars/GeiserX/PiSpot-Show?style=flat)](https://github.com/GeiserX/PiSpot-Show/stargazers) - Raspberry Pi WiFi voucher display system with weather integration and PiJuice battery management.
- [PiSpot Watch](https://github.com/GeiserX/PiSpot-Watch) [![GitHub stars](https://img.shields.io/github/stars/GeiserX/PiSpot-Watch?style=flat)](https://github.com/GeiserX/PiSpot-Watch/stargazers) - Software for running a PiSpot Watch (composed of a Raspberry Pi Zero and a PaPiRus Zero) for the company GPConnect.
- [AutoPi](https://github.com/autopi-io/autopi-core) [![GitHub stars](https://img.shields.io/github/stars/autopi-io/autopi-core?style=flat)](https://github.com/autopi-io/autopi-core/stargazers) - Open-source core software for the AutoPi dongle, a Raspberry Pi-based OBD-II device for connected vehicle telematics, CAN bus data collection, and automotive IoT applications.
...
#### Operating systems
 ...
 - [Tiny OS](https://github.com/tinyos/tinyos-main) [![GitHub stars](https://img.shields.io/github/stars/tinyos/tinyos-main?style=flat)](https://github.com/tinyos/tinyos-main/stargazers) - TinyOS is an open source, BSD-licensed operating system designed for low-power wireless devices, such as those used in sensor networks, ubiquitous computing, personal area networks, smart buildings, and smart meters.
...
> This section regroups every awesome programming language, whether it is compiled, interpreted or a DSL, related to embedded development.
 ...
 - [PikaPython](https://github.com/pikastech/pikapython) [![GitHub stars](https://img.shields.io/github/stars/pikastech/pikapython?style=flat)](https://github.com/pikastech/pikapython/stargazers) - Python runs with only 4KB of RAM, zero dependencies, easy to bind with C.
 - [PharoThings](https://github.com/pharo-iot/PharoThings) [![GitHub stars](https://img.shields.io/github/stars/pharo-iot/PharoThings?style=flat)](https://github.com/pharo-iot/PharoThings/stargazers) - Live programming platform for IoT projects based on [Pharo](https://pharo.org/) (a pure object-oriented programming language and a powerful environment, focused on simplicity and immediate feedback).
...
#### Frameworks
 ...
 - [homebridge-blink-security](https://github.com/BitWise-0x/homebridge-blink-security) [![GitHub stars](https://img.shields.io/github/stars/BitWise-0x/homebridge-blink-security?style=flat)](https://github.com/BitWise-0x/homebridge-blink-security/stargazers) - A Homebridge plugin for integrating Blink cameras, doorbells, and sirens with Apple HomeKit, featuring live streaming, arm/disarm, and motion detection.
 - [homebridge-smartrent](https://github.com/BitWise-0x/homebridge-smartrent) [![GitHub stars](https://img.shields.io/github/stars/BitWise-0x/homebridge-smartrent?style=flat)](https://github.com/BitWise-0x/homebridge-smartrent/stargazers) - A Homebridge plugin for integrating SmartRent locks, thermostats, leak sensors, and switches with Apple HomeKit via real-time WebSocket connection.
 - [AREG SDK](https://github.com/aregtech/areg-sdk) [![GitHub stars](https://img.shields.io/github/stars/aregtech/areg-sdk?style=flat)](https://github.com/aregtech/areg-sdk/stargazers) - AREG SDK is an interface-centric real-time asynchronous communication engine to enable distributed- and [mist-](https://csrc.nist.gov/publications/detail/sp/500-325/final)computing, where connected Things interact and provide services, as if they act like thin distributed servers.
 - [Astarte](https://github.com/astarte-platform/astarte) [![GitHub stars](https://img.shields.io/github/stars/astarte-platform/astarte?style=flat)](https://github.com/astarte-platform/astarte/stargazers) - Astarte is an Open Source IoT platform written in Elixir. It is a turnkey solution which packs in everything you need for connecting a device fleet to a set of remote applications. It performs data modeling, automated data reduction, real-time events, and provides you with any feature you might expect in a modern IoT platform. Right now, Linux and ESP32 devices are supported out of the box using the provided SDKs.
 ...
 - [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) [![GitHub stars](https://img.shields.io/github/stars/jumpstarter-dev/jumpstarter?style=flat)](https://github.com/jumpstarter-dev/jumpstarter/stargazers) - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
 ...
 - [Macchina.io](https://github.com/macchina-io/macchina.io) [![GitHub stars](https://img.shields.io/github/stars/macchina-io/macchina.io?style=flat)](https://github.com/macchina-io/macchina.io/stargazers) - macchina.io EDGE is a rich software framework for quickly building IoT device applications running on Linux-based devices. macchina.io EDGE implements a web-enabled, secure, modular and extensible JavaScript and C++ runtime environment and provides ready-to-use and industry proven software building blocks. These enable devices to talk to various sensors, other devices and cloud services, and to process, analyze and filter sensor data locally, at the edge device or within the local network.
 ...
 - [Home Assistant](https://github.com/home-assistant/home-assistant) [![GitHub stars](https://img.shields.io/github/stars/home-assistant/home-assistant?style=flat)](https://github.com/home-assistant/home-assistant/stargazers) - Home Assistant is a home automation platform running on Python 3. The goal of Home Assistant is to be able to track and control all devices at home and offer a platform for automating control.
 ...
 - [Thingsboard IoT Gateway](https://github.com/thingsboard/thingsboard-gateway) [![GitHub stars](https://img.shields.io/github/stars/thingsboard/thingsboard-gateway?style=flat)](https://github.com/thingsboard/thingsboard-gateway/stargazers) - Open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
 ...
 - [MyController](https://github.com/mycontroller-org/mycontroller) [![GitHub stars](https://img.shields.io/github/stars/mycontroller-org/mycontroller?style=flat)](https://github.com/mycontroller-org/mycontroller/stargazers) - The Open Source Controller. MyController.org is an IoT automation controller for home, office or any place.
...
#### Middlewares
 ...
 - [Huginn](https://github.com/cantino/huginn) [![GitHub stars](https://img.shields.io/github/stars/cantino/huginn?style=flat)](https://github.com/cantino/huginn/stargazers) - Huginn is a system for building agents that perform automated tasks for you online.
 ...
 - [VerneMQ](https://github.com/erlio/vernemq) [![GitHub stars](https://img.shields.io/github/stars/erlio/vernemq?style=flat)](https://github.com/erlio/vernemq/stargazers) - VerneMQ is a high-performance, distributed MQTT broker that connects IoT, M2M, Mobile, and web applications. It scales horizontally and vertically on commodity hardware to support a high number of concurrent publishers and consumers while maintaining low latency and fault tolerance.
 - [Kuzzle](https://github.com/kuzzleio/kuzzle) [![GitHub stars](https://img.shields.io/github/stars/kuzzleio/kuzzle?style=flat)](https://github.com/kuzzleio/kuzzle/stargazers) - An open-source backend with advanced features like real-time pub/sub or geofencing and a multiprotocol interface that supports MQTT, LoRaWAN and more. ([Website](https://kuzzle.io/solutions/technologies/iot-backend/))
 ...
 - [NanoMQ](https://github.com/nanomq/nanomq) [![GitHub stars](https://img.shields.io/github/stars/nanomq/nanomq?style=flat)](https://github.com/nanomq/nanomq/stargazers) - A lightweight and Blazing-fast MQTT Broker for IoT Edge platform.
 - [Kuiper](https://github.com/emqx/kuiper) [![GitHub stars](https://img.shields.io/github/stars/emqx/kuiper?style=flat)](https://github.com/emqx/kuiper/stargazers) - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run on all kinds of resource-constrained edge devices.
 - [t6](https://github.com/mathcoll/t6) [![GitHub stars](https://img.shields.io/github/stars/mathcoll/t6?style=flat)](https://github.com/mathcoll/t6/stargazers) - Data-first IoT platform to connect physical Objects with time-series DB and perform Data Analysis.
 - [IoTSharp](https://github.com/IoTSharp/IoTSharp) [![GitHub stars](https://img.shields.io/github/stars/IoTSharp/IoTSharp?style=flat)](https://github.com/IoTSharp/IoTSharp/stargazers) - IoTSharp is an open-source IoT platform for data collection, processing, visualization, and device management.
 ...
 - [Zilla](https://github.com/aklivity/zilla) [![GitHub stars](https://img.shields.io/github/stars/aklivity/zilla?style=flat)](https://github.com/aklivity/zilla/stargazers) - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
 - [IoT DC3](https://github.com/pnoker/iot-dc3) [![GitHub stars](https://img.shields.io/github/stars/pnoker/iot-dc3?style=flat)](https://github.com/pnoker/iot-dc3/stargazers) - Fully open-source, distributed industrial IoT platform built on Spring Cloud, with 28 built-in protocol drivers (Modbus, OPC UA, Siemens S7, BACnet, MQTT, CoAP), AI-powered operations, and microservice architecture. ([Docs](https://docs.dc3.site))
 - [DeviceChain](https://github.com/devicechain-io/devicechain) [![GitHub stars](https://img.shields.io/github/stars/devicechain-io/devicechain?style=flat)](https://github.com/devicechain-io/devicechain/stargazers) - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes, with MQTT, Sparkplug B and LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine driving alarms and outbound connectors (webhooks, MQTT, Kafka, cloud queues), versioned dashboards, and GraphQL APIs. ([Docs](https://docs.devicechain.io))

#### Libraries and Tools

 - [aem-modbus-simulator](https://github.com/leaberg69/aem-modbus-simulator) [![GitHub stars](https://img.shields.io/github/stars/leaberg69/aem-modbus-simulator?style=flat)](https://github.com/leaberg69/aem-modbus-simulator/stargazers) - Open-source Python Modbus RTU/TCP slave simulator emulating the LRI AEM-60DC8 industrial DC monitor. Mirrors 147 holding registers, 8 DC channels, six baudrates (4,800-115,200). Useful for SCADA/PLC integration testing without physical hardware.
 - [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) [![GitHub stars](https://img.shields.io/github/stars/KristianP26/ble-scale-sync?style=flat)](https://github.com/KristianP26/ble-scale-sync/stargazers) - Cross-platform Node.js CLI that reads BLE smart scales (23 brands), calculates body composition, and exports to Garmin Connect, MQTT, InfluxDB, Webhook, and Ntfy. Runs on Raspberry Pi, Linux, macOS, and Windows.
 ...
 - [SmartObject](https://github.com/PeterEB/smartobject) [![GitHub stars](https://img.shields.io/github/stars/PeterEB/smartobject?style=flat)](https://github.com/PeterEB/smartobject/stargazers) - A Smart Object Class that helps you with creating IPSO Smart Objects in your JavaScript applications. See also: IPSO Alliance [Technical Archive](http://www.ipso-alliance.org/ipso-community/resources/technical-archive/).
 - [United Manufacturing Hub](https://github.com/united-manufacturing-hub/united-manufacturing-hub) [![GitHub stars](https://img.shields.io/github/stars/united-manufacturing-hub/united-manufacturing-hub?style=flat)](https://github.com/united-manufacturing-hub/united-manufacturing-hub/stargazers) - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example, Nodered, VerneMQ and timescaleDB)
 - [QuestDB](https://github.com/questdb/questdb) [![GitHub stars](https://img.shields.io/github/stars/questdb/questdb?style=flat)](https://github.com/questdb/questdb/stargazers) - an open source time series database used for real-time analytics and high-performance applications. Supports high-throughput ingestion over InfluxDB line protocol and SQL as a query language.
 - [Chaos Genius](https://github.com/chaos-genius/chaos_genius) [![GitHub stars](https://img.shields.io/github/stars/chaos-genius/chaos_genius?style=flat)](https://github.com/chaos-genius/chaos_genius/stargazers) - an open source ML powered analytics engine for outlier/anomaly detection and root cause analysis. Connect with sensor data, monitor and get alerted on abnormal behavior.  
 ...
 - [ThingsOn MQTT Bench](https://github.com/volkanalkilic/ThingsOn.MQTT.Bench) [![GitHub stars](https://img.shields.io/github/stars/volkanalkilic/ThingsOn.MQTT.Bench?style=flat)](https://github.com/volkanalkilic/ThingsOn.MQTT.Bench/stargazers) - ThingsOn MQTT Bench is a simple Cross-platform .NET Core benchmark tool for MQTT brokers. It measures the maximum number of messages that can be sent to the broker in a specified amount of time.
 - [ReductStore](https://github.com/reductstore/reductstore) [![GitHub stars](https://img.shields.io/github/stars/reductstore/reductstore?style=flat)](https://github.com/reductstore/reductstore/stargazers) - high-performance blob and time-series storage for industrial IoT, with edge deployment, selective replication, and efficient querying of multimodal data. 
...
#### Miscellaneous
 ...
 - [BirdNET-Go](https://github.com/tphakala/birdnet-go) [![GitHub stars](https://img.shields.io/github/stars/tphakala/birdnet-go?style=flat)](https://github.com/tphakala/birdnet-go/stargazers) - Realtime wildlife soundscape analyser with multi-model AI inference, MQTT publishing with Home Assistant discovery, and web dashboard.
 - [Electrum](https://github.com/yoelf22/electrum) [![GitHub stars](https://img.shields.io/github/stars/yoelf22/electrum?style=flat)](https://github.com/yoelf22/electrum/stargazers) - A structured, AI-assisted toolkit for defining hardware products that have software inside — from concept through engineering spec to presentation-ready materials in eight phases.
 ...
 - [authBroker](https://github.com/authbroker/authbroker) [![GitHub stars](https://img.shields.io/github/stars/authbroker/authbroker?style=flat)](https://github.com/authbroker/authbroker/stargazers) - A Keycloak HTTP/MQTT/CoAP IoT Brokers Adapter like Aedes.
 - [MQTT File Uploader](https://github.com/volkanalkilic/Mqtt-File-Uploader) [![GitHub stars](https://img.shields.io/github/stars/volkanalkilic/Mqtt-File-Uploader?style=flat)](https://github.com/volkanalkilic/Mqtt-File-Uploader/stargazers) - MQTT File Uploader is a simple Cross-platform .NET Core application that watches local directories for changes and uploads new or modified files to an MQTT broker.
 - [PiSpot-Show](https://github.com/GeiserX/PiSpot-Show) [![GitHub stars](https://img.shields.io/github/stars/GeiserX/PiSpot-Show?style=flat)](https://github.com/GeiserX/PiSpot-Show/stargazers) - Raspberry Pi WiFi voucher display system with weather integration and PiJuice battery management.
...
#### <img width="50" src="https://www.pjon.org/assets/images/PJON-logo-devices.jpg" /> - [PJON](https://github.com/gioblu/PJON/) [![GitHub stars](https://img.shields.io/github/stars/gioblu/PJON/?style=flat)](https://github.com/gioblu/PJON//stargazers)
...
To the extent possible under law, [Halim Qarroum](https://github.com/HQarroum/) [![GitHub stars](https://img.shields.io/github/stars/HQarroum/?style=flat)](https://github.com/HQarroum//stargazers) has waived all copyright and related or neighboring rights to this work.
