...
> 来源：[NPACore/awesome-neuroimaging](https://github.com/NPACore/awesome-neuroimaging)

[![GitHub stars](https://img.shields.io/github/stars/NPACore/awesome-neuroimaging?style=flat)](https://github.com/NPACore/awesome-neuroimaging/stargazers)
...
- [XNAT](https://www.xnat.org/) - An extensible open-source imaging informatics software platform dedicated to imaging-based research.
  - [DAX](https://github.com/VUIIS/dax) [![GitHub stars](https://img.shields.io/github/stars/VUIIS/dax?style=flat)](https://github.com/VUIIS/dax/stargazers) - Distributed Automation for XNAT: use containerization w/YAML defined input/output.
...
- [mrQA](https://github.com/Open-Minds-Lab/mrQA) [![GitHub stars](https://img.shields.io/github/stars/Open-Minds-Lab/mrQA?style=flat)](https://github.com/Open-Minds-Lab/mrQA/stargazers) - Tools for quality assurance in medical imaging datasets, including protocol compliance.
- [bids-validator](https://github.com/bids-standard/bids-validator/) [![GitHub stars](https://img.shields.io/github/stars/bids-standard/bids-validator/?style=flat)](https://github.com/bids-standard/bids-validator//stargazers) - Validator for the Brain Imaging Data Structure.
...
- [HALFpipe](https://github.com/HALFpipe/HALFpipe) [![GitHub stars](https://img.shields.io/github/stars/HALFpipe/HALFpipe?style=flat)](https://github.com/HALFpipe/HALFpipe/stargazers) - User-friendly software that facilitates reproducible analysis of fMRI data.
...
- [fmri_processing_scripts](https://github.com/LabNeuroCogDevel/fmri_processing_scripts) [![GitHub stars](https://img.shields.io/github/stars/LabNeuroCogDevel/fmri_processing_scripts?style=flat)](https://github.com/LabNeuroCogDevel/fmri_processing_scripts/stargazers) - Legacy pipeline for maximal preprocessing.
...
- [dcm2niix](https://github.com/rordenlab/dcm2niix) [![GitHub stars](https://img.shields.io/github/stars/rordenlab/dcm2niix?style=flat)](https://github.com/rordenlab/dcm2niix/stargazers) - DICOM to NIfTI converter.
- [heudiconv](https://github.com/nipy/heudiconv/) [![GitHub stars](https://img.shields.io/github/stars/nipy/heudiconv/?style=flat)](https://github.com/nipy/heudiconv//stargazers) - A flexible DICOM converter for organizing brain imaging data into structured directory layouts.
...
<!--lint ignore double-link-->
- [`dcmdirtab`, `dcmtab_bids`](https://lncd.github.io/lncdtools/BIDS/) - CLI focused, regular expression based, and iteration friendly BIDS conversion pipeline from [lncdtools](https://github.com/lncd/lncdtools/) [![GitHub stars](https://img.shields.io/github/stars/lncd/lncdtools/?style=flat)](https://github.com/lncd/lncdtools//stargazers).
...
- [datalad](https://github.com/datalad/datalad) [![GitHub stars](https://img.shields.io/github/stars/datalad/datalad?style=flat)](https://github.com/datalad/datalad/stargazers) - Keep code, data, containers under control with `git` and `git-annex`. Esp `datalad run --input=... --output=...`.
...
<!--lint ignore double-link-->
- [`niinote`](https://github.com/lncd/lncdtools/blob/master/niinote) [![GitHub stars](https://img.shields.io/github/stars/lncd/lncdtools/blob/master/niinote?style=flat)](https://github.com/lncd/lncdtools/blob/master/niinote/stargazers) - Add AFNI nifti XML history to header to run and record any command. Part of [lncdtools](https://github.com/lncd/lncdtools/) [![GitHub stars](https://img.shields.io/github/stars/lncd/lncdtools/?style=flat)](https://github.com/lncd/lncdtools//stargazers).
...
- [lcmodel](https://github.com/schorschinho/LCModel) [![GitHub stars](https://img.shields.io/github/stars/schorschinho/LCModel?style=flat)](https://github.com/schorschinho/LCModel/stargazers) - Implements linear-combination modeling of magnetic resonance spectroscopy data.
...
- [Osprey](https://github.com/schorschinho/osprey) [![GitHub stars](https://img.shields.io/github/stars/schorschinho/osprey?style=flat)](https://github.com/schorschinho/osprey/stargazers) - An all-in-one software suite for state-of-the art processing and quantitative analysis of in-vivo magnetic resonance spectroscopy (MRS) data.
...
#### Misc
- [hurst](https://github.com/elifesciences-publications/ei_hurst/) [![GitHub stars](https://img.shields.io/github/stars/elifesciences-publications/ei_hurst/?style=flat)](https://github.com/elifesciences-publications/ei_hurst//stargazers) - Algorithm to assess intrinsic excitation-inhibition imbalance in MR ([Trakoshis et al, eLife, 2020](http://doi.org/10.7554/eLife.55684)).
<!--lint ignore double-link-->
- [tat2](https://lncd.github.io/lncdtools/tat2/) - Time-averaged T2* wrapper script using AFNI binaries from [lncdtools](https://github.com/lncd/lncdtools/) [![GitHub stars](https://img.shields.io/github/stars/lncd/lncdtools/?style=flat)](https://github.com/lncd/lncdtools//stargazers).
...
### R
- [oro.nifti](https://github.com/bjw34032/oro.nifti) [![GitHub stars](https://img.shields.io/github/stars/bjw34032/oro.nifti?style=flat)](https://github.com/bjw34032/oro.nifti/stargazers) - Functions for the input/output and visualization of medical imaging data that follow either the ANALYZE, NIfTI or AFNI formats.

### MATLAB

<!--lint ignore double-link-->
- [SPM](https://www.fil.ion.ucl.ac.uk/spm/) - Statistical Parametric Mapping refers to the construction and assessment of spatially extended statistical processes used to test hypotheses about functional imaging data.
- [`imtool3D_td`](https://github.com/tanguyduval/imtool3D_td) [![GitHub stars](https://img.shields.io/github/stars/tanguyduval/imtool3D_td?style=flat)](https://github.com/tanguyduval/imtool3D_td/stargazers) - 3D Image Viewer with ROI tools for Matlab (NIFTI viewer, Manual segmentation).
