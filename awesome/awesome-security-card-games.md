...
- [Defensomania](https://github.com/Karneades/Defensomania) [![GitHub stars](https://img.shields.io/github/stars/Karneades/Defensomania?style=flat)](https://github.com/Karneades/Defensomania/stargazers) - An incident response card game for security monitoring and incident response teams to discuss priorities, possible response actions and attack scenarios.

## Threat Modeling

- [Elevation of Privilege (EOP) by Microsoft](https://web.archive.org/web/20150312215303/http://www.microsoft.com/security/sdl/adopt/eop.aspx) - A card game based on Microsoft's threat modeling framework "STRIDE" (Spoofing, Tampering etc.). The [card deck](https://www.microsoft.com/en-us/download/details.aspx?id=20303) is available as PDF from Microsoft. Adam Shostack, the author of EoP has also a [git repo](https://github.com/adamshostack/eop/) [![GitHub stars](https://img.shields.io/github/stars/adamshostack/eop/?style=flat)](https://github.com/adamshostack/eop//stargazers) for EoP.
...
- [Cumulus](https://github.com/TNG/cumulus) [![GitHub stars](https://img.shields.io/github/stars/TNG/cumulus?style=flat)](https://github.com/TNG/cumulus/stargazers) - A threat modeling card game for the clouds which helps you find threats to your DevOps or cloud project and teaches developers a security oriented mindset.
