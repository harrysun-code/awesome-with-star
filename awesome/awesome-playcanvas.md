...
- [PlayCanvas Engine](https://github.com/playcanvas/engine) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/engine?style=flat)](https://github.com/playcanvas/engine/stargazers) - Open source JavaScript graphics application framework.
- [PlayCanvas Editor](https://playcanvas.com/) - Browser-based editor for creating 3D web applications.
- [PlayCanvas React](https://github.com/playcanvas/react) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/react?style=flat)](https://github.com/playcanvas/react/stargazers) - Open source React wrapper for the PlayCanvas Engine.
- [PlayCanvas Web Components](https://github.com/playcanvas/web-components) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/web-components?style=flat)](https://github.com/playcanvas/web-components/stargazers) - Open source Web Components wrapper for the PlayCanvas Engine.
- [Model Viewer](https://playcanvas.com/viewer) - Open source model viewer for viewing glTF and PLY (3D Gaussian Splats) files.
- [Texture Tool](https://github.com/playcanvas/texture-tool) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/texture-tool?style=flat)](https://github.com/playcanvas/texture-tool/stargazers) - Open source tool for reprojecting textures.
- [PCUI](https://github.com/playcanvas/pcui) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/pcui?style=flat)](https://github.com/playcanvas/pcui/stargazers) - Open source front-end framework used by the PlayCanvas toolset.
...
- [Kinematic Character Controller](https://github.com/tatelax/playcanvas-kinematic-character-controller) [![GitHub stars](https://img.shields.io/github/stars/tatelax/playcanvas-kinematic-character-controller?style=flat)](https://github.com/tatelax/playcanvas-kinematic-character-controller/stargazers) - An open-source kinematic character controller.
- [playcanvas-ar](https://github.com/playcanvas/playcanvas-ar) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/playcanvas-ar?style=flat)](https://github.com/playcanvas/playcanvas-ar/stargazers) - Marker-based AR solution built on ARToolkit.
- [playcanvas-node](https://github.com/yushimatenjin/playcanvas-node) [![GitHub stars](https://img.shields.io/github/stars/yushimatenjin/playcanvas-node?style=flat)](https://github.com/yushimatenjin/playcanvas-node/stargazers) - REST API wrapper for Node.js.
- [playcanvas-opti-pixel](https://github.com/AlexAPPi/playcanvas-opti-pixel) [![GitHub stars](https://img.shields.io/github/stars/AlexAPPi/playcanvas-opti-pixel?style=flat)](https://github.com/AlexAPPi/playcanvas-opti-pixel/stargazers) - GPU instancing, LOD, BVH frustum culling, and occlusion culling.
- [playcanvas-p2.js](https://github.com/playcanvas/playcanvas-p2.js) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/playcanvas-p2.js?style=flat)](https://github.com/playcanvas/playcanvas-p2.js/stargazers) - An integration with the p2.js 2D physics engine.
- [playcanvas-react-colyseus](https://github.com/JonasPfi/PlayCanvasReactColyseus) [![GitHub stars](https://img.shields.io/github/stars/JonasPfi/PlayCanvasReactColyseus?style=flat)](https://github.com/JonasPfi/PlayCanvasReactColyseus/stargazers) - Starter template for multiplayer games with React and Colyseus.
- [playcanvas-rest-api-tools](https://github.com/playcanvas/playcanvas-rest-api-tools) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/playcanvas-rest-api-tools?style=flat)](https://github.com/playcanvas/playcanvas-rest-api-tools/stargazers) - CLI tools built on the PlayCanvas REST API.
- [playcanvas-spine](https://github.com/playcanvas/playcanvas-spine) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/playcanvas-spine?style=flat)](https://github.com/playcanvas/playcanvas-spine/stargazers) - Spine plugin for PlayCanvas for 2D animations.
- [playcanvas-tween](https://github.com/playcanvas/playcanvas-tween) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/playcanvas-tween?style=flat)](https://github.com/playcanvas/playcanvas-tween/stargazers) - Officially supported tween animation plugin.
- [playcanvas-vue](https://github.com/isobolewski/playcanvas-vue) [![GitHub stars](https://img.shields.io/github/stars/isobolewski/playcanvas-vue?style=flat)](https://github.com/isobolewski/playcanvas-vue/stargazers) - A PlayCanvas integration with Vue.js.
- [@recast-navigation/playcanvas](https://www.npmjs.com/package/@recast-navigation/playcanvas) - NavMesh and Pathfinding using [Recast](https://github.com/recastnavigation/recastnavigation) [![GitHub stars](https://img.shields.io/github/stars/recastnavigation/recastnavigation?style=flat)](https://github.com/recastnavigation/recastnavigation/stargazers) for PlayCanvas.
- [tween.js](https://github.com/tweenjs/tween.js/) [![GitHub stars](https://img.shields.io/github/stars/tweenjs/tween.js/?style=flat)](https://github.com/tweenjs/tween.js//stargazers) - Popular JavaScript tweening library that integrates easily with PlayCanvas.
- [Sublime Completions](https://github.com/playcanvas/sublime-completions) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/sublime-completions?style=flat)](https://github.com/playcanvas/sublime-completions/stargazers) - Sublime Text Autocompletion for the PlayCanvas API.
...
Please see [CONTRIBUTING](https://github.com/playcanvas/awesome-playcanvas/blob/master/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/playcanvas/awesome-playcanvas/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/playcanvas/awesome-playcanvas/blob/master/CONTRIBUTING.md/stargazers) for details.
