...
* [Center for Computational Pharmacology NLP Group](http://compbio.ucdenver.edu/Hunter_lab/CCP_website/index.html) - based at University of Colorado, Denver and led by Larry Hunter - [see their GitHub repos here.](https://github.com/UCDenver-ccp) [![GitHub stars](https://img.shields.io/github/stars/UCDenver-ccp?style=flat)](https://github.com/UCDenver-ccp/stargazers)
...
* [Biopython](https://biopython.org/) - [paper](http://dx.doi.org/10.1093/bioinformatics/btp163) - [code](https://github.com/biopython/biopython) [![GitHub stars](https://img.shields.io/github/stars/biopython/biopython?style=flat)](https://github.com/biopython/biopython/stargazers) - Python tools primarily intended for bioinformatics and computational molecular biology purposes, but also a convenient way to obtain data, including documents/abstracts from PubMed (see Chapter 9 of the documentation).
* [Bio-SCoRes](https://github.com/kilicogluh/Bio-SCoRes) [![GitHub stars](https://img.shields.io/github/stars/kilicogluh/Bio-SCoRes?style=flat)](https://github.com/kilicogluh/Bio-SCoRes/stargazers) - [paper](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0148538) - A framework for biomedical coreference resolution.
* [medaCy](https://github.com/NLPatVCU/medaCy) [![GitHub stars](https://img.shields.io/github/stars/NLPatVCU/medaCy?style=flat)](https://github.com/NLPatVCU/medaCy/stargazers) - A system for building predictive medical natural language processing models. Built on the [spaCy](https://spacy.io/) framework. 
* [ScispaCy](https://github.com/allenai/SciSpaCy) [![GitHub stars](https://img.shields.io/github/stars/allenai/SciSpaCy?style=flat)](https://github.com/allenai/SciSpaCy/stargazers) - [paper](https://arxiv.org/abs/1902.07669) - A version of the [spaCy](https://spacy.io/) framework for scientific and biomedical documents.
* [rentrez](https://github.com/ropensci/rentrez) [![GitHub stars](https://img.shields.io/github/stars/ropensci/rentrez?style=flat)](https://github.com/ropensci/rentrez/stargazers) - R utilities for accessing NCBI resources, including PubMed.
* [Med7](https://medium.com/@kormilitzin/med7-clinical-information-extraction-system-in-python-and-spacy-5e6f68ab1c68) - [paper](https://arxiv.org/abs/2003.01271) - [code](https://github.com/kormilitzin/med7) [![GitHub stars](https://img.shields.io/github/stars/kormilitzin/med7?style=flat)](https://github.com/kormilitzin/med7/stargazers) - a Python package and model (for use with spaCy) for doing NER with medication-related concepts.

### Repos for Specific Datasets

* [mimic-code](https://github.com/MIT-LCP/mimic-code) [![GitHub stars](https://img.shields.io/github/stars/MIT-LCP/mimic-code?style=flat)](https://github.com/MIT-LCP/mimic-code/stargazers) - Code associated with the MIMIC-III dataset (see below). Includes some helpful [tutorials](https://github.com/MIT-LCP/mimic-code/tree/master/tutorials) [![GitHub stars](https://img.shields.io/github/stars/MIT-LCP/mimic-code/tree/master/tutorials?style=flat)](https://github.com/MIT-LCP/mimic-code/tree/master/tutorials/stargazers).

[Back to Top](#contents)

## Tools, Platforms, and Services

* [cTAKES](https://ctakes.apache.org/) - [paper](https://academic.oup.com/jamia/article/17/5/507/830823) - [code](https://github.com/apache/ctakes) [![GitHub stars](https://img.shields.io/github/stars/apache/ctakes?style=flat)](https://github.com/apache/ctakes/stargazers) - A system for processing the text in electronic medical records. Widely used and open source. 
...
* [DeepPhe](https://github.com/DeepPhe/DeepPhe-Release) [![GitHub stars](https://img.shields.io/github/stars/DeepPhe/DeepPhe-Release?style=flat)](https://github.com/DeepPhe/DeepPhe-Release/stargazers) - A system for processing documents describing cancer presentations. Based on cTAKES (see above).
...
* [Pubrunner](https://github.com/jakelever/pubrunner) [![GitHub stars](https://img.shields.io/github/stars/jakelever/pubrunner?style=flat)](https://github.com/jakelever/pubrunner/stargazers) - A framework for running text mining tools on the newest set(s) of documents from PubMed.
* [SemEHR](https://github.com/CogStack/CogStack-SemEHR) [![GitHub stars](https://img.shields.io/github/stars/CogStack/CogStack-SemEHR?style=flat)](https://github.com/CogStack/CogStack-SemEHR/stargazers) - [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6019046/) - an IE infrastructure for electronic health records (EHR). Built on the [CogStack project](https://github.com/CogStack) [![GitHub stars](https://img.shields.io/github/stars/CogStack?style=flat)](https://github.com/CogStack/stargazers).
...
* [TabInOut](https://github.com/nikolamilosevic86/TabInOut) [![GitHub stars](https://img.shields.io/github/stars/nikolamilosevic86/TabInOut?style=flat)](https://github.com/nikolamilosevic86/TabInOut/stargazers) - [paper](https://link.springer.com/article/10.1007/s10032-019-00317-0) - a framework for IE from tables in the literature.

### Annotation Tools

* [Anafora](https://github.com/weitechen/anafora) [![GitHub stars](https://img.shields.io/github/stars/weitechen/anafora?style=flat)](https://github.com/weitechen/anafora/stargazers) - [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5657237/) - An annotation tool with adjudication and progress tracking features.
* [brat](https://brat.nlplab.org/) - [paper](https://www.aclweb.org/anthology/E12-2021/) - [code](https://github.com/nlplab/brat) [![GitHub stars](https://img.shields.io/github/stars/nlplab/brat?style=flat)](https://github.com/nlplab/brat/stargazers) - The brat rapid annotation tool. Supports producing text annotations visually, through the browser. Not subject specific; appropriate for many annotation projects. Visualization is based on that of the [_stav_ tool](https://github.com/nlplab/stav/) [![GitHub stars](https://img.shields.io/github/stars/nlplab/stav/?style=flat)](https://github.com/nlplab/stav//stargazers).
* [MedTator](https://ohnlp.github.io/MedTator/) - [paper](https://academic.oup.com/bioinformatics/article-abstract/38/6/1776/6496915) - [code](https://github.com/OHNLP/MedTator) [![GitHub stars](https://img.shields.io/github/stars/OHNLP/MedTator?style=flat)](https://github.com/OHNLP/MedTator/stargazers) - An annotation tool designed to have minimal dependencies.
...
### BERT models
* [BioBERT](https://github.com/naver/biobert-pretrained) [![GitHub stars](https://img.shields.io/github/stars/naver/biobert-pretrained?style=flat)](https://github.com/naver/biobert-pretrained/stargazers) - [paper](https://arxiv.org/abs/1901.08746) - [code](https://github.com/dmis-lab/biobert) [![GitHub stars](https://img.shields.io/github/stars/dmis-lab/biobert?style=flat)](https://github.com/dmis-lab/biobert/stargazers) - A PubMed and PubMed Central-trained version of the [BERT language model](https://arxiv.org/abs/1810.04805).
* ClinicalBERT - Two language models trained on clinical text have similar names. Both are BERT models trained on the text of clinical notes from the MIMIC-III dataset.
  * [Alsentzer et al Clinical BERT](https://github.com/EmilyAlsentzer/clinicalBERT) [![GitHub stars](https://img.shields.io/github/stars/EmilyAlsentzer/clinicalBERT?style=flat)](https://github.com/EmilyAlsentzer/clinicalBERT/stargazers) - [paper](https://www.aclweb.org/anthology/W19-1909/)
  * [Huang et al ClinicalBERT](https://github.com/kexinhuang12345/clinicalBERT) [![GitHub stars](https://img.shields.io/github/stars/kexinhuang12345/clinicalBERT?style=flat)](https://github.com/kexinhuang12345/clinicalBERT/stargazers) - [paper](https://arxiv.org/abs/1904.05342)
* [SciBERT](https://github.com/allenai/scibert) [![GitHub stars](https://img.shields.io/github/stars/allenai/scibert?style=flat)](https://github.com/allenai/scibert/stargazers) - [paper](https://arxiv.org/abs/1903.10676) - A BERT model trained on >1M papers from the Semantic Scholar database.
* [BlueBERT](https://github.com/ncbi-nlp/bluebert) [![GitHub stars](https://img.shields.io/github/stars/ncbi-nlp/bluebert?style=flat)](https://github.com/ncbi-nlp/bluebert/stargazers) - [paper](https://arxiv.org/abs/1906.05474) - A BERT model pre-trained on PubMed text and MIMIC-III notes.
...
### GPT-2 models
* [BioGPT](https://github.com/microsoft/BioGPT) [![GitHub stars](https://img.shields.io/github/stars/microsoft/BioGPT?style=flat)](https://github.com/microsoft/BioGPT/stargazers) - [paper](https://doi.org/10.1093/bib/bbac409) - A GPT-2 model pre-trained on 15 million PubMed abstracts, along with fine-tuned versions for several biomedical tasks.

### Other models
* [Flair embeddings from PubMed](https://github.com/zalandoresearch/flair/pull/519) [![GitHub stars](https://img.shields.io/github/stars/zalandoresearch/flair/pull/519?style=flat)](https://github.com/zalandoresearch/flair/pull/519/stargazers) - A language model available through the Flair framework and embedding method. Trained over a 5% sample of PubMed abstracts until 2015, or > 1.2 million abstracts in total.
...
* [BioWordVec](https://figshare.com/articles/Improving_Biomedical_Word_Embeddings_with_Subword_Information_and_MeSH_Ontology/6882647) - [paper](https://www.nature.com/articles/s41597-019-0055-0) - [code](https://github.com/ncbi-nlp/BioWordVec) [![GitHub stars](https://img.shields.io/github/stars/ncbi-nlp/BioWordVec?style=flat)](https://github.com/ncbi-nlp/BioWordVec/stargazers) - Word embeddings derived from biomedical text (>27 million PubMed titles and abstracts), including subword embedding model based on MeSH.
...
* [CRAFT](https://github.com/UCDenver-ccp/CRAFT) [![GitHub stars](https://img.shields.io/github/stars/UCDenver-ccp/CRAFT?style=flat)](https://github.com/UCDenver-ccp/CRAFT/stargazers) - [paper](https://link.springer.com/chapter/10.1007/978-94-024-0881-2_53) - 67 full-text biomedical articles annotated in a variety of ways, including for concepts and coreferences. Now on version 5, including annotations linking concepts to the MONDO disease ontology.
...
* [Biolink](https://biolink.github.io/biolink-model/) - [code](https://github.com/biolink/biolink-model) [![GitHub stars](https://img.shields.io/github/stars/biolink/biolink-model?style=flat)](https://github.com/biolink/biolink-model/stargazers) - A data model of biological entities. Provided as a [YAML](https://yaml.org/) file.
...
* [OMOP Common Data Model](https://github.com/OHDSI/CommonDataModel) [![GitHub stars](https://img.shields.io/github/stars/OHDSI/CommonDataModel?style=flat)](https://github.com/OHDSI/CommonDataModel/stargazers) - a standard for observational healthcare data.
* [unmiri-ngs-fhir-schema](https://github.com/unmirihealth/unmiri-ngs-fhir-schema) [![GitHub stars](https://img.shields.io/github/stars/unmirihealth/unmiri-ngs-fhir-schema?style=flat)](https://github.com/unmirihealth/unmiri-ngs-fhir-schema/stargazers) - Apache-2.0 JSON Schema (Draft 2020-12) API contract for cross-vendor somatic NGS interpretation output (Foundation Medicine, Tempus, Caris, Guardant), aligned with the HL7 FHIR Genomics IG. A standards-aligned target representation for biomedical information-extraction pipelines that parse oncology lab reports.
