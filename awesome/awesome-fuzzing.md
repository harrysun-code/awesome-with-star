...
- [Fuzzing-101](https://github.com/antonio-morales/Fuzzing101) [![GitHub stars](https://img.shields.io/github/stars/antonio-morales/Fuzzing101?style=flat)](https://github.com/antonio-morales/Fuzzing101/stargazers)
...
- [FuzzUSB: Hybrid Stateful Fuzzing of USB Gadget Stacks, 2022](https://github.com/purseclab/fuzzusb/blob/main/paper/fuzzusb.pdf) [![GitHub stars](https://img.shields.io/github/stars/purseclab/fuzzusb/blob/main/paper/fuzzusb.pdf?style=flat)](https://github.com/purseclab/fuzzusb/blob/main/paper/fuzzusb.pdf/stargazers)
...
### File
- [AFL++](https://github.com/AFLplusplus/AFLplusplus) [![GitHub stars](https://img.shields.io/github/stars/AFLplusplus/AFLplusplus?style=flat)](https://github.com/AFLplusplus/AFLplusplus/stargazers) - A superior fork to Google's AFL with more speed, more and better mutations, more and better instrumentation, and custom module support.
- [Angora](https://github.com/AngoraFuzzer/Angora) [![GitHub stars](https://img.shields.io/github/stars/AngoraFuzzer/Angora?style=flat)](https://github.com/AngoraFuzzer/Angora/stargazers) - A mutation-based coverage guided fuzzer that increases branch coverage by solving path constraints without symbolic execution.
### Kernel
- [ACTOR](https://github.com/ucsb-seclab/actor) [![GitHub stars](https://img.shields.io/github/stars/ucsb-seclab/actor?style=flat)](https://github.com/ucsb-seclab/actor/stargazers) (2023) - An action-guided kernel fuzzing framework that generates inputs leveraging triggered actions and their temporal relationships.
- [NTFuzz](https://github.com/SoftSec-KAIST/NTFuzz) [![GitHub stars](https://img.shields.io/github/stars/SoftSec-KAIST/NTFuzz?style=flat)](https://github.com/SoftSec-KAIST/NTFuzz/stargazers) (2021) - A type-aware Windows kernel fuzzer that statically analyzes system binaries to infer system call types for more effective fuzzing.
- [KRACE](https://github.com/sslab-gatech/krace) [![GitHub stars](https://img.shields.io/github/stars/sslab-gatech/krace?style=flat)](https://github.com/sslab-gatech/krace/stargazers) (2020) - A coverage-guided fuzzing framework that detects data races in kernel file systems by exploring concurrency through multi-threaded syscall sequences.
- [Razzer](https://github.com/compsec-snu/razzer) [![GitHub stars](https://img.shields.io/github/stars/compsec-snu/razzer?style=flat)](https://github.com/compsec-snu/razzer/stargazers) (2019) - A kernel fuzzer that uses static analysis and two-phase fuzzing to detect race conditions and concurrency bugs in Linux kernels.
- [Hydra](https://github.com/sslab-gatech/hydra) [![GitHub stars](https://img.shields.io/github/stars/sslab-gatech/hydra?style=flat)](https://github.com/sslab-gatech/hydra/stargazers) (2019) - A fuzzing framework for automatically discovering semantic bugs in file systems using input mutators, feedback engines, and customizable checkers.
- [Janus](https://github.com/sslab-gatech/janus) [![GitHub stars](https://img.shields.io/github/stars/sslab-gatech/janus?style=flat)](https://github.com/sslab-gatech/janus/stargazers) (2019) - A file system fuzzer that finds memory corruptions in Linux kernel file systems by mutating both filesystem images and syscall sequences simultaneously.
- [DIFUZE](https://github.com/ucsb-seclab/difuze) [![GitHub stars](https://img.shields.io/github/stars/ucsb-seclab/difuze?style=flat)](https://github.com/ucsb-seclab/difuze/stargazers) (2017) - An interface-aware fuzzer for Linux kernel drivers that automatically recovers ioctl interfaces via LLVM analysis and generates targeted test cases.
- [IMF](https://github.com/SoftSec-KAIST/IMF) [![GitHub stars](https://img.shields.io/github/stars/SoftSec-KAIST/IMF?style=flat)](https://github.com/SoftSec-KAIST/IMF/stargazers) (2017) - A kernel API fuzzer that leverages automated API model inference to discover vulnerabilities in macOS kernel APIs.
...
- [MINER](https://github.com/puppet-meteor/MINER) [![GitHub stars](https://img.shields.io/github/stars/puppet-meteor/MINER?style=flat)](https://github.com/puppet-meteor/MINER/stargazers) - A REST API fuzzer that utilizes three data-driven designs working together to guide sequence generation, improve request generation quality, and capture unique errors caused by incorrect parameter usage.
- [RestTestGen](https://github.com/SeUniVr/RestTestGen) [![GitHub stars](https://img.shields.io/github/stars/SeUniVr/RestTestGen?style=flat)](https://github.com/SeUniVr/RestTestGen/stargazers) - A robust tool and framework designed for automated black-box testing of RESTful web APIs.
