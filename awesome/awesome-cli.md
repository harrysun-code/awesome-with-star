...
Awesome CLI is a simple command line tool to give you a fancy command line interface to dive into [Awesome](https://github.com/sindresorhus/awesome) [![GitHub stars](https://img.shields.io/github/stars/sindresorhus/awesome?style=flat)](https://github.com/sindresorhus/awesome/stargazers) lists.

![AWESOME CLI](./assets/images/awesome-cli-banner.png)

![Build](https://github.com/umutphp/awesome-cli/workflows/Test%20&%20Build/badge.svg) [![GitHub stars](https://img.shields.io/github/stars/umutphp/awesome-cli/workflows/Test%20&%20Build/badge.svg?style=flat)](https://github.com/umutphp/awesome-cli/workflows/Test%20&%20Build/badge.svg/stargazers) ![WOSPM Checker](https://github.com/umutphp/awesome-cli/workflows/WOSPM%20Checker/badge.svg) [![GitHub stars](https://img.shields.io/github/stars/umutphp/awesome-cli/workflows/WOSPM%20Checker/badge.svg?style=flat)](https://github.com/umutphp/awesome-cli/workflows/WOSPM%20Checker/badge.svg/stargazers)
...
Visit the [latest release](https://github.com/umutphp/awesome-cli/releases/latest) [![GitHub stars](https://img.shields.io/github/stars/umutphp/awesome-cli/releases/latest?style=flat)](https://github.com/umutphp/awesome-cli/releases/latest/stargazers) page, download the zip correspondingly and extract the zip. You can used the binary in the zip file. 
