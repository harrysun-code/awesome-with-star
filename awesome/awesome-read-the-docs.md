...
# Awesome Read the Docs [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![lint](https://github.com/readthedocs-examples/awesome-read-the-docs/actions/workflows/lint.yaml/badge.svg) [![GitHub stars](https://img.shields.io/github/stars/readthedocs-examples/awesome-read-the-docs/actions/workflows/lint.yaml/badge.svg?style=flat)](https://github.com/readthedocs-examples/awesome-read-the-docs/actions/workflows/lint.yaml/badge.svg/stargazers)](https://github.com/readthedocs-examples/awesome-read-the-docs/actions/workflows/lint.yaml)
...
- [CrateDB](https://crate.io/docs/crate/) - Crate.io has integrated their documentation experience into their general website. There's a total of 15 documentation projects nested. They use a custom theme, [crate-docs-theme](https://github.com/crate/crate-docs-theme) [![GitHub stars](https://img.shields.io/github/stars/crate/crate-docs-theme?style=flat)](https://github.com/crate/crate-docs-theme/stargazers) to orchestrate the projects and align them. **#sphinx** **#custom-theme**.
...
- [AiiDA demonstration](https://aiida-qe-demo.readthedocs.io/) - A hardware demo/tutorial written with lots of examples and illustrations. [Behind the scenes](https://github.com/chrisjsewell/aiida-qe-demo) [![GitHub stars](https://img.shields.io/github/stars/chrisjsewell/aiida-qe-demo?style=flat)](https://github.com/chrisjsewell/aiida-qe-demo/stargazers), Conda is used by installing mambaforge and storing the setup in `environment.yml`.  **#sphinx** **#jupyter-notebook**
...
[Thanks goes to these contributors](https://github.com/readthedocs-examples/awesome-read-the-docs/graphs/contributors) [![GitHub stars](https://img.shields.io/github/stars/readthedocs-examples/awesome-read-the-docs/graphs/contributors?style=flat)](https://github.com/readthedocs-examples/awesome-read-the-docs/graphs/contributors/stargazers)!
