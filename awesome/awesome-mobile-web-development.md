...
- [Offline First (Awesome List)](https://github.com/pazguille/offline-first) [![GitHub stars](https://img.shields.io/github/stars/pazguille/offline-first?style=flat)](https://github.com/pazguille/offline-first/stargazers) - The awesome list of offline-first stuff (Progressive Web Apps, Service Workers etc.)
...
- [Lighthouse](https://github.com/GoogleChrome/lighthouse) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/lighthouse?style=flat)](https://github.com/GoogleChrome/lighthouse/stargazers) - Analyzing tool for web apps and web pages.
...
- [Eruda](https://github.com/liriliri/eruda) [![GitHub stars](https://img.shields.io/github/stars/liriliri/eruda?style=flat)](https://github.com/liriliri/eruda/stargazers) - Console for mobile web browsers.
- [Interact.js](https://github.com/taye/interact.js) [![GitHub stars](https://img.shields.io/github/stars/taye/interact.js?style=flat)](https://github.com/taye/interact.js/stargazers) - Drag and drop, resizing and multi-touch gestures with inertia and snapping for modern browsers.
- [Fastclick](https://github.com/ftlabs/fastclick) [![GitHub stars](https://img.shields.io/github/stars/ftlabs/fastclick?style=flat)](https://github.com/ftlabs/fastclick/stargazers) - Removing of 300ms delay in old browsers.
- [Lozad.js](https://github.com/ApoorvSaxena/lozad.js) [![GitHub stars](https://img.shields.io/github/stars/ApoorvSaxena/lozad.js?style=flat)](https://github.com/ApoorvSaxena/lozad.js/stargazers) - Highly performant, light and configurable lazy loader using IntersectionObserver API
- [React Dates](https://github.com/airbnb/react-dates) [![GitHub stars](https://img.shields.io/github/stars/airbnb/react-dates?style=flat)](https://github.com/airbnb/react-dates/stargazers) - An easily internationalizable, mobile-friendly datepicker React library for the web.
- [Screen Sizes](http://screensiz.es/phone) - A list of screen sizes of all popular smartphones.
- [Shiny](https://github.com/rikschennink/shiny) [![GitHub stars](https://img.shields.io/github/stars/rikschennink/shiny?style=flat)](https://github.com/rikschennink/shiny/stargazers) - Shiny reflections for mobile websites.
- [Slideout](https://github.com/Mango/slideout) [![GitHub stars](https://img.shields.io/github/stars/Mango/slideout?style=flat)](https://github.com/Mango/slideout/stargazers) - Standalone and lightweight navigation menu for your mobile web apps.
- [Swiper](https://github.com/nolimits4web/swiper) [![GitHub stars](https://img.shields.io/github/stars/nolimits4web/swiper?style=flat)](https://github.com/nolimits4web/swiper/stargazers) - The most modern mobile touch slider with hardware accelerated transitions.
...
- [Web Starter Kit](https://github.com/google/web-starter-kit) [![GitHub stars](https://img.shields.io/github/stars/google/web-starter-kit?style=flat)](https://github.com/google/web-starter-kit/stargazers) - A workflow for multi-device websites.
...
To the extent possible under law, [@myshov](https://github.com/myshov) [![GitHub stars](https://img.shields.io/github/stars/myshov?style=flat)](https://github.com/myshov/stargazers) has waived all copyright and related or neighboring rights to this work.
