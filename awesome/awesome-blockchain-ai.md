...
- [Danku](https://github.com/algorithmiaio/danku) [![GitHub stars](https://img.shields.io/github/stars/algorithmiaio/danku?style=flat)](https://github.com/algorithmiaio/danku/stargazers) - A blockchain-based protocol for evaluating and purchasing ML models on a public blockchain such as Ethereum. [Blog post.](https://algorithmia.com/research/ml-models-on-blockchain)
- [Decentralized & Collaborative AI on Blockchain](https://github.com/microsoft/0xDeCA10B) [![GitHub stars](https://img.shields.io/github/stars/microsoft/0xDeCA10B?style=flat)](https://github.com/microsoft/0xDeCA10B/stargazers) - 0xDeCA10B is a framework to host and train publicly available machine learning models in smart contracts with incentive mechanisms to encourage good quality training data while keeping the models free to use for prediction. [Blog post.](https://www.microsoft.com/en-us/research/blog/leveraging-blockchain-to-make-machine-learning-models-more-accessible/)
...
- [AgentFund](https://github.com/RioBot-Grind/agentfund) [![GitHub stars](https://img.shields.io/github/stars/RioBot-Grind/agentfund?style=flat)](https://github.com/RioBot-Grind/agentfund/stargazers) - A decentralized crowdfunding infrastructure for autonomous AI agents on Base blockchain, enabling milestone-based escrow funding for AI projects and collaborations.
...
To the extent possible under law, [Steven Van Vaerenbergh](https://github.com/steven2358) [![GitHub stars](https://img.shields.io/github/stars/steven2358?style=flat)](https://github.com/steven2358/stargazers) has waived all copyright and related or neighboring rights to this work.
