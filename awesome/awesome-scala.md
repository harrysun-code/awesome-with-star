...
> 来源：[lauris/awesome-scala](https://github.com/lauris/awesome-scala)

[![GitHub stars](https://img.shields.io/github/stars/lauris/awesome-scala?style=flat)](https://github.com/lauris/awesome-scala/stargazers)
...
* [Learn-by-doing functional programming course on Scala](https://github.com/dehun/learn-fp/) [![GitHub stars](https://img.shields.io/github/stars/dehun/learn-fp/?style=flat)](https://github.com/dehun/learn-fp//stargazers) - Covers type classes, functors, applicatives, monads, monad transformers, free monad
...
* **[Demos and Examples in Scala (Chinese) ★ 923 ⧗ 2](https://github.com/jacksu/utils4s) [![GitHub stars](https://img.shields.io/github/stars/jacksu/utils4s?style=flat)](https://github.com/jacksu/utils4s/stargazers)** - repo of sample Scala library usage, written in Chinese
...
* [Clean Architecture Example](https://github.com/SaeidDadkhah/clean-arch-example) [![GitHub stars](https://img.shields.io/github/stars/SaeidDadkhah/clean-arch-example?style=flat)](https://github.com/SaeidDadkhah/clean-arch-example/stargazers) - A step-by-step guide to develop an application using Clean Architecture in Scala.
...
* [CA Art](https://github.com/makingthematrix/ca_art) [![GitHub stars](https://img.shields.io/github/stars/makingthematrix/ca_art?style=flat)](https://github.com/makingthematrix/ca_art/stargazers) - A small project aimed at learning Scala on intermediate level by experimenting with Cellular Automata
