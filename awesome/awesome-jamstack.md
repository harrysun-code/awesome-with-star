...
- [Coisas](https://github.com/fiatjaf/coisas) [![GitHub stars](https://img.shields.io/github/stars/fiatjaf/coisas?style=flat)](https://github.com/fiatjaf/coisas/stargazers) - A client-side CMS for editing GitHub Markdown (and other) files.
...
- [Stytch](https://stytch.com) - Passwordless authentication and session management API, try it out [on Vercel](https://github.com/vercel/next.js/tree/canary/examples/auth-with-stytch) [![GitHub stars](https://img.shields.io/github/stars/vercel/next.js/tree/canary/examples/auth-with-stytch?style=flat)](https://github.com/vercel/next.js/tree/canary/examples/auth-with-stytch/stargazers).
...
- [Astro Snipcart](https://github.com/lloydjatkinson/astro-snipcart) [![GitHub stars](https://img.shields.io/github/stars/lloydjatkinson/astro-snipcart?style=flat)](https://github.com/lloydjatkinson/astro-snipcart/stargazers) - Astro Snipcart allows developers to build E-Commerce sites using the Astro framework and the Snipcart platform.
- [Flatmarket](https://github.com/christophercliff/flatmarket) [![GitHub stars](https://img.shields.io/github/stars/christophercliff/flatmarket?style=flat)](https://github.com/christophercliff/flatmarket/stargazers) - Flatmarket is a free, open source e-commerce platform for static websites.
...
- [Saleor](https://saleor.io/) - Saleor is [open-source](https://github.com/saleor/saleor) [![GitHub stars](https://img.shields.io/github/stars/saleor/saleor?style=flat)](https://github.com/saleor/saleor/stargazers), GraphQL-first, technology agnostic commerce engine.
...
- [DataFire](https://github.com/DataFire/DataFire) [![GitHub stars](https://img.shields.io/github/stars/DataFire/DataFire?style=flat)](https://github.com/DataFire/DataFire/stargazers) - DataFire is an open source framework for building and integrating APIs.
...
_For a more complete list see [Awesome Serverless](https://github.com/pmuens/awesome-serverless) [![GitHub stars](https://img.shields.io/github/stars/pmuens/awesome-serverless?style=flat)](https://github.com/pmuens/awesome-serverless/stargazers)._
