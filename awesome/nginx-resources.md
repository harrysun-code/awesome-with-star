...
> 来源：[fcambus/nginx-resources](https://github.com/fcambus/nginx-resources)

[![GitHub stars](https://img.shields.io/github/stars/fcambus/nginx-resources?style=flat)](https://github.com/fcambus/nginx-resources/stargazers)
...
- [Nginx HTTP server boilerplate configs](https://github.com/h5bp/server-configs-nginx) [![GitHub stars](https://img.shields.io/github/stars/h5bp/server-configs-nginx?style=flat)](https://github.com/h5bp/server-configs-nginx/stargazers)
- [Nginx Boilerplate - Configuration template and a set of handy must-have snippets](https://github.com/nginx-boilerplate/nginx-boilerplate) [![GitHub stars](https://img.shields.io/github/stars/nginx-boilerplate/nginx-boilerplate?style=flat)](https://github.com/nginx-boilerplate/nginx-boilerplate/stargazers)
...
- [Gixy - Nginx configuration static analyzer](https://github.com/yandex/gixy) [![GitHub stars](https://img.shields.io/github/stars/yandex/gixy?style=flat)](https://github.com/yandex/gixy/stargazers) - Maintained forks: [gixy-ng](https://github.com/dvershinin/gixy) [![GitHub stars](https://img.shields.io/github/stars/dvershinin/gixy?style=flat)](https://github.com/dvershinin/gixy/stargazers), [gixy-next](https://github.com/MegaManSec/Gixy-Next) [![GitHub stars](https://img.shields.io/github/stars/MegaManSec/Gixy-Next?style=flat)](https://github.com/MegaManSec/Gixy-Next/stargazers)
- [Nginx common configuration - Universal config and snippets](https://github.com/tldr-devops/nginx-common-configuration) [![GitHub stars](https://img.shields.io/github/stars/tldr-devops/nginx-common-configuration?style=flat)](https://github.com/tldr-devops/nginx-common-configuration/stargazers)
...
- [agentzh's Nginx Tutorials](https://openresty.org/download/agentzh-nginx-tutorials-en.html) ([Source](https://github.com/openresty/nginx-tutorials) [![GitHub stars](https://img.shields.io/github/stars/openresty/nginx-tutorials?style=flat)](https://github.com/openresty/nginx-tutorials/stargazers))
...
- [Kong - Management Layer for Microservices and APIs](https://github.com/kong/kong) [![GitHub stars](https://img.shields.io/github/stars/kong/kong?style=flat)](https://github.com/kong/kong/stargazers)
...
- [Capture and delay unwanted requests](https://github.com/p0pr0ck5/lua-resty-tarpit) [![GitHub stars](https://img.shields.io/github/stars/p0pr0ck5/lua-resty-tarpit?style=flat)](https://github.com/p0pr0ck5/lua-resty-tarpit/stargazers)
...
- [LSSO - Lua + Nginx SSO System with an OAuth Backend](https://github.com/pirogoeth/lsso) [![GitHub stars](https://img.shields.io/github/stars/pirogoeth/lsso?style=flat)](https://github.com/pirogoeth/lsso/stargazers)
...
- [nginx-lua - Nginx 1.19+ with LUA support based on Alpine Linux, Amazon Linux, CentOS, Debian, Fedora and Ubuntu.](https://github.com/fabiocicerchia/nginx-lua) [![GitHub stars](https://img.shields.io/github/stars/fabiocicerchia/nginx-lua?style=flat)](https://github.com/fabiocicerchia/nginx-lua/stargazers)

## Nginx + njs

- [njs scripting language reference and examples](https://nginx.org/en/docs/njs/)
- [Collection of njs use cases](https://github.com/f5devcentral/nginx-njs-usecases) [![GitHub stars](https://img.shields.io/github/stars/f5devcentral/nginx-njs-usecases?style=flat)](https://github.com/f5devcentral/nginx-njs-usecases/stargazers)
...
- [Building an OpenResty events server](https://github.com/cagerton/dropthat/) [![GitHub stars](https://img.shields.io/github/stars/cagerton/dropthat/?style=flat)](https://github.com/cagerton/dropthat//stargazers)
- [SysAdvent 2014 - OpenResty, Nginx and Lua](https://sysadvent.blogspot.com/2014/12/day-22-largely-unappreciated.html) ([Source](https://github.com/lusis/sysadvent-2014) [![GitHub stars](https://img.shields.io/github/stars/lusis/sysadvent-2014?style=flat)](https://github.com/lusis/sysadvent-2014/stargazers))
...
- [VeryNginx - Nginx distribution which provides WAF, Control Panel, and Dashboards](https://github.com/alexazhou/VeryNginx) [![GitHub stars](https://img.shields.io/github/stars/alexazhou/VeryNginx?style=flat)](https://github.com/alexazhou/VeryNginx/stargazers)

## Tengine

- [Tengine Web Server](https://tengine.taobao.org)
- [Difference between OpenResty and Tengine](https://github.com/openresty/openresty/issues/54) [![GitHub stars](https://img.shields.io/github/stars/openresty/openresty/issues/54?style=flat)](https://github.com/openresty/openresty/issues/54/stargazers)
