...
- [Authentik](https://github.com/goauthentik/authentik) [![GitHub stars](https://img.shields.io/github/stars/goauthentik/authentik?style=flat)](https://github.com/goauthentik/authentik/stargazers) - Open Source Identity Provider focused on flexibility and versatility.
...
- [Dex](https://github.com/dexidp/dex) [![GitHub stars](https://img.shields.io/github/stars/dexidp/dex?style=flat)](https://github.com/dexidp/dex/stargazers) - Provider that acts as a portal to other identity providers through "connectors." like LDAP, SAML, OIDC or established identity providers like GitHub, Google, and Active Directory.
...
- [Logto](https://github.com/logto-io/logto) [![GitHub stars](https://img.shields.io/github/stars/logto-io/logto?style=flat)](https://github.com/logto-io/logto/stargazers) - An Open-source solution designed for Customer Identity and Access Management (CIAM) and Workforce Identity Management with OpenID Connect based authentication.
...
- [MITREid Connect](https://github.com/mitreid-connect/OpenID-Connect-Java-Spring-Server) [![GitHub stars](https://img.shields.io/github/stars/mitreid-connect/OpenID-Connect-Java-Spring-Server?style=flat)](https://github.com/mitreid-connect/OpenID-Connect-Java-Spring-Server/stargazers) - Open Source OpenID Connect reference implementation in Java.
- [OpenIddict](https://github.com/openiddict/openiddict-core) [![GitHub stars](https://img.shields.io/github/stars/openiddict/openiddict-core?style=flat)](https://github.com/openiddict/openiddict-core/stargazers) - .NET Open Source OpenID Connect Provider implementation with ASP.NET Core 2.1 (and higher) applications support.
- [OneLogin](https://www.onelogin.com/) - SaaS Employee and Customer IAM solution with OpenID Connect Provider capabilities.
- [Ory Hydra](https://github.com/ory/hydra) [![GitHub stars](https://img.shields.io/github/stars/ory/hydra?style=flat)](https://github.com/ory/hydra/stargazers) - Open Source OpenID Certified™ OpenID Connect and OAuth Provider.
- [Ory Polis (formerly BoxyHQ Jackson)](https://github.com/ory/polis) [![GitHub stars](https://img.shields.io/github/stars/ory/polis?style=flat)](https://github.com/ory/polis/stargazers) - Open Source Enterprise SSO bridges or proxies a SAML login flow to OpenID Connect with also user directory sync capabilities.
- [panva/node-oidc-provider](https://github.com/panva/node-oidc-provider) [![GitHub stars](https://img.shields.io/github/stars/panva/node-oidc-provider?style=flat)](https://github.com/panva/node-oidc-provider/stargazers) - Open Source and certified OpenID Connect provider implementation in Node.js with FAPI 1.0 and FAPI 2.0 support.
...
- [Pocket ID](https://github.com/pocket-id/pocket-id) [![GitHub stars](https://img.shields.io/github/stars/pocket-id/pocket-id?style=flat)](https://github.com/pocket-id/pocket-id/stargazers) - A simple OpenID Connect Provider that allows users to authenticate with their passkeys.
...
- [Zitadel](https://github.com/zitadel/zitadel) [![GitHub stars](https://img.shields.io/github/stars/zitadel/zitadel?style=flat)](https://github.com/zitadel/zitadel/stargazers) - Open Source Identity solution with OpenID Connect provider (OP) and SAMLv2 ready to use.
...
- [liboauth2](https://github.com/OpenIDC/liboauth2) [![GitHub stars](https://img.shields.io/github/stars/OpenIDC/liboauth2?style=flat)](https://github.com/OpenIDC/liboauth2/stargazers) - Generic library to build C-based OpenID Connect Provider and Relying Party.
- [mod_auth_openidc](https://github.com/OpenIDC/mod_auth_openidc) [![GitHub stars](https://img.shields.io/github/stars/OpenIDC/mod_auth_openidc?style=flat)](https://github.com/OpenIDC/mod_auth_openidc/stargazers) - OpenID Connect Relying Party certified implementation for Apache Server 2.x.
- [ngx_oauth2_module](https://github.com/OpenIDC/ngx_oauth2_module) [![GitHub stars](https://img.shields.io/github/stars/OpenIDC/ngx_oauth2_module?style=flat)](https://github.com/OpenIDC/ngx_oauth2_module/stargazers) - OpenID Connect Relying Party certified implementation for Nginx.

### C#

- [IdentityModel.OidcClient](https://github.com/IdentityModel/IdentityModel.OidcClient) [![GitHub stars](https://img.shields.io/github/stars/IdentityModel/IdentityModel.OidcClient?style=flat)](https://github.com/IdentityModel/IdentityModel.OidcClient/stargazers) - C# / .NET OpenID Connect relying party client certified library for native mobile/desktop applications.

### Dart

- [openid_client](https://github.com/appsup-dart/openid_client) [![GitHub stars](https://img.shields.io/github/stars/appsup-dart/openid_client?style=flat)](https://github.com/appsup-dart/openid_client/stargazers) - OpenID Connect Relying Party client library for Dart in Flutter, Web and Command Line.

### Erlang

- [oidcc](https://github.com/erlef/oidcc) [![GitHub stars](https://img.shields.io/github/stars/erlef/oidcc?style=flat)](https://github.com/erlef/oidcc/stargazers) - Certified OpenID Connect Relying Party client library for Erlang and Elixir with FAPI support.

### Golang

- [coreos/go-oidc](https://github.com/coreos/go-oidc) [![GitHub stars](https://img.shields.io/github/stars/coreos/go-oidc?style=flat)](https://github.com/coreos/go-oidc/stargazers) - Go OpenID Connect client developed by CoreOS.
...
- [zitadel/oidc](https://github.com/zitadel/oidc) [![GitHub stars](https://img.shields.io/github/stars/zitadel/oidc?style=flat)](https://github.com/zitadel/oidc/stargazers) - OpenID Connect client and server library certified by the OpenID Foundation.

### Java

- [com.google.oauth-client/google-oauth-client](https://github.com/googleapis/google-oauth-java-client) [![GitHub stars](https://img.shields.io/github/stars/googleapis/google-oauth-java-client?style=flat)](https://github.com/googleapis/google-oauth-java-client/stargazers) - OAuth Relying Party Java library written by Google for OAuth 2.0 with Android support.
...
- [openid-client](https://github.com/panva/node-openid-client) [![GitHub stars](https://img.shields.io/github/stars/panva/node-openid-client?style=flat)](https://github.com/panva/node-openid-client/stargazers) - OpenID Certified™ Relying Party (OpenID Connect/OAuth 2.0 Client) implementation for Node.js.
- [oauth4webapi](https://github.com/panva/oauth4webapi) [![GitHub stars](https://img.shields.io/github/stars/panva/oauth4webapi?style=flat)](https://github.com/panva/oauth4webapi/stargazers) - OAuth 2/OpenID Connect library for JavaScript Runtimes.
- [oidc-client-ts](https://github.com/authts/oidc-client-ts) [![GitHub stars](https://img.shields.io/github/stars/authts/oidc-client-ts?style=flat)](https://github.com/authts/oidc-client-ts/stargazers) - TypeScript OpenID Client and OAuth 2.0 client for browser-based applications.

*Libraries layer focused on specific framework integration*

- [Better Auth](https://github.com/better-auth/better-auth) [![GitHub stars](https://img.shields.io/github/stars/better-auth/better-auth?style=flat)](https://github.com/better-auth/better-auth/stargazers) - TypeScript Framework agnostic authentication library for SPAs and server-side applications.
- [nuxt-auth for Nuxt 2](https://github.com/nuxt-community/auth-module) [![GitHub stars](https://img.shields.io/github/stars/nuxt-community/auth-module?style=flat)](https://github.com/nuxt-community/auth-module/stargazers) - Zero-boilerplate authentication support for Nuxt.js 2.
- [nuxt-auth for Nuxt3](https://github.com/sidebase/nuxt-auth) [![GitHub stars](https://img.shields.io/github/stars/sidebase/nuxt-auth?style=flat)](https://github.com/sidebase/nuxt-auth/stargazers) - Nuxt 3 user authentication and sessions library. nuxt-auth wraps NextAuth.js.
- [angular-auth-oidc-client](https://github.com/damienbod/angular-auth-oidc-client) [![GitHub stars](https://img.shields.io/github/stars/damienbod/angular-auth-oidc-client?style=flat)](https://github.com/damienbod/angular-auth-oidc-client/stargazers) - Angular certified library with OAuth 2.0 and OpenID Connect flows, and Angular schematics.
- [angular-oauth2-oidc](https://github.com/manfredsteyer/angular-oauth2-oidc) [![GitHub stars](https://img.shields.io/github/stars/manfredsteyer/angular-oauth2-oidc?style=flat)](https://github.com/manfredsteyer/angular-oauth2-oidc/stargazers) - Library which bring support for OAuth 2.0 and OpenID Connect (OIDC) in Angular.

### OCaml

- [ocaml-oidc](https://github.com/ulrikstrid/ocaml-oidc) [![GitHub stars](https://img.shields.io/github/stars/ulrikstrid/ocaml-oidc?style=flat)](https://github.com/ulrikstrid/ocaml-oidc/stargazers) - Certified OpenID Connect Relying Party implementation in OCaml.

### PHP

- [Laravel Socialite](https://github.com/laravel/socialite) [![GitHub stars](https://img.shields.io/github/stars/laravel/socialite?style=flat)](https://github.com/laravel/socialite/stargazers) - Laravel wrapper around OAuth 1 & OAuth 2 libraries with OpenID Connect support.
- [thephpleague/oauth2-client](https://github.com/thephpleague/oauth2-client) [![GitHub stars](https://img.shields.io/github/stars/thephpleague/oauth2-client?style=flat)](https://github.com/thephpleague/oauth2-client/stargazers) - Integration with OAuth 2.0 service providers for PHP.
...
- [openid_connect](https://github.com/nov/openid_connect) [![GitHub stars](https://img.shields.io/github/stars/nov/openid_connect?style=flat)](https://github.com/nov/openid_connect/stargazers) - Ruby OpenID Connect Relying party (RP) and Provider (OP) library.
- [omniauth_openid_connect](https://github.com/omniauth/omniauth_openid_connect) [![GitHub stars](https://img.shields.io/github/stars/omniauth/omniauth_openid_connect?style=flat)](https://github.com/omniauth/omniauth_openid_connect/stargazers) - OpenID Connect Strategy for Ruby OmniAuth library.

### Rust

- [openidconnect](https://github.com/ramosbugs/openidconnect-rs) [![GitHub stars](https://img.shields.io/github/stars/ramosbugs/openidconnect-rs?style=flat)](https://github.com/ramosbugs/openidconnect-rs/stargazers) - OpenID Connect Relying party (RP) library for Rust.
...
- [oauth2-proxy](https://github.com/oauth2-proxy/oauth2-proxy) [![GitHub stars](https://img.shields.io/github/stars/oauth2-proxy/oauth2-proxy?style=flat)](https://github.com/oauth2-proxy/oauth2-proxy/stargazers) - Reverse proxy adding OpenID Connect and OAuth 2.0 based authentication in front of any application.
- [lua-resty-openidc](https://github.com/zmartzone/lua-resty-openidc) [![GitHub stars](https://img.shields.io/github/stars/zmartzone/lua-resty-openidc?style=flat)](https://github.com/zmartzone/lua-resty-openidc/stargazers) - OpenID Connect Relying Party and OAuth 2.0 client Lua library for NGINX/OpenResty.
...
- [traefikoidc](https://github.com/lukaszraczylo/traefikoidc) [![GitHub stars](https://img.shields.io/github/stars/lukaszraczylo/traefikoidc?style=flat)](https://github.com/lukaszraczylo/traefikoidc/stargazers) - OpenID Connect Relying Party middleware plugin for Traefik.
- [caddy-security](https://github.com/greenpau/caddy-security) [![GitHub stars](https://img.shields.io/github/stars/greenpau/caddy-security?style=flat)](https://github.com/greenpau/caddy-security/stargazers) - OpenID Connect Relying Party authentication plugin for the Caddy web server.
- [Vouch Proxy](https://github.com/vouch/vouch-proxy) [![GitHub stars](https://img.shields.io/github/stars/vouch/vouch-proxy?style=flat)](https://github.com/vouch/vouch-proxy/stargazers) - SSO solution using OpenID Connect for Nginx and Traefik reverse proxies.
...
- [OAuth 2.0 App2App Browserless Flow](https://github.com/yaron-zehavi/oauth-app2app-browserless) [![GitHub stars](https://img.shields.io/github/stars/yaron-zehavi/oauth-app2app-browserless?style=flat)](https://github.com/yaron-zehavi/oauth-app2app-browserless/stargazers) - Describing a protocol enabling native navigation across apps performing authentication using the App2App pattern, without requiring a web browser.
...
- [SecureAuthCorp/oauth2c](https://github.com/SecureAuthCorp/oauth2c) [![GitHub stars](https://img.shields.io/github/stars/SecureAuthCorp/oauth2c?style=flat)](https://github.com/SecureAuthCorp/oauth2c/stargazers) - OAuth 2.0 and OpenID Connect command line client for testing and exploring different flows.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/cerberauth/awesome-openidconnect/blob/master/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/cerberauth/awesome-openidconnect/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/cerberauth/awesome-openidconnect/blob/master/CONTRIBUTING.md/stargazers) first.
