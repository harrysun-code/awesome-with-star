...
> 来源：[marcobiedermann/search-engine-optimization](https://github.com/marcobiedermann/search-engine-optimization)

[![GitHub stars](https://img.shields.io/github/stars/marcobiedermann/search-engine-optimization?style=flat)](https://github.com/marcobiedermann/search-engine-optimization/stargazers)
...
- [SEOstats](https://github.com/eyecatchup/SEOstats) [![GitHub stars](https://img.shields.io/github/stars/eyecatchup/SEOstats?style=flat)](https://github.com/eyecatchup/SEOstats/stargazers) - SEOstats is a powerful open source PHP library to request a bunch of SEO relevant metrics.
...
- [Linkbuilding Spider](https://github.com/fulldecent/linkbuilding-spider) [![GitHub stars](https://img.shields.io/github/stars/fulldecent/linkbuilding-spider?style=flat)](https://github.com/fulldecent/linkbuilding-spider/stargazers) - A PHP project to check if websites are linking to your website.
...
- [OuiSEO](https://github.com/carlsednaoui/seo-bookmarklet) [![GitHub stars](https://img.shields.io/github/stars/carlsednaoui/seo-bookmarklet?style=flat)](https://github.com/carlsednaoui/seo-bookmarklet/stargazers) - An open-source bookmarklet that shows you on-page SEO and social meta data information.
...
- [Jekyll SEO Tag](https://github.com/jekyll/jekyll-seo-tag) [![GitHub stars](https://img.shields.io/github/stars/jekyll/jekyll-seo-tag?style=flat)](https://github.com/jekyll/jekyll-seo-tag/stargazers) - A Jekyll plugin to add metadata tags for search engines and social networks to better index and display your site's content.
