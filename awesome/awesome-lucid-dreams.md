...
- [Dreamento](https://github.com/dreamento/dreamento) [![GitHub stars](https://img.shields.io/github/stars/dreamento/dreamento?style=flat)](https://github.com/dreamento/dreamento/stargazers) - DReam ENgenieering TOolbox is Python-based program for dream engineering while monitoring/analyzing real-time EEG data.
- [Fitbit Lucid Trainer](https://github.com/lucid-trainer/fit-lucid-trainer) [![GitHub stars](https://img.shields.io/github/stars/lucid-trainer/fit-lucid-trainer?style=flat)](https://github.com/lucid-trainer/fit-lucid-trainer/stargazers) - A Fitbit SDK 5.0 App to capture sleep related data and send to an external REST service.
- [Dream Journal App](https://github.com/gitbrent/dream-journal-app) [![GitHub stars](https://img.shields.io/github/stars/gitbrent/dream-journal-app?style=flat)](https://github.com/gitbrent/dream-journal-app/stargazers) - A Dream Journal that uses Google Drive.
- [lucidsourcekit](https://github.com/BitFlaker/lucidsourcekit) [![GitHub stars](https://img.shields.io/github/stars/BitFlaker/lucidsourcekit?style=flat)](https://github.com/BitFlaker/lucidsourcekit/stargazers) - An all-you-need toolkit for lucid dreaming including a binaural beats player and much more.
- [Lightened Dream](https://github.com/lucidcode/Lightened-Dream) [![GitHub stars](https://img.shields.io/github/stars/lucidcode/Lightened-Dream?style=flat)](https://github.com/lucidcode/Lightened-Dream/stargazers) - A dream journal designed for lucid dreamers.
...
- [SSILD Trainer](https://github.com/rochismo/ssild-react) [![GitHub stars](https://img.shields.io/github/stars/rochismo/ssild-react?style=flat)](https://github.com/rochismo/ssild-react/stargazers) - A SSILD (Senses Initiated Lucid Dream) training web app designed to help you practice the SSILD cycles.
