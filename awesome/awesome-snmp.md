...
[![Awesome lint](https://github.com/eozer/awesome-snmp/actions/workflows/awesome-lint.yml/badge.svg) [![GitHub stars](https://img.shields.io/github/stars/eozer/awesome-snmp/actions/workflows/awesome-lint.yml/badge.svg?style=flat)](https://github.com/eozer/awesome-snmp/actions/workflows/awesome-lint.yml/badge.svg/stargazers)](https://github.com/eozer/awesome-snmp/actions/workflows/awesome-lint.yml)
...
### C#
- [C# SNMP Library](https://github.com/lextudio/sharpsnmplib) [![GitHub stars](https://img.shields.io/github/stars/lextudio/sharpsnmplib?style=flat)](https://github.com/lextudio/sharpsnmplib/stargazers) - MIT licensed SNMP library for .NET with extensive SNMP standard support, latest .NET platform targets, as well as rich manager/agent samples.
- [SNMP Pro](https://pro.sharpsnmp.com) - Commercial extension that adds enterprise MIB support.
- [SnmpSharpNet](https://github.com/rqx110/SnmpSharpNet) [![GitHub stars](https://img.shields.io/github/stars/rqx110/SnmpSharpNet?style=flat)](https://github.com/rqx110/SnmpSharpNet/stargazers) - Simple Network Management Protocol (SNMP) .Net library written in C# (csharp). Implements protocol version 1, 2 and 3.
...
### Go
- [gosnmp/gosnmp](https://github.com/gosnmp/gosnmp) [![GitHub stars](https://img.shields.io/github/stars/gosnmp/gosnmp?style=flat)](https://github.com/gosnmp/gosnmp/stargazers) - An SNMP library written in Go. It provides Get, GetNext, GetBulk, Walk, BulkWalk, Set and Traps. It supports IPv4/IPv6, using SNMP v1/v2c/v3.
- [sleepinggenius2/gosmi](https://github.com/sleepinggenius2/gosmi) [![GitHub stars](https://img.shields.io/github/stars/sleepinggenius2/gosmi?style=flat)](https://github.com/sleepinggenius2/gosmi/stargazers) - MIB parser in Go language.
- [posteo/go-agentx](https://github.com/posteo/go-agentx) [![GitHub stars](https://img.shields.io/github/stars/posteo/go-agentx?style=flat)](https://github.com/posteo/go-agentx/stargazers) - A library with a pure Go implementation of the AgentX-Protocol.
...
- [mibble](https://github.com/cederberg/mibble) [![GitHub stars](https://img.shields.io/github/stars/cederberg/mibble?style=flat)](https://github.com/cederberg/mibble/stargazers) - Mibble is an open-source SNMP MIB (or SMI) parser library for Java.

### JavaScript
- [node-net-snmp](https://github.com/markabrahams/node-net-snmp) [![GitHub stars](https://img.shields.io/github/stars/markabrahams/node-net-snmp?style=flat)](https://github.com/markabrahams/node-net-snmp/stargazers) -  JavaScript implementation of the Simple Network Management Protocol (SNMP), implements versions 1, 2c and 3.
- [node-snmp-native](https://github.com/calmh/node-snmp-native) [![GitHub stars](https://img.shields.io/github/stars/calmh/node-snmp-native?style=flat)](https://github.com/calmh/node-snmp-native/stargazers) -  Native JavaScript SNMP library for Node.js.
- [node-snmpjs](https://github.com/joyent/node-snmpjs) [![GitHub stars](https://img.shields.io/github/stars/joyent/node-snmpjs?style=flat)](https://github.com/joyent/node-snmpjs/stargazers) - This package provides a toolkit for SNMP agents and management applications in Node.js.
- [snmp-node](https://github.com/neias/snmp-node) [![GitHub stars](https://img.shields.io/github/stars/neias/snmp-node?style=flat)](https://github.com/neias/snmp-node/stargazers) - Native JavaScript SNMP library for Node.js.

### Lua
- [luasnmp](https://github.com/hleuwer/luasnmp) [![GitHub stars](https://img.shields.io/github/stars/hleuwer/luasnmp?style=flat)](https://github.com/hleuwer/luasnmp/stargazers) - Lua binding to net-snmp library.
...
- [FreeDSx/SNMP](https://github.com/FreeDSx/SNMP) [![GitHub stars](https://img.shields.io/github/stars/FreeDSx/SNMP?style=flat)](https://github.com/FreeDSx/SNMP/stargazers) - A Pure PHP SNMP Library.
- [opensolutions/OSS_SNMP](https://github.com/opensolutions/OSS_SNMP) [![GitHub stars](https://img.shields.io/github/stars/opensolutions/OSS_SNMP?style=flat)](https://github.com/opensolutions/OSS_SNMP/stargazers) - A PHP SNMP library for people who hate SNMP, MIBs and OIDs!

### Python
- [pysnmp](https://github.com/lextudio/pysnmp) [![GitHub stars](https://img.shields.io/github/stars/lextudio/pysnmp?style=flat)](https://github.com/lextudio/pysnmp/stargazers) - This is a pure-Python, open source and free implementation of v1/v2c/v3 SNMP engine distributed under 2-clause BSD license.
  - This project is derived from [the original repo](https://github.com/etingof/pysnmp) [![GitHub stars](https://img.shields.io/github/stars/etingof/pysnmp?style=flat)](https://github.com/etingof/pysnmp/stargazers).
- [pysmi](https://github.com/lextudio/pysmi) [![GitHub stars](https://img.shields.io/github/stars/lextudio/pysmi?style=flat)](https://github.com/lextudio/pysmi/stargazers) - PySMI is a pure-Python implementation of SNMP SMI MIB parser.
  - This project is derived from [the original repo](https://github.com/etingof/pysmi) [![GitHub stars](https://img.shields.io/github/stars/etingof/pysmi?style=flat)](https://github.com/etingof/pysmi/stargazers).
...
### Ruby
- [ruby-netsnmp](https://github.com/swisscom/ruby-netsnmp) [![GitHub stars](https://img.shields.io/github/stars/swisscom/ruby-netsnmp?style=flat)](https://github.com/swisscom/ruby-netsnmp/stargazers) - SNMP library in ruby (v1, v2c, v3).

### Rust
- [snmp-parser](https://github.com/rusticata/snmp-parser) [![GitHub stars](https://img.shields.io/github/stars/rusticata/snmp-parser?style=flat)](https://github.com/rusticata/snmp-parser/stargazers) - SNMP parser written in rust with nom parser combinator framework.
- [davedufresne/modern_snmp](https://github.com/davedufresne/modern_snmp) [![GitHub stars](https://img.shields.io/github/stars/davedufresne/modern_snmp?style=flat)](https://github.com/davedufresne/modern_snmp/stargazers) - Modern SNMP is a pure-Rust library for SNMPv3. This repository includes snmp_mp (SNMPv3 Message Processing) and snmp_usm (Implementation of the User-based Security Model (USM) for SNMPv3) crates.
- [Svedrin/sunt](https://github.com/Svedrin/sunt) [![GitHub stars](https://img.shields.io/github/stars/Svedrin/sunt?style=flat)](https://github.com/Svedrin/sunt/stargazers) - This repository implements an SNMP Agent written in Rust.
...
- [snmpsim](https://github.com/etingof/snmpsim) [![GitHub stars](https://img.shields.io/github/stars/etingof/snmpsim?style=flat)](https://github.com/etingof/snmpsim/stargazers) - This is a pure-Python, open source and free implementation of SNMP agents simulator distributed under 2-clause BSD license.
- [snmpfwd](https://github.com/etingof/snmpfwd) [![GitHub stars](https://img.shields.io/github/stars/etingof/snmpfwd?style=flat)](https://github.com/etingof/snmpfwd/stargazers) - The SNMP Proxy Forwarder tool works as an application-level proxy with a built-in SNMP message router. Typical use case for an SNMP proxy is to work as an application-level firewall or a protocol translator that enables SNMPv3 access to a SNMPv1/SNMPv2c entity or vice versa.
- [snmpclitools](https://github.com/etingof/snmpclitools) [![GitHub stars](https://img.shields.io/github/stars/etingof/snmpclitools?style=flat)](https://github.com/etingof/snmpclitools/stargazers) - This is a collection of command-line SNMP tools written in pure-Python. The tools mimic their famous Net-SNMP counterparts. It includes snmpget.py, snmpset.py, snmpwalk.py, snmpbulkwalk.py, snmptrap.py, and snmptranslate.py, see [here](https://snmplabs.thola.io/snmpclitools/) for more details.
- [snmpwn](https://github.com/hatlord/snmpwn) [![GitHub stars](https://img.shields.io/github/stars/hatlord/snmpwn?style=flat)](https://github.com/hatlord/snmpwn/stargazers) - SNMPwn is an SNMPv3 user enumerator and attack tool.
- [trapperkeeper](https://github.com/dropbox/trapperkeeper) [![GitHub stars](https://img.shields.io/github/stars/dropbox/trapperkeeper?style=flat)](https://github.com/dropbox/trapperkeeper/stargazers) - A suite of tools for ingesting and displaying SNMP traps. This is designed as a replacement for snmptrapd and to supplement existing stateful monitoring solutions.
...
- [prometheus/snmp_exporter](https://github.com/prometheus/snmp_exporter) [![GitHub stars](https://img.shields.io/github/stars/prometheus/snmp_exporter?style=flat)](https://github.com/prometheus/snmp_exporter/stargazers) - This exporter is the recommended way to expose SNMP data in a format which Prometheus can ingest.
- [trailofbits/onesixtyone](https://github.com/trailofbits/onesixtyone) [![GitHub stars](https://img.shields.io/github/stars/trailofbits/onesixtyone?style=flat)](https://github.com/trailofbits/onesixtyone/stargazers) - Fast SNMP Scanner.
- [SECFORCE/SNMP-Brute](https://github.com/SECFORCE/SNMP-Brute) [![GitHub stars](https://img.shields.io/github/stars/SECFORCE/SNMP-Brute?style=flat)](https://github.com/SECFORCE/SNMP-Brute/stargazers) - Fast SNMP brute force, enumeration, CISCO config downloader and password cracking script.
- [hatlord/snmpwn](https://github.com/hatlord/snmpwn) [![GitHub stars](https://img.shields.io/github/stars/hatlord/snmpwn?style=flat)](https://github.com/hatlord/snmpwn/stargazers) - An SNMPv3 User Enumerator and Attack tool.
- [zabbix-tools/mib2zabbix](https://github.com/zabbix-tools/mib2zabbix) [![GitHub stars](https://img.shields.io/github/stars/zabbix-tools/mib2zabbix?style=flat)](https://github.com/zabbix-tools/mib2zabbix/stargazers) - This Perl script will generate a Zabbix v3 Template in XML format from an OID tree in a SNMP MIB file.
- [OIDrage](https://github.com/patrickscottbest/OIDrage) [![GitHub stars](https://img.shields.io/github/stars/patrickscottbest/OIDrage?style=flat)](https://github.com/patrickscottbest/OIDrage/stargazers) - A lightweight standalone SNMPd mimic server based on any snmpwalk output. Easily scales to mock thousands of servers.
...
- [Visual SNMP](https://github.com/sisraell/VisualSNMP) [![GitHub stars](https://img.shields.io/github/stars/sisraell/VisualSNMP?style=flat)](https://github.com/sisraell/VisualSNMP/stargazers) - Visual SNMP is a simple tool for testing access to SNMP agents. Currently SNMPGET and SNMPWALK are supported with some limited funcionality.
...
- [toni-moreno/snmpcollector](https://github.com/toni-moreno/snmpcollector) [![GitHub stars](https://img.shields.io/github/stars/toni-moreno/snmpcollector?style=flat)](https://github.com/toni-moreno/snmpcollector/stargazers) - SnmpCollector is a full featured Generic SNMP data collector with Web Administration Interface Open Source tool which has as main goal simplify the configuration for getting data from any device which snmp protocol support and send resulting data to an influxdb backend.
...
- [TWSNMP FK](https://github.com/twsnmp/twsnmpfk) [![GitHub stars](https://img.shields.io/github/stars/twsnmp/twsnmpfk?style=flat)](https://github.com/twsnmp/twsnmpfk/stargazers) - An ultra-lightweight SNMP manager for Windows and Mac OS, featuring network mapping, polling, and AI analysis.
...
## MIB repositories
- [hsnodgrass/snmp_mib_archive](https://github.com/hsnodgrass/snmp_mib_archive) [![GitHub stars](https://img.shields.io/github/stars/hsnodgrass/snmp_mib_archive?style=flat)](https://github.com/hsnodgrass/snmp_mib_archive/stargazers) - An archive of over 3000 unique SNMP MIBs.
- [kcsinclair/mibs](https://github.com/kcsinclair/mibs) [![GitHub stars](https://img.shields.io/github/stars/kcsinclair/mibs?style=flat)](https://github.com/kcsinclair/mibs/stargazers) - Another collection of MIBS used for SNMP. Make sure to clone the repository to see the full list of MIBs.
