...
The Technology's Division's Resource Repository is [sponsored](https://github.com/APA-Technology-Division/urban-and-regional-planning-resources/blob/main/resources/Division_Sponsorship_Package_23.pdf) [![GitHub stars](https://img.shields.io/github/stars/APA-Technology-Division/urban-and-regional-planning-resources/blob/main/resources/Division_Sponsorship_Package_23.pdf?style=flat)](https://github.com/APA-Technology-Division/urban-and-regional-planning-resources/blob/main/resources/Division_Sponsorship_Package_23.pdf/stargazers) by the following companies and organizations. 
...
- [National Zoning & Land Use Database](https://github.com/mtmleczko/nzlud/tree/main) [![GitHub stars](https://img.shields.io/github/stars/mtmleczko/nzlud/tree/main?style=flat)](https://github.com/mtmleczko/nzlud/tree/main/stargazers) - This GitHub project catalogs major metros municipal zoning ordinances in plain text. It can be a useful reference for comparing ordinances or perhaps fine tuning language models.
...
- [Transitland](https://transit.land) - An open data platform that collects GTFS, GTFS Realtime, and other open data feeds from over 2,500 transit operators in over 55 countries. Additional Information: [Interline](https://www.interline.io/), [GitHub](https://github.com/transitland) [![GitHub stars](https://img.shields.io/github/stars/transitland?style=flat)](https://github.com/transitland/stargazers).
...
- [DTDL](https://github.com/Azure/opendigitaltwins-building) [![GitHub stars](https://img.shields.io/github/stars/Azure/opendigitaltwins-building?style=flat)](https://github.com/Azure/opendigitaltwins-building/stargazers) - The Digital Twins Definition Language is the language by which developers can define the language of the entities they expect to use in their topologies.
- [BLDS](https://github.com/open-data-standards/permitdata.org/wiki/Core-Permits-Dataset-Requirements) [![GitHub stars](https://img.shields.io/github/stars/open-data-standards/permitdata.org/wiki/Core-Permits-Dataset-Requirements?style=flat)](https://github.com/open-data-standards/permitdata.org/wiki/Core-Permits-Dataset-Requirements/stargazers) - The BLDS data standard is a collaborative effort by civic technology companies, governments and other interested parties to create a shared data specification for building and construction permit data.
...
- [SharedStreets](https://www.sharedstreets.io) - Referencing System is a global, non-proprietary linear referencing system for describing streets maintained by SharedStreets. Additional Information: [GitHub](https://github.com/sharedstreets/sharedstreets-ref-system) [![GitHub stars](https://img.shields.io/github/stars/sharedstreets/sharedstreets-ref-system?style=flat)](https://github.com/sharedstreets/sharedstreets-ref-system/stargazers)
...
- [CDS](https://github.com/openmobilityfoundation/curb-data-specification) [![GitHub stars](https://img.shields.io/github/stars/openmobilityfoundation/curb-data-specification?style=flat)](https://github.com/openmobilityfoundation/curb-data-specification/stargazers) - The Curb Data Specification provides data specifications for curb regulations alongside a connected event and metrics API intended to help cities manage their curb zone programs and surrounding areas, and measure the utilization and impact.
...
- [GTFS-flex](https://github.com/MobilityData/gtfs-flex) [![GitHub stars](https://img.shields.io/github/stars/MobilityData/gtfs-flex?style=flat)](https://github.com/MobilityData/gtfs-flex/stargazers) - A data format that models flexible public transportation services (microtransit/paratransit) as an extension to GTFS.
...
- [shared-row](https://github.com/d-wasserman/shared-row) [![GitHub stars](https://img.shields.io/github/stars/d-wasserman/shared-row?style=flat)](https://github.com/d-wasserman/shared-row/stargazers) - A data specification designed to represent the full cross-section of the right-of-way, integrating pedestrian, bicycle, and roadway elements into a unified dataset.
- [OpenSidewalks](https://github.com/OpenSidewalks/OpenSidewalks-Schema) [![GitHub stars](https://img.shields.io/github/stars/OpenSidewalks/OpenSidewalks-Schema?style=flat)](https://github.com/OpenSidewalks/OpenSidewalks-Schema/stargazers) - A data specification for routable pedestrian networks and describing and sharing pedestrian network and pedestrian network-adjacent data.
- [GBFS](https://github.com/NABSA/gbfs) [![GitHub stars](https://img.shields.io/github/stars/NABSA/gbfs?style=flat)](https://github.com/NABSA/gbfs/stargazers) - The General Bikeshare Feed Specification is a standardized data feed for shared mobility system availability.
...
- [Folium](https://github.com/python-visualization/folium) [![GitHub stars](https://img.shields.io/github/stars/python-visualization/folium?style=flat)](https://github.com/python-visualization/folium/stargazers) - A light weight library that uses leaflet to visualize geospatial data quickly in an interactive map. 
...
- [Peartree](https://github.com/kuanb/peartree) [![GitHub stars](https://img.shields.io/github/stars/kuanb/peartree?style=flat)](https://github.com/kuanb/peartree/stargazers) - Helps explore GTFS data and their network characteristics.
...
- [UrbanSim](https://github.com/udst/urbansim) [![GitHub stars](https://img.shields.io/github/stars/udst/urbansim?style=flat)](https://github.com/udst/urbansim/stargazers) - A platform for building statistical models of cities and regions. These models help forecast long-range patterns in real estate development, demographics, and related outcomes, under various policy scenarios. Information: License: BSD License: Provider: UrbanSim Inc. (UDST).
- [Geosnap](https://github.com/spatialucr/geosnap) [![GitHub stars](https://img.shields.io/github/stars/spatialucr/geosnap?style=flat)](https://github.com/spatialucr/geosnap/stargazers) - Geospatial & temporal neighborhood analysis using US Census Data.
...
- [Madina](https://github.com/City-Form-Lab/madina) [![GitHub stars](https://img.shields.io/github/stars/City-Form-Lab/madina?style=flat)](https://github.com/City-Form-Lab/madina/stargazers) - This is a package of classes and functions to streamline the representation and analysis of urban networks. This library includes a Python implementation of the Urban Network Analysis Tools. 
- [Pybikes](https://github.com/eskerda/pybikes) [![GitHub stars](https://img.shields.io/github/stars/eskerda/pybikes?style=flat)](https://github.com/eskerda/pybikes/stargazers) - Provides a set of tools to scrape bike sharing data from different websites and APIs, thus providing a coherent and generalized set of classes and methods to access this sort of information.
- [Leafmap](https://github.com/giswqs/leafmap) [![GitHub stars](https://img.shields.io/github/stars/giswqs/leafmap?style=flat)](https://github.com/giswqs/leafmap/stargazers) - A free and open-source Python package that enables users to analyze and visualize geospatial data with minimal coding in a Jupyter environment. Leafmap's interactive GUI allows no code layer management and analysis including a powerful analytical backend (i.e., [WhiteboxTools](https://www.whiteboxgeo.com/manual/wbt_book/intro.html)). Additional Information: [leafmap.org](https://leafmap.org/), [JOSS Article](https://joss.theoj.org/papers/10.21105/joss.03414), [Medium Article](https://medium.com/spatial-data-science/leafmap-a-new-python-package-for-geospatial-data-science-353735b3f889).
- [Prettymaps](https://github.com/marceloprates/prettymaps) [![GitHub stars](https://img.shields.io/github/stars/marceloprates/prettymaps?style=flat)](https://github.com/marceloprates/prettymaps/stargazers) - A small set of Python functions to draw pretty maps from OpenStreetMap data.
- [HerePy](https://github.com/abdullahselek/HerePy) [![GitHub stars](https://img.shields.io/github/stars/abdullahselek/HerePy?style=flat)](https://github.com/abdullahselek/HerePy/stargazers) - A library that provides a Python interface to HERE APIs.
- [StreetTraffic](https://github.com/streettraffic/streettraffic) [![GitHub stars](https://img.shields.io/github/stars/streettraffic/streettraffic?style=flat)](https://github.com/streettraffic/streettraffic/stargazers) - A Python package that crawls the traffic flow data of your favorite routes, cities by using the API provided by HERE.
...
- [Geemap](https://github.com/giswqs/geemap) [![GitHub stars](https://img.shields.io/github/stars/giswqs/geemap?style=flat)](https://github.com/giswqs/geemap/stargazers) - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
- [Gleam](https://github.com/dgrtwo/gleam) [![GitHub stars](https://img.shields.io/github/stars/dgrtwo/gleam?style=flat)](https://github.com/dgrtwo/gleam/stargazers) - A plotting library inspired by R-Shiny to create interactive plots.
- [Urbansprawl](https://github.com/lgervasoni/urbansprawl) [![GitHub stars](https://img.shields.io/github/stars/lgervasoni/urbansprawl?style=flat)](https://github.com/lgervasoni/urbansprawl/stargazers) - The urbansprawl project provides an open source framework for assessing urban sprawl using open data. It uses OpenStreetMap (OSM) data to calculate its sprawling indices, divided in Accessibility, Land use mix, and Dispersion.
...
- [rasterio](https://github.com/rasterio/rasterio/blob/master/docs/index.rst) [![GitHub stars](https://img.shields.io/github/stars/rasterio/rasterio/blob/master/docs/index.rst?style=flat)](https://github.com/rasterio/rasterio/blob/master/docs/index.rst/stargazers) - Geographic information systems use GeoTIFF and other formats to organize and store gridded raster datasets such as satellite imagery and terrain models.
...
- [Neatnet](https://github.com/uscuni/neatnet) [![GitHub stars](https://img.shields.io/github/stars/uscuni/neatnet?style=flat)](https://github.com/uscuni/neatnet/stargazers) - An open source library for simplifying the structure of street networks.
- [Linref](https://github.com/tariqshihadah/linref) [![GitHub stars](https://img.shields.io/github/stars/tariqshihadah/linref?style=flat)](https://github.com/tariqshihadah/linref/stargazers) - A library that builds on tabular and geospatial libraries to implement powerful features for linearly referenced data through event collection objects. 
...
- [leafgl](https://github.com/r-spatial/leafgl) [![GitHub stars](https://img.shields.io/github/stars/r-spatial/leafgl?style=flat)](https://github.com/r-spatial/leafgl/stargazers) - R package for fast web-gl rendering for leaflet maps.
...
- [Rgee](https://github.com/r-spatial/rgee) [![GitHub stars](https://img.shields.io/github/stars/r-spatial/rgee?style=flat)](https://github.com/r-spatial/rgee/stargazers) - Is an R binding package for calling Google Earth Engine API from within R. Various functions are implemented to simplify the connection with the R spatial ecosystem.
- [r5r](https://github.com/ipeaGIT/r5r) [![GitHub stars](https://img.shields.io/github/stars/ipeaGIT/r5r?style=flat)](https://github.com/ipeaGIT/r5r/stargazers) - Is an R package for rapid realistic routing on multimodal transport networks (walk, bike, public transport and car) leveraging the Conveyal R5 routing engine.
...
- [civic-tech-patterns](https://github.com/codeforamerica/civic-tech-patterns) [![GitHub stars](https://img.shields.io/github/stars/codeforamerica/civic-tech-patterns?style=flat)](https://github.com/codeforamerica/civic-tech-patterns/stargazers) - Common patterns and anti-patterns for civic tech and civic applications. Additional Information: Provided by Code for America.
- [global-indicators](https://github.com/global-healthy-liveable-cities/global-indicators) [![GitHub stars](https://img.shields.io/github/stars/global-healthy-liveable-cities/global-indicators?style=flat)](https://github.com/global-healthy-liveable-cities/global-indicators/stargazers) - Case study projected dedicated to developing global healthy and sustainable city-indicators collaboration.
...
- [Chart.js](https://www.chartjs.org/) - Create simple (or advanced) visualizations of data for web and mobile. Additional Information: [GitHub](https://github.com/chartjs/Chart.js) [![GitHub stars](https://img.shields.io/github/stars/chartjs/Chart.js?style=flat)](https://github.com/chartjs/Chart.js/stargazers).
...
- [Turf.js](https://turfjs.org/) - Advanced geospatial analysis for browsers and Node.js. Additional Information: [GitHub](https://github.com/Turfjs/turf) [![GitHub stars](https://img.shields.io/github/stars/Turfjs/turf?style=flat)](https://github.com/Turfjs/turf/stargazers).
- [GTFS-Js](https://github.com/WSDOT-GIS/GTFS-JS) [![GitHub stars](https://img.shields.io/github/stars/WSDOT-GIS/GTFS-JS?style=flat)](https://github.com/WSDOT-GIS/GTFS-JS/stargazers) - JavaScript library for working with GTFS data. Additional Information: Unlicense: WSDOT.

### Learning to Code
Resources for planners learning coding and urban informatics.
- [Urban Informatics & Visualization-Berkeley](https://github.com/waddell/urban-informatics-and-visualization) [![GitHub stars](https://img.shields.io/github/stars/waddell/urban-informatics-and-visualization?style=flat)](https://github.com/waddell/urban-informatics-and-visualization/stargazers) - Urban Informatics and Visualization (UC Berkeley CP255) Class Jupyter Notebook examples. Provides various resources to applied Python in planning contexts.
...
- [City Energy Analyst](https://cityenergyanalyst.com/) - A series of [open-source](https://github.com/architecture-building-systems/CityEnergyAnalyst) [![GitHub stars](https://img.shields.io/github/stars/architecture-building-systems/CityEnergyAnalyst?style=flat)](https://github.com/architecture-building-systems/CityEnergyAnalyst/stargazers) tools for the analysis and optimization of urban energy systems.
...
- [BlenderGIS](https://github.com/domlysz/BlenderGIS) [![GitHub stars](https://img.shields.io/github/stars/domlysz/BlenderGIS?style=flat)](https://github.com/domlysz/BlenderGIS/stargazers) - A free and open-source add on for [Blender](https://www.blender.org/) which allows users to explore, query, and visualize data directly through Blender's GUI.
...
- [CityEngine](https://www.esri.com/en-us/arcgis/products/arcgis-cityengine/overview) - Advanced 3D modeling software for creating huge, interactive and immersive urban environments in less time than traditional modeling techniques. The cities you create using CityEngine can be based on real-world GIS data and the procedural rules that can help quickly create [streets](https://github.com/d-wasserman/Complete_Street_Rule) [![GitHub stars](https://img.shields.io/github/stars/d-wasserman/Complete_Street_Rule?style=flat)](https://github.com/d-wasserman/Complete_Street_Rule/stargazers) & [buildings](https://www.arcgis.com/home/group.html?id=01695af30a384c1e823fa4d72497309d#overview).
...
- [UrbanCanvas](https://urbansim.com/urbancanvas) - Modeler is a web-based platform designed for planners and modelers to generate long-range, small area socioeconomic forecasts using [UrbanSim](https://github.com/UDST/urbansim) [![GitHub stars](https://img.shields.io/github/stars/UDST/urbansim?style=flat)](https://github.com/UDST/urbansim/stargazers) to inform Regional Transportation Plans.
...
- [Tile2Net](https://github.com/VIDA-NYU/tile2net?tab=readme-ov-file) [![GitHub stars](https://img.shields.io/github/stars/VIDA-NYU/tile2net?tab=readme-ov-file?style=flat)](https://github.com/VIDA-NYU/tile2net?tab=readme-ov-file/stargazers) - An end-to-end tool for automated mapping of pedestrian infrastructure from aerial imagery. It provides a deep learning models that semantically segments pedestrian infrastructure from imagery for digitization. It is also available on the Esri Atlas of [models](https://www.arcgis.com/home/item.html?id=c0d520baa30d4b47ab36232231c17875). 
...
This page is registered as an [awesome-list](https://github.com/topics/awesome-list) [![GitHub stars](https://img.shields.io/github/stars/topics/awesome-list?style=flat)](https://github.com/topics/awesome-list/stargazers), but similar GitHub repositories can be listed here. These are managed curations of resources that relate to different topics.

- [awesome-transit](https://github.com/CUTR-at-USF/awesome-transit) [![GitHub stars](https://img.shields.io/github/stars/CUTR-at-USF/awesome-transit?style=flat)](https://github.com/CUTR-at-USF/awesome-transit/stargazers) - A collection of transit data tools and resources.
- [micromobility-tools-and-resources](https://github.com/NABSA/micromobility-tools-and-resources) [![GitHub stars](https://img.shields.io/github/stars/NABSA/micromobility-tools-and-resources?style=flat)](https://github.com/NABSA/micromobility-tools-and-resources/stargazers) - A collection of micromobility tools and data resources.
- [awesome-sustainable-technology](https://github.com/protontypes/open-sustainable-technology) [![GitHub stars](https://img.shields.io/github/stars/protontypes/open-sustainable-technology?style=flat)](https://github.com/protontypes/open-sustainable-technology/stargazers) - A curated list of open technology projects to sustain a stable climate, energy supply, and vital natural resources.
- [awesome-gis](https://github.com/sshuair/awesome-gis) [![GitHub stars](https://img.shields.io/github/stars/sshuair/awesome-gis?style=flat)](https://github.com/sshuair/awesome-gis/stargazers) - Awesome GIS is a collection of geospatial related sources, including cartographic tools, geoanalysis tools, developer tools, data, conference & communities, news, massive open online course, some amazing map sites, and more.
- [awesome-agriculture](https://github.com/brycejohnston/awesome-agriculture) [![GitHub stars](https://img.shields.io/github/stars/brycejohnston/awesome-agriculture?style=flat)](https://github.com/brycejohnston/awesome-agriculture/stargazers) - Open source technology for agriculture, farming, and gardening.
- [awesome-geojson](https://github.com/tmcw/awesome-geojson) [![GitHub stars](https://img.shields.io/github/stars/tmcw/awesome-geojson?style=flat)](https://github.com/tmcw/awesome-geojson/stargazers) - GeoJSON utilities that will make your life easier.
- [ai-collection](https://github.com/ai-collection/ai-collection) [![GitHub stars](https://img.shields.io/github/stars/ai-collection/ai-collection?style=flat)](https://github.com/ai-collection/ai-collection/stargazers) - Review of the generative AI landscape including tools/utilities.
...
- [Urban Computing Foundation](https://github.com/ucfoundation) [![GitHub stars](https://img.shields.io/github/stars/ucfoundation?style=flat)](https://github.com/ucfoundation/stargazers) - Accelerating open source and community development that improves mobility, safety, infrastructure, traffic, and energy consumption in connected cities. Additional Information: [Landscape](https://landscape.uc.foundation/).
...
We are actively looking for contributions from those interested in urban planning and technology. To find out more, visit the [Contribution](https://github.com/APA-Technology-Division/planning-technology-resources/blob/main/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/APA-Technology-Division/planning-technology-resources/blob/main/CONTRIBUTING.md?style=flat)](https://github.com/APA-Technology-Division/planning-technology-resources/blob/main/CONTRIBUTING.md/stargazers) page to see our recommended format. For large contributions, file an issue first. The advantage of contributing to the repo in this manner is that your addition to this shared resource will be recorded.

## License and Citation
Similar to other [resources aggregators](https://github.com/NABSA/micromobility-tools-and-resources/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/NABSA/micromobility-tools-and-resources/blob/master/README.md?style=flat)](https://github.com/NABSA/micromobility-tools-and-resources/blob/master/README.md/stargazers), this repository is released into CC 1.0. We do not require citation, but in order to generate more contributions for and understanding of this resource we do appreciate sharing this repository or citing it where appropriate.
