...
- [reitzig/texlive-docker](https://github.com/reitzig/texlive-docker) [![GitHub stars](https://img.shields.io/github/stars/reitzig/texlive-docker?style=flat)](https://github.com/reitzig/texlive-docker/stargazers) - minimal TeXLive system with package installation possibility
- [Island of TeX/texlive](https://gitlab.com/islandoftex/images/texlive) - debian-based full TeXLive system
- [dante-ev/docker-texlive](https://github.com/dante-ev/docker-texlive) [![GitHub stars](https://img.shields.io/github/stars/dante-ev/docker-texlive?style=flat)](https://github.com/dante-ev/docker-texlive/stargazers) - debian-based full TeXLive system with additions with pandoc, perl, and python pre-installed
...
- [xhub](https://github.com/nschloe/xhub) [![GitHub stars](https://img.shields.io/github/stars/nschloe/xhub?style=flat)](https://github.com/nschloe/xhub/stargazers) - Browser extension that lets you use LaTeX in GitHub pages. ![foss]
...
- [Oleafly](https://github.com/Oleafly/Oleafly) [![GitHub stars](https://img.shields.io/github/stars/Oleafly/Oleafly?style=flat)](https://github.com/Oleafly/Oleafly/stargazers) - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
- [Sublime Text](https://www.sublimetext.com) [![Sublime Text][awesome]](https://github.com/dreikanter/sublime-bookmarks)
  - [LaTeXing](https://github.com/LaTeXing/LaTeXing) [![GitHub stars](https://img.shields.io/github/stars/LaTeXing/LaTeXing?style=flat)](https://github.com/LaTeXing/LaTeXing/stargazers) - Free plug-in to edit LaTeX. ![foss]
  - [LaTeXTools](https://github.com/SublimeText/LaTeXTools) [![GitHub stars](https://img.shields.io/github/stars/SublimeText/LaTeXTools?style=flat)](https://github.com/SublimeText/LaTeXTools/stargazers) - Free LaTeX plugin for Sublime Text. ![foss]
...
- [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ![foss]
  ...
  - [LaTeX Live Preview](https://github.com/xuhdev/vim-latex-live-preview) [![GitHub stars](https://img.shields.io/github/stars/xuhdev/vim-latex-live-preview?style=flat)](https://github.com/xuhdev/vim-latex-live-preview/stargazers) - Instantly previews your LaTeX document. ![foss]
  - [vimtex](https://github.com/lervag/vimtex) [![GitHub stars](https://img.shields.io/github/stars/lervag/vimtex?style=flat)](https://github.com/lervag/vimtex/stargazers) - Modern vim plugin for editing LaTeX files. Has a variety of features including live preview and forward search. ![foss]

- [IntelliJ](https://www.jetbrains.com/idea/)
  - [TeXiFy-IDEA](https://github.com/Hannah-Sten/TeXiFy-IDEA) [![GitHub stars](https://img.shields.io/github/stars/Hannah-Sten/TeXiFy-IDEA?style=flat)](https://github.com/Hannah-Sten/TeXiFy-IDEA/stargazers) - Free LaTeX plugin for IntelliJ IDEA. ![foss]

- [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ![foss]
  - [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) [![GitHub stars](https://img.shields.io/github/stars/James-Yu/LaTeX-Workshop?style=flat)](https://github.com/James-Yu/LaTeX-Workshop/stargazers) - LaTeX extension for Visual Studio Code ![foss]
  - [a-nau/latex-devcontainer](https://github.com/a-nau/latex-devcontainer) [![GitHub stars](https://img.shields.io/github/stars/a-nau/latex-devcontainer?style=flat)](https://github.com/a-nau/latex-devcontainer/stargazers) - Devcontainer setup for easy LaTeX usage without local installation ![foss]
...
- [Modern LaTeX Editor](https://github.com/InMDev/Modern-LaTeX-Editor) [![GitHub stars](https://img.shields.io/github/stars/InMDev/Modern-LaTeX-Editor?style=flat)](https://github.com/InMDev/Modern-LaTeX-Editor/stargazers) - Online editor, no-signup hybrid code editor + visual editor that mixes Notion/Google docs/Microsoft Word-like editing with raw LaTeX code blocks.
...
- [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition](https://github.com/overleaf/overleaf) [![GitHub stars](https://img.shields.io/github/stars/overleaf/overleaf?style=flat)](https://github.com/overleaf/overleaf/stargazers) (self-hosted, AGPL licensed). ![foss]
  - [olcli](https://github.com/aloth/olcli) [![GitHub stars](https://img.shields.io/github/stars/aloth/olcli?style=flat)](https://github.com/aloth/olcli/stargazers) - Command-line interface for Overleaf to sync, manage, and compile projects from the terminal. ![foss]
- [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) [![GitHub stars](https://img.shields.io/github/stars/ywatanabe1989/scitex-cloud?style=flat)](https://github.com/ywatanabe1989/scitex-cloud/stargazers) - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
- [WebLaTeX](https://github.com/sanjib-sen/weblatex) [![GitHub stars](https://img.shields.io/github/stars/sanjib-sen/weblatex?style=flat)](https://github.com/sanjib-sen/weblatex/stargazers) - Web-based vscode with Git Integration + Copilot + Grammar & Spell Checker + Live Collaboration Support based on GitHub Codespace and Dev container.
...
- [TexLab](https://github.com/latex-lsp/texlab) [![GitHub stars](https://img.shields.io/github/stars/latex-lsp/texlab?style=flat)](https://github.com/latex-lsp/texlab/stargazers) - Language server for LaTeX and BibTeX with completion, definitions, references, rename, formatting, and forward search. ![foss]
- [Badness](https://github.com/jolars/badness) [![GitHub stars](https://img.shields.io/github/stars/jolars/badness?style=flat)](https://github.com/jolars/badness/stargazers) - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]

## Bibliography tools

- [JabRef](https://www.jabref.org) - Very powerful cross-platform (Java) bibtex editor. ![mac] ![windows] ![linux] ![foss]
- [Papis](https://github.com/papis/papis) [![GitHub stars](https://img.shields.io/github/stars/papis/papis?style=flat)](https://github.com/papis/papis/stargazers) - Extremely customizable,
...
- [betterbib](https://github.com/nschloe/betterbib) [![GitHub stars](https://img.shields.io/github/stars/nschloe/betterbib?style=flat)](https://github.com/nschloe/betterbib/stargazers) - Command-line utility for improving your BibTeX files. Fetches information from online sources. ![mac] ![windows] ![linux] ![foss]
- [OneCite](https://github.com/HzaCode/OneCite) [![GitHub stars](https://img.shields.io/github/stars/HzaCode/OneCite?style=flat)](https://github.com/HzaCode/OneCite/stargazers) - Universal citation management and academic reference toolkit that converts messy references into perfectly formatted citations. Supports DOI, arXiv ID, titles, and more, with output in BibTeX, APA, and MLA formats. ![mac] ![windows] ![linux] ![foss]
- [CrossRef Local](https://github.com/ywatanabe1989/crossref-local) [![GitHub stars](https://img.shields.io/github/stars/ywatanabe1989/crossref-local?style=flat)](https://github.com/ywatanabe1989/crossref-local/stargazers) - Local CrossRef database (167M papers) with full-text search, impact factor data, Python API for bibliography enrichment, and an MCP server (15 tools). ![foss]
- [OpenAlex Local](https://github.com/ywatanabe1989/openalex-local) [![GitHub stars](https://img.shields.io/github/stars/ywatanabe1989/openalex-local?style=flat)](https://github.com/ywatanabe1989/openalex-local/stargazers) - Local OpenAlex database (284M scholarly works) with abstracts and semantic search for literature discovery, and an MCP server. ![foss]

## Build Tools

Compiling LaTeX documents can be tedious, build tools help you to manage the compilation process.

- [Arara](https://www.ctan.org/pkg/arara) ([GitHub repo](https://github.com/islandoftex/arara) [![GitHub stars](https://img.shields.io/github/stars/islandoftex/arara?style=flat)](https://github.com/islandoftex/arara/stargazers)) - Simple tool that allows you to specify which tools to call inside your document and it can be extended quite easily. ![foss]
...
- [xu-cheng/latex-action](https://github.com/xu-cheng/latex-action) [![GitHub stars](https://img.shields.io/github/stars/xu-cheng/latex-action?style=flat)](https://github.com/xu-cheng/latex-action/stargazers) - GitHub Action to compile LaTeX documents
- [dante-ev/latex-action](https://github.com/dante-ev/latex-action) [![GitHub stars](https://img.shields.io/github/stars/dante-ev/latex-action?style=flat)](https://github.com/dante-ev/latex-action/stargazers) - DANTE e.V.'s GitHub action to compile LaTeX documents. Offers a full TeXLive and pre-installed perl and python.

## Misc. Tools

- [CaTeX](https://github.com/Alexis-benoist/CaTeX) [![GitHub stars](https://img.shields.io/github/stars/Alexis-benoist/CaTeX?style=flat)](https://github.com/Alexis-benoist/CaTeX/stargazers) - Concatenates LaTeX documents with attention for properly merging the preamble.
...
- [SciTeX Writer](https://github.com/ywatanabe1989/scitex-writer) [![GitHub stars](https://img.shields.io/github/stars/ywatanabe1989/scitex-writer?style=flat)](https://github.com/ywatanabe1989/scitex-writer/stargazers) - Manuscript compilation system with templates for manuscripts, revisions, and supplementary materials, plus figure, table, and citation handling, and an MCP server (38 tools). ![foss]
...
- [tex-fmt](https://github.com/WGUNDERWOOD/tex-fmt) [![GitHub stars](https://img.shields.io/github/stars/WGUNDERWOOD/tex-fmt?style=flat)](https://github.com/WGUNDERWOOD/tex-fmt/stargazers) - Extremely fast LaTeX formatter written in Rust, with sensible defaults and minimal configuration. ![foss]
- [Badness](https://github.com/jolars/badness) [![GitHub stars](https://img.shields.io/github/stars/jolars/badness?style=flat)](https://github.com/jolars/badness/stargazers) - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]

### Quality Check Tools

- [ChkTeX](https://www.nongnu.org/chktex/) - Linter / code checker for LaTeX documents. ![foss]
- [blacktex](https://github.com/nschloe/blacktex) [![GitHub stars](https://img.shields.io/github/stars/nschloe/blacktex?style=flat)](https://github.com/nschloe/blacktex/stargazers) - Command-line tool that replaces commonly occurring LaTeX anti-patterns and cleans up your files. ![windows] ![linux] ![mac] ![foss]
- [TeXtidote](https://github.com/sylvainhalle/textidote) [![GitHub stars](https://img.shields.io/github/stars/sylvainhalle/textidote?style=flat)](https://github.com/sylvainhalle/textidote/stargazers) - A cross-platform (Java) spelling, grammar and style checker for LaTeX documents. ![windows] ![linux] ![mac] ![foss]
- [Badness](https://github.com/jolars/badness) [![GitHub stars](https://img.shields.io/github/stars/jolars/badness?style=flat)](https://github.com/jolars/badness/stargazers) - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
- [latex2arxiv](https://github.com/YuZh98/latex2arxiv) [![GitHub stars](https://img.shields.io/github/stars/YuZh98/latex2arxiv?style=flat)](https://github.com/YuZh98/latex2arxiv/stargazers) - CLI tool that prepares a LaTeX project for arXiv submission: prunes unreachable files, strips draft markup, validates the bibliography, and catches desk-rejection errors before upload. Also available as a GitHub Action and MCP server for AI agents. ![windows] ![linux] ![mac] ![foss]
...
- [TikzEdt](https://www.tikzedt.org) (also: [GitHub repo](https://github.com/hchapman/tikzedt) [![GitHub stars](https://img.shields.io/github/stars/hchapman/tikzedt?style=flat)](https://github.com/hchapman/tikzedt/stargazers)) - WYSIWYG and text-based editor for TikZ pictures. ![foss]
- [TikZ-Editor](https://github.com/fredokun/TikZ-Editor) [![GitHub stars](https://img.shields.io/github/stars/fredokun/TikZ-Editor?style=flat)](https://github.com/fredokun/TikZ-Editor/stargazers) - Live-previewing editor for TikZ figures. ![mac] ![linux] ![foss]
...
- [PetarV-/TikZ](https://github.com/PetarV-/TikZ) [![GitHub stars](https://img.shields.io/github/stars/PetarV-/TikZ?style=flat)](https://github.com/PetarV-/TikZ/stargazers) - Collection of publication-ready PGF/TikZ figures by Petar Veličković.
- [matlab2tikz](https://github.com/matlab2tikz/matlab2tikz) [![GitHub stars](https://img.shields.io/github/stars/matlab2tikz/matlab2tikz?style=flat)](https://github.com/matlab2tikz/matlab2tikz/stargazers) - Convert your MATLAB plots to PGFPlots/TikZ. ![windows] ![linux] ![mac] ![foss]
- [tikzplotlib](https://github.com/nschloe/tikzplotlib) [![GitHub stars](https://img.shields.io/github/stars/nschloe/tikzplotlib?style=flat)](https://github.com/nschloe/tikzplotlib/stargazers) - Convert your matplotlib plots to PGFPlots/TikZ. ![windows] ![linux] ![mac] ![foss]
- [TikZBlog](https://latexdraw.com) - Step-by-Step Tutorials about How to Draw Illustrations in LaTeX.
- [OpenTikZ](https://github.com/opentikz/opentikz) [![GitHub stars](https://img.shields.io/github/stars/opentikz/opentikz?style=flat)](https://github.com/opentikz/opentikz/stargazers) - Community library of copyable TikZ icons and editable, parametric templates for academic conceptual diagrams (system/architecture, pipelines, flowcharts); CC0 content, with a Claude Code skill to edit figures on request. ![foss]
...
- [Ultimate Beamer Theme List](https://github.com/martinbjeldbak/ultimate-beamer-theme-list) [![GitHub stars](https://img.shields.io/github/stars/martinbjeldbak/ultimate-beamer-theme-list?style=flat)](https://github.com/martinbjeldbak/ultimate-beamer-theme-list/stargazers) - Links to various beamer themes along with PDF previews.
- [LaTeX Beamer Theme Overview](https://github.com/UweZiegenhagen/LaTeX-Beamer-Theme-Overview/blob/main/OVERVIEW.md) [![GitHub stars](https://img.shields.io/github/stars/UweZiegenhagen/LaTeX-Beamer-Theme-Overview/blob/main/OVERVIEW.md?style=flat)](https://github.com/UweZiegenhagen/LaTeX-Beamer-Theme-Overview/blob/main/OVERVIEW.md/stargazers) - Visual overview of beamer themes included in TeXLive
- [TeXtured](https://github.com/jdujava/TeXtured) [![GitHub stars](https://img.shields.io/github/stars/jdujava/TeXtured?style=flat)](https://github.com/jdujava/TeXtured/stargazers) - A typographically elegant, clean, and structured LaTeX template (primarily intended for theses).
...
- [MartinThoma's LaTeX example](https://github.com/MartinThoma/LaTeX-examples/) [![GitHub stars](https://img.shields.io/github/stars/MartinThoma/LaTeX-examples/?style=flat)](https://github.com/MartinThoma/LaTeX-examples//stargazers) - GitHub repository containing example LaTeX documents.
...
- [Awesome LaTeX drawing](https://github.com/xinychen/awesome-latex-drawing) [![GitHub stars](https://img.shields.io/github/stars/xinychen/awesome-latex-drawing?style=flat)](https://github.com/xinychen/awesome-latex-drawing/stargazers) - Curated list of academic drawing examples for using LaTeX
...
- [Begin LaTeX in minutes](https://github.com/luong-komorebi/Begin-Latex-in-minutes) [![GitHub stars](https://img.shields.io/github/stars/luong-komorebi/Begin-Latex-in-minutes?style=flat)](https://github.com/luong-komorebi/Begin-Latex-in-minutes/stargazers) - Brief intro to LaTeX for beginners that helps you use LaTeX with ease.
