...
> 来源：[passy/awesome-recursion-schemes](https://github.com/passy/awesome-recursion-schemes)

[![GitHub stars](https://img.shields.io/github/stars/passy/awesome-recursion-schemes?style=flat)](https://github.com/passy/awesome-recursion-schemes/stargazers)
...
- [Awesome Recursion Schemes](https://github.com/passy/awesome-recursion-schemes) [![GitHub stars](https://img.shields.io/github/stars/passy/awesome-recursion-schemes?style=flat)](https://github.com/passy/awesome-recursion-schemes/stargazers) - A curation of useful resources for learning about and using recursion schemes.
...
- [Cheat Sheet](https://github.com/sellout/recursion-scheme-talk/blob/master/cheat%20sheet.pdf) [![GitHub stars](https://img.shields.io/github/stars/sellout/recursion-scheme-talk/blob/master/cheat%20sheet.pdf?style=flat)](https://github.com/sellout/recursion-scheme-talk/blob/master/cheat%20sheet.pdf/stargazers) - Map of various recursion schemes and their duals.
...
- [recursion-scheme-talk](https://github.com/sellout/recursion-scheme-talk) [![GitHub stars](https://img.shields.io/github/stars/sellout/recursion-scheme-talk?style=flat)](https://github.com/sellout/recursion-scheme-talk/stargazers) - Collection of slide decks about recursion schemes.
...
- [recursion-schemes](https://github.com/ekmett/recursion-schemes/) [![GitHub stars](https://img.shields.io/github/stars/ekmett/recursion-schemes/?style=flat)](https://github.com/ekmett/recursion-schemes//stargazers) for
  Haskell - The canonical implementation by Edward Kmett.
- [Matryoshka](https://github.com/slamdata/matryoshka) [![GitHub stars](https://img.shields.io/github/stars/slamdata/matryoshka?style=flat)](https://github.com/slamdata/matryoshka/stargazers) for Scala using Scalaz -
  Generalized folds, unfolds, and traversals for fixed point data structures.
- [andyscott/droste](https://github.com/andyscott/droste) [![GitHub stars](https://img.shields.io/github/stars/andyscott/droste?style=flat)](https://github.com/andyscott/droste/stargazers) for Scala using Cats -
  Generalized folds, unfolds, and traversals for fixed point data structures.
- [recursion\_schemes](https://github.com/vmchale/recursion_schemes/) [![GitHub stars](https://img.shields.io/github/stars/vmchale/recursion_schemes/?style=flat)](https://github.com/vmchale/recursion_schemes//stargazers) for
  Idris, based off Edward Kmett's Haskell library.
- [purescript-matryoshka](https://github.com/slamdata/purescript-matryoshka) [![GitHub stars](https://img.shields.io/github/stars/slamdata/purescript-matryoshka?style=flat)](https://github.com/slamdata/purescript-matryoshka/stargazers) for PureScript -
  Work-in-process port of matryoshka.
- [recursion](https://github.com/vmchale/recursion) [![GitHub stars](https://img.shields.io/github/stars/vmchale/recursion?style=flat)](https://github.com/vmchale/recursion/stargazers) for ATS - Demonstration of
  recursion schemes in ATS.
- [dada](https://github.com/sellout/dada) [![GitHub stars](https://img.shields.io/github/stars/sellout/dada?style=flat)](https://github.com/sellout/dada/stargazers) for Dhall - a library for recursion
  schemes in Dhall.
- [static-land-recursion-schemes](https://github.com/JosephJNK/static-land-recursion-schemes) [![GitHub stars](https://img.shields.io/github/stars/JosephJNK/static-land-recursion-schemes?style=flat)](https://github.com/JosephJNK/static-land-recursion-schemes/stargazers) for JavaScript/Flow -
  Schemes for data structures written in the style of [flow-static-land](https://github.com/gcanti/flow-static-land) [![GitHub stars](https://img.shields.io/github/stars/gcanti/flow-static-land?style=flat)](https://github.com/gcanti/flow-static-land/stargazers).
- [Katalyst](https://github.com/aedans/Katalyst) [![GitHub stars](https://img.shields.io/github/stars/aedans/Katalyst?style=flat)](https://github.com/aedans/Katalyst/stargazers) for Kotlin - a re-envisioning based off Matryoshka using lightweight higher kinded polymorphism.
