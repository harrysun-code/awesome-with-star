...
- [CakeSymfonyMailer plugin](https://github.com/josbeir/cakephp-symfony-mailer) [![GitHub stars](https://img.shields.io/github/stars/josbeir/cakephp-symfony-mailer?style=flat)](https://github.com/josbeir/cakephp-symfony-mailer/stargazers) - Use Symfony Mailer as a CakePHP mail transport.
...
- [FeatureFlags plugin](https://github.com/orca-services/cakephp-feature-flags) [![GitHub stars](https://img.shields.io/github/stars/orca-services/cakephp-feature-flags?style=flat)](https://github.com/orca-services/cakephp-feature-flags/stargazers) - A plugin for managing feature flags in your code.
...
- [Setup:Maintenance](https://github.com/dereuromark/cakephp-setup/blob/master/docs/maintenance/index.md) [![GitHub stars](https://img.shields.io/github/stars/dereuromark/cakephp-setup/blob/master/docs/maintenance/index.md?style=flat)](https://github.com/dereuromark/cakephp-setup/blob/master/docs/maintenance/index.md/stargazers) - Maintenance shell to go into maintenance mode for all requests with optional IP whitelisting.
