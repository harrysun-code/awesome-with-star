...
- [d3-dsv](https://github.com/d3/d3-dsv) [![GitHub stars](https://img.shields.io/github/stars/d3/d3-dsv?style=flat)](https://github.com/d3/d3-dsv/stargazers) - d3.js parser and formatter module for delimiter-separated values.
...
- [graph-cli](https://github.com/mcastorina/graph-cli) [![GitHub stars](https://img.shields.io/github/stars/mcastorina/graph-cli?style=flat)](https://github.com/mcastorina/graph-cli/stargazers) - Flexible command line tool to create graphs from CSV data.
...
- [Csvlint.go](https://github.com/Clever/csvlint) [![GitHub stars](https://img.shields.io/github/stars/Clever/csvlint?style=flat)](https://github.com/Clever/csvlint/stargazers) - Command line tool for validating CSV files against RFC 4180.
- [csvstudio](http://www.csvstudio.com/) - A smart app to repair syntax errors in very large CSV files.
- [scrubcsv](https://github.com/faradayio/scrubcsv) [![GitHub stars](https://img.shields.io/github/stars/faradayio/scrubcsv?style=flat)](https://github.com/faradayio/scrubcsv/stargazers) - Remove bad records from a CSV file and normalize (requires rust)
- [reconcile-csv](https://github.com/OpenRefine/reconcile-csv/blob/master/README.md) [![GitHub stars](https://img.shields.io/github/stars/OpenRefine/reconcile-csv/blob/master/README.md?style=flat)](https://github.com/OpenRefine/reconcile-csv/blob/master/README.md/stargazers) - Find relationships between a set of related CSVs
...
- [CSV to Table](https://github.com/vividvilla/csvtotable) [![GitHub stars](https://img.shields.io/github/stars/vividvilla/csvtotable?style=flat)](https://github.com/vividvilla/csvtotable/stargazers) - Convert CSV files to searchable and sortable HTML table.
...
- [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) [![GitHub stars](https://img.shields.io/github/stars/awesomedata/awesome-public-datasets?style=flat)](https://github.com/awesomedata/awesome-public-datasets/stargazers) - A topic-centric list of high-quality open datasets in public domains.
...
- [csv,specs](https://github.com/csvspecs) [![GitHub stars](https://img.shields.io/github/stars/csvspecs?style=flat)](https://github.com/csvspecs/stargazers) - Comma-Separated Values (CSV) Format Specifications (and Tests) incl. CSV v1.0, CSV v1.1, CSV Strict, CSV <3 Numerics, CSV<3 JSON, CSV <3 YAML.
...
- [CSVY](https://github.com/csvy/csvy.github.io/blob/master/index.md) [![GitHub stars](https://img.shields.io/github/stars/csvy/csvy.github.io/blob/master/index.md?style=flat)](https://github.com/csvy/csvy.github.io/blob/master/index.md/stargazers) - A standard for adding a YAML header to CSV files to describe their format

## META: Other similar lists

- [structured-text-tools](https://github.com/dbohdan/structured-text-tools) [![GitHub stars](https://img.shields.io/github/stars/dbohdan/structured-text-tools?style=flat)](https://github.com/dbohdan/structured-text-tools/stargazers) - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
