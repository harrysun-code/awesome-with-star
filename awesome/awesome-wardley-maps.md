...
- [OnlineWardleyMaps](https://github.com/damonsk/onlinewardleymaps) [![GitHub stars](https://img.shields.io/github/stars/damonsk/onlinewardleymaps?style=flat)](https://github.com/damonsk/onlinewardleymaps/stargazers) - Online open source mapping tool. For updates follow [@MapsAsCode](https://twitter.com/MapsAsCode) on Twitter. Hosted version available [here](https://onlinewardleymaps.com/). Online documentation [Wardley Maps as Code](https://docs.onlinewardleymaps.com/).
...
- [Wardley Maps for Obsidian.md](https://github.com/damonsk/obsidian-wardley-maps) [![GitHub stars](https://img.shields.io/github/stars/damonsk/obsidian-wardley-maps?style=flat)](https://github.com/damonsk/obsidian-wardley-maps/stargazers) - Render and edit Wardley maps within Obsidian.md. This community plugin leverages the engine from OnlineWardleyMaps.com. Online documentation [Wardley Maps as Code](https://docs.onlinewardleymaps.com/).
- [Wardley Maps for Jupyter Notebooks (ipywardley)](https://github.com/anjackson/ipywardley) [![GitHub stars](https://img.shields.io/github/stars/anjackson/ipywardley?style=flat)](https://github.com/anjackson/ipywardley/stargazers) - A plugin for generating Wardley maps in Jupyter Notebooks.
...
- [Go-Wardley](https://github.com/DavidGamba/go-wardley) [![GitHub stars](https://img.shields.io/github/stars/DavidGamba/go-wardley?style=flat)](https://github.com/DavidGamba/go-wardley/stargazers) - Generates a Wardley map in SVG format from a HCL-based map description file.
...
- [Doctrine](https://github.com/cdaniel/doctrine/) [![GitHub stars](https://img.shields.io/github/stars/cdaniel/doctrine/?style=flat)](https://github.com/cdaniel/doctrine//stargazers) - A simple tool for visualising how competitive a company is in light of Wardley's doctrine. Hosted version available [here](https://doctrine.wardleymaps.com/).
...
- [cli-owm](https://github.com/monkeypants/cli-owm) [![GitHub stars](https://img.shields.io/github/stars/monkeypants/cli-owm?style=flat)](https://github.com/monkeypants/cli-owm/stargazers) - Command-line tool that renders OnlineWardleyMaps DSL text to SVG. Pipes stdin to stdout, ships as npm package and standalone binaries. Uses the OnlineWardleyMaps parser.
...
- [wardley-omnigraffle](https://github.com/harrylove/wardley-omnigraffle) [![GitHub stars](https://img.shields.io/github/stars/harrylove/wardley-omnigraffle?style=flat)](https://github.com/harrylove/wardley-omnigraffle/stargazers) - Wardley mapping stencils for OmniGraffle.
- [Wardley Maps in LaTeX](https://github.com/latticecut/Wardley_Chapter2_Finding_a_path) [![GitHub stars](https://img.shields.io/github/stars/latticecut/Wardley_Chapter2_Finding_a_path?style=flat)](https://github.com/latticecut/Wardley_Chapter2_Finding_a_path/stargazers) - Figures 8 and 11 from the book by Simon Wardley to demonstrate drawing Wardley maps in LaTeX.
- [yEd Palette](https://github.com/colugo/yed-wardley) [![GitHub stars](https://img.shields.io/github/stars/colugo/yed-wardley?style=flat)](https://github.com/colugo/yed-wardley/stargazers) - Wardley maps palette for yEd.
...
- [Wardley Maps Battle Camp](https://github.com/simalexan/battlecamp) [![GitHub stars](https://img.shields.io/github/stars/simalexan/battlecamp?style=flat)](https://github.com/simalexan/battlecamp/stargazers) - Workshop rules, cards and materials.
- [Workshop Building Block - New Year's Eve Party](https://github.com/LeadingEdgeForum/faciliator-pack/blob/main/WorkshopBuildingBlock-NewYearsEveParty.md) [![GitHub stars](https://img.shields.io/github/stars/LeadingEdgeForum/faciliator-pack/blob/main/WorkshopBuildingBlock-NewYearsEveParty.md?style=flat)](https://github.com/LeadingEdgeForum/faciliator-pack/blob/main/WorkshopBuildingBlock-NewYearsEveParty.md/stargazers) - Help workshop participants gain confidence in mapping in a business-neutral environment.
