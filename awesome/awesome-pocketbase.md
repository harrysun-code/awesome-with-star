...
- [DigitalOcean](https://github.com/pocketbase/pocketbase/discussions/512) [![GitHub stars](https://img.shields.io/github/stars/pocketbase/pocketbase/discussions/512?style=flat)](https://github.com/pocketbase/pocketbase/discussions/512/stargazers) - Guide to deploy in a Droplet.
- [Fly.io](https://github.com/pocketbase/pocketbase/discussions/537) [![GitHub stars](https://img.shields.io/github/stars/pocketbase/pocketbase/discussions/537?style=flat)](https://github.com/pocketbase/pocketbase/discussions/537/stargazers) - Guide to deploy for free in Fly.io.
- [Railway](https://github.com/metruzanca/pocketbase_railway) [![GitHub stars](https://img.shields.io/github/stars/metruzanca/pocketbase_railway?style=flat)](https://github.com/metruzanca/pocketbase_railway/stargazers) - Guide to deploy on Railway.
- [AWS Lightsail](https://github.com/boustanihani/pocketbase-lightsail-hosting) [![GitHub stars](https://img.shields.io/github/stars/boustanihani/pocketbase-lightsail-hosting?style=flat)](https://github.com/boustanihani/pocketbase-lightsail-hosting/stargazers) - Guide to deploy to AWS Lightsail.
...
- [TinyCld](https://github.com/tinycld) [![GitHub stars](https://img.shields.io/github/stars/tinycld?style=flat)](https://github.com/tinycld/stargazers) - A full featured workspace with mail/calendar/drive/text/calc package, uses Pocketbase with React Native for realtime db and file storage.  Extends Pocketbase server with golang services for imap/smtp/caldav/webdav.
