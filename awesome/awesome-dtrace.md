...
> 来源：[xen0l/awesome-dtrace](https://github.com/xen0l/awesome-dtrace)

[![GitHub stars](https://img.shields.io/github/stars/xen0l/awesome-dtrace?style=flat)](https://github.com/xen0l/awesome-dtrace/stargazers)
...
- [Using DTrace stories](https://github.com/NanXiao/using-dtrace-stories) [![GitHub stars](https://img.shields.io/github/stars/NanXiao/using-dtrace-stories?style=flat)](https://github.com/NanXiao/using-dtrace-stories/stargazers) - A collection of using DTrace to debug system stories.
...
- [lua-usdt](https://github.com/chrisa/lua-usdt) [![GitHub stars](https://img.shields.io/github/stars/chrisa/lua-usdt?style=flat)](https://github.com/chrisa/lua-usdt/stargazers) - Libusdt bindings for Lua.

#### Node.js

- [node-dtrace-provider](https://github.com/chrisa/node-dtrace-provider) [![GitHub stars](https://img.shields.io/github/stars/chrisa/node-dtrace-provider?style=flat)](https://github.com/chrisa/node-dtrace-provider/stargazers) - Native DTrace probes for Node.js apps.

#### Perl

- [perl-Devel-DTrace-Provider](https://github.com/chrisa/perl-Devel-DTrace-Provider) [![GitHub stars](https://img.shields.io/github/stars/chrisa/perl-Devel-DTrace-Provider?style=flat)](https://github.com/chrisa/perl-Devel-DTrace-Provider/stargazers) - Perl wrapper for libusdt.
...
- [python-usdt](https://github.com/nshalman/python-usdt) [![GitHub stars](https://img.shields.io/github/stars/nshalman/python-usdt?style=flat)](https://github.com/nshalman/python-usdt/stargazers) - Libusdt bindings for Python.

#### Ruby

- [Ruby](http://ruby-doc.org/core-2.3.1/doc/dtrace_probes_rdoc.html) - Ruby DTrace probes.
- [ruby-usdt](https://github.com/kevinykchan/ruby-usdt) [![GitHub stars](https://img.shields.io/github/stars/kevinykchan/ruby-usdt?style=flat)](https://github.com/kevinykchan/ruby-usdt/stargazers) - Native DTrace probes for ruby apps.
...
- [mod_usdt](https://github.com/davepacheco/mod_usdt) [![GitHub stars](https://img.shields.io/github/stars/davepacheco/mod_usdt?style=flat)](https://github.com/davepacheco/mod_usdt/stargazers) - "httpd" DTrace provider.

### Visualization

- [FlameGraph](https://github.com/brendangregg/FlameGraph) [![GitHub stars](https://img.shields.io/github/stars/brendangregg/FlameGraph?style=flat)](https://github.com/brendangregg/FlameGraph/stargazers) - Stack trace visualizer.
- [node-stackvis](https://github.com/joyent/node-stackvis) [![GitHub stars](https://img.shields.io/github/stars/joyent/node-stackvis?style=flat)](https://github.com/joyent/node-stackvis/stargazers) - Stack trace visualizer.

## Tools

- [DTraceToolkit](http://www.brendangregg.com/dtracetoolkit.html) - A collection of useful documented DTrace scripts.
- [dtrace-cloud-tools](https://github.com/brendangregg/dtrace-cloud-tools) [![GitHub stars](https://img.shields.io/github/stars/brendangregg/dtrace-cloud-tools?style=flat)](https://github.com/brendangregg/dtrace-cloud-tools/stargazers) - DTrace tools written for the SmartOS/SmartDataCenter cloud (illumos-based).
- [pgsql tools](https://github.com/joyent/pgsqlstat) [![GitHub stars](https://img.shields.io/github/stars/joyent/pgsqlstat?style=flat)](https://github.com/joyent/pgsqlstat/stargazers) - Report top-level PostgreSQL stats.
- [portsnoop](https://github.com/davepacheco/portsnoop) [![GitHub stars](https://img.shields.io/github/stars/davepacheco/portsnoop?style=flat)](https://github.com/davepacheco/portsnoop/stargazers) - Trace event port activity.
- [storage tools](https://github.com/richardelling/tools) [![GitHub stars](https://img.shields.io/github/stars/richardelling/tools?style=flat)](https://github.com/richardelling/tools/stargazers) - Report NFS, CIFS and iSCSI stats.
...
Contributions are more than welcome! Please see [contribution guidelines](https://github.com/xen0l/awesome-dtrace/blob/master/CONTRIBUTING.md) [![GitHub stars](https://img.shields.io/github/stars/xen0l/awesome-dtrace/blob/master/CONTRIBUTING.md?style=flat)](https://github.com/xen0l/awesome-dtrace/blob/master/CONTRIBUTING.md/stargazers) first.
