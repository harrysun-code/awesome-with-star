...
- [SQLAlchemy Admin](https://github.com/smithyhq/sqladmin) [![GitHub stars](https://img.shields.io/github/stars/smithyhq/sqladmin?style=flat)](https://github.com/smithyhq/sqladmin/stargazers) - Admin Panel for FastAPI/Starlette that works with SQLAlchemy models.
...
- [FastAPI Casbin Auth](https://github.com/apache/casbin-python-fastapi-casbin-auth) [![GitHub stars](https://img.shields.io/github/stars/apache/casbin-python-fastapi-casbin-auth?style=flat)](https://github.com/apache/casbin-python-fastapi-casbin-auth/stargazers) - Authorization which supports various access control models like RBAC, ReBAC and ABAC through Casbin.
...
- [FastAPI Zitadel Auth](https://github.com/cleanenergyexchange/fastapi-zitadel-auth) [![GitHub stars](https://img.shields.io/github/stars/cleanenergyexchange/fastapi-zitadel-auth?style=flat)](https://github.com/cleanenergyexchange/fastapi-zitadel-auth/stargazers) - OAuth2 using the IAM platform [Zitadel](https://github.com/zitadel/zitadel) [![GitHub stars](https://img.shields.io/github/stars/zitadel/zitadel?style=flat)](https://github.com/zitadel/zitadel/stargazers).
...
- [secure](https://github.com/TypeError/secure) [![GitHub stars](https://img.shields.io/github/stars/TypeError/secure?style=flat)](https://github.com/TypeError/secure/stargazers) - Define and apply HTTP security headers consistently in FastAPI apps using ASGI middleware and a single configuration object.
...
- [Beanie](https://github.com/BeanieODM/beanie) [![GitHub stars](https://img.shields.io/github/stars/BeanieODM/beanie?style=flat)](https://github.com/BeanieODM/beanie/stargazers) - Asynchronous Python ODM for MongoDB, based on [Motor](https://motor.readthedocs.io/en/stable/) and [Pydantic](https://pydantic.dev/docs/), which supports data and schema migrations out of the box.
...
- [Pydantic-SQLAlchemy](https://github.com/tiangolo/pydantic-sqlalchemy) [![GitHub stars](https://img.shields.io/github/stars/tiangolo/pydantic-sqlalchemy?style=flat)](https://github.com/tiangolo/pydantic-sqlalchemy/stargazers) - Convert SQLAlchemy models to [Pydantic](https://pydantic.dev/docs/) models.
...
- [modern-di](https://github.com/modern-python/modern-di) [![GitHub stars](https://img.shields.io/github/stars/modern-python/modern-di?style=flat)](https://github.com/modern-python/modern-di/stargazers) - Dependency injection framework with IoC container and scopes, with a [FastAPI integration](https://github.com/modern-python/modern-di-fastapi) [![GitHub stars](https://img.shields.io/github/stars/modern-python/modern-di-fastapi?style=flat)](https://github.com/modern-python/modern-di-fastapi/stargazers).
...
- [FastAPI Viewsets](https://github.com/svalench/fastapi_viewsets) [![GitHub stars](https://img.shields.io/github/stars/svalench/fastapi_viewsets?style=flat)](https://github.com/svalench/fastapi_viewsets/stargazers) - Django REST Framework-inspired ViewSets for FastAPI, enabling class-based CRUD endpoint organization with automatic route registration.
...
- [Pydantic Resolve](https://github.com/KLR-Pattern/pydantic-resolve) [![GitHub stars](https://img.shields.io/github/stars/KLR-Pattern/pydantic-resolve?style=flat)](https://github.com/KLR-Pattern/pydantic-resolve/stargazers) -  Turns pydantic class into a powerful composable computing container by introducing resolve and post-process hooks.
...
- [FastAPI + SQLAlchemy 2 + PostgreSQL Template](https://github.com/modern-python/fastapi-sqlalchemy-template) [![GitHub stars](https://img.shields.io/github/stars/modern-python/fastapi-sqlalchemy-template?style=flat)](https://github.com/modern-python/fastapi-sqlalchemy-template/stargazers) - Dockerized starter with dependency injection (modern-di), Alembic migrations, and a justfile workflow.
