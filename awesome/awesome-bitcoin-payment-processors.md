...
| --------- |:----:|:---------:|:-----------------------:|:------------------:| ------------ |
| [BTCPay Server](https://btcpayserver.org/) | No fees | Yes | Yes | Via [Strike plugin](https://github.com/Marfusios/strike-btcpayserver-plugin) [![GitHub stars](https://img.shields.io/github/stars/Marfusios/strike-btcpayserver-plugin?style=flat)](https://github.com/Marfusios/strike-btcpayserver-plugin/stargazers) or [Exchange Integration](https://redbtc.org/flows/integrations/kraken-exchange/) | 2 GB RAM, 80 GB Storage, Docker |
| [One Time Address](https://github.com/alexk111/One-Time-Address) [![GitHub stars](https://img.shields.io/github/stars/alexk111/One-Time-Address?style=flat)](https://github.com/alexk111/One-Time-Address/stargazers) | No fees | No | Yes | No | NodeJS |
