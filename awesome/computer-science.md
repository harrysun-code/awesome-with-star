...
> **Warning:** There are a few third-party/deprecated/outdated material that you might find when searching for OSSU. We recommend you to ignore them, and only use the [OSSU CS website](https://cs.ossu.dev) or [OSSU CS Github Repo](https://github.com/ossu/computer-science) [![GitHub stars](https://img.shields.io/github/stars/ossu/computer-science?style=flat)](https://github.com/ossu/computer-science/stargazers). Some known outdated materials are:
...
[Mathematics for Computer Science](https://openlearninglibrary.mit.edu/courses/course-v1:OCW+6.042J+2T2019/about) ([alternative](https://ocw.mit.edu/courses/6-042j-mathematics-for-computer-science-fall-2010/)) | 13 weeks | 5 hours/week | [2015/2019 solutions](https://github.com/spamegg1/Math-for-CS-solutions) [![GitHub stars](https://img.shields.io/github/stars/spamegg1/Math-for-CS-solutions?style=flat)](https://github.com/spamegg1/Math-for-CS-solutions/stargazers) [2010 solutions](https://github.com/frevib/mit-cs-math-6042-fall-2010-problems) [![GitHub stars](https://img.shields.io/github/stars/frevib/mit-cs-math-6042-fall-2010-problems?style=flat)](https://github.com/frevib/mit-cs-math-6042-fall-2010-problems/stargazers) [2005 solutions](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-042j-mathematics-for-computer-science-fall-2005/assignments/). | Calculus 1C | [chat](https://discord.gg/EuTzNbF)
...
[Software Engineering: Introduction](https://www.edx.org/learn/software-engineering/university-of-british-columbia-software-engineering-introduction) ([alternative](https://github.com/ubccpsc/310/blob/main/resources/README.md) [![GitHub stars](https://img.shields.io/github/stars/ubccpsc/310/blob/main/resources/README.md?style=flat)](https://github.com/ubccpsc/310/blob/main/resources/README.md/stargazers)) | 6 weeks | 8-10 hours/week | Core Programming, and a [sizable project](FAQ.md#why-require-experience-with-a-sizable-project-before-the-Software-Engineering-courses) | [chat](https://discord.gg/5Qtcwtz)
...
[Learn Prolog Now!](https://www.let.rug.nl/bos/lpn//lpnpage.php?pageid=online) ([alternative](https://github.com/ossu/computer-science/files/6085884/lpn.pdf) [![GitHub stars](https://img.shields.io/github/stars/ossu/computer-science/files/6085884/lpn.pdf?style=flat)](https://github.com/ossu/computer-science/files/6085884/lpn.pdf/stargazers))*| 12 weeks | - | -
...
(*) book by Blackburn, Bos, Striegnitz (compiled from [source](https://github.com/LearnPrologNow/lpn) [![GitHub stars](https://img.shields.io/github/stars/LearnPrologNow/lpn?style=flat)](https://github.com/LearnPrologNow/lpn/stargazers), redistributed under [CC license](https://creativecommons.org/licenses/by-sa/4.0/))
...
# Code of conduct
[OSSU's code of conduct](https://github.com/ossu/code-of-conduct) [![GitHub stars](https://img.shields.io/github/stars/ossu/code-of-conduct?style=flat)](https://github.com/ossu/code-of-conduct/stargazers).

## How to show your progress

[Fork](https://www.freecodecamp.org/news/how-to-fork-a-github-repository/) the [GitHub repo](https://github.com/ossu/computer-science) [![GitHub stars](https://img.shields.io/github/stars/ossu/computer-science?style=flat)](https://github.com/ossu/computer-science/stargazers) into your own GitHub account and put ✅ next to the stuff you've completed as you complete it. This can serve as your [kanban board](https://en.wikipedia.org/wiki/Kanban_board) and will be faster to implement than any other solution (giving you time to spend on the courses).

# Team

* **[Eric Douglas](https://github.com/ericdouglas) [![GitHub stars](https://img.shields.io/github/stars/ericdouglas?style=flat)](https://github.com/ericdouglas/stargazers)**: founder of OSSU
* **[Josh Hanson](https://github.com/joshmhanson) [![GitHub stars](https://img.shields.io/github/stars/joshmhanson?style=flat)](https://github.com/joshmhanson/stargazers)**: lead technical maintainer
* **[Waciuma Wanjohi](https://github.com/waciumawanjohi) [![GitHub stars](https://img.shields.io/github/stars/waciumawanjohi?style=flat)](https://github.com/waciumawanjohi/stargazers)**: lead academic maintainer
* **[Contributors](https://github.com/ossu/computer-science/graphs/contributors) [![GitHub stars](https://img.shields.io/github/stars/ossu/computer-science/graphs/contributors?style=flat)](https://github.com/ossu/computer-science/graphs/contributors/stargazers)**
