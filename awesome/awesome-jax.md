...
> 来源：[n2cholas/awesome-jax](https://github.com/n2cholas/awesome-jax)

[![GitHub stars](https://img.shields.io/github/stars/n2cholas/awesome-jax?style=flat)](https://github.com/n2cholas/awesome-jax/stargazers)

<!--lint ignore double-link-->
# Awesome JAX [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)[<img src="https://raw.githubusercontent.com/google/jax/master/images/jax_logo_250px.png" alt="JAX Logo" align="right" height="100">](https://github.com/google/jax) [![GitHub stars](https://img.shields.io/github/stars/google/jax?style=flat)](https://github.com/google/jax/stargazers)

<!--lint ignore double-link-->
[JAX](https://github.com/google/jax) [![GitHub stars](https://img.shields.io/github/stars/google/jax?style=flat)](https://github.com/google/jax/stargazers) brings automatic differentiation and the [XLA compiler](https://www.tensorflow.org/xla) together through a [NumPy](https://numpy.org/)-like API for high performance machine learning research on accelerators like GPUs and TPUs.
...
- [Oryx](https://github.com/tensorflow/probability/tree/master/spinoffs/oryx) [![GitHub stars](https://img.shields.io/github/stars/tensorflow/probability/tree/master/spinoffs/oryx?style=flat)](https://github.com/tensorflow/probability/tree/master/spinoffs/oryx/stargazers) - Probabilistic programming language based on program transformations.
- [Optimal Transport Tools](https://github.com/google-research/ott) [![GitHub stars](https://img.shields.io/github/stars/google-research/ott?style=flat)](https://github.com/google-research/ott/stargazers) - Toolbox that bundles utilities to solve optimal transport problems.
...
- [ALX](https://github.com/google-research/google-research/tree/master/alx) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/alx?style=flat)](https://github.com/google-research/google-research/tree/master/alx/stargazers) - Open-source library for distributed matrix factorization using Alternating Least Squares, more info in [_ALX: Large Scale Matrix Factorization on TPUs_](https://arxiv.org/abs/2112.02194).
...
- [GPJax](https://github.com/thomaspinder/GPJax) [![GitHub stars](https://img.shields.io/github/stars/thomaspinder/GPJax?style=flat)](https://github.com/thomaspinder/GPJax/stargazers) - Gaussian processes in JAX.
...
- [Lorax](https://github.com/davisyoshida/lorax) [![GitHub stars](https://img.shields.io/github/stars/davisyoshida/lorax?style=flat)](https://github.com/davisyoshida/lorax/stargazers) - Automatically apply LoRA to JAX models (Flax, Haiku, etc.)
...
- [Fourier Feature Networks](https://github.com/tancik/fourier-feature-networks) [![GitHub stars](https://img.shields.io/github/stars/tancik/fourier-feature-networks?style=flat)](https://github.com/tancik/fourier-feature-networks/stargazers) - Official implementation of [_Fourier Features Let Networks Learn High Frequency Functions in Low Dimensional Domains_](https://people.eecs.berkeley.edu/~bmild/fourfeat).
- [kalman-jax](https://github.com/AaltoML/kalman-jax) [![GitHub stars](https://img.shields.io/github/stars/AaltoML/kalman-jax?style=flat)](https://github.com/AaltoML/kalman-jax/stargazers) - Approximate inference for Markov (i.e., temporal) Gaussian processes using iterated Kalman filtering and smoothing.
- [jaxns](https://github.com/Joshuaalbert/jaxns) [![GitHub stars](https://img.shields.io/github/stars/Joshuaalbert/jaxns?style=flat)](https://github.com/Joshuaalbert/jaxns/stargazers) - Nested sampling in JAX.
- [Amortized Bayesian Optimization](https://github.com/google-research/google-research/tree/master/amortized_bo) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/amortized_bo?style=flat)](https://github.com/google-research/google-research/tree/master/amortized_bo/stargazers) - Code related to [_Amortized Bayesian Optimization over Discrete Spaces_](http://www.auai.org/uai2020/proceedings/329_main_paper.pdf).
- [Accurate Quantized Training](https://github.com/google-research/google-research/tree/master/aqt) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/aqt?style=flat)](https://github.com/google-research/google-research/tree/master/aqt/stargazers) - Tools and libraries for running and analyzing neural network quantization experiments in JAX and Flax.
- [BNN-HMC](https://github.com/google-research/google-research/tree/master/bnn_hmc) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/bnn_hmc?style=flat)](https://github.com/google-research/google-research/tree/master/bnn_hmc/stargazers) - Implementation for the paper [_What Are Bayesian Neural Network Posteriors Really Like?_](https://arxiv.org/abs/2104.14421).
- [JAX-DFT](https://github.com/google-research/google-research/tree/master/jax_dft) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/jax_dft?style=flat)](https://github.com/google-research/google-research/tree/master/jax_dft/stargazers) - One-dimensional density functional theory (DFT) in JAX, with implementation of [_Kohn-Sham equations as regularizer: building prior knowledge into machine-learned physics_](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.126.036401).
- [Robust Loss](https://github.com/google-research/google-research/tree/master/robust_loss_jax) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/robust_loss_jax?style=flat)](https://github.com/google-research/google-research/tree/master/robust_loss_jax/stargazers) - Reference code for the paper [_A General and Adaptive Robust Loss Function_](https://arxiv.org/abs/1701.03077).
- [Symbolic Functionals](https://github.com/google-research/google-research/tree/master/symbolic_functionals) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/symbolic_functionals?style=flat)](https://github.com/google-research/google-research/tree/master/symbolic_functionals/stargazers) - Demonstration from [_Evolving symbolic density functionals_](https://arxiv.org/abs/2203.02540).
- [TriMap](https://github.com/google-research/google-research/tree/master/trimap) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/trimap?style=flat)](https://github.com/google-research/google-research/tree/master/trimap/stargazers) - Official JAX implementation of [_TriMap: Large-scale Dimensionality Reduction Using Triplets_](https://arxiv.org/abs/1910.00204).

### Flax

- [awesome-jax-flax-llms](https://github.com/your-username/awesome-jax-flax-llms) [![GitHub stars](https://img.shields.io/github/stars/your-username/awesome-jax-flax-llms?style=flat)](https://github.com/your-username/awesome-jax-flax-llms/stargazers) - Collection of LLMs implemented in **JAX** & **Flax**
- [DeepSeek-R1-Flax-1.5B-Distill](https://github.com/J-Rosser-UK/Torch2Jax-DeepSeek-R1-Distill-Qwen-1.5B) [![GitHub stars](https://img.shields.io/github/stars/J-Rosser-UK/Torch2Jax-DeepSeek-R1-Distill-Qwen-1.5B?style=flat)](https://github.com/J-Rosser-UK/Torch2Jax-DeepSeek-R1-Distill-Qwen-1.5B/stargazers) - Flax implementation of DeepSeek-R1 1.5B distilled reasoning LLM.
- [Performer](https://github.com/google-research/google-research/tree/master/performer/fast_attention/jax) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/performer/fast_attention/jax?style=flat)](https://github.com/google-research/google-research/tree/master/performer/fast_attention/jax/stargazers) - Flax implementation of the Performer (linear transformer via FAVOR+) architecture.
- [JaxNeRF](https://github.com/google-research/google-research/tree/master/jaxnerf) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/jaxnerf?style=flat)](https://github.com/google-research/google-research/tree/master/jaxnerf/stargazers) - Implementation of [_NeRF: Representing Scenes as Neural Radiance Fields for View Synthesis_](http://www.matthewtancik.com/nerf) with multi-device GPU/TPU support.
- [mip-NeRF](https://github.com/google/mipnerf) [![GitHub stars](https://img.shields.io/github/stars/google/mipnerf?style=flat)](https://github.com/google/mipnerf/stargazers) - Official implementation of [_Mip-NeRF: A Multiscale Representation for Anti-Aliasing Neural Radiance Fields_](https://jonbarron.info/mipnerf).
- [RegNeRF](https://github.com/google-research/google-research/tree/master/regnerf) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/regnerf?style=flat)](https://github.com/google-research/google-research/tree/master/regnerf/stargazers) - Official implementation of [_RegNeRF: Regularizing Neural Radiance Fields for View Synthesis from Sparse Inputs_](https://m-niemeyer.github.io/regnerf/).
- [JaxNeuS](https://github.com/huangjuite/jaxneus) [![GitHub stars](https://img.shields.io/github/stars/huangjuite/jaxneus?style=flat)](https://github.com/huangjuite/jaxneus/stargazers) - Implementation of [_NeuS: Learning Neural Implicit Surfaces by Volume Rendering for Multi-view Reconstruction_](https://lingjie0206.github.io/papers/NeuS/)
- [Big Transfer (BiT)](https://github.com/google-research/big_transfer) [![GitHub stars](https://img.shields.io/github/stars/google-research/big_transfer?style=flat)](https://github.com/google-research/big_transfer/stargazers) - Implementation of [_Big Transfer (BiT): General Visual Representation Learning_](https://arxiv.org/abs/1912.11370).
- [JAX RL](https://github.com/ikostrikov/jax-rl) [![GitHub stars](https://img.shields.io/github/stars/ikostrikov/jax-rl?style=flat)](https://github.com/ikostrikov/jax-rl/stargazers) - Implementations of reinforcement learning algorithms.
- [gMLP](https://github.com/SauravMaheshkar/gMLP) [![GitHub stars](https://img.shields.io/github/stars/SauravMaheshkar/gMLP?style=flat)](https://github.com/SauravMaheshkar/gMLP/stargazers) - Implementation of [_Pay Attention to MLPs_](https://arxiv.org/abs/2105.08050).
- [MLP Mixer](https://github.com/SauravMaheshkar/MLP-Mixer) [![GitHub stars](https://img.shields.io/github/stars/SauravMaheshkar/MLP-Mixer?style=flat)](https://github.com/SauravMaheshkar/MLP-Mixer/stargazers) - Minimal implementation of [_MLP-Mixer: An all-MLP Architecture for Vision_](https://arxiv.org/abs/2105.01601).
- [Distributed Shampoo](https://github.com/google-research/google-research/tree/master/scalable_shampoo) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/scalable_shampoo?style=flat)](https://github.com/google-research/google-research/tree/master/scalable_shampoo/stargazers) - Implementation of [_Second Order Optimization Made Practical_](https://arxiv.org/abs/2002.09018).
- [NesT](https://github.com/google-research/nested-transformer) [![GitHub stars](https://img.shields.io/github/stars/google-research/nested-transformer?style=flat)](https://github.com/google-research/nested-transformer/stargazers) - Official implementation of [_Aggregating Nested Transformers_](https://arxiv.org/abs/2105.12723).
- [XMC-GAN](https://github.com/google-research/xmcgan_image_generation) [![GitHub stars](https://img.shields.io/github/stars/google-research/xmcgan_image_generation?style=flat)](https://github.com/google-research/xmcgan_image_generation/stargazers) - Official implementation of [_Cross-Modal Contrastive Learning for Text-to-Image Generation_](https://arxiv.org/abs/2101.04702).
- [FNet](https://github.com/google-research/google-research/tree/master/f_net) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/f_net?style=flat)](https://github.com/google-research/google-research/tree/master/f_net/stargazers) - Official implementation of [_FNet: Mixing Tokens with Fourier Transforms_](https://arxiv.org/abs/2105.03824).
- [GFSA](https://github.com/google-research/google-research/tree/master/gfsa) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/gfsa?style=flat)](https://github.com/google-research/google-research/tree/master/gfsa/stargazers) - Official implementation of [_Learning Graph Structure With A Finite-State Automaton Layer_](https://arxiv.org/abs/2007.04929).
- [IPA-GNN](https://github.com/google-research/google-research/tree/master/ipagnn) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/ipagnn?style=flat)](https://github.com/google-research/google-research/tree/master/ipagnn/stargazers) - Official implementation of [_Learning to Execute Programs with Instruction Pointer Attention Graph Neural Networks_](https://arxiv.org/abs/2010.12621).
- [Flax Models](https://github.com/google-research/google-research/tree/master/flax_models) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/flax_models?style=flat)](https://github.com/google-research/google-research/tree/master/flax_models/stargazers) - Collection of models and methods implemented in Flax.
- [Protein LM](https://github.com/google-research/google-research/tree/master/protein_lm) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/protein_lm?style=flat)](https://github.com/google-research/google-research/tree/master/protein_lm/stargazers) - Implements BERT and autoregressive models for proteins, as described in [_Biological Structure and Function Emerge from Scaling Unsupervised Learning to 250 Million Protein Sequences_](https://www.biorxiv.org/content/10.1101/622803v1.full) and [_ProGen: Language Modeling for Protein Generation_](https://www.biorxiv.org/content/10.1101/2020.03.07.982272v2).
- [Slot Attention](https://github.com/google-research/google-research/tree/master/ptopk_patch_selection) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/ptopk_patch_selection?style=flat)](https://github.com/google-research/google-research/tree/master/ptopk_patch_selection/stargazers) - Reference implementation for [_Differentiable Patch Selection for Image Recognition_](https://arxiv.org/abs/2104.03059).
- [Vision Transformer](https://github.com/google-research/vision_transformer) [![GitHub stars](https://img.shields.io/github/stars/google-research/vision_transformer?style=flat)](https://github.com/google-research/vision_transformer/stargazers) - Official implementation of [_An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale_](https://arxiv.org/abs/2010.11929).
- [FID computation](https://github.com/matthias-wright/jax-fid) [![GitHub stars](https://img.shields.io/github/stars/matthias-wright/jax-fid?style=flat)](https://github.com/matthias-wright/jax-fid/stargazers) - Port of [mseitzer/pytorch-fid](https://github.com/mseitzer/pytorch-fid) [![GitHub stars](https://img.shields.io/github/stars/mseitzer/pytorch-fid?style=flat)](https://github.com/mseitzer/pytorch-fid/stargazers) to Flax.
- [ARDM](https://github.com/google-research/google-research/tree/master/autoregressive_diffusion) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/autoregressive_diffusion?style=flat)](https://github.com/google-research/google-research/tree/master/autoregressive_diffusion/stargazers) - Official implementation of [_Autoregressive Diffusion Models_](https://arxiv.org/abs/2110.02037).
- [D3PM](https://github.com/google-research/google-research/tree/master/d3pm) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/d3pm?style=flat)](https://github.com/google-research/google-research/tree/master/d3pm/stargazers) - Official implementation of [_Structured Denoising Diffusion Models in Discrete State-Spaces_](https://arxiv.org/abs/2107.03006).
- [Gumbel-max Causal Mechanisms](https://github.com/google-research/google-research/tree/master/gumbel_max_causal_gadgets) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/gumbel_max_causal_gadgets?style=flat)](https://github.com/google-research/google-research/tree/master/gumbel_max_causal_gadgets/stargazers) - Code for [_Learning Generalized Gumbel-max Causal Mechanisms_](https://arxiv.org/abs/2111.06888), with extra code in [GuyLor/gumbel_max_causal_gadgets_part2](https://github.com/GuyLor/gumbel_max_causal_gadgets_part2) [![GitHub stars](https://img.shields.io/github/stars/GuyLor/gumbel_max_causal_gadgets_part2?style=flat)](https://github.com/GuyLor/gumbel_max_causal_gadgets_part2/stargazers).
- [Latent Programmer](https://github.com/google-research/google-research/tree/master/latent_programmer) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/latent_programmer?style=flat)](https://github.com/google-research/google-research/tree/master/latent_programmer/stargazers) - Code for the ICML 2021 paper [_Latent Programmer: Discrete Latent Codes for Program Synthesis_](https://arxiv.org/abs/2012.00377).
- [SNeRG](https://github.com/google-research/google-research/tree/master/snerg) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/snerg?style=flat)](https://github.com/google-research/google-research/tree/master/snerg/stargazers) - Official implementation of [_Baking Neural Radiance Fields for Real-Time View Synthesis_](https://phog.github.io/snerg).
- [Spin-weighted Spherical CNNs](https://github.com/google-research/google-research/tree/master/spin_spherical_cnns) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/spin_spherical_cnns?style=flat)](https://github.com/google-research/google-research/tree/master/spin_spherical_cnns/stargazers) - Adaptation of [_Spin-Weighted Spherical CNNs_](https://arxiv.org/abs/2006.10731).
- [VDVAE](https://github.com/google-research/google-research/tree/master/vdvae_flax) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/vdvae_flax?style=flat)](https://github.com/google-research/google-research/tree/master/vdvae_flax/stargazers) - Adaptation of [_Very Deep VAEs Generalize Autoregressive Models and Can Outperform Them on Images_](https://arxiv.org/abs/2011.10650), original code at [openai/vdvae](https://github.com/openai/vdvae) [![GitHub stars](https://img.shields.io/github/stars/openai/vdvae?style=flat)](https://github.com/openai/vdvae/stargazers).
- [MUSIQ](https://github.com/google-research/google-research/tree/master/musiq) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/musiq?style=flat)](https://github.com/google-research/google-research/tree/master/musiq/stargazers) - Checkpoints and model inference code for the ICCV 2021 paper [_MUSIQ: Multi-scale Image Quality Transformer_](https://arxiv.org/abs/2108.05997)
- [AQuaDem](https://github.com/google-research/google-research/tree/master/aquadem) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/aquadem?style=flat)](https://github.com/google-research/google-research/tree/master/aquadem/stargazers) - Official implementation of [_Continuous Control with Action Quantization from Demonstrations_](https://arxiv.org/abs/2110.10149).
- [Combiner](https://github.com/google-research/google-research/tree/master/combiner) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/combiner?style=flat)](https://github.com/google-research/google-research/tree/master/combiner/stargazers) - Official implementation of [_Combiner: Full Attention Transformer with Sparse Computation Cost_](https://arxiv.org/abs/2107.05768).
- [Dreamfields](https://github.com/google-research/google-research/tree/master/dreamfields) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/dreamfields?style=flat)](https://github.com/google-research/google-research/tree/master/dreamfields/stargazers) - Official implementation of the ICLR 2022 paper [_Progressive Distillation for Fast Sampling of Diffusion Models_](https://ajayj.com/dreamfields).
- [GIFT](https://github.com/google-research/google-research/tree/master/gift) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/gift?style=flat)](https://github.com/google-research/google-research/tree/master/gift/stargazers) - Official implementation of [_Gradual Domain Adaptation in the Wild:When Intermediate Distributions are Absent_](https://arxiv.org/abs/2106.06080).
- [Light Field Neural Rendering](https://github.com/google-research/google-research/tree/master/light_field_neural_rendering) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/light_field_neural_rendering?style=flat)](https://github.com/google-research/google-research/tree/master/light_field_neural_rendering/stargazers) - Official implementation of [_Light Field Neural Rendering_](https://arxiv.org/abs/2112.09687).
...
- [GNNs for Solving Combinatorial Optimization Problems](https://github.com/IvanIsCoding/GNN-for-Combinatorial-Optimization) [![GitHub stars](https://img.shields.io/github/stars/IvanIsCoding/GNN-for-Combinatorial-Optimization?style=flat)](https://github.com/IvanIsCoding/GNN-for-Combinatorial-Optimization/stargazers) -  A JAX + Flax implementation of [Combinatorial Optimization with Physics-Inspired Graph Neural Networks](https://arxiv.org/abs/2107.01188).
- [DETR](https://github.com/MasterSkepticista/detr) [![GitHub stars](https://img.shields.io/github/stars/MasterSkepticista/detr?style=flat)](https://github.com/MasterSkepticista/detr/stargazers) - Flax implementation of [_DETR: End-to-end Object Detection with Transformers_](https://github.com/facebookresearch/detr) [![GitHub stars](https://img.shields.io/github/stars/facebookresearch/detr?style=flat)](https://github.com/facebookresearch/detr/stargazers) using Sinkhorn solver and parallel bipartite matching.

### Haiku

- [AlphaFold](https://github.com/deepmind/alphafold) [![GitHub stars](https://img.shields.io/github/stars/deepmind/alphafold?style=flat)](https://github.com/deepmind/alphafold/stargazers) - Implementation of the inference pipeline of AlphaFold v2.0, presented in [_Highly accurate protein structure prediction with AlphaFold_](https://www.nature.com/articles/s41586-021-03819-2).
- [Adversarial Robustness](https://github.com/deepmind/deepmind-research/tree/master/adversarial_robustness) [![GitHub stars](https://img.shields.io/github/stars/deepmind/deepmind-research/tree/master/adversarial_robustness?style=flat)](https://github.com/deepmind/deepmind-research/tree/master/adversarial_robustness/stargazers) - Reference code for [_Uncovering the Limits of Adversarial Training against Norm-Bounded Adversarial Examples_](https://arxiv.org/abs/2010.03593) and [_Fixing Data Augmentation to Improve Adversarial Robustness_](https://arxiv.org/abs/2103.01946).
- [Bootstrap Your Own Latent](https://github.com/deepmind/deepmind-research/tree/master/byol) [![GitHub stars](https://img.shields.io/github/stars/deepmind/deepmind-research/tree/master/byol?style=flat)](https://github.com/deepmind/deepmind-research/tree/master/byol/stargazers) - Implementation for the paper [_Bootstrap your own latent: A new approach to self-supervised Learning_](https://arxiv.org/abs/2006.07733).
- [Gated Linear Networks](https://github.com/deepmind/deepmind-research/tree/master/gated_linear_networks) [![GitHub stars](https://img.shields.io/github/stars/deepmind/deepmind-research/tree/master/gated_linear_networks?style=flat)](https://github.com/deepmind/deepmind-research/tree/master/gated_linear_networks/stargazers) - GLNs are a family of backpropagation-free neural networks.
- [Glassy Dynamics](https://github.com/deepmind/deepmind-research/tree/master/glassy_dynamics) [![GitHub stars](https://img.shields.io/github/stars/deepmind/deepmind-research/tree/master/glassy_dynamics?style=flat)](https://github.com/deepmind/deepmind-research/tree/master/glassy_dynamics/stargazers) - Open source implementation of the paper [_Unveiling the predictive power of static structure in glassy systems_](https://www.nature.com/articles/s41567-020-0842-8).
- [MMV](https://github.com/deepmind/deepmind-research/tree/master/mmv) [![GitHub stars](https://img.shields.io/github/stars/deepmind/deepmind-research/tree/master/mmv?style=flat)](https://github.com/deepmind/deepmind-research/tree/master/mmv/stargazers) - Code for the models in [_Self-Supervised MultiModal Versatile Networks_](https://arxiv.org/abs/2006.16228).
- [Normalizer-Free Networks](https://github.com/deepmind/deepmind-research/tree/master/nfnets) [![GitHub stars](https://img.shields.io/github/stars/deepmind/deepmind-research/tree/master/nfnets?style=flat)](https://github.com/deepmind/deepmind-research/tree/master/nfnets/stargazers) - Official Haiku implementation of [_NFNets_](https://arxiv.org/abs/2102.06171).
- [NuX](https://github.com/Information-Fusion-Lab-Umass/NuX) [![GitHub stars](https://img.shields.io/github/stars/Information-Fusion-Lab-Umass/NuX?style=flat)](https://github.com/Information-Fusion-Lab-Umass/NuX/stargazers) - Normalizing flows with JAX.
- [OGB-LSC](https://github.com/deepmind/deepmind-research/tree/master/ogb_lsc) [![GitHub stars](https://img.shields.io/github/stars/deepmind/deepmind-research/tree/master/ogb_lsc?style=flat)](https://github.com/deepmind/deepmind-research/tree/master/ogb_lsc/stargazers) - This repository contains DeepMind's entry to the [PCQM4M-LSC](https://ogb.stanford.edu/kddcup2021/pcqm4m/) (quantum chemistry) and [MAG240M-LSC](https://ogb.stanford.edu/kddcup2021/mag240m/) (academic graph)
tracks of the [OGB Large-Scale Challenge](https://ogb.stanford.edu/kddcup2021/) (OGB-LSC).
- [Persistent Evolution Strategies](https://github.com/google-research/google-research/tree/master/persistent_es) [![GitHub stars](https://img.shields.io/github/stars/google-research/google-research/tree/master/persistent_es?style=flat)](https://github.com/google-research/google-research/tree/master/persistent_es/stargazers) - Code used for the paper [_Unbiased Gradient Estimation in Unrolled Computation Graphs with Persistent Evolution Strategies_](http://proceedings.mlr.press/v139/vicol21a.html).
- [Two Player Auction Learning](https://github.com/degregat/two-player-auctions) [![GitHub stars](https://img.shields.io/github/stars/degregat/two-player-auctions?style=flat)](https://github.com/degregat/two-player-auctions/stargazers) - JAX implementation of the paper [_Auction learning as a two-player game_](https://arxiv.org/abs/2006.05684).
- [WikiGraphs](https://github.com/deepmind/deepmind-research/tree/master/wikigraphs) [![GitHub stars](https://img.shields.io/github/stars/deepmind/deepmind-research/tree/master/wikigraphs?style=flat)](https://github.com/deepmind/deepmind-research/tree/master/wikigraphs/stargazers) - Baseline code to reproduce results in [_WikiGraphs: A Wikipedia Text - Knowledge Graph Paired Datase_](https://aclanthology.org/2021.textgraphs-1.7).

### Trax

- [Reformer](https://github.com/google/trax/tree/master/trax/models/reformer) [![GitHub stars](https://img.shields.io/github/stars/google/trax/tree/master/trax/models/reformer?style=flat)](https://github.com/google/trax/tree/master/trax/models/reformer/stargazers) - Implementation of the Reformer (efficient transformer) architecture.

### NumPyro

- [lqg](https://github.com/RothkopfLab/lqg) [![GitHub stars](https://img.shields.io/github/stars/RothkopfLab/lqg?style=flat)](https://github.com/RothkopfLab/lqg/stargazers) - Official implementation of Bayesian inverse optimal control for linear-quadratic Gaussian problems from the paper [_Putting perception into action with inverse optimal control for continuous psychophysics_](https://elifesciences.org/articles/76635)
...
- [JAX, Flax & Transformers 🤗](https://github.com/huggingface/transformers/blob/9160d81c98854df44b1d543ce5d65a6aa28444a2/examples/research_projects/jax-projects/README.md#talks) [![GitHub stars](https://img.shields.io/github/stars/huggingface/transformers/blob/9160d81c98854df44b1d543ce5d65a6aa28444a2/examples/research_projects/jax-projects/README.md?style=flat)](https://github.com/huggingface/transformers/blob/9160d81c98854df44b1d543ce5d65a6aa28444a2/examples/research_projects/jax-projects/README.md/stargazers) - 3 days of talks around JAX / Flax, Transformers, large-scale language modeling and other great topics.
...
- [Extending JAX with custom C++ and CUDA code by Dan Foreman-Mackey](https://github.com/dfm/extending-jax) [![GitHub stars](https://img.shields.io/github/stars/dfm/extending-jax?style=flat)](https://github.com/dfm/extending-jax/stargazers) - Tutorial demonstrating the infrastructure required to provide custom ops in JAX.
...
- [Get started with JAX by Aleksa Gordić](https://github.com/gordicaleksa/get-started-with-JAX) [![GitHub stars](https://img.shields.io/github/stars/gordicaleksa/get-started-with-JAX?style=flat)](https://github.com/gordicaleksa/get-started-with-JAX/stargazers) - A series of notebooks and videos going from zero JAX knowledge to building neural networks in Haiku.
