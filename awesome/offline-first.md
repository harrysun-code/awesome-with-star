...
[Almost any web page can work offline](https://github.com/homam/service-workers-example) [![GitHub stars](https://img.shields.io/github/stars/homam/service-workers-example?style=flat)](https://github.com/homam/service-workers-example/stargazers) 
...
[Service Worker Recipes](https://github.com/GoogleChrome/samples/tree/gh-pages/service-worker) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/samples/tree/gh-pages/service-worker?style=flat)](https://github.com/GoogleChrome/samples/tree/gh-pages/service-worker/stargazers)
...
[offline-plugin](https://github.com/NekR/offline-plugin/) [![GitHub stars](https://img.shields.io/github/stars/NekR/offline-plugin/?style=flat)](https://github.com/NekR/offline-plugin//stargazers): Offline plugin (ServiceWorker, AppCache) for webpack.

[Pinterest Service Workers](https://github.com/pinterest/service-workers) [![GitHub stars](https://img.shields.io/github/stars/pinterest/service-workers?style=flat)](https://github.com/pinterest/service-workers/stargazers):A collection of utilities for creating/testing/experimenting with service workers.

[Kinto](http://www.kinto-storage.org/): Add synchronisation and sharing abilities to your Web application in seconds.

[bottle-service](https://github.com/bahmutov/bottle-service) [![GitHub stars](https://img.shields.io/github/stars/bahmutov/bottle-service?style=flat)](https://github.com/bahmutov/bottle-service/stargazers): Instant web applications restored from ServiceWorker cache.

[react-boilerplate](https://github.com/mxstbr/react-boilerplate) [![GitHub stars](https://img.shields.io/github/stars/mxstbr/react-boilerplate?style=flat)](https://github.com/mxstbr/react-boilerplate/stargazers): Quick setup for performance orientated, offline-first React.js applications.

[Haywire](https://github.com/omnia-salud/haywire) [![GitHub stars](https://img.shields.io/github/stars/omnia-salud/haywire?style=flat)](https://github.com/omnia-salud/haywire/stargazers): A minimal javascript library for network issues detection.

[sw-toolbox](https://github.com/GoogleChrome/sw-toolbox) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/sw-toolbox?style=flat)](https://github.com/GoogleChrome/sw-toolbox/stargazers): A collection of tools for service workers.
...
[simple-serviceworker-tutorial](https://github.com/jakearchibald/simple-serviceworker-tutorial) [![GitHub stars](https://img.shields.io/github/stars/jakearchibald/simple-serviceworker-tutorial?style=flat)](https://github.com/jakearchibald/simple-serviceworker-tutorial/stargazers): A really simple ServiceWorker example, designed to be an interactive introduction to ServiceWorker.

[Hyperboot](https://github.com/substack/hyperboot) [![GitHub stars](https://img.shields.io/github/stars/substack/hyperboot?style=flat)](https://github.com/substack/hyperboot/stargazers): Offline webapp bootloader.

[MakeDrive](https://github.com/mozilla/makedrive) [![GitHub stars](https://img.shields.io/github/stars/mozilla/makedrive?style=flat)](https://github.com/mozilla/makedrive/stargazers): A cloud-based Dropbox® equivalent for browser filesystems. Designed for use with Mozilla Webmaker tools and services.
...
[localForage](https://github.com/localForage/localForage) [![GitHub stars](https://img.shields.io/github/stars/localForage/localForage?style=flat)](https://github.com/localForage/localForage/stargazers): Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
...
[appCache Nanny](https://github.com/gr2m/appcache-nanny) [![GitHub stars](https://img.shields.io/github/stars/gr2m/appcache-nanny?style=flat)](https://github.com/gr2m/appcache-nanny/stargazers):  JavaScript APIs for appCache

[bro-fs](https://github.com/vitalets/bro-fs) [![GitHub stars](https://img.shields.io/github/stars/vitalets/bro-fs?style=flat)](https://github.com/vitalets/bro-fs/stargazers): Promise-based wrapper over [HTML5 Filesystem API](https://www.w3.org/TR/file-system-api/) allowing to work with sandboxed filesystem in Chrome.

[Orbit.js](http://orbitjs.com/): Framework for orchestrating access, transformation, and synchronization between data sources.

[workbox](https://github.com/GoogleChrome/workbox) [![GitHub stars](https://img.shields.io/github/stars/GoogleChrome/workbox?style=flat)](https://github.com/GoogleChrome/workbox/stargazers): JavaScript libraries for Offline Caching

[rxdb](https://github.com/pubkey/rxdb) [![GitHub stars](https://img.shields.io/github/stars/pubkey/rxdb?style=flat)](https://github.com/pubkey/rxdb/stargazers)
...
## Who to Follow
- [Matthew Riley](https://github.com/tofumatt) [![GitHub stars](https://img.shields.io/github/stars/tofumatt?style=flat)](https://github.com/tofumatt/stargazers): Works at mozilla, creator of localForage (localstroage, IndexedDb and WebSQL Wrapper)
- [Jake Archibald](https://github.com/jakearchibald) [![GitHub stars](https://img.shields.io/github/stars/jakearchibald?style=flat)](https://github.com/jakearchibald/stargazers): Self described service worker fanatic, works at google helping make offline web apps a thing.
...
Thanks to all [contributors](https://github.com/pazguille/offline-first/graphs/contributors) [![GitHub stars](https://img.shields.io/github/stars/pazguille/offline-first/graphs/contributors?style=flat)](https://github.com/pazguille/offline-first/graphs/contributors/stargazers).
