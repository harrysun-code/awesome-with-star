...
> 来源：[ianstormtaylor/awesome-heroku](https://github.com/ianstormtaylor/awesome-heroku)

[![GitHub stars](https://img.shields.io/github/stars/ianstormtaylor/awesome-heroku?style=flat)](https://github.com/ianstormtaylor/awesome-heroku/stargazers)
...
- `plugin` [heroku-buildpack-pgbouncer](https://github.com/heroku/heroku-buildpack-pgbouncer) [![GitHub stars](https://img.shields.io/github/stars/heroku/heroku-buildpack-pgbouncer?style=flat)](https://github.com/heroku/heroku-buildpack-pgbouncer/stargazers) — a buildpack that allows for transaction pooling using [`stunnel`](https://www.stunnel.org/index.html) and [`pgbouncer`](https://wiki.postgresql.org/wiki/PgBouncer) to avoid hitting connection limits.
...
- `plugin` [heroku-accounts](https://github.com/ddollar/heroku-accounts) [![GitHub stars](https://img.shields.io/github/stars/ddollar/heroku-accounts?style=flat)](https://github.com/ddollar/heroku-accounts/stargazers) — makes it easy to work with multiple accounts at once from the command line.
- `plugin` [heroku-pg-extras](https://github.com/heroku/heroku-pg-extras) [![GitHub stars](https://img.shields.io/github/stars/heroku/heroku-pg-extras?style=flat)](https://github.com/heroku/heroku-pg-extras/stargazers) — a toolbelt plugin that adds extra useful plugins for working with Postgres. Things like analyzing cache hit rates, outlier queries, unused indexes, table sizes, etc.
