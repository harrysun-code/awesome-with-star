...
- [LLM Engineer Handbook](https://github.com/SylphAI-Inc/LLM-engineer-handbook) [![GitHub stars](https://img.shields.io/github/stars/SylphAI-Inc/LLM-engineer-handbook?style=flat)](https://github.com/SylphAI-Inc/LLM-engineer-handbook/stargazers) — A goldmine of useful links for AI engineers.
...
- [Docling](https://github.com/docling-project/docling) [![GitHub stars](https://img.shields.io/github/stars/docling-project/docling?style=flat)](https://github.com/docling-project/docling/stargazers) — Great library for ingesting any kind of document for RAG ⭐

### Evals
- [OpenAI Evals](https://github.com/openai/evals) [![GitHub stars](https://img.shields.io/github/stars/openai/evals?style=flat)](https://github.com/openai/evals/stargazers) — OpenAI's framework for writing evals.

### IDEs
- [Cursor](https://cursor.sh/) — LLM-powered IDE for multi-file edits and codebase-aware chat.
- [GitHub Copilot](https://github.com/features/copilot) [![GitHub stars](https://img.shields.io/github/stars/features/copilot?style=flat)](https://github.com/features/copilot/stargazers) — In-IDE code completion, chat, and refactors.
...
- [Codex CLI](https://github.com/openai/codex) [![GitHub stars](https://img.shields.io/github/stars/openai/codex?style=flat)](https://github.com/openai/codex/stargazers) — OpenAI's Rust-based local terminal agent; lightweight and fast.
- [Gemini CLI](https://github.com/google-gemini/gemini-cli) [![GitHub stars](https://img.shields.io/github/stars/google-gemini/gemini-cli?style=flat)](https://github.com/google-gemini/gemini-cli/stargazers) — Google's official open-source terminal agent; long-context repo exploration.
...
- [Cline](https://github.com/cline/cline) [![GitHub stars](https://img.shields.io/github/stars/cline/cline?style=flat)](https://github.com/cline/cline/stargazers) — Open-source agentic IDE extension with strong multi-provider support.
...
- [Qwen Code](https://github.com/QwenLM/qwen-code) [![GitHub stars](https://img.shields.io/github/stars/QwenLM/qwen-code?style=flat)](https://github.com/QwenLM/qwen-code/stargazers) — Alibaba's terminal coding agent, optimized for Qwen models.
- [Pi](https://pi.dev/) — Highly customizable terminal harness; minimal base prompt, extension-driven.
- [Nanocoder](https://github.com/Nano-Collective/nanocoder) [![GitHub stars](https://img.shields.io/github/stars/Nano-Collective/nanocoder?style=flat)](https://github.com/Nano-Collective/nanocoder/stargazers) — Private, local-first agent for Ollama and LM Studio.
