...
> 来源：[nirgn975/awesome-drupal](https://github.com/nirgn975/awesome-drupal)

[![GitHub stars](https://img.shields.io/github/stars/nirgn975/awesome-drupal?style=flat)](https://github.com/nirgn975/awesome-drupal/stargazers)
...
- [Yo Hedley!](https://github.com/Gizra/generator-hedley) [![GitHub stars](https://img.shields.io/github/stars/Gizra/generator-hedley?style=flat)](https://github.com/Gizra/generator-hedley/stargazers) - Scaffold a headless Drupal backend, Angular app client, and Behat tests.
- [DDEV-Local](https://github.com/drud/ddev) [![GitHub stars](https://img.shields.io/github/stars/drud/ddev?style=flat)](https://github.com/drud/ddev/stargazers) - A Docker-based tool to create and manage local development environments. Use for other PHP apps too. Also see the [Get Started Guide](https://www.drud.com/get-started/) 
...
- [Solr Script](https://github.com/RoySegall/solr-script) [![GitHub stars](https://img.shields.io/github/stars/RoySegall/solr-script?style=flat)](https://github.com/RoySegall/solr-script/stargazers) - Handy script to install Apache Solr.
- [Ubuntu development environment setup](https://github.com/Gizra/KnowledgeBase/wiki/Ubuntu-and-development-environment-setup) [![GitHub stars](https://img.shields.io/github/stars/Gizra/KnowledgeBase/wiki/Ubuntu-and-development-environment-setup?style=flat)](https://github.com/Gizra/KnowledgeBase/wiki/Ubuntu-and-development-environment-setup/stargazers) - Provides steps for configuring ubuntu so it will be ready for PHP and Drupal development.
- [MacOS: New Machine configuration](https://github.com/Gizra/KnowledgeBase/wiki/MacOS:-New-Machine) [![GitHub stars](https://img.shields.io/github/stars/Gizra/KnowledgeBase/wiki/MacOS:-New-Machine?style=flat)](https://github.com/Gizra/KnowledgeBase/wiki/MacOS:-New-Machine/stargazers) - Provides files and scripts for configuring MacOS for development.
