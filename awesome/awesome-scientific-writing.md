...
- [Marktext](https://github.com/marktext/marktext) [![GitHub stars](https://img.shields.io/github/stars/marktext/marktext?style=flat)](https://github.com/marktext/marktext/stargazers) - Markdown text editor.
- [R Studio](https://github.com/rstudio/rstudio) [![GitHub stars](https://img.shields.io/github/stars/rstudio/rstudio?style=flat)](https://github.com/rstudio/rstudio/stargazers) - IDE for R.
...
- [Zotero](https://www.zotero.org/) - FOSS tool to collect, organize, cite, and
  ...
  - [Zotero OCR](https://github.com/UB-Mannheim/zotero-ocr) [![GitHub stars](https://img.shields.io/github/stars/UB-Mannheim/zotero-ocr?style=flat)](https://github.com/UB-Mannheim/zotero-ocr/stargazers) - Plugin that makes scanned PDFs searchable using Tesseract OCR and Poppler.
...
- [latex2arxiv](https://github.com/YuZh98/latex2arxiv) [![GitHub stars](https://img.shields.io/github/stars/YuZh98/latex2arxiv?style=flat)](https://github.com/YuZh98/latex2arxiv/stargazers) - Command-line tool which converts
...
- [pandoc](https://pandoc.org/MANUAL) - Haskell library for converting from
  ...
  - [Pandoc filters](https://github.com/jgm/pandoc/wiki/Pandoc-Filters) [![GitHub stars](https://img.shields.io/github/stars/jgm/pandoc/wiki/Pandoc-Filters?style=flat)](https://github.com/jgm/pandoc/wiki/Pandoc-Filters/stargazers) - List of
...
- [Typst](https://github.com/typst/typst) [![GitHub stars](https://img.shields.io/github/stars/typst/typst?style=flat)](https://github.com/typst/typst/stargazers) - Markup-based typesetting system with math, bibliography management, and fast incremental compilation to PDF.
...
- [Vale](https://github.com/errata-ai/vale) [![GitHub stars](https://img.shields.io/github/stars/errata-ai/vale?style=flat)](https://github.com/errata-ai/vale/stargazers) - Free, open-source linter for
 prose built with speed and extensibility in mind.
- [write-good](https://github.com/btford/write-good) [![GitHub stars](https://img.shields.io/github/stars/btford/write-good?style=flat)](https://github.com/btford/write-good/stargazers) - Naive linter for English
 prose.
...
- [Paper Templates for GitHub Pages](https://github.com/dev-onejun/paper-templates-for-github-pages) [![GitHub stars](https://img.shields.io/github/stars/dev-onejun/paper-templates-for-github-pages?style=flat)](https://github.com/dev-onejun/paper-templates-for-github-pages/stargazers) - Markdown-based templates for papers and RESUME/CVs, publishing with GitHub Pages.
