...
> 来源：[michelpereira/awesome-games-of-coding](https://github.com/michelpereira/awesome-games-of-coding)

[![GitHub stars](https://img.shields.io/github/stars/michelpereira/awesome-games-of-coding?style=flat)](https://github.com/michelpereira/awesome-games-of-coding/stargazers)
...
- [Robocode](https://github.com/turkishviking/Python-Robocode) [![GitHub stars](https://img.shields.io/github/stars/turkishviking/Python-Robocode?style=flat)](https://github.com/turkishviking/Python-Robocode/stargazers) - The goal is to develop a robot battle tank to battle against other tanks. The robot battles are running in real-time and on-screen.
...
- [BitBurner](https://github.com/bitburner-official/bitburner-src) [![GitHub stars](https://img.shields.io/github/stars/bitburner-official/bitburner-src?style=flat)](https://github.com/bitburner-official/bitburner-src/stargazers) - A programming-based idle incremental RPG where you, the player, take the role of an unknown hacker in a dark, dystopian world. The game can be played in the browser, or installed locally through Steam.
...
- [Robocode](https://github.com/d6y/scala-robot-dev) [![GitHub stars](https://img.shields.io/github/stars/d6y/scala-robot-dev?style=flat)](https://github.com/d6y/scala-robot-dev/stargazers) - The goal is to develop a robot battle tank to battle against other tanks in Java or .NET. The robot battles are running in real-time and on-screen.
...
- [The Command Line Murders](https://github.com/veltman/clmystery) [![GitHub stars](https://img.shields.io/github/stars/veltman/clmystery?style=flat)](https://github.com/veltman/clmystery/stargazers) - There's been a murder in Terminal City, and TCPD needs your help.
