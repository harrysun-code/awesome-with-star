...
- [A simple plugin to keep font-size in proportion with it's containers size](https://github.com/jkroso/flowtype) [![GitHub stars](https://img.shields.io/github/stars/jkroso/flowtype?style=flat)](https://github.com/jkroso/flowtype/stargazers)
...
- [Using Custom Fonts in Emails](https://github.com/ladjs/custom-fonts-in-emails) [![GitHub stars](https://img.shields.io/github/stars/ladjs/custom-fonts-in-emails?style=flat)](https://github.com/ladjs/custom-fonts-in-emails/stargazers)
- [Typographist — Modular scale calculator API with config validation](https://github.com/typographist) [![GitHub stars](https://img.shields.io/github/stars/typographist?style=flat)](https://github.com/typographist/stargazers)
...
- [How to use custom fonts in emails](https://github.com/forwardemail/custom-fonts-in-emails) [![GitHub stars](https://img.shields.io/github/stars/forwardemail/custom-fonts-in-emails?style=flat)](https://github.com/forwardemail/custom-fonts-in-emails/stargazers)
